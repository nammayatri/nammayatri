...
var getFR = function (stringKey) {
    ...
    if (stringKey instanceof Language_Types.PRIVACY_POLICY) {
        return "Politique de confidentialit\xe9";
    };
    if (stringKey instanceof Language_Types.LOGO) {
        return "Logo";
    };
    if (stringKey instanceof Language_Types.ABOUT_APP_DESCRIPTION) {
        return "Le partenaire Namma Yatri est une plateforme ouverte de mise en relation des chauffeurs et des clients. L'application permet aux conducteurs de trouver des chauffeurs aux tarifs propos\xe9s. Il n'y a pas de commission bas\xe9e sur la course : il suffit de payer un petit montant sous la forme d'un abonnement mensuel";
    };
    if (stringKey instanceof Language_Types.TERMS_AND_CONDITIONS) {
        return "Conditions g\xe9n\xe9rales d'utilisation";
    };
    if (stringKey instanceof Language_Types.UPDATE_VEHICLE_DETAILS) {
        return "Mettre \xe0 jour les informations du v\xe9hicule";
    };
    ...
    if (stringKey instanceof Language_Types.YOU_ARE_OFFLINE) {
        return "Vous \xeates hors ligne";
    };
    if (stringKey instanceof Language_Types.YOU_ARE_CURRENTLY_BUSY_GO_ONLINE_TO_RECIEVE_TRIP_REQUESTS) {
        return "Vous avez actuellement le statut occup\xe9. Placez votre statut sur en ligne pour recevoir des demandes de course";
    };
    if (stringKey instanceof Language_Types.GOING_OFFLINE_WILL_NOT_GET_YOU_ANY_RIDE) {
        return "Se d\xe9connecter vous emp\xeachera de recevoir des courses";
    };
    ...
    if (stringKey instanceof Language_Types.ENTERED_WRONG_OTP) {
        return "Code \xe0 usage unique erron\xe9";
    };
    if (stringKey instanceof Language_Types.OTP_INVALID_FOR_THIS_VEHICLE_VARIANT) {
        return "OTP invalide \u2013 Le type de v\xe9hicule ne correspond pas au type de trajet";
    };
    ...
    if (stringKey instanceof Language_Types.ISSUE_WITH_DL_IMAGE) {
        return "Il semble y avoir un probl\xe8me avec votre photo de permis, notre \xe9quipe d'assistance vous contactera bient\xf4t";
    };
    if (stringKey instanceof Language_Types.STILL_HAVE_SOME_DOUBT) {
        return "Vous avez encore un doute?";
    };
    if (stringKey instanceof Language_Types.ISSUE_WITH_RC_IMAGE) {
        return "Il semble y avoir un probl\xe8me avec votre photo de certification d'enregistrement, notre \xe9quipe d'assistance vous contactera bient\xf4t";
    };
    if (stringKey instanceof Language_Types.PLEASE_CHECK_FOR_IMAGE_IF_VALID_DOCUMENT_IMAGE_OR_NOT) {
        return "Veuillez v\xe9rifier l'image si l'image du document est valide ou non";
    };
    if (stringKey instanceof Language_Types.OOPS_YOUR_APPLICATION_HAS_BEEN_REJECTED) {
        return "Oups! Votre demande a \xe9t\xe9 rejet\xe9e. Veuillez r\xe9essayer";
    };
    ...
    if (stringKey instanceof Language_Types.DRIVER_ALREADY_LINKED) {
        return "Un autre doc est d\xe9j\xe0 li\xe9 au chauffeur";
    };
    if (stringKey instanceof Language_Types.DL_ALREADY_UPDATED) {
        return "Aucune action requise. Le permis de conduire est d\xe9j\xe0 li\xe9 au chauffeur";
    };
    if (stringKey instanceof Language_Types.RC_ALREADY_LINKED) {
        return "CE du V\xe9hicule non disponible. Li\xe9 \xe0 un autre conducteur";
    };
    if (stringKey instanceof Language_Types.RC_ALREADY_UPDATED) {
        return "Aucune action requise. Le CE du v\xe9hicule est d\xe9j\xe0 li\xe9 au conducteur";
    };
    if (stringKey instanceof Language_Types.DL_ALREADY_LINKED) {
        return "Permis de conduire non disponible. Li\xe9 \xe0 un autre conducteur";
    };
    if (stringKey instanceof Language_Types.SOMETHING_WENT_WRONG) {
        return "Quelque chose s'est mal pass\xe9";
    };
    ...
    if (stringKey instanceof Language_Types.CURRENTLY_WE_ALLOW_ONLY_KARNATAKA_REGISTERED_NUMBER) {
        return "Actuellement, nous n'autorisons que les num\xe9ros enregistr\xe9s au Karnataka";
    };
    if (stringKey instanceof Language_Types.UPDATED_AT) {
        return "Carte mise \xe0 jour \xe0";
    };
    if (stringKey instanceof Language_Types.TRIP_COUNT) {
        return "Compteur de trajets";
    };
    ...
    if (stringKey instanceof Language_Types.SELECT_DATE_OF_ISSUE) {
        return "S\xe9lectionner la date de d\xe9livrance";
    };
    if (stringKey instanceof Language_Types.DATE_OF_ISSUE) {
        return "Date d'\xe9mission";
    };
    if (stringKey instanceof Language_Types.PROVIDE_DATE_OF_ISSUE_TEXT) {
        return "D\xe9sol\xe9, nous ne pouvons pas valider vos informations, veuillez fournir <b> la date de d\xe9livrance </b> pour faire valider votre permis de conduire";
    };
    if (stringKey instanceof Language_Types.PROVIDE_DATE_OF_REGISTRATION_TEXT) {
        return "D\xe9sol\xe9, nous ne pourrions pas valider vos d\xe9tails, veuillez fournir <b> la date de l'enregistrement </b> pour faire valider les d\xe9tails de votre v\xe9hicule";
    };
    if (stringKey instanceof Language_Types.SELECT_DATE_OF_REGISTRATION) {
        return "S\xe9lectionner la date d'inscription";
    };
    if (stringKey instanceof Language_Types.SAME_REENTERED_RC_MESSAGE) {
        return "Veuillez vous assurer que le num\xe9ro de CE r\xe9int\xe9gr\xe9 est le m\xeame que le num\xe9ro de CE fourni ci-dessus";
    };
    if (stringKey instanceof Language_Types.SAME_REENTERED_DL_MESSAGE) {
        return "Le num\xe9ro de PC re-renseign\xe9 ne correspond pas au num\xe9ro de PC fourni ci-dessus";
    };
    if (stringKey instanceof Language_Types.WHERE_IS_MY_ISSUE_DATE) {
        return "O\xf9 est ma date d'\xe9mission?";
    };
    if (stringKey instanceof Language_Types.WHERE_IS_MY_REGISTRATION_DATE) {
        return "O\xf9 est la date d'inscription?";
    };
    if (stringKey instanceof Language_Types.OTP_RESENT) {
        return "Code \xe0 usage unique envoy\xe9";
    };
    if (stringKey instanceof Language_Types.EARNINGS_CREDITED_IN_ACCOUNT) {
        return "Vos gains seront cr\xe9dit\xe9s dans ce compte";
    };
    if (stringKey instanceof Language_Types.INVALID_PARAMETERS) {
        return "Param\xe8tres invalides";
    };
    if (stringKey instanceof Language_Types.UNAUTHORIZED) {
        return "Non autoris\xe9";
    };
    ...
    if (stringKey instanceof Language_Types.VEHICLE_ISSUE) {
        return "Probl\xe8me de v\xe9hicule";
    };
    if (stringKey instanceof Language_Types.FARE_UPDATED) {
        return "Tarif mis \xe0 jour";
    };
    if (stringKey instanceof Language_Types.FREQUENT_CANCELLATIONS_WILL_LEAD_TO_LESS_RIDES) {
        return "Les annulations fr\xe9quentes conduiront \xe0 moins de courses et \xe0 une note inf\xe9rieure";
    };
    ...
    if (stringKey instanceof Language_Types.CUSTOMER_WAS_RUDE) {
        return "Le client \xe9tait impoli";
    };
    ...
    if (stringKey instanceof Language_Types.NO_NOTIFICATIONS_RIGHT_NOW) {
        return "Pas de notifications en ce moment !";
    };
    if (stringKey instanceof Language_Types.NO_NOTIFICATIONS_RIGHT_NOW_DESC) {
        return "Nous vous ferons savoir quand il y a de nouvelles notifications";
    };
    ...
    if (stringKey instanceof Language_Types.GETTING_DELAYED_PLEASE_WAIT) {
        return "\xcatre retard\xe9, veuillez attendre";
    };
    if (stringKey instanceof Language_Types.UNREACHABLE_PLEASE_CALL_BACK) {
        return "Injoignable, veuillez rappeler";
    };
    ...
    if (stringKey instanceof Language_Types.PLEASE_COME_SOON) {
        return "S'il vous plait venez bientot";
    };
    if (stringKey instanceof Language_Types.OK_I_WILL_WAIT) {
        return "D'accord, je vais attendre";
    };
    ...
    if (stringKey instanceof Language_Types.CORPORATE_ADDRESS_DESCRIPTION) {
        return "Juspay Technologies Private Limited <br> Girija Building, num\xe9ro 817, Ganapathi Temple Rd, 8th Block, Koramangala, Bengaluru, Karnataka 560095, Inde";
    };
    if (stringKey instanceof Language_Types.CORPORATE_ADDRESS_DESCRIPTION_ADDITIONAL) {
        return "Website: <u> https://nammayatriin/ </u>";
    };
    if (stringKey instanceof Language_Types.REGISTERED_ADDRESS) {
        return "Adresse enregistr\xe9e";
    };
    if (stringKey instanceof Language_Types.REGISTERED_ADDRESS_DESCRIPTION) {
        return "Juspay Technologies Private Limited <br>Stallion Business Centre, numero 444, 3e et 4e \xe9tage, 18e Main, 6e bloc, Koramangala Bengaluru, Karnataka- 560095, Inde";
    };
    ...
    if (stringKey instanceof Language_Types.AUTOMATIC_PAYMENTS_WILL_APPEAR_HERE) {
        return "Les paiements automatiques appara\xeetront ici";
    };
    if (stringKey instanceof Language_Types.MANUAL_PAYMENTS) {
        return "Paiements manuels";
    };
    if (stringKey instanceof Language_Types.MANUAL_PAYMENTS_WILL_APPEAR_HERE) {
        return "Les paiements manuels appara\xeetront ici";
    };
    if (stringKey instanceof Language_Types.NO_AUTOMATIC_PAYMENTS_DESC) {
        return "Votre historique de paiement automatique appara\xeetra ici une fois que vous serez factur\xe9 pour la m\xeame chose";
    };
    if (stringKey instanceof Language_Types.NO_MANUAL_PAYMENTS_DESC) {
        return "Votre historique de paiement pour la compensation des cotisations appara\xeetra ici, le cas \xe9ch\xe9ant.";
    };
    ...
    if (stringKey instanceof Language_Types.TAP_A_PLAN_TO_VIEW_DETAILS) {
        return "Appuyez sur un plan pour afficher les d\xe9tails";
    };
    if (stringKey instanceof Language_Types.HOW_IT_WORKS) {
        return "Comment \xe7a marche";
    };
    ...
    if (stringKey instanceof Language_Types.EARN_TODAY_PAY_TOMORROW) {
        return "Gagnez aujourd'hui, payez demain";
    };
    if (stringKey instanceof Language_Types.PAY_ONLY_IF_YOU_TAKE_RIDES) {
        return "Ne payez que si vous faites des trajets";
    };
    ...
    if (stringKey instanceof Language_Types.INVALID_AUTO_PAY_STATUS) {
        return "Statut de paiement automatique non valide";
    };
    ...
    if (stringKey instanceof Language_Types.SWITCH_PLAN_STR) {
        return "Plan de commutation?";
    };
    if (stringKey instanceof Language_Types.PLAN_SWITCHED_TO) {
        return "le plan est pass\xe9 \xe0";
    };
    if (stringKey instanceof Language_Types.OFFERS_APPLICABLE_ON_DAILY_UNLIMITED) {
        return "Remarque: Offre applicable uniquement si AutoPay est configur\xe9 sur le plan illimit\xe9 quotidien.";
    };
    if (stringKey instanceof Language_Types.DAILY_UNLIMITED_OFFER_NOT_AVAILABLE) {
        return "Remarque: les offres illimit\xe9es quotidiennes ne sont pas applicables sur ce plan!";
    };
    if (stringKey instanceof Language_Types.NO_RIDES_NO_CHARGE) {
        return "Payez uniquement si vous faites des courses";
    };
    ...
    if (stringKey instanceof Language_Types.SETUP_AUTOPAY_NOW_TO_GET_SPECIAL_DISCOUNTS) {
        return "Configurez le automatique maintenant pour obtenir des remises sp\xe9ciales";
    };
    if (stringKey instanceof Language_Types.SETUP_NOW) {
        return "Configuration maintenant";
    };
    ...
    if (stringKey instanceof Language_Types.NOTIFICATION_FAILED) {
        return "\xc9chec de la notification";
    };
    ...
    if (stringKey instanceof Language_Types.DOWNGRADE_AVAILABLE_ONLY_FOR_AC_VEHICLES) {
        return "L'option de r\xe9trogradation du v\xe9hicule n'est disponible que pour les v\xe9hicules avec climatisation";
    };
    if (stringKey instanceof Language_Types.DOWNGRADING_VEHICLE_WILL_ALLOW_YOU_TO_TAKE_BOTH_1) {
        return "Le d\xe9classement de votre v\xe9hicule vous permettra de prendre ";
    };
    if (stringKey instanceof Language_Types.DOWNGRADING_VEHICLE_WILL_ALLOW_YOU_TO_TAKE_BOTH_2) {
        return "et des trajets en";
    };
    ...
    if (stringKey instanceof Language_Types.GET_READY_FOR_YS_SUBSCRIPTION) {
        return "Pr\xe9parez-vous pour les plans Yatri Sathi !";
    };
    if (stringKey instanceof Language_Types.SIGNUP_EARLY_FOR_SPECIAL_OFFERS) {
        return "Inscrivez-vous t\xf4t pour b\xe9n\xe9ficier d'offres sp\xe9ciales";
    };
    if (stringKey instanceof Language_Types.GUARANTEED_FIXED_PRICE) {
        return "Prix fixe garanti jusqu'au 1er janvier 2025";
    };
    if (stringKey instanceof Language_Types.INTRODUCTORY_OFFER_TO_BE_ANNOUNCED_SOON) {
        return "L'offre de lancement sera bient\xf4t annonc\xe9e !";
    };
    if (stringKey instanceof Language_Types.NO_CHARGES_TILL) {
        return "Aucun frais jusqu'au 31 d\xe9cembre";
    };
    if (stringKey instanceof Language_Types.DO_YOU_WANT_TO_CANCEL) {
        return "Voulez-vous annuler";
    };
    if (stringKey instanceof Language_Types.DO_YOU_WANT_TO_CANCEL_DESC) {
        return "Vous avez d\xe9j\xe0 un plan actif. Voulez-vous annuler le plan actif et rejoindre le nouveau plan ?";
    };
    ...
    if (stringKey instanceof Language_Types.SELECT_LOCATION) {
        return "S\xe9lectionnez l'emplacement";
    };
    if (stringKey instanceof Language_Types.SELECT_LOCATION_DESC) {
        return "S\xe9lectionnez l'endroit o\xf9 vous souhaitez faire des promenades";
    };
    if (stringKey instanceof Language_Types.SELECT_LANGUAGE_DESC) {
        return "S\xe9lectionnez la langue que vous pouvez lire";
    };
    if (stringKey instanceof Language_Types.CONFIRM_LANGUAGE) {
        return "Confirmer la langue";
    };
    if (stringKey instanceof Language_Types.GET_STARTED) {
        return "Commencer";
    };
    if (stringKey instanceof Language_Types.ENTER_YOUR_MOBILE_NUMBER) {
        return "Entrez votre num\xe9ro de portable";
    };
    if (stringKey instanceof Language_Types.NOTIFICATION_ACCESS) {
        return "Acc\xe8s aux notifications";
    };
    if (stringKey instanceof Language_Types.NOTIFICATION_ACCESS_DESC) {
        return "Recommand\xe9, assurez-vous de ne jamais manquer de messages";
    };
    if (stringKey instanceof Language_Types.WATCH_VIDEO) {
        return "Regarder la vid\xe9o";
    };
    if (stringKey instanceof Language_Types.DL_VERIFICATION_FAILED) {
        return "\xc9chec de la v\xe9rification du permis de conduire. Veuillez entrer la date d'\xe9mission et r\xe9essayer";
    };
    if (stringKey instanceof Language_Types.RC_VERIFICATION_FAILED) {
        return "\xc9chec de la v\xe9rification du certificat d'immatriculation. Veuillez entrer la date d'\xe9mission et r\xe9essayer";
    };
    if (stringKey instanceof Language_Types.DL_UPLOAD_FAILED) {
        return "\xc9chec de t\xe9l\xe9chargement du permis de conduire";
    };
    if (stringKey instanceof Language_Types.RC_UPLOAD_FAILED) {
        return "\xc9chec de t\xe9l\xe9chargement du certificat d'immatriculation";
    };
    if (stringKey instanceof Language_Types.PLEASE_RETRY_THE_UPLOAD_AGAIN) {
        return "Veuillez r\xe9essayer le t\xe9l\xe9chargement";
    };
    if (stringKey instanceof Language_Types.RC_AND_DL_UPLOAD_FAILED) {
        return "\xc9chec de t\xe9l\xe9chargement du certificat d'immatriculation et du permis de conduire";
    };
    if (stringKey instanceof Language_Types.RC_UPLOAD_LIMIT_REACHED) {
        return "Limite de t\xe9l\xe9chargement du certificat d'immatriculation atteinte";
    };
    if (stringKey instanceof Language_Types.DL_UPLOAD_LIMIT_REACHED) {
        return "Limite de t\xe9l\xe9chargement du permis de conduire atteinte";
    };
    if (stringKey instanceof Language_Types.RETRY_UPLOAD) {
        return "R\xe9essayer le t\xe9l\xe9chargement";
    };
    if (stringKey instanceof Language_Types.VEHICLE_REGISTERATON_CERTIFICATE) {
        return "Certificat d'immatriculation du v\xe9hicule";
    };
    if (stringKey instanceof Language_Types.GRANT_PERMISSIONS) {
        return "Accorder les autorisations";
    };
    ...
    if (stringKey instanceof Language_Types.COMPLETE_AUTOPAY_LATER) {
        return "Effectuer le paiement automatique complet ult\xe9rieurement depuis la section \xab Mon plan \xbb.";
    };
    if (stringKey instanceof Language_Types.START_EARNING_IN_FOUR_STEPS) {
        return "Commencez \xe0 gagner en {} \xe9tapes simples";
    };
    if (stringKey instanceof Language_Types.COMPLETE) {
        return "Terminer";
    };
    if (stringKey instanceof Language_Types.HOW_TO_UPLOAD) {
        return "Comment t\xe9l\xe9charger";
    };
    if (stringKey instanceof Language_Types.TAKE_CLEAR_PICTURE_DL) {
        return "Prenez une photo claire du c\xf4t\xe9 photo de votre permis de conduire sur une surface plane.";
    };
    if (stringKey instanceof Language_Types.ENSURE_ADEQUATE_LIGHT) {
        return "Assurez-vous que l'\xe9clairage est ad\xe9quat et que tous les d\xe9tails sont clairement visibles";
    };
    if (stringKey instanceof Language_Types.FIT_DL_CORRECTLY) {
        return "Placez correctement le permis de conduire dans la zone indiqu\xe9e, comme illustr\xe9 ci-dessous";
    };
    ...
    if (stringKey instanceof Language_Types.FIT_RC_CORRECTLY) {
        return "Placez correctement le certificat d'immatriculation dans la zone indiqu\xe9e, comme illustr\xe9 ci-dessous";
    };
    if (stringKey instanceof Language_Types.TAKE_CLEAR_PICTURE_RC) {
        return "Prenez une photo claire du c\xf4t\xe9 photo de votre certificat d'immatriculation sur une surface plane.";
    };
    if (stringKey instanceof Language_Types.DL_UPLOADED) {
        return "Permis de conduire t\xe9l\xe9charg\xe9";
    };
    if (stringKey instanceof Language_Types.RC_UPLOADED) {
        return "Certificat d'immatriculation t\xe9l\xe9charg\xe9";
    };
    if (stringKey instanceof Language_Types.DL_UPLOADING) {
        return "T\xe9l\xe9chargement du permis de conduire en cours";
    };
    if (stringKey instanceof Language_Types.RC_UPLOADING) {
        return "T\xe9l\xe9chargement du certificat d'immatriculation en cours";
    };
    if (stringKey instanceof Language_Types.RETAKE_RC) {
        return "\x0aVeuillez reprendre la photo avec le certificat d'immatriculation \xe0 l'int\xe9rieur de la zone indiqu\xe9e";
    };
    if (stringKey instanceof Language_Types.RETAKE_DL) {
        return "\x0aVeuillez reprendre la photo avec le permis de conduire \xe0 l'int\xe9rieur de la zone indiqu\xe9e";
    };
    if (stringKey instanceof Language_Types.CONFIRM_AND_UPLOAD) {
        return "CONFIRMER ET T\xc9L\xc9CHARGER";
    };
    ...
    if (stringKey instanceof Language_Types.UPLOAD_REGISTRATION_CERTIFICATE_STR) {
        return "T\xe9l\xe9charger le certificat d'enregistrement";
    };
    ...
    if (stringKey instanceof Language_Types.GET_FULL_PAYMENT) {
        return "Obtenez un paiement complet";
    };
    if (stringKey instanceof Language_Types.SELECT_CITY_STR) {
        return "S\xe9lectionnez la ville";
    };
    if (stringKey instanceof Language_Types.WE_ARE_NOT_LIVE_IN_YOUR_AREA) {
        return "Nous ne sommes pas encore en direct dans votre r\xe9gion !\x0aBient\xf4t dans votre ville !";
    };
    if (stringKey instanceof Language_Types.LOCATION_UNSERVICEABLE) {
        return "Emplacement inutilisable";
    };
    ...
    if (stringKey instanceof Language_Types.TURN_OFF_ANY_MOCK_LOCATION_APP_AND_RESTART) {
        return "D\xe9sactivez toute application Mock Location que vous utilisez et red\xe9marrez l'application.";
    };
