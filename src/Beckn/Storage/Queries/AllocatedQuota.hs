...
import qualified Beckn.Types.Domain.AllocatedQuota  as Domain
...
dbTable :: B.DatabaseEntity be DB.BecknDb (B.TableEntity Storage.AllocatedQuotaT)
dbTable = DB._allocatedQuota DB.becknDb

findAllocatedQuota :: Text -> L.Flow (T.DBResult (Maybe Domain.AllocatedQuota))
