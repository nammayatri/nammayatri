...
import qualified Beckn.Types.Domain.RegistrationToken  as Domain
...
dbTable :: B.DatabaseEntity be DB.BecknDb (B.TableEntity Storage.RegistrationTokenT)
dbTable = DB._registrationToken DB.becknDb

findRegistrationToken :: Text -> L.Flow (T.DBResult (Maybe Domain.RegistrationToken))
