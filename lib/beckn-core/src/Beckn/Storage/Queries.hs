...
findAllWithLimitOffset dbTable limit offset orderBy =
  runSqlDB $ lift . L.findRows $ B.select $ B.limit_ limit $ B.offset_ offset $ B.orderBy_ orderBy $ B.all_ dbTable
...
findAllWithLimitOffsetWhere dbTable predicate limit offset orderBy =
  runSqlDB $ lift . L.findRows $ B.select $ B.limit_ limit $ B.offset_ offset $ B.filter_ predicate $ B.orderBy_ orderBy $ B.all_ dbTable
...
aggregate ::
  ...
  _aggregator ->
  _predicate ->
  DB.FlowWithDb r [_result]
aggregate dbTable aggregator predicate = runSqlDB $ lift . L.findRows $ B.select $ B.aggregate_ aggregator $ B.filter_ predicate $ B.all_ dbTable
...
findAllByJoin limit offset orderBy =
  runSqlDB . lift . L.findRows . B.select . B.limit_ limit . B.offset_ offset . B.orderBy_ orderBy
...
findAllByJoinWithoutLimits orderBy =
  runSqlDB . lift . L.findRows . B.select . B.orderBy_ orderBy
