module Beckn.Types.Core.Cabs.OnUpdate.OnUpdateEvent.RideStartedEvent where

import Beckn.Types.Core.Cabs.OnUpdate.OnUpdateEvent.OnUpdateEventType (OnUpdateEventType (RIDE_STARTED))
