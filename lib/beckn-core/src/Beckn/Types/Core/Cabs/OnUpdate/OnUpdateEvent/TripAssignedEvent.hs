module Beckn.Types.Core.Cabs.OnUpdate.OnUpdateEvent.TripAssignedEvent
  ( module Beckn.Types.Core.Cabs.OnUpdate.OnUpdateEvent.TripAssignedEvent,
    module Reexport,
  )
where
...
import Beckn.Types.Core.Cabs.OnUpdate.OnUpdateEvent.OnUpdateEventType (OnUpdateEventType (TRIP_ASSIGNED))
