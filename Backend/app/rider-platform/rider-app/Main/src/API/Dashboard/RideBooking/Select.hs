...
callSelect merchantId personId estimateId = do
  ...
  US.select2 (personId, m.id) estimateId $ US.DSelectReq {customerExtraFee = Nothing, customerExtraFeeWithCurrency = Nothing, autoAssignEnabled = False, autoAssignEnabledV2 = Nothing, paymentMethodId = Nothing}
