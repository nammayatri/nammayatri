...
-- | NOTE: depends on the @Kernel.External.FleetEngine.*@ modules from
-- shared-kernel (branch claude/fleet-engine-odrd-sdk); a shared-kernel pin bump
-- is required for this to compile.
