...
updateLocation :: (Id Person.Person, Id Merchant.Merchant) -> DLocation.UpdateLocationReq -> FlowHandler APISuccess
updateLocation (personId, _) = withFlowHandlerAPI . DLocation.updateLocationHandler personId
