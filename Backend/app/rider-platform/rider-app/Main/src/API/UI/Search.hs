...
multiModalSearch searchRequest riderConfig initateJourney req' = do
  ...
  mbSingleModeRouteDetails <- JMU.measureLatency (JMU.getSingleModeRouteDetails searchRequest.routeCode searchRequest.originStopCode searchRequest.destinationStopCode integratedBPPConfig.id searchRequest.merchantId searchRequest.merchantOperatingCityId) "getSingleModeRouteDetails"
