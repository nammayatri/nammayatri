...
getRoute (personId, merchantId, merchantOperatingCityId) = withFlowHandlerAPI . withPersonIdLogTag personId . DRoute.getRoutes (personId, merchantId, merchantOperatingCityId)
...
getPickupRoute (personId, merchantId, merchantOperatingCityId) = withFlowHandlerAPI . withPersonIdLogTag personId . DRoute.getPickupRoutes (personId, merchantId, merchantOperatingCityId)
...
getTripRoute (personId, merchantId, merchantOperatingCityId) = withFlowHandlerAPI . withPersonIdLogTag personId . DRoute.getTripRoutes (personId, merchantId, merchantOperatingCityId)
