...
getInstructionRoute (personId, merchantId) = withFlowHandlerAPI . withPersonIdLogTag personId . DRoute.getInstructionRoute (personId, merchantId) (Just personId.getId)
