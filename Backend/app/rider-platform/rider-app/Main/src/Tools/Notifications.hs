      ...
      body =
        unwords
          [ "Hope you enjoyed your trip with",
            driverName,
            "Total Fare " <> showPriceWithRounding totalFare
          ]
...
notifyFirstRideEvent :: (ServiceFlow m r, EsqDBFlow m r, EsqDBReplicaFlow m r) => Id Person -> BecknConfig.VehicleCategory -> Maybe Text -> Maybe Text -> m ()
