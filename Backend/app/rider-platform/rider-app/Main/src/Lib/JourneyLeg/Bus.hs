...
instance JT.JourneyLeg BusLegRequest m where
  ...
  confirm (BusLegRequestConfirm BusLegRequestConfirmData {..}) = CFRFS.confirm personId merchantId searchId quoteId quantity Nothing skipBooking bookingAllowed Nothing
