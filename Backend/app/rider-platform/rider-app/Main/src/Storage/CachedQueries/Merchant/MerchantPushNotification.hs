...
findMatchingMerchantPN :: (CacheFlow m r, EsqDBFlow m r) => Id MerchantOperatingCity -> Text -> Maybe TripCategory -> Maybe DLanguage.Language -> m (Maybe MerchantPushNotification)
