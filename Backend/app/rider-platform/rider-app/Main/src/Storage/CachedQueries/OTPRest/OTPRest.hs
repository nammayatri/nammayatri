...
getStationByGtfsIdAndStopCode stopCode integratedBPPConfig = IM.withInMemCache [stopCode, integratedBPPConfig.id.getId] $ do
  baseUrl <- MM.getOTPRestServiceReq integratedBPPConfig.merchantId integratedBPPConfig.merchantOperatingCityId
...
getVehicleServiceType integratedBPPConfig vehicleNumber = IM.withInMemCache [integratedBPPConfig.id.getId, vehicleNumber] $ do
  baseUrl <- MM.getOTPRestServiceReq integratedBPPConfig.merchantId integratedBPPConfig.merchantOperatingCityId
