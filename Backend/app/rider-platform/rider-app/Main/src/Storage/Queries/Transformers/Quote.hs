...
fromQuoteDetails quoteDetails =
  let (fareProductType, distanceToNearestDriver, rentalDetailsId, driverOfferId, specialZoneQuoteId) = case quoteDetails of
        ...
        DQ.OneWayDetails details -> (ONE_WAY, Nothing, Nothing, Nothing, Just details.quoteId)
...
toQuoteDetails :: (CoreMetrics m, MonadFlow m, CoreMetrics m, CacheFlow m r, EsqDBFlow m r, MonadReader r m, MonadThrow m) => FareProductType -> Maybe TripCategory -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> m Domain.Types.Quote.QuoteDetails
toQuoteDetails fareProductType mbTripCategory rentalDetailsId meterRideBppQuoteId staticQuoteId driverOfferId specialZoneQuoteId =
  case mbTripCategory of
    Just tripCategory ->
      case tripCategory of
        ...
        OneWay OneWayOnDemandStaticOffer -> getOneWayStaticQuoteDetails staticQuoteId & fromMaybeM (InternalError "No static bpp quote details")
    ...
    Nothing ->
      case fareProductType of
        ONE_WAY -> getOneWayStaticQuoteDetails staticQuoteId & fromMaybeM (InternalError "No static bpp quote details")
  ...
  where
    ...
    getOneWayStaticQuoteDetails mbStaticBppQuoteId = do
