...
findByRideBookingId :: MonadFlow m => Id Booking -> m (Maybe BookingCancellationReason)
...
countCancelledBookingsByBookingIds :: MonadFlow m => [Id Booking] -> CancellationSource -> m Int
