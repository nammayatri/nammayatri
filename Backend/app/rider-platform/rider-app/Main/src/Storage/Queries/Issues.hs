...
import Kernel.Utils.Common (KvDbFlow, MonadTime (..), getCurrentTime)
import qualified Sequelize as Se
import qualified Storage.Beam.Issue as BeamI
import qualified Storage.Beam.Person as BeamP
import qualified Storage.Queries.Person ()

insertIssue :: KvDbFlow m r => Issue -> m ()
insertIssue = createWithKV

findByCustomerId :: KvDbFlow m r => Id Person -> Maybe Int -> Maybe Int -> UTCTime -> UTCTime -> m [(Issue, Person)]
...
updateIssueStatus :: KvDbFlow m r => Text -> Domain.IssueStatus -> m ()
