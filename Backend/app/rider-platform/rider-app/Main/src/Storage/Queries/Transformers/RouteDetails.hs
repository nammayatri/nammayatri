        ...
        { gtfsId = RD.routeGtfsId rd,
          ...
          startLocation =
            LocationV2
              { latLng =
                  LatLngV2
                    { latitude = fromMaybe 0.0 (RD.startLocationLat rd), --RD.startLocationLat rd,
                      longitude = fromMaybe 0.0 (RD.startLocationLon rd) --RD.startLocationLon rd
                    }
              },
          endLocation =
            LocationV2
              { latLng =
                  LatLngV2
                    { latitude = fromMaybe 0.0 (RD.endLocationLat rd), --RD.endLocationLat rd,
                      longitude = fromMaybe 0.0 (RD.endLocationLon rd) --RD.endLocationLon rd
                    }
              },
