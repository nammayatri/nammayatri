      ...
      Just $
        Merchant
          { id = Id id,
            ...
            editPickupDistanceThreshold = mkDistanceWithDefault distanceUnit editPickupDistanceThresholdValue editPickupDistanceThreshold,
            driverDistanceThresholdFromPickup = mkDistanceWithDefault distanceUnit driverDistanceThresholdFromPickupValue driverDistanceThresholdFromPickup,
            ...
            arrivedPickupThreshold = maybe (Distance 50 Meter) (mkDistanceWithDefaultMeters distanceUnit arrivedPickupThresholdValue) arrivedPickupThreshold,
