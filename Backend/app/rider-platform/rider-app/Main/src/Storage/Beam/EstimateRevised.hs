...
data EstimateRevisedT f = EstimateRevisedT
  { id :: B.C f Text,
    ...
    bppEstimateRevisedId :: B.C f Text,
    itemId :: B.C f Text,
...
$(enableKVPG ''EstimateRevisedT ['id] [['requestId], ['bppEstimateRevisedId]])

$(mkTableInstancesWithTModifier ''EstimateRevisedT "estimate_revised" [("oldNightShiftCharge", "night_shift_multiplier")])
