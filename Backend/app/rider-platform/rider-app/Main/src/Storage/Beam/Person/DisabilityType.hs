...
data DisabilityTypeT f = DisabilityTypeT
  { id :: B.C f Text,
    ...
    onBookingMessage :: B.C f (Maybe Text),
    onArrivalMessage :: B.C f (Maybe Text),
    onRideStartMessage :: B.C f (Maybe Text),
...
disabilityTypeTMod =
  B.tableModification
    { id = B.fieldNamed "id",
      ...
      onBookingMessage = B.fieldNamed "booking_message",
      onArrivalMessage = B.fieldNamed "arrival_message",
      onRideStartMessage = B.fieldNamed "ride_message",
