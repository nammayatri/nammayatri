...
import Storage.Beam.PassOrganization (PassOrganizationT, passOrganizationTable)
  ...
  B.defaultDbSettings
    `B.withDbModification` B.dbModification
      { exophone = exophoneTable,
        ...
        rating = ratingTable,
        passOrganization = passOrganizationTable
      }
...
data AtlasDB f = AtlasDB
  { exophone :: f (B.TableEntity ExophoneT),
    ...
    passOrganization :: f (B.TableEntity PassOrganizationT)
  }
