...
data AppCfg = AppCfg
  { esqDBCfg :: EsqDBConfig,
    ...
    cloudSwitchPassword :: Maybe Text,
    ...
    -- Per-operator limit on the dashboard routes this server serves directly.
    ...
    -- lib-dashboard's Domain.Action.Dashboard.* handlers.
    ...
    passSelectAPIRateLimitOptions :: APIRateLimitOptions,
