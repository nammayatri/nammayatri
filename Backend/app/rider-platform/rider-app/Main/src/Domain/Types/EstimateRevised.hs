...
data EstimateRevised = EstimateRevised
  { id :: Id EstimateRevised,
    ...
    bppEstimateRevisedId :: Id BPPEstimateRevised,
    estimatedFare :: Money,
    ...
    estimateRevisedBreakupList :: [EstimateRevisedBreakup],
...
data EstimateRevisedBreakup = EstimateRevisedBreakup
  { id :: Id EstimateRevisedBreakup,
    estimateRevisedId :: Id EstimateRevised,
    title :: Text,
    price :: EstimateRevisedBreakupPrice
  }
  deriving (Generic, FromJSON, ToJSON, Show, PrettyShow, ToSchema)

data EstimateRevisedBreakupPrice = EstimateRevisedBreakupPrice
  { currency :: Text,
    value :: Money
  }
  deriving (Generic, FromJSON, ToJSON, Show, PrettyShow, ToSchema)
...
mkEstimateAPIEntity :: EstimateRevised -> EstimateAPIEntity
mkEstimateAPIEntity EstimateRevised {..} = do
  EstimateAPIEntity
    { agencyName = providerName,
      ...
      estimateFareBreakup = mkEstimateBreakupAPIEntity <$> estimateRevisedBreakupList,
...
mkEstimateBreakupAPIEntity :: EstimateRevisedBreakup -> EstimateBreakupAPIEntity
mkEstimateBreakupAPIEntity EstimateRevisedBreakup {..} = do
