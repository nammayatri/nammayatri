...
findOrCreatePersonForDirectBooking merchantId req = do
  ...
  case existingPerson of
    ...
    Nothing -> do
      ...
      person <- Registration.createPerson authReq Domain.Types.Person.MOBILENUMBER Nothing Nothing Nothing Nothing Nothing Nothing merchant Nothing Nothing
      return person.id
...
postTicketDashboardRegister merchant req = do
  ...
  case personOpt of
    ...
    Nothing -> do
      ...
      person <- Registration.buildPerson authReq Domain.Types.Person.MOBILENUMBER Nothing Nothing Nothing Nothing Nothing Nothing merchant merchant.defaultCity merchantOperatingCityId Nothing Nothing
