  ...
  let milestone =
        DIJM.IncentiveJourneyMilestone
          { id = milestoneId,
            ...
            subscriptionWaiveOffPercentage = (.percentage) <$> req.subscriptionWaiveOff,
            subscriptionWaiveOffDaysValidFor = (.daysValidFor) <$> req.subscriptionWaiveOff,
            subscriptionWaiveOffServiceName = (.serviceName) <$> req.subscriptionWaiveOff,
            subscriptionWaiveOffMode = (.waiveOffMode) <$> req.subscriptionWaiveOff,
  ...
  let updated =
        milestone
          { DIJM.name = maybe milestone.name Just req.name,
            ...
            DIJM.subscriptionWaiveOffPercentage = maybe milestone.subscriptionWaiveOffPercentage (Just . (.percentage)) req.subscriptionWaiveOff,
            DIJM.subscriptionWaiveOffDaysValidFor = maybe milestone.subscriptionWaiveOffDaysValidFor (Just . (.daysValidFor)) req.subscriptionWaiveOff,
            DIJM.subscriptionWaiveOffServiceName = maybe milestone.subscriptionWaiveOffServiceName (Just . (.serviceName)) req.subscriptionWaiveOff,
            DIJM.subscriptionWaiveOffMode = maybe milestone.subscriptionWaiveOffMode (Just . (.waiveOffMode)) req.subscriptionWaiveOff,
    ...
    { milestoneId = ID.cast milestone.id,
      ...
      subscriptionWaiveOff =
        Common.SubscriptionWaiveOffConfig
          <$> milestone.subscriptionWaiveOffPercentage
          <*> milestone.subscriptionWaiveOffDaysValidFor
          <*> milestone.subscriptionWaiveOffServiceName
          <*> milestone.subscriptionWaiveOffMode,
