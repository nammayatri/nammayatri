      ...
      whenJust booking.journeyId $ \journeyId -> do
        ...
        forM_ allLegsInfo $ \journeyLegInfo -> do
          case journeyLegInfo.travelMode of
            DTrip.Walk -> JM.markLegStatus JL.Cancelled journeyLegInfo.legExtraInfo journeyId journeyLegInfo.order Nothing
            DTrip.Taxi -> JM.markLegStatus JL.Cancelled journeyLegInfo.legExtraInfo journeyId journeyLegInfo.order Nothing
            _ -> do
