...
postPassCustomerPassUpdateProfilePicture _merchantShortId _opCity _personId purchasedPassId req = do
  DPass.postMultimodalPassUpdateProfilePictureUtil purchasedPassId req.profilePicture
