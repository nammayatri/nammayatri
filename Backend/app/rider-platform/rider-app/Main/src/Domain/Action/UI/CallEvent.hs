...
logCallEvent :: (KvDbFlow m r, EsqDBReplicaFlow m r, EventStreamFlow m r, CacheFlow m r) => CallEventReq -> m APISuccess.APISuccess
...
sendCallDataToKafka :: (KvDbFlow m r, EsqDBReplicaFlow m r, EventStreamFlow m r, CacheFlow m r) => Maybe Text -> Maybe (Id Ride.Ride) -> Maybe Text -> Maybe Text -> Maybe Text -> EventTriggeredBy -> Maybe Text -> m ()
