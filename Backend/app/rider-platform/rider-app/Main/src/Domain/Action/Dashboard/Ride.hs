  ...
  return $
    Common.ShareRideInfoRes
      { id = cast ride.id,
        ...
        estimatedDistanceWithUnit = convertHighPrecMetersToDistance ride.distanceUnit <$> mbDistance,
  ...
  pure
    Common.RideInfoRes
      { rideId = reqRideId,
        ...
        rideDistanceEstimatedWithUnit = convertHighPrecMetersToDistance ride.distanceUnit <$> mbDistance,
        ...
        chargeableDistanceWithUnit = convertHighPrecMetersToDistance ride.distanceUnit <$> ride.chargeableDistance,
