...
postMultimodalConfirm (_mbPersonId, _merchantId) journeyId forcedBookLegOrder mbIsMockPayment mbSkipCreateOrderCall journeyConfirmReq =
  withTimeAPI "multimodalConfirm" "total" $ do
