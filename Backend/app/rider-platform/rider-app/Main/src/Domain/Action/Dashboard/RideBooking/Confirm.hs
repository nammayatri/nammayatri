...
postConfirmRideSearchQuotes merchantShortId _opCity personId quoteId mbPaymentMethodId = do
  m <- findMerchantByShortId merchantShortId
  API.UI.Confirm.confirm' (personId, m.id) quoteId mbPaymentMethodId
