...
getTaggedEstimate autoQar cabQar autoPrice nonACPrice userType localTime mocId estimate = do
  ...
  response <- withTryCatch "runLogics:EstimateTags" $ LYDL.runLogicsWithDebugLog LYDL.Rider (cast mocId) LYT.ESTIMATE_TAGS (Nothing :: Maybe Text) allLogics logicInput
