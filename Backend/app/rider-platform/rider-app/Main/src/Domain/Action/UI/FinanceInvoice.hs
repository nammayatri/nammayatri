    ...
    then case (mbInvoiceId, mbInvoiceType, mbReferenceId) of
      ...
      invoices <- case mbInvoiceId of
        ...
        Nothing -> case (mbInvoiceType, mbReferenceId) of
          (Just Ride, Just rideId) -> QInvoiceExtra.findByReferenceIdWithOptions rideId (Just Ride) Nothing [Draft, Issued, Paid] (Just 1) (Just 0)
          (Just RideCancellation, Just rideId) -> QInvoiceExtra.findByReferenceIdWithOptions rideId (Just RideCancellation) Nothing [Draft, Issued, Paid] (Just 1) (Just 0)
