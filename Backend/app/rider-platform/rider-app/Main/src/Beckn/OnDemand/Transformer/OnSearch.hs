    ...
    QuoteBased _ -> do
      ...
      quoteDetails_ <-
        case tripCategory of
          ...
          OneWay OneWayOnDemandStaticOffer -> pure $ Domain.Action.Beckn.OnSearch.OneWayDetails (Domain.Action.Beckn.OnSearch.OneWayQuoteDetails {quoteId = quoteOrEstId_})
