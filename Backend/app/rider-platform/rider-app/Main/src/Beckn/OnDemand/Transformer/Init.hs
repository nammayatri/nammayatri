...
tfOrder uiConfirm isValueAddNP bapConfig riderConfig = do
  ...
  let orderPayments_ = Beckn.OnDemand.Utils.Init.mkPayment uiConfirm.paymentInstrument uiConfirm.paymentMethodInfo bapConfig riderConfig uiConfirm.city uiConfirm.isStripe & Just
