...
buildSearchReq ::
  ...
  Maybe Bool ->
  m (BecknReq Search.SearchMessage)
buildSearchReq origin destination searchId _ distance duration customerLanguage disabilityTag merchant city mbPoints mbPhoneNumber mbIsReallocationEnabled = do
