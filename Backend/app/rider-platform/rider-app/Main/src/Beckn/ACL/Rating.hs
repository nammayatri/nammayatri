...
buildRatingReq DFeedback.FeedbackRes {..} = do
  ...
  context <- buildTaxiContext Context.RATING msgId transactionId merchant.bapId bapUrl (Just providerId) (Just providerUrl) merchant.city merchant.country False Nothing
  let message =
