...
buildRatingReq DFeedback.FeedbackRes {..} = do
  ...
  context <- buildContext Context.MOBILITY Context.RATING msgId (Just transactionId) merchant.bapId bapUrl (Just providerId) (Just providerUrl) merchant.defaultCity merchant.country False
  let message =
