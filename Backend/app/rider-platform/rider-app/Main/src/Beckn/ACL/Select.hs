...
buildSelectReq dSelectRes = do
  ...
  context <- buildTaxiContext Context.SELECT messageId (Just transactionId) dSelectRes.merchant.bapId bapUrl (Just dSelectRes.providerId) (Just dSelectRes.providerUrl) dSelectRes.merchantConfig.city dSelectRes.merchantConfig.country dSelectRes.autoAssignEnabled
