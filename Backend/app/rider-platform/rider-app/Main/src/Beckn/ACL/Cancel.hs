...
buildCancelReq res = do
  ...
  context <- buildTaxiContext Context.CANCEL messageId Nothing bapIDs.cabs bapURIs.cabs (Just res.bppId) (Just res.bppUrl) res.city
...
buildCancelSearchReq res = do
  ...
  context <- buildTaxiContext Context.CANCEL messageId Nothing bapIDs.cabs bapURIs.cabs (Just res.providerId) (Just res.providerUrl) res.city
