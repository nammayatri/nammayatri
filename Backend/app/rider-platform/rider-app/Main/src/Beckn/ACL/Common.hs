...
parseRideCompletedEvent order msgId txnId = do
  ...
  let totalFare = fare
      ...
      stateEntryPermitConfidence :: Maybe Confidence = readMaybe . T.unpack =<< getTagV2' Tag.STATE_ENTRY_PERMIT_CONFIDENCE_INFO Tag.STATE_ENTRY_PERMIT_CONFIDENCE tagGroups
