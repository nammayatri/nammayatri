...
castTicketStatus "UNCLAIMED" _ True Spec.METRO = return Ticket.INPROGRESS -- True means unsolicited on_status received
castTicketStatus "CLAIMED" _ _ Spec.METRO = return Ticket.USED
castTicketStatus "UNCLAIMED" _ True Spec.BUS = return Ticket.USED
