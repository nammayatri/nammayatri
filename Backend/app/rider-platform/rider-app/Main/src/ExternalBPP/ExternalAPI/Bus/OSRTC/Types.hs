...
import Data.Aeson (Value, defaultOptions, genericToEncoding)
...
data OSRTCSeatInfo = OSRTCSeatInfo
  { col :: Int,
    ...
    seatSrNo :: Int,
    seatCode :: Text,
    quotaCode :: OSRTCEnums.OSRTCQuota,
    seatStatusCode :: Text,
    strColorCode :: Text,
    isAvailable :: Bool,
    ...
    minFare :: Double,
    netFare :: Double,
    seatTypeID :: OSRTCEnums.OSRTCSeatType,
...
instance FromJSON OSRTCSeatInfo where
  parseJSON = genericParseJSON osrtcSeatInfoJSONOptions
...
data OSRTCFareCalcRes = OSRTCFareCalcRes
  { lstFinalFare :: [OSRTCFareComponent],
    ...
    intTotalDiscount :: Double,
    intConcessionAmount :: Double,
