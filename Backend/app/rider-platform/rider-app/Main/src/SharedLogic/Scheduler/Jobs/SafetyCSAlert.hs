  ...
  ticketId <- do
    case ticketResponse of
      ...
      Left err -> do
        ...
        return Nothing
  sosDetails <- buildSosDetails person SosReq {flow = DSos.CSAlertSosTicket, rideId = ride.id, isRideEnded = Nothing, notifyAllContacts = Nothing, customerLocation = Nothing} ticketId
