...
sendCommunicationToCustomer SendCommunicationToCustomerReq {..} = do
  ...
  case notificationType of
    ...
    SMS -> do
      ...
      Sms.sendSMS person.merchantId merchantOperatingCityId (Sms.SendSMSReq smsReqBody phoneNumber sender (Just merchantMessage.templateId)) -- TODO: append SMS heading
        >>= Sms.checkSmsResult
    _ -> pure ()
  where
