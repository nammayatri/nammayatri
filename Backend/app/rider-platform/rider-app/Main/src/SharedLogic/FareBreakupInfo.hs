...
upsertFareBreakupInfo entityId entityType items mbMerchantId mbMocId =
  Redis.withWaitAndLockMasterCloudCrossAppRedis "Redis" "upsertFareBreakupInfoLockWait" (upsertLockKey entityId entityType) 10 100 $ do
...
addFareBreakupInfoItems entityId entityType newItems mbMerchantId mbMocId =
  Redis.withWaitAndLockMasterCloudCrossAppRedis "Redis" "addFareBreakupInfoItemsLockWait" (upsertLockKey entityId entityType) 10 100 $ do
    mbExisting <- QFareBreakupInfo.findByEntityIdAndEntityType entityId entityType
    case mbExisting of
