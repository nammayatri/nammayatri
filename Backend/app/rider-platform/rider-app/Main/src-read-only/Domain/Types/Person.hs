    ...
    pure
      Person
        { aadhaarVerified = aadhaarVerified entity,
          ...
          bundleVersion = bundleVersion entity,
          clientVersion = clientVersion entity,
...
data IdentifierType = MOBILENUMBER | AADHAAR | EMAIL deriving (Show, (Eq), (Read), (Ord), (Generic), (ToJSON), (FromJSON), ToParamSchema)
