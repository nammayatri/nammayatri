...
data SosType = Police | AudioRecording | CustomerCare | EmergencyContact Domain.Types.Sos.EmergencyContactId | SafetyFlow deriving (Eq, Ord, Show, Read, Generic, ToJSON, FromJSON, ToSchema)
