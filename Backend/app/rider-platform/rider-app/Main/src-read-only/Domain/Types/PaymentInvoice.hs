...
data PaymentInvoice = PaymentInvoice
  { amount :: Kernel.Types.Common.HighPrecMoney,
    ...
    paymentMethod :: Domain.Types.Extra.MerchantPaymentMethod.PaymentInstrument,
...
data InvoicePaymentStatus = PENDING | CAPTURED | FAILED deriving (Show, Eq, Ord, Read, Generic, ToJSON, FromJSON, ToSchema)
