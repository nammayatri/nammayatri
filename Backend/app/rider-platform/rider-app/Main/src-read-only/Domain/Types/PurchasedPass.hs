...
data PurchasedPass
    = PurchasedPass {applicableVehicleServiceTiers :: [BecknV2.FRFS.Enums.ServiceTierType],
...
data StatusType
    = Pending | Active | PreBooked | Failed | Expired | RefundPending | RefundInitiated | Refunded | RefundFailed | PhotoPending
