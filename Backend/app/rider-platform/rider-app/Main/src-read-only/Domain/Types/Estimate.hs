...
data Estimate
    = Estimate {backendAppVersion :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
data EstimateBreakup
    = EstimateBreakup {estimateId :: Kernel.Types.Id.Id Domain.Types.Estimate.Estimate,
...
data NightShiftInfo
    = NightShiftInfo {nightShiftCharge :: Kernel.Types.Common.Price,
