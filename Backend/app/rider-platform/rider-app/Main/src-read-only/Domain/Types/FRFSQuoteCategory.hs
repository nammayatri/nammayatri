...
data FRFSQuoteCategory
    = FRFSQuoteCategory {bppItemId :: Kernel.Prelude.Text,
...
data QuoteCategoryMetadata
    = QuoteCategoryMetadata {categoryOrder :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
