...
data TicketPlace
    = TicketPlace {allowSameDayBooking :: Kernel.Prelude.Bool,
...
data PlaceType
    = Museum | ThemePark | AmusementPark | WaterPark | WildLifeSanctuary | ArtGallery | HeritageSite | ReligiousSite | Boating | Other
