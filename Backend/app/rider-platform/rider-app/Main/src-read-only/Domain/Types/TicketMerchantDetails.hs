...
data TicketMerchantDetailsE e
    = TicketMerchantDetails {agreementLetter :: Kernel.Prelude.Maybe (Kernel.External.Encryption.EncryptedHashedField e Kernel.Prelude.Text),
...
instance EncryptedItem TicketMerchantDetails
    where type Unencrypted TicketMerchantDetails = (DecryptedTicketMerchantDetails, HashSalt)
          encryptItem (entity, salt) = do {agreementLetter_ <- encryptItem $ (, salt) <$> agreementLetter entity;
                                           ...
                                           pure TicketMerchantDetails{agreementLetter = agreementLetter_,
          ...
          decryptItem entity = do {agreementLetter_ <- fmap fst <$> decryptItem (agreementLetter entity);
                                   ...
                                   pure (TicketMerchantDetails{agreementLetter = agreementLetter_,
                                         ...
                                         "")}
instance EncryptedItem' TicketMerchantDetails
    where type UnencryptedItem TicketMerchantDetails = DecryptedTicketMerchantDetails
