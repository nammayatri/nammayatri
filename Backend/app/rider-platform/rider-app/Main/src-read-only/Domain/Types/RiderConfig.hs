...
data RiderConfig = RiderConfig
  { alwaysAllowedNotificationCategories :: [Domain.Types.Extra.RiderPreferences.NotificationCategory],
    ...
    betterPointMaxWalkPctOfRideAtDrop :: Kernel.Prelude.Maybe Kernel.Prelude.Double,
    ...
    boardingMaxBookingStartDriftSeconds :: Kernel.Prelude.Maybe Kernel.Prelude.Double,
    ...
    enableEditLocationWithoutRide :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
    ...
    enableMetroFrfsSearch :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
    ...
    frfsDriverDetailsLeadTimeSeconds :: Kernel.Prelude.Maybe Kernel.Types.Common.Seconds,
    ...
    immediateCaptureRiderCancellationFee :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
    ...
    maxWalkDistanceForBetterPoint :: Kernel.Prelude.Maybe Kernel.Types.Common.Meters,
    maxWalkDistanceForBetterPointAtDrop :: Kernel.Prelude.Maybe Kernel.Types.Common.Meters,
    ...
    nonAllowedOverrideFleetNoServiceTiers :: Kernel.Prelude.Maybe [BecknV2.FRFS.Enums.ServiceTierType],
