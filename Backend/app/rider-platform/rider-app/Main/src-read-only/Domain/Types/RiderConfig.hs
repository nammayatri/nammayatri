...
data RiderConfig = RiderConfig
  { appUrl :: Kernel.Prelude.Text,
    ...
    ivrTriggerExpireTime :: Kernel.Prelude.NominalDiffTime,
    ...
    policeTriggerExpireTime :: Kernel.Prelude.NominalDiffTime,
    ...
    scheduledRidePopupToRiderExpireTime :: Kernel.Prelude.NominalDiffTime,
