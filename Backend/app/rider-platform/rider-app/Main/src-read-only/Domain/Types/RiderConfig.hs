...
data StudentPassVerifyConfig = StudentPassVerifyConfig
  { activationLimit :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    distanceThresholdMeters :: Kernel.Types.Common.Meters,
    minMatchingStops :: Kernel.Prelude.Int,
    validityDurationDays :: Kernel.Prelude.Int
  }
  deriving (Generic, Show, ToJSON, FromJSON, ToSchema, Eq)
