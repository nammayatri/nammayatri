...
data RiderConfig
    = RiderConfig {appUrl :: Kernel.Prelude.Text,
                   ...
                   chatRateLimitMaxRequests :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                   chatRateLimitWindowSeconds :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                   ...
                   enableCustomerCancellationRateBlocking :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
                   ...
                   metroFareCachingAllowed :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
                   metroTicketAllowed :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
                   ...
                   monthlyMinRidesForNudging :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                   monthlyOffenceSuspensionTimeHours :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                   ...
                   seatBookingTtl :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
...
data BusTrackingConfig
    = BusTrackingConfig {fairScore :: Kernel.Prelude.Double,
...
data ExternalSOSConfig
    = ExternalSOSConfig {flow :: Domain.Types.RiderConfig.ExternalSOSFlow,
...
data RingBucketCfg
    = RingBucketCfg {radiusInMeters :: Kernel.Types.Common.Meters, size :: Kernel.Prelude.Int, vehVariant :: Domain.Types.VehicleVariant.VehicleVariant}
    deriving (Generic, Show, ToJSON, FromJSON, ToSchema, Eq)
data ServiceTierRelationshipCfg
    = ServiceTierRelationshipCfg {canBoardIn :: [BecknV2.FRFS.Enums.ServiceTierType], serviceTierType :: BecknV2.FRFS.Enums.ServiceTierType, vehicleType :: BecknV2.OnDemand.Enums.VehicleCategory}
    deriving (Generic, Show, ToJSON, FromJSON, ToSchema, Eq)
data ServiceTierSource = NANDI | QUOTES deriving (Eq, Ord, Show, Read, Generic, ToJSON, FromJSON, ToSchema)
data SpecialVehicleNotificationConfig
    = SpecialVehicleNotificationConfig {notificationMessage :: Kernel.Prelude.Text, notificationTitle :: Kernel.Prelude.Text, vehicleNo :: Kernel.Prelude.Text}
    deriving (Generic, Show, ToJSON, FromJSON, ToSchema, Eq)
