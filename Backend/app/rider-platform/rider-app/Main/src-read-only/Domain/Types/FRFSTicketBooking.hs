...
data FRFSTicketBooking = FRFSTicketBooking
  { _type :: Domain.Types.FRFSQuote.FRFSQuoteType,
    ...
    bppPaymentId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    parentBookingId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Domain.Types.FRFSTicketBooking.FRFSTicketBooking),
