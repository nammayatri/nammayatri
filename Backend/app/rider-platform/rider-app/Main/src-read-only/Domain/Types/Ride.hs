...
data RideE e
    = Ride {allowedEditLocationAttempts :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
...
instance EncryptedItem Ride
    where type Unencrypted Ride = (DecryptedRide, HashSalt)
          encryptItem (entity, salt) = do {driverAlternateNumber_ <- encryptItem $ (, salt) <$> driverAlternateNumber entity;
                                           driverPhoneNumber_ <- encryptItem $ (, salt) <$> driverPhoneNumber entity;
                                           pure Ride{allowedEditLocationAttempts = allowedEditLocationAttempts entity,
                                                     ...
                                                     discountAmount = discountAmount entity,
                                                     ...
                                                     id = id entity,
                                                     insuredAmount = insuredAmount entity,
                                                     ...
                                                     payoutAmount = payoutAmount entity,
          ...
          decryptItem entity = do {driverAlternateNumber_ <- fmap fst <$> decryptItem (driverAlternateNumber entity);
                                   ...
                                   pure (Ride{allowedEditLocationAttempts = allowedEditLocationAttempts entity,
                                         ...
                                         "")}
instance EncryptedItem' Ride
    where type UnencryptedItem Ride = DecryptedRide
...
data SosJourneyStatus
    = Safe | UnexpectedCondition Domain.Types.Ride.UnexpectedConditionStage | IVRCallInitiated | CSAlerted | PoliceMonitoring
