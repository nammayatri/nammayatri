    ...
    pure
      Ride
        { allowedEditLocationAttempts = allowedEditLocationAttempts entity,
          ...
          cancellationFeeImmediateCapture = cancellationFeeImmediateCapture entity,
          ...
          otp = otp entity,
          paymentCharge = paymentCharge entity,
          paymentChargeBearer = paymentChargeBearer entity,
