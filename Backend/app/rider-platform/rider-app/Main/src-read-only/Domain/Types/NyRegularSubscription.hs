...
data NyRegularSubscription = NyRegularSubscription
  { bppId :: Kernel.Prelude.Text,
    ...
    fixedPriceExpiryDate :: Kernel.Prelude.Maybe Kernel.Prelude.UTCTime,
    ...
    pauseEndDate :: Kernel.Prelude.Maybe Kernel.Prelude.UTCTime,
    pauseStartDate :: Kernel.Prelude.Maybe Kernel.Prelude.UTCTime,
    ...
    startDatetime :: Kernel.Prelude.UTCTime,
