...
data Booking
    = Booking {backendAppVersion :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
data BookingDetails
    ...
    deriving (Generic, Show, FromJSON, ToJSON)
data DeliveryBookingDetails
    = DeliveryBookingDetails {distance :: Kernel.Types.Common.Distance,
    ...
    deriving (Generic, Show, FromJSON, ToJSON)
data InterCityBookingDetails
    = InterCityBookingDetails {distance :: Kernel.Types.Common.Distance,
                               otpCode :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                               stops :: [Domain.Types.Location.Location],
                               toLocation :: Domain.Types.Location.Location}
    deriving (Generic, Show, FromJSON, ToJSON)
data MeterRideBookingDetails
    = MeterRideBookingDetails {distanceCovered :: Kernel.Prelude.Maybe Kernel.Types.Common.Distance, toLocation :: Kernel.Prelude.Maybe Domain.Types.Location.Location}
    deriving (Generic, Show, FromJSON, ToJSON)
data OneWayBookingDetails
    = OneWayBookingDetails {distance :: Kernel.Types.Common.Distance,
                            isUpgradedToCab :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
                            stops :: [Domain.Types.Location.Location],
                            toLocation :: Domain.Types.Location.Location}
    deriving (Generic, Show, FromJSON, ToJSON)
data OneWaySpecialZoneBookingDetails
    = OneWaySpecialZoneBookingDetails {distance :: Kernel.Types.Common.Distance,
                                       otpCode :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                                       stops :: [Domain.Types.Location.Location],
                                       toLocation :: Domain.Types.Location.Location}
    deriving (Generic, Show, FromJSON, ToJSON)
data RentalBookingDetails
    = RentalBookingDetails {otpCode :: Kernel.Prelude.Maybe Kernel.Prelude.Text, stopLocation :: Kernel.Prelude.Maybe Domain.Types.Location.Location}
    deriving (Generic, Show, FromJSON, ToJSON)
