...
data SearchRequest = SearchRequest
  { allJourneysLoaded :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
    ...
    betterPointRideDistanceSaved :: Kernel.Prelude.Maybe Kernel.Types.Common.Meters,
    betterPointWalkFromDrop :: Kernel.Prelude.Maybe Kernel.Types.Common.Meters,
    betterPointWalkToPickup :: Kernel.Prelude.Maybe Kernel.Types.Common.Meters,
    ...
    hasBetterPointSuggestion :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
    ...
    negativeFareAdjustment :: Kernel.Prelude.Maybe Kernel.Types.Common.Price,
    ...
    parentSearchRequestId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Domain.Types.SearchRequest.SearchRequest),
