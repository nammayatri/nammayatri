...
module Domain.Types.PersonPTStats where
...
data PersonPTStats = PersonPTStats
  { createdAt :: Kernel.Prelude.UTCTime,
    id :: Kernel.Types.Id.Id Domain.Types.PersonPTStats.PersonPTStats,
    ...
    staticPersonId :: Kernel.Prelude.Text,
