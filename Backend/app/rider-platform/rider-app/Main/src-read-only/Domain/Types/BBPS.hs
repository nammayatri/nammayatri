...
data BBPS
    = BBPS {amount :: Kernel.Types.Common.HighPrecMoney,
...
data BBPSPaymentStatus
    = NEW | PENDING | SUCCESS | FAILED | REFUND_PENDING | REFUND_INITIATED | REFUND_FAILED | REFUNDED | CONFIRMATION_PENDING | CONFIRMATION_FAILED | AWAITING_BBPS_CONFIRMATION
