...
data MerchantD (s :: UsageSafety) = Merchant
  { aadhaarKeyExpiryTime :: Kernel.Types.Common.Seconds,
    ...
    arrivedPickupThreshold :: Kernel.Types.Common.Meters,
    arrivingPickupThreshold :: Kernel.Types.Common.Meters,
    ...
    driverDistanceThresholdFromPickup :: Kernel.Types.Common.HighPrecMeters,
    ...
    editPickupDistanceThreshold :: Kernel.Types.Common.HighPrecMeters,
