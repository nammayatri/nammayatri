...
data Quote
    = Quote {backendAppVersion :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
data OneWayQuoteAPIDetails
    = OneWayQuoteAPIDetails {distanceToNearestDriver :: Kernel.Types.Common.HighPrecMeters,
...
data OneWaySpecialZoneQuoteAPIDetails
    = OneWaySpecialZoneQuoteAPIDetails {distanceToNearestDriver :: Kernel.Types.Common.HighPrecMeters, quoteId :: Kernel.Prelude.Text}
    deriving (Generic, Show, ToJSON, FromJSON, ToSchema)
