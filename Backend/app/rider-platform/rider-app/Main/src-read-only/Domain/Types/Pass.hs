...
data Pass
    = Pass {amount :: Kernel.Types.Common.HighPrecMoney,
...
data Benefit
    = FullSaving | FixedSaving Kernel.Types.Common.HighPrecMoney | PercentageSaving Kernel.Types.Common.HighPrecMoney
