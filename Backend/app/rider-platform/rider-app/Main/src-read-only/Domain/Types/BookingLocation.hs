...
data BookingLocation
    = BookingLocation {address :: Domain.Types.LocationAddress.LocationAddress,
...
data BookingLocationAPIEntity
    = BookingLocationAPIEntity {area :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
