...
data RouteDetails
    = RouteDetails {agencyGtfsId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
data AvailableRoutesByTier
    = AvailableRoutesByTier {alsoValidServiceTypes :: Kernel.Prelude.Maybe [BecknV2.FRFS.Enums.ServiceTierType],
    ...
    deriving (Generic, Show, ToJSON, FromJSON, ToSchema)
data AvailableRoutesInfo
    = AvailableRoutesInfo {isLiveTrackingAvailable :: Kernel.Prelude.Bool,
