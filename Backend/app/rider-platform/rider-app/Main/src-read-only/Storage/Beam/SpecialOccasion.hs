...
data SpecialOccasionT f
    = SpecialOccasionT {businessHours :: (B.C f [Kernel.Prelude.Text]),
...
instance B.Table SpecialOccasionT
    where data PrimaryKey SpecialOccasionT f = SpecialOccasionId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
