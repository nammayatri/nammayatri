...
data MerchantServiceUsageConfigT f = MerchantServiceUsageConfigT
  { aadhaarVerificationService :: B.C f Kernel.External.AadhaarVerification.AadhaarVerificationService,
    ...
    autoCompletePriorityList :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Maps.Types.MapsService]),
    ...
    getDistancesForCancelRidePriorityList :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Maps.Types.MapsService]),
    getDistancesForScheduledRides :: B.C f Kernel.External.Maps.Types.MapsService,
    getDistancesForScheduledRidesPriorityList :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Maps.Types.MapsService]),
    getDistancesPriorityList :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Maps.Types.MapsService]),
    getExophone :: B.C f Kernel.External.Call.Types.CallService,
    getPickupRoutes :: B.C f Kernel.External.Maps.Types.MapsService,
    getPickupRoutesPriorityList :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Maps.Types.MapsService]),
    getPlaceDetails :: B.C f Kernel.External.Maps.Types.MapsService,
    getPlaceDetailsPriorityList :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Maps.Types.MapsService]),
    getPlaceName :: B.C f Kernel.External.Maps.Types.MapsService,
    getPlaceNamePriorityList :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Maps.Types.MapsService]),
    getRoutes :: B.C f Kernel.External.Maps.Types.MapsService,
    getRoutesPriorityList :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Maps.Types.MapsService]),
    getTripRoutes :: B.C f Kernel.External.Maps.Types.MapsService,
    getTripRoutesPriorityList :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Maps.Types.MapsService]),
