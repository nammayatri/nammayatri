...
data DepotManagerT f
    = DepotManagerT {createdAt :: (B.C f Kernel.Prelude.UTCTime),
...
instance B.Table DepotManagerT
    where data PrimaryKey DepotManagerT f = DepotManagerId (B.C f Kernel.Prelude.Text) (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
