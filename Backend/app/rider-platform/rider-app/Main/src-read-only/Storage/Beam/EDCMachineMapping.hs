...
data EDCMachineMappingT f
    = EDCMachineMappingT {clientId :: (B.C f Kernel.Prelude.Text),
...
instance B.Table EDCMachineMappingT
    where data PrimaryKey EDCMachineMappingT f = EDCMachineMappingId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
