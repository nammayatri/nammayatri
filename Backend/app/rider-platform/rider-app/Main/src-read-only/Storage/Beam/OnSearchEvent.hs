...
data OnSearchEventT f
    = OnSearchEventT {bppId :: (B.C f Kernel.Prelude.Text),
...
instance B.Table OnSearchEventT
    where data PrimaryKey OnSearchEventT f = OnSearchEventId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
