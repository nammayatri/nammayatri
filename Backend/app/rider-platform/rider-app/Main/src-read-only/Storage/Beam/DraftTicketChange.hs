...
data DraftTicketChangeT f
    = DraftTicketChangeT {createdAt :: (B.C f Kernel.Prelude.UTCTime),
...
instance B.Table DraftTicketChangeT
    where data PrimaryKey DraftTicketChangeT f = DraftTicketChangeId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
