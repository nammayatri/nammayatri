...
data SearchReqLocationT f
    = SearchReqLocationT {area :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text)),
...
instance B.Table SearchReqLocationT
    where data PrimaryKey SearchReqLocationT f = SearchReqLocationId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
