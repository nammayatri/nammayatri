...
instance B.Table VehicleSeatLayoutMappingT where
  data PrimaryKey VehicleSeatLayoutMappingT f = VehicleSeatLayoutMappingId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
