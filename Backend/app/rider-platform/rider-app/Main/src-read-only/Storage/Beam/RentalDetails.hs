...
data RentalDetailsT f
    = RentalDetailsT {baseFare :: (B.C f Kernel.Utils.Common.Money),
...
instance B.Table RentalDetailsT
    where data PrimaryKey RentalDetailsT f = RentalDetailsId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
