...
data FRFSTicketBookingT f = FRFSTicketBookingT
  { _type :: B.C f Domain.Types.FRFSQuote.FRFSQuoteType,
    ...
    bppPaymentId :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
...
$(enableKVPG ''FRFSTicketBookingT ['id] [['bookingGroupId], ['bppOrderId], ['overrideAppliedEntityId], ['quoteId], ['riderId], ['searchId], ['tripId], ['waybillNo]])
