...
data FRFSTicketBookingT f
    = FRFSTicketBookingT {_type :: (B.C f Domain.Types.FRFSQuote.FRFSQuoteType),
...
instance B.Table FRFSTicketBookingT
    where data PrimaryKey FRFSTicketBookingT f = FRFSTicketBookingId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
