...
data PTCircuitBreakerHistoryT f
    = PTCircuitBreakerHistoryT {apiType :: (B.C f Domain.Types.PTCircuitBreakerHistory.APIType),
...
instance B.Table PTCircuitBreakerHistoryT
    where data PrimaryKey PTCircuitBreakerHistoryT f = PTCircuitBreakerHistoryId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
