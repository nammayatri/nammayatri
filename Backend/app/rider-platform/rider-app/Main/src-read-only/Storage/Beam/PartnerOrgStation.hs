...
data PartnerOrgStationT f
    = PartnerOrgStationT {name :: (B.C f Kernel.Prelude.Text),
...
instance B.Table PartnerOrgStationT
    where data PrimaryKey PartnerOrgStationT f = PartnerOrgStationId (B.C f Kernel.Prelude.Text) (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
