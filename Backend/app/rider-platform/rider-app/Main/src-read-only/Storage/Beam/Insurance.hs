...
data InsuranceT f
    = InsuranceT {category :: (B.C f Kernel.Prelude.Text),
...
instance B.Table InsuranceT
    where data PrimaryKey InsuranceT f = InsuranceId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
