...
data SearchRequestT f = SearchRequestT
  { allJourneysLoaded :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    ...
    discoveredDropSpecialLocationId :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    ...
    hasBetterPointSuggestion :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    ...
    routeCacheUsed :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
