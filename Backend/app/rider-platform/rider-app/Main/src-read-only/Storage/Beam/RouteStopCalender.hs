...
data RouteStopCalenderT f
    = RouteStopCalenderT {integratedBppConfigId :: (B.C f Kernel.Prelude.Text),
...
instance B.Table RouteStopCalenderT
    where data PrimaryKey RouteStopCalenderT f = RouteStopCalenderId (B.C f Kernel.Prelude.Text) (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
