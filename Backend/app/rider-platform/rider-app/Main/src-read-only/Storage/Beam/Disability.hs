...
data DisabilityT f = DisabilityT {id :: B.C f Kernel.Prelude.Text, tag :: B.C f Kernel.Prelude.Text, description :: B.C f Kernel.Prelude.Text} deriving (Generic, B.Beamable)
