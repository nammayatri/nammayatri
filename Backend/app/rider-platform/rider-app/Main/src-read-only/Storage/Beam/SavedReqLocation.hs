...
data SavedReqLocationT f
    = SavedReqLocationT {area :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text)),
...
instance B.Table SavedReqLocationT
    where data PrimaryKey SavedReqLocationT f = SavedReqLocationId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
