...
data CallbackRequestT f
    = CallbackRequestT {createdAt :: (B.C f Kernel.Prelude.UTCTime),
...
instance B.Table CallbackRequestT
    where data PrimaryKey CallbackRequestT f = CallbackRequestId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
