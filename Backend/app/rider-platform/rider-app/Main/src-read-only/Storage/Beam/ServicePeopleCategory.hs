...
data ServicePeopleCategoryT f
    = ServicePeopleCategoryT {cancellationCharges :: (B.C f (Kernel.Prelude.Maybe Data.Aeson.Value)),
...
instance B.Table ServicePeopleCategoryT
    where data PrimaryKey ServicePeopleCategoryT f = ServicePeopleCategoryId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
