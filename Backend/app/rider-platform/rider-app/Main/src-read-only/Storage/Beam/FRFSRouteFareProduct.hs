...
data FRFSRouteFareProductT f
    = FRFSRouteFareProductT {farePolicyId :: (B.C f Kernel.Prelude.Text),
...
instance B.Table FRFSRouteFareProductT
    where data PrimaryKey FRFSRouteFareProductT f = FRFSRouteFareProductId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
