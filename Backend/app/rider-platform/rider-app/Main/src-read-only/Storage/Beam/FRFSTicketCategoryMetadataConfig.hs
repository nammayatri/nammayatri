...
data FRFSTicketCategoryMetadataConfigT f
    = FRFSTicketCategoryMetadataConfigT {category :: (B.C f Domain.Types.FRFSQuoteCategoryType.FRFSQuoteCategoryType),
...
instance B.Table FRFSTicketCategoryMetadataConfigT
    where data PrimaryKey FRFSTicketCategoryMetadataConfigT f = FRFSTicketCategoryMetadataConfigId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
