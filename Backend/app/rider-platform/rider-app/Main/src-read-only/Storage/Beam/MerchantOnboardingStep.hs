...
data MerchantOnboardingStepT f
    = MerchantOnboardingStepT {createdAt :: (B.C f Kernel.Prelude.UTCTime),
...
instance B.Table MerchantOnboardingStepT
    where data PrimaryKey MerchantOnboardingStepT f = MerchantOnboardingStepId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
