...
data ClientPersonInfoT f
    = ClientPersonInfoT {clientId :: (B.C f (Kernel.Prelude.Maybe (Kernel.Prelude.Text))),
...
instance B.Table ClientPersonInfoT
    where data PrimaryKey ClientPersonInfoT f = ClientPersonInfoId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
