...
data NyRegularSubscriptionT f = NyRegularSubscriptionT
  { bppId :: (B.C f Kernel.Prelude.Text),
    ...
    fixedPriceExpiryDate :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.UTCTime)),
    ...
    pauseEndDate :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.UTCTime)),
    pauseStartDate :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.UTCTime)),
    ...
    startDatetime :: (B.C f Kernel.Prelude.UTCTime),
    status :: (B.C f Domain.Types.NyRegularSubscription.NyRegularSubscriptionStatus),
