...
data NyRegularSubscriptionT f
    = NyRegularSubscriptionT {bppId :: (B.C f Kernel.Prelude.Text),
...
instance B.Table NyRegularSubscriptionT
    where data PrimaryKey NyRegularSubscriptionT f = NyRegularSubscriptionId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
