...
data IssueT f
    = IssueT {bookingId :: (B.C f (Kernel.Prelude.Maybe (Kernel.Prelude.Text))),
...
instance B.Table IssueT
    where data PrimaryKey IssueT f = IssueId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
