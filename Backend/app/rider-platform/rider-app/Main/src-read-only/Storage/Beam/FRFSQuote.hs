...
data FRFSQuoteT f
    = FRFSQuoteT {_type :: (B.C f Domain.Types.FRFSQuote.FRFSQuoteType),
...
instance B.Table FRFSQuoteT
    where data PrimaryKey FRFSQuoteT f = FRFSQuoteId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
