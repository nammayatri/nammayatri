...
data FRFSQuoteT f = FRFSQuoteT
  { _type :: B.C f Domain.Types.FRFSQuote.FRFSQuoteType,
    arrivalDate :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    arrivalTime :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    ...
    concessionTypeId :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    departureTime :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    ...
    extraFees :: B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney),
    ...
    offerSegment :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    ...
    providerClassId :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    providerDescription :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    providerId :: B.C f Kernel.Prelude.Text,
    providerLayoutId :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    providerName :: B.C f Kernel.Prelude.Text,
    providerRefNo :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    providerServiceId :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    providerTripCode :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
