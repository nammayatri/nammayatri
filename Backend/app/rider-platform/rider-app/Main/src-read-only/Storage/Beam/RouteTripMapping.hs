...
data RouteTripMappingT f
    = RouteTripMappingT {createdAt :: (B.C f Kernel.Prelude.UTCTime),
...
instance B.Table RouteTripMappingT
    where data PrimaryKey RouteTripMappingT f = RouteTripMappingId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
