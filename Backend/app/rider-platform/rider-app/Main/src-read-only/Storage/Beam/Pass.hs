...
data PassT f
    = PassT {amount :: (B.C f Kernel.Types.Common.HighPrecMoney),
...
instance B.Table PassT
    where data PrimaryKey PassT f = PassId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
