...
data PassT f = PassT
  { amount :: (B.C f Kernel.Types.Common.HighPrecMoney),
    ...
    dynamicPricingConfigJson :: (B.C f (Kernel.Prelude.Maybe Data.Aeson.Value)),
    dynamicPricingEnabled :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool)),
    ...
    minDaysToSuggestRenewal :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int)),
    minFare :: (B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney)),
    minTripsAllowingOverlap :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int)),
