...
data FRFSVehicleServiceTierT f
    = FRFSVehicleServiceTierT {_type :: (B.C f BecknV2.FRFS.Enums.ServiceTierType),
...
instance B.Table FRFSVehicleServiceTierT
    where data PrimaryKey FRFSVehicleServiceTierT f = FRFSVehicleServiceTierId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
