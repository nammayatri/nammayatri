...
data RiderConfigT f = RiderConfigT
  { alwaysAllowedNotificationCategories :: B.C f (Kernel.Prelude.Maybe [Kernel.Prelude.Text]),
    ...
    betterPointLoadSuggestionsAsync :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    ...
    betterPointMaxWalkPctOfRideAtDrop :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Double),
    ...
    boardingMaxBookingStartDriftSeconds :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Double),
    ...
    maxWalkDistanceForBetterPointAtDrop :: B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.Meters),
    ...
    silentReallocationWindowSeconds :: B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.Seconds),
