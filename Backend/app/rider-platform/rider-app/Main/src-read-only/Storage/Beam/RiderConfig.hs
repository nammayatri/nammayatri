...
data RiderConfigT f = RiderConfigT
  { appUrl :: B.C f Kernel.Prelude.Text,
    ...
    ivrTriggerExpireTime :: B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.Seconds),
    ...
    policeTriggerExpireTime :: B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.Seconds),
    ...
    scheduledRidePopupToRiderExpireTime :: B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.Seconds),
