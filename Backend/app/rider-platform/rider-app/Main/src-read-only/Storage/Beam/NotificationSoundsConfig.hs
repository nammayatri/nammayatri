...
data NotificationSoundsConfigT f
    = NotificationSoundsConfigT {blindSound :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text)),
...
instance B.Table NotificationSoundsConfigT
    where data PrimaryKey NotificationSoundsConfigT f = NotificationSoundsConfigId (B.C f Kernel.Prelude.Text) (B.C f Kernel.External.Notification.Interface.Types.Category) deriving (Generic, B.Beamable)
