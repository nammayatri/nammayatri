...
data TicketPlaceT f
    = TicketPlaceT {allowSameDayBooking :: (B.C f Kernel.Prelude.Bool),
...
instance B.Table TicketPlaceT
    where data PrimaryKey TicketPlaceT f = TicketPlaceId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
