...
updateErrorObjById :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateErrorObjById errorObj id = do {_now <- getCurrentTime;
                                     updateOneWithKV [Se.Set Beam.errorCode ((.errorCode) <$> errorObj),
...
updateMultipleById travelledDistance estimatedDistance estimatedFare totalDistance currentPointLat currentPointLon id = do {_now <- getCurrentTime;
...
instance FromTType' Beam.BookingUpdateRequest Domain.Types.BookingUpdateRequest.BookingUpdateRequest
    where fromTType' (Beam.BookingUpdateRequestT {..}) = do pure $ Just Domain.Types.BookingUpdateRequest.BookingUpdateRequest{bookingId = Kernel.Types.Id.Id bookingId,
                                                                                                                               createdAt = createdAt,
...
instance ToTType' Beam.BookingUpdateRequest Domain.Types.BookingUpdateRequest.BookingUpdateRequest
    where toTType' (Domain.Types.BookingUpdateRequest.BookingUpdateRequest {..}) = do Beam.BookingUpdateRequestT{Beam.bookingId = Kernel.Types.Id.getId bookingId,
