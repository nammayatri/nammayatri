...
findByTicketPlaceId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByTicketPlaceIdAndStatus :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByTicketPlaceIdAndStatus limit offset ticketPlaceId status = do findAllWithOptionsKV [Se.And [Se.Is Beam.ticketPlaceId $ Se.Eq (Kernel.Types.Id.getId ticketPlaceId),
                                                                                                  Se.Is Beam.status $ Se.Eq status]] (Se.Desc Beam.createdAt) limit offset
...
updateByPrimaryKey (Domain.Types.DraftTicketChangeHistory.DraftTicketChangeHistory {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.DraftTicketChangeHistory Domain.Types.DraftTicketChangeHistory.DraftTicketChangeHistory
    where fromTType' (Beam.DraftTicketChangeHistoryT {..}) = do pure $ Just Domain.Types.DraftTicketChangeHistory.DraftTicketChangeHistory{createdAt = createdAt,
...
instance ToTType' Beam.DraftTicketChangeHistory Domain.Types.DraftTicketChangeHistory.DraftTicketChangeHistory
    where toTType' (Domain.Types.DraftTicketChangeHistory.DraftTicketChangeHistory {..}) = do Beam.DraftTicketChangeHistoryT{Beam.createdAt = createdAt,
