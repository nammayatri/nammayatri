...
updateByPrimaryKey (Domain.Types.FRFSConfig.FRFSConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.bookingEndTime bookingEndTime,
      ...
      Se.Set Beam.singleModeBusStationTtl (Kernel.Prelude.Just singleModeBusStationTtl),
      ...
      Just
        Domain.Types.FRFSConfig.FRFSConfig
          { bookingEndTime = bookingEndTime,
            ...
            singleModeBusStationTtl = Kernel.Prelude.fromMaybe (Kernel.Types.Time.Seconds 1800) singleModeBusStationTtl,
  ...
  toTType' (Domain.Types.FRFSConfig.FRFSConfig {..}) = do
    Beam.FRFSConfigT
      { Beam.bookingEndTime = bookingEndTime,
        ...
        Beam.singleModeBusStationTtl = Kernel.Prelude.Just singleModeBusStationTtl,
