...
updateByPrimaryKey (Domain.Types.CrisRecon.CrisRecon {..}) = do {_now <- getCurrentTime;
                                                                 updateWithKV [Se.Set Beam.bppOrderId bppOrderId,
...
instance FromTType' Beam.CrisRecon Domain.Types.CrisRecon.CrisRecon
    where fromTType' (Beam.CrisReconT {..}) = do pure $ Just Domain.Types.CrisRecon.CrisRecon{bppOrderId = bppOrderId,
                                                                                              createdAt = createdAt,
                                                                                              dateIst = dateIst,
...
instance ToTType' Beam.CrisRecon Domain.Types.CrisRecon.CrisRecon
    where toTType' (Domain.Types.CrisRecon.CrisRecon {..}) = do Beam.CrisReconT{Beam.bppOrderId = bppOrderId,
