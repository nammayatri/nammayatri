...
findBySplDayAndEntityIdAndDate :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findBySplDayAndEntityIdAndDate specialDayType entityId date = do findOneWithKV [Se.And [Se.Is Beam.specialDayType $ Se.Eq specialDayType,
                                                                                        Se.Is Beam.entityId $ Se.Eq entityId,
                                                                                        Se.Is Beam.date $ Se.Eq date]]
findSpecialOccasionByEntityIdAndDate :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findSpecialOccasionByEntityIdAndDayOfWeek :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateBusinessHoursById :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateBusinessHoursById businessHours id = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.SpecialOccasion.SpecialOccasion {..}) = do {_now <- getCurrentTime;
                                                                             updateWithKV [Se.Set Beam.businessHours (Kernel.Types.Id.getId <$> businessHours),
...
instance FromTType' Beam.SpecialOccasion Domain.Types.SpecialOccasion.SpecialOccasion
    where fromTType' (Beam.SpecialOccasionT {..}) = do pure $ Just Domain.Types.SpecialOccasion.SpecialOccasion{businessHours = Kernel.Types.Id.Id <$> businessHours,
                                                                                                                date = date,
                                                                                                                dayOfWeek = dayOfWeek,
                                                                                                                ...
                                                                                                                createdAt = createdAt,
                                                                                                                updatedAt = updatedAt}
instance ToTType' Beam.SpecialOccasion Domain.Types.SpecialOccasion.SpecialOccasion
    where toTType' (Domain.Types.SpecialOccasion.SpecialOccasion {..}) = do Beam.SpecialOccasionT{Beam.businessHours = Kernel.Types.Id.getId <$> businessHours,
                                                                                                  Beam.date = date,
