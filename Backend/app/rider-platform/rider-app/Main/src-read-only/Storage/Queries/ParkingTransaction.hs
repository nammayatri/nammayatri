...
findByPaymentOrderId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByPrimaryKey (Domain.Types.ParkingTransaction.ParkingTransaction {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.ParkingTransaction Domain.Types.ParkingTransaction.ParkingTransaction
    where fromTType' (Beam.ParkingTransactionT {..}) = do pure $ Just Domain.Types.ParkingTransaction.ParkingTransaction{amount = amount,
                                                                                                                         endTime = endTime,
                                                                                                                         ...
                                                                                                                         createdAt = createdAt,
                                                                                                                         updatedAt = updatedAt}
instance ToTType' Beam.ParkingTransaction Domain.Types.ParkingTransaction.ParkingTransaction
    where toTType' (Domain.Types.ParkingTransaction.ParkingTransaction {..}) = do Beam.ParkingTransactionT{Beam.amount = amount,
