...
findAllBySeatLayoutId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateSeatLayoutIdByVehicleNoAndGtfsId seatLayoutId vehicleNo gtfsId = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.VehicleSeatLayoutMapping.VehicleSeatLayoutMapping {..}) = do {_now <- getCurrentTime;
                                                                                               updateWithKV [Se.Set Beam.gtfsId gtfsId,
...
instance FromTType' Beam.VehicleSeatLayoutMapping Domain.Types.VehicleSeatLayoutMapping.VehicleSeatLayoutMapping
    where fromTType' (Beam.VehicleSeatLayoutMappingT {..}) = do pure $ Just Domain.Types.VehicleSeatLayoutMapping.VehicleSeatLayoutMapping{gtfsId = gtfsId,
                                                                                                                                           ...
                                                                                                                                           createdAt = createdAt,
                                                                                                                                           updatedAt = updatedAt}
instance ToTType' Beam.VehicleSeatLayoutMapping Domain.Types.VehicleSeatLayoutMapping.VehicleSeatLayoutMapping
    where toTType' (Domain.Types.VehicleSeatLayoutMapping.VehicleSeatLayoutMapping {..}) = do Beam.VehicleSeatLayoutMappingT{Beam.gtfsId = gtfsId,
