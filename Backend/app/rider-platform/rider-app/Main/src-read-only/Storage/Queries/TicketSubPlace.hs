...
findActiveByTicketPlaceId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByPrimaryKey (Domain.Types.TicketSubPlace.TicketSubPlace {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.TicketSubPlace Domain.Types.TicketSubPlace.TicketSubPlace
    where fromTType' (Beam.TicketSubPlaceT {..}) = do pure $ Just Domain.Types.TicketSubPlace.TicketSubPlace{createdAt = createdAt,
...
instance ToTType' Beam.TicketSubPlace Domain.Types.TicketSubPlace.TicketSubPlace
    where toTType' (Domain.Types.TicketSubPlace.TicketSubPlace {..}) = do Beam.TicketSubPlaceT{Beam.createdAt = createdAt,
