...
instance FromTType' Beam.Merchant Domain.Types.Merchant.Merchant
    where fromTType' (Beam.MerchantT {..}) = do {driverOfferBaseUrl' <- Kernel.Prelude.parseBaseUrl driverOfferBaseUrl;
                                                 gatewayUrl' <- Kernel.Prelude.parseBaseUrl gatewayUrl;
                                                 registryUrl' <- Kernel.Prelude.parseBaseUrl registryUrl;
                                                 pure $ Just Domain.Types.Merchant.Merchant{aadhaarKeyExpiryTime = aadhaarKeyExpiryTime,
...
instance ToTType' Beam.Merchant Domain.Types.Merchant.Merchant
    where toTType' (Domain.Types.Merchant.Merchant {..}) = do Beam.MerchantT{Beam.aadhaarKeyExpiryTime = aadhaarKeyExpiryTime,
