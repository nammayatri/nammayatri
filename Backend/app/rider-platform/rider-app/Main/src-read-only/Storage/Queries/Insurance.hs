...
updateByPrimaryKey (Domain.Types.Insurance.Insurance {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.Insurance Domain.Types.Insurance.Insurance
    where fromTType' (Beam.InsuranceT {..}) = do pure $ Just Domain.Types.Insurance.Insurance{category = category,
                                                                                              ...
                                                                                              updatedAt = updatedAt}
instance ToTType' Beam.Insurance Domain.Types.Insurance.Insurance
    where toTType' (Domain.Types.Insurance.Insurance {..}) = do Beam.InsuranceT{Beam.category = category,
