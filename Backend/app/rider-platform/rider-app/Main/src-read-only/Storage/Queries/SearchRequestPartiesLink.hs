...
findAllBySearchRequestId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
instance FromTType' Beam.SearchRequestPartiesLink Domain.Types.SearchRequestPartiesLink.SearchRequestPartiesLink
    where fromTType' (Beam.SearchRequestPartiesLinkT {..}) = do pure $ Just Domain.Types.SearchRequestPartiesLink.SearchRequestPartiesLink{id = Kernel.Types.Id.Id id,
                                                                                                                                           ...
                                                                                                                                           createdAt = createdAt,
                                                                                                                                           updatedAt = updatedAt}
instance ToTType' Beam.SearchRequestPartiesLink Domain.Types.SearchRequestPartiesLink.SearchRequestPartiesLink
    where toTType' (Domain.Types.SearchRequestPartiesLink.SearchRequestPartiesLink {..}) = do Beam.SearchRequestPartiesLinkT{Beam.id = Kernel.Types.Id.getId id,
