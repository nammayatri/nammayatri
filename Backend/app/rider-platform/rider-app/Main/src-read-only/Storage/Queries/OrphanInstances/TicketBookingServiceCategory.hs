...
instance FromTType' Beam.TicketBookingServiceCategory Domain.Types.TicketBookingServiceCategory.TicketBookingServiceCategory
    where fromTType' (Beam.TicketBookingServiceCategoryT {..}) = do pure $ Just Domain.Types.TicketBookingServiceCategory.TicketBookingServiceCategory{amount = Kernel.Types.Common.mkPrice currency amount,
                                                                                                                                                       ...
                                                                                                                                                       createdAt = createdAt,
                                                                                                                                                       updatedAt = updatedAt}
instance ToTType' Beam.TicketBookingServiceCategory Domain.Types.TicketBookingServiceCategory.TicketBookingServiceCategory
    where toTType' (Domain.Types.TicketBookingServiceCategory.TicketBookingServiceCategory {..}) = do Beam.TicketBookingServiceCategoryT{Beam.amount = (.amount) amount,
