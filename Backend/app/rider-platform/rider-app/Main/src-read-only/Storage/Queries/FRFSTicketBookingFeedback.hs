...
findByBookingId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMerchantIdAndOperatingCityId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMerchantIdAndOperatingCityId merchantId merchantOperatingCityId = do findAllWithKV [Se.And [Se.Is Beam.merchantId $ Se.Eq (Kernel.Types.Id.getId merchantId),
                                                                                                  Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId)]]
updateByBookingId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByBookingId isFareAccepted feedbackDetails bookingId = do {_now <- getCurrentTime;
                                                                 updateOneWithKV [Se.Set Beam.isFareAccepted isFareAccepted,
                                                                                  Se.Set Beam.feedbackDetails feedbackDetails,
                                                                                  Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.bookingId $ Se.Eq (Kernel.Types.Id.getId bookingId)]]}
...
updateByPrimaryKey (Domain.Types.FRFSTicketBookingFeedback.FRFSTicketBookingFeedback {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.FRFSTicketBookingFeedback Domain.Types.FRFSTicketBookingFeedback.FRFSTicketBookingFeedback
    where fromTType' (Beam.FRFSTicketBookingFeedbackT {..}) = do pure $ Just Domain.Types.FRFSTicketBookingFeedback.FRFSTicketBookingFeedback{bookingId = Kernel.Types.Id.Id bookingId,
                                                                                                                                              createdAt = createdAt,
                                                                                                                                              ...
                                                                                                                                              updatedAt = updatedAt}
instance ToTType' Beam.FRFSTicketBookingFeedback Domain.Types.FRFSTicketBookingFeedback.FRFSTicketBookingFeedback
    where toTType' (Domain.Types.FRFSTicketBookingFeedback.FRFSTicketBookingFeedback {..}) = do Beam.FRFSTicketBookingFeedbackT{Beam.bookingId = Kernel.Types.Id.getId bookingId,
