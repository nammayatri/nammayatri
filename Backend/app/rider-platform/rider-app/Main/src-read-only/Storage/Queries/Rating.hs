...
updateRating :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateRating ratingValue feedbackDetails wasOfferedAssistance mediaId id riderId = do {_now <- getCurrentTime;
                                                                                       updateOneWithKV [Se.Set Beam.ratingValue ratingValue,
                                                                                                        ...
                                                                                                        Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id), Se.Is Beam.riderId $ Se.Eq (Kernel.Types.Id.getId riderId)]]}
...
updateByPrimaryKey (Domain.Types.Rating.Rating {..}) = do {_now <- getCurrentTime;
                                                           updateWithKV [Se.Set Beam.feedbackDetails feedbackDetails,
                                                                         Se.Set Beam.mediaId (Kernel.Types.Id.getId <$> mediaId),
