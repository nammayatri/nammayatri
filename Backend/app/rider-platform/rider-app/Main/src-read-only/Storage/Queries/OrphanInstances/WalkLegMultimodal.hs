      ...
      Just
        Domain.Types.WalkLegMultimodal.WalkLegMultimodal
          { estimatedDistance = (Kernel.Types.Common.Distance <$> estimatedDistance <*> distanceUnit),
            ...
            journeyLegInfo = Storage.Queries.Transformers.MultiModal.mkJourneyLegInfo agency convenienceCost isDeleted journeyId journeyLegOrder onSearchFailed pricingId,
