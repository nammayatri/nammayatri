...
updateByPrimaryKey (Domain.Types.JourneyLeg.JourneyLeg {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.agencyGtfsId (routeDetails >>= (.gtfsId)),
      ...
      Se.Set Beam.frequency (routeColor >>= (.frequency)),
      Se.Set Beam.routeColorCode (routeDetails >>= (.routeColorCode)),
      Se.Set Beam.routeColorName (routeDetails >>= (.routeColorName)),
      ...
      Just
        Domain.Types.JourneyLeg.JourneyLeg
          { agency = Kernel.External.MultiModal.Interface.Types.MultiModalAgency agencyGtfsId <$> agencyName,
            ...
            legId = legId,
            mode = mode,
            routeDetails = Just $ Kernel.External.MultiModal.Interface.Types.MultiModalRouteDetails routeGtfsId routeLongName routeShortName routeColorName routeColorCode frequency,
            ...
            toStopDetails = Just $ Kernel.External.MultiModal.Interface.Types.MultiModalStopDetails toStopCode toStopName toStopGtfsId,
  ...
  toTType' (Domain.Types.JourneyLeg.JourneyLeg {..}) = do
    Beam.JourneyLegT
      { Beam.agencyGtfsId = routeDetails >>= (.gtfsId),
        ...
        Beam.legId = legId,
        Beam.mode = mode,
        Beam.frequency = routeColor >>= (.frequency),
        Beam.routeColorCode = routeDetails >>= (.routeColorCode),
        Beam.routeColorName = routeDetails >>= (.routeColorName),
