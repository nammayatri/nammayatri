...
instance FromTType' Beam.InterCityDetails Domain.Types.InterCityDetails.InterCityDetails
    where fromTType' (Beam.InterCityDetailsT {..}) = do pure $ Just Domain.Types.InterCityDetails.InterCityDetails{baseFare = Kernel.Utils.Common.mkPrice (Just currency) baseFare,
                                                                                                                   ...
                                                                                                                   createdAt = createdAt,
                                                                                                                   updatedAt = updatedAt}
instance ToTType' Beam.InterCityDetails Domain.Types.InterCityDetails.InterCityDetails
    where toTType' (Domain.Types.InterCityDetails.InterCityDetails {..}) = do Beam.InterCityDetailsT{Beam.baseFare = (.amount) baseFare,
