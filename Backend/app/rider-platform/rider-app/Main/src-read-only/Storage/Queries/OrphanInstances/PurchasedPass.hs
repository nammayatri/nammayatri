...
instance FromTType' Beam.PurchasedPass Domain.Types.PurchasedPass.PurchasedPass
    where fromTType' (Beam.PurchasedPassT {..}) = do pure $ Just Domain.Types.PurchasedPass.PurchasedPass{applicableVehicleServiceTiers = applicableVehicleServiceTiers,
                                                                                                          ...
                                                                                                          createdAt = createdAt,
                                                                                                          updatedAt = updatedAt}
instance ToTType' Beam.PurchasedPass Domain.Types.PurchasedPass.PurchasedPass
    where toTType' (Domain.Types.PurchasedPass.PurchasedPass {..}) = do Beam.PurchasedPassT{Beam.applicableVehicleServiceTiers = applicableVehicleServiceTiers,
                                                                                            ...
                                                                                            Beam.preferredDestination = preferredDestination,
                                                                                            Beam.preferredSource = preferredSource,
