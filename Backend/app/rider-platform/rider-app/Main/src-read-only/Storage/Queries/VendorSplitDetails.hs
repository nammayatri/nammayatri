...
findAllByMerchantOperatingCityIdAndIncludeInSplit :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByMerchantOperatingCityIdAndIncludeInSplit merchantOperatingCityId includeInSplit = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId <$> merchantOperatingCityId),
...
updateByPrimaryKey (Domain.Types.VendorSplitDetails.VendorSplitDetails {..}) = do {_now <- getCurrentTime;
                                                                                   updateWithKV [Se.Set Beam.includeInSplit includeInSplit,
...
instance FromTType' Beam.VendorSplitDetails Domain.Types.VendorSplitDetails.VendorSplitDetails
    where fromTType' (Beam.VendorSplitDetailsT {..}) = do pure $ Just Domain.Types.VendorSplitDetails.VendorSplitDetails{id = Kernel.Types.Id.Id id,
...
instance ToTType' Beam.VendorSplitDetails Domain.Types.VendorSplitDetails.VendorSplitDetails
    where toTType' (Domain.Types.VendorSplitDetails.VendorSplitDetails {..}) = do Beam.VendorSplitDetailsT{Beam.id = Kernel.Types.Id.getId id,
