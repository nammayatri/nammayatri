...
instance FromTType' Beam.NyRegularSubscription Domain.Types.NyRegularSubscription.NyRegularSubscription
    where fromTType' (Beam.NyRegularSubscriptionT {..}) = do {dropoffLocation' <- Storage.Queries.Location.findById (Kernel.Types.Id.Id dropoffLocationId) >>= fromMaybeM (Kernel.Types.Error.InternalError ("Failed to get dropoffLocation " <> dropoffLocationId));
                                                              ...
                                                              pure $ Just Domain.Types.NyRegularSubscription.NyRegularSubscription{bppId = bppId,
                                                                                                                                   createdAt = createdAt,
...
instance ToTType' Beam.NyRegularSubscription Domain.Types.NyRegularSubscription.NyRegularSubscription
    where toTType' (Domain.Types.NyRegularSubscription.NyRegularSubscription {..}) = do Beam.NyRegularSubscriptionT{Beam.bppId = bppId,
