...
findAllTripIdByRouteCode :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllTripIdByRouteCode routeCode integratedBppConfigId = do findAllWithKV [Se.And [Se.Is Beam.routeCode $ Se.Eq routeCode,
...
updateByPrimaryKey (Domain.Types.RouteTripMapping.RouteTripMapping {..}) = do {_now <- getCurrentTime;
                                                                               updateWithKV [Se.Set Beam.integratedBppConfigId (Kernel.Types.Id.getId integratedBppConfigId),
                                                                                             ...
                                                                                             Se.Set Beam.vehicleType vehicleType] [Se.And [Se.Is Beam.tripCode $ Se.Eq tripCode]]}



instance FromTType' Beam.RouteTripMapping Domain.Types.RouteTripMapping.RouteTripMapping
    where fromTType' (Beam.RouteTripMappingT {..}) = do pure $ Just Domain.Types.RouteTripMapping.RouteTripMapping{createdAt = createdAt,
...
instance ToTType' Beam.RouteTripMapping Domain.Types.RouteTripMapping.RouteTripMapping
    where toTType' (Domain.Types.RouteTripMapping.RouteTripMapping {..}) = do Beam.RouteTripMappingT{Beam.createdAt = createdAt,
