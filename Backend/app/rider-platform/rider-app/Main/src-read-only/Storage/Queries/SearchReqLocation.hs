...
updateByPrimaryKey (Domain.Types.SearchReqLocation.SearchReqLocation {..}) = do {_now <- getCurrentTime;
                                                                                 updateWithKV [Se.Set Beam.area (Domain.Types.LocationAddress.area address),
...
instance FromTType' Beam.SearchReqLocation Domain.Types.SearchReqLocation.SearchReqLocation
    where fromTType' (Beam.SearchReqLocationT {..}) = do pure $ Just Domain.Types.SearchReqLocation.SearchReqLocation{address = mkLocationAddress area areaCode building city country door extras instructions placeId state street title ward,
                                                                                                                      createdAt = createdAt,
                                                                                                                      id = Kernel.Types.Id.Id id,
                                                                                                                      lat = lat,
                                                                                                                      lon = lon,
                                                                                                                      updatedAt = updatedAt}
instance ToTType' Beam.SearchReqLocation Domain.Types.SearchReqLocation.SearchReqLocation
    where toTType' (Domain.Types.SearchReqLocation.SearchReqLocation {..}) = do Beam.SearchReqLocationT{Beam.area = Domain.Types.LocationAddress.area address,
