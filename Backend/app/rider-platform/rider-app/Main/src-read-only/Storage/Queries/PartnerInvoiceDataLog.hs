...
instance FromTType' Beam.PartnerInvoiceDataLog Domain.Types.PartnerInvoiceDataLog.PartnerInvoiceDataLog
    where fromTType' (Beam.PartnerInvoiceDataLogT {..}) = do pure $ Just Domain.Types.PartnerInvoiceDataLog.PartnerInvoiceDataLog{bookingId = Kernel.Types.Id.Id bookingId,
                                                                                                                                  createdAt = createdAt,
                                                                                                                                  ...
                                                                                                                                  updatedAt = updatedAt}
instance ToTType' Beam.PartnerInvoiceDataLog Domain.Types.PartnerInvoiceDataLog.PartnerInvoiceDataLog
    where toTType' (Domain.Types.PartnerInvoiceDataLog.PartnerInvoiceDataLog {..}) = do Beam.PartnerInvoiceDataLogT{Beam.bookingId = Kernel.Types.Id.getId bookingId,
