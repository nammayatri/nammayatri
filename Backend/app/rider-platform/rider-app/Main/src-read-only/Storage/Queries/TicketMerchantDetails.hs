...
updateIsBankOnboarded :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
                         (Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Kernel.Types.Id.Id Domain.Types.TicketMerchantDetails.TicketMerchantDetails -> m ())
updateIsBankOnboarded isBankOnboarded id = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.TicketMerchantDetails.TicketMerchantDetails {..}) = do {_now <- getCurrentTime;
                                                                                         updateWithKV [Se.Set Beam.agreementLetterEncrypted (((agreementLetter <&> unEncrypted . (.encrypted)))),
...
instance FromTType' Beam.TicketMerchantDetails Domain.Types.TicketMerchantDetails.TicketMerchantDetails
    where fromTType' (Beam.TicketMerchantDetailsT {..}) = do pure $ Just Domain.Types.TicketMerchantDetails.TicketMerchantDetails{agreementLetter = EncryptedHashed <$> (Encrypted <$> agreementLetterEncrypted) <*> agreementLetterHash,
                                                                                                                                  ...
                                                                                                                                  state = state,
                                                                                                                                  updatedAt = updatedAt}
instance ToTType' Beam.TicketMerchantDetails Domain.Types.TicketMerchantDetails.TicketMerchantDetails
    where toTType' (Domain.Types.TicketMerchantDetails.TicketMerchantDetails {..}) = do Beam.TicketMerchantDetailsT{Beam.agreementLetterEncrypted = ((agreementLetter <&> unEncrypted . (.encrypted))),
