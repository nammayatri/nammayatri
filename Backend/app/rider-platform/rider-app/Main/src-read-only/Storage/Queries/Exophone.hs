...
findByMerchantOperatingCityIdAndService :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMerchantOperatingCityIdAndService merchantOperatingCityId callService = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
updateByPrimaryKey (Domain.Types.Exophone.Exophone {..}) = do {_now <- getCurrentTime;
                                                               updateWithKV [Se.Set Beam.backupPhone backupPhone,
