...
updateByPrimaryKey (Domain.Types.MerchantOperatingCity.MerchantOperatingCity {..}) = do {_now <- getCurrentTime;
                                                                                         updateWithKV [Se.Set Beam.city city,
