...
instance FromTType' Beam.TicketBooking Domain.Types.TicketBooking.TicketBooking
    where fromTType' (Beam.TicketBookingT {..}) = do pure $ Just Domain.Types.TicketBooking.TicketBooking{amount = Kernel.Types.Common.mkPrice currency amount,
...
instance ToTType' Beam.TicketBooking Domain.Types.TicketBooking.TicketBooking
    where toTType' (Domain.Types.TicketBooking.TicketBooking {..}) = do Beam.TicketBookingT{Beam.amount = (.amount) amount,
