...
findAllByMerchantOperatingCityId merchantOperatingCityId enabled = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
updateByPrimaryKey (Domain.Types.MerchantConfig.MerchantConfig {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.MerchantConfig Domain.Types.MerchantConfig.MerchantConfig
    where fromTType' (Beam.MerchantConfigT {..}) = do pure $ Just Domain.Types.MerchantConfig.MerchantConfig{createdAt = createdAt,
                                                                                                             enabled = enabled,
                                                                                                             ...
                                                                                                             updatedAt = updatedAt}
instance ToTType' Beam.MerchantConfig Domain.Types.MerchantConfig.MerchantConfig
    where toTType' (Domain.Types.MerchantConfig.MerchantConfig {..}) = do Beam.MerchantConfigT{Beam.createdAt = createdAt,
