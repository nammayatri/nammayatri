...
findByMerchantOperatingCityId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByPrimaryKey (Domain.Types.PTCircuitBreakerHistory.PTCircuitBreakerHistory {..}) = do {_now <- getCurrentTime;
                                                                                             updateWithKV [Se.Set Beam.apiType apiType,
...
instance FromTType' Beam.PTCircuitBreakerHistory Domain.Types.PTCircuitBreakerHistory.PTCircuitBreakerHistory
    where fromTType' (Beam.PTCircuitBreakerHistoryT {..}) = do pure $ Just Domain.Types.PTCircuitBreakerHistory.PTCircuitBreakerHistory{apiType = apiType,
                                                                                                                                        createdAt = createdAt,
                                                                                                                                        ...
                                                                                                                                        updatedAt = updatedAt}
instance ToTType' Beam.PTCircuitBreakerHistory Domain.Types.PTCircuitBreakerHistory.PTCircuitBreakerHistory
    where toTType' (Domain.Types.PTCircuitBreakerHistory.PTCircuitBreakerHistory {..}) = do Beam.PTCircuitBreakerHistoryT{Beam.apiType = apiType,
