...
findAllByMerchantOperatingCityIdAndIntegratedBPPConfigId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByMerchantOperatingCityIdAndIntegratedBPPConfigId merchantOperatingCityId integratedBppConfigId = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
findByProviderCode :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByProviderCode providerCode merchantOperatingCityId = do findAllWithKV [Se.And [Se.Is Beam.providerCode $ Se.Eq providerCode,
                                                                                    Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId)]]
findByProviderCodeAndTrainType :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByProviderCodeAndTrainType providerCode trainType merchantOperatingCityId = do findAllWithKV [Se.And [Se.Is Beam.providerCode $ Se.Eq providerCode,
                                                                                                          Se.Is Beam.trainType $ Se.Eq trainType,
                                                                                                          Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId)]]
findByServiceTierAndMerchantOperatingCityIdAndIntegratedBPPConfigId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByServiceTierAndMerchantOperatingCityIdAndIntegratedBPPConfigId _type merchantOperatingCityId integratedBppConfigId = do findOneWithKV [Se.And [Se.Is Beam._type $ Se.Eq _type,
                                                                                                                                                    Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
                                                                                                                                                    Se.Is Beam.integratedBppConfigId $ Se.Eq (Kernel.Types.Id.getId integratedBppConfigId)]]
...
updateByPrimaryKey (Domain.Types.FRFSVehicleServiceTier.FRFSVehicleServiceTier {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.FRFSVehicleServiceTier Domain.Types.FRFSVehicleServiceTier.FRFSVehicleServiceTier
    where fromTType' (Beam.FRFSVehicleServiceTierT {..}) = do pure $ Just Domain.Types.FRFSVehicleServiceTier.FRFSVehicleServiceTier{_type = _type,
                                                                                                                                     ...
                                                                                                                                     createdAt = createdAt,
                                                                                                                                     updatedAt = updatedAt}
instance ToTType' Beam.FRFSVehicleServiceTier Domain.Types.FRFSVehicleServiceTier.FRFSVehicleServiceTier
    where toTType' (Domain.Types.FRFSVehicleServiceTier.FRFSVehicleServiceTier {..}) = do Beam.FRFSVehicleServiceTierT{Beam._type = _type,
