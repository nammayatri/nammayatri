...
instance FromTType' Beam.RouteDetails Domain.Types.RouteDetails.RouteDetails
    where fromTType' (Beam.RouteDetailsT {..}) = do pure $ Just Domain.Types.RouteDetails.RouteDetails{agencyGtfsId = agencyGtfsId,
                                                                                                       ...
                                                                                                       createdAt = createdAt,
                                                                                                       updatedAt = updatedAt}
instance ToTType' Beam.RouteDetails Domain.Types.RouteDetails.RouteDetails
    where toTType' (Domain.Types.RouteDetails.RouteDetails {..}) = do Beam.RouteDetailsT{Beam.agencyGtfsId = agencyGtfsId,
