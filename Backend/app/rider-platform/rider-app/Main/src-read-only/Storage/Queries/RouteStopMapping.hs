...
findByRouteCode routeCode = do findAllWithDb [Se.Is Beam.routeCode $ Se.Eq routeCode]
...
findByRouteCodes routeCode = do findAllWithDb [Se.And [Se.Is Beam.routeCode $ Se.In routeCode]]
...
findByStopCode stopCode = do findAllWithDb [Se.Is Beam.stopCode $ Se.Eq stopCode]
