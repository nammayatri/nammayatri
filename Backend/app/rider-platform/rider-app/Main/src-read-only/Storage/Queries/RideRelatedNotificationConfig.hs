...
findAllByMerchantOperatingCityIdAndTimeDiffEvent :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByMerchantOperatingCityIdAndTimeDiffEvent merchantOperatingCityId timeDiffEvent = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
findByPrimaryKey id merchantOperatingCityId = do findOneWithKV [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id),
...
updateByPrimaryKey (Domain.Types.RideRelatedNotificationConfig.RideRelatedNotificationConfig {..}) = do {_now <- getCurrentTime;
                                                                                                         updateWithKV [Se.Set Beam.eventTime eventTime,
                                                                                                                       ...
                                                                                                                       Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id), Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId)]]}



instance FromTType' Beam.RideRelatedNotificationConfig Domain.Types.RideRelatedNotificationConfig.RideRelatedNotificationConfig
    where fromTType' (Beam.RideRelatedNotificationConfigT {..}) = do pure $ Just Domain.Types.RideRelatedNotificationConfig.RideRelatedNotificationConfig{eventTime = eventTime,
                                                                                                                                                          ...
                                                                                                                                                          createdAt = createdAt,
                                                                                                                                                          updatedAt = updatedAt}
instance ToTType' Beam.RideRelatedNotificationConfig Domain.Types.RideRelatedNotificationConfig.RideRelatedNotificationConfig
    where toTType' (Domain.Types.RideRelatedNotificationConfig.RideRelatedNotificationConfig {..}) = do Beam.RideRelatedNotificationConfigT{Beam.eventTime = eventTime,
