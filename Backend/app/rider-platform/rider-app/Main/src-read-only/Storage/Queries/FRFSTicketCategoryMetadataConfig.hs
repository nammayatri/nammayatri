...
findByCategoryVehicleAndCity :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByCategoryVehicleAndCity category vehicleCategory merchantOperatingCityId = do findOneWithKV [Se.And [Se.Is Beam.category $ Se.Eq category,
...
updateByPrimaryKey (Domain.Types.FRFSTicketCategoryMetadataConfig.FRFSTicketCategoryMetadataConfig {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.FRFSTicketCategoryMetadataConfig Domain.Types.FRFSTicketCategoryMetadataConfig.FRFSTicketCategoryMetadataConfig
    where fromTType' (Beam.FRFSTicketCategoryMetadataConfigT {..}) = do pure $ Just Domain.Types.FRFSTicketCategoryMetadataConfig.FRFSTicketCategoryMetadataConfig{category = category,
                                                                                                                                                                   ...
                                                                                                                                                                   createdAt = createdAt,
                                                                                                                                                                   updatedAt = updatedAt}
instance ToTType' Beam.FRFSTicketCategoryMetadataConfig Domain.Types.FRFSTicketCategoryMetadataConfig.FRFSTicketCategoryMetadataConfig
    where toTType' (Domain.Types.FRFSTicketCategoryMetadataConfig.FRFSTicketCategoryMetadataConfig {..}) = do Beam.FRFSTicketCategoryMetadataConfigT{Beam.category = category,
