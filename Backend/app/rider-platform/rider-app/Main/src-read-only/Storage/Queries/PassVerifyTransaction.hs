...
findAllByPurchasePassId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByPrimaryKey (Domain.Types.PassVerifyTransaction.PassVerifyTransaction {..}) = do {_now <- getCurrentTime;
                                                                                         updateWithKV [Se.Set Beam.autoActivated autoActivated,
