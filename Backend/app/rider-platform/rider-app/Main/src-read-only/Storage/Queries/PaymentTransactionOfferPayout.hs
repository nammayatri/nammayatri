...
instance FromTType' Beam.PaymentTransactionOfferPayout Domain.Types.PaymentTransactionOfferPayout.PaymentTransactionOfferPayout
    where fromTType' (Beam.PaymentTransactionOfferPayoutT {..}) = do pure $ Just Domain.Types.PaymentTransactionOfferPayout.PaymentTransactionOfferPayout{amountPaidByUser = amountPaidByUser,
                                                                                                                                                          ...
                                                                                                                                                          updatedAt = updatedAt}
instance ToTType' Beam.PaymentTransactionOfferPayout Domain.Types.PaymentTransactionOfferPayout.PaymentTransactionOfferPayout
    where toTType' (Domain.Types.PaymentTransactionOfferPayout.PaymentTransactionOfferPayout {..}) = do Beam.PaymentTransactionOfferPayoutT{Beam.amountPaidByUser = amountPaidByUser,
