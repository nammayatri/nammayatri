...
updateByPrimaryKey (Domain.Types.FRFSFarePolicy.FRFSFarePolicy {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.FRFSFarePolicy Domain.Types.FRFSFarePolicy.FRFSFarePolicy
    where fromTType' (Beam.FRFSFarePolicyT {..}) = do pure $ Just Domain.Types.FRFSFarePolicy.FRFSFarePolicy{_type = _type,
                                                                                                             ...
                                                                                                             createdAt = createdAt,
                                                                                                             updatedAt = updatedAt}
instance ToTType' Beam.FRFSFarePolicy Domain.Types.FRFSFarePolicy.FRFSFarePolicy
    where toTType' (Domain.Types.FRFSFarePolicy.FRFSFarePolicy {..}) = do Beam.FRFSFarePolicyT{Beam._type = _type,
