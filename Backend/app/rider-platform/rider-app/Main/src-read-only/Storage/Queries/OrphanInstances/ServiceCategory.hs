...
instance FromTType' Beam.ServiceCategory Domain.Types.ServiceCategory.ServiceCategory
    where fromTType' (Beam.ServiceCategoryT {..}) = do pure $ Just Domain.Types.ServiceCategory.ServiceCategory{allowedSeats = allowedSeats,
                                                                                                                ...
                                                                                                                createdAt = createdAt,
                                                                                                                updatedAt = updatedAt}
instance ToTType' Beam.ServiceCategory Domain.Types.ServiceCategory.ServiceCategory
    where toTType' (Domain.Types.ServiceCategory.ServiceCategory {..}) = do Beam.ServiceCategoryT{Beam.allowedSeats = allowedSeats,
