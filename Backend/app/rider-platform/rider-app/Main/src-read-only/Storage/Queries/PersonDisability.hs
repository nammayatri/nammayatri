...
updateDisabilityByPersonId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateDisabilityByPersonId disabilityId tag description personId = do {_now <- getCurrentTime;
                                                                       updateWithKV [Se.Set Beam.disabilityId disabilityId,
                                                                                     Se.Set Beam.tag tag,
...
updateByPrimaryKey (Domain.Types.PersonDisability.PersonDisability {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.PersonDisability Domain.Types.PersonDisability.PersonDisability
    where fromTType' (Beam.PersonDisabilityT {..}) = do pure $ Just Domain.Types.PersonDisability.PersonDisability{createdAt = Kernel.Prelude.fromMaybe updatedAt createdAt,
                                                                                                                   description = description,
                                                                                                                   disabilityId = disabilityId,
                                                                                                                   personId = Kernel.Types.Id.Id personId,
                                                                                                                   tag = tag,
                                                                                                                   updatedAt = updatedAt}
instance ToTType' Beam.PersonDisability Domain.Types.PersonDisability.PersonDisability
    where toTType' (Domain.Types.PersonDisability.PersonDisability {..}) = do Beam.PersonDisabilityT{Beam.createdAt = Kernel.Prelude.Just createdAt,
