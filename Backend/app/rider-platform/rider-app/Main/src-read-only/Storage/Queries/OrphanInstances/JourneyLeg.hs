...
instance FromTType' Beam.JourneyLeg Domain.Types.JourneyLeg.JourneyLeg
    where fromTType' (Beam.JourneyLegT {..}) = do {mbJourneyLegMapping <- Storage.Queries.JourneyLegMapping.findByJourneyLegId (Kernel.Types.Id.Id id);
                                                   ...
                                                   pure $ Just Domain.Types.JourneyLeg.JourneyLeg{agency = (Kernel.External.MultiModal.Interface.Types.MultiModalAgency agencyGtfsId <$> agencyName),
                                                                                                  ...
                                                                                                  createdAt = createdAt,
                                                                                                  updatedAt = updatedAt}}
instance ToTType' Beam.JourneyLeg Domain.Types.JourneyLeg.JourneyLeg
    where toTType' (Domain.Types.JourneyLeg.JourneyLeg {..}) = do Beam.JourneyLegT{Beam.agencyGtfsId = (agency >>= (.gtfsId)),
                                                                                   ...
                                                                                   Beam.busTagNumber = busTagNumber,
