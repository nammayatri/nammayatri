...
instance FromTType' Beam.ServicePeopleCategory Domain.Types.ServicePeopleCategory.ServicePeopleCategory
    where fromTType' (Beam.ServicePeopleCategoryT {..}) = do pure $ Just Domain.Types.ServicePeopleCategory.ServicePeopleCategory{cancellationCharges = getCancellationChargesFromTable cancellationCharges,
                                                                                                                                  ...
                                                                                                                                  createdAt = createdAt,
                                                                                                                                  updatedAt = updatedAt}
instance ToTType' Beam.ServicePeopleCategory Domain.Types.ServicePeopleCategory.ServicePeopleCategory
    where toTType' (Domain.Types.ServicePeopleCategory.ServicePeopleCategory {..}) = do Beam.ServicePeopleCategoryT{Beam.cancellationCharges = convertCancellationChargesToTable cancellationCharges,
