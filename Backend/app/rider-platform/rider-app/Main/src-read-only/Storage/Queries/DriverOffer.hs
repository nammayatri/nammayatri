...
updateByPrimaryKey (Domain.Types.DriverOffer.DriverOffer {..}) = do {_now <- getCurrentTime;
                                                                     updateWithKV [Se.Set Beam.bppQuoteId bppQuoteId,
                                                                                   ...
                                                                                   Se.Set Beam.isUpgradedToCab isUpgradedToCab,
...
instance FromTType' Beam.DriverOffer Domain.Types.DriverOffer.DriverOffer
    where fromTType' (Beam.DriverOfferT {..}) = do pure $ Just Domain.Types.DriverOffer.DriverOffer{bppQuoteId = bppQuoteId,
                                                                                                    ...
                                                                                                    updatedAt = updatedAt,
                                                                                                    validTill = validTill}
instance ToTType' Beam.DriverOffer Domain.Types.DriverOffer.DriverOffer
    where toTType' (Domain.Types.DriverOffer.DriverOffer {..}) = do Beam.DriverOfferT{Beam.bppQuoteId = bppQuoteId,
                                                                                      ...
                                                                                      Beam.fareProductType = fareProductType,
                                                                                      Beam.id = Kernel.Types.Id.getId id,
                                                                                      Beam.isUpgradedToCab = isUpgradedToCab,
