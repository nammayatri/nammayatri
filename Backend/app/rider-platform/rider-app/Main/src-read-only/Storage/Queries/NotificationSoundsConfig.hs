...
findByNotificationType :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByNotificationType notificationType merchantOperatingCityId = do findOneWithKV [Se.And [Se.Is Beam.notificationType $ Se.Eq notificationType,
...
findByPrimaryKey merchantOperatingCityId notificationType = do findOneWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
updateByPrimaryKey (Domain.Types.NotificationSoundsConfig.NotificationSoundsConfig {..}) = do {_now <- getCurrentTime;
                                                                                               updateWithKV [Se.Set Beam.blindSound blindSound,
                                                                                                             Se.Set Beam.defaultSound defaultSound,
                                                                                                             Se.Set Beam.merchantId (Kernel.Types.Id.getId merchantId),
                                                                                                             Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId), Se.Is Beam.notificationType $ Se.Eq notificationType]]}



instance FromTType' Beam.NotificationSoundsConfig Domain.Types.NotificationSoundsConfig.NotificationSoundsConfig
    where fromTType' (Beam.NotificationSoundsConfigT {..}) = do pure $ Just Domain.Types.NotificationSoundsConfig.NotificationSoundsConfig{blindSound = blindSound,
                                                                                                                                           ...
                                                                                                                                           createdAt = createdAt,
                                                                                                                                           updatedAt = updatedAt}
instance ToTType' Beam.NotificationSoundsConfig Domain.Types.NotificationSoundsConfig.NotificationSoundsConfig
    where toTType' (Domain.Types.NotificationSoundsConfig.NotificationSoundsConfig {..}) = do Beam.NotificationSoundsConfigT{Beam.blindSound = blindSound,
