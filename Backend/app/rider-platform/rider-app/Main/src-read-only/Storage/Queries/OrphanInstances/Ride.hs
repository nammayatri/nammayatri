      ...
      Just
        Domain.Types.Ride.Ride
          { allowedEditLocationAttempts = allowedEditLocationAttempts,
            ...
            cancellationFeeImmediateCapture = cancellationFeeImmediateCapture,
            ...
            driverArrivalStatus = driverArrivalStatus,
  ...
  toTType' (Domain.Types.Ride.Ride {..}) = do
    Beam.RideT
      { Beam.allowedEditLocationAttempts = allowedEditLocationAttempts,
        ...
        Beam.cancellationFeeImmediateCapture = cancellationFeeImmediateCapture,
        ...
        Beam.driverArrivalStatus = driverArrivalStatus,
