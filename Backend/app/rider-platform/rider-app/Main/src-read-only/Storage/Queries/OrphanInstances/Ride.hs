      ...
      Just
        Domain.Types.Ride.Ride
          { allowedEditLocationAttempts = allowedEditLocationAttempts,
            ...
            pickupEtaLogicVersion = pickupEtaLogicVersion,
            pickupRouteCallCount = pickupRouteCallCount,
            pickupSpeedInMPS = pickupSpeedInMPS,
  ...
  toTType' (Domain.Types.Ride.Ride {..}) = do
    Beam.RideT
      { Beam.allowedEditLocationAttempts = allowedEditLocationAttempts,
        ...
        Beam.driverCancellationDeductionOnPreviousRide = driverCancellationDeductionOnPreviousRide,
        ...
        Beam.pickupEtaLogicVersion = pickupEtaLogicVersion,
        Beam.pickupRouteCallCount = pickupRouteCallCount,
        Beam.pickupSpeedInMPS = pickupSpeedInMPS,
        Beam.refundRequestStatus = refundRequestStatus,
