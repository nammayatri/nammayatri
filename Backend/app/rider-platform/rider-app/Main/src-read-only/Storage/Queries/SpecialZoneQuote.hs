...
updateByPrimaryKey (Domain.Types.SpecialZoneQuote.SpecialZoneQuote {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.SpecialZoneQuote Domain.Types.SpecialZoneQuote.SpecialZoneQuote
    where fromTType' (Beam.SpecialZoneQuoteT {..}) = do {createdAt' <- getCreatedAt createdAt;
...
instance ToTType' Beam.SpecialZoneQuote Domain.Types.SpecialZoneQuote.SpecialZoneQuote
    where toTType' (Domain.Types.SpecialZoneQuote.SpecialZoneQuote {..}) = do Beam.SpecialZoneQuoteT{Beam.createdAt = Kernel.Prelude.Just createdAt,
