...
instance FromTType' Beam.BBPS Domain.Types.BBPS.BBPS
    where fromTType' (Beam.BBPST {..}) = do pure $ Just Domain.Types.BBPS.BBPS{amount = amount,
                                                                               billerId = billerId,
                                                                               ...
                                                                               createdAt = createdAt,
                                                                               updatedAt = updatedAt}
instance ToTType' Beam.BBPS Domain.Types.BBPS.BBPS
    where toTType' (Domain.Types.BBPS.BBPS {..}) = do Beam.BBPST{Beam.amount = amount,
