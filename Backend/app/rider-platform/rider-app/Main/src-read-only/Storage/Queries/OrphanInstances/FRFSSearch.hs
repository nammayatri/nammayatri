...
instance FromTType' Beam.FRFSSearch Domain.Types.FRFSSearch.FRFSSearch
    where fromTType' (Beam.FRFSSearchT {..}) = do pure $ Just Domain.Types.FRFSSearch.FRFSSearch{busLocationData = fromMaybe [] (Kernel.Utils.JSON.valueToMaybe =<< busLocationData),
                                                                                                 cloudType = cloudType,
                                                                                                 ...
                                                                                                 createdAt = createdAt,
                                                                                                 updatedAt = updatedAt}
instance ToTType' Beam.FRFSSearch Domain.Types.FRFSSearch.FRFSSearch
    where toTType' (Domain.Types.FRFSSearch.FRFSSearch {..}) = do Beam.FRFSSearchT{Beam.busLocationData = Just $ toJSON busLocationData,
