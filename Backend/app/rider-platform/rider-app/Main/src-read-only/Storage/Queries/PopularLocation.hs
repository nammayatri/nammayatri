...
updateByPrimaryKey (Domain.Types.PopularLocation.PopularLocation {..}) = do {_now <- getCurrentTime;
                                                                             updateWithKV [Se.Set Beam.address address,
                                                                                           ...
                                                                                           Se.Set Beam.merchantId (Kernel.Types.Id.getId <$> merchantId)] [Se.And [Se.Is Beam.id $ Se.Eq id]]}
