...
findByCityIdAndVehicleCategory :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByCityIdAndVehicleCategory merchantOperatingCityId vehicleCategory = do findOneWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
                                                                                                   Se.Is Beam.vehicleCategory $ Se.Eq vehicleCategory]]
findByMerchantOpCityIdAndIsPayoutEnabledAndPayoutEntity :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMerchantOpCityIdAndIsPayoutEnabledAndPayoutEntity merchantOperatingCityId isPayoutEnabled payoutEntity = do findOneWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
