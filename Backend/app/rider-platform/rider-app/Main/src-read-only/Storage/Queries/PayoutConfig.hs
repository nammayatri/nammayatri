...
updateByPrimaryKey (Domain.Types.PayoutConfig.PayoutConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.batchLimit batchLimit,
      ...
      Se.Set Beam.scheduleCashbackPayoutAfter (Just scheduleCashbackPayoutAfter),
      ...
      Just
        Domain.Types.PayoutConfig.PayoutConfig
          { batchLimit = batchLimit,
            ...
            remark = remark,
            scheduleCashbackPayoutAfter = fromMaybe 86400 scheduleCashbackPayoutAfter,
  ...
  toTType' (Domain.Types.PayoutConfig.PayoutConfig {..}) = do
    Beam.PayoutConfigT
      { Beam.batchLimit = batchLimit,
        ...
        Beam.remark = remark,
        Beam.scheduleCashbackPayoutAfter = Just scheduleCashbackPayoutAfter,
