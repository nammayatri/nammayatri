...
updateByPrimaryKey (Domain.Types.JourneyFeedback.JourneyFeedback {..}) = do {_now <- getCurrentTime;
                                                                             updateWithKV [Se.Set Beam.additionalFeedBack additionalFeedBack,
                                                                                           Se.Set Beam.rating rating,
                                                                                           Se.Set Beam.riderId (Kernel.Types.Id.getId riderId),
                                                                                           Se.Set Beam.merchantId (Kernel.Types.Id.getId <$> merchantId),
                                                                                           Se.Set Beam.merchantOperatingCityId (Kernel.Types.Id.getId <$> merchantOperatingCityId),
                                                                                           Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.journeyId $ Se.Eq (Kernel.Types.Id.getId journeyId)]]}



instance FromTType' Beam.JourneyFeedback Domain.Types.JourneyFeedback.JourneyFeedback
    where fromTType' (Beam.JourneyFeedbackT {..}) = do pure $ Just Domain.Types.JourneyFeedback.JourneyFeedback{additionalFeedBack = additionalFeedBack,
                                                                                                                ...
                                                                                                                createdAt = createdAt,
                                                                                                                updatedAt = updatedAt}
instance ToTType' Beam.JourneyFeedback Domain.Types.JourneyFeedback.JourneyFeedback
    where toTType' (Domain.Types.JourneyFeedback.JourneyFeedback {..}) = do Beam.JourneyFeedbackT{Beam.additionalFeedBack = additionalFeedBack,
