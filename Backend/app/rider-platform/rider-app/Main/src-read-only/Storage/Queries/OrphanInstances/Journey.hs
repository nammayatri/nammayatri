...
instance FromTType' Beam.Journey Domain.Types.Journey.Journey
    where fromTType' (Beam.JourneyT {..}) = do {fromLocation' <- Storage.Queries.Transformers.Journey.getLocation fromLocationId fromLocationAddress;
                                                toLocation' <- Just <$> Storage.Queries.Transformers.Journey.getLocation toLocationId toLocationAddress;
                                                pure $ Just Domain.Types.Journey.Journey{convenienceCost = convenienceCost,
                                                                                         endTime = endTime,
                                                                                         ...
                                                                                         createdAt = createdAt,
                                                                                         updatedAt = updatedAt}}
instance ToTType' Beam.Journey Domain.Types.Journey.Journey
    where toTType' (Domain.Types.Journey.Journey {..}) = do Beam.JourneyT{Beam.convenienceCost = convenienceCost,
