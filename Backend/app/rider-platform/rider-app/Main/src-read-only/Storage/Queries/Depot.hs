...
updateByPrimaryKey (Domain.Types.Depot.Depot {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.Depot Domain.Types.Depot.Depot
    where fromTType' (Beam.DepotT {..}) = do pure $ Just Domain.Types.Depot.Depot{createdAt = createdAt,
                                                                                  id = Kernel.Types.Id.Id id,
                                                                                  merchantId = Kernel.Types.Id.Id merchantId,
                                                                                  merchantOperatingCityId = Kernel.Types.Id.Id merchantOperatingCityId,
                                                                                  name = name,
                                                                                  updatedAt = updatedAt}
instance ToTType' Beam.Depot Domain.Types.Depot.Depot
    where toTType' (Domain.Types.Depot.Depot {..}) = do Beam.DepotT{Beam.createdAt = createdAt,
