...
findAllByQuoteId limit offset quoteId = do findAllWithOptionsKV [Se.Is Beam.quoteId $ Se.Eq (Kernel.Types.Id.getId quoteId)] (Se.Desc Beam.categoryOrder) limit offset
      ...
      Just
        Domain.Types.FRFSQuoteCategory.FRFSQuoteCategory
          { bppItemId = bppItemId,
            ...
            categoryMeta = Storage.Queries.Transformers.FRFSQuoteCategory.mkQuoteCategoryMetadata code title description tnc categoryOrder,
