...
findByPhoneNumberAndUpdate :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByPhoneNumberAndUpdate personName personGender personDob aadhaarNumberHash isVerified personId = do {_now <- getCurrentTime;
                                                                                                         updateWithKV [Se.Set Beam.personName personName,
...
updatePersonImagePath personImagePath personId = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.AadhaarVerification.AadhaarVerification {..}) = do {_now <- getCurrentTime;
                                                                                     updateWithKV [Se.Set Beam.aadhaarNumberHash aadhaarNumberHash,
                                                                                                   Se.Set Beam.isVerified isVerified,
                                                                                                   Se.Set Beam.personDob personDob,
                                                                                                   Se.Set Beam.personGender personGender,
...
instance FromTType' Beam.AadhaarVerification Domain.Types.AadhaarVerification.AadhaarVerification
    where fromTType' (Beam.AadhaarVerificationT {..}) = do pure $ Just Domain.Types.AadhaarVerification.AadhaarVerification{aadhaarNumberHash = aadhaarNumberHash,
                                                                                                                            createdAt = createdAt,
                                                                                                                            ...
                                                                                                                            updatedAt = updatedAt}
instance ToTType' Beam.AadhaarVerification Domain.Types.AadhaarVerification.AadhaarVerification
    where toTType' (Domain.Types.AadhaarVerification.AadhaarVerification {..}) = do Beam.AadhaarVerificationT{Beam.aadhaarNumberHash = aadhaarNumberHash,
