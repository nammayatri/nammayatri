...
updateByPrimaryKey (Domain.Types.OnSearchEvent.OnSearchEvent {..}) = do {_now <- getCurrentTime;
                                                                         updateWithKV [Se.Set Beam.bppId bppId,
...
instance FromTType' Beam.OnSearchEvent Domain.Types.OnSearchEvent.OnSearchEvent
    where fromTType' (Beam.OnSearchEventT {..}) = do pure $ Just Domain.Types.OnSearchEvent.OnSearchEvent{bppId = bppId,
                                                                                                          createdAt = createdAt,
                                                                                                          errorCode = errorCode,
                                                                                                          ...
                                                                                                          messageId = messageId,
                                                                                                          updatedAt = updatedAt}
instance ToTType' Beam.OnSearchEvent Domain.Types.OnSearchEvent.OnSearchEvent
    where toTType' (Domain.Types.OnSearchEvent.OnSearchEvent {..}) = do Beam.OnSearchEventT{Beam.bppId = bppId,
