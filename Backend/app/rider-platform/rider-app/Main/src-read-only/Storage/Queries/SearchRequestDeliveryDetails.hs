      ...
      Just
        Domain.Types.SearchRequestDeliveryDetails.SearchRequestDeliveryDetails
          { initiatedAs = initiatedAs,
            receiverDetails = Domain.Types.DeliveryPersonDetails.DeliveryPersonDetails receiverName (EncryptedHashed (Encrypted receiverPhoneNumberEncrypted) receiverPhoneNumberHash),
            searchRequestId = searchRequestId,
            senderDetails = Domain.Types.DeliveryPersonDetails.DeliveryPersonDetails senderName (EncryptedHashed (Encrypted senderPhoneNumberEncrypted) senderPhoneNumberHash),
            createdAt = createdAt,
            updatedAt = updatedAt
          }
