...
instance FromTType' Beam.PersonStats Domain.Types.PersonStats.PersonStats
    where fromTType' (Beam.PersonStatsT {..}) = do pure $ Just Domain.Types.PersonStats.PersonStats{backlogPayoutAmount = Kernel.Prelude.fromMaybe 0 backlogPayoutAmount,
...
instance ToTType' Beam.PersonStats Domain.Types.PersonStats.PersonStats
    where toTType' (Domain.Types.PersonStats.PersonStats {..}) = do Beam.PersonStatsT{Beam.backlogPayoutAmount = Kernel.Prelude.Just backlogPayoutAmount,
