...
instance FromTType' Beam.Pass Domain.Types.Pass.Pass
    where fromTType' (Beam.PassT {..}) = do pure $ Just Domain.Types.Pass.Pass{amount = amount,
                                                                               ...
                                                                               createdAt = createdAt,
                                                                               updatedAt = updatedAt}
instance ToTType' Beam.Pass Domain.Types.Pass.Pass
    where toTType' (Domain.Types.Pass.Pass {..}) = do Beam.PassT{Beam.amount = amount,
