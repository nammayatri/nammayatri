      ...
      Just
        Domain.Types.Pass.Pass
          { amount = amount,
            ...
            dynamicPricingConfigJson = dynamicPricingConfigJson,
  ...
  toTType' (Domain.Types.Pass.Pass {..}) = do
    Beam.PassT
      { Beam.amount = amount,
        ...
        Beam.dynamicPricingConfigJson = dynamicPricingConfigJson,
        Beam.dynamicPricingEnabled = dynamicPricingEnabled,
        Beam.enable = enable,
