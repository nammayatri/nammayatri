...
instance FromTType' Beam.EDCMachineMapping Domain.Types.EDCMachineMapping.EDCMachineMapping
    where fromTType' (Beam.EDCMachineMappingT {..}) = do pure $ Just Domain.Types.EDCMachineMapping.EDCMachineMapping{clientId = clientId,
                                                                                                                      createdAt = createdAt,
                                                                                                                      ...
                                                                                                                      updatedAt = updatedAt}
instance ToTType' Beam.EDCMachineMapping Domain.Types.EDCMachineMapping.EDCMachineMapping
    where toTType' (Domain.Types.EDCMachineMapping.EDCMachineMapping {..}) = do Beam.EDCMachineMappingT{Beam.clientId = clientId,
