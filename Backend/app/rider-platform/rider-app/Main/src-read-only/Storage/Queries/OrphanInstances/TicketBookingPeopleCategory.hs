...
instance FromTType' Beam.TicketBookingPeopleCategory Domain.Types.TicketBookingPeopleCategory.TicketBookingPeopleCategory
    where fromTType' (Beam.TicketBookingPeopleCategoryT {..}) = do pure $ Just Domain.Types.TicketBookingPeopleCategory.TicketBookingPeopleCategory{amountToRefund = amountToRefund,
                                                                                                                                                    ...
                                                                                                                                                    createdAt = createdAt,
                                                                                                                                                    updatedAt = updatedAt}
instance ToTType' Beam.TicketBookingPeopleCategory Domain.Types.TicketBookingPeopleCategory.TicketBookingPeopleCategory
    where toTType' (Domain.Types.TicketBookingPeopleCategory.TicketBookingPeopleCategory {..}) = do Beam.TicketBookingPeopleCategoryT{Beam.amountToRefund = amountToRefund,
