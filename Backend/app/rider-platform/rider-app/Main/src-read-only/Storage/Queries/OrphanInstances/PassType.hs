      ...
      Just
        Domain.Types.PassType.PassType
          { catchline = catchline,
            ...
            maxPhotoChangeLimit = maxPhotoChangeLimit,
            ...
            passEnum = passEnum,
            photoReUploadTimeLimit = photoReUploadTimeLimit,
            title = title,
            createdAt = createdAt,
            updatedAt = updatedAt
          }
  ...
  toTType' (Domain.Types.PassType.PassType {..}) = do
    Beam.PassTypeT
      { Beam.catchline = catchline,
        ...
        Beam.maxPhotoChangeLimit = maxPhotoChangeLimit,
        ...
        Beam.photoReUploadTimeLimit = photoReUploadTimeLimit,
        Beam.title = title,
