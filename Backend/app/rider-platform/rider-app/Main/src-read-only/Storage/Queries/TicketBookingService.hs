...
findByShortId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateAllStatusByBookingId status ticketBookingId = do {_now <- getCurrentTime;
...
updateAssignmentById assignmentId id = do {_now <- getCurrentTime;
...
updateVerificationById :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateVerificationById status verificationCount id = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.TicketBookingService.TicketBookingService {..}) = do {_now <- getCurrentTime;
