...
getTicketServicesByPlaceIdAndSubPlaceId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByPrimaryKey (Domain.Types.TicketService.TicketService {..}) = do {_now <- getCurrentTime;
                                                                         updateWithKV [Se.Set Beam.allowCancellation allowCancellation,
