...
findByPlacesIdAndService placesId service = do findOneWithDb [Se.And [Se.Is Beam.placesId $ Se.Eq placesId, Se.Is Beam.service $ Se.Eq service]]
...
getTicketServicesByPlaceId placesId = do findAllWithDb [Se.Is Beam.placesId $ Se.Eq placesId]
