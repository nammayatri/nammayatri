...
updateAdvancedBookingEnabled isAdvanceBookingEnabled (Kernel.Types.Id.Id id) = do updateOneWithKV [Se.Set Beam.isAdvanceBookingEnabled isAdvanceBookingEnabled] [Se.Is Beam.id $ Se.Eq id]
