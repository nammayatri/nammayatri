...
updateRiderPreferredOption :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateTotalRidesCount :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateTotalRidesCount id totalRidesCount riderId = do updateOneWithKV [Se.Set Beam.id (Kernel.Types.Id.getId id),
                                                                       Se.Set Beam.totalRidesCount totalRidesCount] [Se.Is Beam.riderId $ Se.Eq (Kernel.Types.Id.getId riderId)]
