...
findAllByPaymentIds ::
  (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
  ([Kernel.Types.Id.Id Domain.Types.FRFSTicketBookingPayment.FRFSTicketBookingPayment] -> m [Domain.Types.FRFSTicketBookingPaymentCategory.FRFSTicketBookingPaymentCategory])
findAllByPaymentIds frfsTicketBookingPaymentId = do findAllWithKV [Se.Is Beam.frfsTicketBookingPaymentId $ Se.In (Kernel.Types.Id.getId <$> frfsTicketBookingPaymentId)]
