...
findAllByPaymentId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByPrimaryKey (Domain.Types.FRFSTicketBookingPaymentCategory.FRFSTicketBookingPaymentCategory {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.FRFSTicketBookingPaymentCategory Domain.Types.FRFSTicketBookingPaymentCategory.FRFSTicketBookingPaymentCategory
    where fromTType' (Beam.FRFSTicketBookingPaymentCategoryT {..}) = do pure $ Just Domain.Types.FRFSTicketBookingPaymentCategory.FRFSTicketBookingPaymentCategory{bppItemId = bppItemId,
                                                                                                                                                                   ...
                                                                                                                                                                   createdAt = createdAt,
                                                                                                                                                                   updatedAt = updatedAt}
instance ToTType' Beam.FRFSTicketBookingPaymentCategory Domain.Types.FRFSTicketBookingPaymentCategory.FRFSTicketBookingPaymentCategory
    where toTType' (Domain.Types.FRFSTicketBookingPaymentCategory.FRFSTicketBookingPaymentCategory {..}) = do Beam.FRFSTicketBookingPaymentCategoryT{Beam.bppItemId = bppItemId,
