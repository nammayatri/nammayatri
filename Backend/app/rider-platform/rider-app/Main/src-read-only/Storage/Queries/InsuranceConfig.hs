...
findByMerchantIdAndMerchantOperatingCityIdAndTripCategoryAndVehicleCategory :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMerchantIdAndMerchantOperatingCityIdAndTripCategoryAndVehicleCategory merchantId merchantOperatingCityId tripCategory vehicleCategory = do findOneWithKV [Se.And [Se.Is Beam.merchantId $ Se.Eq (Kernel.Types.Id.getId merchantId),
...
updateByPrimaryKey (Domain.Types.InsuranceConfig.InsuranceConfig {..}) = do {_now <- getCurrentTime;
                                                                             updateWithKV [Se.Set Beam.allowedVehicleServiceTiers allowedVehicleServiceTiers,
...
instance FromTType' Beam.InsuranceConfig Domain.Types.InsuranceConfig.InsuranceConfig
    where fromTType' (Beam.InsuranceConfigT {..}) = do pure $ Just Domain.Types.InsuranceConfig.InsuranceConfig{allowedVehicleServiceTiers = allowedVehicleServiceTiers,
                                                                                                                city = city,
                                                                                                                createdAt = createdAt,
...
instance ToTType' Beam.InsuranceConfig Domain.Types.InsuranceConfig.InsuranceConfig
    where toTType' (Domain.Types.InsuranceConfig.InsuranceConfig {..}) = do Beam.InsuranceConfigT{Beam.allowedVehicleServiceTiers = allowedVehicleServiceTiers,
                                                                                                  Beam.city = city,
