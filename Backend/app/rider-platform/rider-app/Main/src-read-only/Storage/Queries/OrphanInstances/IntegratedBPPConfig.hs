      ...
      Just
        Domain.Types.IntegratedBPPConfig.IntegratedBPPConfig
          { agencyKey = agencyKey,
            domain = domain,
            feedKey = feedKey,
            filterQuotesOnApplicableServiceTypes = filterQuotesOnApplicableServiceTypes,
  ...
  toTType' (Domain.Types.IntegratedBPPConfig.IntegratedBPPConfig {..}) = do
    Beam.IntegratedBPPConfigT
      { Beam.agencyKey = agencyKey,
        ...
        Beam.filterQuotesOnApplicableServiceTypes = filterQuotesOnApplicableServiceTypes,
