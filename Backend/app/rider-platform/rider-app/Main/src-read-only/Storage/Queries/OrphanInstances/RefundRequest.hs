...
instance FromTType' Beam.RefundRequest Domain.Types.RefundRequest.RefundRequest
    where fromTType' (Beam.RefundRequestT {..}) = do pure $ Just Domain.Types.RefundRequest.RefundRequest{code = code,
                                                                                                          currency = currency,
                                                                                                          ...
                                                                                                          createdAt = createdAt,
                                                                                                          updatedAt = updatedAt}
instance ToTType' Beam.RefundRequest Domain.Types.RefundRequest.RefundRequest
    where toTType' (Domain.Types.RefundRequest.RefundRequest {..}) = do Beam.RefundRequestT{Beam.code = code,
