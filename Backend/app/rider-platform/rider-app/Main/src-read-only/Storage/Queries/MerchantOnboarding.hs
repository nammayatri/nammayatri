...
findAllByOnboardingType :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByRequestorIdAndOnboardingType :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateOnboardingStatus :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateOnboardingStatusAndRemarks :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateOnboardingStatusAndRemarks status remarks id = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.MerchantOnboarding.MerchantOnboarding {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.MerchantOnboarding Domain.Types.MerchantOnboarding.MerchantOnboarding
    where fromTType' (Beam.MerchantOnboardingT {..}) = do pure $ Just Domain.Types.MerchantOnboarding.MerchantOnboarding{createdAt = createdAt,
                                                                                                                         ...
                                                                                                                         status = status,
                                                                                                                         updatedAt = updatedAt}
instance ToTType' Beam.MerchantOnboarding Domain.Types.MerchantOnboarding.MerchantOnboarding
    where toTType' (Domain.Types.MerchantOnboarding.MerchantOnboarding {..}) = do Beam.MerchantOnboardingT{Beam.createdAt = createdAt,
