...
instance FromTType' Beam.Rating Domain.Types.Rating.Rating
    where fromTType' (Beam.RatingT {..}) = do pure $ Just Domain.Types.Rating.Rating{createdAt = createdAt,
...
instance ToTType' Beam.Rating Domain.Types.Rating.Rating
    where toTType' (Domain.Types.Rating.Rating {..}) = do Beam.RatingT{Beam.createdAt = createdAt,
