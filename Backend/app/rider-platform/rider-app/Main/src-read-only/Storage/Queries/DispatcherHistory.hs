...
updateByPrimaryKey (Domain.Types.DispatcherHistory.DispatcherHistory {..}) = do {_now <- getCurrentTime;
                                                                                 updateWithKV [Se.Set Beam.conductorCode conductorCode,
                                                                                               ...
                                                                                               Se.Set Beam.waybillNo waybillNo] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]}



instance FromTType' Beam.DispatcherHistory Domain.Types.DispatcherHistory.DispatcherHistory
    where fromTType' (Beam.DispatcherHistoryT {..}) = do pure $ Just Domain.Types.DispatcherHistory.DispatcherHistory{conductorCode = conductorCode,
                                                                                                                      createdAt = createdAt,
                                                                                                                      ...
                                                                                                                      updatedAt = updatedAt,
                                                                                                                      waybillNo = waybillNo}
instance ToTType' Beam.DispatcherHistory Domain.Types.DispatcherHistory.DispatcherHistory
    where toTType' (Domain.Types.DispatcherHistory.DispatcherHistory {..}) = do Beam.DispatcherHistoryT{Beam.conductorCode = conductorCode,
