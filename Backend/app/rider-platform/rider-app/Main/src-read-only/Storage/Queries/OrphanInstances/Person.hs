...
instance FromTType' Beam.Person Domain.Types.Person.Person
    where fromTType' (Beam.PersonT {..}) = do {updateMerchantOpIdAndCity <- Storage.Queries.Transformers.Person.backfillCityAndMOCId currentCity merchantOperatingCityId merchantId;
                                               ...
                                               pure $ Just Domain.Types.Person.Person{aadhaarVerified = aadhaarVerified,
                                                                                      androidId = androidId,
                                                                                      ...
                                                                                      customerTestPaymentId = customerTestPaymentId,
                                                                                      dateOfBirth = dateOfBirth,
                                                                                      defaultPaymentMethodId = defaultPaymentMethodId,
                                                                                      defaultTestPaymentMethodId = defaultTestPaymentMethodId,
...
instance ToTType' Beam.Person Domain.Types.Person.Person
    where toTType' (Domain.Types.Person.Person {..}) = do Beam.PersonT{Beam.aadhaarVerified = aadhaarVerified,
                                                                       ...
                                                                       Beam.customerTestPaymentId = customerTestPaymentId,
                                                                       Beam.dateOfBirth = dateOfBirth,
                                                                       Beam.defaultPaymentMethodId = defaultPaymentMethodId,
                                                                       Beam.defaultTestPaymentMethodId = defaultTestPaymentMethodId,
