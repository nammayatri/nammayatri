...
updateByPrimaryKey (Domain.Types.AadhaarOtpReq.AadhaarOtpReq {..}) = do {_now <- getCurrentTime;
                                                                         updateWithKV [Se.Set Beam.personId (Kernel.Types.Id.getId personId),
...
instance FromTType' Beam.AadhaarOtpReq Domain.Types.AadhaarOtpReq.AadhaarOtpReq
    where fromTType' (Beam.AadhaarOtpReqT {..}) = do pure $ Just Domain.Types.AadhaarOtpReq.AadhaarOtpReq{createdAt = createdAt,
...
instance ToTType' Beam.AadhaarOtpReq Domain.Types.AadhaarOtpReq.AadhaarOtpReq
    where toTType' (Domain.Types.AadhaarOtpReq.AadhaarOtpReq {..}) = do Beam.AadhaarOtpReqT{Beam.createdAt = createdAt,
