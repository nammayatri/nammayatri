...
updateByPrimaryKey (Domain.Types.HotSpotConfig.HotSpotConfig {..}) = do updateWithKV [Se.Set Beam.blockRadius blockRadius,
                                                                                      ...
                                                                                      Se.Set Beam.weightOfTripStart weightOfTripStart] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]



instance FromTType' Beam.HotSpotConfig Domain.Types.HotSpotConfig.HotSpotConfig
    where fromTType' (Beam.HotSpotConfigT {..}) = do pure $ Just Domain.Types.HotSpotConfig.HotSpotConfig{blockRadius = blockRadius,
...
instance ToTType' Beam.HotSpotConfig Domain.Types.HotSpotConfig.HotSpotConfig
    where toTType' (Domain.Types.HotSpotConfig.HotSpotConfig {..}) = do Beam.HotSpotConfigT{Beam.blockRadius = blockRadius,
