...
updateByPrimaryKey (Domain.Types.LocationMapping.LocationMapping {..}) = do {_now <- getCurrentTime;
                                                                             updateWithKV [Se.Set Beam.entityId entityId,
                                                                                           ...
                                                                                           Se.Set Beam.version version] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]}
