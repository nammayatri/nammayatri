...
getLatestStartByEntityId :: (MonadFlow m, CacheFlow m r, EsqDBFlow m r) => Kernel.Prelude.Text -> Kernel.Prelude.Int -> Kernel.Prelude.Text -> m (Maybe (Domain.Types.LocationMapping.LocationMapping))
getLatestStartByEntityId entityId order version = do
  findOneWithKV
    [ Se.And
...
findByPrimaryKey :: (MonadFlow m, CacheFlow m r, EsqDBFlow m r) => Kernel.Types.Id.Id Domain.Types.LocationMapping.LocationMapping -> m (Maybe (Domain.Types.LocationMapping.LocationMapping))
...
updateByPrimaryKey :: (MonadFlow m, CacheFlow m r, EsqDBFlow m r) => Domain.Types.LocationMapping.LocationMapping -> m ()
