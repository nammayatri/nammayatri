...
instance FromTType' Beam.Quote Domain.Types.Quote.Quote
    where fromTType' (Beam.QuoteT {..}) = do {backendConfigVersion' <- (mapM Kernel.Utils.Version.readVersion (Data.Text.strip <$> backendConfigVersion));
                                              ...
                                              pure $ Just Domain.Types.Quote.Quote{backendAppVersion = backendAppVersion,
...
instance ToTType' Beam.Quote Domain.Types.Quote.Quote
    where toTType' (Domain.Types.Quote.Quote {..}) = do Beam.QuoteT{Beam.backendAppVersion = backendAppVersion,
