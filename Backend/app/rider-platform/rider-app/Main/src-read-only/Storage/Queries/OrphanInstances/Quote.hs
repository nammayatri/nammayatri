      ...
      Just
        Domain.Types.Quote.Quote
          { backendAppVersion = backendAppVersion,
            ...
            stateEntryPermitChargesInfo = mkStateEntryPermitChargesInfo stateEntryPermitCharges stateEntryPermitNames currency,
  ...
  toTType' (Domain.Types.Quote.Quote {..}) = do
    Beam.QuoteT
      { Beam.backendAppVersion = backendAppVersion,
        ...
        Beam.stateEntryPermitCharges = ((stateEntryPermitChargesInfo <&> ((.amount) . (.stateEntryPermitCharges)))),
        Beam.stateEntryPermitNames = (stateEntryPermitChargesInfo <&> (.stateEntryPermitNames)),
