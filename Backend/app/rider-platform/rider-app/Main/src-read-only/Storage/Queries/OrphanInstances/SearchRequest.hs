      ...
      Just
        Domain.Types.SearchRequest.SearchRequest
          { allJourneysLoaded = allJourneysLoaded,
            ...
            isPetRide = isPetRide,
            journeyLegInfo = Storage.Queries.Transformers.SearchRequest.mkJourneyLegInfo agency convenienceCost isDeleted journeyId journeyLegOrder onSearchFailed pricingId,
            language = language,
