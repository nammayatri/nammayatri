      ...
      Just
        Domain.Types.SearchRequest.SearchRequest
          { allJourneysLoaded = allJourneysLoaded,
            ...
            betterPointRideDistanceSaved = betterPointRideDistanceSaved,
            betterPointWalkFromDrop = betterPointWalkFromDrop,
            betterPointWalkToPickup = betterPointWalkToPickup,
            ...
            discoveredDropSpecialLocationId = discoveredDropSpecialLocationId,
            discoveredSpecialLocationId = discoveredSpecialLocationId,
            ...
            hasBetterPointSuggestion = hasBetterPointSuggestion,
            ...
            isPetRide = isPetRide,
            isWhatsappRequest = isWhatsappRequest,
            language = language,
            ...
            negativeFareAdjustment = Kernel.Utils.Common.mkPriceWithDefault negativeFareAdjustmentAmount currency <$> negativeFareAdjustment,
            offersFraudCheckFailureReason = offersFraudCheckFailureReason,
            onSearchFailed = onSearchFailed,
            originStopCode = originStopCode,
            parentSearchRequestId = Kernel.Types.Id.Id <$> parentSearchRequestId,
  ...
  toTType' (Domain.Types.SearchRequest.SearchRequest {..}) = do
    Beam.SearchRequestT
      { Beam.allJourneysLoaded = allJourneysLoaded,
        ...
        Beam.betterPointRideDistanceSaved = betterPointRideDistanceSaved,
        Beam.betterPointWalkFromDrop = betterPointWalkFromDrop,
        Beam.betterPointWalkToPickup = betterPointWalkToPickup,
        ...
        Beam.currency = maybe (negativeFareAdjustment <&> (.currency)) Just (customerExtraFee <&> (.currency)),
        ...
        Beam.discoveredDropSpecialLocationId = discoveredDropSpecialLocationId,
        Beam.discoveredSpecialLocationId = discoveredSpecialLocationId,
        ...
        Beam.hasBetterPointSuggestion = hasBetterPointSuggestion,
        ...
        Beam.isWhatsappRequest = isWhatsappRequest,
        ...
        Beam.negativeFareAdjustment = negativeFareAdjustment <&> (.amountInt),
        Beam.negativeFareAdjustmentAmount = negativeFareAdjustment <&> (.amount),
        ...
        Beam.parentSearchRequestId = Kernel.Types.Id.getId <$> parentSearchRequestId,
        ...
        Beam.routeCacheUsed = routeCacheUsed,
        Beam.routeCode = routeCode,
        Beam.searchMode = searchMode,
        Beam.selectedPaymentInstrument = selectedPaymentInstrument,
        Beam.selectedPaymentMethodId = selectedPaymentMethodId,
        Beam.startTime = startTime,
        Beam.syncSearch = syncSearch,
