...
instance FromTType' Beam.SearchRequest Domain.Types.SearchRequest.SearchRequest
    where fromTType' (Beam.SearchRequestT {..}) = do {backendConfigVersion' <- mapM Kernel.Utils.Version.readVersion (Data.Text.strip <$> backendConfigVersion);
                                                      ...
                                                      pure $ Just Domain.Types.SearchRequest.SearchRequest{allJourneysLoaded = allJourneysLoaded,
...
instance ToTType' Beam.SearchRequest Domain.Types.SearchRequest.SearchRequest
    where toTType' (Domain.Types.SearchRequest.SearchRequest {..}) = do Beam.SearchRequestT{Beam.allJourneysLoaded = allJourneysLoaded,
                                                                                            ...
                                                                                            Beam.preferredRouteId = preferredRouteId,
