      ...
      Just
        Domain.Types.SearchRequest.SearchRequest
          { allJourneysLoaded = allJourneysLoaded,
            ...
            isPetRide = isPetRide,
            journeyLegInfo = Storage.Queries.Transformers.SearchRequest.mkJourneyLegInfo agency convenienceCost isCompleted isDeleted journeyId journeyLegOrder onSearchFailed pricingId skipBooking,
            language = language,
  ...
  toTType' (Domain.Types.SearchRequest.SearchRequest {..}) = do
    Beam.SearchRequestT
      { Beam.allJourneysLoaded = allJourneysLoaded,
        ...
        Beam.isCompleted = journeyLegInfo >>= (.isCompleted),
