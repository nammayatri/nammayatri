...
updateStatusByTicketBookingId ticketStatus frfsTicketBookingId = do {_now <- getCurrentTime;
...
updateTOrderValueAndSettlementAmountById :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateTOrderValueAndSettlementAmountById settlementAmount totalOrderValue frfsTicketBookingId = do {_now <- getCurrentTime;
                                                                                                    updateWithKV [Se.Set Beam.settlementAmount ((.amount) settlementAmount),
                                                                                                                  Se.Set Beam.totalOrderValue ((.amount) totalOrderValue),
                                                                                                                  Se.Set Beam.updatedAt _now] [Se.Is Beam.frfsTicketBookingId $ Se.Eq (Kernel.Types.Id.getId frfsTicketBookingId)]}
...
updateByPrimaryKey (Domain.Types.FRFSRecon.FRFSRecon {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.FRFSRecon Domain.Types.FRFSRecon.FRFSRecon
    where fromTType' (Beam.FRFSReconT {..}) = do pure $ Just Domain.Types.FRFSRecon.FRFSRecon{beneficiaryBankAccount = beneficiaryBankAccount,
                                                                                              ...
                                                                                              createdAt = createdAt,
                                                                                              updatedAt = updatedAt}
instance ToTType' Beam.FRFSRecon Domain.Types.FRFSRecon.FRFSRecon
    where toTType' (Domain.Types.FRFSRecon.FRFSRecon {..}) = do Beam.FRFSReconT{Beam.beneficiaryBankAccount = beneficiaryBankAccount,
