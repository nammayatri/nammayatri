...
findAllByServiceCategoryId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateTicketPeopleUnitsAndAmountById :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateTicketPeopleUnitsAndAmountById numberOfUnitsCancelled amountToRefund id = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.TicketBookingPeopleCategory.TicketBookingPeopleCategory {..}) = do {_now <- getCurrentTime;
                                                                                                     updateWithKV [Se.Set Beam.amountToRefund amountToRefund,
