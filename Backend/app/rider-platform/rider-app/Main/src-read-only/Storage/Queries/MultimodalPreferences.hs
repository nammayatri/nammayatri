...
updateUserPreferences :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateUserPreferences allowedTransitModes journeyOptionsSortingType busTransitTypes subwayTransitTypes personId = do {_now <- getCurrentTime;
                                                                                                                      updateWithKV [Se.Set Beam.allowedTransitModes allowedTransitModes,
...
updateByPrimaryKey (Domain.Types.MultimodalPreferences.MultimodalPreferences {..}) = do {_now <- getCurrentTime;
                                                                                         updateWithKV [Se.Set Beam.allowedTransitModes allowedTransitModes,
                                                                                                       Se.Set Beam.busTransitTypes busTransitTypes,
                                                                                                       Se.Set Beam.journeyOptionsSortingType journeyOptionsSortingType,
                                                                                                       Se.Set Beam.subwayTransitTypes subwayTransitTypes,
...
instance FromTType' Beam.MultimodalPreferences Domain.Types.MultimodalPreferences.MultimodalPreferences
    where fromTType' (Beam.MultimodalPreferencesT {..}) = do pure $ Just Domain.Types.MultimodalPreferences.MultimodalPreferences{allowedTransitModes = allowedTransitModes,
                                                                                                                                  ...
                                                                                                                                  createdAt = createdAt,
                                                                                                                                  updatedAt = updatedAt}
instance ToTType' Beam.MultimodalPreferences Domain.Types.MultimodalPreferences.MultimodalPreferences
    where toTType' (Domain.Types.MultimodalPreferences.MultimodalPreferences {..}) = do Beam.MultimodalPreferencesT{Beam.allowedTransitModes = allowedTransitModes,
