...
updateAllowedTransitModesAndJourneyOptionsSortingType ::
  (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
  ([Domain.Types.Common.MultimodalTravelMode] -> Domain.Types.MultimodalPreferences.JourneyOptionsSortingType -> Kernel.Types.Id.Id Domain.Types.Person.Person -> m ())
updateAllowedTransitModesAndJourneyOptionsSortingType allowedTransitModes journeyOptionsSortingType personId = do
  _now <- getCurrentTime
  updateWithKV
