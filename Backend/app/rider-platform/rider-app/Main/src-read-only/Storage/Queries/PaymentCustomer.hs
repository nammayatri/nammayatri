...
findByPersonIdAndPaymentMode :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateDefaultPaymentMethodId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateDefaultPaymentMethodId defaultPaymentMethodId personId paymentMode = do {_now <- getCurrentTime;
                                                                               updateWithKV [Se.Set Beam.defaultPaymentMethodId defaultPaymentMethodId, Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.personId $ Se.Eq (Kernel.Types.Id.getId <$> personId),
                                                                                                                                                                                             Se.Is Beam.paymentMode $ Se.Eq paymentMode]]}
...
updateByPrimaryKey (Domain.Types.PaymentCustomer.PaymentCustomer {..}) = do {_now <- getCurrentTime;
                                                                             updateWithKV [Se.Set Beam.clientAuthToken clientAuthToken,
                                                                                           ...
                                                                                           Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.customerId $ Se.Eq customerId, Se.Is Beam.paymentMode $ Se.Eq paymentMode]]}
