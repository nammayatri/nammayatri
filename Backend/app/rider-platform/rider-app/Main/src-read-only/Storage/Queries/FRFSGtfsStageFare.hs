...
findAllByVehicleServiceTierId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByVehicleTypeAndStageAndMerchantOperatingCityId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByVehicleTypeAndStageAndMerchantOperatingCityId vehicleType stage merchantOperatingCityId = do findAllWithKV [Se.And [Se.Is Beam.vehicleType $ Se.Eq vehicleType,
                                                                                                                             Se.Is Beam.stage $ Se.Eq stage,
                                                                                                                             Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId)]]
findOneByVehicleTypeAndStageAndMerchantOperatingCityIdAndVehicleServiceTierId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findOneByVehicleTypeAndStageAndMerchantOperatingCityIdAndVehicleServiceTierId vehicleType stage merchantOperatingCityId vehicleServiceTierId = do findOneWithKV [Se.And [Se.Is Beam.vehicleType $ Se.Eq vehicleType,
                                                                                                                                                                         Se.Is Beam.stage $ Se.Eq stage,
                                                                                                                                                                         Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
updateByPrimaryKey (Domain.Types.FRFSGtfsStageFare.FRFSGtfsStageFare {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.FRFSGtfsStageFare Domain.Types.FRFSGtfsStageFare.FRFSGtfsStageFare
    where fromTType' (Beam.FRFSGtfsStageFareT {..}) = do pure $ Just Domain.Types.FRFSGtfsStageFare.FRFSGtfsStageFare{amount = amount,
                                                                                                                      ...
                                                                                                                      createdAt = createdAt,
                                                                                                                      updatedAt = updatedAt}
instance ToTType' Beam.FRFSGtfsStageFare Domain.Types.FRFSGtfsStageFare.FRFSGtfsStageFare
    where toTType' (Domain.Types.FRFSGtfsStageFare.FRFSGtfsStageFare {..}) = do Beam.FRFSGtfsStageFareT{Beam.amount = amount,
