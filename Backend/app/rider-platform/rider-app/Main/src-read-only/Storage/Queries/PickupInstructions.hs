...
findByPersonIdAndGeohash :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findOldestByPersonId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateInstructionById :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateInstructionById geohash instruction mediaFileId id = do {_now <- getCurrentTime;
                                                               updateOneWithKV [Se.Set Beam.geohash geohash,
...
updateMediaFileById :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateMediaFileById mediaFileId id = do {_now <- getCurrentTime;
...
instance FromTType' Beam.PickupInstructions Domain.Types.PickupInstructions.PickupInstructions
    where fromTType' (Beam.PickupInstructionsT {..}) = do pure $ Just Domain.Types.PickupInstructions.PickupInstructions{createdAt = createdAt,
                                                                                                                         geohash = geohash,
                                                                                                                         ...
                                                                                                                         updatedAt = updatedAt}
instance ToTType' Beam.PickupInstructions Domain.Types.PickupInstructions.PickupInstructions
    where toTType' (Domain.Types.PickupInstructions.PickupInstructions {..}) = do Beam.PickupInstructionsT{Beam.createdAt = createdAt,
