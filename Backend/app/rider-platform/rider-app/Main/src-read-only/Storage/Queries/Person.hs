...
import Storage.Queries.Transformers.Person
...
updateMultiple ::
  ...
  (Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Domain.Types.Person.Gender -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Domain.Types.Person.Role -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Types.Version.Version -> Kernel.Prelude.Maybe Kernel.Types.Version.Version -> Kernel.Types.Id.Id Domain.Types.Person.Person -> m ())
updateMultiple firstName middleName lastName gender description role identifier deviceToken clientVersion bundleVersion (Kernel.Types.Id.Id id) = do
  _now <- getCurrentTime
  updateOneWithKV
    [ Se.Set Beam.updatedAt _now,
      ...
      Se.Set Beam.clientVersion (Kernel.Prelude.fmap Kernel.Utils.Version.versionToText clientVersion),
...
updateByPrimaryKey (Domain.Types.Person.Person {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.aadhaarVerified aadhaarVerified,
      ...
      Se.Set Beam.currentCity (Just currentCity),
