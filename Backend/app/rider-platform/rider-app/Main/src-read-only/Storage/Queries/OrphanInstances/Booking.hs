      ...
      Just
        Domain.Types.Booking.Booking
          { backendAppVersion = backendAppVersion,
            ...
            parentSearchRequestLocationInfo = Kernel.Utils.JSON.valueToMaybe =<< parentSearchRequestLocationInfo,
            ...
            requiresPaymentBeforeConfirm = fromMaybe False requiresPaymentBeforeConfirm,
  ...
  toTType' (Domain.Types.Booking.Booking {..}) = do
    ...
    Beam.BookingT
      { Beam.backendAppVersion = backendAppVersion,
        ...
        Beam.bookingDepositAmount = bookingDepositAmount,
        ...
        Beam.driverPreference = driverPreference,
        ...
        Beam.parentSearchRequestLocationInfo = fmap toJSON parentSearchRequestLocationInfo,
        Beam.paymentCharge = paymentCharge,
        Beam.paymentChargeBearer = paymentChargeBearer,
        ...
        Beam.requiresPaymentBeforeConfirm = Kernel.Prelude.Just requiresPaymentBeforeConfirm,
        Beam.returnTime = returnTime,
        Beam.riderId = Kernel.Types.Id.getId riderId,
        Beam.roundTrip = roundTrip,
        Beam.selectedOfferId = selectedOfferId,
        ...
        Beam.specialLocationSupportNumber = specialLocationSupportNumber,
