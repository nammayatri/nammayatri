      ...
      Just
        Domain.Types.Booking.Booking
          { backendAppVersion = backendAppVersion,
            ...
            prioritizeDrivers = fmap Kernel.Types.Id.Id (fromMaybe [] prioritizeDrivers),
  ...
  toTType' (Domain.Types.Booking.Booking {..}) = do
    ...
    Beam.BookingT
      { Beam.backendAppVersion = backendAppVersion,
        ...
        Beam.prioritizeDrivers = if null prioritizeDrivers then Nothing else Just (fmap Kernel.Types.Id.getId prioritizeDrivers),
