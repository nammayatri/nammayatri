...
instance FromTType' Beam.Booking Domain.Types.Booking.Booking
    where fromTType' (Beam.BookingT {..}) = do {mappings <- Storage.Queries.LocationMapping.findByEntityId id;
                                                ...
                                                pure $ Just Domain.Types.Booking.Booking{backendAppVersion = backendAppVersion,
...
instance ToTType' Beam.Booking Domain.Types.Booking.Booking
    where toTType' (Domain.Types.Booking.Booking {..}) = do {let {distance = getDistance bookingDetails};
                                                             Beam.BookingT{Beam.backendAppVersion = backendAppVersion,
