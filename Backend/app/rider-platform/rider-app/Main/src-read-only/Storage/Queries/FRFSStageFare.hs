...
updateByPrimaryKey (Domain.Types.FRFSStageFare.FRFSStageFare {..}) = do {_now <- getCurrentTime;
                                                                         updateWithKV [Se.Set Beam.amount amount,
                                                                                       Se.Set Beam.currency currency,
                                                                                       Se.Set Beam.merchantId (Kernel.Types.Id.getId merchantId),
                                                                                       Se.Set Beam.merchantOperatingCityId (Kernel.Types.Id.getId merchantOperatingCityId),
                                                                                       Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.farePolicyId $ Se.Eq (Kernel.Types.Id.getId farePolicyId), Se.Is Beam.stage $ Se.Eq stage]]}



instance FromTType' Beam.FRFSStageFare Domain.Types.FRFSStageFare.FRFSStageFare
    where fromTType' (Beam.FRFSStageFareT {..}) = do pure $ Just Domain.Types.FRFSStageFare.FRFSStageFare{amount = amount,
                                                                                                          currency = currency,
                                                                                                          ...
                                                                                                          createdAt = createdAt,
                                                                                                          updatedAt = updatedAt}
instance ToTType' Beam.FRFSStageFare Domain.Types.FRFSStageFare.FRFSStageFare
    where toTType' (Domain.Types.FRFSStageFare.FRFSStageFare {..}) = do Beam.FRFSStageFareT{Beam.amount = amount,
