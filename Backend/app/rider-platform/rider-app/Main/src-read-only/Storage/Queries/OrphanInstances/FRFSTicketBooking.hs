      ...
      Just
        Domain.Types.FRFSTicketBooking.FRFSTicketBooking
          { _type = _type,
            ...
            overrideAppliedEntityId = overrideAppliedEntityId,
  ...
  toTType' (Domain.Types.FRFSTicketBooking.FRFSTicketBooking {..}) = do
    Beam.FRFSTicketBookingT
      { Beam._type = _type,
        ...
        Beam.osType = osType,
        Beam.overriddenAmount = overriddenAmount,
        Beam.overrideAppliedEntityId = overrideAppliedEntityId,
        Beam.overrideType = overrideType,
