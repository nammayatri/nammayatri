...
instance FromTType' Beam.FRFSTicketBooking Domain.Types.FRFSTicketBooking.FRFSTicketBooking
    where fromTType' (Beam.FRFSTicketBookingT {..}) = do pure $ Just Domain.Types.FRFSTicketBooking.FRFSTicketBooking{_type = _type,
                                                                                                                      ...
                                                                                                                      finalBoardedVehicleNumber = finalBoardedVehicleNumber,
                                                                                                                      finalBoardedVehicleNumberSource = finalBoardedVehicleNumberSource,
                                                                                                                      finalBoardedVehicleServiceTierType = finalBoardedVehicleServiceTierType,
                                                                                                                      ...
                                                                                                                      createdAt = createdAt,
                                                                                                                      updatedAt = updatedAt}
instance ToTType' Beam.FRFSTicketBooking Domain.Types.FRFSTicketBooking.FRFSTicketBooking
    where toTType' (Domain.Types.FRFSTicketBooking.FRFSTicketBooking {..}) = do Beam.FRFSTicketBookingT{Beam._type = _type,
                                                                                                        ...
                                                                                                        Beam.finalBoardedVehicleNumber = finalBoardedVehicleNumber,
                                                                                                        Beam.finalBoardedVehicleNumberSource = finalBoardedVehicleNumberSource,
                                                                                                        Beam.finalBoardedVehicleServiceTierType = finalBoardedVehicleServiceTierType,
