      ...
      Just
        Domain.Types.FRFSTicketBooking.FRFSTicketBooking
          { _type = _type,
            ...
            frfsTicketBookingPaymentIdForTicketGeneration = frfsTicketBookingPaymentIdForTicketGeneration,
  ...
  toTType' (Domain.Types.FRFSTicketBooking.FRFSTicketBooking {..}) = do
    Beam.FRFSTicketBookingT
      { Beam._type = _type,
        ...
        Beam.frfsTicketBookingPaymentIdForTicketGeneration = frfsTicketBookingPaymentIdForTicketGeneration,
