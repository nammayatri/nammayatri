...
updateByPrimaryKey (Domain.Types.RiderConfig.RiderConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.alwaysAllowedNotificationCategories (Just (map show alwaysAllowedNotificationCategories)),
      ...
      Se.Set Beam.betterPointLoadSuggestionsAsync betterPointLoadSuggestionsAsync,
      Se.Set Beam.betterPointMaxOffRouteDistance betterPointMaxOffRouteDistance,
      Se.Set Beam.betterPointMaxWalkPctOfRide betterPointMaxWalkPctOfRide,
      Se.Set Beam.betterPointMaxWalkPctOfRideAtDrop betterPointMaxWalkPctOfRideAtDrop,
      Se.Set Beam.betterPointMinSavingPctOfRide betterPointMinSavingPctOfRide,
      Se.Set Beam.betterPointResolvePlaceNameOnSelect betterPointResolvePlaceNameOnSelect,
      Se.Set Beam.betterPointWalkAversion betterPointWalkAversion,
      Se.Set Beam.betterPointWalkDistanceSource betterPointWalkDistanceSource,
      Se.Set Beam.blockedUntilInMins blockedUntilInMins,
      Se.Set Beam.boardingBusPingMaxAgeSeconds boardingBusPingMaxAgeSeconds,
      Se.Set Beam.boardingMatchRadiusInMeters boardingMatchRadiusInMeters,
      Se.Set Beam.boardingMaxBookingStartDriftSeconds boardingMaxBookingStartDriftSeconds,
      ...
      Se.Set Beam.busApproachingNotificationTiers busApproachingNotificationTiers,
      Se.Set Beam.busBookingAllowed busBookingAllowed,
      Se.Set Beam.busFareCachingAllowed busFareCachingAllowed,
      Se.Set Beam.busScanRouteCalculationEnabledModes busScanRouteCalculationEnabledModes,
      Se.Set Beam.busTicketAllowed busTicketAllowed,
      ...
      Se.Set Beam.busTrackingNotificationTiers busTrackingNotificationTiers,
      Se.Set Beam.busTransitTypes busTransitTypes,
      Se.Set Beam.busTripTtl busTripTtl,
      ...
      Se.Set Beam.cancellationRateThresholdMonthly cancellationRateThresholdMonthly,
      ...
      Se.Set Beam.duesExcludedPaymentPurposes duesExcludedPaymentPurposes,
      ...
      Se.Set Beam.enableAdjacentGeoHashPlaceNameLookup enableAdjacentGeoHashPlaceNameLookup,
      ...
      Se.Set Beam.enableBoardingProximityCheck enableBoardingProximityCheck,
      Se.Set Beam.enableBusFiltering enableBusFiltering,
      Se.Set Beam.enableCustomerCancellationRateBlocking enableCustomerCancellationRateBlocking,
      Se.Set Beam.enableEditLocationWithoutRide enableEditLocationWithoutRide,
      ...
      Se.Set Beam.enableMetroFrfsSearch enableMetroFrfsSearch,
      ...
      Se.Set Beam.enablePaymentRefunds enablePaymentRefunds,
      Se.Set Beam.enableRewardsManagement (Just enableRewardsManagement),
      Se.Set Beam.enableRideEndOffers (Just enableRideEndOffers),
      Se.Set Beam.enableRideHailingOffers (Just enableRideHailingOffers),
      Se.Set Beam.enableRouteCacheRead enableRouteCacheRead,
      Se.Set Beam.enableShareNumberWithDriver enableShareNumberWithDriver,
      Se.Set Beam.enableSubwayFrfsSearch enableSubwayFrfsSearch,
      ...
      Se.Set Beam.externalSOSConfig (externalSOSConfig >>= Just . Data.Aeson.toJSON),
      ...
      Se.Set Beam.frfsDriverDetailsLeadTimeSeconds frfsDriverDetailsLeadTimeSeconds,
      ...
      Se.Set Beam.immediateCaptureDriverCancellationFee immediateCaptureDriverCancellationFee,
      Se.Set Beam.immediateCaptureRiderCancellationFee immediateCaptureRiderCancellationFee,
      Se.Set Beam.incidentReportSupport (Just incidentReportSupport),
      Se.Set Beam.includeVehiclesWithNoEta includeVehiclesWithNoEta,
      ...
      Se.Set Beam.invoiceConfig (invoiceConfig >>= Just . Data.Aeson.toJSON),
      Se.Set Beam.invoiceLogoUrl invoiceLogoUrl,
      ...
      Se.Set Beam.kafkaTopicName (Just kafkaTopicName),
      ...
      Se.Set Beam.maxAlternateRouteVehicles (Just maxAlternateRouteVehicles),
      Se.Set Beam.maxLiveVehiclesPerRoute (Just maxLiveVehiclesPerRoute),
      Se.Set Beam.maxNearbyBuses maxNearbyBuses,
      Se.Set Beam.maxNumberOfLuggages maxNumberOfLuggages,
      Se.Set Beam.maxWalkDistanceForBetterPoint maxWalkDistanceForBetterPoint,
      Se.Set Beam.maxWalkDistanceForBetterPointAtDrop maxWalkDistanceForBetterPointAtDrop,
      ...
      Se.Set Beam.metroFareCachingAllowed metroFareCachingAllowed,
      Se.Set Beam.metroTicketAllowed metroTicketAllowed,
      Se.Set Beam.minRideDistanceSavingForBetterPoint minRideDistanceSavingForBetterPoint,
      ...
      Se.Set Beam.monthlyConditionCooldownTimeHours monthlyConditionCooldownTimeHours,
      Se.Set Beam.monthlyMinRidesForBlocking monthlyMinRidesForBlocking,
      Se.Set Beam.monthlyMinRidesForNudging monthlyMinRidesForNudging,
      Se.Set Beam.monthlyOffenceSuspensionTimeHours monthlyOffenceSuspensionTimeHours,
      ...
      Se.Set Beam.nonAllowedOverrideFleetNoServiceTiers (nonAllowedOverrideFleetNoServiceTiers >>= Just . Data.Aeson.toJSON),
      ...
      Se.Set Beam.passExpiryReminderBatchSize passExpiryReminderBatchSize,
      Se.Set Beam.passExpiryReminderDays passExpiryReminderDays,
      Se.Set Beam.passExpiryReminderNextRunLocalTime passExpiryReminderNextRunLocalTime,
      Se.Set Beam.passExtraConfig (passExtraConfig >>= Just . Data.Aeson.toJSON),
      Se.Set Beam.passStatusUpdateBatchSize passStatusUpdateBatchSize,
      ...
      Se.Set Beam.ptCircuitBreakerConfig ptCircuitBreakerConfig,
      ...
      Se.Set Beam.remindEverydayUntilPassExpiry remindEverydayUntilPassExpiry,
      Se.Set Beam.rentalsConfig rentalsConfig,
      Se.Set Beam.routeCacheMaxDurationDeviation routeCacheMaxDurationDeviation,
      Se.Set Beam.safetyCheckEndTime safetyCheckEndTime,
      Se.Set Beam.safetyCheckStartTime safetyCheckStartTime,
      Se.Set Beam.seatBookingCleanupTtl seatBookingCleanupTtl,
      Se.Set Beam.seatBookingTtl seatBookingTtl,
      ...
      Se.Set Beam.silentReallocationWindowSeconds silentReallocationWindowSeconds,
      Se.Set Beam.singleModeWalkSpeed singleModeWalkSpeed,
      Se.Set Beam.sosTrackingLink sosTrackingLink,
      Se.Set Beam.sourceOfServiceTier (Just sourceOfServiceTier),
      Se.Set Beam.specialLocationTierOrderConfig (specialLocationTierOrderConfig >>= Just . Data.Aeson.toJSON),
      ...
      Se.Set Beam.staticCustomerIdThresholdDay staticCustomerIdThresholdDay,
      Se.Set Beam.studentPassVerifyConfig (studentPassVerifyConfig >>= Just . Data.Aeson.toJSON),
      Se.Set Beam.suburbanBookingAllowed suburbanBookingAllowed,
      Se.Set Beam.suburbanFareCachingAllowed suburbanFareCachingAllowed,
      Se.Set Beam.suburbanTicketAllowed suburbanTicketAllowed,
      ...
      Se.Set Beam.syncSearchDispatchConfig (syncSearchDispatchConfig >>= Just . Data.Aeson.toJSON),
      ...
      Se.Set Beam.unifiedQREnabled unifiedQREnabled,
      ...
      Se.Set Beam.validCancellationReasonCodesForImmediateCharge validCancellationReasonCodesForImmediateCharge,
      ...
      Just
        Domain.Types.RiderConfig.RiderConfig
          { alwaysAllowedNotificationCategories = fromMaybe [Domain.Types.Extra.RiderPreferences.RIDE_RELATED, Domain.Types.Extra.RiderPreferences.SAFETY] (alwaysAllowedNotificationCategories >>= traverse (readMaybe . Data.Text.unpack)),
            ...
            betterPointLoadSuggestionsAsync = betterPointLoadSuggestionsAsync,
            betterPointMaxOffRouteDistance = betterPointMaxOffRouteDistance,
            betterPointMaxWalkPctOfRide = betterPointMaxWalkPctOfRide,
            betterPointMaxWalkPctOfRideAtDrop = betterPointMaxWalkPctOfRideAtDrop,
            betterPointMinSavingPctOfRide = betterPointMinSavingPctOfRide,
            betterPointResolvePlaceNameOnSelect = betterPointResolvePlaceNameOnSelect,
            betterPointWalkAversion = betterPointWalkAversion,
            betterPointWalkDistanceSource = betterPointWalkDistanceSource,
            blockedUntilInMins = blockedUntilInMins,
            boardingBusPingMaxAgeSeconds = boardingBusPingMaxAgeSeconds,
            boardingMatchRadiusInMeters = boardingMatchRadiusInMeters,
            boardingMaxBookingStartDriftSeconds = boardingMaxBookingStartDriftSeconds,
            ...
            busApproachingNotificationTiers = busApproachingNotificationTiers,
            busBookingAllowed = busBookingAllowed,
            busFareCachingAllowed = busFareCachingAllowed,
            busScanRouteCalculationEnabledModes = busScanRouteCalculationEnabledModes,
            busTicketAllowed = busTicketAllowed,
            ...
            busTrackingNotificationTiers = busTrackingNotificationTiers,
            busTransitTypes = busTransitTypes,
            busTripTtl = busTripTtl,
            ...
            cancellationRateThresholdMonthly = cancellationRateThresholdMonthly,
            ...
            duesExcludedPaymentPurposes = duesExcludedPaymentPurposes,
            ...
            enableAdjacentGeoHashPlaceNameLookup = enableAdjacentGeoHashPlaceNameLookup,
            ...
            enableBoardingProximityCheck = enableBoardingProximityCheck,
            enableBusFiltering = enableBusFiltering,
            enableCustomerCancellationRateBlocking = enableCustomerCancellationRateBlocking,
            enableEditLocationWithoutRide = enableEditLocationWithoutRide,
            ...
            enableMetroFrfsSearch = enableMetroFrfsSearch,
            enableMultiModalForAllUsers = enableMultiModalForAllUsers,
            enableOnlinePaymentRide = enableOnlinePaymentRide,
            enablePaymentRefunds = enablePaymentRefunds,
            enableRewardsManagement = fromMaybe False enableRewardsManagement,
            enableRideEndOffers = fromMaybe False enableRideEndOffers,
            enableRideHailingOffers = fromMaybe False enableRideHailingOffers,
            enableRouteCacheRead = enableRouteCacheRead,
            enableShareNumberWithDriver = enableShareNumberWithDriver,
            enableSubwayFrfsSearch = enableSubwayFrfsSearch,
            ...
            externalSOSConfig = externalSOSConfig >>= Kernel.Utils.JSON.valueToMaybe,
            ...
            frfsDriverDetailsLeadTimeSeconds = frfsDriverDetailsLeadTimeSeconds,
            frfsMetricsApiKey = frfsMetricsApiKey,
            hardLimitForSafetyJobs = fromMaybe 21600 ((.getSeconds) <$> hardLimitForSafetyJobs),
            immediateCaptureDriverCancellationFee = immediateCaptureDriverCancellationFee,
            immediateCaptureRiderCancellationFee = immediateCaptureRiderCancellationFee,
            incidentReportSupport = fromMaybe False incidentReportSupport,
            includeVehiclesWithNoEta = includeVehiclesWithNoEta,
            ...
            invoiceConfig = invoiceConfig >>= Kernel.Utils.JSON.valueToMaybe,
            ...
            kafkaTopicName = fromMaybe "gps-data" kafkaTopicName,
            ...
            maxAlternateRouteVehicles = fromMaybe 7 maxAlternateRouteVehicles,
            maxLiveVehiclesPerRoute = fromMaybe 5 maxLiveVehiclesPerRoute,
            maxNearbyBuses = maxNearbyBuses,
            maxNumberOfLuggages = maxNumberOfLuggages,
            maxWalkDistanceForBetterPoint = maxWalkDistanceForBetterPoint,
            maxWalkDistanceForBetterPointAtDrop = maxWalkDistanceForBetterPointAtDrop,
            ...
            metroFareCachingAllowed = metroFareCachingAllowed,
            metroTicketAllowed = metroTicketAllowed,
            minRideDistanceSavingForBetterPoint = minRideDistanceSavingForBetterPoint,
            ...
            monthlyConditionCooldownTimeHours = monthlyConditionCooldownTimeHours,
            monthlyMinRidesForBlocking = monthlyMinRidesForBlocking,
            monthlyMinRidesForNudging = monthlyMinRidesForNudging,
            monthlyOffenceSuspensionTimeHours = monthlyOffenceSuspensionTimeHours,
            ...
            nonAllowedOverrideFleetNoServiceTiers = nonAllowedOverrideFleetNoServiceTiers >>= Kernel.Utils.JSON.valueToMaybe,
            ...
            passExpiryReminderBatchSize = passExpiryReminderBatchSize,
            passExpiryReminderDays = passExpiryReminderDays,
            passExpiryReminderNextRunLocalTime = passExpiryReminderNextRunLocalTime,
            passExtraConfig = passExtraConfig >>= Kernel.Utils.JSON.valueToMaybe,
            passStatusUpdateBatchSize = passStatusUpdateBatchSize,
            ...
            ptCircuitBreakerConfig = ptCircuitBreakerConfig,
            ...
            remindEverydayUntilPassExpiry = remindEverydayUntilPassExpiry,
            rentalsConfig = rentalsConfig,
            routeCacheMaxDurationDeviation = routeCacheMaxDurationDeviation,
            safetyCheckEndTime = safetyCheckEndTime,
            safetyCheckStartTime = safetyCheckStartTime,
            seatBookingCleanupTtl = seatBookingCleanupTtl,
            seatBookingTtl = seatBookingTtl,
            ...
            silentReallocationWindowSeconds = silentReallocationWindowSeconds,
            singleModeWalkSpeed = singleModeWalkSpeed,
            sosTrackingLink = sosTrackingLink,
            sourceOfServiceTier = fromMaybe Domain.Types.RiderConfig.NANDI sourceOfServiceTier,
            specialLocationTierOrderConfig = specialLocationTierOrderConfig >>= Kernel.Utils.JSON.valueToMaybe,
            ...
            staticCustomerIdThresholdDay = staticCustomerIdThresholdDay,
            studentPassVerifyConfig = studentPassVerifyConfig >>= Kernel.Utils.JSON.valueToMaybe,
            suburbanBookingAllowed = suburbanBookingAllowed,
            suburbanFareCachingAllowed = suburbanFareCachingAllowed,
            suburbanTicketAllowed = suburbanTicketAllowed,
            ...
            syncSearchDispatchConfig = syncSearchDispatchConfig >>= Kernel.Utils.JSON.valueToMaybe,
            ...
            unifiedQREnabled = unifiedQREnabled,
            ...
            validCancellationReasonCodesForImmediateCharge = validCancellationReasonCodesForImmediateCharge,
  ...
  toTType' (Domain.Types.RiderConfig.RiderConfig {..}) = do
    Beam.RiderConfigT
      { Beam.alwaysAllowedNotificationCategories = Just (map show alwaysAllowedNotificationCategories),
        ...
        Beam.betterPointLoadSuggestionsAsync = betterPointLoadSuggestionsAsync,
        Beam.betterPointMaxOffRouteDistance = betterPointMaxOffRouteDistance,
        Beam.betterPointMaxWalkPctOfRide = betterPointMaxWalkPctOfRide,
        Beam.betterPointMaxWalkPctOfRideAtDrop = betterPointMaxWalkPctOfRideAtDrop,
        Beam.betterPointMinSavingPctOfRide = betterPointMinSavingPctOfRide,
        Beam.betterPointResolvePlaceNameOnSelect = betterPointResolvePlaceNameOnSelect,
        Beam.betterPointWalkAversion = betterPointWalkAversion,
        Beam.betterPointWalkDistanceSource = betterPointWalkDistanceSource,
        Beam.blockedUntilInMins = blockedUntilInMins,
        Beam.boardingBusPingMaxAgeSeconds = boardingBusPingMaxAgeSeconds,
        Beam.boardingMatchRadiusInMeters = boardingMatchRadiusInMeters,
        Beam.boardingMaxBookingStartDriftSeconds = boardingMaxBookingStartDriftSeconds,
        ...
        Beam.busApproachingNotificationTiers = busApproachingNotificationTiers,
        Beam.busBookingAllowed = busBookingAllowed,
        Beam.busFareCachingAllowed = busFareCachingAllowed,
        Beam.busScanRouteCalculationEnabledModes = busScanRouteCalculationEnabledModes,
        Beam.busTicketAllowed = busTicketAllowed,
        ...
        Beam.busTrackingNotificationTiers = busTrackingNotificationTiers,
        Beam.busTransitTypes = busTransitTypes,
        Beam.busTripTtl = busTripTtl,
        ...
        Beam.cancellationRateThresholdMonthly = cancellationRateThresholdMonthly,
        ...
        Beam.duesExcludedPaymentPurposes = duesExcludedPaymentPurposes,
        ...
        Beam.enableAdjacentGeoHashPlaceNameLookup = enableAdjacentGeoHashPlaceNameLookup,
        ...
        Beam.enableBoardingProximityCheck = enableBoardingProximityCheck,
        Beam.enableBusFiltering = enableBusFiltering,
        Beam.enableCustomerCancellationRateBlocking = enableCustomerCancellationRateBlocking,
        Beam.enableEditLocationWithoutRide = enableEditLocationWithoutRide,
        ...
        Beam.enableMetroFrfsSearch = enableMetroFrfsSearch,
        Beam.enableMultiModalForAllUsers = enableMultiModalForAllUsers,
        Beam.enableOnlinePaymentRide = enableOnlinePaymentRide,
        Beam.enablePaymentRefunds = enablePaymentRefunds,
        Beam.enableRewardsManagement = Just enableRewardsManagement,
        Beam.enableRideEndOffers = Just enableRideEndOffers,
        Beam.enableRideHailingOffers = Just enableRideHailingOffers,
        Beam.enableRouteCacheRead = enableRouteCacheRead,
        Beam.enableShareNumberWithDriver = enableShareNumberWithDriver,
        Beam.enableSubwayFrfsSearch = enableSubwayFrfsSearch,
        ...
        Beam.externalSOSConfig = externalSOSConfig >>= Just . Data.Aeson.toJSON,
        ...
        Beam.frfsDriverDetailsLeadTimeSeconds = frfsDriverDetailsLeadTimeSeconds,
        ...
        Beam.immediateCaptureDriverCancellationFee = immediateCaptureDriverCancellationFee,
        Beam.immediateCaptureRiderCancellationFee = immediateCaptureRiderCancellationFee,
        Beam.incidentReportSupport = Just incidentReportSupport,
        Beam.includeVehiclesWithNoEta = includeVehiclesWithNoEta,
        ...
        Beam.invoiceConfig = invoiceConfig >>= Just . Data.Aeson.toJSON,
        Beam.invoiceLogoUrl = invoiceLogoUrl,
        ...
        Beam.kafkaTopicName = Just kafkaTopicName,
        ...
        Beam.maxAlternateRouteVehicles = Just maxAlternateRouteVehicles,
        Beam.maxLiveVehiclesPerRoute = Just maxLiveVehiclesPerRoute,
        Beam.maxNearbyBuses = maxNearbyBuses,
        Beam.maxNumberOfLuggages = maxNumberOfLuggages,
        Beam.maxWalkDistanceForBetterPoint = maxWalkDistanceForBetterPoint,
        Beam.maxWalkDistanceForBetterPointAtDrop = maxWalkDistanceForBetterPointAtDrop,
        ...
        Beam.metroFareCachingAllowed = metroFareCachingAllowed,
        Beam.metroTicketAllowed = metroTicketAllowed,
        Beam.minRideDistanceSavingForBetterPoint = minRideDistanceSavingForBetterPoint,
        ...
        Beam.monthlyConditionCooldownTimeHours = monthlyConditionCooldownTimeHours,
        Beam.monthlyMinRidesForBlocking = monthlyMinRidesForBlocking,
        Beam.monthlyMinRidesForNudging = monthlyMinRidesForNudging,
        Beam.monthlyOffenceSuspensionTimeHours = monthlyOffenceSuspensionTimeHours,
        ...
        Beam.nonAllowedOverrideFleetNoServiceTiers = nonAllowedOverrideFleetNoServiceTiers >>= Just . Data.Aeson.toJSON,
        ...
        Beam.passExpiryReminderBatchSize = passExpiryReminderBatchSize,
        Beam.passExpiryReminderDays = passExpiryReminderDays,
        Beam.passExpiryReminderNextRunLocalTime = passExpiryReminderNextRunLocalTime,
        Beam.passExtraConfig = passExtraConfig >>= Just . Data.Aeson.toJSON,
        Beam.passStatusUpdateBatchSize = passStatusUpdateBatchSize,
        ...
        Beam.ptCircuitBreakerConfig = ptCircuitBreakerConfig,
        ...
        Beam.remindEverydayUntilPassExpiry = remindEverydayUntilPassExpiry,
        Beam.rentalsConfig = rentalsConfig,
        Beam.routeCacheMaxDurationDeviation = routeCacheMaxDurationDeviation,
        Beam.safetyCheckEndTime = safetyCheckEndTime,
        Beam.safetyCheckStartTime = safetyCheckStartTime,
        Beam.seatBookingCleanupTtl = seatBookingCleanupTtl,
        Beam.seatBookingTtl = seatBookingTtl,
        ...
        Beam.silentReallocationWindowSeconds = silentReallocationWindowSeconds,
        Beam.singleModeWalkSpeed = singleModeWalkSpeed,
        Beam.sosTrackingLink = sosTrackingLink,
        Beam.sourceOfServiceTier = Just sourceOfServiceTier,
        Beam.specialLocationTierOrderConfig = specialLocationTierOrderConfig >>= Just . Data.Aeson.toJSON,
        ...
        Beam.staticCustomerIdThresholdDay = staticCustomerIdThresholdDay,
        Beam.studentPassVerifyConfig = studentPassVerifyConfig >>= Just . Data.Aeson.toJSON,
        Beam.suburbanBookingAllowed = suburbanBookingAllowed,
        Beam.suburbanFareCachingAllowed = suburbanFareCachingAllowed,
        Beam.suburbanTicketAllowed = suburbanTicketAllowed,
        ...
        Beam.syncSearchDispatchConfig = syncSearchDispatchConfig >>= Just . Data.Aeson.toJSON,
        ...
        Beam.unifiedQREnabled = unifiedQREnabled,
        ...
        Beam.validCancellationReasonCodesForImmediateCharge = validCancellationReasonCodesForImmediateCharge,
