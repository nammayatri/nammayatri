...
updateByPrimaryKey (Domain.Types.RiderConfig.RiderConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.appUrl appUrl,
      ...
      Se.Set Beam.showDropLocationSuggestion showDropLocationSuggestion,
      ...
      Se.Set Beam.updateUpiMaxAmountForPoc updateUpiMaxAmountForPoc,
      ...
      Just
        Domain.Types.RiderConfig.RiderConfig
          { appUrl = appUrl,
            ...
            showDropLocationSuggestion = showDropLocationSuggestion,
            ...
            updateUpiMaxAmountForPoc = updateUpiMaxAmountForPoc,
  ...
  toTType' (Domain.Types.RiderConfig.RiderConfig {..}) = do
    Beam.RiderConfigT
      { Beam.appUrl = appUrl,
        ...
        Beam.showDropLocationSuggestion = showDropLocationSuggestion,
        ...
        Beam.updateUpiMaxAmountForPoc = updateUpiMaxAmountForPoc,
