...
updateByPrimaryKey (Domain.Types.RiderConfig.RiderConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.appUrl appUrl,
      ...
      Se.Set Beam.frfsDriverDetailsLeadTime frfsDriverDetailsLeadTime,
      ...
      Just
        Domain.Types.RiderConfig.RiderConfig
          { appUrl = appUrl,
            ...
            frfsDriverDetailsLeadTime = frfsDriverDetailsLeadTime,
  ...
  toTType' (Domain.Types.RiderConfig.RiderConfig {..}) = do
    Beam.RiderConfigT
      { Beam.appUrl = appUrl,
        ...
        Beam.frfsDriverDetailsLeadTime = frfsDriverDetailsLeadTime,
