...
updateByPrimaryKey (Domain.Types.RiderConfig.RiderConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.appUrl appUrl,
      ...
      Se.Set Beam.chargeOnlyCommissionAtBooth chargeOnlyCommissionAtBooth,
      ...
      Just
        Domain.Types.RiderConfig.RiderConfig
          { appUrl = appUrl,
            ...
            chargeOnlyCommissionAtBooth = chargeOnlyCommissionAtBooth,
  ...
  toTType' (Domain.Types.RiderConfig.RiderConfig {..}) = do
    Beam.RiderConfigT
      { Beam.appUrl = appUrl,
        ...
        Beam.chargeOnlyCommissionAtBooth = chargeOnlyCommissionAtBooth,
