...
updateByPrimaryKey (Domain.Types.RiderConfig.RiderConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.appUrl appUrl,
      ...
      Se.Set Beam.externalSOSTracePollingIntervalSeconds externalSOSTracePollingIntervalSeconds,
      ...
      Just
        Domain.Types.RiderConfig.RiderConfig
          { appUrl = appUrl,
            ...
            externalSOSTracePollingIntervalSeconds = externalSOSTracePollingIntervalSeconds,
  ...
  toTType' (Domain.Types.RiderConfig.RiderConfig {..}) = do
    Beam.RiderConfigT
      { Beam.appUrl = appUrl,
        ...
        Beam.externalSOSTracePollingIntervalSeconds = externalSOSTracePollingIntervalSeconds,
