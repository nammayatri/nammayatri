...
updateByPrimaryKey (Domain.Types.RiderConfig.RiderConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.appUrl appUrl,
      ...
      Se.Set Beam.exotelStatusCheckSchedulerExpireTime ((Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) exotelStatusCheckSchedulerExpireTime),
      ...
      Se.Set Beam.ivrTriggerExpireTime ((Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) ivrTriggerExpireTime),
      ...
      Se.Set Beam.policeTriggerExpireTime ((Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) policeTriggerExpireTime),
      ...
      Se.Set Beam.postRideSafetyNotificationExpireTime ((Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) postRideSafetyNotificationExpireTime),
      Se.Set Beam.safetyCheckEndTime safetyCheckEndTime,
      Se.Set Beam.safetyCheckStartTime safetyCheckStartTime,
      Se.Set Beam.scheduledRideNotificationsExpireTime ((Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) scheduledRideNotificationsExpireTime),
      Se.Set Beam.scheduledRidePopupToRiderExpireTime ((Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) scheduledRidePopupToRiderExpireTime),
      ...
      Just
        Domain.Types.RiderConfig.RiderConfig
          { appUrl = appUrl,
            ...
            exotelStatusCheckSchedulerExpireTime = fromMaybe 60 (Kernel.Utils.Common.secondsToNominalDiffTime <$> exotelStatusCheckSchedulerExpireTime),
            ...
            ivrTriggerExpireTime = fromMaybe 60 (Kernel.Utils.Common.secondsToNominalDiffTime <$> ivrTriggerExpireTime),
            ...
            policeTriggerExpireTime = fromMaybe 60 (Kernel.Utils.Common.secondsToNominalDiffTime <$> policeTriggerExpireTime),
            ...
            postRideSafetyNotificationExpireTime = fromMaybe 60 (Kernel.Utils.Common.secondsToNominalDiffTime <$> postRideSafetyNotificationExpireTime),
            safetyCheckEndTime = safetyCheckEndTime,
            safetyCheckStartTime = safetyCheckStartTime,
            scheduledRideNotificationsExpireTime = fromMaybe 60 (Kernel.Utils.Common.secondsToNominalDiffTime <$> scheduledRideNotificationsExpireTime),
            scheduledRidePopupToRiderExpireTime = fromMaybe 60 (Kernel.Utils.Common.secondsToNominalDiffTime <$> scheduledRidePopupToRiderExpireTime),
  ...
  toTType' (Domain.Types.RiderConfig.RiderConfig {..}) = do
    Beam.RiderConfigT
      { Beam.appUrl = appUrl,
        ...
        Beam.exotelStatusCheckSchedulerExpireTime = (Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) exotelStatusCheckSchedulerExpireTime,
        ...
        Beam.ivrTriggerExpireTime = (Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) ivrTriggerExpireTime,
        ...
        Beam.policeTriggerExpireTime = (Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) policeTriggerExpireTime,
        Beam.postRideSafetyNotificationDelay = (Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) postRideSafetyNotificationDelay,
        Beam.postRideSafetyNotificationExpireTime = (Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) postRideSafetyNotificationExpireTime,
        Beam.safetyCheckEndTime = safetyCheckEndTime,
        Beam.safetyCheckStartTime = safetyCheckStartTime,
        Beam.scheduledRideNotificationsExpireTime = (Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) scheduledRideNotificationsExpireTime,
        Beam.scheduledRidePopupToRiderExpireTime = (Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) scheduledRidePopupToRiderExpireTime,
