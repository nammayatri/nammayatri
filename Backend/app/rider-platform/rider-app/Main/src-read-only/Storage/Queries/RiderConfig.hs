...
updateByPrimaryKey (Domain.Types.RiderConfig.RiderConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.appUrl appUrl,
      ...
      Se.Set Beam.otpPlanCacheEnabled otpPlanCacheEnabled,
      Se.Set Beam.otpPlanCacheTtlSeconds otpPlanCacheTtlSeconds,
      ...
      Just
        Domain.Types.RiderConfig.RiderConfig
          { appUrl = appUrl,
            ...
            otpPlanCacheEnabled = otpPlanCacheEnabled,
            otpPlanCacheTtlSeconds = otpPlanCacheTtlSeconds,
  ...
  toTType' (Domain.Types.RiderConfig.RiderConfig {..}) = do
    Beam.RiderConfigT
      { Beam.appUrl = appUrl,
        ...
        Beam.otpPlanCacheEnabled = otpPlanCacheEnabled,
        Beam.otpPlanCacheTtlSeconds = otpPlanCacheTtlSeconds,
