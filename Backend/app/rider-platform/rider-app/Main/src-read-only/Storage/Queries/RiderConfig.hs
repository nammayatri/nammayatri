...
updateByPrimaryKey (Domain.Types.RiderConfig.RiderConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.appUrl appUrl,
      ...
      Se.Set Beam.onStatusEstimatedDurationMultiplier (Just onStatusEstimatedDurationMultiplier),
      ...
      Just
        Domain.Types.RiderConfig.RiderConfig
          { appUrl = appUrl,
            ...
            onStatusEstimatedDurationMultiplier = fromMaybe 4 onStatusEstimatedDurationMultiplier,
  ...
  toTType' (Domain.Types.RiderConfig.RiderConfig {..}) = do
    Beam.RiderConfigT
      { Beam.appUrl = appUrl,
        ...
        Beam.onStatusEstimatedDurationMultiplier = Just onStatusEstimatedDurationMultiplier,
