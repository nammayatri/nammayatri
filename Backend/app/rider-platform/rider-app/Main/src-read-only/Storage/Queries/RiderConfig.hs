...
updateByPrimaryKey (Domain.Types.RiderConfig.RiderConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.appUrl appUrl,
      ...
      Se.Set Beam.routeTimestampExpiryTTL (((Just . Kernel.Utils.Common.nominalDiffTimeToSeconds)) routeTimestampExpiryTTL),
      ...
      Just
        Domain.Types.RiderConfig.RiderConfig
          { appUrl = appUrl,
            ...
            routeTimestampExpiryTTL = fromMaybe 60 (Kernel.Utils.Common.secondsToNominalDiffTime <$> routeTimestampExpiryTTL),
  ...
  toTType' (Domain.Types.RiderConfig.RiderConfig {..}) = do
    Beam.RiderConfigT
      { Beam.appUrl = appUrl,
        ...
        Beam.routeTimestampExpiryTTL = ((Just . Kernel.Utils.Common.nominalDiffTimeToSeconds)) routeTimestampExpiryTTL,
