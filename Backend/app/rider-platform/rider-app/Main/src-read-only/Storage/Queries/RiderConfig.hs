...
updateByPrimaryKey (Domain.Types.RiderConfig.RiderConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.appUrl appUrl,
      ...
      Se.Set Beam.frfsStatusDelay ((Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) frfsStatusDelay),
      ...
      Just
        Domain.Types.RiderConfig.RiderConfig
          { appUrl = appUrl,
            ...
            frfsStatusDelay = fromMaybe 300 (Kernel.Utils.Common.secondsToNominalDiffTime <$> frfsStatusDelay),
  ...
  toTType' (Domain.Types.RiderConfig.RiderConfig {..}) = do
    Beam.RiderConfigT
      { Beam.appUrl = appUrl,
        ...
        Beam.frfsStatusDelay = (Just . Kernel.Utils.Common.nominalDiffTimeToSeconds) frfsStatusDelay,
