...
updateByPrimaryKey (Domain.Types.RiderConfig.RiderConfig {..}) = do {_now <- getCurrentTime;
                                                                     updateWithKV [Se.Set Beam.appUrl appUrl,
                                                                                   ...
                                                                                   Se.Set Beam.chatRateLimitMaxRequests (Just chatRateLimitMaxRequests),
                                                                                   Se.Set Beam.chatRateLimitWindowSeconds (Just chatRateLimitWindowSeconds),
...
instance FromTType' Beam.RiderConfig Domain.Types.RiderConfig.RiderConfig
    where fromTType' (Beam.RiderConfigT {..}) = do {now <- Kernel.Types.Common.getCurrentTime;
                                                    let {payoutReferralStartDate_ = fromMaybe now payoutReferralStartDate};
                                                    pure $ Just Domain.Types.RiderConfig.RiderConfig{appUrl = appUrl,
                                                                                                     ...
                                                                                                     chatRateLimitMaxRequests = fromMaybe 20 chatRateLimitMaxRequests,
                                                                                                     chatRateLimitWindowSeconds = fromMaybe 60 chatRateLimitWindowSeconds,
                                                                                                     ...
                                                                                                     createdAt = createdAt,
                                                                                                     updatedAt = updatedAt}}
instance ToTType' Beam.RiderConfig Domain.Types.RiderConfig.RiderConfig
    where toTType' (Domain.Types.RiderConfig.RiderConfig {..}) = do Beam.RiderConfigT{Beam.appUrl = appUrl,
                                                                                      ...
                                                                                      Beam.chatRateLimitMaxRequests = Just chatRateLimitMaxRequests,
                                                                                      Beam.chatRateLimitWindowSeconds = Just chatRateLimitWindowSeconds,
