...
findByStepId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateDependency :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateDependency dependency id = do {_now <- getCurrentTime;
...
updateStepStatus :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByPrimaryKey (Domain.Types.MerchantOnboardingStep.MerchantOnboardingStep {..}) = do {_now <- getCurrentTime;
                                                                                           updateWithKV [Se.Set Beam.dependency (Kernel.Types.Id.getId <$> dependency),
...
instance FromTType' Beam.MerchantOnboardingStep Domain.Types.MerchantOnboardingStep.MerchantOnboardingStep
    where fromTType' (Beam.MerchantOnboardingStepT {..}) = do pure $ Just Domain.Types.MerchantOnboardingStep.MerchantOnboardingStep{createdAt = createdAt,
                                                                                                                                     ...
                                                                                                                                     updatedAt = updatedAt}
instance ToTType' Beam.MerchantOnboardingStep Domain.Types.MerchantOnboardingStep.MerchantOnboardingStep
    where toTType' (Domain.Types.MerchantOnboardingStep.MerchantOnboardingStep {..}) = do Beam.MerchantOnboardingStepT{Beam.createdAt = createdAt,
