...
findByCategoryId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) => (Kernel.Types.Id.Id Domain.Types.PassCategory.PassCategory -> m ([Domain.Types.PassType.PassType]))
findByCategoryId passCategoryId = do findAllWithKV [Se.Is Beam.passCategoryId $ Se.Eq (Kernel.Types.Id.getId passCategoryId)]

findById :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) => (Kernel.Types.Id.Id Domain.Types.PassType.PassType -> m (Maybe Domain.Types.PassType.PassType))
