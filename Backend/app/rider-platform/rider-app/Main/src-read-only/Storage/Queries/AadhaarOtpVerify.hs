...
instance FromTType' Beam.AadhaarOtpVerify Domain.Types.AadhaarOtpVerify.AadhaarOtpVerify
    where fromTType' (Beam.AadhaarOtpVerifyT {..}) = do pure $ Just Domain.Types.AadhaarOtpVerify.AadhaarOtpVerify{createdAt = createdAt,
...
instance ToTType' Beam.AadhaarOtpVerify Domain.Types.AadhaarOtpVerify.AadhaarOtpVerify
    where toTType' (Domain.Types.AadhaarOtpVerify.AadhaarOtpVerify {..}) = do Beam.AadhaarOtpVerifyT{Beam.createdAt = createdAt,
