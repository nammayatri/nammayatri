...
updateAlternateShortNamesAndRouteIds alternateShortNames alternateRouteIds journeyLegId = do {_now <- getCurrentTime;
...
updateRoute :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateRoute routeGtfsId routeCode routeLongName routeShortName journeyLegId = do {_now <- getCurrentTime;
                                                                                  updateOneWithKV [Se.Set Beam.routeGtfsId routeGtfsId,
                                                                                                   Se.Set Beam.routeCode routeCode,
                                                                                                   Se.Set Beam.routeLongName routeLongName,
                                                                                                   Se.Set Beam.routeShortName routeShortName,
                                                                                                   Se.Set Beam.updatedAt _now] [Se.Is Beam.journeyLegId $ Se.Eq journeyLegId]}
...
updateUserBookedRouteShortName userBookedRouteShortName journeyLegId = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.RouteDetails.RouteDetails {..}) = do {_now <- getCurrentTime;
                                                                       updateWithKV [Se.Set Beam.agencyGtfsId agencyGtfsId,
