...
updateByPrimaryKey (Domain.Types.TripTerms.TripTerms {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.TripTerms Domain.Types.TripTerms.TripTerms
    where fromTType' (Beam.TripTermsT {..}) = do {createdAt' <- getCreatedAt createdAt;
...
instance ToTType' Beam.TripTerms Domain.Types.TripTerms.TripTerms
    where toTType' (Domain.Types.TripTerms.TripTerms {..}) = do Beam.TripTermsT{Beam.createdAt = Kernel.Prelude.Just createdAt,
