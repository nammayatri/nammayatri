      ...
      Just
        Domain.Types.BecknConfig.BecknConfig
          { bapIFSC = bapIFSC,
            ...
            provider = Kernel.Prelude.fromMaybe Domain.Types.BecknConfig.ONDC provider,
            ...
            verifiedBy = Kernel.Prelude.fromMaybe Domain.Types.BecknConfig.BPP verifiedBy,
  ...
  toTType' (Domain.Types.BecknConfig.BecknConfig {..}) = do
    Beam.BecknConfigT
      { Beam.bapIFSC = bapIFSC,
        ...
        Beam.provider = Kernel.Prelude.Just provider,
        ...
        Beam.verificationCipher = verificationCipher,
        Beam.verifiedBy = Kernel.Prelude.Just verifiedBy,
