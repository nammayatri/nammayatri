...
updateByPrimaryKey (Domain.Types.Journey.Journey {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.convenienceCost convenienceCost,
      ...
      Se.Set Beam.targetArrivalTime targetArrivalTime,
      Se.Set Beam.targetDepartureTime targetDepartureTime,
      Se.Set Beam.bufferMinutes bufferMinutes,
      Se.Set Beam.riskLevel riskLevel,
      Se.Set Beam.recommendedDeparture recommendedDeparture,
