...
updateHasStartedTrackingWithoutBooking hasStartedTrackingWithoutBooking id = do {_now <- getCurrentTime;
...
updatePaymentOrderShortId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updatePaymentOrderShortId paymentOrderShortId isPaymentSuccess id = do {_now <- getCurrentTime;
                                                                        updateOneWithKV [Se.Set Beam.paymentOrderShortId (Kernel.Types.Id.getShortId <$> paymentOrderShortId),
...
updateByPrimaryKey (Domain.Types.Journey.Journey {..}) = do {_now <- getCurrentTime;
                                                             updateWithKV [Se.Set Beam.convenienceCost convenienceCost,
