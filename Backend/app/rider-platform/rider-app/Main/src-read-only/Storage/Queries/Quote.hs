...
updateByPrimaryKey (Domain.Types.Quote.Quote {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.backendAppVersion backendAppVersion,
      ...
      Se.Set Beam.stateEntryPermitCharges (((stateEntryPermitChargesInfo <&> ((.amount) . (.stateEntryPermitCharges))))),
      Se.Set Beam.stateEntryPermitNames ((stateEntryPermitChargesInfo <&> (.stateEntryPermitNames))),
