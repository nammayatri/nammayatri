...
updateByPrimaryKey (Domain.Types.Quote.Quote {..}) = do {_now <- getCurrentTime;
                                                         updateWithKV [Se.Set Beam.backendAppVersion backendAppVersion,
                                                                       ...
                                                                       Se.Set Beam.driverOfferId ((Storage.Queries.Transformers.Quote.getDriverOfferId (Storage.Queries.Transformers.Quote.fromQuoteDetails quoteDetails))),
                                                                       Se.Set Beam.fareProductType ((Storage.Queries.Transformers.Quote.getfareProduct (Storage.Queries.Transformers.Quote.fromQuoteDetails quoteDetails))),
                                                                       Se.Set Beam.meterRideBppQuoteId ((Storage.Queries.Transformers.Quote.getMeterRideBppQuoteId (Storage.Queries.Transformers.Quote.fromQuoteDetails quoteDetails))),
                                                                       Se.Set Beam.rentalDetailsId ((Storage.Queries.Transformers.Quote.getRentalDetailsId (Storage.Queries.Transformers.Quote.fromQuoteDetails quoteDetails))),
                                                                       ...
                                                                       Se.Set Beam.isSafetyPlus (Kernel.Prelude.Just isSafetyPlus),
                                                                       ...
                                                                       Se.Set Beam.selectedOfferId selectedOfferId,
                                                                       ...
                                                                       Se.Set Beam.vehicleVariant vehicleServiceTierType] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]}
