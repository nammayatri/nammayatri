...
instance FromTType' Beam.TicketService Domain.Types.TicketService.TicketService
    where fromTType' (Beam.TicketServiceT {..}) = do pure $ Just Domain.Types.TicketService.TicketService{allowCancellation = allowCancellation,
                                                                                                          ...
                                                                                                          createdAt = createdAt,
                                                                                                          updatedAt = updatedAt}
instance ToTType' Beam.TicketService Domain.Types.TicketService.TicketService
    where toTType' (Domain.Types.TicketService.TicketService {..}) = do Beam.TicketServiceT{Beam.allowCancellation = allowCancellation,
