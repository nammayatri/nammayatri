...
findAllByMerchantOpCityAndMessageKeyAndTripCategory :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByMerchantOpCityAndMessageKeyAndTripCategory merchantOperatingCityId key tripCategory = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
findAllByMerchantOpCityIdAndMessageKey :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByMerchantOpCityIdAndMessageKey merchantOperatingCityId key = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
                                                                                               Se.Is Beam.key $ Se.Eq key]]
...
updateByPrimaryKey (Domain.Types.MerchantPushNotification.MerchantPushNotification {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.MerchantPushNotification Domain.Types.MerchantPushNotification.MerchantPushNotification
    where fromTType' (Beam.MerchantPushNotificationT {..}) = do pure $ Just Domain.Types.MerchantPushNotification.MerchantPushNotification{body = body,
                                                                                                                                           ...
                                                                                                                                           createdAt = createdAt,
                                                                                                                                           updatedAt = updatedAt}
instance ToTType' Beam.MerchantPushNotification Domain.Types.MerchantPushNotification.MerchantPushNotification
    where toTType' (Domain.Types.MerchantPushNotification.MerchantPushNotification {..}) = do Beam.MerchantPushNotificationT{Beam.body = body,
