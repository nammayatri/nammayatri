...
findByDomainAndCityAndVehicleCategory ::
  ...
  (Kernel.Prelude.Text -> Kernel.Types.Id.Id Domain.Types.MerchantOperatingCity.MerchantOperatingCity -> BecknV2.OnDemand.Enums.VehicleCategory -> Kernel.Prelude.Maybe Domain.Types.IntegratedBPPConfig.PlatformType -> m (Kernel.Prelude.Maybe Domain.Types.IntegratedBPPConfig.IntegratedBPPConfig))
