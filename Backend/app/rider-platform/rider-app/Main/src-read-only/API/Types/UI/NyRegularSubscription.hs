...
data ConfirmSubscriptionReq
    = ConfirmSubscriptionReq {estimateId :: Kernel.Types.Id.Id Domain.Types.Estimate.Estimate, subscriptionId :: Kernel.Types.Id.Id Domain.Types.NyRegularSubscription.NyRegularSubscription}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CreateSubscriptionReq
    = CreateSubscriptionReq {bppId :: Data.Text.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CreateSubscriptionRes
    = CreateSubscriptionRes {searchRequestId :: Data.Text.Text, subscriptionId :: Kernel.Types.Id.Id Domain.Types.NyRegularSubscription.NyRegularSubscription}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data NyRegularSubscriptionApiEntity
    = NyRegularSubscriptionApiEntity {bppId :: Data.Text.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data OneWaySearchReqDetails
    = OneWaySearchReqDetails {driverIdentifier :: Kernel.Prelude.Maybe Domain.Types.RefereeLink.DriverIdentifier,
...
data UpdateSubscriptionReq
    = UpdateSubscriptionReq {id :: Kernel.Types.Id.Id Domain.Types.NyRegularSubscription.NyRegularSubscription,
                             metadata :: Kernel.Prelude.Maybe Data.Aeson.Value,
                             pauseEndDate :: Kernel.Prelude.Maybe Data.Time.UTCTime,
                             pauseStartDate :: Kernel.Prelude.Maybe Data.Time.UTCTime,
                             recurrenceEndDate :: Kernel.Prelude.Maybe Data.Time.Calendar.Day,
