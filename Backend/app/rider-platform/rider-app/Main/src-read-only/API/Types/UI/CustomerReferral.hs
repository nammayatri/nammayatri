...
data ApplyCodeReq
    = ApplyCodeReq {androidId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
data PayoutHistory
    = PayoutHistory {history :: [PayoutItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PayoutItem
    = PayoutItem {amount :: Kernel.Types.Common.HighPrecMoney,
...
data ReferredCustomers
    = ReferredCustomers {count :: Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ReferrerInfo
    = ReferrerInfo {applicableServiceTiers :: Kernel.Prelude.Maybe [Kernel.Prelude.Text],
...
data UpdatePayoutVpaReq
    = UpdatePayoutVpaReq {vpa :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VpaResp
    = VpaResp {isValid :: Kernel.Prelude.Bool, vpa :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
