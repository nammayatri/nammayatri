...
data PassAPIEntity
    = PassAPIEntity {amount :: Kernel.Types.Common.HighPrecMoney,
...
data PassCategoryAPIEntity
    = PassCategoryAPIEntity {description :: Data.Text.Text, id :: Kernel.Types.Id.Id Domain.Types.PassCategory.PassCategory, name :: Data.Text.Text}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PassDetailsAPIEntity
    = PassDetailsAPIEntity {category :: PassCategoryAPIEntity, passDetails :: PassAPIEntity, passType :: PassTypeAPIEntity}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PassInfoAPIEntity
    = PassInfoAPIEntity {passCategory :: PassCategoryAPIEntity, passTypes :: [PassTypeAPIEntity], passes :: [PassAPIEntity]}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PassSelectReq
    = PassSelectReq {imeiNumber :: Data.Text.Text, profilePicture :: Data.Text.Text, startDate :: Data.Time.Day}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PassSelectionAPIEntity
    = PassSelectionAPIEntity {paymentOrder :: Data.Maybe.Maybe Kernel.External.Payment.Juspay.Types.CreateOrder.CreateOrderResp,
                              purchasedPassId :: Kernel.Types.Id.Id Domain.Types.PurchasedPass.PurchasedPass}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PassSwitchDeviceIdReq
    = PassSwitchDeviceIdReq {deviceId :: Data.Maybe.Maybe Data.Text.Text, imeiNumber :: Data.Maybe.Maybe Data.Text.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PassTypeAPIEntity
    = PassTypeAPIEntity {catchline :: Data.Maybe.Maybe Data.Text.Text,
                         description :: Data.Maybe.Maybe Data.Text.Text,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PassUploadProfilePictureReq
    = PassUploadProfilePictureReq {imeiNumber :: Data.Text.Text, profilePicture :: Data.Text.Text, purchasedPassId :: Kernel.Types.Id.Id Domain.Types.PurchasedPass.PurchasedPass}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PassVerifyReq
    = PassVerifyReq {autoActivated :: Data.Maybe.Maybe Kernel.Prelude.Bool,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PurchasedPassAPIEntity
    = PurchasedPassAPIEntity {daysToExpire :: Kernel.Prelude.Int,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PurchasedPassTransactionAPIEntity
    = PurchasedPassTransactionAPIEntity {amount :: Kernel.Types.Common.HighPrecMoney,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SetPassPrefSrcAndDestReq
    = SetPassPrefSrcAndDestReq {prefDest :: Data.Text.Text, prefSrc :: Data.Text.Text}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
