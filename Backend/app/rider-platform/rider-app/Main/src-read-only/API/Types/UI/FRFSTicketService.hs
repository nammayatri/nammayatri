...
data FRFSBookingPaymentStatusAPI
    = NEW | PENDING | SUCCESS | FAILURE | REFUND_PENDING | REFUNDED
...
data FRFSConfigAPIRes
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSDiscountReq
    = FRFSDiscountReq {code :: Data.Text.Text, quantity :: Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data FRFSDiscoverySearchAPIReq
    = FRFSDiscoverySearchAPIReq {city :: Kernel.Types.Beckn.Context.City, vehicleType :: BecknV2.FRFS.Enums.VehicleCategory}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data FRFSQuoteConfirmReq
    = FRFSQuoteConfirmReq {discounts :: [FRFSDiscountReq]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSRouteAPI
    = FRFSRouteAPI {code :: Data.Text.Text,
                    endPoint :: Kernel.External.Maps.Types.LatLong,
                    integratedBppConfigId :: Data.Maybe.Maybe (Kernel.Types.Id.Id Domain.Types.IntegratedBPPConfig.IntegratedBPPConfig),
...
data FRFSSearchAPIReq
    = FRFSSearchAPIReq {fromStationCode :: Data.Text.Text,
...
data FRFSSearchAPIRes
    = FRFSSearchAPIRes {searchId :: Kernel.Types.Id.Id Domain.Types.FRFSSearch.FRFSSearch}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSStationAPI
...
data FRFSVehicleServiceTierAPI
    = FRFSVehicleServiceTierAPI {_type :: BecknV2.FRFS.Enums.ServiceTierType, description :: Data.Text.Text, longName :: Data.Text.Text, providerCode :: Data.Text.Text, shortName :: Data.Text.Text}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
