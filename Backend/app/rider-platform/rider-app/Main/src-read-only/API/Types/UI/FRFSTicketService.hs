...
data ActiveRouteRes
    = ActiveRouteRes {lastScheduleTime :: Data.Text.Text, routeId :: Data.Text.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data AutocompleteRes
    = AutocompleteRes {routes :: [FRFSRouteAPI], stops :: [FRFSStationAPI]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BookingFareAcceptedReq
    = BookingFareAcceptedReq {isFareAccepted :: Kernel.Prelude.Bool}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BookingFeedbackReq
    = BookingFeedbackReq {feedbackDetails :: Data.Text.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CategoryInfoResponse
    = CategoryInfoResponse {categoryFinalPrice :: Data.Maybe.Maybe Kernel.Types.Common.PriceAPIEntity,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CrisSdkResponse
    = CrisSdkResponse {bookAuthCode :: Data.Text.Text, latency :: Data.Maybe.Maybe Kernel.Prelude.Int, osBuildVersion :: Data.Text.Text, osType :: Data.Text.Text}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSBookingFeedbackReq
    = BookingFareAccepted BookingFareAcceptedReq | BookingFeedback BookingFeedbackReq
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSBookingPaymentAPI
    = FRFSBookingPaymentAPI {paymentOrder :: Data.Maybe.Maybe Kernel.External.Payment.Juspay.Types.CreateOrder.CreateOrderResp,
                             status :: FRFSBookingPaymentStatusAPI,
                             transactionId :: Data.Maybe.Maybe Data.Text.Text}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSBookingPaymentStatusAPI
    = NEW | PENDING | SUCCESS | FAILURE | REFUND_PENDING | REFUNDED | REFUND_FAILED | REFUND_INITIATED
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSCanCancelStatus
    = FRFSCanCancelStatus {cancellationCharges :: Data.Maybe.Maybe Kernel.Types.Common.HighPrecMoney,
                           isCancellable :: Data.Maybe.Maybe Kernel.Prelude.Bool,
                           refundAmount :: Data.Maybe.Maybe Kernel.Types.Common.HighPrecMoney}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSCancelStatus
    = FRFSCancelStatus {cancellationCharges :: Data.Maybe.Maybe Kernel.Types.Common.HighPrecMoney, refundAmount :: Data.Maybe.Maybe Kernel.Types.Common.HighPrecMoney}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSCategorySelectionReq
    = FRFSCategorySelectionReq {quantity :: Kernel.Prelude.Int,
                                quoteCategoryId :: Kernel.Types.Id.Id Domain.Types.FRFSQuoteCategory.FRFSQuoteCategory,
                                seatIds :: Data.Maybe.Maybe [(Kernel.Types.Id.Id Domain.Types.Seat.Seat)]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSConfigAPIRes
    = FRFSConfigAPIRes {bookingEndTime :: Kernel.Prelude.UTCTime,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSDiscountRes
    = FRFSDiscountRes {code :: Data.Text.Text,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSDiscoverySearchAPIReq
    = FRFSDiscoverySearchAPIReq {city :: Kernel.Types.Beckn.Context.City, platformType :: Data.Maybe.Maybe Domain.Types.IntegratedBPPConfig.PlatformType, vehicleType :: BecknV2.FRFS.Enums.VehicleCategory}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSPossibleStopsReq
    = FRFSPossibleStopsReq {stationCodes :: [Data.Text.Text]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSQuoteAPIRes
    = FRFSQuoteAPIRes {_type :: Domain.Types.FRFSQuote.FRFSQuoteType,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSQuoteCategoryAPIEntity
    = FRFSQuoteCategoryAPIEntity {bppItemId :: Data.Text.Text,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSQuoteConfirmReq
    = FRFSQuoteConfirmReq {childTicketQuantity :: Data.Maybe.Maybe Kernel.Prelude.Int,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSRouteAPI
    = FRFSRouteAPI {code :: Data.Text.Text,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSRouteServiceabilityReq
    = FRFSRouteServiceabilityReq {endStopCode :: Data.Text.Text, startStopCode :: Data.Text.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSRouteStationsAPI
    = FRFSRouteStationsAPI {code :: Data.Text.Text,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSSearchAPIReq
    = FRFSSearchAPIReq {busLocationData :: Data.Maybe.Maybe [API.Types.UI.RiderLocation.BusLocation],
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSSearchAPIRes
    = FRFSSearchAPIRes {quotes :: [FRFSQuoteAPIRes], searchId :: Kernel.Types.Id.Id Domain.Types.FRFSSearch.FRFSSearch}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSStationAPI
    = FRFSStationAPI {address :: Data.Maybe.Maybe Data.Text.Text,
                      code :: Data.Text.Text,
                      color :: Data.Maybe.Maybe Data.Text.Text,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSTicketAPI
    = FRFSTicketAPI {createdAt :: Kernel.Prelude.UTCTime,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSTicketBookingStatusAPIRes
    = FRFSTicketBookingStatusAPIRes {_type :: Domain.Types.FRFSQuote.FRFSQuoteType,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSTicketCategoryMetadataAPIEntity
    = FRFSTicketCategoryMetadataAPIEntity {category :: Domain.Types.FRFSQuoteCategoryType.FRFSQuoteCategoryType, description :: Data.Text.Text, title :: Data.Text.Text, tnc :: Data.Text.Text}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSTicketCategoryRes
    = FRFSTicketCategoryRes {category :: Data.Text.Text,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSTicketVerifyReq
    = FRFSTicketVerifyReq {qrData :: Data.Text.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSTripPassengerManifestResp
    = FRFSTripPassengerManifestResp {manifest :: [PassengerStopManifest]}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FRFSVehicleServiceTierAPI
    = FRFSVehicleServiceTierAPI {_type :: BecknV2.FRFS.Enums.ServiceTierType,
                                 description :: Data.Text.Text,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FleetOperatorCurrentOperationReq
    = FleetOperatorCurrentOperationReq {conductorToken :: Data.Maybe.Maybe Data.Text.Text, driverToken :: Data.Maybe.Maybe Data.Text.Text, vehicleNumber :: Data.Maybe.Maybe Data.Text.Text}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FleetOperatorCurrentOperationResp
    = FleetOperatorCurrentOperationResp {conductorToken :: Data.Text.Text,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FleetOperatorTripActionReq
    = FleetOperatorTripActionReq {action :: Domain.Types.FleetOperatorTripAction.FleetOperatorTripAction,
                                  conductorToken :: Data.Maybe.Maybe Data.Text.Text,
                                  driverToken :: Data.Maybe.Maybe Data.Text.Text,
                                  vehicleNumber :: Data.Maybe.Maybe Data.Text.Text}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FleetOperatorTripActionResp
    = FleetOperatorTripActionResp {currentTripNumber :: Kernel.Prelude.Int, hasUpcomingTrips :: Kernel.Prelude.Bool}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data OperatorTripInfo
    = OperatorTripInfo {dutyDate :: Data.Maybe.Maybe Data.Text.Text,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PassengerInfo
    = PassengerInfo {bookingId :: Kernel.Types.Id.Id Domain.Types.FRFSTicketBooking.FRFSTicketBooking,
    ...
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PassengerStopManifest
    = PassengerStopManifest {alightingPassengers :: [PassengerInfo], boardingPassengers :: [PassengerInfo], stopCode :: Data.Text.Text, stopName :: Data.Maybe.Maybe Data.Text.Text}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SeatLayoutDetailsResp
    = SeatLayoutDetailsResp {seatLayout :: Domain.Types.SeatLayout.SeatLayout, seats :: [Domain.Types.Seat.Seat]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SeatLayoutResp
    = SeatLayoutResp {seatLayout :: Domain.Types.SeatLayout.SeatLayout, seats :: [SeatWithStatus]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SeatStatus
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SeatWithStatus
    = SeatWithStatus {seat :: Domain.Types.Seat.Seat, status :: SeatStatus}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
