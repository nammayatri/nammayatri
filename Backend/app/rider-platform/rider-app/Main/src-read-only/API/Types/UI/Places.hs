...
data MultiModalLocation
    = MultiModalLocation {address :: Data.Text.Text,
...
data PlacesRequest
    = PlacesRequest {integratedBppConfigId :: Kernel.Types.Id.Id Domain.Types.IntegratedBPPConfig.IntegratedBPPConfig, userLat :: Kernel.Prelude.Double, userLon :: Kernel.Prelude.Double}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PlacesResponse
    = PlacesResponse {popularLocations :: [MultiModalLocation], recentLocations :: [MultiModalLocation]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
