...
data BusinessHourResp
    = BusinessHourResp {categories :: [CategoriesResp],
...
data CategoriesResp
    = CategoriesResp {allowedSeats :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DirectTicketBookingReq
    = DirectTicketBookingReq {customerName :: Kernel.Prelude.Maybe Data.Text.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DirectTicketBookingResp
    = DirectTicketBookingResp {bookingShortId :: Kernel.Types.Id.ShortId Domain.Types.TicketBooking.TicketBooking,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PeopleCategoriesResp
    = PeopleCategoriesResp {cancellationCharges :: Kernel.Prelude.Maybe [Domain.Types.ServicePeopleCategory.CancellationCharge],
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PeopleCategoriesVerificationRes
    = PeopleCategoriesVerificationRes {id :: Kernel.Types.Id.Id Domain.Types.ServicePeopleCategory.ServicePeopleCategory,
                                       name :: Data.Text.Text,
                                       pricePerUnit :: Kernel.Types.Common.HighPrecMoney,
                                       pricePerUnitWithCurrency :: Kernel.Types.Common.PriceAPIEntity}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingAPIEntity
    = TicketBookingAPIEntity {amount :: Kernel.Types.Common.HighPrecMoney,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingAPIEntityV2
    = TicketBookingAPIEntityV2 {amount :: Kernel.Types.Common.HighPrecMoney,
                                amountWithCurrency :: Kernel.Types.Common.PriceAPIEntity,
                                iconUrl :: Kernel.Prelude.Maybe Data.Text.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingCancelReq
    = TicketBookingCancelReq {ticketBookingServices :: [TicketBookingServiceCancelReq], ticketBookingShortId :: Kernel.Types.Id.ShortId Domain.Types.TicketBooking.TicketBooking}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingCategoryDetails
    = TicketBookingCategoryDetails {amount :: Kernel.Types.Common.HighPrecMoney,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingCategoryReq
    = TicketBookingCategoryReq {categoryId :: Kernel.Types.Id.Id Domain.Types.ServiceCategory.ServiceCategory, peopleCategories :: [TicketBookingPeopleCategoryReq]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingDetails
    = TicketBookingDetails {amount :: Kernel.Types.Common.HighPrecMoney,
                            amountWithCurrency :: Kernel.Types.Common.PriceAPIEntity,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingPeopleCategoryDetails
    = TicketBookingPeopleCategoryDetails {amountToRefund :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingPeopleCategoryReq
    = TicketBookingPeopleCategoryReq {numberOfUnits :: Kernel.Prelude.Int, peopleCategoryId :: Kernel.Types.Id.Id Domain.Types.ServicePeopleCategory.ServicePeopleCategory}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingReq
    = TicketBookingReq {services :: [TicketBookingServicesReq],
                        ticketSubPlaceId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Domain.Types.TicketSubPlace.TicketSubPlace),
                        visitDate :: Data.Time.Calendar.Day}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingServiceCancelReq
    = TicketBookingServiceCancelReq {businessHourId :: Kernel.Types.Id.Id Domain.Types.BusinessHour.BusinessHour,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingServiceCategoryCancelReq
    = TicketBookingServiceCategoryCancelReq {id :: Kernel.Types.Id.Id Domain.Types.TicketBookingServiceCategory.TicketBookingServiceCategory,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingServiceDetails
    = TicketBookingServiceDetails {allowCancellation :: Kernel.Prelude.Bool,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingServicePeopleCategoryCancelReq
    = TicketBookingServicePeopleCategoryCancelReq {id :: Kernel.Types.Id.Id Domain.Types.TicketBookingPeopleCategory.TicketBookingPeopleCategory, quantity :: Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingServicesReq
    = TicketBookingServicesReq {businessHourId :: Kernel.Types.Id.Id Domain.Types.BusinessHour.BusinessHour,
                                categories :: [TicketBookingCategoryReq],
                                serviceId :: Kernel.Types.Id.Id Domain.Types.TicketService.TicketService}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketBookingUpdateSeatsReq
    = TicketBookingUpdateSeatsReq {businessHourId :: Kernel.Types.Id.Id Domain.Types.BusinessHour.BusinessHour,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketFleetVehicleResp
    = TicketFleetVehicleResp {driverId :: Kernel.Prelude.Maybe Data.Text.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketPlaceAvailability
    = TicketPlaceAvailability {closedDays :: [Kernel.Prelude.Int], month :: Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketPlaceBookingList
    = TicketPlaceBookingList {bookings :: [API.Types.UI.TicketService.TicketBookingDetails], summary :: Dashboard.Common.Summary}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketPlaceResp
    = TicketPlaceResp {subPlaces :: [Domain.Types.TicketSubPlace.TicketSubPlace], ticketPlace :: Domain.Types.TicketPlace.TicketPlace}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketServiceCancelReq
    = TicketServiceCancelReq {businessHourId :: Kernel.Types.Id.Id Domain.Types.BusinessHour.BusinessHour,
                              date :: Data.Time.Calendar.Day,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketServiceResp
    = TicketServiceResp {allowCancellation :: Kernel.Prelude.Bool,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketServiceVerificationReq
    = TicketServiceVerificationReq {assignments :: Kernel.Prelude.Maybe [SharedLogic.CallBPPInternal.BookingAssignment]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketServiceVerificationResp
    = TicketServiceVerificationResp {amount :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
...
data TicketVerificationStatus
    = BookingSuccess | BookingExpired | BookingFuture | BookingAlreadyVerified | DifferentService | PaymentPending | InvalidBooking | CancelledBooking
