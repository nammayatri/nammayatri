...
data BBPSBillDetails
    = BBPSBillDetails {billerId :: Kernel.Prelude.Text, customerParams :: Kernel.Prelude.Maybe [Domain.Types.BBPS.Tag], txnAmount :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BBPSInfoAPIRes
    = BBPSInfoAPIRes {billDetails :: BBPSBillDetails,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BBPSPaymentReq
    = BBPSPaymentReq {appId :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BBPSPaymentStatusAPIRes
    = BBPSPaymentStatusAPIRes {errorMessage :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                               paymentInformation :: Kernel.Prelude.Maybe [Domain.Types.BBPS.Tag],
                               paymentMode :: Kernel.Prelude.Maybe Domain.Types.BBPS.BBPSPaymentMode,
                               paymentTxnId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                               status :: Domain.Types.BBPS.BBPSPaymentStatus}
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BBPSServerReq
    = BBPSServerReq {amount :: Kernel.Prelude.Text,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BBPSServerResp
    = BBPSServerResp {message :: Kernel.Prelude.Text, status :: BBPSServerStatus}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data BBPSSessionReq
    = BBPSSessionReq {deviceId :: Kernel.Prelude.Text, mobileNumber :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
