...
data SendVerifyOtpReq
    = SendVerifyOtpReq {mobileNumber :: Kernel.Prelude.Text, mobileCountryCode :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketDashboardAgreementTemplateResp
    = TicketDashboardAgreementTemplateResp {template :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketDashboardLoginReq
    = TicketDashboardLoginReq {mobileNumber :: Kernel.Prelude.Text, mobileCountryCode :: Kernel.Prelude.Text, otp :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketDashboardLoginResp
    = TicketDashboardLoginResp {authToken :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketDashboardRegisterReq
    = TicketDashboardRegisterReq {firstName :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketDashboardRegisterResp
    = TicketDashboardRegisterResp {success :: Kernel.Prelude.Bool, message :: Kernel.Prelude.Maybe Kernel.Prelude.Text, id :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TicketDashboardUserInfo
    = TicketDashboardUserInfo {firstName :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
type PostTicketsVerify = ("tickets" :> Capture "personServiceId" (Kernel.Types.Id.Id Domain.Types.TicketService.TicketService) :> Capture "ticketBookingShortId"
                                                                                                                                          (Kernel.Types.Id.ShortId Domain.Types.TicketBookingService.TicketBookingService) :> "verify" :> QueryParam "fleetOwnerId"
                                                                                                                                                                                                                                                     Kernel.Prelude.Text :> QueryParam "vehicleId"
                                                                                                                                                                                                                                                                                       Kernel.Prelude.Text :> Post ('[JSON])
                                                                                                                                                                                                                                                                                                                   API.Types.UI.TicketService.TicketServiceVerificationResp)
type PostTicketsServices = (Capture "ticketPlaceId" (Kernel.Types.Id.Id Domain.Types.TicketPlace.TicketPlace) :> "services" :> QueryParam "date" Data.Time.Calendar.Day :> QueryParam "subPlaceId"
                                                                                                                                                                                      (Kernel.Types.Id.Id Domain.Types.TicketSubPlace.TicketSubPlace) :> Post ('[JSON])
...
type GetTicketsBookingDetails = ("booking" :> Capture "ticketBookingShortId" (Kernel.Types.Id.ShortId Domain.Types.TicketBooking.TicketBooking) :> "details" :> Get ('[JSON])
...
type GetTicketsTicketdashboardUserInfo = ("ticketdashboard" :> "user" :> "info" :> QueryParam "requestorId" Kernel.Prelude.Text :> QueryParam "userRole"
                                                                                                                                              Domain.Types.MerchantOnboarding.RequestorRole :> QueryParam "requestorRole" Domain.Types.MerchantOnboarding.RequestorRole :> Get ('[JSON])
                                                                                                                                                                                                                                                                               TicketDashboardUserInfo)
type GetTicketsTicketdashboardFile = ("ticketdashboard" :> "file" :> Capture "fileId" Kernel.Prelude.Text :> QueryParam "requestorId" Kernel.Prelude.Text :> QueryParam "requestorRole"
                                                                                                                                                                        Domain.Types.MerchantOnboarding.RequestorRole :> Get ('[JSON]) Domain.Types.MerchantOnboarding.GetFileResponse)
...
type GetTicketsTicketdashboardTicketplaceInfo = ("ticketdashboard" :> "ticketplace" :> Capture "ticketPlaceId"
                                                                                               (Kernel.Types.Id.Id Domain.Types.TicketPlace.TicketPlace) :> "info" :> QueryParam "requestorId" Kernel.Prelude.Text :> QueryParam "requestorRole"
                                                                                                                                                                                                                                 Domain.Types.MerchantOnboarding.RequestorRole :> Get ('[JSON])
                                                                                                                                                                                                                                                                                      Domain.Types.TicketDashboard.TicketPlaceDashboardDetails)
type PostTicketsTicketdashboardTicketplaceUpdate = ("ticketdashboard" :> "ticketplace" :> "update" :> QueryParam "requestorId" Kernel.Prelude.Text :> QueryParam "requestorRole"
                                                                                                                                                                 Domain.Types.MerchantOnboarding.RequestorRole :> ReqBody ('[JSON])
                                                                                                                                                                                                                          Domain.Types.TicketDashboard.TicketPlaceDashboardDetails :> Post ('[JSON])
                                                                                                                                                                                                                                                                                           Kernel.Types.APISuccess.APISuccess)
type GetTicketsTicketdashboardTicketplaces = ("ticketdashboard" :> "ticketplaces" :> QueryParam "status" Kernel.Prelude.Text :> QueryParam "requestorId"
                                                                                                                                           Kernel.Prelude.Text :> QueryParam "requestorRole" Domain.Types.MerchantOnboarding.RequestorRole :> Get ('[JSON]) [Domain.Types.TicketPlace.TicketPlace])
type GetTicketsTicketdashboardTicketplaceSubPlaces = ("ticketdashboard" :> "ticketplace" :> Capture "ticketPlaceId"
                                                                                                    (Kernel.Types.Id.Id Domain.Types.TicketPlace.TicketPlace) :> "subPlaces" :> Get ('[JSON]) [Domain.Types.TicketSubPlace.TicketSubPlace])
type PostTicketsTicketdashboardTicketplaceUpdateSubPlaces = ("ticketdashboard" :> "ticketplace" :> Capture "ticketPlaceId"
                                                                                                           (Kernel.Types.Id.Id Domain.Types.TicketPlace.TicketPlace) :> "updateSubPlaces" :> ReqBody ('[JSON]) [Domain.Types.TicketSubPlace.TicketSubPlace] :> Post ('[JSON])
                                                                                                                                                                                                                                                                    Kernel.Types.APISuccess.APISuccess)
type GetTicketFleetVehicles = ("ticket" :> "places" :> Capture "placeId" (Kernel.Types.Id.Id Domain.Types.TicketPlace.TicketPlace) :> "fleet" :> "VehicleAssociation" :> "list" :> QueryParam "limit"
                                                                                                                                                                                              Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> QueryParam "searchString"
                                                                                                                                                                                                                                                                         Kernel.Prelude.Text :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                    [API.Types.UI.TicketService.TicketFleetVehicleResp])
type GetTicketFleetVehiclesV2 = ("ticket" :> "places" :> Capture "placeId"
                                                                 (Kernel.Types.Id.Id Domain.Types.TicketPlace.TicketPlace) :> "fleet" :> "VehicleAssociation" :> "list" :> "v2" :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset"
                                                                                                                                                                                                                                       Kernel.Prelude.Int :> QueryParam "searchString"
                                                                                                                                                                                                                                                                        Kernel.Prelude.Text :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                   [API.Types.UI.TicketService.TicketFleetVehicleResp])
type PostTicketBookingsVerifyV2 = ("tickets" :> Capture "personServiceId" (Kernel.Types.Id.Id Domain.Types.TicketService.TicketService) :> Capture "ticketServiceShortId"
                                                                                                                                                   (Kernel.Types.Id.ShortId Domain.Types.TicketBookingService.TicketBookingService) :> "verify" :> "v2" :> ReqBody ('[JSON])
                                                                                                                                                                                                                                                                   API.Types.UI.TicketService.TicketServiceVerificationReq :> Post ('[JSON])
                                                                                                                                                                                                                                                                                                                                   API.Types.UI.TicketService.TicketServiceVerificationResp)
type PostTicketPlacesBook = ("ticket" :> "places" :> Capture "placeId" (Kernel.Types.Id.Id Domain.Types.TicketPlace.TicketPlace) :> "book" :> ReqBody ('[JSON])
                                                                                                                                                      API.Types.UI.TicketService.TicketBookingReq :> Post ('[JSON]) Kernel.External.Payment.Interface.Types.CreateOrderResp)
type GetTicketPlaces = ("ticket" :> "places" :> Get ('[JSON]) [Domain.Types.TicketPlace.TicketPlace])
type GetTicketPlaceServices = ("ticket" :> "places" :> Capture "placeId" (Kernel.Types.Id.Id Domain.Types.TicketPlace.TicketPlace) :> "services" :> QueryParam "date"
                                                                                                                                                               Data.Time.Calendar.Day :> QueryParam "subPlaceId" (Kernel.Types.Id.Id Domain.Types.TicketSubPlace.TicketSubPlace) :> Get ('[JSON])
                                                                                                                                                                                                                                                                                        [API.Types.UI.TicketService.TicketServiceResp])
type GetTicketBookingDetails = ("ticket" :> "booking" :> Capture "bookingShortId" (Kernel.Types.Id.ShortId Domain.Types.TicketBooking.TicketBooking) :> Get ('[JSON])
                                                                                                                                                            API.Types.UI.TicketService.TicketBookingDetails)
type GetTicketsDashboardBookingStatus = ("dashboard" :> "booking" :> Capture "userPhoneNumber" Kernel.Prelude.Text :> Capture "bookingShortId"
                                                                                                                              (Kernel.Types.Id.ShortId Domain.Types.TicketBooking.TicketBooking) :> "status" :> Get ('[JSON]) Domain.Types.TicketBooking.BookingStatus)
type GetAllTicketBookings = ("ticket" :> "bookings" :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> QueryParam "status"
                                                                                                                                                     Domain.Types.TicketBooking.BookingStatus :> Get ('[JSON]) [API.Types.UI.TicketService.TicketBookingAPIEntityV2])
type PostTicketBookingCashCollect = ("ticket" :> "booking" :> Capture "bookingShortId" (Kernel.Types.Id.ShortId Domain.Types.TicketBooking.TicketBooking) :> "cashCollect" :> Post ('[JSON])
                                                                                                                                                                                   Kernel.Types.APISuccess.APISuccess)
type PostTicketPlacesDirectBook = ("ticket" :> "places" :> Capture "placeId" (Kernel.Types.Id.Id Domain.Types.TicketPlace.TicketPlace) :> "directBook" :> QueryParam "requestorId"
                                                                                                                                                                     Kernel.Prelude.Text :> ReqBody ('[JSON]) API.Types.UI.TicketService.DirectTicketBookingReq :> Post ('[JSON])
                                                                                                                                                                                                                                                                        API.Types.UI.TicketService.DirectTicketBookingResp)
type GetTicketPlaceBookings = ("ticket" :> "places" :> Capture "placeId" (Kernel.Types.Id.Id Domain.Types.TicketPlace.TicketPlace) :> "bookings" :> "list" :> QueryParam "limit"
                                                                                                                                                                         Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> MandatoryQueryParam "status"
                                                                                                                                                                                                                                                             Domain.Types.TicketBooking.BookingStatus :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                             API.Types.UI.TicketService.TicketPlaceBookingList)
data TicketsAPIs
    = TicketsAPIs {postTicketsVerify :: (Kernel.Types.Id.Id Domain.Types.TicketService.TicketService -> Kernel.Types.Id.ShortId Domain.Types.TicketBookingService.TicketBookingService -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> EulerHS.Types.EulerClient API.Types.UI.TicketService.TicketServiceVerificationResp),
...
mkTicketsAPIs ticketsClient = (TicketsAPIs {..})
                  where postTicketsVerify :<|> postTicketsServices :<|> getTicketsPlaces :<|> postTicketsUpdate :<|> postTicketsBookingsCancel :<|> postTicketsServiceCancel :<|> getTicketsBookingDetails :<|> postTicketsTicketdashboardRegister :<|> postTicketsTicketdashboardLoginAuth :<|> postTicketsTicketdashboardLoginVerify :<|> getTicketsTicketdashboardAgreement :<|> getTicketsTicketdashboardUserInfo :<|> getTicketsTicketdashboardFile :<|> postTicketsTicketdashboardSendverifyotp :<|> getTicketsTicketdashboardTicketplaceInfo :<|> postTicketsTicketdashboardTicketplaceUpdate :<|> getTicketsTicketdashboardTicketplaces :<|> getTicketsTicketdashboardTicketplaceSubPlaces :<|> postTicketsTicketdashboardTicketplaceUpdateSubPlaces :<|> getTicketFleetVehicles :<|> getTicketFleetVehiclesV2 :<|> postTicketBookingsVerifyV2 :<|> postTicketPlacesBook :<|> getTicketPlaces :<|> getTicketPlaceServices :<|> getTicketBookingDetails :<|> getTicketsDashboardBookingStatus :<|> getAllTicketBookings :<|> postTicketBookingCashCollect :<|> postTicketPlacesDirectBook :<|> getTicketPlaceBookings = ticketsClient
