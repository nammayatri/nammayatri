...
data DepotManagerDetail = DepotManagerDetail
...
mkDepotManagerAPIs depotManagerClient = (DepotManagerAPIs {..})
  where
    postDepotManagerUpsertOne :<|> postDepotManagerUpsertMany :<|> getDepotManagerList :<|> deleteDepotManager :<|> getDepotManagerByMobileNumber :<|> getDepotManagerByDepotCode = depotManagerClient
