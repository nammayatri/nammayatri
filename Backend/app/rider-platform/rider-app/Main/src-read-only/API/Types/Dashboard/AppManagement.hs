...
instance Text.Show.Show AppManagementUserActionType
    where show = \case
...
instance Text.Read.Read AppManagementUserActionType
    where readsPrec d' = Text.Read.readParen (d' > app_prec) (\r -> [(CUSTOMER v1, r2) | r1 <- stripPrefix "CUSTOMER/" r, (v1, r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(EVENT_MANAGEMENT v1,
                                                                                                                                                                                  r2) | r1 <- stripPrefix "EVENT_MANAGEMENT/" r,
                                                                                                                                                                                        (v1, r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(FRFS_TICKET_SERVICE v1,
                                                                                                                                                                                                                                                r2) | r1 <- stripPrefix "FRFS_TICKET_SERVICE/" r,
                                                                                                                                                                                                                                                      (v1,
                                                                                                                                                                                                                                                       r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(MERCHANT_ONBOARDING v1,
                                                                                                                                                                                                                                                                                                          r2) | r1 <- stripPrefix "MERCHANT_ONBOARDING/" r,
                                                                                                                                                                                                                                                                                                                (v1,
                                                                                                                                                                                                                                                                                                                 r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(PASS v1,
                                                                                                                                                                                                                                                                                                                                                                    r2) | r1 <- stripPrefix "PASS/" r,
                                                                                                                                                                                                                                                                                                                                                                          (v1,
                                                                                                                                                                                                                                                                                                                                                                           r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(PAYMENT v1,
                                                                                                                                                                                                                                                                                                                                                                                                                              r2) | r1 <- stripPrefix "PAYMENT/" r,
                                                                                                                                                                                                                                                                                                                                                                                                                                    (v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                     r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(TICKET_DASHBOARD v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        r2) | r1 <- stripPrefix "TICKET_DASHBOARD/" r,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              (v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(TICKETS v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  r2) | r1 <- stripPrefix "TICKETS/" r,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(TRANSIT_OPERATOR v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            r2) | r1 <- stripPrefix "TRANSIT_OPERATOR/" r,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  (v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(VEHICLE_SEAT_LAYOUT_MAPPING v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      r2) | r1 <- stripPrefix "VEHICLE_SEAT_LAYOUT_MAPPING/" r,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            (v1,
