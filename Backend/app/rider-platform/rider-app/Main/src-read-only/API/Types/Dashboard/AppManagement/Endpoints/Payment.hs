...
data RefundRequestInfoResp
    = RefundRequestInfoResp {orderId :: Kernel.Types.Id.Id Lib.Payment.Domain.Types.PaymentOrder.PaymentOrder,
...
data RefundRequestItem
    = RefundRequestItem {orderId :: Kernel.Types.Id.Id Lib.Payment.Domain.Types.PaymentOrder.PaymentOrder,
                         requestedAmount :: Kernel.Prelude.Maybe Kernel.Types.Common.PriceAPIEntity,
                         transactionAmount :: Kernel.Types.Common.PriceAPIEntity,
                         refundPurpose :: Domain.Types.RefundRequest.RefundPurpose,
                         status :: Domain.Types.RefundRequest.RefundRequestStatus,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RefundRequestResp
    = RefundRequestResp {summary :: Dashboard.Common.Summary, refundRequests :: [RefundRequestItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RefundRequestRespondReq
    = RefundRequestRespondReq {approve :: Kernel.Prelude.Bool,
                               responseDescription :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets RefundRequestRespondReq
    where hideSecrets = Kernel.Prelude.identity
data RefundRequestRespondResp
    = RefundRequestRespondResp {status :: Domain.Types.RefundRequest.RefundRequestStatus,
                                refundStatus :: Kernel.Prelude.Maybe Kernel.External.Payment.Interface.Types.RefundStatus,
                                errorCode :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets RefundRequestRespondResp
    where hideSecrets = Kernel.Prelude.identity
type API = ("payment" :> (GetPaymentRefundRequestList :<|> GetPaymentRefundRequestInfo :<|> PostPaymentRefundRequestRespond))
type GetPaymentRefundRequestList = ("refundRequest" :> "list" :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> QueryParam "status"
                                                                                                                                                               Domain.Types.RefundRequest.RefundRequestStatus :> QueryParam "code" Domain.Types.RefundRequest.RefundRequestCode :> QueryParam "customerId"
                                                                                                                                                                                                                                                                                              (Kernel.Types.Id.Id Domain.Types.Person.Person) :> QueryParam "orderId"
                                                                                                                                                                                                                                                                                                                                                            (Kernel.Types.Id.Id Lib.Payment.Domain.Types.PaymentOrder.PaymentOrder) :> QueryParam "from"
                                                                                                                                                                                                                                                                                                                                                                                                                                                  Kernel.Prelude.UTCTime :> QueryParam "to"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       Kernel.Prelude.UTCTime :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     RefundRequestResp)
type GetPaymentRefundRequestInfo = ("refundRequest" :> Capture "orderId" (Kernel.Types.Id.Id Lib.Payment.Domain.Types.PaymentOrder.PaymentOrder) :> "info" :> QueryParam "refreshRefunds"
                                                                                                                                                                         Kernel.Prelude.Bool :> Get ('[JSON]) RefundRequestInfoResp)
type PostPaymentRefundRequestRespond = ("refundRequest" :> Capture "orderId" (Kernel.Types.Id.Id Lib.Payment.Domain.Types.PaymentOrder.PaymentOrder) :> "respond" :> ReqBody ('[JSON])
                                                                                                                                                                             RefundRequestRespondReq :> Post ('[JSON]) RefundRequestRespondResp)
data PaymentAPIs
    = PaymentAPIs {getPaymentRefundRequestList :: (Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Domain.Types.RefundRequest.RefundRequestStatus) -> Kernel.Prelude.Maybe (Domain.Types.RefundRequest.RefundRequestCode) -> Kernel.Prelude.Maybe (Kernel.Types.Id.Id Domain.Types.Person.Person) -> Kernel.Prelude.Maybe (Kernel.Types.Id.Id Lib.Payment.Domain.Types.PaymentOrder.PaymentOrder) -> Kernel.Prelude.Maybe (Kernel.Prelude.UTCTime) -> Kernel.Prelude.Maybe (Kernel.Prelude.UTCTime) -> EulerHS.Types.EulerClient RefundRequestResp),
...
mkPaymentAPIs paymentClient = (PaymentAPIs {..})
                  where getPaymentRefundRequestList :<|> getPaymentRefundRequestInfo :<|> postPaymentRefundRequestRespond = paymentClient
data PaymentUserActionType
    = GET_PAYMENT_REFUND_REQUEST_LIST | GET_PAYMENT_REFUND_REQUEST_INFO | POST_PAYMENT_REFUND_REQUEST_RESPOND
