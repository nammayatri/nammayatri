...
data BookingStatementItem
    = BookingStatementItem {bookingDatetime :: Kernel.Prelude.UTCTime,
...
data BookingStatementReq
    = BookingStatementReq {count :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    ...
    deriving stock (Generic, Show)
    deriving anyclass ToSchema
data BookingStatementRes
    = BookingStatementRes {emailId :: Kernel.Prelude.Text,
    ...
    deriving anyclass ToSchema
data InvoiceBilling
    = InvoiceBilling {addonAmount :: Kernel.Types.Common.HighPrecMoney,
    ...
    deriving anyclass ToSchema
data InvoiceDataReq
    = InvoiceDataReq {bookingId :: Kernel.Types.Id.Id Domain.Types.Booking.Booking,
                      emailId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving anyclass ToSchema
data InvoiceDataRes
    = InvoiceDataRes {billing :: InvoiceBilling,
    ...
    deriving anyclass ToSchema
data InvoiceGST
    = InvoiceGST {cgst :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
    ...
    deriving anyclass ToSchema
data InvoiceInvoice
    = InvoiceInvoice {invoiceAmount :: Kernel.Types.Common.HighPrecMoney,
    ...
    deriving anyclass ToSchema
data InvoiceItem
    = InvoiceItem {bookingClass :: Domain.Types.ServiceTierType.ServiceTierType,
...
data InvoicePaymentMode
    = InvoicePaymentMode {amount :: Kernel.Types.Common.HighPrecMoney,
    ...
    deriving anyclass ToSchema
data InvoicePerson
    = InvoicePerson {dob :: Kernel.Prelude.Text,
    ...
    deriving stock (Generic, Show)
    deriving anyclass ToSchema
data InvoiceUnitPricing
    = InvoiceUnitPricing {discountAmount :: Kernel.Types.Common.HighPrecMoney,
                          itemAmount :: Kernel.Types.Common.HighPrecMoney,
                          itemId :: Kernel.Prelude.Text,
