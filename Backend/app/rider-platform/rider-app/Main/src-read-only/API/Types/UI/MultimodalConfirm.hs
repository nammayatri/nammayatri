...
data LegStatus = LegStatus {legId :: Kernel.Types.Id.Id Domain.Types.JourneyLeg.JourneyLeg, legOrder :: Kernel.Prelude.Int, status :: Lib.JourneyModule.Types.JourneyLegStatus}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
