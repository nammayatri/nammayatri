...
data AlternateRouteDetails
    = AlternateRouteDetails {isLive :: Kernel.Prelude.Bool, routeCode :: Kernel.Prelude.Text, routeShortName :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data AvailableRoute
    = AvailableRoute {quoteId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Domain.Types.FRFSQuote.FRFSQuote),
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ChangeStopsReq
    = ChangeStopsReq {journeyId :: Kernel.Types.Id.Id Domain.Types.Journey.Journey,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ChangeStopsResp
    = ChangeStopsResp {stationsChanged :: Kernel.Prelude.Bool}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data EffectiveStops
    = EffectiveStops {destStopNameChanged :: Kernel.Prelude.Bool,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ExtendLegGetFareReq
    = ExtendLegGetFareReq {endLocation :: Kernel.Prelude.Maybe Domain.Types.Location.LocationAPIEntity, startLocation :: Lib.JourneyModule.Types.ExtendLegStartPoint}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ExtendLegGetFareResp
    = ExtendLegGetFareResp {bookingUpdateRequestId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Domain.Types.BookingUpdateRequest.BookingUpdateRequest),
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ExtendLegReq
    = ExtendLegReq {bookingUpdateRequestId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Domain.Types.BookingUpdateRequest.BookingUpdateRequest),
                    distance :: Kernel.Types.Common.Distance,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data IntegratedQRReq
    = IntegratedQRReq {integratedQR :: Lib.JourneyModule.Types.UnifiedTicketQRV2, provider :: Lib.JourneyModule.Types.Provider}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data JourneyBookingPaymentStatus
    = JourneyBookingPaymentStatus {gatewayReferenceId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                                   journeyId :: Kernel.Types.Id.Id Domain.Types.Journey.Journey,
                                   paymentOrder :: Kernel.Prelude.Maybe PaymentOrder}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data JourneyConfirmReq
    = JourneyConfirmReq {enableOffer :: Kernel.Prelude.Maybe Kernel.Prelude.Bool, journeyConfirmReqElements :: [JourneyConfirmReqElement]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data JourneyConfirmReqElement
    = JourneyConfirmReqElement {categorySelectionReq :: Kernel.Prelude.Maybe [API.Types.UI.FRFSTicketService.FRFSCategorySelectionReq],
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data JourneyConfirmResp
    = JourneyConfirmResp {gatewayReferenceId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                          orderSdkPayload :: Kernel.Prelude.Maybe Kernel.External.Payment.Juspay.Types.CreateOrderResp,
                          result :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data JourneyFeedBackForm
    = JourneyFeedBackForm {additionalFeedBack :: Kernel.Prelude.Maybe Kernel.Prelude.Text, rateTravelMode :: [RateMultiModelTravelModes], rating :: Kernel.Prelude.Maybe Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data JourneyInfoResp
    = JourneyInfoResp {createdAt :: Kernel.Prelude.UTCTime,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data JourneyStatusResp
    = JourneyStatusResp {journeyChangeLogCounter :: Kernel.Prelude.Int,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data KafKaPacket
    = KafKaPacket {client_ip :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LegRouteWithLiveVehicle
    = LegRouteWithLiveVehicle {legOrder :: Kernel.Prelude.Int, routeWithLiveVehicles :: [RouteWithLiveVehicle]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LegServiceTierOptionsResp
    = LegServiceTierOptionsResp {options :: [Domain.Types.RouteDetails.AvailableRoutesByTier]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LegStatus
    = LegStatus {bookingStatus :: Lib.JourneyModule.State.Types.JourneyBookingStatus,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LiveVehicleInfo
    = LiveVehicleInfo {eta :: Kernel.Prelude.Maybe [Storage.CachedQueries.Merchant.MultiModalBus.BusStopETA],
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MultimodalCancelStatusResp
    = MultimodalCancelStatusResp {bookingStatus :: Domain.Types.FRFSTicketBookingStatus.FRFSTicketBookingStatus,
...
data MultimodalTicketVerifyReq
    = IntegratedQR IntegratedQRReq | SingleQR SingleQRReq
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MultimodalTicketVerifyResp
    = MultimodalTicketVerifyResp {legInfo :: [Lib.JourneyModule.Types.LegInfo], provider :: Lib.JourneyModule.Types.Provider}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MultimodalTransitOptionData
    = MultimodalTransitOptionData {duration :: Kernel.Prelude.Maybe Kernel.Types.Common.Seconds, travelModes :: [Domain.Types.Trip.MultimodalTravelMode]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MultimodalTransitOptionsReq
    = MultimodalTransitOptionsReq {destLatLong :: Kernel.External.Maps.Types.LatLong, sourceLatLong :: Kernel.External.Maps.Types.LatLong}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MultimodalTransitOptionsResp
    = MultimodalTransitOptionsResp {options :: [MultimodalTransitOptionData]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MultimodalUserPreferences
    = MultimodalUserPreferences {allowedTransitModes :: [Domain.Types.Trip.MultimodalTravelMode],
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data OnboardedVehicleDetailsReq
    = OnboardedVehicleDetailsReq {vehicleNumber :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PaymentFareUpdate
    = PaymentFareUpdate {category :: Domain.Types.FRFSQuoteCategoryType.FRFSQuoteCategoryType,
                         journeyLegOrder :: Kernel.Prelude.Int,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PaymentOrder
    = PaymentOrder {sdkPayload :: Kernel.Prelude.Maybe Kernel.External.Payment.Juspay.Types.CreateOrderResp, status :: API.Types.UI.FRFSTicketService.FRFSBookingPaymentStatusAPI}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PublicTransportData
    = PublicTransportData {eligiblePassIds :: Kernel.Prelude.Maybe [Kernel.Prelude.Text], ptcv :: Kernel.Prelude.Text, rs :: [TransportRoute], rsm :: [TransportRouteStopMapping], ss :: [TransportStation]}
    deriving stock Generic
    deriving anyclass ToSchema
data RateMultiModelTravelModes
    = RateMultiModelTravelModes {isExperienceGood :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
                                 legOrder :: Kernel.Prelude.Int,
                                 rating :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                                 travelMode :: Kernel.Prelude.Maybe Domain.Types.Trip.MultimodalTravelMode}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RiderLocationReq
    = RiderLocationReq {currTime :: Kernel.Prelude.UTCTime, latLong :: Kernel.External.Maps.Types.LatLong}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RouteAvailabilityReq
    = RouteAvailabilityReq {endStopCode :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RouteAvailabilityResp
    = RouteAvailabilityResp {availableRoutes :: [AvailableRoute]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RouteCodesWithLeg
    = RouteCodesWithLeg {legOrder :: Kernel.Prelude.Int, routeCodes :: [Kernel.Prelude.Text]}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RouteServiceabilityReq
    = RouteServiceabilityReq {destinationStopCode :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
data RouteServiceabilityResp
    = RouteServiceabilityResp {alternateRouteCodes :: Kernel.Prelude.Maybe [Kernel.Prelude.Text], effectiveStops :: Kernel.Prelude.Maybe EffectiveStops, legs :: [LegRouteWithLiveVehicle]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RouteStopMapping
    = RouteStopMapping {code :: Kernel.Prelude.Text, lat :: Kernel.Prelude.Double, lon :: Kernel.Prelude.Double, name :: Kernel.Prelude.Text, seqNo :: Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RouteWithLiveVehicle
    = RouteWithLiveVehicle {liveVehicles :: [LiveVehicleInfo], routeCode :: Kernel.Prelude.Text, routeShortName :: Kernel.Prelude.Text, schedules :: [ScheduledVehicleInfo]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ScheduledVehicleInfo
    = ScheduledVehicleInfo {availableSeats :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SetRouteNameReq
    = SetRouteNameReq {journeyId :: Kernel.Types.Id.Id Domain.Types.Journey.Journey, legOrder :: Kernel.Prelude.Int, shortName :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SimilarJourneyLegsResp
    = SimilarJourneyLegsResp {allLegsLoaded :: Kernel.Prelude.Bool, journeyLegsInfo :: [Lib.JourneyModule.Utils.JourneyLegOption]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SingleQRReq
    = SingleQRReq {provider :: Lib.JourneyModule.Types.Provider, tickets :: [Kernel.Prelude.Text]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data StationAPIEntity
    = StationAPIEntity {stopCode :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SwitchFRFSTierReq
    = SwitchFRFSTierReq {quoteId :: Kernel.Types.Id.Id Domain.Types.FRFSQuote.FRFSQuote}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SwitchJourneyLegReq
    = SwitchJourneyLegReq {journeyLegId :: Kernel.Types.Id.Id Domain.Types.JourneyLeg.JourneyLeg}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SwitchLegReq
    = SwitchLegReq {legOrder :: Kernel.Prelude.Int,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SwitchRouteReq
    = SwitchRouteReq {journeyId :: Kernel.Types.Id.Id Domain.Types.Journey.Journey,
                      legOrder :: Kernel.Prelude.Int,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SwitchTaxiReq
    = SwitchTaxiReq {estimateId :: Kernel.Types.Id.Id Domain.Types.Estimate.Estimate}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TowerInfo
    = TowerInfo {areaCode :: Kernel.Prelude.Int,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TowerInfoReq
    = TowerInfoReq {latLngAccuracy :: Kernel.Prelude.Double, timeStamp :: Kernel.Prelude.UTCTime, towerInfo :: [TowerInfo], userLat :: Kernel.Prelude.Double, userLng :: Kernel.Prelude.Double}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TransportRoute
    = TransportRoute {cd :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass ToSchema
data TransportRouteStopMapping
    = TransportRouteStopMapping {ibc :: Kernel.Types.Id.Id Domain.Types.IntegratedBPPConfig.IntegratedBPPConfig, rc :: Kernel.Prelude.Text, sc :: Kernel.Prelude.Text, sn :: Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass ToSchema
data TransportStation
    = TransportStation {ad :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass ToSchema
data UpdateBusLocationReq
    = UpdateBusLocationReq {lat :: Kernel.Prelude.Double, long :: Kernel.Prelude.Double, timestamp :: Kernel.Prelude.Double}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data UpdatePaymentOrderReq
    = UpdatePaymentOrderReq {childTicketQuantity :: Kernel.Prelude.Int, quantity :: Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data UpdatePaymentOrderResp
    = UpdatePaymentOrderResp {sdkPayload :: Kernel.Prelude.Maybe Kernel.External.Payment.Juspay.Types.SDKPayloadDetails}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
