...
data ApproveResponse
    = ApproveResponse {success :: Kernel.Prelude.Bool, handler :: Kernel.Prelude.Maybe Domain.Types.MerchantOnboarding.Handler.DashboardSideHandler}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data UploadFileRequest
    = UploadFileRequest {file :: Kernel.Prelude.FilePath, reqContentType :: Kernel.Prelude.Text, fileType :: AWS.S3.FileType}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UploadFileRequest
    where hideSecrets = Kernel.Prelude.identity
newtype UploadFileResponse
  = UploadFileResponse {fileId :: Kernel.Types.Id.Id Dashboard.Common.File}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
...
type MerchantOnboardingInfo = ("onboarding" :> Capture "onboardingType" Kernel.Prelude.Text :> "info" :> QueryParam "requestorId" Kernel.Prelude.Text :> QueryParam "requestorRole"
                                                                                                                                                                    Domain.Types.MerchantOnboarding.RequestorRole :> Get ('[JSON]) Domain.Types.MerchantOnboarding.MerchantOnboardingAPI)
type MerchantOnboardingStart = ("onboarding" :> Capture "onboardingType" Kernel.Prelude.Text :> "start" :> QueryParam "requestorId" Kernel.Prelude.Text :> QueryParam "requestorRole"
                                                                                                                                                                      Domain.Types.MerchantOnboarding.RequestorRole :> Get ('[JSON]) Domain.Types.MerchantOnboarding.MerchantOnboardingAPI)
type MerchantOnboardingList = ("onboarding" :> "list" :> QueryParam "requestorId" Kernel.Prelude.Text :> QueryParam "requestorRole" Domain.Types.MerchantOnboarding.RequestorRole :> Get ('[JSON])
                                                                                                                                                                                         [Domain.Types.MerchantOnboarding.MerchantOnboarding])
type MerchantOnboardingStepSubmit = ("onboarding" :> "step" :> Capture "stepId" Kernel.Prelude.Text :> "submit" :> QueryParam "requestorId" Kernel.Prelude.Text :> QueryParam "requestorRole"
                                                                                                                                                                              Domain.Types.MerchantOnboarding.RequestorRole :> ReqBody ('[JSON]) Data.Aeson.Value :> Post ('[JSON])
                                                                                                                                                                                                                                                                          Domain.Types.MerchantOnboarding.MerchantOnboardingAPI)
type MerchantOnboardingStepUpdatePayload = ("onboarding" :> "step" :> Capture "stepId" Kernel.Prelude.Text :> "updatePayload" :> QueryParam "requestorId"
                                                                                                                                            Kernel.Prelude.Text :> QueryParam "requestorRole" Domain.Types.MerchantOnboarding.RequestorRole :> ReqBody ('[JSON]) Data.Aeson.Value :> Post ('[JSON])
                                                                                                                                                                                                                                                                                          Kernel.Types.APISuccess.APISuccess)
type MerchantOnboardingStepReject = ("onboarding" :> "step" :> Capture "stepId" Kernel.Prelude.Text :> "reject" :> QueryParam "requestorId" Kernel.Prelude.Text :> QueryParam "requestorRole"
                                                                                                                                                                              Domain.Types.MerchantOnboarding.RequestorRole :> ReqBody ('[JSON]) Data.Aeson.Value :> Post ('[JSON])
                                                                                                                                                                                                                                                                          Kernel.Types.APISuccess.APISuccess)
type MerchantOnboardingStepApprove = ("onboarding" :> "step" :> Capture "stepId" Kernel.Prelude.Text :> "approve" :> QueryParam "requestorId" Kernel.Prelude.Text :> QueryParam "requestorRole"
                                                                                                                                                                                Domain.Types.MerchantOnboarding.RequestorRole :> ReqBody ('[JSON]) Data.Aeson.Value :> Post ('[JSON]) ApproveResponse)
type MerchantOnboardingStepUploadFile = ("onboarding" :> "step" :> Capture "stepId" Kernel.Prelude.Text :> Capture "payloadKey" Kernel.Prelude.Text :> "uploadFile" :> QueryParam "requestorId"
                                                                                                                                                                                  Kernel.Prelude.Text :> QueryParam "requestorRole"
                                                                                                                                                                                                                    Domain.Types.MerchantOnboarding.RequestorRole :> Kernel.ServantMultipart.MultipartForm Kernel.ServantMultipart.Tmp
                                                                                                                                                                                                                                                                                                           UploadFileRequest :> Post ('[JSON])
                                                                                                                                                                                                                                                                                                                                     UploadFileResponse)
type MerchantOnboardingReject = ("onboarding" :> Capture "onboardingId" Kernel.Prelude.Text :> "reject" :> QueryParam "requestorId" Kernel.Prelude.Text :> QueryParam "requestorRole"
                                                                                                                                                                      Domain.Types.MerchantOnboarding.RequestorRole :> ReqBody ('[JSON]) Data.Aeson.Value :> Post ('[JSON])
                                                                                                                                                                                                                                                                  Kernel.Types.APISuccess.APISuccess)
type MerchantOnboadingListAll = ("onboarding" :> "list" :> "all" :> QueryParam "requestorId" Kernel.Prelude.Text :> QueryParam "requestorRole"
                                                                                                                               Domain.Types.MerchantOnboarding.RequestorRole :> QueryParam "status" Domain.Types.MerchantOnboarding.OnboardingStatus :> QueryParam "onboardingType"
                                                                                                                                                                                                                                                                   Domain.Types.MerchantOnboarding.OnboardingType :> QueryParam "limit"
                                                                                                                                                                                                                                                                                                                                Kernel.Prelude.Int :> QueryParam "offset"
                                                                                                                                                                                                                                                                                                                                                                 Kernel.Prelude.Int :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                           [Domain.Types.MerchantOnboarding.MerchantOnboardingAPI])
type MerchantOnboardingStepList = ("onboarding" :> Capture "onboardingId" Kernel.Prelude.Text :> "step" :> "list" :> QueryParam "requestorId" Kernel.Prelude.Text :> QueryParam "requestorRole"
                                                                                                                                                                                Domain.Types.MerchantOnboarding.RequestorRole :> Get ('[JSON]) [Domain.Types.MerchantOnboardingStep.MerchantOnboardingStep])
type MerchantOnboardingGetFile = ("onboarding" :> Capture "onboardingId" Kernel.Prelude.Text :> "file" :> Capture "fileId" Kernel.Prelude.Text :> QueryParam "requestorId"
                                                                                                                                                             Kernel.Prelude.Text :> QueryParam "requestorRole" Domain.Types.MerchantOnboarding.RequestorRole :> Get ('[JSON])
                                                                                                                                                                                                                                                                    Domain.Types.MerchantOnboarding.GetFileResponse)
type MerchantOnboardingCancel = ("onboarding" :> Capture "onboardingId" Kernel.Prelude.Text :> "cancel" :> QueryParam "requestorId" Kernel.Prelude.Text :> QueryParam "requestorRole"
                                                                                                                                                                      Domain.Types.MerchantOnboarding.RequestorRole :> Get ('[JSON]) Kernel.Types.APISuccess.APISuccess)
data MerchantOnboardingAPIs
    = MerchantOnboardingAPIs {merchantOnboardingInfo :: (Kernel.Prelude.Text -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Domain.Types.MerchantOnboarding.RequestorRole) -> EulerHS.Types.EulerClient Domain.Types.MerchantOnboarding.MerchantOnboardingAPI),
                              ...
                              merchantOnboardingStepUploadFile :: (Kernel.Prelude.Text -> Kernel.Prelude.Text -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Domain.Types.MerchantOnboarding.RequestorRole) -> (Data.ByteString.Lazy.ByteString,
                                                                                                                                                                                                                                        UploadFileRequest) -> EulerHS.Types.EulerClient UploadFileResponse),
...
mkMerchantOnboardingAPIs merchantOnboardingClient = (MerchantOnboardingAPIs {..})
                             where merchantOnboardingInfo :<|> merchantOnboardingStart :<|> merchantOnboardingList :<|> merchantOnboardingStepSubmit :<|> merchantOnboardingStepUpdatePayload :<|> merchantOnboardingStepReject :<|> merchantOnboardingStepApprove :<|> merchantOnboardingStepUploadFile :<|> merchantOnboardingReject :<|> merchantOnboadingListAll :<|> merchantOnboardingStepList :<|> merchantOnboardingGetFile :<|> merchantOnboardingCancel = merchantOnboardingClient
