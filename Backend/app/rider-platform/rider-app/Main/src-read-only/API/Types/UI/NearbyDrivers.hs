...
data BusRideInfo
    = BusRideInfo {busNumber :: Data.Text.Text,
...
data CarRideInfo
    = CarRideInfo {pickupLocation :: Kernel.External.Maps.Types.LatLong}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverInfo
    = DriverInfo {applicableServiceTierTypes :: [Domain.Types.ServiceTierType.ServiceTierType],
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data NearByDriversBucket
    = NearByDriversBucket {driverInfo :: [DriverInfo], radius :: Kernel.Types.Distance.Meters, variant :: Domain.Types.VehicleVariant.VehicleVariant}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data NearbyDriverReq
    = NearbyDriverReq {location :: Kernel.External.Maps.Types.LatLong,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data NearbyDriverRes
    = NearbyDriverRes {buckets :: [NearByDriversBucket], serviceTierTypeToVehicleVariant :: Data.Aeson.Value, variantLevelDriverCount :: Data.Aeson.Value, vehicleDataBuckets :: [VehicleDataBucket]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PilotRideInfo
    = PilotRideInfo {destination :: Kernel.External.Maps.Types.LatLong,
                     driverName :: Kernel.Prelude.Maybe Data.Text.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PublicTransportBucket
    = PublicTransportBucket {serviceTierName :: Kernel.Prelude.Maybe Data.Text.Text, serviceType :: Kernel.Prelude.Maybe BecknV2.FRFS.Enums.ServiceTierType, vehicles :: [PublicTransportInfo]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PublicTransportInfo
    = PublicTransportInfo {bearing :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RideDetails
    = RideDetails {rideId :: Data.Text.Text, rideInfo :: Kernel.Prelude.Maybe RideInfo}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RideInfo
    = Bus BusRideInfo | Car CarRideInfo | Pilot PilotRideInfo
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VehicleDataBucket
    = VehicleDataBucket {radius :: Kernel.Types.Distance.Meters, travelMode :: Domain.Types.Trip.MultimodalTravelMode, vehicleInfo :: VehicleInfo}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VehicleInfo
    = PublicTransport PublicTransportBucket | Taxi NearByDriversBucket
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
