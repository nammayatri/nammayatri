...
data NearbyBus
    = NearbyBus {bearing :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
...
data NearbyBusesRequest
    = NearbyBusesRequest {platformType :: Domain.Types.IntegratedBPPConfig.PlatformType,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data NearbyBusesResponse
    = NearbyBusesResponse {nearbyBuses :: [NearbyBus], recentRides :: [RecentRide]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RecentRide
    = RecentRide {fare :: Kernel.Types.Price.Price, fromStopCode :: Data.Text.Text, routeCode :: Kernel.Prelude.Maybe Data.Text.Text, toStopCode :: Data.Text.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RouteCodes
    = RouteCodes {routeCodes :: [Data.Text.Text]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TimetableEntry
    = TimetableEntry {delay :: Kernel.Prelude.Maybe Kernel.Types.Time.Seconds,
...
data TimetableResponse
    = TimetableResponse {timetable :: [TimetableEntry]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
