...
data CustomerCommentReq
    = CustomerCommentReq {body :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CustomerCommentsResp
    = CustomerCommentsResp {comments :: Kernel.Prelude.Maybe [Kernel.Prelude.Text], customerId :: Kernel.Types.Id.Id Domain.Types.Person.Person}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CustomerSendMessageReq
    = CustomerSendMessageReq {channel :: MediaChannel,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MediaChannel
    = WHATSAPP | PUSH_NOTIFICATION | SMS
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
type API = ("multiModal" :> (GetMultiModalList :<|> PostMultiModalSendMessage :<|> PostMultiModalAddComment :<|> GetMultiModalGetComments))
type GetMultiModalList = ("list" :> QueryParam "limit" EulerHS.Prelude.Integer :> QueryParam "offset" EulerHS.Prelude.Integer :> QueryParam "bookingOffset"
                                                                                                                                            EulerHS.Prelude.Integer :> QueryParam "journeyOffset" EulerHS.Prelude.Integer :> QueryParam "customerPhoneNo" Kernel.Prelude.Text :> QueryParam "countryCode"
                                                                                                                                                                                                                                                                                            Kernel.Prelude.Text :> QueryParam "email"
                                                                                                                                                                                                                                                                                                                              Kernel.Prelude.Text :> QueryParam "fromDate"
                                                                                                                                                                                                                                                                                                                                                                EulerHS.Prelude.Integer :> QueryParam "toDate"
                                                                                                                                                                                                                                                                                                                                                                                                      EulerHS.Prelude.Integer :> QueryParam "rideStatus"
                                                                                                                                                                                                                                                                                                                                                                                                                                            [Domain.Types.BookingStatus.BookingStatus] :> QueryParam "journeyStatus"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     [Domain.Types.Journey.JourneyStatus] :> QueryParam "isPaymentSuccess"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        Kernel.Prelude.Bool :> QueryParam "bookingRequestType"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Domain.Types.Booking.API.BookingRequestType :> QueryParam "customerId"
...
mkMultiModalAPIs multiModalClient = (MultiModalAPIs {..})
                     where getMultiModalList :<|> postMultiModalSendMessage :<|> postMultiModalAddComment :<|> getMultiModalGetComments = multiModalClient
data MultiModalUserActionType
    = GET_MULTI_MODAL_LIST | POST_MULTI_MODAL_SEND_MESSAGE | POST_MULTI_MODAL_ADD_COMMENT | GET_MULTI_MODAL_GET_COMMENTS
