...
transitOperatorStationEtaUpsert :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> BecknV2.OnDemand.Enums.VehicleCategory -> SharedLogic.External.Nandi.Types.StationEtaUpsertReq -> Environment.FlowHandler Data.Aeson.Value)
transitOperatorStationEtaUpsert a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.AppManagement.TransitOperator.transitOperatorStationEtaUpsert a4 a3 a2 a1
