...
postSelectEstimate a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Select.postSelectEstimate a6 a5 a3 a2 a1
    )
...
postSelectCancelSearch a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Select.postSelectCancelSearch a5 a4 a2 a1
    )
