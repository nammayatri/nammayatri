...
ticketDashboardUploadAsset a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.TicketDashboard.ticketDashboardUploadAsset a5 a4 a2 a1
    )
...
ticketDashboardDeleteAsset a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.TicketDashboard.ticketDashboardDeleteAsset a5 a4 a2 a1
    )
...
ticketDashboardCurrentSeatStatus a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.TicketDashboard.ticketDashboardCurrentSeatStatus a5 a4 a2 a1
    )
...
ticketDashboardSeatManagement a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.TicketDashboard.ticketDashboardSeatManagement a5 a4 a2 a1
    )
