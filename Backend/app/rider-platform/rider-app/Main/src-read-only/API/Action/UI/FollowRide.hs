...
type API = (TokenAuth :> "follow" :> "ride" :> Get ('[JSON]) [API.Types.UI.FollowRide.Followers] :<|> TokenAuth :> "share" :> "ride" :> ReqBody ('[JSON])
                                                                                                                                                API.Types.UI.FollowRide.ShareRideReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess :<|> TokenAuth :> "followRide" :> "ECStatus" :> Capture "rideId"
                                                                                                                                                                                                                                                                                                  (Kernel.Types.Id.Id Domain.Types.Ride.Ride) :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                     API.Types.UI.FollowRide.EmergencyContactsStatusRes :<|> TokenAuth :> "followRide" :> Capture "rideId"
                                                                                                                                                                                                                                                                                                                                                                                                                                                  (Kernel.Types.Id.Id Domain.Types.Ride.Ride) :> "customerDetails" :> Get ('[JSON])
...
postShareRide :: ((Kernel.Types.Id.Id Domain.Types.Person.Person,
                   Kernel.Types.Id.Id Domain.Types.Merchant.Merchant) -> API.Types.UI.FollowRide.ShareRideReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
getFollowRideECStatus :: ((Kernel.Types.Id.Id Domain.Types.Person.Person,
                           Kernel.Types.Id.Id Domain.Types.Merchant.Merchant) -> Kernel.Types.Id.Id Domain.Types.Ride.Ride -> Environment.FlowHandler API.Types.UI.FollowRide.EmergencyContactsStatusRes)
...
getFollowRideCustomerDetails :: ((Kernel.Types.Id.Id Domain.Types.Person.Person,
                                  Kernel.Types.Id.Id Domain.Types.Merchant.Merchant) -> Kernel.Types.Id.Id Domain.Types.Ride.Ride -> Environment.FlowHandler API.Types.UI.FollowRide.FollowRideCustomerDetailsRes)
