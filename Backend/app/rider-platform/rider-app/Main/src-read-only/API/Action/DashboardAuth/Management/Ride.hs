...
postRideSyncMultiple a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Ride.postRideSyncMultiple a4 a3 a1
    )
...
postRidePayoutOfferSync a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Ride.postRidePayoutOfferSync a4 a3 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a2)) a1
    )
...
postRideCancelMultiple a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Ride.postRideCancelMultiple a4 a3 a1
    )
