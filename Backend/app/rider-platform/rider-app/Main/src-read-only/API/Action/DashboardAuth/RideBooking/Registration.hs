...
postRegistrationAuth a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Registration.postRegistrationAuth a4 a3 a1
    )
...
postRegistrationVerify a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Registration.postRegistrationVerify a5 a4 a2 a1
    )
...
postRegistrationOtpResend a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Registration.postRegistrationOtpResend a4 a3 a1
    )
...
postRegistrationLogout a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Registration.postRegistrationLogout a4 a3 a1
    )
