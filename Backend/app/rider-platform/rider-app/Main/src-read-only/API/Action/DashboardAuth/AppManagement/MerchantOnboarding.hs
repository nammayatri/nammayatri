...
merchantOnboardingStepSubmit a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.MerchantOnboarding.merchantOnboardingStepSubmit a7 a6 a4 a3 a2 a1
    )
...
merchantOnboardingStepUpdatePayload a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.MerchantOnboarding.merchantOnboardingStepUpdatePayload a7 a6 a4 a3 a2 a1
    )
...
merchantOnboardingStepReject a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.MerchantOnboarding.merchantOnboardingStepReject a7 a6 a4 a3 a2 a1
    )
...
merchantOnboardingStepApprove a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.MerchantOnboarding.merchantOnboardingStepApprove a7 a6 a4 a3 a2 a1
    )
...
merchantOnboardingStepUploadFile a8 a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.MerchantOnboarding.merchantOnboardingStepUploadFile a8 a7 a5 a4 a3 a2 a1
    )
...
merchantOnboardingReject a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.MerchantOnboarding.merchantOnboardingReject a7 a6 a4 a3 a2 a1
    )
