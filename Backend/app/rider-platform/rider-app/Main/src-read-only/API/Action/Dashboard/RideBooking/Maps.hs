...
import qualified Domain.Action.Dashboard.RideBooking.Maps as Domain.Action.Dashboard.RideBooking.Maps
...
postMapsGetPlaceDetails :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Kernel.Types.Id.Id Domain.Types.Person.Person -> Domain.Action.UI.Maps.GetPlaceDetailsReq -> Environment.FlowHandler Domain.Action.UI.Maps.GetPlaceDetailsResp)
postMapsGetPlaceDetails a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.RideBooking.Maps.postMapsGetPlaceDetails a4 a3 a2 a1
