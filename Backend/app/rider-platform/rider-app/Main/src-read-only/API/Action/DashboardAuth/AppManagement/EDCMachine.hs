...
assignEDCMachine a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.EDCMachine.assignEDCMachine a4 a3 a1
    )
...
updateEDCMachine a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.EDCMachine.updateEDCMachine a5 a4 a2 a1
    )
...
deleteEDCMachine a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.EDCMachine.deleteEDCMachine a4 a3 a1
    )
