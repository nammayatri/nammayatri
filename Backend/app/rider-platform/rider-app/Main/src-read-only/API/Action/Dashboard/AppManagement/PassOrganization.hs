...
getPassOrganizationPassDetailsDepot a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.AppManagement.PassOrganization.getPassOrganizationPassDetailsDepot a7 a6 a5 a4 a3 a2 a1
