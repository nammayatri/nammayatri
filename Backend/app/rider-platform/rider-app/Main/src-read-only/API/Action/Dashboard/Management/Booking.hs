...
postBookingCancelAllStuck a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Booking.postBookingCancelAllStuck a3 a2 a1
...
postBookingSyncMultiple a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Booking.postBookingSyncMultiple a3 a2 a1
