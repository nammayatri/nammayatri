...
type API = (API.Action.Dashboard.RideBooking.Booking.API :<|> API.Action.Dashboard.RideBooking.Cancel.API :<|> API.Action.Dashboard.RideBooking.Confirm.API :<|> API.Action.Dashboard.RideBooking.Frontend.API :<|> API.Action.Dashboard.RideBooking.Maps.API :<|> API.Action.Dashboard.RideBooking.Profile.API :<|> API.Action.Dashboard.RideBooking.Quote.API :<|> API.Action.Dashboard.RideBooking.Registration.API :<|> API.Action.Dashboard.RideBooking.Search.API :<|> API.Action.Dashboard.RideBooking.Select.API)
