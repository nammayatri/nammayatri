...
type API = ("getCustomerInfo" :> Header "token" Data.Text.Text :> ReqBody ('[JSON]) API.Types.UI.MeterRideInternal.CustomerInfo :> Get ('[JSON])
                                                                                                                                       API.Types.UI.MeterRideInternal.CustomerInfoResponse :<|> Capture "bppRideId" Data.Text.Text :> "addDestination" :> Header "token" Data.Text.Text :> ReqBody ('[JSON])
                                                                                                                                                                                                                                                                                                   API.Types.UI.MeterRideInternal.MeterRideAddDestinationReq :> Post ('[JSON])
