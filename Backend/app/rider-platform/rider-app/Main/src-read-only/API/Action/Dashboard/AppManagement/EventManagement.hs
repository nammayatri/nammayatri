...
postEventManagementTicketdashboardTicketplaceApproveDraft a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.AppManagement.EventManagement.postEventManagementTicketdashboardTicketplaceApproveDraft a5 a4 a3 a2 a1
