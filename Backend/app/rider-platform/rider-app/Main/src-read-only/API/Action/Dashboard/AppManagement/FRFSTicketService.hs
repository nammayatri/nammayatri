...
getFRFSTicketServiceCustomerFrfsPaymentAttempts a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.getFRFSTicketServiceCustomerFrfsPaymentAttempts a5 a4 a3 a2 a1
...
postFRFSTicketServiceCustomerFrfsFleetOperatorTripAction a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.postFRFSTicketServiceCustomerFrfsFleetOperatorTripAction a4 a3 a2 a1
...
postFRFSTicketServiceCustomerFrfsFleetOperatorCurrentOperation a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.postFRFSTicketServiceCustomerFrfsFleetOperatorCurrentOperation a4 a3 a2 a1
