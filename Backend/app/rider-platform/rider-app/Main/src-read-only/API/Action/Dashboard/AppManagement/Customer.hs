...
postCustomerSosCreate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Kernel.Types.Id.Id Domain.Types.Person.Person -> Safety.API.Types.UI.Sos.SosReq -> Environment.FlowHandler Safety.API.Types.UI.Sos.SosRes)
