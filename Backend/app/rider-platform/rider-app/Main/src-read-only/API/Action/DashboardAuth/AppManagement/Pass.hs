...
postPassCustomerActivateToday a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Pass.postPassCustomerActivateToday a7 a6 a4 a3 a2 a1
    )
...
postPassCustomerPassSelect a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Pass.postPassCustomerPassSelect a6 a5 a3 a2 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a4)) a1
    )
...
postPassCustomerPassResetDeviceSwitchCount a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Pass.postPassCustomerPassResetDeviceSwitchCount a5 a4 a2 a1
    )
...
postPassCustomerPassUpdateProfilePicture a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Pass.postPassCustomerPassUpdateProfilePicture a6 a5 a3 a2 a1
    )
...
postPassCustomerPassRestore a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Pass.postPassCustomerPassRestore a4 a3 a1
    )
...
createPass a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Pass.createPass a4 a3 a1
    )
...
updatePass a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Pass.updatePass a5 a4 a2 a1
    )
...
deletePass a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Pass.deletePass a4 a3 a1
    )
