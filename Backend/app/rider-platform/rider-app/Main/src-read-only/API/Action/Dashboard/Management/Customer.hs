...
postCustomerUnblock a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Customer.postCustomerUnblock a3 a2 a1
...
getCustomerInfo a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Customer.getCustomerInfo a3 a2 a1
...
postCustomerCancellationDuesSync a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Customer.postCustomerCancellationDuesSync a4 a3 a2 a1
...
getCustomerCancellationDuesDetails a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Customer.getCustomerCancellationDuesDetails a3 a2 a1
...
postCustomerUpdateSafetyCenterBlocking a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Customer.postCustomerUpdateSafetyCenterBlocking a4 a3 a2 a1
...
postCustomerPersonNumbers a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Customer.postCustomerPersonNumbers a3 a2 a1
...
postCustomerPersonId a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Customer.postCustomerPersonId a3 a2 a1
