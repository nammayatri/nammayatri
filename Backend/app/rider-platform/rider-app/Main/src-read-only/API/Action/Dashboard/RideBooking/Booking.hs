...
getBookingAgentL1List a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.RideBooking.Booking.getBookingAgentL1List a9 a8 a7 a6 a5 a4 a3 a2 a1
...
getBookingAgentL2List a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.RideBooking.Booking.getBookingAgentL2List a8 a7 a6 a5 a4 a3 a2 a1
