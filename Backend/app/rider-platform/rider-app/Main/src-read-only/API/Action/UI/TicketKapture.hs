...
type API = (TokenAuth :> "kaptureCustomerLogin" :> MandatoryQueryParam "ticketType" Kernel.External.Ticket.Interface.Types.TicketType :> Post '[JSON] API.Types.UI.TicketKapture.TicketKaptureResp)
