...
getInsurance :: ((Kernel.Types.Id.Id Domain.Types.Person.Person,
                  Kernel.Types.Id.Id Domain.Types.Merchant.Merchant) -> Kernel.Types.Id.Id Domain.Types.Insurance.Insurance -> Environment.FlowHandler API.Types.UI.Insurance.InsuranceAPIEntity)
