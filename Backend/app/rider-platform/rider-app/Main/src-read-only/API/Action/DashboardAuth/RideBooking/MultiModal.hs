...
postMultiModalSendMessage a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.MultiModal.postMultiModalSendMessage a5 a4 a2 a1
    )
...
postMultiModalSendDirectMessage a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.MultiModal.postMultiModalSendDirectMessage a4 a3 a1
    )
...
postMultiModalAddComment a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.MultiModal.postMultiModalAddComment a5 a4 a2 a1
    )
