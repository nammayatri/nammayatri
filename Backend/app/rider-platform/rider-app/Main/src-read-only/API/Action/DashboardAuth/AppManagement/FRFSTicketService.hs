...
postFRFSTicketServiceCustomerFrfsStationsPossibleStops a8 a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.FRFSTicketService.postFRFSTicketServiceCustomerFrfsStationsPossibleStops a8 a7 a5 a4 a3 a2 a1
    )
...
postFRFSTicketServiceCustomerFrfsSearch a9 a8 a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.FRFSTicketService.postFRFSTicketServiceCustomerFrfsSearch a9 a8 a6 a5 a4 a3 a2 a1
    )
...
postFRFSTicketServiceCustomerFrfsQuoteV2Confirm a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.FRFSTicketService.postFRFSTicketServiceCustomerFrfsQuoteV2Confirm a7 a6 a4 a3 a2 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a5)) a1
    )
...
postFRFSTicketServiceCustomerFrfsRouteServiceability a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.FRFSTicketService.postFRFSTicketServiceCustomerFrfsRouteServiceability a6 a5 a3 a2 a1
    )
...
postFRFSTicketServiceCustomerFrfsFleetOperatorTripAction a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.FRFSTicketService.postFRFSTicketServiceCustomerFrfsFleetOperatorTripAction a5 a4 a2 a1
    )
...
postFRFSTicketServiceCustomerFrfsFleetOperatorCurrentOperation a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.FRFSTicketService.postFRFSTicketServiceCustomerFrfsFleetOperatorCurrentOperation a5 a4 a2 a1
    )
