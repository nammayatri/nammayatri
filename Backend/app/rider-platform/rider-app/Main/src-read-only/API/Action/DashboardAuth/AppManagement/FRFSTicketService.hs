...
getFRFSTicketServiceCustomerFrfsConfig a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.getFRFSTicketServiceCustomerFrfsConfig a5 a4 a2 a1
...
getFRFSTicketServiceCustomerFrfsAutocomplete a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a9 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.getFRFSTicketServiceCustomerFrfsAutocomplete a11 a10 a8 a7 a6 a5 a4 a3 a2 a1
...
getFRFSTicketServiceCustomerFrfsRoutes a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a6 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.getFRFSTicketServiceCustomerFrfsRoutes a8 a7 a5 a4 a3 a2 a1
...
getFRFSTicketServiceCustomerFrfsStations a12 a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a10 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.getFRFSTicketServiceCustomerFrfsStations a12 a11 a9 a8 a7 a6 a5 a4 a3 a2 a1
...
postFRFSTicketServiceCustomerFrfsStationsPossibleStops a8 a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_APP_MANAGEMENT/FRFS_TICKET_SERVICE/POST_FRFS_TICKET_SERVICE_CUSTOMER_FRFS_STATIONS_POSSIBLE_STOPS" a6 (Kernel.Prelude.Nothing :: Kernel.Prelude.Maybe ())
        Tools.ActorInfo.withDashboardUserActorInfo a6 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.postFRFSTicketServiceCustomerFrfsStationsPossibleStops a8 a7 a5 a4 a3 a2 a1
    )
...
getFRFSTicketServiceCustomerFrfsRoute a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a7 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.getFRFSTicketServiceCustomerFrfsRoute a9 a8 a6 a5 a4 a3 a2 a1
...
postFRFSTicketServiceCustomerFrfsSearch a9 a8 a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_APP_MANAGEMENT/FRFS_TICKET_SERVICE/POST_FRFS_TICKET_SERVICE_CUSTOMER_FRFS_SEARCH" a7 (Kernel.Prelude.Nothing :: Kernel.Prelude.Maybe ())
        Tools.ActorInfo.withDashboardUserActorInfo a7 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.postFRFSTicketServiceCustomerFrfsSearch a9 a8 a6 a5 a4 a3 a2 a1
    )
...
getFRFSTicketServiceCustomerFrfsSearchQuote a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.getFRFSTicketServiceCustomerFrfsSearchQuote a5 a4 a2 a1
...
postFRFSTicketServiceCustomerFrfsQuoteV2Confirm a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_APP_MANAGEMENT/FRFS_TICKET_SERVICE/POST_FRFS_TICKET_SERVICE_CUSTOMER_FRFS_QUOTE_V2_CONFIRM" a5 (Kernel.Prelude.Nothing :: Kernel.Prelude.Maybe ())
        Tools.ActorInfo.withDashboardUserActorInfo a5 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.postFRFSTicketServiceCustomerFrfsQuoteV2Confirm a7 a6 a4 a3 a2 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a5)) a1
    )
...
getFRFSTicketServiceCustomerFrfsBookingStatus a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.getFRFSTicketServiceCustomerFrfsBookingStatus a5 a4 a2 a1 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a3))
...
getFRFSTicketServiceCustomerFrfsBookingPaymentAttempts a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.getFRFSTicketServiceCustomerFrfsBookingPaymentAttempts a5 a4 a2 a1
...
getFRFSTicketServiceCustomerFrfsPaymentAttempts a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a4 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.getFRFSTicketServiceCustomerFrfsPaymentAttempts a6 a5 a3 a2 a1
...
getFRFSTicketServiceCustomerFrfsRouteSeatLayout a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a4 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.getFRFSTicketServiceCustomerFrfsRouteSeatLayout a6 a5 a3 a2 a1
...
getFRFSTicketServiceCustomerFrfsTripRouteSeats a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a7 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.getFRFSTicketServiceCustomerFrfsTripRouteSeats a9 a8 a6 a5 a4 a3 a2 a1
...
postFRFSTicketServiceCustomerFrfsRouteServiceability a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_APP_MANAGEMENT/FRFS_TICKET_SERVICE/POST_FRFS_TICKET_SERVICE_CUSTOMER_FRFS_ROUTE_SERVICEABILITY" a4 (Kernel.Prelude.Nothing :: Kernel.Prelude.Maybe ())
        Tools.ActorInfo.withDashboardUserActorInfo a4 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.postFRFSTicketServiceCustomerFrfsRouteServiceability a6 a5 a3 a2 a1
    )
...
postFRFSTicketServiceCustomerFrfsFleetOperatorTripAction a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_APP_MANAGEMENT/FRFS_TICKET_SERVICE/POST_FRFS_TICKET_SERVICE_CUSTOMER_FRFS_FLEET_OPERATOR_TRIP_ACTION" a3 (Kernel.Prelude.Nothing :: Kernel.Prelude.Maybe ())
        Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.postFRFSTicketServiceCustomerFrfsFleetOperatorTripAction a5 a4 a2 a1
    )
...
postFRFSTicketServiceCustomerFrfsFleetOperatorCurrentOperation a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_APP_MANAGEMENT/FRFS_TICKET_SERVICE/POST_FRFS_TICKET_SERVICE_CUSTOMER_FRFS_FLEET_OPERATOR_CURRENT_OPERATION" a3 (Kernel.Prelude.Nothing :: Kernel.Prelude.Maybe ())
        Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.Dashboard.AppManagement.FRFSTicketService.postFRFSTicketServiceCustomerFrfsFleetOperatorCurrentOperation a5 a4 a2 a1
    )
