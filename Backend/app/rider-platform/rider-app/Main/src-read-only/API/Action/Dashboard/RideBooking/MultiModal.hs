...
postMultiModalSendDirectMessage :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.Dashboard.RideBooking.MultiModal.CustomerSendDirectMessageReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postMultiModalSendDirectMessage a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.RideBooking.MultiModal.postMultiModalSendDirectMessage a3 a2 a1
