...
postPassOrganizationPassDetailsVerify a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.PassOrganization.postPassOrganizationPassDetailsVerify a4 a3 a1
    )
...
postPassOrganizationUpdate a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.PassOrganization.postPassOrganizationUpdate a5 a4 a2 a1
    )
...
postPassOrganizationAssignDepot a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.PassOrganization.postPassOrganizationAssignDepot a4 a3 a1
    )
