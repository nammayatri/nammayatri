...
getPassOrganizationGetPassOrganization a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.AppManagement.PassOrganization.getPassOrganizationGetPassOrganization a4 a3 a1
...
getPassOrganizationPassDetailsDepot a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a5 $ Domain.Action.Dashboard.AppManagement.PassOrganization.getPassOrganizationPassDetailsDepot a7 a6 a4 a3 a2 a1
...
getPassOrganizationPassDetails a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a6 $ Domain.Action.Dashboard.AppManagement.PassOrganization.getPassOrganizationPassDetails a8 a7 a5 a4 a3 a2 a1
...
postPassOrganizationPassDetailsVerify a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_APP_MANAGEMENT/PASS_ORGANIZATION/POST_PASS_ORGANIZATION_PASS_DETAILS_VERIFY" a2 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.AppManagement.PassOrganization.postPassOrganizationPassDetailsVerify a4 a3 a1
    )
...
postPassOrganizationUpdate a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_APP_MANAGEMENT/PASS_ORGANIZATION/POST_PASS_ORGANIZATION_UPDATE" a3 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.Dashboard.AppManagement.PassOrganization.postPassOrganizationUpdate a5 a4 a2 a1
    )
...
getPassOrganizationGetOrganizations a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.Dashboard.AppManagement.PassOrganization.getPassOrganizationGetOrganizations a5 a4 a2 a1
...
getPassOrganizationPassDetailsDocument a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.AppManagement.PassOrganization.getPassOrganizationPassDetailsDocument a4 a3 a1
...
postPassOrganizationAssignDepot a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_APP_MANAGEMENT/PASS_ORGANIZATION/POST_PASS_ORGANIZATION_ASSIGN_DEPOT" a2 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.AppManagement.PassOrganization.postPassOrganizationAssignDepot a4 a3 a1
    )
