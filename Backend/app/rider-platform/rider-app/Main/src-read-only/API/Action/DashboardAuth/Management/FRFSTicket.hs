...
getFRFSTicketFrfsRouteFareList a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a4 $ Domain.Action.Dashboard.FRFSTicket.getFRFSTicketFrfsRouteFareList a6 a5 a3 a2 a1
...
putFRFSTicketFrfsRouteFareUpsert a7 a6 a5 a4 a3 a2 a1 =
...
getFRFSTicketFrfsRouteStations a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a5 $ Domain.Action.Dashboard.FRFSTicket.getFRFSTicketFrfsRouteStations a7 a6 a4 a3 a2 a1
...
getFRFSTicketFrfsGtfs a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a4 $ Domain.Action.Dashboard.FRFSTicket.getFRFSTicketFrfsGtfs a6 a5 a3 a2 a1
...
postFRFSTicketFrfsStatusUpdate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_MANAGEMENT/FRFS_TICKET/POST_FRFS_TICKET_FRFS_STATUS_UPDATE" a2 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.FRFSTicket.postFRFSTicketFrfsStatusUpdate a4 a3 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a2)) a1
    )
