...
putFRFSTicketFrfsRouteFareUpsert a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.FRFSTicket.putFRFSTicketFrfsRouteFareUpsert a7 a6 a4 a3 a2 a1
    )
...
postFRFSTicketFrfsStatusUpdate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.FRFSTicket.postFRFSTicketFrfsStatusUpdate a4 a3 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a2)) a1
    )
