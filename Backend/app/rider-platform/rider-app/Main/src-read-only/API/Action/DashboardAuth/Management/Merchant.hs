...
postMerchantConfigAllowedDestinationStates a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Merchant.postMerchantConfigAllowedDestinationStates a4 a3 a1
    )
...
getMerchantConfigAllowedDestinationStates a4 a3 _a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Merchant.getMerchantConfigAllowedDestinationStates a4 a3 a1
...
postMerchantCloudUpdate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Merchant.postMerchantCloudUpdate a4 a3 a1
    )
