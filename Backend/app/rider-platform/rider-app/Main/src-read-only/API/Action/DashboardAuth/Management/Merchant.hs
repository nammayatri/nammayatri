...
postMerchantConfigOperatingCityCreate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Merchant.postMerchantConfigOperatingCityCreate a4 a3 a1
    )
...
postMerchantSpecialLocationUpsert a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Merchant.postMerchantSpecialLocationUpsert a5 a4 a2 a1
    )
...
postMerchantSpecialLocationGatesUpsert a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Merchant.postMerchantSpecialLocationGatesUpsert a5 a4 a2 a1
    )
...
postMerchantConfigMerchantCreate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Merchant.postMerchantConfigMerchantCreate a4 a3 a1
    )
