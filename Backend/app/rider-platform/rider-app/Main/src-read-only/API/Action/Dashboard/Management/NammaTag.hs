...
postNammaTagTagCreate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.postNammaTagTagCreate a3 a2 a1
...
postNammaTagTagUpdate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.postNammaTagTagUpdate a3 a2 a1
...
deleteNammaTagTagDelete a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.deleteNammaTagTagDelete a3 a2 a1
...
postNammaTagQueryCreate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.postNammaTagQueryCreate a3 a2 a1
...
postNammaTagAppDynamicLogicVerify a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.postNammaTagAppDynamicLogicVerify a3 a2 a1
...
getNammaTagAppDynamicLogic a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.getNammaTagAppDynamicLogic a4 a3 a2 a1
...
postNammaTagRunJob a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.postNammaTagRunJob a3 a2 a1
...
getNammaTagTimeBounds a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.getNammaTagTimeBounds a3 a2 a1
...
postNammaTagTimeBoundsCreate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.postNammaTagTimeBoundsCreate a3 a2 a1
...
deleteNammaTagTimeBoundsDelete a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.deleteNammaTagTimeBoundsDelete a4 a3 a2 a1
...
getNammaTagAppDynamicLogicGetLogicRollout a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.getNammaTagAppDynamicLogicGetLogicRollout a4 a3 a2 a1
...
postNammaTagAppDynamicLogicUpsertLogicRollout a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.postNammaTagAppDynamicLogicUpsertLogicRollout a3 a2 a1
...
getNammaTagAppDynamicLogicVersions a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.getNammaTagAppDynamicLogicVersions a5 a4 a3 a2 a1
...
getNammaTagAppDynamicLogicDomains a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.getNammaTagAppDynamicLogicDomains a2 a1
...
getNammaTagQueryAll a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.getNammaTagQueryAll a3 a2 a1
...
postNammaTagUpdateCustomerTag a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.NammaTag.postNammaTagUpdateCustomerTag a4 a3 a2 a1
