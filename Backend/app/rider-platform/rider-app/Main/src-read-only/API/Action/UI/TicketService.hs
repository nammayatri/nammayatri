...
type API =
  TokenAuth :> "ticket" :> "places" :> Get '[JSON] [Domain.Types.TicketPlace.TicketPlace]
    ...
    :<|> TokenAuth :> "ticket" :> "bookings" :> QueryParam "limit" (Kernel.Prelude.Int) :> QueryParam "offset" (Kernel.Prelude.Int) :> QueryParam "status" (Domain.Types.TicketBooking.BookingStatus) :> Get '[JSON] [API.Types.UI.TicketService.TicketBookingAPIEntity]
