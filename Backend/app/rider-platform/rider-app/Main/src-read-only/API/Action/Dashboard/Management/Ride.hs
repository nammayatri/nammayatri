...
getShareRideInfo a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Ride.getShareRideInfo a3 a2 a1
...
getShareRideInfoByShortId a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Ride.getShareRideInfoByShortId a3 a2 a1
