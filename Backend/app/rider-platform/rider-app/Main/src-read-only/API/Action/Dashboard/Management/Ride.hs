...
postRidePayoutOfferSync :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.RiderPlatform.Management.Ride.MultipleRideSyncReq -> Environment.FlowHandler Dashboard.Common.Ride.MultipleRideSyncResp)
postRidePayoutOfferSync a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Ride.postRidePayoutOfferSync a3 a2 a1
...
getRideFlowDebugBap a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Ride.getRideFlowDebugBap a8 a7 a6 a5 a4 a3 a2 a1
