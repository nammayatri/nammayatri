...
type PostNammaTagConfigPilotVerify =
  ( DashboardUserAuth
      ('APP_BACKEND_MANAGEMENT)
      "RIDER_MANAGEMENT/NAMMA_TAG/POST_NAMMA_TAG_CONFIG_PILOT_VERIFY"
      :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagConfigPilotVerify
  )

type PostNammaTagConfigPilotUpsertLogicRollout =
  ( DashboardUserAuth
      ('APP_BACKEND_MANAGEMENT)
      "RIDER_MANAGEMENT/NAMMA_TAG/POST_NAMMA_TAG_CONFIG_PILOT_UPSERT_LOGIC_ROLLOUT"
      :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagConfigPilotUpsertLogicRollout
  )

type PostNammaTagConfigPilotRolloutAction =
  ( DashboardUserAuth
      ('APP_BACKEND_MANAGEMENT)
      "RIDER_MANAGEMENT/NAMMA_TAG/POST_NAMMA_TAG_CONFIG_PILOT_ROLLOUT_ACTION"
      :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagConfigPilotRolloutAction
  )
...
postNammaTagTagCreate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagTagCreate a4 a3 a1
    )
...
postNammaTagTagUpdate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagTagUpdate a4 a3 a1
    )
...
postNammaTagTagVerify a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagTagVerify a4 a3 a1
    )
...
deleteNammaTagTagDelete a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.deleteNammaTagTagDelete a4 a3 a1
    )
...
postNammaTagQueryCreate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagQueryCreate a4 a3 a1
    )
...
postNammaTagQueryUpdate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagQueryUpdate a4 a3 a1
    )
...
deleteNammaTagQueryDelete a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.deleteNammaTagQueryDelete a4 a3 a1
    )
...
postNammaTagAppDynamicLogicVerify a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagAppDynamicLogicVerify a4 a3 a1
    )
...
postNammaTagRunJob a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagRunJob a4 a3 a1
    )
...
postNammaTagTimeBoundsCreate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagTimeBoundsCreate a4 a3 a1
    )
...
deleteNammaTagTimeBoundsDelete a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.deleteNammaTagTimeBoundsDelete a5 a4 a2 a1
    )
...
postNammaTagAppDynamicLogicUpsertLogicRollout a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagAppDynamicLogicUpsertLogicRollout a4 a3 a1
    )
...
postNammaTagAppDynamicLogicUpdateExperimentGroup a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagAppDynamicLogicUpdateExperimentGroup a4 a3 a1
    )
...
postNammaTagUpdateCustomerTag a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagUpdateCustomerTag a5 a4 a2 a1
    )
...
postNammaTagBulkUpdateCustomerTag a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagBulkUpdateCustomerTag a4 a3 a1
    )
...
postNammaTagConfigPilotGetVersion a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagConfigPilotGetVersion a4 a3 a1
    )
...
postNammaTagConfigPilotGetConfig a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagConfigPilotGetConfig a4 a3 a1
    )
...
postNammaTagConfigPilotCreateUiConfig a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagConfigPilotCreateUiConfig a4 a3 a1
    )
...
postNammaTagConfigPilotActionChange a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagConfigPilotActionChange a4 a3 a1
    )
...
postNammaTagConfigPilotGetConfigWithDimensions a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_MANAGEMENT/NAMMA_TAG/POST_NAMMA_TAG_CONFIG_PILOT_GET_CONFIG_WITH_DIMENSIONS" a3 (Kernel.Prelude.Just a1)
        Domain.Action.Dashboard.NammaTag.postNammaTagConfigPilotGetConfigWithDimensions a5 a4 a2 a1
    )
...
postNammaTagConfigPilotCreateRow a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_MANAGEMENT/NAMMA_TAG/POST_NAMMA_TAG_CONFIG_PILOT_CREATE_ROW" a3 (Kernel.Prelude.Just a1)
        Domain.Action.Dashboard.NammaTag.postNammaTagConfigPilotCreateRow a5 a4 a2 a1
    )
...
postNammaTagConfigPilotVerify a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_MANAGEMENT/NAMMA_TAG/POST_NAMMA_TAG_CONFIG_PILOT_VERIFY" a3 (Kernel.Prelude.Just a1)
        Domain.Action.Dashboard.NammaTag.postNammaTagConfigPilotVerify a5 a4 a2 a1
    )
...
postNammaTagConfigPilotUpsertLogicRollout a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_MANAGEMENT/NAMMA_TAG/POST_NAMMA_TAG_CONFIG_PILOT_UPSERT_LOGIC_ROLLOUT" a3 (Kernel.Prelude.Just a1)
        Domain.Action.Dashboard.NammaTag.postNammaTagConfigPilotUpsertLogicRollout a5 a4 a2 a1
    )
...
postNammaTagConfigPilotRolloutAction a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.APP_BACKEND_MANAGEMENT "RIDER_MANAGEMENT/NAMMA_TAG/POST_NAMMA_TAG_CONFIG_PILOT_ROLLOUT_ACTION" a3 (Kernel.Prelude.Just a1)
        Domain.Action.Dashboard.NammaTag.postNammaTagConfigPilotRolloutAction a5 a4 a2 a1
    )
