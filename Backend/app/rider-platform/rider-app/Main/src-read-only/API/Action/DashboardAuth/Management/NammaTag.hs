...
postNammaTagConfigPilotGetConfigWithDimensions a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagConfigPilotGetConfigWithDimensions a4 a3 a1
    )
...
postNammaTagConfigPilotCreateRow a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.NammaTag.postNammaTagConfigPilotCreateRow a4 a3 a1
    )
