...
postMerchantSchedulerRevive :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.RiderPlatform.Management.Merchant.ReviveSchedulerJobsReq -> Environment.FlowHandler API.Types.RiderPlatform.Management.Merchant.ReviveSchedulerJobsRes)
postMerchantSchedulerRevive a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Merchant.postMerchantSchedulerRevive a3 a2 a1
