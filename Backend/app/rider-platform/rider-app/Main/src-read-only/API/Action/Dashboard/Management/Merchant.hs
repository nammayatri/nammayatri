...
postMerchantConfigMerchantPushNotificationUpsert :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.RiderPlatform.Management.Merchant.UpsertMerchantPushNotificationCsvReq -> Environment.FlowHandler API.Types.RiderPlatform.Management.Merchant.UpsertMerchantPushNotificationCsvResp)
postMerchantConfigMerchantPushNotificationUpsert a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Merchant.postMerchantConfigMerchantPushNotificationUpsert a3 a2 a1

postMerchantConfigMerchantMessageUpsert :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.RiderPlatform.Management.Merchant.UpsertMerchantMessageCsvReq -> Environment.FlowHandler API.Types.RiderPlatform.Management.Merchant.UpsertMerchantMessageCsvResp)
postMerchantConfigMerchantMessageUpsert a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Merchant.postMerchantConfigMerchantMessageUpsert a3 a2 a1

postMerchantConfigDisabilityTranslationUpsert :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.RiderPlatform.Management.Merchant.UpsertDisabilityTranslationCsvReq -> Environment.FlowHandler API.Types.RiderPlatform.Management.Merchant.UpsertDisabilityTranslationCsvResp)
postMerchantConfigDisabilityTranslationUpsert a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Merchant.postMerchantConfigDisabilityTranslationUpsert a3 a2 a1
