...
type API =
  ( "updateBusLocation" :> QueryParam "latitude" Double :> QueryParam "longitude" Double :> QueryParam "busId" Text :> Get '[JSON] Text
      :<|> TokenAuth
      :> "multimodal"
      :> "routeServiceability"
      :> ReqBody '[JSON] API.Types.UI.MultimodalConfirm.RouteServiceabilityReq
      :> Post
           '[JSON]
