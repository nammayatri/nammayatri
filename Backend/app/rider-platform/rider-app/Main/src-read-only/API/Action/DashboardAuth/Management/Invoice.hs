...
getInvoiceFinanceList a11 a10 _a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Invoice.getInvoiceFinanceList a11 a10 a8 a7 a6 a5 a4 a3 a2 a1
...
getInvoiceFinancePdf a4 a3 _a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Invoice.getInvoiceFinancePdf a4 a3 a1
