...
tfCustomer :: (Monad m, Kernel.Types.App.MonadFlow m) => Maybe Tools.Maps.Language -> Maybe Data.Text.Text -> Maybe Data.Text.Text -> m (Maybe BecknV2.OnDemand.Types.Customer)
...
tfPayment :: (Monad m, Kernel.Types.App.MonadFlow m) => Data.Text.Text -> m (Maybe BecknV2.OnDemand.Types.Payment)
...
tfPerson :: (Monad m, Kernel.Types.App.MonadFlow m) => Maybe Tools.Maps.Language -> Maybe Data.Text.Text -> Maybe Data.Text.Text -> m (Maybe BecknV2.OnDemand.Types.Person)
