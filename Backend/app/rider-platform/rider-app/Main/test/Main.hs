import Prelude
import Test.Tasty
import qualified ReachOnTime.DepartureAdvisorSpec as DepartureAdvisorSpec

main :: IO ()
main = defaultMain $ testGroup "rider-app tests"
  [ DepartureAdvisorSpec.tests
  ]

-- Previous integration test code (requires running services):
--
-- import App
