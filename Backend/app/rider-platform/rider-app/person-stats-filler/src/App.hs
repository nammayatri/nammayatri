...
runPersonStatsFiller :: (AppCfg -> AppCfg) -> IO ()
runPersonStatsFiller configModifier = do
  appCfg <- configModifier <$> readDhallConfigDefault "person-stats-filler"
  appEnv <-
