...
runUpdateCommands (cmd, val) streamKey = do
  ...
  case cmd of
    ...
    UpdateDBCommand id _ tag _ _ (RentalDetailsOptions _ setClauses whereClause) -> runUpdateInKafkaAndDb id val streamKey setClauses tag whereClause ("RentalDetails" :: Text) =<< dbConf
    ...
    UpdateDBCommand id _ tag _ _ (AutoCompleteDataOptions _ setClauses whereClause) -> runUpdateInKafkaAndDb id val streamKey setClauses tag whereClause ("AutoCompleteData" :: Text) =<< dbConf
  where
