...
let outputPrefixReadOnly =
      rootDir ++ "/Backend/app/safety-dashboard/src-read-only/"

let outputPrefix = rootDir ++ "/Backend/app/safety-dashboard/src/"

let migrationPath =
      rootDir ++ "/Backend/dev/migrations-read-only/safety-dashboard/"
...
let defaultImports =
      ...
      , { _simpleImports =
          ...
          , "Kernel.Prelude"
          , "Kernel.External.Encryption"
          , "Kernel.Utils.Common (KvDbFlow, getCurrentTime, fromMaybeM)"
          , "Kernel.Types.Error"
          ]
