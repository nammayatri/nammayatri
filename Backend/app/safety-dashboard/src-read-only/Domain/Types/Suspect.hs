...
data Suspect
    = Suspect {createdAt :: Kernel.Prelude.UTCTime,
...
data FlaggedBy
    = FlaggedBy {agentContactNumber :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
data ReportDetails
    = ReportDetails {reportNumber :: Kernel.Prelude.Maybe Kernel.Prelude.Text, reportPoliceStation :: Kernel.Prelude.Maybe Kernel.Prelude.Text, reportType :: Domain.Types.Suspect.ReportType}
    deriving (Generic, Show, ToJSON, FromJSON, ToSchema, Ord, Eq, Read)
