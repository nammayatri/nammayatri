...
type API = (DashboardAuth ('MERCHANT_ADMIN) :> "set" :> "merchantConfig" :> ReqBody ('[JSON]) API.Types.UI.Merchant.SetMerchantConfigReq :> Post ('[JSON])
                                                                                                                                                 Kernel.Types.APISuccess.APISuccess :<|> DashboardAuth ('MERCHANT_ADMIN) :> "merchant" :> "user" :> "list" :> Get ('[JSON])
                                                                                                                                                                                                                                                                  API.Types.UI.Merchant.MerchantUserList :<|> DashboardAuth ('MERCHANT_ADMIN) :> "merchant" :> "user" :> "resetPassword" :> ReqBody ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                    API.Types.UI.Merchant.ResetPasswordReq :> Post ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                   Kernel.Types.APISuccess.APISuccess :<|> DashboardAuth ('MERCHANT_ADMIN) :> "merchant" :> "get" :> "webhookConfig" :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            Domain.Types.MerchantConfigs.MerchantConfigs :<|> DashboardAuth ('MERCHANT_ADMIN) :> "merchant" :> "webhookConfig" :> "preference" :> ReqBody ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          API.Types.UI.Merchant.WebHookConfigPreferenceReq :> Post ('[JSON])
