...
data CheckSuspectStatusHistoryResp
    = CheckSuspectStatusHistoryResp {suspectStatusHistory :: [StatusHistory]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SearchSuspectReq
    = SearchSuspectReq {dl :: Kernel.Prelude.Maybe Data.Text.Text, voterId :: Kernel.Prelude.Maybe Data.Text.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SearchSuspectReqList
    = SearchSuspectReqList {suspectReqList :: [SearchSuspectReq]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SearchSuspectResp
    = SearchSuspectResp {createdAt :: Kernel.Prelude.UTCTime,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data StatusHistory
    = StatusHistory {adminApproval :: Kernel.Prelude.Maybe Domain.Types.SuspectFlagRequest.AdminApproval,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SuspectsList
    = SuspectsList {summary :: API.Types.UI.Notification.Summary, suspects :: [SearchSuspectResp]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
