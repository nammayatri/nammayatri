...
data MerchantConfigsT f
    = MerchantConfigsT {id :: (B.C f Kernel.Prelude.Text),
...
instance B.Table MerchantConfigsT
    where data PrimaryKey MerchantConfigsT f = MerchantConfigsId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
