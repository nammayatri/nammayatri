...
findByMerchantId merchantId = do findOneWithDb [Se.Is Beam.merchantId $ Se.Eq (Kernel.Types.Id.getId <$> merchantId)]
...
findByRequestWebHook requestWebHook = do findAllWithDb [Se.Is Beam.requestWebHook $ Se.Eq requestWebHook]
