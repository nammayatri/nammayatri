...
updateRequestWebHookById requestWebHook id = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.MerchantConfigs.MerchantConfigs {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.MerchantConfigs Domain.Types.MerchantConfigs.MerchantConfigs
    where fromTType' (Beam.MerchantConfigsT {..}) = do pure $ Just Domain.Types.MerchantConfigs.MerchantConfigs{id = Kernel.Types.Id.Id id,
                                                                                                                ...
                                                                                                                createdAt = createdAt,
                                                                                                                updatedAt = updatedAt}
instance ToTType' Beam.MerchantConfigs Domain.Types.MerchantConfigs.MerchantConfigs
    where toTType' (Domain.Types.MerchantConfigs.MerchantConfigs {..}) = do Beam.MerchantConfigsT{Beam.id = Kernel.Types.Id.getId id,
