...
instance FromTType' Beam.Suspect Domain.Types.Suspect.Suspect
    where fromTType' (Beam.SuspectT {..}) = do {flaggedBy' <- getFlaggedByFromTable flaggedBy;
                                                pure $ Just Domain.Types.Suspect.Suspect{createdAt = createdAt,
                                                                                         dl = dl,
                                                                                         firstName = firstName,
                                                                                         ...
                                                                                         updatedAt = updatedAt,
                                                                                         voterId = voterId}}
instance ToTType' Beam.Suspect Domain.Types.Suspect.Suspect
    where toTType' (Domain.Types.Suspect.Suspect {..}) = do Beam.SuspectT{Beam.createdAt = createdAt,
                                                                          Beam.dl = dl,
