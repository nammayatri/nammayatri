...
instance FromTType' Beam.SuspectFlagRequest Domain.Types.SuspectFlagRequest.SuspectFlagRequest
    where fromTType' (Beam.SuspectFlagRequestT {..}) = do pure $ Just Domain.Types.SuspectFlagRequest.SuspectFlagRequest{adminApproval = adminApproval,
...
instance ToTType' Beam.SuspectFlagRequest Domain.Types.SuspectFlagRequest.SuspectFlagRequest
    where toTType' (Domain.Types.SuspectFlagRequest.SuspectFlagRequest {..}) = do Beam.SuspectFlagRequestT{Beam.adminApproval = adminApproval,
