...
lookupSpecialZone :: DashboardLoginFlow r => TokenInfo -> LatLong -> LatLong -> FlowHandlerR r [Value]
...
createSpecialZone :: DashboardLoginFlow r => TokenInfo -> Value -> FlowHandlerR r APISuccess
...
updateSpecialZone :: DashboardLoginFlow r => TokenInfo -> Value -> FlowHandlerR r APISuccess
...
deleteSpecialZone :: DashboardLoginFlow r => TokenInfo -> Text -> FlowHandlerR r APISuccess
