...
sendEmailVerificationOtp :: DashboardLoginFlow r => TokenInfo -> DEV.EmailOtpSendReq -> FlowHandlerR r APISuccess
sendEmailVerificationOtp token = withDashboardDbFlowHandlerAPI . DEV.sendEmailVerificationOtp token

verifyEmailOtp :: DashboardLoginFlow r => TokenInfo -> DEV.EmailOtpVerifyReq -> FlowHandlerR r APISuccess
