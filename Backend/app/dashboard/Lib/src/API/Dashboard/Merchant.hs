...
createMerchantWithAdmin :: DashboardLoginFlow r => TokenInfo -> DMerchant.CreateMerchantWithAdminReq -> FlowHandlerR r DP.PersonAPIEntity
createMerchantWithAdmin tokenInfo =
  withDashboardDbFlowHandlerAPI . DMerchant.createMerchantWithAdmin tokenInfo

createMerchant :: DashboardLoginFlow r => TokenInfo -> DMerchant.CreateMerchantReq -> FlowHandlerR r DMerchant.MerchantAPIEntity
createMerchant tokenInfo =
  withDashboardDbFlowHandlerAPI . DMerchant.createMerchant tokenInfo

listMerchants :: DashboardLoginFlow r => TokenInfo -> Maybe Int -> Maybe Int -> Maybe Text -> FlowHandlerR r DMerchant.ListMerchantResp
...
changeMerchantEnableState :: DashboardLoginFlow r => TokenInfo -> DMerchant.ChangeMerchantEnableStateReq -> FlowHandlerR r APISuccess
changeMerchantEnableState tokenInfo req =
  withDashboardDbFlowHandlerAPI $ DMerchant.changeMerchantEnableState tokenInfo req

createUserForMerchant :: DashboardLoginFlow r => TokenInfo -> DPerson.CreatePersonReq -> FlowHandlerR r DPerson.CreatePersonRes
