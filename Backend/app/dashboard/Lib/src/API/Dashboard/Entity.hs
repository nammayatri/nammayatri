...
listEntity :: DashboardLoginFlow r => ShortId DMerchant.Merchant -> TokenInfo -> Maybe Bool -> FlowHandlerR r DEntity.ListEntityResp
listEntity merchantId _ mbIncludeDeleted =
  withDashboardDbFlowHandlerAPI (DEntity.listEntity merchantId mbIncludeDeleted)

createEntity :: DashboardLoginFlow r => ShortId DMerchant.Merchant -> TokenInfo -> DEntity.CreateEntityReq -> FlowHandlerR r DEntity.CreateEntityResp
...
updateEntity :: DashboardLoginFlow r => ShortId DMerchant.Merchant -> TokenInfo -> Id DE.Entity -> DEntity.UpdateEntityReq -> FlowHandlerR r APISuccess
...
deleteEntity :: DashboardLoginFlow r => ShortId DMerchant.Merchant -> TokenInfo -> Id DE.Entity -> FlowHandlerR r APISuccess
