...
getUserResourceScope :: DashboardLoginFlow r => TokenInfo -> FlowHandlerR r DRS.UserResourceScopeRes
getUserResourceScope = withDashboardDbFlowHandlerAPI . DRS.getUserResourceScope

getPersonResourceAccess :: DashboardLoginFlow r => TokenInfo -> Id DP.Person -> FlowHandlerR r DRS.PersonResourceAccessRes
getPersonResourceAccess tokenInfo = withDashboardDbFlowHandlerAPI . DRS.getPersonResourceAccess tokenInfo

assignResourceAccess :: DashboardLoginFlow r => TokenInfo -> Id DP.Person -> DRS.AssignResourceAccessReq -> FlowHandlerR r APISuccess
assignResourceAccess tokenInfo personId = withDashboardDbFlowHandlerAPI . DRS.assignResourceAccess tokenInfo personId

resetResourceAccess :: DashboardLoginFlow r => TokenInfo -> Id DP.Person -> DRS.ResetResourceAccessReq -> FlowHandlerR r APISuccess
