...
getUserCapabilities :: DashboardLoginFlow r => TokenInfo -> FlowHandlerR r DCap.UserCapabilitiesRes
getUserCapabilities = withDashboardDbFlowHandlerAPI . DCap.getUserCapabilities

listCapabilities :: DashboardLoginFlow r => TokenInfo -> FlowHandlerR r DCap.ListCapabilitiesRes
listCapabilities = withDashboardDbFlowHandlerAPI . DCap.listCapabilities

getCapabilityEndpoints :: DashboardLoginFlow r => TokenInfo -> Text -> FlowHandlerR r DCap.CapabilityEndpointsRes
getCapabilityEndpoints tokenInfo = withDashboardDbFlowHandlerAPI . DCap.getCapabilityEndpoints tokenInfo

getRoleCapabilities :: DashboardLoginFlow r => TokenInfo -> Id DRole.Role -> FlowHandlerR r DCap.RoleCapabilitiesRes
getRoleCapabilities tokenInfo = withDashboardDbFlowHandlerAPI . DCap.getRoleCapabilities tokenInfo

updateRoleCapabilities :: DashboardLoginFlow r => TokenInfo -> Id DRole.Role -> DCap.UpdateRoleCapabilitiesReq -> FlowHandlerR r APISuccess
updateRoleCapabilities tokenInfo roleId = withDashboardDbFlowHandlerAPI . DCap.updateRoleCapabilities tokenInfo roleId

getPersonCapabilities :: DashboardLoginFlow r => TokenInfo -> Id DP.Person -> FlowHandlerR r DCap.PersonCapabilitiesRes
getPersonCapabilities tokenInfo = withDashboardDbFlowHandlerAPI . DCap.getPersonCapabilities tokenInfo

upsertPersonCapability :: DashboardLoginFlow r => TokenInfo -> Id DP.Person -> DCap.UpsertPersonCapabilityReq -> FlowHandlerR r APISuccess
upsertPersonCapability tokenInfo personId = withDashboardDbFlowHandlerAPI . DCap.upsertPersonCapability tokenInfo personId

deletePersonCapability :: DashboardLoginFlow r => TokenInfo -> Id DP.Person -> Text -> FlowHandlerR r APISuccess
