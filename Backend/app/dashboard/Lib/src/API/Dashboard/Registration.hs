...
login :: DashboardLoginFlow r => DReg.LoginReq -> FlowHandlerR r DReg.LoginRes
login = withDashboardDbFlowHandlerAPI . DReg.login

logout :: DashboardLoginFlow r => TokenInfo -> FlowHandlerR r DReg.LogoutRes
logout = withDashboardDbFlowHandlerAPI . DReg.logout

logoutAllMerchants :: DashboardLoginFlow r => TokenInfo -> FlowHandlerR r DReg.LogoutRes
logoutAllMerchants = withDashboardDbFlowHandlerAPI . DReg.logoutAllMerchants

enable2fa :: DashboardLoginFlow r => DReg.Enable2FAReq -> FlowHandlerR r DReg.Enable2FARes
enable2fa = withDashboardDbFlowHandlerAPI . DReg.enable2fa

initiate2FASetup :: DashboardLoginFlow r => DReg.Initiate2FASetupReq -> FlowHandlerR r DReg.Initiate2FASetupRes
initiate2FASetup = withDashboardDbFlowHandlerAPI . DReg.initiate2FASetup

verify2FASetup :: DashboardLoginFlow r => DReg.Verify2FASetupReq -> FlowHandlerR r DReg.Enable2FARes
verify2FASetup = withDashboardDbFlowHandlerAPI . DReg.verify2FASetup

twoFaStatus :: DashboardLoginFlow r => TokenInfo -> FlowHandlerR r DReg.TwoFaStatusRes
...
switchMerchant :: DashboardLoginFlow r => TokenInfo -> DReg.SwitchMerchantReq -> FlowHandlerR r DReg.LoginRes
switchMerchant token = withDashboardDbFlowHandlerAPI . DReg.switchMerchant token

switchMerchantAndCity :: DashboardLoginFlow r => TokenInfo -> DReg.SwitchMerchantAndCityReq -> FlowHandlerR r DReg.LoginRes
