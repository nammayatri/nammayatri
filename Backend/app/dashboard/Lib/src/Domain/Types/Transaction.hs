...
data Endpoint
  ...
  | ProviderConductorAPI ProviderConductor.ConductorUserActionType
...
instance Show Endpoint where
  show = \case
    ...
    ProviderConductorAPI e -> "PROVIDER_CONDUCTOR/" <> show e
...
castEndpoint (DMatrix.PROVIDER_CONDUCTOR uat) = ProviderConductorAPI uat
