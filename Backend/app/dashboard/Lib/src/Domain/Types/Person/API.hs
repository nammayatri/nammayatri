...
makePersonAPIEntity :: DecryptedPerson -> DRole.Role -> [ShortId DMerchant.Merchant] -> Maybe [AvailableCitiesForMerchant] -> [DEntity.Entity] -> Maybe Text -> PersonAPIEntity
makePersonAPIEntity Person {..} personRole availableMerchants availableCitiesForMerchant personEntities visibleTokenNo =
  PersonAPIEntity
