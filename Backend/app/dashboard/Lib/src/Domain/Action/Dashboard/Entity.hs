...
module Domain.Action.Dashboard.Entity
  ( CreateEntityReq (..),
    CreateEntityResp (..),
    UpdateEntityReq (..),
    ListEntityResp (..),
...
import qualified Storage.Beam.BeamFlow as BeamFlow
import Storage.Beam.SchemaInstances ()
import qualified Storage.Queries.Entity as QE
