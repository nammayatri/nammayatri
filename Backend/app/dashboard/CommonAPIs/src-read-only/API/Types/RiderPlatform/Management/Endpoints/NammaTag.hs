...
type GetNammaTagQueryDetails = ("query" :> "details" :> MandatoryQueryParam "chakra" Lib.Yudhishthira.Types.Chakra :> MandatoryQueryParam "queryName" Kernel.Prelude.Text :> Get ('[JSON])
...
type GetNammaTagAppDynamicLogic = ("appDynamicLogic" :> QueryParam "version" Kernel.Prelude.Int :> MandatoryQueryParam "domain" Lib.Yudhishthira.Types.LogicDomain :> Get ('[JSON])
...
type DeleteNammaTagTimeBoundsDelete = ("timeBounds" :> "delete" :> MandatoryQueryParam "domain" Lib.Yudhishthira.Types.LogicDomain :> MandatoryQueryParam "name" Kernel.Prelude.Text :> Delete ('[JSON])
                                                                                                                                                                                               Kernel.Types.APISuccess.APISuccess)
type GetNammaTagAppDynamicLogicGetLogicRollout = ("appDynamicLogic" :> "getLogicRollout" :> QueryParam "activeOnly" Kernel.Prelude.Bool :> QueryParam "timeBound"
                                                                                                                                                      Kernel.Prelude.Text :> MandatoryQueryParam "domain" Lib.Yudhishthira.Types.LogicDomain :> Get ('[JSON]) [Lib.Yudhishthira.Types.LogicRolloutObject])
type PostNammaTagAppDynamicLogicUpsertLogicRollout = ("appDynamicLogic" :> "upsertLogicRollout" :> ReqBody ('[JSON]) Lib.Yudhishthira.Types.LogicRolloutReq :> Post ('[JSON])
                                                                                                                                                                    Kernel.Types.APISuccess.APISuccess)
type GetNammaTagAppDynamicLogicVersions = ("appDynamicLogic" :> "versions" :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> MandatoryQueryParam "domain"
                                                                                                                                                                                     Lib.Yudhishthira.Types.LogicDomain :> Get ('[JSON]) Lib.Yudhishthira.Types.AppDynamicLogicVersionResp)
type GetNammaTagAppDynamicLogicDomains = ("appDynamicLogic" :> "domains" :> Get ('[JSON]) Lib.Yudhishthira.Types.AppDynamicLogicDomainResp)
type GetNammaTagAppDynamicLogicDomainsAndEvents = ("appDynamicLogic" :> "domainsAndEvents" :> QueryParam "fetchNammaTagNames" Kernel.Prelude.Bool :> Get ('[JSON])
                                                                                                                                                         Lib.Yudhishthira.Types.NammaTagEventsOrNammaTagNamesResp)
type GetNammaTagAppDynamicLogicGetDomainSchema = ("appDynamicLogic" :> "getDomainSchema" :> MandatoryQueryParam "domain" Lib.Yudhishthira.Types.LogicDomain :> Get ('[JSON])
...
type PostNammaTagUpdateCustomerTag = (Capture "customerId" (Kernel.Types.Id.Id Dashboard.Common.User) :> "updateCustomerTag" :> ReqBody ('[JSON]) Lib.Yudhishthira.Types.UpdateTagReq :> Post ('[JSON])
                                                                                                                                                                                              Kernel.Types.APISuccess.APISuccess)
...
type GetNammaTagConfigPilotConfigDetails = ("configPilot" :> "configDetails" :> MandatoryQueryParam "tableName" Lib.Yudhishthira.Types.ConfigType :> Get ('[JSON])
...
type GetNammaTagConfigPilotUiConfigDetails = ("configPilot" :> "uiConfigDetails" :> ReqBody ('[JSON]) Lib.Yudhishthira.Types.UiDevicePlatformReq :> Get ('[JSON])
                                                                                                                                                        [Lib.Yudhishthira.Types.ConfigDetailsResp])
...
type PostNammaTagConfigPilotGetConfigWithDimensions = ("configPilot" :> "getConfigWithDimensions" :> ReqBody ('[JSON]) Lib.Yudhishthira.Types.ConfigPilotGetConfigRequest :> Post ('[JSON])
                                                                                                                                                                                  Lib.Yudhishthira.Types.TableDataResp)
type GetNammaTagConfigPilotGetDimensionSchema = ("configPilot" :> "getDimensionSchema" :> MandatoryQueryParam "configType" Lib.Yudhishthira.Types.ConfigType :> Get ('[JSON])
                                                                                                                                                                    Lib.Yudhishthira.Types.DomainSchemaResp)
...
data NammaTagAPIs
    = NammaTagAPIs {postNammaTagTagCreate :: (Lib.Yudhishthira.Types.CreateNammaTagRequest -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess),
