...
module API.Types.RiderPlatform.RideBooking.Invoice where
...
data InvoiceRes = InvoiceRes
  { chargeableDistance :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMeters,
    ...
    faresList :: [API.Types.RiderPlatform.RideBooking.Invoice.FareBreakup],
...
type GetInvoiceInvoice =
  ( "invoice" :> Kernel.Types.Common.MandatoryQueryParam "from" Kernel.Prelude.UTCTime :> Kernel.Types.Common.MandatoryQueryParam "phoneNumber" Data.Text.Text
      :> Kernel.Types.Common.MandatoryQueryParam
           "to"
