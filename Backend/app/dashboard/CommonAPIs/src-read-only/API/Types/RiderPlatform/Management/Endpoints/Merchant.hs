...
data GeometryAPIEntity
    = GeometryAPIEntity {region :: Kernel.Prelude.Text,
...
data JobName
    = NyRegularMasterTrigger | PartnerInvoiceDataExportTrigger
...
data Platform
    ...
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RiderConfigEstimatesOrderRes
    = RiderConfigEstimatesOrderRes {userServiceTierOrderConfig :: [Dashboard.Common.VehicleServiceTierOrderConfig],
...
data SpecialLocationWithPlatform
    = SpecialLocationWithPlatform {location :: Lib.Queries.SpecialLocation.SpecialLocationFull, platform :: Platform}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data UpdateRiderConfigEstimatesOrderReq
    = UpdateRiderConfigEstimatesOrderReq {userServiceTierOrderConfig :: Kernel.Prelude.Maybe [Dashboard.Common.VehicleServiceTierOrderConfig],
...
type GetMerchantConfigGeometryList = ("config" :> "geometry" :> "list" :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> QueryParam "allCities"
                                                                                                                                                                        Kernel.Prelude.Bool :> Get ('[JSON]) GeometryResp)
...
type PostMerchantTicketConfigUpsert = ("ticket" :> "config" :> "upsert" :> Kernel.ServantMultipart.MultipartForm Kernel.ServantMultipart.Tmp UpsertTicketConfigReq :> Post ('[JSON])
...
type PostMerchantRiderConfigEstimatesOrderUpdate = ("riderConfig" :> "estimatesOrder" :> "update" :> ReqBody ('[JSON]) UpdateRiderConfigEstimatesOrderReq :> Post ('[JSON])
                                                                                                                                                                  Kernel.Types.APISuccess.APISuccess)
type PostMerchantConfigDebugLogUpdate = ("config" :> "debugLog" :> "update" :> ReqBody ('[JSON]) Lib.Yudhishthira.Tools.DebugLog.SetJsonLogicDebugReq :> Post ('[JSON])
                                                                                                                                                              Kernel.Types.APISuccess.APISuccess)
data MerchantAPIs
    = MerchantAPIs {postMerchantUpdate :: (MerchantUpdateReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess),
