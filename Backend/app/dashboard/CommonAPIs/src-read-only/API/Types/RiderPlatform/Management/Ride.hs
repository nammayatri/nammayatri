...
data RideInfo = RideInfo
  { rideShortId :: Kernel.Types.Id.ShortId Dashboard.Common.Ride,
    ...
    status :: API.Types.RiderPlatform.Management.Ride.BookingStatus,
...
data RideInfoRes = RideInfoRes
  { rideId :: Kernel.Types.Id.Id Dashboard.Common.Ride,
    ...
    customerPickupLocation :: API.Types.RiderPlatform.Management.Ride.Location,
    customerDropLocation :: Kernel.Prelude.Maybe API.Types.RiderPlatform.Management.Ride.Location,
    driverName :: Kernel.Prelude.Text,
    driverPhoneNo :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
data ShareRideInfoRes = ShareRideInfoRes
  { id :: Kernel.Types.Id.Id Dashboard.Common.Ride,
    ...
    fromLocation :: API.Types.RiderPlatform.Management.Ride.Location,
    toLocation :: Kernel.Prelude.Maybe API.Types.RiderPlatform.Management.Ride.Location,
...
newtype TicketRideListRes = TicketRideListRes {rides :: [API.Types.RiderPlatform.Management.Ride.RideInfo]}
  deriving stock (Show, Generic)
  deriving anyclass (ToSchema)

type API = ("ride" :> (GetRideList :<|> GetRideInfo :<|> GetShareRideInfo :<|> GetShareRideInfoByShortId :<|> GetRideTripRoute :<|> GetRidePickupRoute :<|> PostRideSyncMultiple :<|> PostRideCancelMultiple :<|> GetRideKaptureList))
...
type GetRideInfo = ("rideinfo" :> Capture "rideId" (Kernel.Types.Id.Id Dashboard.Common.Ride) :> Get '[JSON] API.Types.RiderPlatform.Management.Ride.RideInfoRes)

type GetShareRideInfo = (Capture "rideId" (Kernel.Types.Id.Id Dashboard.Common.Ride) :> "info" :> Get '[JSON] API.Types.RiderPlatform.Management.Ride.ShareRideInfoRes)

type GetShareRideInfoByShortId = (Capture "rideShortId" (Kernel.Types.Id.ShortId Dashboard.Common.Ride) :> "rideInfo" :> Get '[JSON] API.Types.RiderPlatform.Management.Ride.ShareRideInfoRes)
...
type PostRideSyncMultiple = ("sync" :> ReqBody '[JSON] API.Types.RiderPlatform.Management.Ride.MultipleRideSyncReq :> Post '[JSON] Dashboard.Common.Ride.MultipleRideSyncResp)

type PostRideCancelMultiple = ("cancel" :> ReqBody '[JSON] API.Types.RiderPlatform.Management.Ride.MultipleRideCancelReq :> Post '[JSON] Kernel.Types.APISuccess.APISuccess)
...
type GetRideKaptureList =
  ( "kapture" :> "list" :> QueryParam "rideShortId" (Kernel.Types.Id.ShortId Dashboard.Common.Ride) :> QueryParam "countryCode" Kernel.Prelude.Text
      ...
      :> Get
           '[JSON]
           API.Types.RiderPlatform.Management.Ride.TicketRideListRes
  )
...
data RideAPIs = RideAPIs
  { getRideList :: Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe API.Types.RiderPlatform.Management.Ride.BookingStatus -> Kernel.Prelude.Maybe (Kernel.Types.Id.ShortId Dashboard.Common.Ride) -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> EulerHS.Types.EulerClient API.Types.RiderPlatform.Management.Ride.RideListRes,
    getRideInfo :: Kernel.Types.Id.Id Dashboard.Common.Ride -> EulerHS.Types.EulerClient API.Types.RiderPlatform.Management.Ride.RideInfoRes,
    getShareRideInfo :: Kernel.Types.Id.Id Dashboard.Common.Ride -> EulerHS.Types.EulerClient API.Types.RiderPlatform.Management.Ride.ShareRideInfoRes,
    getShareRideInfoByShortId :: Kernel.Types.Id.ShortId Dashboard.Common.Ride -> EulerHS.Types.EulerClient API.Types.RiderPlatform.Management.Ride.ShareRideInfoRes,
    ...
    postRideSyncMultiple :: API.Types.RiderPlatform.Management.Ride.MultipleRideSyncReq -> EulerHS.Types.EulerClient Dashboard.Common.Ride.MultipleRideSyncResp,
    postRideCancelMultiple :: API.Types.RiderPlatform.Management.Ride.MultipleRideCancelReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
    getRideKaptureList :: Kernel.Prelude.Maybe (Kernel.Types.Id.ShortId Dashboard.Common.Ride) -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> EulerHS.Types.EulerClient API.Types.RiderPlatform.Management.Ride.TicketRideListRes
  }

mkRideAPIs :: (Client EulerHS.Types.EulerClient API -> RideAPIs)
mkRideAPIs rideClient = (RideAPIs {..})
  where
    getRideList :<|> getRideInfo :<|> getShareRideInfo :<|> getShareRideInfoByShortId :<|> getRideTripRoute :<|> getRidePickupRoute :<|> postRideSyncMultiple :<|> postRideCancelMultiple :<|> getRideKaptureList = rideClient

data RideEndpointDSL
  = GetRideListEndpoint
  | GetRideInfoEndpoint
  | GetShareRideInfoEndpoint
  | GetShareRideInfoByShortIdEndpoint
