...
data BookingCancelledReq
    = BookingCancelledReq {bookingId :: Kernel.Types.Id.Id Dashboard.Common.Booking,
...
data BookingStatus
    = UPCOMING | UPCOMING_6HRS | ONGOING | ONGOING_6HRS | RCOMPLETED | RCANCELLED
    deriving stock (Eq, Show, Generic, Read)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data CancellationChargesWaiveOffRes
    = CancellationChargesWaiveOffRes {rideId :: Kernel.Types.Id.Id Dashboard.Common.Ride,
...
data CancellationSource
    = ByUser | ByDriver | ByMerchant | ByAllocator | ByApplication
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CancellationStage
    = OnSearch | OnInit | OnConfirm | OnAssign
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data EstimateBreakup
    = EstimateBreakup {title :: Kernel.Prelude.Text, price :: EstimateBreakupPrice}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype EstimateBreakupPrice
  = EstimateBreakupPrice {value :: Kernel.Types.Price.PriceAPIEntity}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FareBreakup
    = FareBreakup {amount :: Kernel.Types.Common.Price, description :: Kernel.Prelude.Text, entityId :: Kernel.Prelude.Text, entityType :: FareBreakupEntityType}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FareBreakupEntityType
    = BOOKING_UPDATE_REQUEST | BOOKING | RIDE | INITIAL_BOOKING
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data Location
    = Location {id :: Kernel.Types.Id.Id Location,
...
data LocationAddress
    = LocationAddress {street :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
newtype MultipleRideCancelReq
  = MultipleRideCancelReq {multipleRideCancelInfo :: [BookingCancelledReq]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets MultipleRideCancelReq
    where hideSecrets = Kernel.Prelude.identity
newtype MultipleRideItem
  = MultipleRideItem {rideId :: Kernel.Types.Id.Id Dashboard.Common.Ride}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype MultipleRideSyncReq
  = MultipleRideSyncReq {rides :: [MultipleRideItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data RideInfoRes
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RideListItem
    = RideListItem {rideShortId :: Kernel.Types.Id.ShortId Dashboard.Common.Ride,
                    rideCreatedAt :: Kernel.Prelude.UTCTime,
...
data RideListRes
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RideStatus
    = UPCOMING_RIDE | NEW | INPROGRESS | COMPLETED | CANCELLED
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ShareRideInfoRes
    = ShareRideInfoRes {id :: Kernel.Types.Id.Id Dashboard.Common.Ride,
                        bookingId :: Kernel.Types.Id.Id Dashboard.Common.Booking,
                        status :: RideStatus,
                        driverName :: Kernel.Prelude.Text,
...
type GetRideList = ("list" :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> QueryParam "bookingStatus" BookingStatus :> QueryParam "rideShortId"
                                                                                                                                                                        ((Kernel.Types.Id.ShortId Dashboard.Common.Ride)) :> QueryParam "customerPhoneNo" Kernel.Prelude.Text :> QueryParam "driverPhoneNo"
                                                                                                                                                                                                                                                                                            Kernel.Prelude.Text :> QueryParam "from"
                                                                                                                                                                                                                                                                                                                              Kernel.Prelude.UTCTime :> QueryParam "to"
...
type GetRideTripRoute = ("trip" :> "route" :> Capture "rideId" (Kernel.Types.Id.Id Dashboard.Common.Ride) :> MandatoryQueryParam "lat" Kernel.Prelude.Double :> MandatoryQueryParam "lon"
                                                                                                                                                                                    Kernel.Prelude.Double :> Get ('[JSON]) Kernel.External.Maps.GetRoutesResp)
type GetRidePickupRoute = ("pickup" :> "route" :> Capture "rideId" (Kernel.Types.Id.Id Dashboard.Common.Ride) :> MandatoryQueryParam "lat" Kernel.Prelude.Double :> MandatoryQueryParam "lon"
                                                                                                                                                                                        Kernel.Prelude.Double :> Get ('[JSON]) Kernel.External.Maps.GetRoutesResp)
...
mkRideAPIs rideClient = (RideAPIs {..})
               where getRideList :<|> getRideInfo :<|> cancellationChargesWaiveOff :<|> getShareRideInfo :<|> getShareRideInfoByShortId :<|> getRideTripRoute :<|> getRidePickupRoute :<|> postRideSyncMultiple :<|> postRideCancelMultiple :<|> getRideKaptureList = rideClient
