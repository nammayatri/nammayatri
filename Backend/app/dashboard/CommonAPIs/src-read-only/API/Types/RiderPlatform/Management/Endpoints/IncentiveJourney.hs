...
module API.Types.RiderPlatform.Management.Endpoints.IncentiveJourney where
...
type GetIncentiveJourneyStatsHistory =
  ( "stats" :> "history" :> QueryParam "journeyId" (Kernel.Types.Id.Id Dashboard.Common.IncentiveJourney)
      ...
      :> MandatoryQueryParam "fromDate" Data.Time.Day
      :> MandatoryQueryParam
           "personId"
...
type GetIncentiveJourneyPersonAssignments =
  ( "person" :> "assignments" :> MandatoryQueryParam "personId" (Kernel.Types.Id.Id Dashboard.Common.Person)
      :> Get
           '[JSON]
           IncentiveJourneyPersonAssignmentListRes
  )
...
data IncentiveJourneyAPIs = IncentiveJourneyAPIs
  { getIncentiveJourneyList :: Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> EulerHS.Types.EulerClient IncentiveJourneyListRes,
    ...
    getIncentiveJourneyStatsHistory :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Dashboard.Common.IncentiveJourney) -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Data.Time.Day -> Kernel.Types.Id.Id Dashboard.Common.Person -> Data.Time.Day -> EulerHS.Types.EulerClient IncentiveJourneyStatsHistoryRes,
