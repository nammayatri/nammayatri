...
data VerificationStatusListResponse = VerificationStatusListResponse {verificationStatus :: [VerificationStatusObject]}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

data VerificationStatusObject = VerificationStatusObject
  { status :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    response :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
type GetDriverRegistrationVerificationStatus = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "verificationStatus" :> Get ('[JSON]) VerificationStatusListResponse)
...
data DriverRegistrationAPIs = DriverRegistrationAPIs
  { getDriverRegistrationDocumentsList :: (Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> EulerHS.Types.EulerClient DocumentsListResponse),
    ...
    getDriverRegistrationVerificationStatus :: (Kernel.Types.Id.Id Dashboard.Common.Driver -> EulerHS.Types.EulerClient VerificationStatusListResponse)
  }
