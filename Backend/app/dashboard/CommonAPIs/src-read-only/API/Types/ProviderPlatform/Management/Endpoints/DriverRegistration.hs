...
data AadhaarCardReq
    = AadhaarCardReq {aadhaarBackImageId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Dashboard.Common.Image),
...
instance Kernel.Types.HideSecrets.HideSecrets AadhaarCardReq
...
data ApproveDetails
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BusinessLicenseApproveDetails
    = BusinessLicenseApproveDetails {documentImageId :: Kernel.Types.Id.Id Dashboard.Common.Image, businessLicenseNumber :: Kernel.Prelude.Text, licenseExpiry :: Kernel.Prelude.UTCTime}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CommonDocumentApproveDetails
    = CommonDocumentApproveDetails {documentId :: Kernel.Types.Id.Id Dashboard.Common.CommonDriverOnboardingDocuments, updatedDocumentData :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CommonDocumentCreateReq
    = CommonDocumentCreateReq {documentType :: DocumentType, documentData :: Kernel.Prelude.Text, imageId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Dashboard.Common.Image)}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets CommonDocumentCreateReq
    where hideSecrets = Kernel.Prelude.identity
data CommonDocumentItem
    = CommonDocumentItem {documentId :: Kernel.Types.Id.Id Dashboard.Common.CommonDriverOnboardingDocuments,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CommonDocumentListItem
    = CommonDocumentListItem {documentId :: Kernel.Types.Id.Id Dashboard.Common.CommonDriverOnboardingDocuments,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CommonDocumentRejectDetails
    = CommonDocumentRejectDetails {reason :: Kernel.Prelude.Text, documentId :: Kernel.Types.Id.Id Dashboard.Common.CommonDriverOnboardingDocuments}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CommonDocumentsListRes
    = CommonDocumentsListRes {summary :: Dashboard.Common.Summary, documents :: [CommonDocumentListItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DLApproveDetails
    = DLApproveDetails {documentImageId :: Kernel.Types.Id.Id Dashboard.Common.Image,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DLDetails
    = DLDetails {driverName :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype DocumentInfo
  = DocumentInfo {documentNumber :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DocumentType
    = DriverLicense
...
instance Kernel.Types.HideSecrets.HideSecrets DocumentType
    where hideSecrets = Kernel.Prelude.identity
data DocumentsListResponse
    = DocumentsListResponse {driverLicense :: [[Kernel.Prelude.Text]],
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverDocument
    = DriverDocument {documentType :: DocumentType,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FitnessApproveDetails
    = FitnessApproveDetails {applicationNumber :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data GenerateAadhaarOtpReq
    = GenerateAadhaarOtpReq {aadhaarNumber :: Kernel.Prelude.Text, consent :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets GenerateAadhaarOtpReq
    where hideSecrets = Kernel.Prelude.identity
data GenerateAadhaarOtpRes
    = GenerateAadhaarOtpRes {message :: Kernel.Prelude.Text, transactionId :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets GenerateAadhaarOtpRes
    where hideSecrets = Kernel.Prelude.identity
data GetDocumentResponse
    = GetDocumentResponse {imageBase64 :: Kernel.Prelude.Text, status :: Kernel.Prelude.Maybe Dashboard.Common.VerificationStatus, createdAt :: Kernel.Prelude.UTCTime}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ImageDocumentsRejectDetails
    = ImageDocumentsRejectDetails {reason :: Kernel.Prelude.Text, documentImageId :: Kernel.Types.Id.Id Dashboard.Common.Image}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data NOCApproveDetails
    = NOCApproveDetails {documentImageId :: Kernel.Types.Id.Id Dashboard.Common.Image, nocNumber :: Kernel.Prelude.Text, nocExpiry :: Kernel.Prelude.UTCTime, rcNumber :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PanApproveDetails
    = PanApproveDetails {documentImageId :: Kernel.Types.Id.Id Dashboard.Common.Image,
...
data PanType
    ...
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PayoutRegistrationRes
    = PayoutRegistrationRes {orderId :: Kernel.Prelude.Text, orderResp :: Kernel.External.Payment.Interface.Types.CreateOrderResp}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RCApproveDetails
    = RCApproveDetails {documentImageId :: Kernel.Types.Id.Id Dashboard.Common.Image,
...
data RCDetails
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RegisterDLReq
    = RegisterDLReq {driverLicenseNumber :: Kernel.Prelude.Text,
                     operatingCity :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets RegisterDLReq
    where hideSecrets = Kernel.Prelude.identity
data RegisterRCReq
    = RegisterRCReq {vehicleRegistrationCertNumber :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets RegisterRCReq
    where hideSecrets = Kernel.Prelude.identity
data RejectDetails
    = SSNReject SSNRejectDetails | ImageDocuments ImageDocumentsRejectDetails | CommonDocumentReject CommonDocumentRejectDetails
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SSNRejectDetails
    = SSNRejectDetails {reason :: Kernel.Prelude.Text, ssn :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ServiceType
    = HyperVerge | Idfy
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data TriggerReminderReq
    = TriggerReminderReq {documentType :: DocumentType, dueDate :: Kernel.Prelude.Maybe Kernel.Prelude.UTCTime, intervals :: Kernel.Prelude.Maybe [Kernel.Prelude.Int]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets TriggerReminderReq
    where hideSecrets = Kernel.Prelude.identity
data UnderReviewDriver
    = UnderReviewDriver {driverId :: Kernel.Types.Id.Id Dashboard.Common.Driver,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data UnderReviewDriversListResponse
    = UnderReviewDriversListResponse {drivers :: [UnderReviewDriver], summary :: Dashboard.Common.Summary}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype UnlinkDocumentResp
  = UnlinkDocumentResp {mandatoryDocumentRemoved :: Kernel.Prelude.Bool}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data UpdateDocumentRequest
    = Approve ApproveDetails | Reject RejectDetails
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdateDocumentRequest
    where hideSecrets = Kernel.Prelude.identity
data UploadDocumentReq
    = UploadDocumentReq {imageBase64 :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype UploadDocumentResp
  = UploadDocumentResp {imageId :: Kernel.Types.Id.Id Dashboard.Common.Image}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UploadDocumentResp
    where hideSecrets = Kernel.Prelude.identity
data UploadDocumentTReq
    = UploadDocumentTReq {imageType :: DocumentType, rcNumber :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VInspectionApproveDetails
    = VInspectionApproveDetails {documentImageId :: Kernel.Types.Id.Id Dashboard.Common.Image, dateOfExpiry :: Kernel.Prelude.Maybe Kernel.Prelude.UTCTime}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VInsuranceApproveDetails
    = VInsuranceApproveDetails {documentImageId :: Kernel.Types.Id.Id Dashboard.Common.Image,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VPUCApproveDetails
    = VPUCApproveDetails {documentImageId :: Kernel.Types.Id.Id Dashboard.Common.Image,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VPermitApproveDetails
    = VPermitApproveDetails {documentImageId :: Kernel.Types.Id.Id Dashboard.Common.Image,
                             issueDate :: Kernel.Prelude.Maybe Kernel.Prelude.UTCTime,
...
data ValidationStatus
    = APPROVED | DECLINED | AUTO_APPROVED | AUTO_DECLINED | NEEDS_REVIEW
    deriving stock (Eq, Show, Generic, Read)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VerificationStatusItem
    = VerificationStatusItem {documentType :: DocumentType,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VerificationStatusListResponse
    = VerificationStatusListResponse {verificationStatuses :: [VerificationStatusItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VerifyAadhaarOtpReq
    = VerifyAadhaarOtpReq {otp :: Kernel.Prelude.Int, shareCode :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets VerifyAadhaarOtpReq
    where hideSecrets = Kernel.Prelude.identity
data VerifyAadhaarOtpRes
    = VerifyAadhaarOtpRes {message :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets VerifyAadhaarOtpRes
    where hideSecrets = Kernel.Prelude.identity
data VerifyBankAccountReq
    = VerifyBankAccountReq {bankAccountNo :: Kernel.Prelude.Text, bankIfscCode :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
...
type GetDriverRegistrationDocumentsList = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "documents" :> "list" :> QueryParam "rcId" Kernel.Prelude.Text :> Get ('[JSON])
...
type PostDriverRegistrationDocumentUpload = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "document" :> "upload" :> ReqBody ('[JSON]) UploadDocumentReq :> Post ('[JSON])
                                                                                                                                                                                      UploadDocumentResp)
type PostDriverRegistrationRegisterDl = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "register" :> "dl" :> ReqBody ('[JSON]) RegisterDLReq :> Post ('[JSON])
                                                                                                                                                                          Kernel.Types.APISuccess.APISuccess)
type PostDriverRegistrationVerifyBankAccount = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "verify" :> "bankAccount" :> ReqBody ('[JSON]) VerifyBankAccountReq :> Post ('[JSON])
                                                                                                                                                                                               Kernel.External.Verification.Interface.Types.VerifyAsyncResp)
type GetDriverRegistrationInfoBankAccount = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "info" :> Capture "requestId" Kernel.Prelude.Text :> "bankAccount" :> Get ('[JSON])
...
type GetDriverRegistrationPayoutOrderStatus = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "payout" :> "order" :> "status" :> MandatoryQueryParam "orderId"
                                                                                                                                                                         Kernel.Prelude.Text :> Get ('[JSON]) Kernel.External.Payout.Interface.Types.PayoutOrderStatusResp)
type PostDriverRegistrationRegisterRc = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "register" :> "rc" :> ReqBody ('[JSON]) RegisterRCReq :> Post ('[JSON])
                                                                                                                                                                          Kernel.Types.APISuccess.APISuccess)
type PostDriverRegistrationRegisterAadhaar = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "register" :> "aadhaar" :> ReqBody ('[JSON]) AadhaarCardReq :> Post ('[JSON])
                                                                                                                                                                                     Kernel.Types.APISuccess.APISuccess)
type PostDriverRegistrationRegisterGenerateAadhaarOtp = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "register" :> "generateAadhaarOtp" :> ReqBody ('[JSON])
                                                                                                                                                                          GenerateAadhaarOtpReq :> Post ('[JSON]) GenerateAadhaarOtpRes)
type PostDriverRegistrationRegisterVerifyAadhaarOtp = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "register" :> "verifyAadhaarOtp" :> ReqBody ('[JSON])
                                                                                                                                                                      VerifyAadhaarOtpReq :> Post ('[JSON]) VerifyAadhaarOtpRes)
...
type GetDriverRegistrationVerificationStatus = ("verificationStatus" :> MandatoryQueryParam "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> MandatoryQueryParam "fromDate"
                                                                                                                                                                           Kernel.Prelude.UTCTime :> MandatoryQueryParam "toDate" Kernel.Prelude.UTCTime :> MandatoryQueryParam "limit"
                                                                                                                                                                                                                                                                                Kernel.Prelude.Int :> MandatoryQueryParam "offset"
                                                                                                                                                                                                                                                                                                                          Kernel.Prelude.Int :> MandatoryQueryParam "documentType"
                                                                                                                                                                                                                                                                                                                                                                    DocumentType :> MandatoryQueryParam "serviceType"
                                                                                                                                                                                                                                                                                                                                                                                                        ServiceType :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                           VerificationStatusListResponse)
type GetDriverRegistrationDocumentsCommonList = ("documents" :> "common" :> "list" :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> QueryParam "from"
                                                                                                                                                                                    Kernel.Prelude.UTCTime :> QueryParam "to" Kernel.Prelude.UTCTime :> QueryParam "documentType"
                                                                                                                                                                                                                                                                   [DocumentType] :> QueryParam "verificationStatus"
                                                                                                                                                                                                                                                                                                [Dashboard.Common.VerificationStatus] :> QueryParam "driverId"
                                                                                                                                                                                                                                                                                                                                                    ([Kernel.Types.Id.Id Dashboard.Common.Driver]) :> QueryParam "sortByField"
                                                                                                                                                                                                                                                                                                                                                                                                                 Kernel.Prelude.Text :> QueryParam "sortOrder"
...
type PostDriverRegistrationDocumentsCommon = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "documents" :> "common" :> ReqBody ('[JSON]) CommonDocumentCreateReq :> Post ('[JSON])
                                                                                                                                                                                              Kernel.Types.APISuccess.APISuccess)
type PostDriverRegistrationUnlinkDocument = (Capture "personId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "unlink" :> "document" :> Capture "documentType" DocumentType :> Post ('[JSON])
                                                                                                                                                                                      Kernel.Types.APISuccess.APISuccess)
type PostDriverRegistrationUnlinkDocumentHelper = (Capture "personId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "unlink" :> "document" :> Capture "documentType"
                                                                                                                                                        DocumentType :> QueryParam "requestorId" Kernel.Prelude.Text :> Post ('[JSON]) UnlinkDocumentResp)
type PostDriverRegistrationTriggerReminder = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "trigger" :> "reminder" :> ReqBody ('[JSON]) TriggerReminderReq :> Post ('[JSON])
                                                                                                                                                                                         Kernel.Types.APISuccess.APISuccess)
type PostDriverRegistrationTriggerReminderHelper = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "trigger" :> "reminder" :> QueryParam "requestorId"
                                                                                                                                                             Kernel.Prelude.Text :> ReqBody ('[JSON]) TriggerReminderReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
data DriverRegistrationAPIs
    = DriverRegistrationAPIs {getDriverRegistrationDocumentsList :: (Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> EulerHS.Types.EulerClient DocumentsListResponse),
...
mkDriverRegistrationAPIs driverRegistrationClient = (DriverRegistrationAPIs {..})
                             where getDriverRegistrationDocumentsList :<|> getDriverRegistrationGetDocument :<|> postDriverRegistrationDocumentUpload :<|> postDriverRegistrationRegisterDl :<|> postDriverRegistrationVerifyBankAccount :<|> getDriverRegistrationInfoBankAccount :<|> getDriverRegistrationPayoutRegistration :<|> postDriverRegistrationDeleteBankAccount :<|> getDriverRegistrationPayoutOrderStatus :<|> postDriverRegistrationRegisterRc :<|> postDriverRegistrationRegisterAadhaar :<|> postDriverRegistrationRegisterGenerateAadhaarOtp :<|> postDriverRegistrationRegisterVerifyAadhaarOtp :<|> getDriverRegistrationUnderReviewDrivers :<|> getDriverRegistrationDocumentsInfo :<|> getDriverRegistrationVerificationStatus :<|> getDriverRegistrationDocumentsCommonList :<|> postDriverRegistrationDocumentsUpdate :<|> postDriverRegistrationDocumentsCommon :<|> postDriverRegistrationUnlinkDocument :<|> postDriverRegistrationTriggerReminder = driverRegistrationClient
data DriverRegistrationUserActionType
    ...
    | POST_DRIVER_REGISTRATION_TRIGGER_REMINDER
