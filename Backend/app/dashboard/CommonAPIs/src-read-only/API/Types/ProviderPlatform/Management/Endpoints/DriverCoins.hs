...
data BulkUploadCoinRes
    = BulkUploadCoinRes {success :: Kernel.Prelude.Int, failed :: Kernel.Prelude.Int, failedItems :: [BulkUploadFailedItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BulkUploadCoinsReq
    = BulkUploadCoinsReq {driverIdListWithCoins :: [DriverIdListWithCoins], bulkUploadTitle :: Translations, expirationTime :: Kernel.Prelude.Maybe Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BulkUploadCoinsReqV2
    = BulkUploadCoinsReqV2 {driverIdListWithCoins :: [DriverIdListWithAmount],
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BulkUploadFailedItem
    = BulkUploadFailedItem {driverId :: Kernel.Prelude.Text, errorMessage :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CoinBurnHistoryItem
    = CoinBurnHistoryItem {numCoins :: Kernel.Prelude.Int,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CoinEarnHistoryItem
    = CoinEarnHistoryItem {coins :: Kernel.Prelude.Int,
                           eventFunction :: Dashboard.Common.DriverCoins.DriverCoinsFunctionType,
                           createdAt :: Kernel.Prelude.UTCTime,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CoinHistoryRes
    = CoinHistoryRes {coinBalance :: Kernel.Prelude.Int,
...
data CoinStatus
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverIdListWithAmount
    = DriverIdListWithAmount {driverId :: Kernel.Prelude.Text, amount :: Kernel.Types.Common.HighPrecMoney, amountWithCurrency :: Kernel.Prelude.Maybe Kernel.Types.Common.PriceAPIEntity}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverIdListWithCoins
    = DriverIdListWithCoins {driverId :: Kernel.Prelude.Text, coins :: Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data Translations
    = Translations {en :: Kernel.Prelude.Text,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data UpdateBlacklistedCoinEventsReq
    = UpdateBlacklistedCoinEventsReq {blacklistedEvents :: [Dashboard.Common.DriverCoins.DriverCoinsFunctionType]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
...
type GetDriverCoinsCoinHistory = ("coinHistory" :> Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> QueryParam "limit" Kernel.Prelude.Integer :> QueryParam "offset"
                                                                                                                                                                              Kernel.Prelude.Integer :> Get ('[JSON]) CoinHistoryRes)
type PostDriverCoinsBlacklistedEventsUpdate = ("blacklistedEvents" :> Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "update" :> ReqBody ('[JSON])
                                                                                                                                                             UpdateBlacklistedCoinEventsReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
data DriverCoinsAPIs
    = DriverCoinsAPIs {postDriverCoinsBulkUploadCoins :: (BulkUploadCoinsReq -> EulerHS.Types.EulerClient BulkUploadCoinRes),
...
mkDriverCoinsAPIs driverCoinsClient = (DriverCoinsAPIs {..})
                      where postDriverCoinsBulkUploadCoins :<|> postDriverCoinsBulkUploadCoinsV2 :<|> getDriverCoinsCoinHistory :<|> postDriverCoinsBlacklistedEventsUpdate = driverCoinsClient
data DriverCoinsUserActionType
    = POST_DRIVER_COINS_BULK_UPLOAD_COINS | POST_DRIVER_COINS_BULK_UPLOAD_COINS_V2 | GET_DRIVER_COINS_COIN_HISTORY | POST_DRIVER_COINS_BLACKLISTED_EVENTS_UPDATE
