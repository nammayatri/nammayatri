...
type PostMerchantConfigDriverPoolUpdate =
  ( "config" :> "driverPool" :> "update" :> QueryParam "tripDistanceValue" Kernel.Types.Common.HighPrecDistance
      ...
      :> QueryParam "vehicleVariant" Dashboard.Common.Variant
      :> QueryParam
           "tripCategory"
           Kernel.Prelude.Text
      :> MandatoryQueryParam
...
type PostMerchantConfigOnboardingDocumentUpdate =
  ( "config" :> "onboardingDocument" :> "update"
      ...
      :> MandatoryQueryParam "category" Dashboard.Common.Category
      :> ReqBody
           '[JSON]
...
data MerchantAPIs = MerchantAPIs
  { postMerchantUpdate :: API.Types.ProviderPlatform.Management.Merchant.MerchantUpdateReq -> EulerHS.Types.EulerClient API.Types.ProviderPlatform.Management.Merchant.MerchantUpdateRes,
    ...
    postMerchantConfigDriverPoolUpdate :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecDistance -> Kernel.Prelude.Maybe Kernel.Types.Common.DistanceUnit -> Kernel.Prelude.Maybe Dashboard.Common.Variant -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Types.Common.Meters -> Lib.Types.SpecialLocation.Area -> API.Types.ProviderPlatform.Management.Merchant.DriverPoolConfigUpdateReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
    postMerchantConfigDriverPoolCreate :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecDistance -> Kernel.Prelude.Maybe Kernel.Types.Common.DistanceUnit -> Kernel.Prelude.Maybe Dashboard.Common.Variant -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Types.Common.Meters -> Lib.Types.SpecialLocation.Area -> API.Types.ProviderPlatform.Management.Merchant.DriverPoolConfigCreateReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
    ...
    postMerchantConfigOnboardingDocumentUpdate :: API.Types.ProviderPlatform.Management.Merchant.DocumentType -> Dashboard.Common.Category -> API.Types.ProviderPlatform.Management.Merchant.DocumentVerificationConfigUpdateReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
    postMerchantConfigOnboardingDocumentCreate :: API.Types.ProviderPlatform.Management.Merchant.DocumentType -> Dashboard.Common.Category -> API.Types.ProviderPlatform.Management.Merchant.DocumentVerificationConfigCreateReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
