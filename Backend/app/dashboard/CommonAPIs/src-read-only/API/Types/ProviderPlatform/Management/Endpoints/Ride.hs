...
data ActualRoute
    = ActualRoute {lat :: Kernel.Prelude.Double,
...
data BookingStatus
    = UPCOMING | UPCOMING_6HRS | ONGOING | ONGOING_6HRS | COMPLETED | CANCELLED
    deriving stock (Eq, Show, Generic, Read)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data CancellationSource
    = ByUser | ByDriver | ByMerchant | ByAllocator | ByApplication | ByFleetOwner
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DeprecatedTripCategory
    = OneWay | Rental | RideShare | InterCity | CrossCity | Ambulance
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverEdaKafka
    = DriverEdaKafka {driver_id :: Kernel.Prelude.String,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FParamsAmbulanceDetails
    = FParamsAmbulanceDetails {platformFee :: Kernel.Prelude.Maybe Kernel.Types.Common.PriceAPIEntity,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FParamsInterCityDetails
    = FParamsInterCityDetails {timeFare :: Kernel.Types.Common.PriceAPIEntity,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FParamsProgressiveDetails
    = FParamsProgressiveDetails {deadKmFare :: Kernel.Types.Common.Money,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FParamsRentalDetails
    = FParamsRentalDetails {deadKmFare :: Kernel.Types.Common.PriceAPIEntity,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FParamsSlabDetails
    = FParamsSlabDetails {platformFee :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FareBreakUp
    = FareBreakUp {driverSelectedFare :: Kernel.Prelude.Maybe Kernel.Types.Common.Money,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FareBreakUpRes
    = FareBreakUpRes {estimatedFareBreakUp :: Kernel.Prelude.Maybe FareBreakUp, actualFareBreakUp :: Kernel.Prelude.Maybe FareBreakUp}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets FareBreakUpRes
...
data LocationAPIEntity
    = LocationAPIEntity {lat :: Kernel.Prelude.Double,
                         lon :: Kernel.Prelude.Double,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MultipleRideCancelItem
    = MultipleRideCancelItem {rideId :: Kernel.Types.Id.Id Dashboard.Common.Ride, reasonCode :: Dashboard.Common.Booking.CancellationReasonCode, additionalInfo :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype MultipleRideCancelReq
  = MultipleRideCancelReq {rides :: [MultipleRideCancelItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets MultipleRideCancelReq
    where hideSecrets = Kernel.Prelude.identity
type MultipleRideCancelResp = Dashboard.Common.Ride.MultipleRideSyncResp
data MultipleRideData
    = MultipleRideData {rideId :: Kernel.Types.Id.Id Dashboard.Common.Ride, newStatus :: RideStatus, message :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MultipleRideEndItem
    = MultipleRideEndItem {rideId :: Kernel.Types.Id.Id Dashboard.Common.Ride, point :: Kernel.Prelude.Maybe Kernel.External.Maps.Types.LatLong}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype MultipleRideEndReq
  = MultipleRideEndReq {rides :: [MultipleRideEndItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets MultipleRideEndReq
    where hideSecrets = Kernel.Prelude.identity
type MultipleRideEndResp = Dashboard.Common.Ride.MultipleRideSyncResp
newtype MultipleRideSyncReq
  = MultipleRideSyncReq {rideIds :: [Kernel.Types.Id.Id Dashboard.Common.Ride]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets MultipleRideSyncReq
    where hideSecrets = Kernel.Prelude.identity
newtype MultipleRideSyncRes
  = MultipleRideSyncRes {list :: [Kernel.Prelude.Either Kernel.Prelude.Text MultipleRideData]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets MultipleRideSyncRes
    where hideSecrets = Kernel.Prelude.identity
data PaymentMode
    = CASH | ONLINE
    deriving stock (Eq, Show, Generic, Read)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data RideInfo
    = RideInfo {rideShortId :: Kernel.Types.Id.ShortId Dashboard.Common.Ride,
...
data RideInfoRes
    = RideInfoRes {rideId :: Kernel.Types.Id.Id Dashboard.Common.Ride,
                   customerName :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                   customerPhoneNo :: Kernel.Prelude.Text,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RideListItem
    = RideListItem {rideId :: Kernel.Types.Id.Id Dashboard.Common.Ride,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RideListItemV2
    = RideListItemV2 {rideId :: Kernel.Types.Id.Id Dashboard.Common.Ride,
                      rideShortId :: Kernel.Types.Id.ShortId Dashboard.Common.Ride,
                      driverName :: Kernel.Prelude.Text,
                      driverPhoneNo :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                      rideStatus :: RideStatus,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RideListRes
    = RideListRes {totalItems :: Kernel.Prelude.Int, summary :: Dashboard.Common.Summary, rides :: [RideListItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RideListResV2
    = RideListResV2 {totalItems :: Kernel.Prelude.Int, summary :: Dashboard.Common.Summary, rides :: [RideListItemV2]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype RideRouteRes
  = RideRouteRes {actualRoute :: [ActualRoute]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets RideRouteRes
    where hideSecrets = Kernel.Prelude.identity
data RideStatus
    = RIDE_UPCOMING | RIDE_NEW | RIDE_INPROGRESS | RIDE_COMPLETED | RIDE_CANCELLED
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data RideSyncRes
    = RideSyncRes {newStatus :: RideStatus, message :: Kernel.Prelude.Text}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets RideSyncRes
    where hideSecrets = Kernel.Prelude.identity
data Status
    = ON_RIDE | ON_PICKUP | IDLE
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data StopInformation
    = StopInformation {stopId :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype TicketRideListRes
  = TicketRideListRes {rides :: [RideInfo]}
    deriving stock (Show, Generic)
    deriving anyclass ToSchema
data WaiverRideCancellationPenaltyReq
    = WaiverRideCancellationPenaltyReq {reason :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data WalletTransactionItem
    = WalletTransactionItem {ledgerEntryId :: Kernel.Prelude.Text, referenceType :: Kernel.Prelude.Text, amount :: Kernel.Types.Common.HighPrecMoney, createdAt :: Kernel.Prelude.UTCTime}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
...
type GetRideAgentList = ("agent" :> "list" :> QueryParam "bookingStatus" BookingStatus :> QueryParam "currency" Kernel.Types.Common.Currency :> QueryParam "customerPhoneNo"
                                                                                                                                                           Kernel.Prelude.Text :> QueryParam "driverPhoneNo" Kernel.Prelude.Text :> QueryParam "from" Kernel.Prelude.UTCTime :> QueryParam "limit"
                                                                                                                                                                                                                                                                                           Kernel.Prelude.Int :> QueryParam "offset"
                                                                                                                                                                                                                                                                                                                            Kernel.Prelude.Int :> QueryParam "rideShortId"
                                                                                                                                                                                                                                                                                                                                                             (Kernel.Types.Id.ShortId Dashboard.Common.Ride) :> QueryParam "to"
                                                                                                                                                                                                                                                                                                                                                                                                                           Kernel.Prelude.UTCTime :> QueryParam "vehicleNo"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                Kernel.Prelude.Text :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           RideListRes)
type GetRideList = ("list" :> QueryParam "bookingStatus" BookingStatus :> QueryParam "currency" Kernel.Types.Common.Currency :> QueryParam "customerPhoneNo"
                                                                                                                                           Kernel.Prelude.Text :> QueryParam "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> QueryParam "driverPhoneNo"
                                                                                                                                                                                                                                                   Kernel.Prelude.Text :> QueryParam "fleetOwnerId"
                                                                                                                                                                                                                                                                                     Kernel.Prelude.Text :> QueryParam "from"
                                                                                                                                                                                                                                                                                                                       Kernel.Prelude.UTCTime :> QueryParam "fromAmount"
                                                                                                                                                                                                                                                                                                                                                            Kernel.Types.Common.HighPrecMoney :> QueryParam "limit"
                                                                                                                                                                                                                                                                                                                                                                                                            Kernel.Prelude.Int :> QueryParam "offset"
                                                                                                                                                                                                                                                                                                                                                                                                                                             Kernel.Prelude.Int :> QueryParam "paymentMode"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                              PaymentMode :> QueryParam "rideId"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        (Kernel.Types.Id.Id Dashboard.Common.Ride) :> QueryParam "rideShortId"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (Kernel.Types.Id.ShortId Dashboard.Common.Ride) :> QueryParam "to"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               Kernel.Prelude.UTCTime :> QueryParam "toAmount"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    Kernel.Types.Common.HighPrecMoney :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             RideListRes)
type GetRideListHelper = (Capture "requestorId" Kernel.Prelude.Text :> "list" :> QueryParam "bookingStatus" BookingStatus :> QueryParam "currency"
                                                                                                                                        Kernel.Types.Common.Currency :> QueryParam "customerPhoneNo" Kernel.Prelude.Text :> QueryParam "driverId"
                                                                                                                                                                                                                                       (Kernel.Types.Id.Id Dashboard.Common.Driver) :> QueryParam "driverPhoneNo"
                                                                                                                                                                                                                                                                                                  Kernel.Prelude.Text :> QueryParam "fleetOwnerId"
                                                                                                                                                                                                                                                                                                                                    Kernel.Prelude.Text :> QueryParam "from"
                                                                                                                                                                                                                                                                                                                                                                      Kernel.Prelude.UTCTime :> QueryParam "fromAmount"
                                                                                                                                                                                                                                                                                                                                                                                                           Kernel.Types.Common.HighPrecMoney :> QueryParam "limit"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       (Kernel.Types.Id.Id Dashboard.Common.Ride) :> QueryParam "rideShortId"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (Kernel.Types.Id.ShortId Dashboard.Common.Ride) :> QueryParam "to"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              Kernel.Prelude.UTCTime :> QueryParam "toAmount"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   Kernel.Types.Common.HighPrecMoney :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            RideListRes)
type GetRideListV2 = ("listV2" :> QueryParam "currency" Kernel.Types.Common.Currency :> QueryParam "customerPhoneNo" Kernel.Prelude.Text :> QueryParam "driverId"
                                                                                                                                                       (Kernel.Types.Id.Id Dashboard.Common.Driver) :> QueryParam "driverPhoneNo" Kernel.Prelude.Text :> QueryParam "fleetOwnerId"
                                                                                                                                                                                                                                                                    Kernel.Prelude.Text :> QueryParam "from"
                                                                                                                                                                                                                                                                                                      Kernel.Prelude.UTCTime :> QueryParam "fromAmount"
                                                                                                                                                                                                                                                                                                                                           Kernel.Types.Common.HighPrecMoney :> QueryParam "limit"
                                                                                                                                                                                                                                                                                                                                                                                           Kernel.Prelude.Int :> QueryParam "offset"
                                                                                                                                                                                                                                                                                                                                                                                                                            Kernel.Prelude.Int :> QueryParam "paymentMode"
                                                                                                                                                                                                                                                                                                                                                                                                                                                             PaymentMode :> QueryParam "rideId"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       (Kernel.Types.Id.Id Dashboard.Common.Ride) :> QueryParam "rideShortId"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (Kernel.Types.Id.ShortId Dashboard.Common.Ride) :> QueryParam "rideStatus"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              RideStatus :> QueryParam "to"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       Kernel.Prelude.UTCTime :> QueryParam "toAmount"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            Kernel.Types.Common.HighPrecMoney :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     RideListResV2)
...
type GetRideKaptureList = ("kapture" :> "list" :> QueryParam "rideShortId" (Kernel.Types.Id.ShortId Dashboard.Common.Ride) :> QueryParam "countryCode" Kernel.Prelude.Text :> QueryParam "phoneNumber"
                                                                                                                                                                                         Kernel.Prelude.Text :> QueryParam "supportPhoneNumber" Kernel.Prelude.Text :> Get ('[JSON]) TicketRideListRes)
type GetRideFareBreakUp = (Capture "rideId" (Kernel.Types.Id.Id Dashboard.Common.Ride) :> "fareBreakUp" :> Get ('[JSON]) FareBreakUpRes)
type PostRideWaiverRideCancellationPenalty = (Capture "rideId" (Kernel.Types.Id.Id Dashboard.Common.Ride) :> "waiverRideCancellationPenalty" :> ReqBody ('[JSON])
                                                                                                                                                        WaiverRideCancellationPenaltyReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
data RideAPIs
    = RideAPIs {getRideAgentList :: (Kernel.Prelude.Maybe (BookingStatus) -> Kernel.Prelude.Maybe (Kernel.Types.Common.Currency) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.UTCTime) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Types.Id.ShortId Dashboard.Common.Ride) -> Kernel.Prelude.Maybe (Kernel.Prelude.UTCTime) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> EulerHS.Types.EulerClient RideListRes),
...
mkRideAPIs rideClient = (RideAPIs {..})
               where getRideAgentList :<|> getRideList :<|> getRideListV2 :<|> postRideEndMultiple :<|> postRideCancelMultiple :<|> getRideInfo :<|> postRideSync :<|> postRideSyncMultiple :<|> postRideRoute :<|> getRideKaptureList :<|> getRideFareBreakUp :<|> postRideWaiverRideCancellationPenalty = rideClient
