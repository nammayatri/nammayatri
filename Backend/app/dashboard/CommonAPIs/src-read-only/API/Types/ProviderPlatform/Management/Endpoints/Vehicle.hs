...
type PostVehicleParkingFeeExemption = (Capture "rcId" Kernel.Prelude.Text :> "parkingFeeExemption" :> ReqBody '[JSON] ParkingFeeExemptionReq :> Post '[JSON] Kernel.Types.APISuccess.APISuccess)
