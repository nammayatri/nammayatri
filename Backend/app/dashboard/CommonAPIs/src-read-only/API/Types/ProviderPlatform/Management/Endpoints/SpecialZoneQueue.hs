...
data SpecialZoneQueueStatsRes
    = SpecialZoneQueueStatsRes {gateId :: Kernel.Prelude.Text,
...
data TriggerSpecialZoneQueueNotifyReq
    = TriggerSpecialZoneQueueNotifyReq {gateId :: Kernel.Prelude.Text, vehicleType :: Kernel.Prelude.Text, driversToNotify :: Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets TriggerSpecialZoneQueueNotifyReq
    where hideSecrets = Kernel.Prelude.identity
data VehicleQueueStats
    = VehicleQueueStats {vehicleType :: Kernel.Prelude.Text, totalInQueue :: Kernel.Prelude.Int, inPickupZone :: Kernel.Prelude.Int, outsidePickupZone :: Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data SpecialZoneQueueAPIs
    = SpecialZoneQueueAPIs {postSpecialZoneQueueTriggerNotify :: (TriggerSpecialZoneQueueNotifyReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess),
...
mkSpecialZoneQueueAPIs specialZoneQueueClient = (SpecialZoneQueueAPIs {..})
                           where postSpecialZoneQueueTriggerNotify :<|> getSpecialZoneQueueQueueStats = specialZoneQueueClient
data SpecialZoneQueueUserActionType
    = POST_SPECIAL_ZONE_QUEUE_TRIGGER_NOTIFY | GET_SPECIAL_ZONE_QUEUE_QUEUE_STATS
