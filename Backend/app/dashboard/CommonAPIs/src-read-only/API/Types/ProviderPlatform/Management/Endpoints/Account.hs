...
data FleetOwnerStatus
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data PersonAPIEntity
    = PersonAPIEntity {id :: Kernel.Types.Id.Id Dashboard.Common.Person,
...
data RoleAPIEntity
    = RoleAPIEntity {id :: Kernel.Types.Id.Id Dashboard.Common.Role, name :: Kernel.Prelude.Text, dashboardAccessType :: DashboardAccessType, description :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data UnverifiedAccountsResp
    = UnverifiedAccountsResp {listItems :: [PersonAPIEntity], summary :: Dashboard.Common.Summary}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VerifyAccountReq
    = VerifyAccountReq {status :: FleetOwnerStatus, reason :: Kernel.Prelude.Maybe Kernel.Prelude.Text, fleetOwnerId :: Kernel.Types.Id.Id Dashboard.Common.Person}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets VerifyAccountReq
...
type GetAccountFetchUnverifiedAccounts = ("fetchUnverifiedAccounts" :> QueryParam "fromDate" Kernel.Prelude.UTCTime :> QueryParam "toDate" Kernel.Prelude.UTCTime :> QueryParam "mobileNumber"
                                                                                                                                                                                Kernel.Prelude.Text :> QueryParam "status" FleetOwnerStatus :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset"
...
type PutAccountUpdateRole = ("updateRole" :> Capture "personId" (Kernel.Types.Id.Id Dashboard.Common.Person) :> Capture "roleId" (Kernel.Types.Id.Id Dashboard.Common.Role) :> Put ('[JSON])
                                                                                                                                                                                   Kernel.Types.APISuccess.APISuccess)
type PutAccountUpdateRoleHelper = ("updateRole" :> Capture "personId" (Kernel.Types.Id.Id Dashboard.Common.Person) :> Capture "accessType" DashboardAccessType :> Put ('[JSON])
                                                                                                                                                                      Kernel.Types.APISuccess.APISuccess)
data AccountAPIs
    = AccountAPIs {getAccountFetchUnverifiedAccounts :: (Kernel.Prelude.Maybe (Kernel.Prelude.UTCTime) -> Kernel.Prelude.Maybe (Kernel.Prelude.UTCTime) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (FleetOwnerStatus) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> EulerHS.Types.EulerClient UnverifiedAccountsResp),
...
mkAccountAPIs accountClient = (AccountAPIs {..})
                  where getAccountFetchUnverifiedAccounts :<|> postAccountVerifyAccount :<|> putAccountUpdateRole = accountClient
data AccountUserActionType
    = GET_ACCOUNT_FETCH_UNVERIFIED_ACCOUNTS | POST_ACCOUNT_VERIFY_ACCOUNT | PUT_ACCOUNT_UPDATE_ROLE
