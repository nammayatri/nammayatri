...
data CreateDashboardOperatorFleetAssignmentReq
    = CreateDashboardOperatorFleetAssignmentReq {fleetOwnerMobileCountryCode :: Kernel.Prelude.Text, fleetOwnerMobileNo :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CreateDashboardOperatorReq
    = CreateDashboardOperatorReq {email :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data OperatorRegisterReq
    = OperatorRegisterReq {email :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                           firstName :: Kernel.Prelude.Text,
                           lastName :: Kernel.Prelude.Text,
                           mobileCountryCode :: Kernel.Prelude.Text,
                           mobileNumber :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype OperatorRegisterResp
  = OperatorRegisterResp {personId :: Kernel.Types.Id.Id Dashboard.Common.Operator}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data OperatorRegisterTReq
    = OperatorRegisterTReq {firstName :: Kernel.Prelude.Text, lastName :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data RegistrationAPIs
    = RegistrationAPIs {postOperatorRegister :: (OperatorRegisterReq -> EulerHS.Types.EulerClient OperatorRegisterResp),
...
mkRegistrationAPIs registrationClient = (RegistrationAPIs {..})
                       where postOperatorRegister :<|> postRegistrationDashboardRegister = registrationClient
data RegistrationUserActionType
    = POST_OPERATOR_REGISTER | POST_REGISTRATION_DASHBOARD_REGISTER
