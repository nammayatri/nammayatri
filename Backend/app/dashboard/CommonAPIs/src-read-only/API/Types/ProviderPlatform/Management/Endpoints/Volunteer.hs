...
data CreateVolunteerReq = CreateVolunteerReq {place :: Kernel.Prelude.Text, vendorId :: Kernel.Prelude.Maybe Kernel.Prelude.Text, isActive :: Kernel.Prelude.Maybe Kernel.Prelude.Bool}
...
data UpdateVolunteerReq = UpdateVolunteerReq {vendorId :: Kernel.Prelude.Maybe Kernel.Prelude.Text, isActive :: Kernel.Prelude.Maybe Kernel.Prelude.Bool}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
...
type GetVolunteerList =
  ( "list" :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> QueryParam "volunteerId" Kernel.Prelude.Text
      :> QueryParam
           "place"
           Kernel.Prelude.Text
      :> QueryParam "vendorId" Kernel.Prelude.Text
      :> Get ('[JSON]) VolunteerListRes
  )

type PostVolunteerUpdate = (Capture "volunteerId" Kernel.Prelude.Text :> "update" :> ReqBody ('[JSON]) UpdateVolunteerReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)

data VolunteerAPIs = VolunteerAPIs
  { postVolunteerCreate :: (CreateVolunteerReq -> EulerHS.Types.EulerClient CreateVolunteerRes),
    getVolunteerList :: (Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> EulerHS.Types.EulerClient VolunteerListRes),
    postVolunteerUpdate :: (Kernel.Prelude.Text -> UpdateVolunteerReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess)
  }
