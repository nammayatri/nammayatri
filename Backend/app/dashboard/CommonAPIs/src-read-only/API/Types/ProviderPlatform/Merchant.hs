...
module API.Types.ProviderPlatform.Merchant where
...
data MerchantUpdateRes = MerchantUpdateRes
  { contactNumber :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    status :: API.Types.ProviderPlatform.Merchant.Status
  }
  deriving (Generic, ToJSON, FromJSON, ToSchema)
...
type PostMerchantUpdate = ("update" :> ReqBody '[JSON] API.Types.ProviderPlatform.Merchant.MerchantUpdateReq :> Post '[JSON] API.Types.ProviderPlatform.Merchant.MerchantUpdateRes)
...
data MerchantAPIs = MerchantAPIs
  { postMerchantUpdate :: API.Types.ProviderPlatform.Merchant.MerchantUpdateReq -> EulerHS.Types.EulerClient API.Types.ProviderPlatform.Merchant.MerchantUpdateRes,
