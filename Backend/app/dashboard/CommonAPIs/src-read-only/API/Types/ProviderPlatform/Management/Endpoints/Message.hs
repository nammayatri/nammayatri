...
data AddLinkAsMedia
    = AddLinkAsMedia {url :: Kernel.Prelude.Text, fileType :: AWS.S3.FileType}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data AddMessageRequest
    = AddMessageRequest {_type :: MessageType,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets AddMessageRequest
    where hideSecrets = Kernel.Prelude.identity
newtype AddMessageResponse
  = AddMessageResponse {messageId :: Kernel.Types.Id.Id Dashboard.Common.Message}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data EditMessageRequest
    = EditMessageRequest {messageId :: Kernel.Types.Id.Id Dashboard.Common.Message,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data InputType
    = Include | Exclude | AllEnabled
    deriving stock (Eq, Show, Generic, Kernel.Prelude.Read)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MediaFile
    = MediaFile {_type :: AWS.S3.FileType, link :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MessageDeliveryInfoResponse
    = MessageDeliveryInfoResponse {messageId :: Kernel.Types.Id.Id Dashboard.Common.Message,
...
data MessageDeliveryStatus
    = Failed | Success | Queued | Sending
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data MessageInfoResponse
    = MessageInfoResponse {messageId :: Kernel.Types.Id.Id Dashboard.Common.Message,
                           title :: Kernel.Prelude.Text,
                           description :: Kernel.Prelude.Text,
                           shortDescription :: Kernel.Prelude.Text,
                           _type :: MessageType,
...
data MessageListItem
    = MessageListItem {messageId :: Kernel.Types.Id.Id Dashboard.Common.Message, title :: Kernel.Prelude.Text, _type :: MessageType, shareable :: Kernel.Prelude.Bool}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MessageListResponse
    = MessageListResponse {messages :: [MessageListItem], summary :: Dashboard.Common.Summary}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MessageReceiverListItem
    = MessageReceiverListItem {receiverId :: Kernel.Types.Id.Id Dashboard.Common.Receiver,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MessageReceiverListResponse
    = MessageReceiverListResponse {receivers :: [MessageReceiverListItem], summary :: Dashboard.Common.Summary}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MessageTranslation
    = MessageTranslation {language :: Kernel.External.Types.Language,
                          title :: Kernel.Prelude.Text,
                          description :: Kernel.Prelude.Text,
                          shortDescription :: Kernel.Prelude.Text,
                          label :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MessageType
    = Action Kernel.Prelude.Text | Read
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SendMessageRequest
    = SendMessageRequest {csvFile :: Kernel.Prelude.Maybe Kernel.Prelude.FilePath, _type :: InputType, messageId :: Kernel.Prelude.Text, scheduledTime :: Kernel.Prelude.Maybe Kernel.Prelude.UTCTime}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets SendMessageRequest
    where hideSecrets = Kernel.Prelude.identity
...
type GetMessageReceiverList = (Capture "messageId" (Kernel.Types.Id.Id Dashboard.Common.Message) :> "receiverList" :> QueryParam "number" Kernel.Prelude.Text :> QueryParam "status"
                                                                                                                                                                            MessageDeliveryStatus :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> Get ('[JSON])
                                                                                                                                                                                                                                                                                            MessageReceiverListResponse)
data MessageAPIs
    = MessageAPIs {postMessageUploadFile :: ((Data.ByteString.Lazy.ByteString, UploadFileRequest) -> EulerHS.Types.EulerClient UploadFileResponse),
...
mkMessageAPIs messageClient = (MessageAPIs {..})
                  where postMessageUploadFile :<|> postMessageAddLink :<|> postMessageAdd :<|> postMessageSend :<|> postMessageEdit :<|> getMessageList :<|> getMessageInfo :<|> getMessageDeliveryInfo :<|> getMessageReceiverList = messageClient
