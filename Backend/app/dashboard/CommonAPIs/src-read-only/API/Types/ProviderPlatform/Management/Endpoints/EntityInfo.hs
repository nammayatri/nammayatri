...
data EntityExtraInformation
    = EntityExtraInformation {entityType :: EntityType, entityId :: Kernel.Prelude.Text, entityInfo :: [EntityInfoAPIEntity]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data EntityInfoAPIEntity
    = EntityInfoAPIEntity {questionId :: Kernel.Prelude.Text, question :: Kernel.Prelude.Text, answer :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data EntityType
    = DRIVER | RC
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data UpdateEntityInfoReq
    = UpdateEntityInfoReq {entityType :: EntityType, entityId :: Kernel.Prelude.Text, newInfo :: [EntityInfoAPIEntity]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdateEntityInfoReq
...
data EntityInfoAPIs
    = EntityInfoAPIs {getEntityInfoList :: (Kernel.Prelude.Text -> Kernel.Prelude.Text -> EulerHS.Types.EulerClient EntityExtraInformation),
...
mkEntityInfoAPIs entityInfoClient = (EntityInfoAPIs {..})
                     where getEntityInfoList :<|> postEntityInfoUpdate = entityInfoClient
data EntityInfoUserActionType
    = GET_ENTITY_INFO_LIST | POST_ENTITY_INFO_UPDATE
