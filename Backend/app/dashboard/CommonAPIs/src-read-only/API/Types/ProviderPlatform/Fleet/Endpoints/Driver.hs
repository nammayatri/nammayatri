...
data ChangeFleetDriverReq = ChangeFleetDriverReq {newOperatorCode :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

instance Kernel.Types.HideSecrets.HideSecrets ChangeFleetDriverReq where
  hideSecrets = Kernel.Prelude.identity
...
type GetDriverFleetOwnerList =
  ( "fleetOwner" :> "list" :> QueryParam "blocked" Kernel.Prelude.Bool
      :> QueryParam
           "docsVerificationStatus"
           Dashboard.Common.DocsVerificationStatus
      :> QueryParam "fleetType" API.Types.ProviderPlatform.Fleet.Endpoints.RegistrationV2.FleetType
      :> QueryParam
           "fromDate"
...
type PostDriverFleetUnlink =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> Capture "vehicleNo" Kernel.Prelude.Text :> "fleet" :> "unlink"
      :> QueryParam
           "fleetOwnerId"
           Kernel.Prelude.Text
      :> QueryParam "notifyDriver" Kernel.Prelude.Bool
      :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
  )
...
type PostDriverFleetChangeDriver =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "fleet" :> "change" :> "driver"
      :> QueryParam
           "fleetOwnerId"
           Kernel.Prelude.Text
      :> ReqBody '[JSON] ChangeFleetDriverReq
      :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
  )

type PostDriverFleetChangeDriverHelper =
  ( Capture "requestorId" Kernel.Prelude.Text
      :> Capture
           "driverId"
           (Kernel.Types.Id.Id Dashboard.Common.Driver)
...
type GetDriverFleetDriverListStats =
  ( "fleet" :> "driver" :> "list" :> "stats" :> QueryParam "from" Data.Time.Day :> QueryParam "to" Data.Time.Day
      ...
      :> QueryParam "driverNumber" Kernel.Prelude.Text
      :> QueryParam
           "limit"
           Kernel.Prelude.Int
      :> QueryParam
...
data DriverAPIs = DriverAPIs
  { getDriverFleetAccessList :: Kernel.Prelude.Maybe Kernel.Prelude.Text -> EulerHS.Types.EulerClient FleetOwnerListRes,
    getDriverFleetOwnerList :: Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Kernel.Prelude.Maybe Dashboard.Common.DocsVerificationStatus -> Kernel.Prelude.Maybe API.Types.ProviderPlatform.Fleet.Endpoints.RegistrationV2.FleetType -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> EulerHS.Types.EulerClient [FleetOwnerListItem],
    ...
    postDriverFleetUnlink :: Kernel.Prelude.Text -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
    ...
    postDriverFleetChangeDriver :: Kernel.Prelude.Text -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> ChangeFleetDriverReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
...
data DriverUserActionType
  ...
  | POST_DRIVER_FLEET_CHANGE_DRIVER
