...
data FleetVehicleStatsItem = FleetVehicleStatsItem
  { vehicleNo :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    earningPerKm :: Kernel.Prelude.Double
  }
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
