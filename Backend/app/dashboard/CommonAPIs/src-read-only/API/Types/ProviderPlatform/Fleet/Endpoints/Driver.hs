...
type PostDriverFleetDashboardAnalyticsCache =
  ( "fleet" :> "dashboard" :> "analytics" :> "cache" :> QueryParam "activeDriverCount" Kernel.Prelude.Int
      :> QueryParam
           "activeVehicleCount"
           Kernel.Prelude.Int
      :> QueryParam "currentOnlineDriver" Kernel.Prelude.Int
      :> MandatoryQueryParam
           "fleetOwnerId"
           Kernel.Prelude.Text
      :> Post
...
data DriverAPIs = DriverAPIs
  { getDriverFleetAccessList :: (Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> EulerHS.Types.EulerClient FleetOwnerListRes),
    ...
    postDriverFleetDashboardAnalyticsCache :: Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Text -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
