...
data FleetDriverMetricsStatsRes = FleetDriverMetricsStatsRes
  { driverName :: Kernel.Prelude.Text,
    ...
    onlineHrs :: Kernel.Prelude.Double,
    rideTime :: Kernel.Prelude.Double,
