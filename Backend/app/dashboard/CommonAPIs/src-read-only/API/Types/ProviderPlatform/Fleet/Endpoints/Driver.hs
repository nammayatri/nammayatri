...
instance Kernel.Types.HideSecrets.HideSecrets ChangeDriverFleetOwnerReq where
  hideSecrets = Kernel.Prelude.identity
...
type PostDriverFleetCashRideUpdate = ("fleet" :> "cashRideUpdate" :> ReqBody ('[JSON]) UpdateCashRideReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)

type PostDriverFleetCashRideUpdateHelper =
  ( Capture "requestorId" Kernel.Prelude.Text :> "fleet" :> "cashRideUpdate" :> ReqBody ('[JSON]) UpdateCashRideReq
      :> Post
           ('[JSON])
           Kernel.Types.APISuccess.APISuccess
  )
...
data DriverAPIs = DriverAPIs
  { getDriverFleetAccessList :: (Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> EulerHS.Types.EulerClient FleetOwnerListRes),
    ...
    postDriverFleetCashRideUpdate :: (Kernel.Prelude.Text -> UpdateCashRideReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess),
    ...
    postDriverFleetDriverChangeFleetOwner :: (Kernel.Types.Id.Id Dashboard.Common.Driver -> ChangeDriverFleetOwnerReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess),
