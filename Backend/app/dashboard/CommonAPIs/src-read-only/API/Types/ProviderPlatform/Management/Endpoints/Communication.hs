...
data CTAButtonReq
    = CTAButtonReq {label :: Kernel.Prelude.Text, url :: Kernel.Prelude.Text, linkType :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CommunicationChannelType
    = CH_PUSH | CH_SMS | CH_EMAIL | CH_WHATSAPP | CH_WEB
...
data CommunicationDeliveryStatusType
    = DLV_PENDING | DLV_SENT | DLV_DELIVERED | DLV_READ | DLV_FAILED
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data CommunicationDomainType
    = COMM_FLEET | COMM_RIDE_HAILING | COMM_GENERAL
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data CommunicationInfoResponse
    = CommunicationInfoResponse {id :: Kernel.Types.Id.Id Dashboard.Common.Communication,
...
data CommunicationListItem
    = CommunicationListItem {id :: Kernel.Types.Id.Id Dashboard.Common.Communication,
                             title :: Kernel.Prelude.Text,
                             body :: Kernel.Prelude.Text,
                             msgContentType :: CommunicationContentTypeEnum,
                             channels :: [CommunicationChannelType],
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CommunicationListResponse
    = CommunicationListResponse {communications :: [CommunicationListItem], summary :: Dashboard.Common.Summary}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CommunicationListType
    = LIST_SENT | LIST_RECEIVED | LIST_DRAFT
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data CommunicationMediaFile
    = CommunicationMediaFile {url :: Kernel.Prelude.Text, fileType :: Kernel.Prelude.Text, thumbnailUrl :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CommunicationMessageStatus
    = SEND_NOW | SAVE_AS_DRAFT
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CommunicationRoleType
    = ROLE_DRIVER | ROLE_FLEET_OWNER | ROLE_OPERATOR | ROLE_ADMIN
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data CommunicationStatusType
    = CS_DRAFT | CS_QUEUED | CS_SENDING | CS_SENT | CS_FAILED | CS_SCHEDULED
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data CommunicationTemplateResponse
    = CommunicationTemplateResponse {templateId :: Kernel.Prelude.Text, messageBody :: Kernel.Prelude.Text, templateName :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CreateCommunicationRequest
    = CreateCommunicationRequest {title :: Kernel.Prelude.Text,
                                  body :: Kernel.Prelude.Text,
                                  htmlBody :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                                  msgContentType :: CommunicationContentTypeEnum,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets CreateCommunicationRequest
    where hideSecrets = Kernel.Prelude.identity
data CreateCommunicationResponse
    = CreateCommunicationResponse {communicationId :: Kernel.Types.Id.Id Dashboard.Common.Communication, status :: CommunicationStatusType}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DeliveryStatusItem
    = DeliveryStatusItem {id :: Kernel.Prelude.Text,
...
data DeliveryStatusResponse
    = DeliveryStatusResponse {deliveries :: [DeliveryStatusItem], summary :: Dashboard.Common.Summary}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DeliverySummary
    = DeliverySummary {total :: Kernel.Prelude.Int, sent :: Kernel.Prelude.Int, delivered :: Kernel.Prelude.Int, read :: Kernel.Prelude.Int, failed :: Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data EditCommunicationRequest
    = EditCommunicationRequest {title :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets EditCommunicationRequest
    where hideSecrets = Kernel.Prelude.identity
data RecipientItem
    = RecipientItem {id :: Kernel.Prelude.Text,
...
data RecipientsResponse
    = RecipientsResponse {recipients :: [RecipientItem], summary :: Dashboard.Common.Summary}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SendCommunicationRequest
    = SendCommunicationRequest {recipientIds :: Kernel.Prelude.Maybe [Kernel.Prelude.Text],
                                selectAll :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
                                selectAllRoles :: Kernel.Prelude.Maybe [CommunicationRoleType],
                                fleetOwnerId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                                operatorId :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets SendCommunicationRequest
    where hideSecrets = Kernel.Prelude.identity
...
type PostCommunicationCreate = ("create" :> MandatoryQueryParam "personId" (Kernel.Types.Id.Id Dashboard.Common.Person) :> ReqBody ('[JSON]) CreateCommunicationRequest :> Post ('[JSON])
                                                                                                                                                                                CreateCommunicationResponse)
type GetCommunicationList = ("list" :> QueryParam "listType" CommunicationListType :> QueryParam "channel" CommunicationChannelType :> QueryParam "domain"
                                                                                                                                                  CommunicationDomainType :> QueryParam "search" Kernel.Prelude.Text :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset"
                                                                                                                                                                                                                                                                            Kernel.Prelude.Int :> MandatoryQueryParam "personId"
                                                                                                                                                                                                                                                                                                                      (Kernel.Types.Id.Id Dashboard.Common.Person) :> Get ('[JSON])
...
type PostCommunicationSend = (Capture "communicationId" (Kernel.Types.Id.Id Dashboard.Common.Communication) :> "send" :> ReqBody ('[JSON]) SendCommunicationRequest :> Post ('[JSON])
                                                                                                                                                                            Kernel.Types.APISuccess.APISuccess)
type PutCommunicationEdit = (Capture "communicationId" (Kernel.Types.Id.Id Dashboard.Common.Communication) :> "edit" :> ReqBody ('[JSON]) EditCommunicationRequest :> Put ('[JSON])
                                                                                                                                                                          Kernel.Types.APISuccess.APISuccess)
...
type GetCommunicationDeliveryStatus = (Capture "communicationId" (Kernel.Types.Id.Id Dashboard.Common.Communication) :> "deliveryStatus" :> QueryParam "channel"
                                                                                                                                                       CommunicationChannelType :> QueryParam "status" CommunicationDeliveryStatusType :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset"
                                                                                                                                                                                                                                                                                              Kernel.Prelude.Int :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                        DeliveryStatusResponse)
type GetCommunicationRecipients = ("recipients" :> QueryParam "role" CommunicationRoleType :> QueryParam "fleetOwnerId" Kernel.Prelude.Text :> QueryParam "operatorId"
                                                                                                                                                          Kernel.Prelude.Text :> QueryParam "search" Kernel.Prelude.Text :> QueryParam "selectAll" Kernel.Prelude.Bool :> QueryParam "limit"
                                                                                                                                                                                                                                                                                     Kernel.Prelude.Int :> QueryParam "offset"
                                                                                                                                                                                                                                                                                                                      Kernel.Prelude.Int :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                RecipientsResponse)
type GetCommunicationTemplate = ("template" :> MandatoryQueryParam "domain" CommunicationDomainType :> MandatoryQueryParam "channel" CommunicationChannelType :> Get ('[JSON])
                                                                                                                                                                     CommunicationTemplateResponse)
data CommunicationAPIs
    = CommunicationAPIs {postCommunicationCreate :: (Kernel.Types.Id.Id Dashboard.Common.Person -> CreateCommunicationRequest -> EulerHS.Types.EulerClient CreateCommunicationResponse),
...
mkCommunicationAPIs communicationClient = (CommunicationAPIs {..})
                        where postCommunicationCreate :<|> getCommunicationList :<|> getCommunicationInfo :<|> postCommunicationSend :<|> putCommunicationEdit :<|> deleteCommunicationDelete :<|> getCommunicationDeliveryStatus :<|> getCommunicationRecipients :<|> getCommunicationTemplate = communicationClient
