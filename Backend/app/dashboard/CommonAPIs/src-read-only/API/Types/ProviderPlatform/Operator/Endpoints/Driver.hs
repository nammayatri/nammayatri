...
data AllTimeOperatorAnalyticsRes
    = AllTimeOperatorAnalyticsRes {rating :: Kernel.Prelude.Maybe Kernel.Prelude.Double,
...
data DriverInfo
    = DriverInfo {driverId :: Kernel.Types.Id.Id Dashboard.Common.Driver,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverInfoResp
    = DriverInfoResp {listItem :: [DriverInfo], summary :: Dashboard.Common.Summary}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverOperationHubRequest
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets DriverOperationHubRequest
    where hideSecrets = Kernel.Prelude.identity
data FilteredOperatorAnalyticsRes
    = FilteredOperatorAnalyticsRes {activeDriver :: Kernel.Prelude.Int,
...
data OperationHubDriverRequest
    = OperationHubDriverRequest {creatorPhoneNo :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                                 driverId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Dashboard.Common.Driver),
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data OperationHubReqResp
    = OperationHubReqResp {requests :: [OperationHubDriverRequest], summary :: Dashboard.Common.Summary}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RequestStatus
...
data RequestType
    ...
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data RespondHubRequest
    = RespondHubRequest {operationHubRequestId :: Kernel.Prelude.Text, operatorId :: Kernel.Prelude.Text, remarks :: Kernel.Prelude.Text, status :: RequestStatus}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets RespondHubRequest
    where hideSecrets = Kernel.Prelude.identity
data VerifyOperatorJoiningOtpReq
    = VerifyOperatorJoiningOtpReq {mobileCountryCode :: Kernel.Prelude.Text,
                                   mobileNumber :: Kernel.Prelude.Text,
                                   otp :: Kernel.Prelude.Text,
                                   deviceToken :: Kernel.Prelude.Maybe Kernel.External.Notification.FCM.Types.FCMRecipientToken}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets VerifyOperatorJoiningOtpReq
    where hideSecrets = Kernel.Prelude.identity
...
type GetDriverOperatorFetchHubRequests = ("operator" :> "fetch" :> "hubRequests" :> QueryParam "mbFrom" Kernel.Prelude.UTCTime :> QueryParam "mbTo" Kernel.Prelude.UTCTime :> QueryParam "mbStatus"
                                                                                                                                                                                         RequestStatus :> QueryParam "mbReqType" RequestType :> QueryParam "mbLimit"
                                                                                                                                                                                                                                                           Kernel.Prelude.Int :> QueryParam "mbOffset"
                                                                                                                                                                                                                                                                                            Kernel.Prelude.Int :> QueryParam "mbDriverId"
                                                                                                                                                                                                                                                                                                                             Kernel.Prelude.Text :> QueryParam "mbMobileNumber"
                                                                                                                                                                                                                                                                                                                                                               Kernel.Prelude.Text :> QueryParam "mbOperationHubId"
                                                                                                                                                                                                                                                                                                                                                                                                 (Kernel.Types.Id.Id OperationHub) :> QueryParam "mbOperationHubName"
                                                                                                                                                                                                                                                                                                                                                                                                                                                 Kernel.Prelude.Text :> QueryParam "mbRegistrationNo"
...
type GetDriverOperatorList = ("operator" :> "list" :> QueryParam "isActive" Kernel.Prelude.Bool :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset"
                                                                                                                                                       Kernel.Prelude.Int :> QueryParam "vehicleNo" Kernel.Prelude.Text :> QueryParam "mbSearchString" Kernel.Prelude.Text :> QueryParam "includeDocuments"
                                                                                                                                                                                                                                                                                         Kernel.Prelude.Bool :> QueryParam "onlyMandatoryDocs"
                                                                                                                                                                                                                                                                                                                           Kernel.Prelude.Bool :> QueryParam "mbStatus"
                                                                                                                                                                                                                                                                                                                                                             API.Types.ProviderPlatform.Fleet.Endpoints.Driver.DriverMode :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                 DriverInfoResp)
type GetDriverOperatorListHelper = ("operator" :> "list" :> QueryParam "isActive" Kernel.Prelude.Bool :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset"
                                                                                                                                                             Kernel.Prelude.Int :> QueryParam "vehicleNo" Kernel.Prelude.Text :> QueryParam "mbSearchString"
                                                                                                                                                                                                                                            Kernel.Prelude.Text :> QueryParam "includeDocuments"
                                                                                                                                                                                                                                                                              Kernel.Prelude.Bool :> QueryParam "onlyMandatoryDocs"
                                                                                                                                                                                                                                                                                                                Kernel.Prelude.Bool :> QueryParam "mbStatus"
                                                                                                                                                                                                                                                                                                                                                  API.Types.ProviderPlatform.Fleet.Endpoints.Driver.DriverMode :> MandatoryQueryParam "requestorId"
                                                                                                                                                                                                                                                                                                                                                                                                                                      Kernel.Prelude.Text :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                 DriverInfoResp)
type PostDriverOperatorSendJoiningOtp = ("operator" :> "sendJoiningOtp" :> ReqBody ('[JSON]) Dashboard.ProviderPlatform.Management.DriverRegistration.AuthReq :> Post ('[JSON])
                                                                                                                                                                      Dashboard.ProviderPlatform.Management.DriverRegistration.AuthRes)
type PostDriverOperatorSendJoiningOtpHelper = ("operator" :> "sendJoiningOtp" :> MandatoryQueryParam "requestorId" Kernel.Prelude.Text :> ReqBody ('[JSON])
...
type PostDriverOperatorVerifyJoiningOtp = ("operator" :> "verifyJoiningOtp" :> QueryParam "authId" Kernel.Prelude.Text :> ReqBody ('[JSON]) VerifyOperatorJoiningOtpReq :> Post ('[JSON])
                                                                                                                                                                                Kernel.Types.APISuccess.APISuccess)
type PostDriverOperatorVerifyJoiningOtpHelper = ("operator" :> "verifyJoiningOtp" :> QueryParam "authId" Kernel.Prelude.Text :> MandatoryQueryParam "requestorId"
                                                                                                                                                    Kernel.Prelude.Text :> ReqBody ('[JSON]) VerifyOperatorJoiningOtpReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
...
type GetDriverOperatorDashboardAnalyticsAllTimeHelper = (Capture "requestorId" Kernel.Prelude.Text :> "operator" :> "dashboard" :> "analytics" :> "allTime" :> Get ('[JSON])
                                                                                                                                                                   AllTimeOperatorAnalyticsRes)
type GetDriverOperatorDashboardAnalytics = ("operator" :> "dashboard" :> "analytics" :> MandatoryQueryParam "from" Data.Time.Calendar.Day :> MandatoryQueryParam "to"
                                                                                                                                                                 Data.Time.Calendar.Day :> Get ('[JSON]) FilteredOperatorAnalyticsRes)
type GetDriverOperatorDashboardAnalyticsHelper = (Capture "requestorId" Kernel.Prelude.Text :> "operator" :> "dashboard" :> "analytics" :> MandatoryQueryParam "from"
                                                                                                                                                               Data.Time.Calendar.Day :> MandatoryQueryParam "to" Data.Time.Calendar.Day :> Get ('[JSON]) FilteredOperatorAnalyticsRes)
data DriverAPIs
    = DriverAPIs {getDriverOperatorFetchHubRequests :: (Kernel.Prelude.Maybe (Kernel.Prelude.UTCTime) -> Kernel.Prelude.Maybe (Kernel.Prelude.UTCTime) -> Kernel.Prelude.Maybe (RequestStatus) -> Kernel.Prelude.Maybe (RequestType) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Types.Id.Id OperationHub) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> EulerHS.Types.EulerClient OperationHubReqResp),
...
mkDriverAPIs driverClient = (DriverAPIs {..})
                 where getDriverOperatorFetchHubRequests :<|> getDriverOperationGetAllHubs :<|> postDriverOperatorRespondHubRequest :<|> postDriverOperatorCreateRequest :<|> getDriverOperatorList :<|> postDriverOperatorSendJoiningOtp :<|> postDriverOperatorVerifyJoiningOtp :<|> getDriverOperatorDashboardAnalyticsAllTime :<|> getDriverOperatorDashboardAnalytics = driverClient
