...
data UpdateScheduledPayoutConfigReq
    = UpdateScheduledPayoutConfigReq {payoutCategory :: Lib.Payment.Domain.Types.Common.EntityName,
...
type PostPayoutPayoutRetry = ("payout" :> Capture "payoutRequestId" (Kernel.Types.Id.Id Lib.Payment.Domain.Types.PayoutRequest.PayoutRequest) :> "retry" :> Post ('[JSON])
                                                                                                                                                                 Lib.Payment.API.Payout.Types.PayoutSuccess)
type PostPayoutPayoutCancel = ("payout" :> Capture "payoutRequestId" (Kernel.Types.Id.Id Lib.Payment.Domain.Types.PayoutRequest.PayoutRequest) :> "cancel" :> ReqBody ('[JSON])
                                                                                                                                                                      Lib.Payment.API.Payout.Types.PayoutCancelReq :> Post ('[JSON]) Lib.Payment.API.Payout.Types.PayoutSuccess)
type PostPayoutPayoutCash = ("payout" :> Capture "payoutRequestId" (Kernel.Types.Id.Id Lib.Payment.Domain.Types.PayoutRequest.PayoutRequest) :> "cash" :> ReqBody ('[JSON])
                                                                                                                                                                  Lib.Payment.API.Payout.Types.PayoutCashUpdateReq :> Post ('[JSON]) Lib.Payment.API.Payout.Types.PayoutSuccess)
...
type PostPayoutPayoutVpaRefundRegistration = ("payout" :> "vpa" :> "refundRegistration" :> ReqBody ('[JSON]) Lib.Payment.API.Payout.Types.RefundRegAmountReq :> Post ('[JSON])
                                                                                                                                                                     Lib.Payment.API.Payout.Types.PayoutSuccess)
type PostPayoutPayoutScheduledPayoutConfigUpsert = ("payout" :> "scheduledPayoutConfig" :> "upsert" :> ReqBody ('[JSON]) UpdateScheduledPayoutConfigReq :> Post ('[JSON])
                                                                                                                                                                Kernel.Types.APISuccess.APISuccess)
data PayoutAPIs
    = PayoutAPIs {getPayoutPayout :: (Kernel.Types.Id.Id Lib.Payment.Domain.Types.PayoutRequest.PayoutRequest -> EulerHS.Types.EulerClient Lib.Payment.API.Payout.Types.PayoutRequestResp),
...
mkPayoutAPIs payoutClient = (PayoutAPIs {..})
                 where getPayoutPayout :<|> postPayoutPayoutRetry :<|> postPayoutPayoutCancel :<|> postPayoutPayoutCash :<|> postPayoutPayoutVpaDelete :<|> postPayoutPayoutVpaUpdate :<|> postPayoutPayoutVpaRefundRegistration :<|> postPayoutPayoutScheduledPayoutConfigUpsert = payoutClient
