...
data AadhaarDetails
    = AadhaarDetails {aadhaarStatus :: Kernel.Prelude.Maybe Kernel.Prelude.Text, aadhaarStatusTime :: Kernel.Prelude.UTCTime, aadhaarTransactionId :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data AadharPanSyncReq
    = AadharPanSyncReq {phoneNo :: Kernel.Prelude.Text, countryCode :: Kernel.Prelude.Text, documentType :: SyncDocType}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets AadharPanSyncReq
    where hideSecrets = Kernel.Prelude.identity
data AppendSelectedServiceTiersReq
    = AppendSelectedServiceTiersReq {selected_service_tiers :: [Dashboard.Common.ServiceTierType]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets AppendSelectedServiceTiersReq
    where hideSecrets = Kernel.Prelude.identity
data BlockDriverWithReasonReq
    = BlockDriverWithReasonReq {reasonCode :: Kernel.Prelude.Text, blockReason :: Kernel.Prelude.Maybe Kernel.Prelude.Text, blockTimeInHours :: Kernel.Prelude.Maybe Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BlockReason
    = BlockReason {reasonCode :: Kernel.Types.Id.Id BlockReason, blockReason :: Kernel.Prelude.Maybe Kernel.Prelude.Text, blockTimeInHours :: Kernel.Prelude.Maybe Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BulkServiceUpdateReq
    = BulkServiceUpdateReq {driverIds :: [Kernel.Prelude.Text], serviceNames :: [Dashboard.Common.Driver.ServiceNames]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets BulkServiceUpdateReq
    where hideSecrets = Kernel.Prelude.identity
newtype ChangeOperatingCityReq
  = ChangeOperatingCityReq {operatingCity :: Kernel.Types.Beckn.Context.City}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets ChangeOperatingCityReq
    where hideSecrets = Kernel.Prelude.identity
data ClearDriverFeeReq
    = ClearDriverFeeReq {serviceName :: Dashboard.Common.Driver.ServiceNames,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype ClearOnRideStuckDriversRes
  = ClearOnRideStuckDriversRes {driverIds :: [Kernel.Types.Id.Id Dashboard.Common.Driver]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype DeleteRCReq
  = DeleteRCReq {rcNo :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets DeleteRCReq
    where hideSecrets = Kernel.Prelude.identity
type DriverAadhaarInfoByPhoneReq = DriverAadhaarInfoRes
data DriverAadhaarInfoRes
    = DriverAadhaarInfoRes {driverName :: Kernel.Prelude.Text, driverGender :: Kernel.Prelude.Text, driverDob :: Kernel.Prelude.Text, driverImage :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverDecDataResp
    = DriverDecDataResp {driverIdResp :: Kernel.Types.Id.Id Dashboard.Common.Driver, driverDataResp :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets DriverDecDataResp
    where hideSecrets = Kernel.Prelude.identity
data DriverEncDataReq
    = DriverEncDataReq {driverIdReq :: Kernel.Types.Id.Id Dashboard.Common.Driver, driverDataReq :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets DriverEncDataReq
    where hideSecrets = Kernel.Prelude.identity
data DriverFeeType
    = PAYOUT_REGISTRATION | ONE_TIME_SECURITY_DEPOSIT
    deriving stock (Eq, Show, Generic, Read)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data DriverListItem
    = DriverListItem {driverId :: Kernel.Types.Id.Id Dashboard.Common.Driver,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverListRes
    = DriverListRes {totalItems :: Kernel.Prelude.Int, summary :: Dashboard.Common.Summary, drivers :: [DriverListItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverLocationItem
    = DriverLocationItem {driverId :: Kernel.Types.Id.Id Dashboard.Common.Driver,
                          firstName :: Kernel.Prelude.Text,
                          middleName :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                          lastName :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverLocationRes
    = DriverLocationRes {driverLocationsNotFound :: Kernel.Prelude.Maybe (Kernel.Prelude.NonEmpty (Kernel.Types.Id.Id Dashboard.Common.Driver)), driverLocations :: [DriverLocationItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverStatsRes
    = DriverStatsRes {numDriversOnboarded :: Kernel.Prelude.Int,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DummyRideRequestRes
    = DummyRideRequestRes {result :: Kernel.Prelude.Text, reason :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data EarningPeriodStats
    = EarningPeriodStats {periodStart :: Data.Time.Calendar.Day,
                          totalEarnings :: Kernel.Types.Common.Money,
                          totalDistance :: Kernel.Types.Common.Meters,
                          totalRides :: Kernel.Prelude.Int,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data EarningPeriodStatsRes
    = EarningPeriodStatsRes {earnings :: [EarningPeriodStats]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype GetOperatingCityResp
  = GetOperatingCityResp {operatingCity :: Kernel.Types.Beckn.Context.City}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets GetOperatingCityResp
    where hideSecrets = Kernel.Prelude.identity
data LicDetails
    = LicDetails {licExpiry :: Kernel.Prelude.UTCTime, vehicleClass :: [Kernel.Prelude.Text]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PanAadharSelfieDetailsListResp
    = PanAadharSelfieDetailsListResp {transactionId :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PanAadharSelfieDetailsResp
    = PanAadharSelfieDetailsResp {personName :: Kernel.Prelude.Text,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PanDetails
    = PanDetails {panStatus :: Kernel.Prelude.Maybe Kernel.Prelude.Text, panStatusTime :: Kernel.Prelude.UTCTime, panTransactionId :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PauseOrResumeServiceChargesReq
    = PauseOrResumeServiceChargesReq {serviceChargeEligibility :: Kernel.Prelude.Bool,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets PauseOrResumeServiceChargesReq
    where hideSecrets = Kernel.Prelude.identity
data RCDetails
    = RCDetails {vehicleRegistrationCertNumber :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RefundByPayoutReq
    = RefundByPayoutReq {serviceName :: Dashboard.Common.Driver.ServiceNames,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets RefundByPayoutReq
    where hideSecrets = Kernel.Prelude.identity
data ReviewRCVariantReq
    = ReviewRCVariantReq {rcId :: Kernel.Prelude.Text, vehicleVariant :: Kernel.Prelude.Maybe Dashboard.Common.VehicleVariant, markReviewed :: Kernel.Prelude.Maybe Kernel.Prelude.Bool}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ReviewRCVariantRes
    = ReviewRCVariantRes {rcId :: Kernel.Prelude.Text, status :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SecurityDepositDfStatusRes
    = SecurityDepositDfStatusRes {securityDepositStatus :: Dashboard.Common.Driver.DriverFeeStatus,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SelfieDetails
    = SelfieDetails {latestStatus :: Kernel.Prelude.Maybe Kernel.Prelude.Text, latestStatusTime :: Kernel.Prelude.UTCTime, latestTransactionId :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SyncDocType
    = Aadhaar | Pan
...
data TdsOwnerType
    ...
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data UpdateACUsageRestrictionReq
    = UpdateACUsageRestrictionReq {isWorking :: Kernel.Prelude.Bool, downgradeReason :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdateACUsageRestrictionReq
    where hideSecrets = Kernel.Prelude.identity
data UpdateDriverDataReq
    = UpdateDriverDataReq {driverName :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data UpdateDriverMerchantReq
    = UpdateDriverMerchantReq {newMerchantId :: Kernel.Types.Id.Id Dashboard.Common.Merchant, newMerchantOperatingCityId :: Kernel.Types.Id.Id Dashboard.Common.MerchantOperatingCity}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdateDriverMerchantReq
    where hideSecrets = Kernel.Prelude.identity
data UpdateDriverNameReq
    = UpdateDriverNameReq {firstName :: Kernel.Prelude.Text, middleName :: Kernel.Prelude.Maybe Kernel.Prelude.Text, lastName :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdateDriverNameReq
    where hideSecrets = Kernel.Prelude.identity
data UpdateDriverTagReq
    = UpdateDriverTagReq {driverTag :: Lib.Yudhishthira.Types.TagNameValue, isAddingTag :: Kernel.Prelude.Bool}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdateDriverTagReq
    where hideSecrets = Kernel.Prelude.identity
data UpdatePhoneNumberReq
    = UpdatePhoneNumberReq {newPhoneNumber :: Kernel.Prelude.Text, newCountryCode :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdatePhoneNumberReq
    where hideSecrets = Kernel.Prelude.identity
data UpdateRCInvalidStatusByRCNumberReq
    = UpdateRCInvalidStatusByRCNumberReq {rcNumber :: Kernel.Prelude.Text, vehicleVariant :: Dashboard.Common.VehicleVariant}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdateRCInvalidStatusByRCNumberReq
    where hideSecrets = Kernel.Prelude.identity
data UpdateRCInvalidStatusReq
    = UpdateRCInvalidStatusReq {rcId :: Kernel.Prelude.Text, vehicleVariant :: Dashboard.Common.VehicleVariant}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdateRCInvalidStatusReq
    where hideSecrets = Kernel.Prelude.identity
data UpdateTdsRateReq
    = UpdateTdsRateReq {ownerType :: TdsOwnerType, ownerId :: Kernel.Types.Id.Id Dashboard.Common.Person, tdsRate :: Kernel.Prelude.Maybe Kernel.Prelude.Double}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdateTdsRateReq
    where hideSecrets = Kernel.Prelude.identity
data UpdateVehicleManufacturingReq
    = UpdateVehicleManufacturingReq {rcId :: Kernel.Prelude.Text, manufacturing :: Data.Time.Calendar.Day}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdateVehicleManufacturingReq
    where hideSecrets = Kernel.Prelude.identity
data UpdateVehicleVariantReq
    = UpdateVehicleVariantReq {rcId :: Kernel.Prelude.Text, vehicleVariant :: Dashboard.Common.VehicleVariant}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdateVehicleVariantReq
    where hideSecrets = Kernel.Prelude.identity
type API = ("driver" :> (GetDriverDocumentsInfo :<|> PostDriverPersonNumbers :<|> PostDriverUpdateTagBulk :<|> PostDriverDriverDataDecryption :<|> PostDriverPersonId :<|> GetDriverAadhaarInfo :<|> GetDriverAadhaarInfobyMobileNumber :<|> GetDriverList :<|> GetDriverActivity :<|> PostDriverDisable :<|> PostDriverAcRestrictionUpdate :<|> PostDriverBlockWithReasonHelper :<|> PostDriverBlock :<|> GetDriverBlockReasonList :<|> PostDriverUnblockHelper :<|> GetDriverLocation :<|> DeleteDriverPermanentlyDelete :<|> PostDriverUnlinkDL :<|> PostDriverUnlinkAadhaar :<|> PostDriverUpdatePhoneNumber :<|> PostDriverUpdateByPhoneNumber :<|> PostDriverUpdateName :<|> PostDriverDeleteRC :<|> GetDriverClearStuckOnRide :<|> PostDriverSendDummyNotification :<|> PostDriverChangeOperatingCity :<|> GetDriverGetOperatingCity :<|> PostDriverPauseOrResumeServiceCharges :<|> PostDriverUpdateRCInvalidStatus :<|> PostDriverUpdateRCInvalidStatusByRCNumber :<|> PostDriverUpdateVehicleVariant :<|> PostDriverBulkReviewRCVariant :<|> PostDriverUpdateDriverTag :<|> PostDriverClearFee :<|> GetDriverPanAadharSelfieDetails :<|> PostDriverSyncDocAadharPan :<|> PostDriverUpdateVehicleManufacturing :<|> PostDriverVehicleAppendSelectedServiceTiers :<|> PostDriverVehicleUpsertSelectedServiceTiers :<|> PostDriverRefundByPayout :<|> GetDriverSecurityDepositStatus :<|> GetDriverPanAadharSelfieDetailsList :<|> PostDriverBulkSubscriptionServiceUpdate :<|> GetDriverStatsHelper :<|> GetDriverEarningsHelper :<|> PostDriverTdsRateUpdate :<|> PostDriverUpdateMerchant))
...
type PostDriverUpdateTagBulk = ("updateTagBulk" :> Kernel.ServantMultipart.MultipartForm Kernel.ServantMultipart.Tmp Dashboard.Common.UpdateTagBulkReq :> Post ('[JSON])
...
type GetDriverList = ("list" :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> QueryParam "verified" Kernel.Prelude.Bool :> QueryParam "enabled"
                                                                                                                                                                           Kernel.Prelude.Bool :> QueryParam "blocked" Kernel.Prelude.Bool :> QueryParam "subscribed"
                                                                                                                                                                                                                                                         Kernel.Prelude.Bool :> QueryParam "phone"
                                                                                                                                                                                                                                                                                           Kernel.Prelude.Text :> QueryParam "vehicleNumberSearchString"
                                                                                                                                                                                                                                                                                                                             Kernel.Prelude.Text :> QueryParam "mbNameSearchString"
...
type PostDriverAcRestrictionUpdate = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "acRestriction" :> "update" :> ReqBody ('[JSON]) UpdateACUsageRestrictionReq :> Post ('[JSON])
                                                                                                                                                                                              Kernel.Types.APISuccess.APISuccess)
type PostDriverBlockWithReason = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "blockWithReason" :> ReqBody ('[JSON]) BlockDriverWithReasonReq :> Post ('[JSON])
                                                                                                                                                                             Kernel.Types.APISuccess.APISuccess)
type PostDriverBlockWithReasonHelper = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "blockWithReason" :> Capture "dashboardUserName" Kernel.Prelude.Text :> ReqBody ('[JSON])
                                                                                                                                                                                           BlockDriverWithReasonReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
...
type PostDriverUnblock = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "unblock" :> QueryParam "preventWeeklyCancellationRateBlockingTill"
                                                                                                                     Kernel.Prelude.UTCTime :> QueryParam "preventDailyCancellationRateBlockingTill" Kernel.Prelude.UTCTime :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostDriverUnblockHelper = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "unblock" :> Capture "dashboardUserName"
                                                                                                                        Kernel.Prelude.Text :> QueryParam "preventWeeklyCancellationRateBlockingTill" Kernel.Prelude.UTCTime :> QueryParam "preventDailyCancellationRateBlockingTill"
                                                                                                                                                                                                                                           Kernel.Prelude.UTCTime :> Post ('[JSON])
                                                                                                                                                                                                                                                                          Kernel.Types.APISuccess.APISuccess)
type GetDriverLocation = ("location" :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> ReqBody ('[JSON]) Dashboard.Common.Driver.DriverIds :> Get ('[JSON])
                                                                                                                                                                                      DriverLocationRes)
...
type PostDriverUpdatePhoneNumber = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "updatePhoneNumber" :> ReqBody ('[JSON]) UpdatePhoneNumberReq :> Post ('[JSON])
                                                                                                                                                                             Kernel.Types.APISuccess.APISuccess)
...
type PostDriverUpdateName = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "updateName" :> ReqBody ('[JSON]) UpdateDriverNameReq :> Post ('[JSON])
                                                                                                                                                              Kernel.Types.APISuccess.APISuccess)
...
type PostDriverSendDummyNotification = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "sendDummyNotification" :> Post ('[JSON]) DummyRideRequestRes)
type PostDriverChangeOperatingCity = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "changeOperatingCity" :> ReqBody ('[JSON]) ChangeOperatingCityReq :> Post ('[JSON])
                                                                                                                                                                                   Kernel.Types.APISuccess.APISuccess)
type GetDriverGetOperatingCity = ("getOperatingCity" :> QueryParam "mobileCountryCode" Kernel.Prelude.Text :> QueryParam "mobileNumber" Kernel.Prelude.Text :> QueryParam "rideId"
                                                                                                                                                                          (Kernel.Types.Id.Id Dashboard.Common.Ride) :> Get ('[JSON]) GetOperatingCityResp)
type PostDriverPauseOrResumeServiceCharges = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "pauseOrResumeServiceCharges" :> ReqBody ('[JSON])
                                                                                                                                                          PauseOrResumeServiceChargesReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostDriverUpdateRCInvalidStatus = ("updateRCInvalidStatus" :> Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> ReqBody ('[JSON]) UpdateRCInvalidStatusReq :> Post ('[JSON])
                                                                                                                                                                                         Kernel.Types.APISuccess.APISuccess)
...
type PostDriverUpdateVehicleVariant = ("updateVehicleVariant" :> Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> ReqBody ('[JSON]) UpdateVehicleVariantReq :> Post ('[JSON])
                                                                                                                                                                                      Kernel.Types.APISuccess.APISuccess)
type PostDriverBulkReviewRCVariant = ("bulkReviewRCVariant" :> ReqBody ('[JSON]) [ReviewRCVariantReq] :> Post ('[JSON]) [ReviewRCVariantRes])
type PostDriverUpdateDriverTag = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "updateDriverTag" :> ReqBody ('[JSON]) UpdateDriverTagReq :> Post ('[JSON])
                                                                                                                                                                       Kernel.Types.APISuccess.APISuccess)
type PostDriverClearFee = ("clearFee" :> MandatoryQueryParam "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> ReqBody ('[JSON]) ClearDriverFeeReq :> Post ('[JSON])
                                                                                                                                                                    Kernel.Types.APISuccess.APISuccess)
type GetDriverPanAadharSelfieDetails = ("panAadharSelfieDetails" :> MandatoryQueryParam "countryCode" Kernel.Prelude.Text :> MandatoryQueryParam "phoneNo" Kernel.Prelude.Text :> Get ('[JSON])
...
type PostDriverUpdateVehicleManufacturing = ("updateVehicleManufacturing" :> Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> ReqBody ('[JSON])
                                                                                                                                                        UpdateVehicleManufacturingReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostDriverVehicleAppendSelectedServiceTiers = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "vehicle" :> "appendSelectedServiceTiers" :> ReqBody ('[JSON])
                                                                                                                                                                            AppendSelectedServiceTiersReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostDriverVehicleUpsertSelectedServiceTiers = ("vehicle" :> "upsertSelectedServiceTiers" :> Kernel.ServantMultipart.MultipartForm Kernel.ServantMultipart.Tmp
                                                                                                                                       Dashboard.Common.Driver.UpsertDriverServiceTiersCsvReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostDriverRefundByPayout = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "refundByPayout" :> ReqBody ('[JSON]) RefundByPayoutReq :> Post ('[JSON])
                                                                                                                                                                    Kernel.Types.APISuccess.APISuccess)
type GetDriverSecurityDepositStatus = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "securityDepositStatus" :> QueryParam "serviceName"
                                                                                                                                                Dashboard.Common.Driver.ServiceNames :> Get ('[JSON]) ([SecurityDepositDfStatusRes]))
type GetDriverPanAadharSelfieDetailsList = ("panAadharSelfieDetailsList" :> MandatoryQueryParam "docType" Kernel.Prelude.Text :> MandatoryQueryParam "driverId"
                                                                                                                                                     (Kernel.Types.Id.Id Dashboard.Common.Driver) :> Get ('[JSON]) ([PanAadharSelfieDetailsListResp]))
...
type GetDriverStats = ("stats" :> QueryParam "entityId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> QueryParam "fromDate" Data.Time.Calendar.Day :> QueryParam "toDate"
                                                                                                                                                                   Data.Time.Calendar.Day :> Get ('[JSON]) DriverStatsRes)
type GetDriverStatsHelper = ("stats" :> QueryParam "entityId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> QueryParam "fromDate" Data.Time.Calendar.Day :> QueryParam "toDate"
                                                                                                                                                                         Data.Time.Calendar.Day :> MandatoryQueryParam "requestorId" Kernel.Prelude.Text :> Get ('[JSON]) DriverStatsRes)
type GetDriverEarnings = ("earnings" :> MandatoryQueryParam "from" Data.Time.Calendar.Day :> MandatoryQueryParam "to" Data.Time.Calendar.Day :> MandatoryQueryParam "earningType"
                                                                                                                                                                    Dashboard.Common.Driver.EarningType :> MandatoryQueryParam "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> Get ('[JSON])
                                                                                                                                                                                                                                                                                              EarningPeriodStatsRes)
type GetDriverEarningsHelper = ("earnings" :> MandatoryQueryParam "from" Data.Time.Calendar.Day :> MandatoryQueryParam "to" Data.Time.Calendar.Day :> MandatoryQueryParam "earningType"
                                                                                                                                                                          Dashboard.Common.Driver.EarningType :> MandatoryQueryParam "driverId"
                                                                                                                                                                                                                                     (Kernel.Types.Id.Id Dashboard.Common.Driver) :> MandatoryQueryParam "requestorId"
                                                                                                                                                                                                                                                                                                         Kernel.Prelude.Text :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                    EarningPeriodStatsRes)
type PostDriverTdsRateUpdate = ("tdsRate" :> "update" :> ReqBody ('[JSON]) UpdateTdsRateReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostDriverUpdateMerchant = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "updateMerchant" :> ReqBody ('[JSON]) UpdateDriverMerchantReq :> Post ('[JSON])
                                                                                                                                                                          Kernel.Types.APISuccess.APISuccess)
data DriverAPIs
    = DriverAPIs {getDriverDocumentsInfo :: (EulerHS.Types.EulerClient Dashboard.Common.Driver.DriverDocumentsInfoRes),
                  ...
                  postDriverVehicleUpsertSelectedServiceTiers :: ((Data.ByteString.Lazy.ByteString,
                                                                   Dashboard.Common.Driver.UpsertDriverServiceTiersCsvReq) -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess),
