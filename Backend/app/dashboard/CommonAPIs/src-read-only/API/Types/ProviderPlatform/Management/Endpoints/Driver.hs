...
type GetDriverSearchRequestStats =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "searchRequestStats" :> QueryParam "fromDate" Data.Time.Calendar.Day
      :> QueryParam
           "toDate"
           Data.Time.Calendar.Day
