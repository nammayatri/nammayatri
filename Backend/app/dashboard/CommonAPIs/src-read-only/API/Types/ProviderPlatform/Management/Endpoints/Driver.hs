...
data AadharPanSyncReq = AadharPanSyncReq
...
instance Kernel.Types.HideSecrets.HideSecrets AssociationChangeType where
  hideSecrets = Kernel.Prelude.identity
...
instance Kernel.Types.HideSecrets.HideSecrets ChangeAssociationReq where
  hideSecrets = Kernel.Prelude.identity
...
data DeleteRCReq = DeleteRCReq {rcNo :: Kernel.Prelude.Text, requestorId :: Kernel.Prelude.Maybe Kernel.Prelude.Text, requestorRole :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data DriverIdentityInfoRes = DriverIdentityInfoRes
  { driverId :: Kernel.Types.Id.Id Dashboard.Common.Driver,
...
instance Kernel.Types.HideSecrets.HideSecrets DriverIdentityInfoRes where
  hideSecrets = Kernel.Prelude.identity
...
data DriverSearchRequestDailyStats = DriverSearchRequestDailyStats {day :: Data.Time.Day, response :: Kernel.Prelude.Maybe SearchRequestForDriverResponse, count :: Kernel.Prelude.Int}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

data DriverSearchRequestStatsRes = DriverSearchRequestStatsRes {stats :: [DriverSearchRequestDailyStats]}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data DummyRideRequestRes = DummyRideRequestRes {result :: Kernel.Prelude.Text, reason :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

data EarningPeriodStats = EarningPeriodStats
  { periodStart :: Data.Time.Day,
    totalEarnings :: Kernel.Types.Common.Money,
    totalDistance :: Kernel.Types.Common.Meters,
    totalRides :: Kernel.Prelude.Int,
...
data ReviewRCVariantReq = ReviewRCVariantReq
  { rcId :: Kernel.Prelude.Text,
    ...
    markReviewed :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
    requestorId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    requestorRole :: Kernel.Prelude.Maybe Kernel.Prelude.Text
  }
  deriving stock (Generic)
...
data UpdateDriverIdentityInfoReq = UpdateDriverIdentityInfoReq
  { nomineeName :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    nomineeRelationship :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    nomineeDob :: Kernel.Prelude.Maybe Data.Time.Day,
    address :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
instance Kernel.Types.HideSecrets.HideSecrets UpdateDriverIdentityInfoReq where
  hideSecrets = Kernel.Prelude.identity
...
data UpdateRCInvalidStatusByRCNumberReq = UpdateRCInvalidStatusByRCNumberReq
...
data UpdateTdsRateReq = UpdateTdsRateReq {ownerType :: TdsOwnerType, ownerId :: Kernel.Types.Id.Id Dashboard.Common.Person, tdsRate :: Kernel.Prelude.Maybe Kernel.Prelude.Double}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

instance Kernel.Types.HideSecrets.HideSecrets UpdateTdsRateReq where
  hideSecrets = Kernel.Prelude.identity

data UpdateVehicleManufacturingReq = UpdateVehicleManufacturingReq {rcId :: Kernel.Prelude.Text, manufacturing :: Data.Time.Day}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
...
type PostDriverDisableHelper =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "disable" :> QueryParam "requestorId" Kernel.Prelude.Text
      :> QueryParam
           "requestorRole"
           Kernel.Prelude.Text
...
type DeleteDriverPermanentlyDeleteHelper =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "permanentlyDelete"
      :> QueryParam
           "requestorId"
           Kernel.Prelude.Text
...
type PostDriverUnlinkDLHelper =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "unlinkDL" :> QueryParam "requestorId" Kernel.Prelude.Text
      :> QueryParam
           "requestorRole"
           Kernel.Prelude.Text
      :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
...
type PostDriverUnlinkAadhaarHelper =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "unlinkAadhaar" :> QueryParam "requestorId" Kernel.Prelude.Text
      :> QueryParam
           "requestorRole"
           Kernel.Prelude.Text
      :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
...
type PostDriverClearFeeHelper =
  ( "clearFee" :> QueryParam "requestorId" Kernel.Prelude.Text :> MandatoryQueryParam "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver)
      :> ReqBody
           '[JSON]
           ClearDriverFeeReq
      :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
...
type PostDriverRefundByPayoutHelper =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "refundByPayout" :> QueryParam "requestorId" Kernel.Prelude.Text
      :> ReqBody
           '[JSON]
           RefundByPayoutReq
      :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
...
type GetDriverStatsHelper =
  ( "stats" :> QueryParam "entityId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> QueryParam "fromDate" Data.Time.Day
      :> QueryParam
           "toDate"
           Data.Time.Day
...
type GetDriverEarnings =
  ( "earnings" :> MandatoryQueryParam "from" Data.Time.Day :> MandatoryQueryParam "to" Data.Time.Day
      :> MandatoryQueryParam
           "earningType"
           Dashboard.Common.Driver.EarningType
      :> MandatoryQueryParam "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver)
      :> Get '[JSON] EarningPeriodStatsRes
  )
...
type GetDriverIdentityInfo = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "identityInfo" :> Get '[JSON] DriverIdentityInfoRes)

type GetDriverIdentityInfoHelper =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "identityInfo" :> Capture "requestorId" Kernel.Prelude.Text
      :> Get
           '[JSON]
           DriverIdentityInfoRes
  )

type PostDriverIdentityInfoUpdate =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "identityInfo" :> "update" :> ReqBody '[JSON] UpdateDriverIdentityInfoReq
      :> Post
           '[JSON]
           Kernel.Types.APISuccess.APISuccess
  )

type PostDriverIdentityInfoUpdateHelper =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "identityInfo" :> "update"
      :> Capture
           "requestorId"
           Kernel.Prelude.Text
      :> ReqBody '[JSON] UpdateDriverIdentityInfoReq
      :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
  )

type PostDriverAssociationChange = (Capture "subjectId" Kernel.Prelude.Text :> "association" :> "change" :> ReqBody '[JSON] ChangeAssociationReq :> Post '[JSON] Kernel.Types.APISuccess.APISuccess)

type PostDriverAssociationChangeHelper =
  ( Capture "requestorId" Kernel.Prelude.Text :> Capture "subjectId" Kernel.Prelude.Text :> "association" :> "change"
      :> ReqBody
           '[JSON]
           ChangeAssociationReq
      :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
  )
...
data DriverAPIs = DriverAPIs
  { getDriverDocumentsInfo :: EulerHS.Types.EulerClient Dashboard.Common.Driver.DriverDocumentsInfoRes,
    ...
    postDriverDisable :: Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
    ...
    deleteDriverPermanentlyDelete :: Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
    postDriverUnlinkDL :: Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
    postDriverUnlinkAadhaar :: Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
...
data DriverUserActionType
  ...
  | GET_DRIVER_AIRPORT_PREFERENCE
  | POST_DRIVER_AIRPORT_PREFERENCE
  | GET_DRIVER_SEARCH_REQUEST_STATS
  | GET_DRIVER_IDENTITY_INFO
  | POST_DRIVER_IDENTITY_INFO_UPDATE
  | POST_DRIVER_ASSOCIATION_CHANGE
