...
data AllowedTripDistanceBoundsAPIEntity
    = AllowedTripDistanceBoundsAPIEntity {maxAllowedTripDistance :: Kernel.Types.Common.Meters,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BatchSplitByPickupDistance
    = BatchSplitByPickupDistance {batchSplitSize :: Kernel.Prelude.Int, batchSplitDelay :: Kernel.Types.Common.Seconds}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BatchSplitByPickupDistanceOnRide
    = BatchSplitByPickupDistanceOnRide {batchSplitSize :: Kernel.Prelude.Int, batchSplitDelay :: Kernel.Types.Common.Seconds}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ClearCacheSubscriptionReq
    = ClearCacheSubscriptionReq {serviceName :: Kernel.Prelude.Maybe Dashboard.Common.Merchant.ServiceNames,
                                 planId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                                 tableName :: Kernel.Prelude.Maybe TableName}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets ClearCacheSubscriptionReq
...
data CongestionChargeMultiplierAPIEntity
    = BaseFareAndExtraDistanceFare Kernel.Types.Common.Centesimal | ExtraDistanceFare Kernel.Types.Common.Centesimal
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CreateFPDriverExtraFeeReq
    = CreateFPDriverExtraFeeReq {minFee :: Kernel.Types.Common.Money,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets CreateFPDriverExtraFeeReq
    where hideSecrets = Kernel.Prelude.identity
...
data DocumentVerificationConfigCreateReq
    = DocumentVerificationConfigCreateReq {checkExtraction :: Kernel.Prelude.Bool,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets DocumentVerificationConfigCreateReq
    where hideSecrets = Kernel.Prelude.identity
data DocumentVerificationConfigItem
    = DocumentVerificationConfigItem {documentType :: DocumentType,
...
data DocumentVerificationConfigUpdateReq
    = DocumentVerificationConfigUpdateReq {checkExtraction :: Kernel.Prelude.Maybe (Kernel.Types.Value.MandatoryValue Kernel.Prelude.Bool),
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets DocumentVerificationConfigUpdateReq
    where hideSecrets = Kernel.Prelude.identity
data DriverIntelligentPoolConfigRes
    = DriverIntelligentPoolConfigRes {availabilityTimeWeightage :: Kernel.Prelude.Int,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverIntelligentPoolConfigUpdateReq
    = DriverIntelligentPoolConfigUpdateReq {availabilityTimeWeightage :: Kernel.Prelude.Maybe (Kernel.Types.Value.MandatoryValue Kernel.Prelude.Int),
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets DriverIntelligentPoolConfigUpdateReq
    where hideSecrets = Kernel.Prelude.identity
data DriverPoolConfigCreateReq
    = DriverPoolConfigCreateReq {minRadiusOfSearch :: Kernel.Types.Common.Meters,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets DriverPoolConfigCreateReq
    where hideSecrets = Kernel.Prelude.identity
data DriverPoolConfigItem
    = DriverPoolConfigItem {minRadiusOfSearch :: Kernel.Types.Common.Meters,
                            maxRadiusOfSearch :: Kernel.Types.Common.Meters,
                            radiusStepSize :: Kernel.Types.Common.Meters,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverPoolConfigListItem
    = DriverPoolConfigListItem {minRadiusOfSearch :: Kernel.Types.Common.Meters,
                                maxRadiusOfSearch :: Kernel.Types.Common.Meters,
                                radiusStepSize :: Kernel.Types.Common.Meters,
                                driverPositionInfoExpiry :: Kernel.Prelude.Maybe Kernel.Types.Common.Seconds,
                                actualDistanceThreshold :: Kernel.Prelude.Maybe Kernel.Types.Common.Meters,
                                ...
                                driverToDestinationDuration :: Kernel.Types.Common.Seconds,
                                distanceBasedBatchSplit :: [BatchSplitByPickupDistance],
                                vehicleVariant :: Kernel.Prelude.Maybe Dashboard.Common.ServiceTierType,
                                ...
                                actualDistanceThresholdOnRide :: Kernel.Prelude.Maybe Kernel.Types.Common.Meters,
                                onRideRadiusConfig :: [OnRideRadiusConfig],
                                timeBounds :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
type DriverPoolConfigListRes = [DriverPoolConfigListItem]
type DriverPoolConfigRes = [DriverPoolConfigItem]
data DriverPoolConfigUpdateReq
    = DriverPoolConfigUpdateReq {minRadiusOfSearch :: Kernel.Prelude.Maybe (Kernel.Types.Value.MandatoryValue Kernel.Types.Common.Meters),
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets DriverPoolConfigUpdateReq
    where hideSecrets = Kernel.Prelude.identity
data GeometryAPIEntity
    = GeometryAPIEntity {region :: Kernel.Prelude.Text, state :: Kernel.Types.Beckn.Context.IndianState, city :: Kernel.Types.Beckn.Context.City, geom :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data JobName
    ...
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MerchantCommonConfigRes
    = MerchantCommonConfigRes {pickupLocThreshold :: Kernel.Types.Common.Meters,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MerchantCommonConfigUpdateReq
    = MerchantCommonConfigUpdateReq {pickupLocThreshold :: Kernel.Prelude.Maybe (Kernel.Types.Value.MandatoryValue Kernel.Types.Common.Meters),
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets MerchantCommonConfigUpdateReq
    where hideSecrets = Kernel.Prelude.identity
data MerchantUpdateReq
    = MerchantUpdateReq {name :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MerchantUpdateRes
    = MerchantUpdateRes {name :: Kernel.Prelude.Text,
                         description :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data NightShiftBounds
    = NightShiftBounds {nightShiftStart :: Kernel.Prelude.TimeOfDay, nightShiftEnd :: Kernel.Prelude.TimeOfDay}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data NightShiftChargeAPIEntity
    = ProgressiveNightShiftCharge Kernel.Prelude.Float | ConstantNightShiftCharge Kernel.Types.Common.Money | ConstantNightShiftChargeWithCurrency Kernel.Types.Common.PriceAPIEntity
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data OnRideRadiusConfig
    = OnRideRadiusConfig {onRideRadius :: Kernel.Types.Common.Meters, onRideRadiusWithUnit :: Kernel.Prelude.Maybe Kernel.Types.Common.Distance, batchNumber :: Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PayoutConfigReq
    = PayoutConfigReq {toEnable :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets PayoutConfigReq
    where hideSecrets = Kernel.Prelude.identity
data PoolSortingType
    = Intelligent | Random | Tagged
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SchedulerTriggerReq
    = SchedulerTriggerReq {scheduledAt :: Kernel.Prelude.Maybe Kernel.Prelude.UTCTime, jobName :: Kernel.Prelude.Maybe JobName, jobData :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets SchedulerTriggerReq
    where hideSecrets = Kernel.Prelude.identity
...
data Status
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TableName
    = SUBSCRIPTION_CONFIG | PLAN | PLAN_TRANSLATION
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data UpdateFPPerExtraKmRateReq
    = UpdateFPPerExtraKmRateReq {perExtraKmRate :: Kernel.Types.Common.HighPrecMoney, perExtraKmRateWithCurrency :: Kernel.Prelude.Maybe Kernel.Types.Common.PriceAPIEntity}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdateFPPerExtraKmRateReq
    where hideSecrets = Kernel.Prelude.identity
data UpdateFarePolicyReq
    = UpdateFarePolicyReq {serviceCharge :: Kernel.Prelude.Maybe Kernel.Types.Common.Money,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdateFarePolicyReq
    where hideSecrets = Kernel.Prelude.identity
data UpdateOnboardingVehicleVariantMappingReq
    = UpdateOnboardingVehicleVariantMappingReq {file :: Kernel.Prelude.FilePath, vehicleCategory :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpdateOnboardingVehicleVariantMappingReq
    where hideSecrets = Kernel.Prelude.identity
newtype UpsertFarePolicyReq
  = UpsertFarePolicyReq {file :: Kernel.Prelude.FilePath}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpsertFarePolicyReq
    where hideSecrets = Kernel.Prelude.identity
data UpsertFarePolicyResp
    = UpsertFarePolicyResp {unprocessedFarePolicies :: [Kernel.Prelude.Text], success :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data UpsertPlanAndConfigReq
    = UpsertPlanAndConfigReq {action :: Action, command :: Command, config :: Data.Aeson.Value, tableName :: TableName}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets UpsertPlanAndConfigReq
    where hideSecrets = Kernel.Prelude.identity
data UpsertPlanAndConfigResp
    = UpsertPlanAndConfigResp {respCode :: Kernel.Types.APISuccess.APISuccess,
...
data VehicleClassCheckType
    ...
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VehicleServiceTierConfigCreateReq
    = VehicleServiceTierConfigCreateReq {serviceTierType :: Dashboard.Common.ServiceTierType,
                                         ...
                                         vehicleIconUrl :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets VehicleServiceTierConfigCreateReq
    where hideSecrets = Kernel.Prelude.identity
data VehicleServiceTierConfigUpdateReq
    = VehicleServiceTierConfigUpdateReq {name :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets VehicleServiceTierConfigUpdateReq
    where hideSecrets = Kernel.Prelude.identity
data VehicleServiceTierItem
    = VehicleServiceTierItem {serviceTierType :: Dashboard.Common.ServiceTierType,
                              name :: Kernel.Prelude.Text,
                              shortDescription :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                              longDescription :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                              seatingCapacity :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
type VehicleServiceTierListRes = [VehicleServiceTierItem]
...
type GetMerchantConfigDriverPool = ("config" :> "driverPool" :> QueryParam "tripDistance" Kernel.Types.Common.Meters :> QueryParam "tripDistanceValue"
                                                                                                                                   Kernel.Types.Common.HighPrecDistance :> QueryParam "distanceUnit" Kernel.Types.Common.DistanceUnit :> Get ('[JSON]) DriverPoolConfigRes)
type PostMerchantConfigDriverPoolUpdate = ("config" :> "driverPool" :> "update" :> QueryParam "tripDistanceValue" Kernel.Types.Common.HighPrecDistance :> QueryParam "distanceUnit"
                                                                                                                                                                     Kernel.Types.Common.DistanceUnit :> QueryParam "vehicleVariant" Dashboard.Common.VehicleVariant :> QueryParam "tripCategory"
                                                                                                                                                                                                                                                                                   Kernel.Prelude.Text :> MandatoryQueryParam "tripDistance"
                                                                                                                                                                                                                                                                                                                              Kernel.Types.Common.Meters :> MandatoryQueryParam "area"
                                                                                                                                                                                                                                                                                                                                                                                Lib.Types.SpecialLocation.Area :> ReqBody ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                          DriverPoolConfigUpdateReq :> Post ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                            Kernel.Types.APISuccess.APISuccess)
type PostMerchantConfigDriverPoolCreate = ("config" :> "driverPool" :> "create" :> QueryParam "tripDistanceValue" Kernel.Types.Common.HighPrecDistance :> QueryParam "distanceUnit"
                                                                                                                                                                     Kernel.Types.Common.DistanceUnit :> QueryParam "vehiclevariant" Dashboard.Common.VehicleVariant :> QueryParam "tripCategory"
                                                                                                                                                                                                                                                                                   Kernel.Prelude.Text :> MandatoryQueryParam "tripDistance"
                                                                                                                                                                                                                                                                                                                              Kernel.Types.Common.Meters :> MandatoryQueryParam "area"
                                                                                                                                                                                                                                                                                                                                                                                Lib.Types.SpecialLocation.Area :> ReqBody ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                          DriverPoolConfigCreateReq :> Post ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                            Kernel.Types.APISuccess.APISuccess)
type PostMerchantConfigDriverPoolUpsert = ("config" :> "driverPool" :> "upsert" :> Kernel.ServantMultipart.MultipartForm Kernel.ServantMultipart.Tmp
                                                                                                                         Dashboard.Common.Merchant.UpsertDriverPoolConfigCsvReq :> Post ('[JSON]) Dashboard.Common.Merchant.APISuccessWithUnprocessedEntities)
...
type PostMerchantConfigDriverIntelligentPoolUpdate = ("config" :> "driverIntelligentPool" :> "update" :> ReqBody ('[JSON]) DriverIntelligentPoolConfigUpdateReq :> Post ('[JSON])
                                                                                                                                                                        Kernel.Types.APISuccess.APISuccess)
type GetMerchantConfigOnboardingDocument = ("config" :> "onboardingDocument" :> QueryParam "documentType" DocumentType :> QueryParam "vehicleCategory" Dashboard.Common.VehicleCategory :> Get ('[JSON])
                                                                                                                                                                                               DocumentVerificationConfigRes)
type PostMerchantConfigOnboardingDocumentUpdate = ("config" :> "onboardingDocument" :> "update" :> MandatoryQueryParam "documentType" DocumentType :> MandatoryQueryParam "category"
                                                                                                                                                                          Dashboard.Common.VehicleCategory :> ReqBody ('[JSON]) DocumentVerificationConfigUpdateReq :> Post ('[JSON])
                                                                                                                                                                                                                                                                            Kernel.Types.APISuccess.APISuccess)
type PostMerchantConfigOnboardingDocumentCreate = ("config" :> "onboardingDocument" :> "create" :> MandatoryQueryParam "documentType" DocumentType :> MandatoryQueryParam "category"
                                                                                                                                                                          Dashboard.Common.VehicleCategory :> ReqBody ('[JSON]) DocumentVerificationConfigCreateReq :> Post ('[JSON])
                                                                                                                                                                                                                                                                            Kernel.Types.APISuccess.APISuccess)
type GetMerchantServiceUsageConfig = ("serviceUsageConfig" :> Get ('[JSON]) Dashboard.Common.Merchant.ServiceUsageConfigRes)
type PostMerchantServiceConfigMapsUpdate = ("serviceConfig" :> "maps" :> "update" :> ReqBody ('[JSON]) Dashboard.Common.Merchant.MapsServiceConfigUpdateReq :> Post ('[JSON])
                                                                                                                                                                    Kernel.Types.APISuccess.APISuccess)
type PostMerchantServiceUsageConfigMapsUpdate = ("serviceUsageConfig" :> "maps" :> "update" :> ReqBody ('[JSON]) Dashboard.Common.Merchant.MapsServiceUsageConfigUpdateReq :> Post ('[JSON])
                                                                                                                                                                                   Kernel.Types.APISuccess.APISuccess)
type PostMerchantServiceConfigSmsUpdate = ("serviceConfig" :> "sms" :> "update" :> ReqBody ('[JSON]) Dashboard.Common.Merchant.SmsServiceConfigUpdateReq :> Post ('[JSON])
                                                                                                                                                                 Kernel.Types.APISuccess.APISuccess)
type PostMerchantServiceUsageConfigSmsUpdate = ("serviceUsageConfig" :> "sms" :> "update" :> ReqBody ('[JSON]) Dashboard.Common.Merchant.SmsServiceUsageConfigUpdateReq :> Post ('[JSON])
                                                                                                                                                                                Kernel.Types.APISuccess.APISuccess)
type PostMerchantServiceConfigVerificationUpdate = ("serviceConfig" :> "verification" :> "update" :> ReqBody ('[JSON]) Dashboard.Common.Merchant.VerificationServiceConfigUpdateReq :> Post ('[JSON])
                                                                                                                                                                                            Kernel.Types.APISuccess.APISuccess)
type PostMerchantConfigFarePolicyDriverExtraFeeBoundsCreate = ("config" :> "farePolicy" :> Capture "farePolicyId"
                                                                                                   (Kernel.Types.Id.Id Dashboard.Common.FarePolicy) :> "driverExtraFeeBounds" :> "create" :> QueryParam "startDistanceValue" Kernel.Types.Common.HighPrecDistance :> QueryParam "distanceUnit"
                                                                                                                                                                                                                                                                                Kernel.Types.Common.DistanceUnit :> MandatoryQueryParam "startDistance"
                                                                                                                                                                                                                                                                                                                                        Kernel.Types.Common.Meters :> ReqBody ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                              CreateFPDriverExtraFeeReq :> Post ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                Kernel.Types.APISuccess.APISuccess)
type PostMerchantConfigFarePolicyDriverExtraFeeBoundsUpdate = ("config" :> "farePolicy" :> Capture "farePolicyId"
                                                                                                   (Kernel.Types.Id.Id Dashboard.Common.FarePolicy) :> "driverExtraFeeBounds" :> "update" :> QueryParam "startDistanceValue" Kernel.Types.Common.HighPrecDistance :> QueryParam "distanceUnit"
                                                                                                                                                                                                                                                                                Kernel.Types.Common.DistanceUnit :> MandatoryQueryParam "startDistance"
                                                                                                                                                                                                                                                                                                                                        Kernel.Types.Common.Meters :> ReqBody ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                              CreateFPDriverExtraFeeReq :> Post ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                Kernel.Types.APISuccess.APISuccess)
type PostMerchantConfigFarePolicyPerExtraKmRateUpdate = ("config" :> "farePolicy" :> Capture "farePolicyId" (Kernel.Types.Id.Id Dashboard.Common.FarePolicy) :> Capture "startDistance"
                                                                                                                                                                        Kernel.Types.Common.Meters :> "perExtraKmRate" :> "update" :> ReqBody ('[JSON]) UpdateFPPerExtraKmRateReq :> Post ('[JSON])
                                                                                                                                                                                                                                                                                          Kernel.Types.APISuccess.APISuccess)
type PostMerchantConfigFarePolicyUpdate = ("config" :> "farePolicy" :> Capture "farePolicyId" (Kernel.Types.Id.Id Dashboard.Common.FarePolicy) :> "update" :> ReqBody ('[JSON])
                                                                                                                                                                      UpdateFarePolicyReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostMerchantConfigFarePolicyUpsert = ("config" :> "farePolicy" :> "upsert" :> Kernel.ServantMultipart.MultipartForm Kernel.ServantMultipart.Tmp UpsertFarePolicyReq :> Post ('[JSON])
                                                                                                                                                                                 UpsertFarePolicyResp)
type GetMerchantConfigFarePolicyExport = ("config" :> "farePolicy" :> "export" :> Get ('[JSON]) Kernel.Prelude.Text)
type PostMerchantConfigOperatingCityCreate = ("config" :> "operatingCity" :> "create" :> Kernel.ServantMultipart.MultipartForm Kernel.ServantMultipart.Tmp
                                                                                                                               Dashboard.Common.Merchant.CreateMerchantOperatingCityReq :> Post ('[JSON]) Dashboard.Common.Merchant.CreateMerchantOperatingCityRes)
type PostMerchantConfigOperatingCityCreateHelper = ("config" :> "operatingCity" :> "create" :> ReqBody ('[JSON]) Dashboard.Common.Merchant.CreateMerchantOperatingCityReqT :> Post ('[JSON])
...
type PostMerchantUpdateOnboardingVehicleVariantMapping = ("updateOnboardingVehicleVariantMapping" :> Kernel.ServantMultipart.MultipartForm Kernel.ServantMultipart.Tmp
                                                                                                                                           UpdateOnboardingVehicleVariantMappingReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostMerchantConfigSpecialLocationUpsert = ("config" :> "specialLocation" :> "upsert" :> Kernel.ServantMultipart.MultipartForm Kernel.ServantMultipart.Tmp
                                                                                                                                   Dashboard.Common.Merchant.UpsertSpecialLocationCsvReq :> Post ('[JSON]) Dashboard.Common.Merchant.APISuccessWithUnprocessedEntities)
type GetMerchantConfigSpecialLocationList = ("config" :> "specialLocation" :> "list" :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> QueryParam "locationType"
                                                                                                                                                                                      Lib.Types.SpecialLocation.SpecialLocationType :> Get ('[JSON]) SpecialLocationResp)
...
type PutMerchantConfigGeometryUpdate = ("config" :> "geometry" :> "update" :> Kernel.ServantMultipart.MultipartForm Kernel.ServantMultipart.Tmp
                                                                                                                    Dashboard.Common.Merchant.UpdateGeometryReq :> Put ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostMerchantSpecialLocationUpsert = ("specialLocation" :> "upsert" :> QueryParam "specialLocationId"
                                                                                      (Kernel.Types.Id.Id Lib.Types.SpecialLocation.SpecialLocation) :> Kernel.ServantMultipart.MultipartForm Kernel.ServantMultipart.Tmp Dashboard.Common.Merchant.UpsertSpecialLocationReq :> Post ('[JSON])
                                                                                                                                                                                                                                                                                     Kernel.Types.APISuccess.APISuccess)
type PostMerchantSpecialLocationUpsertHelper = ("specialLocation" :> "upsert" :> QueryParam "specialLocationId" (Kernel.Types.Id.Id Lib.Types.SpecialLocation.SpecialLocation) :> ReqBody ('[JSON])
                                                                                                                                                                                          Dashboard.Common.Merchant.UpsertSpecialLocationReqT :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type DeleteMerchantSpecialLocationDelete = ("specialLocation" :> Capture "specialLocationId" (Kernel.Types.Id.Id Lib.Types.SpecialLocation.SpecialLocation) :> "delete" :> Delete ('[JSON])
                                                                                                                                                                                  Kernel.Types.APISuccess.APISuccess)
type PostMerchantSpecialLocationGatesUpsert = ("specialLocation" :> Capture "specialLocationId"
                                                                            (Kernel.Types.Id.Id Lib.Types.SpecialLocation.SpecialLocation) :> "gates" :> "upsert" :> Kernel.ServantMultipart.MultipartForm Kernel.ServantMultipart.Tmp
                                                                                                                                                                                                           Dashboard.Common.Merchant.UpsertSpecialLocationGateReq :> Post ('[JSON])
                                                                                                                                                                                                                                                                          Kernel.Types.APISuccess.APISuccess)
type PostMerchantSpecialLocationGatesUpsertHelper = ("specialLocation" :> Capture "specialLocationId"
                                                                                  (Kernel.Types.Id.Id Lib.Types.SpecialLocation.SpecialLocation) :> "gates" :> "upsert" :> ReqBody ('[JSON]) Dashboard.Common.Merchant.UpsertSpecialLocationGateReqT :> Post ('[JSON])
                                                                                                                                                                                                                                                             Kernel.Types.APISuccess.APISuccess)
type DeleteMerchantSpecialLocationGatesDelete = ("specialLocation" :> Capture "specialLocationId"
                                                                              (Kernel.Types.Id.Id Lib.Types.SpecialLocation.SpecialLocation) :> "gates" :> "delete" :> Capture "gateName" Kernel.Prelude.Text :> Delete ('[JSON]) Kernel.Types.APISuccess.APISuccess)
...
type PostMerchantConfigFailover = ("config" :> Capture "configName" Dashboard.Common.Merchant.ConfigNames :> "failover" :> ReqBody ('[JSON])
                                                                                                                                   Dashboard.Common.Merchant.ConfigFailoverReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
...
type PostMerchantConfigOperatingCityWhiteList = ("config" :> "operatingCity" :> "whiteList" :> ReqBody ('[JSON]) Dashboard.Common.Merchant.WhiteListOperatingCityReq :> Post ('[JSON])
                                                                                                                                                                             Dashboard.Common.Merchant.WhiteListOperatingCityRes)
type PostMerchantConfigMerchantCreate = ("config" :> "merchant" :> "create" :> Kernel.ServantMultipart.MultipartForm Kernel.ServantMultipart.Tmp
                                                                                                                     Dashboard.Common.Merchant.CreateMerchantOperatingCityReq :> Post ('[JSON]) Dashboard.Common.Merchant.CreateMerchantOperatingCityRes)
type PostMerchantConfigMerchantCreateHelper = ("config" :> "merchant" :> "create" :> ReqBody ('[JSON]) Dashboard.Common.Merchant.CreateMerchantOperatingCityReqT :> Post ('[JSON])
                                                                                                                                                                         Dashboard.Common.Merchant.CreateMerchantOperatingCityRes)
...
type PostMerchantConfigVehicleServiceTierUpdate = ("config" :> "vehicleServiceTier" :> "update" :> MandatoryQueryParam "serviceTierType" Dashboard.Common.ServiceTierType :> ReqBody ('[JSON])
                                                                                                                                                                                     VehicleServiceTierConfigUpdateReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostMerchantConfigVehicleServiceTierCreate = ("config" :> "vehicleServiceTier" :> "create" :> ReqBody ('[JSON]) VehicleServiceTierConfigCreateReq :> Post ('[JSON])
                                                                                                                                                               Kernel.Types.APISuccess.APISuccess)
type PostMerchantConfigDebugLogUpdate = ("config" :> "debugLog" :> "update" :> ReqBody ('[JSON]) Lib.Yudhishthira.Tools.DebugLog.SetJsonLogicDebugReq :> Post ('[JSON])
                                                                                                                                                              Kernel.Types.APISuccess.APISuccess)
data MerchantAPIs
    = MerchantAPIs {postMerchantUpdate :: (MerchantUpdateReq -> EulerHS.Types.EulerClient MerchantUpdateRes),
                    ...
                    postMerchantConfigDriverPoolUpsert :: ((Data.ByteString.Lazy.ByteString,
                                                            Dashboard.Common.Merchant.UpsertDriverPoolConfigCsvReq) -> EulerHS.Types.EulerClient Dashboard.Common.Merchant.APISuccessWithUnprocessedEntities),
                    ...
                    postMerchantConfigSpecialLocationUpsert :: ((Data.ByteString.Lazy.ByteString,
                                                                 Dashboard.Common.Merchant.UpsertSpecialLocationCsvReq) -> EulerHS.Types.EulerClient Dashboard.Common.Merchant.APISuccessWithUnprocessedEntities),
...
data MerchantUserActionType
    ...
    | POST_MERCHANT_CONFIG_DRIVER_POOL_UPSERT
    | GET_MERCHANT_CONFIG_DRIVER_POOL_LIST
    ...
    | GET_MERCHANT_CONFIG_VEHICLE_SERVICE_TIER_LIST
    | POST_MERCHANT_CONFIG_VEHICLE_SERVICE_TIER_UPDATE
    | POST_MERCHANT_CONFIG_VEHICLE_SERVICE_TIER_CREATE
