...
data CityListResp = CityListResp {supportedCities :: [Kernel.Types.Beckn.Context.City]}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data CreateMerchantDocumentReq = CreateMerchantDocumentReq
  { documentType :: Kernel.Prelude.Text,
    role :: MerchantDocumentRoleT,
    ...
    platformType :: Kernel.Prelude.Maybe MerchantDocumentPlatformTypeT
  }
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

instance Kernel.Types.HideSecrets.HideSecrets CreateMerchantDocumentReq where
  hideSecrets = Kernel.Prelude.identity

data DeleteMerchantDocumentReq = DeleteMerchantDocumentReq {id :: Kernel.Prelude.Text}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

instance Kernel.Types.HideSecrets.HideSecrets DeleteMerchantDocumentReq where
  hideSecrets = Kernel.Prelude.identity

data DeleteMerchantMessageReq = DeleteMerchantMessageReq {messageKey :: Kernel.Prelude.Text, vehicleCategory :: Kernel.Prelude.Maybe Dashboard.Common.VehicleCategory}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

instance Kernel.Types.HideSecrets.HideSecrets DeleteMerchantMessageReq where
  hideSecrets = Kernel.Prelude.identity
...
data FarePolicyDetailsResp = FarePolicyDetailsResp
  { id :: Kernel.Types.Id.Id Dashboard.Common.FarePolicy,
    ...
    farePolicyType :: Kernel.Prelude.Text,
...
data FareProductListRes = FareProductListRes {fareProducts :: [FareProductListItem]}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data MerchantDocumentItem = MerchantDocumentItem
...
data MerchantDocumentListResp = MerchantDocumentListResp {documents :: [MerchantDocumentItem]}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

data MerchantDocumentPlatformTypeT
  = WEB
  | ANDROID
  | IOS
  deriving stock (Eq, Show, Generic)
...
data MerchantMessageCatalogResp = MerchantMessageCatalogResp {values :: [Kernel.Prelude.Text]}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

data MerchantMessageCatalogType
  = KEY
  | CHANNEL
  | DOMAIN
  deriving stock (Eq, Show, Generic)
...
data UpdateMerchantDocumentReq = UpdateMerchantDocumentReq {id :: Kernel.Prelude.Text, url :: Kernel.Prelude.Text, title :: Kernel.Prelude.Text}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

instance Kernel.Types.HideSecrets.HideSecrets UpdateMerchantDocumentReq where
  hideSecrets = Kernel.Prelude.identity
...
data UpsertMerchantMessageReq = UpsertMerchantMessageReq
  { messageKey :: Kernel.Prelude.Text,
    ...
    channel :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    domain :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
instance Kernel.Types.HideSecrets.HideSecrets UpsertMerchantMessageReq where
  hideSecrets = Kernel.Prelude.identity
...
data VehicleServiceTierConfigCreateReq = VehicleServiceTierConfigCreateReq
  { serviceTierType :: Dashboard.Common.ServiceTierType,
    ...
    specialZoneQueueCalloutVariants :: [Dashboard.Common.VehicleVariant],
...
instance Kernel.Types.HideSecrets.HideSecrets VehicleServiceTierConfigCreateReq where
  hideSecrets = Kernel.Prelude.identity
...
data VehicleServiceTierConfigUpdateReq = VehicleServiceTierConfigUpdateReq
  { name :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    specialZoneQueueCalloutVariants :: Kernel.Prelude.Maybe [Dashboard.Common.VehicleVariant],
...
type GetMerchantMerchantDocument =
  ( "merchantDocument" :> Capture "documentType" Kernel.Prelude.Text :> QueryParam "language" Kernel.External.Types.Language
      :> MandatoryQueryParam
           "role"
...
type PostMerchantMerchantMessageDelete = ("merchantMessage" :> "delete" :> ReqBody ('[JSON]) DeleteMerchantMessageReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
...
data MerchantAPIs = MerchantAPIs
  { postMerchantUpdate :: MerchantUpdateReq -> EulerHS.Types.EulerClient MerchantUpdateRes,
    ...
    postMerchantMerchantMessageDelete :: (DeleteMerchantMessageReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess),
...
data MerchantUserActionType
  ...
  | GET_MERCHANT_CONFIG_FARE_POLICY_DETAILS
  | GET_MERCHANT_CONFIG_FARE_PRODUCT_LIST
  | POST_MERCHANT_CONFIG_FARE_PRODUCT_SET_ENABLED
  ...
  | GET_MERCHANT_MERCHANT_DOCUMENT_LIST
  | GET_MERCHANT_MERCHANT_DOCUMENT
  | POST_MERCHANT_MERCHANT_DOCUMENT_CREATE
  | POST_MERCHANT_MERCHANT_DOCUMENT_UPDATE
  | POST_MERCHANT_MERCHANT_DOCUMENT_DELETE
  | GET_MERCHANT_MERCHANT_MESSAGE_CATALOG
  | POST_MERCHANT_MERCHANT_MESSAGE_UPSERT
  | POST_MERCHANT_MERCHANT_MESSAGE_DELETE
  | GET_MERCHANT_CITY_LIST
