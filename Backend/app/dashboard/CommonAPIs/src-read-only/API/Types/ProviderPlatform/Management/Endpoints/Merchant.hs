...
type PostMerchantUpdateVehicleServiceTier =
  ( "updateVehicleServiceTier" :> Kernel.ServantMultipart.MultipartForm Kernel.ServantMultipart.Tmp UpdateVehicleServiceTierReq
      :> Post
           '[JSON]
           Kernel.Types.APISuccess.APISuccess
  )
...
data MerchantAPIs = MerchantAPIs
  { postMerchantUpdate :: MerchantUpdateReq -> EulerHS.Types.EulerClient MerchantUpdateRes,
    ...
    postMerchantUpdateVehicleServiceTier :: (Data.ByteString.Lazy.ByteString, UpdateVehicleServiceTierReq) -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
...
data MerchantUserActionType
  ...
  | POST_MERCHANT_UPDATE_VEHICLE_SERVICE_TIER
