...
type GetFinanceManagementFinanceInvoicePdf =
  ( "finance" :> "invoice" :> "pdf" :> QueryParam "from" Lib.Finance.Invoice.PdfService.DateOrTime
      :> QueryParam
           "invoiceId"
           Kernel.Prelude.Text
      :> QueryParam "invoiceSource" InvoiceSource
      :> QueryParam
           "invoiceType"
...
$(mkHttpInstancesForEnum ''InvoiceSource)
