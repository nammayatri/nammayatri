...
data EarningsSummaryRes
    = EarningsSummaryRes {totalRideEarnings :: Kernel.Types.Common.HighPrecMoney,
...
data FleetOperatorListItem
    = FleetOperatorListItem {fleetOperatorId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FleetOperatorListRes
    = FleetOperatorListRes {totalItems :: Kernel.Prelude.Int, summary :: Dashboard.Common.Summary, fleetOperators :: [FleetOperatorListItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data InvoiceListItem
    = InvoiceListItem {invoiceId :: Kernel.Prelude.Text,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data InvoiceListRes
    = InvoiceListRes {totalItems :: Kernel.Prelude.Int, summary :: Dashboard.Common.Summary, invoices :: [InvoiceListItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LinkedRideItem
    = LinkedRideItem {rideId :: Kernel.Prelude.Text, bookingId :: Kernel.Prelude.Text, rideCreatedAt :: Kernel.Prelude.UTCTime, rideSubscriptionDebitAmount :: Kernel.Types.Common.HighPrecMoney}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data PaymentSettlementListItem
    = PaymentSettlementListItem {subscriptionPurchaseId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PaymentSettlementListRes
    = PaymentSettlementListRes {totalItems :: Kernel.Prelude.Int, summary :: Dashboard.Common.Summary, settlements :: [PaymentSettlementListItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PaymentStatusFilter
    ...
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data PaymentTransactionReportItem
    = PaymentTransactionReportItem {gatewayTransactionId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PaymentTransactionReportListRes
    = PaymentTransactionReportListRes {totalItems :: Kernel.Prelude.Int, summary :: Dashboard.Common.Summary, transactions :: [PaymentTransactionReportItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PayoutListItem
    = PayoutListItem {payoutReference :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                      payoutAmount :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PayoutListRes
    = PayoutListRes {totalItems :: Kernel.Prelude.Int, payouts :: [PayoutListItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PgGateway
    = Juspay | BillDesk
...
data ReconciliationEntry
    = ReconciliationEntry {bookingId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ReconciliationRes
    = ReconciliationRes {summary :: ReconciliationSummary, exceptions :: [ReconciliationEntry], completed :: [ReconciliationEntry]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ReconciliationSummary
    = ReconciliationSummary {totalDiscrepancies :: Kernel.Prelude.Int,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ReconciliationTriggerReq
    = ReconciliationTriggerReq {fromDate :: Kernel.Prelude.UTCTime, toDate :: Kernel.Prelude.UTCTime, reconciliationType :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ReconciliationTriggerRes
    = ReconciliationTriggerRes {success :: Kernel.Prelude.Bool, message :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SubscriptionPurchaseListItem
    = SubscriptionPurchaseListItem {subscriptionPurchaseId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SubscriptionPurchaseListRes
    = SubscriptionPurchaseListRes {totalItems :: Kernel.Prelude.Int, summary :: Dashboard.Common.Summary, subscriptions :: [SubscriptionPurchaseListItem]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SubscriptionPurchaseStatus
    = SubscriptionPending | SubscriptionActive | SubscriptionExpired | SubscriptionFailed | SubscriptionExhausted
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema, Kernel.Prelude.ToParamSchema)
data TransactionTypeFilter
    = Order | Refund | Chargeback
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema, ToParamSchema, Kernel.Prelude.ToParamSchema)
data WalletLedgerItem
    = WalletLedgerItem {walletTxnId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data WalletLedgerRes
    = WalletLedgerRes {availableWalletBalance :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
...
type GetFinanceManagementSubscriptionPurchaseList = ("subscriptionPurchase" :> "list" :> QueryParam "amountMax" Kernel.Types.Common.HighPrecMoney :> QueryParam "amountMin"
                                                                                                                                                                Kernel.Types.Common.HighPrecMoney :> QueryParam "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> QueryParam "fleetOwnerId"
                                                                                                                                                                                                                                                                                      Kernel.Prelude.Text :> QueryParam "from"
                                                                                                                                                                                                                                                                                                                        Kernel.Prelude.UTCTime :> QueryParam "limit"
                                                                                                                                                                                                                                                                                                                                                             Kernel.Prelude.Int :> QueryParam "offset"
                                                                                                                                                                                                                                                                                                                                                                                              Kernel.Prelude.Int :> QueryParam "serviceName"
                                                                                                                                                                                                                                                                                                                                                                                                                               Kernel.Prelude.Text :> QueryParam "status"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                 SubscriptionPurchaseStatus :> QueryParam "subscriptionId"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Kernel.Prelude.Text :> QueryParam "to"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            Kernel.Prelude.UTCTime :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          SubscriptionPurchaseListRes)
type GetFinanceManagementFinanceInvoiceList = ("finance" :> "invoice" :> "list" :> QueryParam "fleetOwnerOrDriverId" Kernel.Prelude.Text :> QueryParam "from"
                                                                                                                                                       Kernel.Prelude.UTCTime :> QueryParam "invoiceId" Kernel.Prelude.Text :> QueryParam "invoiceNumber" Kernel.Prelude.Text :> QueryParam "invoiceType"
                                                                                                                                                                                                                                                                                            Lib.Finance.Domain.Types.Invoice.InvoiceType :> QueryParam "limit"
                                                                                                                                                                                                                                                                                                                                                       Kernel.Prelude.Int :> QueryParam "offset"
                                                                                                                                                                                                                                                                                                                                                                                        Kernel.Prelude.Int :> QueryParam "status"
                                                                                                                                                                                                                                                                                                                                                                                                                         Lib.Finance.Domain.Types.Invoice.InvoiceStatus :> QueryParam "to"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      Kernel.Prelude.UTCTime :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    InvoiceListRes)
type GetFinanceManagementFinanceReconciliation = ("finance" :> "reconciliation" :> QueryParam "fromDate" Kernel.Prelude.UTCTime :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset"
                                                                                                                                                                                       Kernel.Prelude.Int :> QueryParam "toDate" Kernel.Prelude.UTCTime :> MandatoryQueryParam "reconciliationType"
                                                                                                                                                                                                                                                                               Lib.Finance.Domain.Types.ReconciliationSummary.ReconciliationType :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                        ReconciliationRes)
type GetFinanceManagementFinancePaymentSettlementList = ("finance" :> "payment" :> "settlement" :> "list" :> QueryParam "from" Kernel.Prelude.UTCTime :> QueryParam "limit"
                                                                                                                                                                    Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> QueryParam "paymentOrderShortId"
                                                                                                                                                                                                                                               (Kernel.Types.Id.ShortId Dashboard.Common.PaymentOrder) :> QueryParam "pgApprovalCode"
                                                                                                                                                                                                                                                                                                                     Kernel.Prelude.Text :> QueryParam "pgGateway"
                                                                                                                                                                                                                                                                                                                                                       PgGateway :> QueryParam "settlementAmountMax"
                                                                                                                                                                                                                                                                                                                                                                               Kernel.Types.Common.HighPrecMoney :> QueryParam "settlementAmountMin"
                                                                                                                                                                                                                                                                                                                                                                                                                               Kernel.Types.Common.HighPrecMoney :> QueryParam "settlementFrom"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                               Kernel.Prelude.UTCTime :> QueryParam "settlementId"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    (Kernel.Types.Id.Id Dashboard.Common.PGPaymentSettlementReport) :> QueryParam "settlementTo"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  Kernel.Prelude.UTCTime :> QueryParam "settlementUtr"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       Kernel.Prelude.Text :> QueryParam "subscriptionPurchaseId"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         (Kernel.Types.Id.Id Dashboard.Common.SubscriptionPurchase) :> QueryParam "to"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  Kernel.Prelude.UTCTime :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                PaymentSettlementListRes)
type GetFinanceManagementFinancePaymentGatewayTransactionList = ("finance" :> "payment" :> "gateway" :> "transaction" :> "list" :> QueryParam "from" Kernel.Prelude.UTCTime :> QueryParam "limit"
                                                                                                                                                                                          Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> QueryParam "paymentMode"
                                                                                                                                                                                                                                                                     PaymentModeFilter :> QueryParam "paymentOrderId"
                                                                                                                                                                                                                                                                                                     (Kernel.Types.Id.ShortId Dashboard.Common.PaymentOrder) :> QueryParam "paymentStatus"
                                                                                                                                                                                                                                                                                                                                                                           PaymentStatusFilter :> QueryParam "pgGateway"
                                                                                                                                                                                                                                                                                                                                                                                                             PgGateway :> QueryParam "subscriptionId"
                                                                                                                                                                                                                                                                                                                                                                                                                                     (Kernel.Types.Id.Id Dashboard.Common.SubscriptionPurchase) :> QueryParam "to"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              Kernel.Prelude.UTCTime :> QueryParam "txnAmountMax"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   Kernel.Types.Common.HighPrecMoney :> QueryParam "txnAmountMin"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   Kernel.Types.Common.HighPrecMoney :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            PaymentTransactionReportListRes)
type GetFinanceManagementFinanceWalletLedger = ("finance" :> "wallet" :> "ledger" :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> QueryParam "driverId"
                                                                                                                                                                                   Kernel.Prelude.Text :> QueryParam "fleetOperatorId" Kernel.Prelude.Text :> QueryParam "from"
                                                                                                                                                                                                                                                                         Kernel.Prelude.UTCTime :> QueryParam "to"
                                                                                                                                                                                                                                                                                                              Kernel.Prelude.UTCTime :> QueryParam "sourceType"
...
mkFinanceManagementAPIs financeManagementClient = (FinanceManagementAPIs {..})
                            where getFinanceManagementSubscriptionPurchaseList :<|> getFinanceManagementFinanceInvoiceList :<|> getFinanceManagementFinanceReconciliation :<|> getFinanceManagementFinancePaymentSettlementList :<|> getFinanceManagementFinancePaymentGatewayTransactionList :<|> getFinanceManagementFinanceWalletLedger :<|> postFinanceManagementReconciliationTrigger = financeManagementClient
