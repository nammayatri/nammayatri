...
data RadarCreateTicketReq = RadarCreateTicketReq
  { subject :: Kernel.Prelude.Text,
    ...
    priority :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
type API = ("radarTickets" :> (GetRadarTicketsList :<|> GetRadarTicketsSummary :<|> GetRadarTicketsReporters :<|> GetRadarTicketsTicket :<|> GetRadarTicketsTicketAttachment :<|> GetRadarTicketsTicketConversation :<|> PostRadarTicketsTicketReply :<|> PostRadarTicketsCreate :<|> PostRadarTicketsTicketUpdateStatus :<|> PostRadarTicketsTicketCsat))
...
mkRadarTicketsAPIs radarTicketsClient = (RadarTicketsAPIs {..})
  where
    getRadarTicketsList :<|> getRadarTicketsSummary :<|> getRadarTicketsReporters :<|> getRadarTicketsTicket :<|> getRadarTicketsTicketAttachment :<|> getRadarTicketsTicketConversation :<|> postRadarTicketsTicketReply :<|> postRadarTicketsCreate :<|> postRadarTicketsTicketUpdateStatus :<|> postRadarTicketsTicketCsat = radarTicketsClient
