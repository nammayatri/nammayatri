...
getRevenueCollectionHistory merchantShortId opCity apiTokenInfo a1 a2 a3 a4 = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Revenue.getRevenueCollectionHistory merchantShortId opCity apiTokenInfo a1 a2 a3 a4
...
getRevenueAllFeeHistory merchantShortId opCity apiTokenInfo a1 a2 = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Revenue.getRevenueAllFeeHistory merchantShortId opCity apiTokenInfo a1 a2
