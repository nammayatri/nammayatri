...
type GetIncentiveJourneyDriverAssignments =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.INCENTIVE_JOURNEY / 'API.Types.ProviderPlatform.Management.IncentiveJourney.GET_INCENTIVE_JOURNEY_DRIVER_ASSIGNMENTS)
      :> API.Types.ProviderPlatform.Management.IncentiveJourney.GetIncentiveJourneyDriverAssignments
  )
...
type GetIncentiveJourneyCohortJourneyList =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.INCENTIVE_JOURNEY / 'API.Types.ProviderPlatform.Management.IncentiveJourney.GET_INCENTIVE_JOURNEY_COHORT_JOURNEY_LIST)
      :> API.Types.ProviderPlatform.Management.IncentiveJourney.GetIncentiveJourneyCohortJourneyList
  )
...
type PostIncentiveJourneyAssignBulkFromS3 =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.INCENTIVE_JOURNEY / 'API.Types.ProviderPlatform.Management.IncentiveJourney.POST_INCENTIVE_JOURNEY_ASSIGN_BULK_FROM_S3)
      :> API.Types.ProviderPlatform.Management.IncentiveJourney.PostIncentiveJourneyAssignBulkFromS3
  )
...
getIncentiveJourneyDriverAssignments :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Environment.FlowHandler API.Types.ProviderPlatform.Management.IncentiveJourney.IncentiveJourneyDriverAssignmentListRes)
getIncentiveJourneyDriverAssignments merchantShortId opCity apiTokenInfo driverId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.IncentiveJourney.getIncentiveJourneyDriverAssignments merchantShortId opCity apiTokenInfo driverId
...
getIncentiveJourneyCohortJourneyList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Environment.FlowHandler API.Types.ProviderPlatform.Management.IncentiveJourney.CohortJourneyMappingListRes)
getIncentiveJourneyCohortJourneyList merchantShortId opCity apiTokenInfo limit offset cohortName = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.IncentiveJourney.getIncentiveJourneyCohortJourneyList merchantShortId opCity apiTokenInfo limit offset cohortName
...
postIncentiveJourneyAssignBulkFromS3 merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.IncentiveJourney.postIncentiveJourneyAssignBulkFromS3 merchantShortId opCity apiTokenInfo req
