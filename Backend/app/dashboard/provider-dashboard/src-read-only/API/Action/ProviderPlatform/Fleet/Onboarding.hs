...
type GetOnboardingDocumentConfigs = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                             ('DSL)
                                             (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.ONBOARDING) / ('API.Types.ProviderPlatform.Fleet.Onboarding.GET_ONBOARDING_DOCUMENT_CONFIGS)) :> API.Types.ProviderPlatform.Fleet.Onboarding.GetOnboardingDocumentConfigs)
type GetOnboardingRegisterStatus = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                            ('DSL)
                                            (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.ONBOARDING) / ('API.Types.ProviderPlatform.Fleet.Onboarding.GET_ONBOARDING_REGISTER_STATUS)) :> API.Types.ProviderPlatform.Fleet.Onboarding.GetOnboardingRegisterStatus)
type PostOnboardingVerify = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                     ('DSL)
                                     (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.ONBOARDING) / ('API.Types.ProviderPlatform.Fleet.Onboarding.POST_ONBOARDING_VERIFY)) :> API.Types.ProviderPlatform.Fleet.Onboarding.PostOnboardingVerify)
type GetOnboardingGetReferralDetails = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                ('DSL)
                                                (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.ONBOARDING) / ('API.Types.ProviderPlatform.Fleet.Onboarding.GET_ONBOARDING_GET_REFERRAL_DETAILS)) :> API.Types.ProviderPlatform.Fleet.Onboarding.GetOnboardingGetReferralDetails)
