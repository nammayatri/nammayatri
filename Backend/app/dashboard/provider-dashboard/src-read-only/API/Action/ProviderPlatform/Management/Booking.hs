...
type PostBookingCancelAllStuck = (ApiAuth 'DRIVER_OFFER_BPP_MANAGEMENT 'RIDES 'STUCK_BOOKING_CANCEL :> API.Types.ProviderPlatform.Management.Booking.PostBookingCancelAllStuck)

type PostBookingSyncMultiple = (ApiAuth 'DRIVER_OFFER_BPP_MANAGEMENT 'RIDES 'MULTIPLE_BOOKING_SYNC :> API.Types.ProviderPlatform.Management.Booking.PostBookingSyncMultiple)
