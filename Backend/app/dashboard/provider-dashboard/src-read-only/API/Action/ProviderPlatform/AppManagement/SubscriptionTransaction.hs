...
type GetSubscriptionTransactionSubscriptionTransactions = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                                   ('DSL)
                                                                   (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION_TRANSACTION) / ('API.Types.Dashboard.AppManagement.SubscriptionTransaction.GET_SUBSCRIPTION_TRANSACTION_SUBSCRIPTION_TRANSACTIONS)) :> API.Types.Dashboard.AppManagement.SubscriptionTransaction.GetSubscriptionTransactionSubscriptionTransactions)
