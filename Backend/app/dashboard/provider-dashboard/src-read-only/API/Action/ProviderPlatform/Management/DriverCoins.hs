...
type PostDriverCoinsBulkUploadCoins = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                               ('DSL)
                                               (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER_COINS) / ('API.Types.ProviderPlatform.Management.DriverCoins.POST_DRIVER_COINS_BULK_UPLOAD_COINS)) :> API.Types.ProviderPlatform.Management.DriverCoins.PostDriverCoinsBulkUploadCoins)
type PostDriverCoinsBulkUploadCoinsV2 = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                 ('DSL)
                                                 (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER_COINS) / ('API.Types.ProviderPlatform.Management.DriverCoins.POST_DRIVER_COINS_BULK_UPLOAD_COINS_V2)) :> API.Types.ProviderPlatform.Management.DriverCoins.PostDriverCoinsBulkUploadCoinsV2)
type GetDriverCoinsCoinHistory = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                          ('DSL)
                                          (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER_COINS) / ('API.Types.ProviderPlatform.Management.DriverCoins.GET_DRIVER_COINS_COIN_HISTORY)) :> API.Types.ProviderPlatform.Management.DriverCoins.GetDriverCoinsCoinHistory)
type PostDriverCoinsBlacklistedEventsUpdate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                       ('DSL)
                                                       (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER_COINS) / ('API.Types.ProviderPlatform.Management.DriverCoins.POST_DRIVER_COINS_BLACKLISTED_EVENTS_UPDATE)) :> API.Types.ProviderPlatform.Management.DriverCoins.PostDriverCoinsBlacklistedEventsUpdate)
