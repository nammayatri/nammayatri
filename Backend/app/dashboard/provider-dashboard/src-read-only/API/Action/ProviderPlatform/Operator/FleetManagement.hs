...
type GetFleetManagementFleets = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                         ('DSL)
                                         (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.FLEET_MANAGEMENT) / ('API.Types.ProviderPlatform.Operator.FleetManagement.GET_FLEET_MANAGEMENT_FLEETS)) :> API.Types.ProviderPlatform.Operator.FleetManagement.GetFleetManagementFleets)
type PostFleetManagementFleetCreate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                               ('DSL)
                                               (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.FLEET_MANAGEMENT) / ('API.Types.ProviderPlatform.Operator.FleetManagement.POST_FLEET_MANAGEMENT_FLEET_CREATE)) :> API.Types.ProviderPlatform.Operator.FleetManagement.PostFleetManagementFleetCreate)
type PostFleetManagementFleetRegister = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                 ('DSL)
                                                 (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.FLEET_MANAGEMENT) / ('API.Types.ProviderPlatform.Operator.FleetManagement.POST_FLEET_MANAGEMENT_FLEET_REGISTER)) :> API.Types.ProviderPlatform.Operator.FleetManagement.PostFleetManagementFleetRegister)
type PostFleetManagementFleetLinkSendOtp = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                    ('DSL)
                                                    (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.FLEET_MANAGEMENT) / ('API.Types.ProviderPlatform.Operator.FleetManagement.POST_FLEET_MANAGEMENT_FLEET_LINK_SEND_OTP)) :> API.Types.ProviderPlatform.Operator.FleetManagement.PostFleetManagementFleetLinkSendOtp)
type PostFleetManagementFleetLinkVerifyOtp = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                      ('DSL)
                                                      (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.FLEET_MANAGEMENT) / ('API.Types.ProviderPlatform.Operator.FleetManagement.POST_FLEET_MANAGEMENT_FLEET_LINK_VERIFY_OTP)) :> API.Types.ProviderPlatform.Operator.FleetManagement.PostFleetManagementFleetLinkVerifyOtp)
type PostFleetManagementFleetUnlink = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                               ('DSL)
                                               (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.FLEET_MANAGEMENT) / ('API.Types.ProviderPlatform.Operator.FleetManagement.POST_FLEET_MANAGEMENT_FLEET_UNLINK)) :> API.Types.ProviderPlatform.Operator.FleetManagement.PostFleetManagementFleetUnlink)
type PostFleetManagementFleetMemberAssociationCreate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                                ('DSL)
                                                                (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.FLEET_MANAGEMENT) / ('API.Types.ProviderPlatform.Operator.FleetManagement.POST_FLEET_MANAGEMENT_FLEET_MEMBER_ASSOCIATION_CREATE)) :> API.Types.ProviderPlatform.Operator.FleetManagement.PostFleetManagementFleetMemberAssociationCreate)
