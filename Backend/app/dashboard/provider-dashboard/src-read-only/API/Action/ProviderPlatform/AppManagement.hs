...
type API = (API.Action.ProviderPlatform.AppManagement.Driver.API :<|> API.Action.ProviderPlatform.AppManagement.DriverSubscription.API :<|> API.Action.ProviderPlatform.AppManagement.Overlay.API :<|> API.Action.ProviderPlatform.AppManagement.Subscription.API)

handler :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Environment.FlowServer API)
handler merchantId city = API.Action.ProviderPlatform.AppManagement.Driver.handler merchantId city :<|> API.Action.ProviderPlatform.AppManagement.DriverSubscription.handler merchantId city :<|> API.Action.ProviderPlatform.AppManagement.Overlay.handler merchantId city :<|> API.Action.ProviderPlatform.AppManagement.Subscription.handler merchantId city
