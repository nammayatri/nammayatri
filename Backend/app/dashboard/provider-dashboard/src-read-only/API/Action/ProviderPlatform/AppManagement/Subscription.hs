...
type GetSubscriptionListPlan = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                        ('DSL)
                                        (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.GET_SUBSCRIPTION_LIST_PLAN)) :> API.Types.Dashboard.AppManagement.Subscription.GetSubscriptionListPlan)
type PutSubscriptionSelectPlan = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                          ('DSL)
                                          (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.PUT_SUBSCRIPTION_SELECT_PLAN)) :> API.Types.Dashboard.AppManagement.Subscription.PutSubscriptionSelectPlan)
type PutSubscriptionSuspendPlan = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                           ('DSL)
                                           (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.PUT_SUBSCRIPTION_SUSPEND_PLAN)) :> API.Types.Dashboard.AppManagement.Subscription.PutSubscriptionSuspendPlan)
type PostSubscriptionSubscribePlan = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                              ('DSL)
                                              (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.POST_SUBSCRIPTION_SUBSCRIBE_PLAN)) :> API.Types.Dashboard.AppManagement.Subscription.PostSubscriptionSubscribePlan)
type GetSubscriptionCurrentPlan = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                           ('DSL)
                                           (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.GET_SUBSCRIPTION_CURRENT_PLAN)) :> API.Types.Dashboard.AppManagement.Subscription.GetSubscriptionCurrentPlan)
type GetSubscriptionListPlanV2 = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                          ('DSL)
                                          (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.GET_SUBSCRIPTION_LIST_PLAN_V2)) :> API.Types.Dashboard.AppManagement.Subscription.GetSubscriptionListPlanV2)
type PutSubscriptionSelectPlanV2 = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                            ('DSL)
                                            (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.PUT_SUBSCRIPTION_SELECT_PLAN_V2)) :> API.Types.Dashboard.AppManagement.Subscription.PutSubscriptionSelectPlanV2)
type PutSubscriptionSuspendPlanV2 = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                             ('DSL)
                                             (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.PUT_SUBSCRIPTION_SUSPEND_PLAN_V2)) :> API.Types.Dashboard.AppManagement.Subscription.PutSubscriptionSuspendPlanV2)
type PostSubscriptionSubscribePlanV2 = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                ('DSL)
                                                (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.POST_SUBSCRIPTION_SUBSCRIBE_PLAN_V2)) :> API.Types.Dashboard.AppManagement.Subscription.PostSubscriptionSubscribePlanV2)
type GetSubscriptionCurrentPlanV2 = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                             ('DSL)
                                             (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.GET_SUBSCRIPTION_CURRENT_PLAN_V2)) :> API.Types.Dashboard.AppManagement.Subscription.GetSubscriptionCurrentPlanV2)
type GetSubscriptionOrderStatus = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                           ('DSL)
                                           (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.GET_SUBSCRIPTION_ORDER_STATUS)) :> API.Types.Dashboard.AppManagement.Subscription.GetSubscriptionOrderStatus)
type GetSubscriptionDriverPaymentHistoryAPIV2 = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                         ('DSL)
                                                         (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.GET_SUBSCRIPTION_DRIVER_PAYMENT_HISTORY_API_V2)) :> API.Types.Dashboard.AppManagement.Subscription.GetSubscriptionDriverPaymentHistoryAPIV2)
type GetSubscriptionDriverPaymentHistoryEntityDetailsV2 = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                                   ('DSL)
                                                                   (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.GET_SUBSCRIPTION_DRIVER_PAYMENT_HISTORY_ENTITY_DETAILS_V2)) :> API.Types.Dashboard.AppManagement.Subscription.GetSubscriptionDriverPaymentHistoryEntityDetailsV2)
type PostSubscriptionCollectManualPayments = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                      ('DSL)
                                                      (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.POST_SUBSCRIPTION_COLLECT_MANUAL_PAYMENTS)) :> API.Types.Dashboard.AppManagement.Subscription.PostSubscriptionCollectManualPayments)
type PostSubscriptionFeeWaiveOff = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                            ('DSL)
                                            (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.POST_SUBSCRIPTION_FEE_WAIVE_OFF)) :> API.Types.Dashboard.AppManagement.Subscription.PostSubscriptionFeeWaiveOff)
type GetSubscriptionPurchaseList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                            ('DSL)
                                            (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.SUBSCRIPTION) / ('API.Types.Dashboard.AppManagement.Subscription.GET_SUBSCRIPTION_PURCHASE_LIST)) :> API.Types.Dashboard.AppManagement.Subscription.GetSubscriptionPurchaseList)
