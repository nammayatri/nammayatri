...
type PostSpecialZoneQueueTriggerNotify = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                  ('DSL)
                                                  (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.SPECIAL_ZONE_QUEUE) / ('API.Types.ProviderPlatform.Management.SpecialZoneQueue.POST_SPECIAL_ZONE_QUEUE_TRIGGER_NOTIFY)) :> API.Types.ProviderPlatform.Management.SpecialZoneQueue.PostSpecialZoneQueueTriggerNotify)
type GetSpecialZoneQueueQueueStats = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                              ('DSL)
                                              (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.SPECIAL_ZONE_QUEUE) / ('API.Types.ProviderPlatform.Management.SpecialZoneQueue.GET_SPECIAL_ZONE_QUEUE_QUEUE_STATS)) :> API.Types.ProviderPlatform.Management.SpecialZoneQueue.GetSpecialZoneQueueQueueStats)
