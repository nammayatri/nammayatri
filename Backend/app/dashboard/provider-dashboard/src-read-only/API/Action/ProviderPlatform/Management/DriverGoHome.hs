...
type GetDriverGoHomeGetHomeLocation = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                               ('DSL)
                                               (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER_GO_HOME) / ('API.Types.ProviderPlatform.Management.DriverGoHome.GET_DRIVER_GO_HOME_GET_HOME_LOCATION)) :> API.Types.ProviderPlatform.Management.DriverGoHome.GetDriverGoHomeGetHomeLocation)
type PostDriverGoHomeUpdateHomeLocation = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                   ('DSL)
                                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER_GO_HOME) / ('API.Types.ProviderPlatform.Management.DriverGoHome.POST_DRIVER_GO_HOME_UPDATE_HOME_LOCATION)) :> API.Types.ProviderPlatform.Management.DriverGoHome.PostDriverGoHomeUpdateHomeLocation)
type PostDriverGoHomeIncrementGoToCount = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                   ('DSL)
                                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER_GO_HOME) / ('API.Types.ProviderPlatform.Management.DriverGoHome.POST_DRIVER_GO_HOME_INCREMENT_GO_TO_COUNT)) :> API.Types.ProviderPlatform.Management.DriverGoHome.PostDriverGoHomeIncrementGoToCount)
type GetDriverGoHomeGetGoHomeInfo = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                             ('DSL)
                                             (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER_GO_HOME) / ('API.Types.ProviderPlatform.Management.DriverGoHome.GET_DRIVER_GO_HOME_GET_GO_HOME_INFO)) :> API.Types.ProviderPlatform.Management.DriverGoHome.GetDriverGoHomeGetGoHomeInfo)
