...
type PostOverlayCreate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                  ('DSL)
                                  (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.OVERLAY) / ('API.Types.Dashboard.AppManagement.Overlay.POST_OVERLAY_CREATE)) :> API.Types.Dashboard.AppManagement.Overlay.PostOverlayCreate)
type PostOverlayDelete = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                  ('DSL)
                                  (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.OVERLAY) / ('API.Types.Dashboard.AppManagement.Overlay.POST_OVERLAY_DELETE)) :> API.Types.Dashboard.AppManagement.Overlay.PostOverlayDelete)
type GetOverlayList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                               ('DSL)
                               (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.OVERLAY) / ('API.Types.Dashboard.AppManagement.Overlay.GET_OVERLAY_LIST)) :> API.Types.Dashboard.AppManagement.Overlay.GetOverlayList)
type GetOverlayInfo = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                               ('DSL)
                               (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.OVERLAY) / ('API.Types.Dashboard.AppManagement.Overlay.GET_OVERLAY_INFO)) :> API.Types.Dashboard.AppManagement.Overlay.GetOverlayInfo)
type PostOverlaySchedule = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                    ('DSL)
                                    (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.OVERLAY) / ('API.Types.Dashboard.AppManagement.Overlay.POST_OVERLAY_SCHEDULE)) :> API.Types.Dashboard.AppManagement.Overlay.PostOverlaySchedule)
...
getOverlayList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Environment.FlowHandler API.Types.Dashboard.AppManagement.Overlay.ListOverlayResp)
getOverlayList merchantShortId opCity apiTokenInfo limit offset = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.AppManagement.Overlay.getOverlayList merchantShortId opCity apiTokenInfo limit offset
