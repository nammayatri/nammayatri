...
getVolunteerList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Volunteer.VolunteerListRes)
getVolunteerList merchantShortId opCity apiTokenInfo limit offset volunteerId place vendorId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Volunteer.getVolunteerList merchantShortId opCity apiTokenInfo limit offset volunteerId place vendorId

postVolunteerUpdate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Text -> API.Types.ProviderPlatform.Management.Volunteer.UpdateVolunteerReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postVolunteerUpdate merchantShortId opCity apiTokenInfo volunteerId req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Volunteer.postVolunteerUpdate merchantShortId opCity apiTokenInfo volunteerId req
