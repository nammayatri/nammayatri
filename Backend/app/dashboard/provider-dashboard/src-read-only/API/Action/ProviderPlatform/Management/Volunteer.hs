...
type PostVolunteerCreate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                    ('DSL)
                                    (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.VOLUNTEER) / ('API.Types.ProviderPlatform.Management.Volunteer.POST_VOLUNTEER_CREATE)) :> API.Types.ProviderPlatform.Management.Volunteer.PostVolunteerCreate)
type GetVolunteerList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                 ('DSL)
                                 (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.VOLUNTEER) / ('API.Types.ProviderPlatform.Management.Volunteer.GET_VOLUNTEER_LIST)) :> API.Types.ProviderPlatform.Management.Volunteer.GetVolunteerList)
type PostVolunteerUpdate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                    ('DSL)
                                    (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.VOLUNTEER) / ('API.Types.ProviderPlatform.Management.Volunteer.POST_VOLUNTEER_UPDATE)) :> API.Types.ProviderPlatform.Management.Volunteer.PostVolunteerUpdate)
