...
type GetDriverWalletWalletTransactions = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                  ('DSL)
                                                  (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.DRIVER_WALLET) / ('API.Types.Dashboard.AppManagement.DriverWallet.GET_DRIVER_WALLET_WALLET_TRANSACTIONS)) :> API.Types.Dashboard.AppManagement.DriverWallet.GetDriverWalletWalletTransactions)
type PostDriverWalletWalletPayout = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                             ('DSL)
                                             (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.DRIVER_WALLET) / ('API.Types.Dashboard.AppManagement.DriverWallet.POST_DRIVER_WALLET_WALLET_PAYOUT)) :> API.Types.Dashboard.AppManagement.DriverWallet.PostDriverWalletWalletPayout)
type PostDriverWalletWalletTopup = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                            ('DSL)
                                            (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.DRIVER_WALLET) / ('API.Types.Dashboard.AppManagement.DriverWallet.POST_DRIVER_WALLET_WALLET_TOPUP)) :> API.Types.Dashboard.AppManagement.DriverWallet.PostDriverWalletWalletTopup)
type PostDriverWalletWalletAirportCashRecharge = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                          ('DSL)
                                                          (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.DRIVER_WALLET) / ('API.Types.Dashboard.AppManagement.DriverWallet.POST_DRIVER_WALLET_WALLET_AIRPORT_CASH_RECHARGE)) :> API.Types.Dashboard.AppManagement.DriverWallet.PostDriverWalletWalletAirportCashRecharge)
type GetDriverWalletWalletPayoutHistory = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                   ('DSL)
                                                   (('PROVIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.DRIVER_WALLET) / ('API.Types.Dashboard.AppManagement.DriverWallet.GET_DRIVER_WALLET_WALLET_PAYOUT_HISTORY)) :> API.Types.Dashboard.AppManagement.DriverWallet.GetDriverWalletWalletPayoutHistory)
