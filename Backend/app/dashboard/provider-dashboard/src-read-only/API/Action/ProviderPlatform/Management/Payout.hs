...
type GetPayoutPayout = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                ('DSL)
                                (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PAYOUT) / ('API.Types.ProviderPlatform.Management.Payout.GET_PAYOUT_PAYOUT)) :> API.Types.ProviderPlatform.Management.Payout.GetPayoutPayout)
type PostPayoutPayoutRetry = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                      ('DSL)
                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PAYOUT) / ('API.Types.ProviderPlatform.Management.Payout.POST_PAYOUT_PAYOUT_RETRY)) :> API.Types.ProviderPlatform.Management.Payout.PostPayoutPayoutRetry)
type PostPayoutPayoutCancel = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                       ('DSL)
                                       (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PAYOUT) / ('API.Types.ProviderPlatform.Management.Payout.POST_PAYOUT_PAYOUT_CANCEL)) :> API.Types.ProviderPlatform.Management.Payout.PostPayoutPayoutCancel)
type PostPayoutPayoutCash = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                     ('DSL)
                                     (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PAYOUT) / ('API.Types.ProviderPlatform.Management.Payout.POST_PAYOUT_PAYOUT_CASH)) :> API.Types.ProviderPlatform.Management.Payout.PostPayoutPayoutCash)
type PostPayoutPayoutVpaDelete = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                          ('DSL)
                                          (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PAYOUT) / ('API.Types.ProviderPlatform.Management.Payout.POST_PAYOUT_PAYOUT_VPA_DELETE)) :> API.Types.ProviderPlatform.Management.Payout.PostPayoutPayoutVpaDelete)
type PostPayoutPayoutVpaUpdate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                          ('DSL)
                                          (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PAYOUT) / ('API.Types.ProviderPlatform.Management.Payout.POST_PAYOUT_PAYOUT_VPA_UPDATE)) :> API.Types.ProviderPlatform.Management.Payout.PostPayoutPayoutVpaUpdate)
type PostPayoutPayoutVpaRefundRegistration = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                      ('DSL)
                                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PAYOUT) / ('API.Types.ProviderPlatform.Management.Payout.POST_PAYOUT_PAYOUT_VPA_REFUND_REGISTRATION)) :> API.Types.ProviderPlatform.Management.Payout.PostPayoutPayoutVpaRefundRegistration)
type PostPayoutPayoutScheduledPayoutConfigUpsert = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                            ('DSL)
                                                            (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PAYOUT) / ('API.Types.ProviderPlatform.Management.Payout.POST_PAYOUT_PAYOUT_SCHEDULED_PAYOUT_CONFIG_UPSERT)) :> API.Types.ProviderPlatform.Management.Payout.PostPayoutPayoutScheduledPayoutConfigUpsert)
