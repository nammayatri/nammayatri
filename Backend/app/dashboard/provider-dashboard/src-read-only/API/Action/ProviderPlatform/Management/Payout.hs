...
type PostPayoutScheduler =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.PAYOUT / 'API.Types.ProviderPlatform.Management.Payout.POST_PAYOUT_SCHEDULER)
      :> API.Types.ProviderPlatform.Management.Payout.PostPayoutScheduler
  )
...
postPayoutScheduler :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> API.Types.ProviderPlatform.Management.Payout.PayoutSchedulerReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Payout.PayoutSchedulerResp)
postPayoutScheduler merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Payout.postPayoutScheduler merchantShortId opCity apiTokenInfo req
