...
type PostRideStart = (ApiAuth ('DRIVER_OFFER_BPP)
                              ('DSL)
                              (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.RIDE) / ('API.Types.Dashboard.RideBooking.Ride.POST_RIDE_START)) :> API.Types.Dashboard.RideBooking.Ride.PostRideStart)
type PostRideEnd = (ApiAuth ('DRIVER_OFFER_BPP)
                            ('DSL)
                            (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.RIDE) / ('API.Types.Dashboard.RideBooking.Ride.POST_RIDE_END)) :> API.Types.Dashboard.RideBooking.Ride.PostRideEnd)
type GetRideCurrentActiveRide = (ApiAuth ('DRIVER_OFFER_BPP)
                                         ('DSL)
                                         (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.RIDE) / ('API.Types.Dashboard.RideBooking.Ride.GET_RIDE_CURRENT_ACTIVE_RIDE)) :> API.Types.Dashboard.RideBooking.Ride.GetRideCurrentActiveRide)
type PostRideCancel = (ApiAuth ('DRIVER_OFFER_BPP)
                               ('DSL)
                               (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.RIDE) / ('API.Types.Dashboard.RideBooking.Ride.POST_RIDE_CANCEL)) :> API.Types.Dashboard.RideBooking.Ride.PostRideCancel)
type PostRideBookingWithVehicleNumberAndPhone = (ApiAuth ('DRIVER_OFFER_BPP)
                                                         ('DSL)
                                                         (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.RIDE) / ('API.Types.Dashboard.RideBooking.Ride.POST_RIDE_BOOKING_WITH_VEHICLE_NUMBER_AND_PHONE)) :> API.Types.Dashboard.RideBooking.Ride.PostRideBookingWithVehicleNumberAndPhone)
