...
type PostNammaTagTagCreate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                      ('DSL)
                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.POST_NAMMA_TAG_TAG_CREATE)) :> API.Types.ProviderPlatform.Management.NammaTag.PostNammaTagTagCreate)
type PostNammaTagTagVerify = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                      ('DSL)
                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.POST_NAMMA_TAG_TAG_VERIFY)) :> API.Types.ProviderPlatform.Management.NammaTag.PostNammaTagTagVerify)
type PostNammaTagTagUpdate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                      ('DSL)
                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.POST_NAMMA_TAG_TAG_UPDATE)) :> API.Types.ProviderPlatform.Management.NammaTag.PostNammaTagTagUpdate)
type DeleteNammaTagTagDelete = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                        ('DSL)
                                        (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.DELETE_NAMMA_TAG_TAG_DELETE)) :> API.Types.ProviderPlatform.Management.NammaTag.DeleteNammaTagTagDelete)
type GetNammaTagTagAll = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                  ('DSL)
                                  (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_TAG_ALL)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagTagAll)
type GetNammaTagTagDetails = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                      ('DSL)
                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_TAG_DETAILS)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagTagDetails)
type PostNammaTagQueryCreate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                        ('DSL)
                                        (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.POST_NAMMA_TAG_QUERY_CREATE)) :> API.Types.ProviderPlatform.Management.NammaTag.PostNammaTagQueryCreate)
type PostNammaTagQueryUpdate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                        ('DSL)
                                        (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.POST_NAMMA_TAG_QUERY_UPDATE)) :> API.Types.ProviderPlatform.Management.NammaTag.PostNammaTagQueryUpdate)
type DeleteNammaTagQueryDelete = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                          ('DSL)
                                          (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.DELETE_NAMMA_TAG_QUERY_DELETE)) :> API.Types.ProviderPlatform.Management.NammaTag.DeleteNammaTagQueryDelete)
type GetNammaTagQueryDetails = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                        ('DSL)
                                        (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_QUERY_DETAILS)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagQueryDetails)
type PostNammaTagAppDynamicLogicVerify = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                  ('DSL)
                                                  (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.POST_NAMMA_TAG_APP_DYNAMIC_LOGIC_VERIFY)) :> API.Types.ProviderPlatform.Management.NammaTag.PostNammaTagAppDynamicLogicVerify)
type GetNammaTagAppDynamicLogic = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                           ('DSL)
                                           (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_APP_DYNAMIC_LOGIC)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagAppDynamicLogic)
type PostNammaTagRunJob = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                   ('DSL)
                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.POST_NAMMA_TAG_RUN_JOB)) :> API.Types.ProviderPlatform.Management.NammaTag.PostNammaTagRunJob)
type GetNammaTagTimeBounds = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                      ('DSL)
                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_TIME_BOUNDS)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagTimeBounds)
type PostNammaTagTimeBoundsCreate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                             ('DSL)
                                             (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.POST_NAMMA_TAG_TIME_BOUNDS_CREATE)) :> API.Types.ProviderPlatform.Management.NammaTag.PostNammaTagTimeBoundsCreate)
type DeleteNammaTagTimeBoundsDelete = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                               ('DSL)
                                               (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.DELETE_NAMMA_TAG_TIME_BOUNDS_DELETE)) :> API.Types.ProviderPlatform.Management.NammaTag.DeleteNammaTagTimeBoundsDelete)
type GetNammaTagAppDynamicLogicGetLogicRollout = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                          ('DSL)
                                                          (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_APP_DYNAMIC_LOGIC_GET_LOGIC_ROLLOUT)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagAppDynamicLogicGetLogicRollout)
type PostNammaTagAppDynamicLogicUpsertLogicRollout = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                              ('DSL)
                                                              (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.POST_NAMMA_TAG_APP_DYNAMIC_LOGIC_UPSERT_LOGIC_ROLLOUT)) :> API.Types.ProviderPlatform.Management.NammaTag.PostNammaTagAppDynamicLogicUpsertLogicRollout)
type GetNammaTagAppDynamicLogicVersions = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                   ('DSL)
                                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_APP_DYNAMIC_LOGIC_VERSIONS)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagAppDynamicLogicVersions)
type GetNammaTagAppDynamicLogicDomains = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                  ('DSL)
                                                  (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_APP_DYNAMIC_LOGIC_DOMAINS)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagAppDynamicLogicDomains)
type GetNammaTagAppDynamicLogicDomainsAndEvents = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                           ('DSL)
                                                           (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_APP_DYNAMIC_LOGIC_DOMAINS_AND_EVENTS)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagAppDynamicLogicDomainsAndEvents)
type GetNammaTagAppDynamicLogicGetDomainSchema = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                          ('DSL)
                                                          (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_APP_DYNAMIC_LOGIC_GET_DOMAIN_SCHEMA)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagAppDynamicLogicGetDomainSchema)
type GetNammaTagQueryAll = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                    ('DSL)
                                    (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_QUERY_ALL)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagQueryAll)
type PostNammaTagConfigPilotGetVersion = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                  ('DSL)
                                                  (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.POST_NAMMA_TAG_CONFIG_PILOT_GET_VERSION)) :> API.Types.ProviderPlatform.Management.NammaTag.PostNammaTagConfigPilotGetVersion)
type PostNammaTagConfigPilotGetConfig = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                 ('DSL)
                                                 (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.POST_NAMMA_TAG_CONFIG_PILOT_GET_CONFIG)) :> API.Types.ProviderPlatform.Management.NammaTag.PostNammaTagConfigPilotGetConfig)
type PostNammaTagConfigPilotCreateUiConfig = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                      ('DSL)
                                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.POST_NAMMA_TAG_CONFIG_PILOT_CREATE_UI_CONFIG)) :> API.Types.ProviderPlatform.Management.NammaTag.PostNammaTagConfigPilotCreateUiConfig)
type GetNammaTagConfigPilotAllConfigs = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                 ('DSL)
                                                 (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_ALL_CONFIGS)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagConfigPilotAllConfigs)
type GetNammaTagConfigPilotConfigDetails = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                    ('DSL)
                                                    (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_CONFIG_DETAILS)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagConfigPilotConfigDetails)
type GetNammaTagConfigPilotGetTableData = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                   ('DSL)
                                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_GET_TABLE_DATA)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagConfigPilotGetTableData)
type GetNammaTagConfigPilotAllUiConfigs = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                   ('DSL)
                                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_ALL_UI_CONFIGS)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagConfigPilotAllUiConfigs)
type GetNammaTagConfigPilotUiConfigDetails = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                      ('DSL)
                                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_UI_CONFIG_DETAILS)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagConfigPilotUiConfigDetails)
type GetNammaTagConfigPilotGetUiTableData = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                     ('DSL)
                                                     (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_GET_UI_TABLE_DATA)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagConfigPilotGetUiTableData)
type GetNammaTagConfigPilotAlwaysOnList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                   ('DSL)
                                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_ALWAYS_ON_LIST)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagConfigPilotAlwaysOnList)
type PostNammaTagConfigPilotActionChange = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                    ('DSL)
                                                    (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.POST_NAMMA_TAG_CONFIG_PILOT_ACTION_CHANGE)) :> API.Types.ProviderPlatform.Management.NammaTag.PostNammaTagConfigPilotActionChange)
type PostNammaTagConfigPilotGetPatchedElement = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                         ('DSL)
                                                         (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.POST_NAMMA_TAG_CONFIG_PILOT_GET_PATCHED_ELEMENT)) :> API.Types.ProviderPlatform.Management.NammaTag.PostNammaTagConfigPilotGetPatchedElement)
type GetNammaTagBehaviorVisibility = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                              ('DSL)
                                              (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.NAMMA_TAG) / ('API.Types.ProviderPlatform.Management.NammaTag.GET_NAMMA_TAG_BEHAVIOR_VISIBILITY)) :> API.Types.ProviderPlatform.Management.NammaTag.GetNammaTagBehaviorVisibility)
...
getNammaTagBehaviorVisibility :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Text -> Kernel.Prelude.Text -> Environment.FlowHandler Lib.BehaviorTracker.Types.EntityBehaviorVisibility)
