...
type PostRegistrationV2Register = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                           ('DSL)
                                           (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.REGISTRATION_V2) / ('API.Types.ProviderPlatform.Fleet.RegistrationV2.POST_REGISTRATION_V2_REGISTER)) :> API.Types.ProviderPlatform.Fleet.RegistrationV2.PostRegistrationV2Register)
type PostRegistrationV2RegisterBankAccountLink = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                          ('DSL)
                                                          (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.REGISTRATION_V2) / ('API.Types.ProviderPlatform.Fleet.RegistrationV2.POST_REGISTRATION_V2_REGISTER_BANK_ACCOUNT_LINK)) :> API.Types.ProviderPlatform.Fleet.RegistrationV2.PostRegistrationV2RegisterBankAccountLink)
type GetRegistrationV2RegisterBankAccountStatus = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                           ('DSL)
                                                           (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.REGISTRATION_V2) / ('API.Types.ProviderPlatform.Fleet.RegistrationV2.GET_REGISTRATION_V2_REGISTER_BANK_ACCOUNT_STATUS)) :> API.Types.ProviderPlatform.Fleet.RegistrationV2.GetRegistrationV2RegisterBankAccountStatus)
