...
type PostIGMIssueTriggerActionUpdate =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_ISSUE_MANAGEMENT / 'API.Types.ProviderPlatform.IssueManagement.ISSUE / 'API.Types.ProviderPlatform.IssueManagement.Issue.POST_IGM_ISSUE_TRIGGER_ACTION_UPDATE)
      :> API.Types.ProviderPlatform.IssueManagement.Issue.PostIGMIssueTriggerActionUpdate
  )
...
postIGMIssueTriggerActionUpdate merchantShortId opCity apiTokenInfo issueReportId req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.IssueManagement.Issue.postIGMIssueTriggerActionUpdate merchantShortId opCity apiTokenInfo issueReportId req
