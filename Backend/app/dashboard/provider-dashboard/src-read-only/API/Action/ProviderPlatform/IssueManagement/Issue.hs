...
type GetIssueCategoryList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                     ('DSL)
                                     (('PROVIDER_ISSUE_MANAGEMENT) / ('API.Types.ProviderPlatform.IssueManagement.ISSUE) / ('API.Types.ProviderPlatform.IssueManagement.Issue.GET_ISSUE_CATEGORY_LIST)) :> API.Types.ProviderPlatform.IssueManagement.Issue.GetIssueCategoryList)
type GetIssueList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                             ('DSL)
                             (('PROVIDER_ISSUE_MANAGEMENT) / ('API.Types.ProviderPlatform.IssueManagement.ISSUE) / ('API.Types.ProviderPlatform.IssueManagement.Issue.GET_ISSUE_LIST)) :> API.Types.ProviderPlatform.IssueManagement.Issue.GetIssueList)
type GetIssueInfo = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                             ('DSL)
                             (('PROVIDER_ISSUE_MANAGEMENT) / ('API.Types.ProviderPlatform.IssueManagement.ISSUE) / ('API.Types.ProviderPlatform.IssueManagement.Issue.GET_ISSUE_INFO)) :> API.Types.ProviderPlatform.IssueManagement.Issue.GetIssueInfo)
type GetIssueInfoV2 = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                               ('DSL)
                               (('PROVIDER_ISSUE_MANAGEMENT) / ('API.Types.ProviderPlatform.IssueManagement.ISSUE) / ('API.Types.ProviderPlatform.IssueManagement.Issue.GET_ISSUE_INFO_V2)) :> API.Types.ProviderPlatform.IssueManagement.Issue.GetIssueInfoV2)
type PutIssueUpdate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                               ('DSL)
                               (('PROVIDER_ISSUE_MANAGEMENT) / ('API.Types.ProviderPlatform.IssueManagement.ISSUE) / ('API.Types.ProviderPlatform.IssueManagement.Issue.PUT_ISSUE_UPDATE)) :> API.Types.ProviderPlatform.IssueManagement.Issue.PutIssueUpdate)
type PostIssueComment = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                 ('DSL)
                                 (('PROVIDER_ISSUE_MANAGEMENT) / ('API.Types.ProviderPlatform.IssueManagement.ISSUE) / ('API.Types.ProviderPlatform.IssueManagement.Issue.POST_ISSUE_COMMENT)) :> API.Types.ProviderPlatform.IssueManagement.Issue.PostIssueComment)
type GetIssueMedia = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                              ('DSL)
                              (('PROVIDER_ISSUE_MANAGEMENT) / ('API.Types.ProviderPlatform.IssueManagement.ISSUE) / ('API.Types.ProviderPlatform.IssueManagement.Issue.GET_ISSUE_MEDIA)) :> API.Types.ProviderPlatform.IssueManagement.Issue.GetIssueMedia)
type PostIssueTicketStatusCallBack = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                              ('DSL)
                                              (('PROVIDER_ISSUE_MANAGEMENT) / ('API.Types.ProviderPlatform.IssueManagement.ISSUE) / ('API.Types.ProviderPlatform.IssueManagement.Issue.POST_ISSUE_TICKET_STATUS_CALL_BACK)) :> API.Types.ProviderPlatform.IssueManagement.Issue.PostIssueTicketStatusCallBack)
type PostIssueCategoryCreate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                        ('DSL)
                                        (('PROVIDER_ISSUE_MANAGEMENT) / ('API.Types.ProviderPlatform.IssueManagement.ISSUE) / ('API.Types.ProviderPlatform.IssueManagement.Issue.POST_ISSUE_CATEGORY_CREATE)) :> API.Types.ProviderPlatform.IssueManagement.Issue.PostIssueCategoryCreate)
type PostIssueCategoryUpdate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                        ('DSL)
                                        (('PROVIDER_ISSUE_MANAGEMENT) / ('API.Types.ProviderPlatform.IssueManagement.ISSUE) / ('API.Types.ProviderPlatform.IssueManagement.Issue.POST_ISSUE_CATEGORY_UPDATE)) :> API.Types.ProviderPlatform.IssueManagement.Issue.PostIssueCategoryUpdate)
type PostIssueOptionCreate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                      ('DSL)
                                      (('PROVIDER_ISSUE_MANAGEMENT) / ('API.Types.ProviderPlatform.IssueManagement.ISSUE) / ('API.Types.ProviderPlatform.IssueManagement.Issue.POST_ISSUE_OPTION_CREATE)) :> API.Types.ProviderPlatform.IssueManagement.Issue.PostIssueOptionCreate)
type PostIssueOptionUpdate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                      ('DSL)
                                      (('PROVIDER_ISSUE_MANAGEMENT) / ('API.Types.ProviderPlatform.IssueManagement.ISSUE) / ('API.Types.ProviderPlatform.IssueManagement.Issue.POST_ISSUE_OPTION_UPDATE)) :> API.Types.ProviderPlatform.IssueManagement.Issue.PostIssueOptionUpdate)
type PostIssueMessageUpsert = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                       ('DSL)
                                       (('PROVIDER_ISSUE_MANAGEMENT) / ('API.Types.ProviderPlatform.IssueManagement.ISSUE) / ('API.Types.ProviderPlatform.IssueManagement.Issue.POST_ISSUE_MESSAGE_UPSERT)) :> API.Types.ProviderPlatform.IssueManagement.Issue.PostIssueMessageUpsert)
