...
type PostMessageUploadFile = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                      ('DSL)
                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.MESSAGE) / ('API.Types.ProviderPlatform.Management.Message.POST_MESSAGE_UPLOAD_FILE)) :> API.Types.ProviderPlatform.Management.Message.PostMessageUploadFile)
type PostMessageAddLink = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                   ('DSL)
                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.MESSAGE) / ('API.Types.ProviderPlatform.Management.Message.POST_MESSAGE_ADD_LINK)) :> API.Types.ProviderPlatform.Management.Message.PostMessageAddLink)
type PostMessageAdd = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                               ('DSL)
                               (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.MESSAGE) / ('API.Types.ProviderPlatform.Management.Message.POST_MESSAGE_ADD)) :> API.Types.ProviderPlatform.Management.Message.PostMessageAdd)
type PostMessageSend = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                ('DSL)
                                (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.MESSAGE) / ('API.Types.ProviderPlatform.Management.Message.POST_MESSAGE_SEND)) :> API.Types.ProviderPlatform.Management.Message.PostMessageSend)
type PostMessageEdit = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                ('DSL)
                                (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.MESSAGE) / ('API.Types.ProviderPlatform.Management.Message.POST_MESSAGE_EDIT)) :> API.Types.ProviderPlatform.Management.Message.PostMessageEdit)
type GetMessageList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                               ('DSL)
                               (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.MESSAGE) / ('API.Types.ProviderPlatform.Management.Message.GET_MESSAGE_LIST)) :> API.Types.ProviderPlatform.Management.Message.GetMessageList)
type GetMessageInfo = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                               ('DSL)
                               (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.MESSAGE) / ('API.Types.ProviderPlatform.Management.Message.GET_MESSAGE_INFO)) :> API.Types.ProviderPlatform.Management.Message.GetMessageInfo)
type GetMessageDeliveryInfo = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                       ('DSL)
                                       (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.MESSAGE) / ('API.Types.ProviderPlatform.Management.Message.GET_MESSAGE_DELIVERY_INFO)) :> API.Types.ProviderPlatform.Management.Message.GetMessageDeliveryInfo)
type GetMessageReceiverList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                       ('DSL)
                                       (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.MESSAGE) / ('API.Types.ProviderPlatform.Management.Message.GET_MESSAGE_RECEIVER_LIST)) :> API.Types.ProviderPlatform.Management.Message.GetMessageReceiverList)
