...
type GetAccountFetchUnverifiedAccounts = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                  ('DSL)
                                                  (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.ACCOUNT) / ('API.Types.ProviderPlatform.Management.Account.GET_ACCOUNT_FETCH_UNVERIFIED_ACCOUNTS)) :> API.Types.ProviderPlatform.Management.Account.GetAccountFetchUnverifiedAccounts)
type PostAccountVerifyAccount = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                         ('DSL)
                                         (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.ACCOUNT) / ('API.Types.ProviderPlatform.Management.Account.POST_ACCOUNT_VERIFY_ACCOUNT)) :> API.Types.ProviderPlatform.Management.Account.PostAccountVerifyAccount)
type PutAccountUpdateRole = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                     ('DSL)
                                     (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.ACCOUNT) / ('API.Types.ProviderPlatform.Management.Account.PUT_ACCOUNT_UPDATE_ROLE)) :> API.Types.ProviderPlatform.Management.Account.PutAccountUpdateRole)
