...
type GetDriverPaymentDue = (ApiAuth ('DRIVER_OFFER_BPP)
                                    ('DSL)
                                    (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.GET_DRIVER_PAYMENT_DUE)) :> API.Types.Dashboard.RideBooking.Driver.GetDriverPaymentDue)
type PostDriverEnable = (ApiAuth ('DRIVER_OFFER_BPP)
                                 ('DSL)
                                 (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.POST_DRIVER_ENABLE)) :> API.Types.Dashboard.RideBooking.Driver.PostDriverEnable)
type PostDriverCollectCash = (ApiAuth ('DRIVER_OFFER_BPP)
                                      ('DSL)
                                      (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.POST_DRIVER_COLLECT_CASH)) :> API.Types.Dashboard.RideBooking.Driver.PostDriverCollectCash)
type PostDriverV2CollectCash = (ApiAuth ('DRIVER_OFFER_BPP)
                                        ('DSL)
                                        (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.POST_DRIVER_V2_COLLECT_CASH)) :> API.Types.Dashboard.RideBooking.Driver.PostDriverV2CollectCash)
type PostDriverExemptCash = (ApiAuth ('DRIVER_OFFER_BPP)
                                     ('DSL)
                                     (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.POST_DRIVER_EXEMPT_CASH)) :> API.Types.Dashboard.RideBooking.Driver.PostDriverExemptCash)
type PostDriverV2ExemptCash = (ApiAuth ('DRIVER_OFFER_BPP)
                                       ('DSL)
                                       (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.POST_DRIVER_V2_EXEMPT_CASH)) :> API.Types.Dashboard.RideBooking.Driver.PostDriverV2ExemptCash)
type GetDriverInfo = (ApiAuth ('DRIVER_OFFER_BPP)
                              ('DSL)
                              (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.GET_DRIVER_INFO)) :> API.Types.Dashboard.RideBooking.Driver.GetDriverInfo)
type GetDriverFeedbackList = (ApiAuth ('DRIVER_OFFER_BPP)
                                      ('DSL)
                                      (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.GET_DRIVER_FEEDBACK_LIST)) :> API.Types.Dashboard.RideBooking.Driver.GetDriverFeedbackList)
type PostDriverUnlinkVehicle = (ApiAuth ('DRIVER_OFFER_BPP)
                                        ('DSL)
                                        (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.POST_DRIVER_UNLINK_VEHICLE)) :> API.Types.Dashboard.RideBooking.Driver.PostDriverUnlinkVehicle)
type PostDriverEndRCAssociation = (ApiAuth ('DRIVER_OFFER_BPP)
                                           ('DSL)
                                           (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.POST_DRIVER_END_RC_ASSOCIATION)) :> API.Types.Dashboard.RideBooking.Driver.PostDriverEndRCAssociation)
type PostDriverDeleteAadhaar = (ApiAuth ('DRIVER_OFFER_BPP)
                                        ('DSL)
                                        (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.POST_DRIVER_DELETE_AADHAAR)) :> API.Types.Dashboard.RideBooking.Driver.PostDriverDeleteAadhaar)
type PostDriverDeletePanCard = (ApiAuth ('DRIVER_OFFER_BPP)
                                        ('DSL)
                                        (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.POST_DRIVER_DELETE_PAN_CARD)) :> API.Types.Dashboard.RideBooking.Driver.PostDriverDeletePanCard)
type PostDriverAddVehicle = (ApiAuth ('DRIVER_OFFER_BPP)
                                     ('DSL)
                                     (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.POST_DRIVER_ADD_VEHICLE)) :> API.Types.Dashboard.RideBooking.Driver.PostDriverAddVehicle)
type PostDriverSetRCStatus = (ApiAuth ('DRIVER_OFFER_BPP)
                                      ('DSL)
                                      (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.POST_DRIVER_SET_RC_STATUS)) :> API.Types.Dashboard.RideBooking.Driver.PostDriverSetRCStatus)
type PostDriverExemptDriverFee = (ApiAuth ('DRIVER_OFFER_BPP)
                                          ('DSL)
                                          (('PROVIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.DRIVER) / ('API.Types.Dashboard.RideBooking.Driver.POST_DRIVER_EXEMPT_DRIVER_FEE)) :> API.Types.Dashboard.RideBooking.Driver.PostDriverExemptDriverFee)
...
postDriverCollectCash :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverCollectCash merchantShortId opCity apiTokenInfo driverId vendorId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.RideBooking.Driver.postDriverCollectCash merchantShortId opCity apiTokenInfo driverId vendorId
postDriverV2CollectCash :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Dashboard.Common.Driver.ServiceNames -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverV2CollectCash merchantShortId opCity apiTokenInfo driverId serviceName vendorId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.RideBooking.Driver.postDriverV2CollectCash merchantShortId opCity apiTokenInfo driverId serviceName vendorId
...
getDriverInfo merchantShortId opCity apiTokenInfo mobileNumber mobileCountryCode vehicleNumber dlNumber rcNumber email personId walletId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.RideBooking.Driver.getDriverInfo merchantShortId opCity apiTokenInfo mobileNumber mobileCountryCode vehicleNumber dlNumber rcNumber email personId walletId
...
postDriverDeleteAadhaar :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverDeleteAadhaar merchantShortId opCity apiTokenInfo driverId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.RideBooking.Driver.postDriverDeleteAadhaar merchantShortId opCity apiTokenInfo driverId
postDriverDeletePanCard :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverDeletePanCard merchantShortId opCity apiTokenInfo driverId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.RideBooking.Driver.postDriverDeletePanCard merchantShortId opCity apiTokenInfo driverId
