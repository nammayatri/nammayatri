...
type GetFeedbackFormList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                    ('DSL)
                                    (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.FEEDBACK_FORM) / ('API.Types.ProviderPlatform.Management.FeedbackForm.GET_FEEDBACK_FORM_LIST)) :> API.Types.ProviderPlatform.Management.FeedbackForm.GetFeedbackFormList)
type PostFeedbackFormCreate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                       ('DSL)
                                       (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.FEEDBACK_FORM) / ('API.Types.ProviderPlatform.Management.FeedbackForm.POST_FEEDBACK_FORM_CREATE)) :> API.Types.ProviderPlatform.Management.FeedbackForm.PostFeedbackFormCreate)
type PutFeedbackFormUpdate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                      ('DSL)
                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.FEEDBACK_FORM) / ('API.Types.ProviderPlatform.Management.FeedbackForm.PUT_FEEDBACK_FORM_UPDATE)) :> API.Types.ProviderPlatform.Management.FeedbackForm.PutFeedbackFormUpdate)
type DeleteFeedbackFormDelete = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                         ('DSL)
                                         (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.FEEDBACK_FORM) / ('API.Types.ProviderPlatform.Management.FeedbackForm.DELETE_FEEDBACK_FORM_DELETE)) :> API.Types.ProviderPlatform.Management.FeedbackForm.DeleteFeedbackFormDelete)
type GetFeedbackForm = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                ('DSL)
                                (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.FEEDBACK_FORM) / ('API.Types.ProviderPlatform.Management.FeedbackForm.GET_FEEDBACK_FORM)) :> API.Types.ProviderPlatform.Management.FeedbackForm.GetFeedbackForm)
