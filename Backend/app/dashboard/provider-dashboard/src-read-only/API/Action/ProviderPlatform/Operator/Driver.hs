...
type GetDriverOperatorFetchHubRequests = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                  ('DSL)
                                                  (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.DRIVER) / ('API.Types.ProviderPlatform.Operator.Driver.GET_DRIVER_OPERATOR_FETCH_HUB_REQUESTS)) :> API.Types.ProviderPlatform.Operator.Driver.GetDriverOperatorFetchHubRequests)
type GetDriverOperationGetAllHubs = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                             ('DSL)
                                             (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.DRIVER) / ('API.Types.ProviderPlatform.Operator.Driver.GET_DRIVER_OPERATION_GET_ALL_HUBS)) :> API.Types.ProviderPlatform.Operator.Driver.GetDriverOperationGetAllHubs)
type PostDriverOperatorRespondHubRequest = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                    ('DSL)
                                                    (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.DRIVER) / ('API.Types.ProviderPlatform.Operator.Driver.POST_DRIVER_OPERATOR_RESPOND_HUB_REQUEST)) :> API.Types.ProviderPlatform.Operator.Driver.PostDriverOperatorRespondHubRequest)
type PostDriverOperatorCreateRequest = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                ('DSL)
                                                (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.DRIVER) / ('API.Types.ProviderPlatform.Operator.Driver.POST_DRIVER_OPERATOR_CREATE_REQUEST)) :> API.Types.ProviderPlatform.Operator.Driver.PostDriverOperatorCreateRequest)
type GetDriverOperatorList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                      ('DSL)
                                      (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.DRIVER) / ('API.Types.ProviderPlatform.Operator.Driver.GET_DRIVER_OPERATOR_LIST)) :> API.Types.ProviderPlatform.Operator.Driver.GetDriverOperatorList)
type PostDriverOperatorSendJoiningOtp = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                 ('DSL)
                                                 (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.DRIVER) / ('API.Types.ProviderPlatform.Operator.Driver.POST_DRIVER_OPERATOR_SEND_JOINING_OTP)) :> API.Types.ProviderPlatform.Operator.Driver.PostDriverOperatorSendJoiningOtp)
type PostDriverOperatorVerifyJoiningOtp = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                   ('DSL)
                                                   (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.DRIVER) / ('API.Types.ProviderPlatform.Operator.Driver.POST_DRIVER_OPERATOR_VERIFY_JOINING_OTP)) :> API.Types.ProviderPlatform.Operator.Driver.PostDriverOperatorVerifyJoiningOtp)
type GetDriverOperatorDashboardAnalyticsAllTime = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                           ('DSL)
                                                           (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.DRIVER) / ('API.Types.ProviderPlatform.Operator.Driver.GET_DRIVER_OPERATOR_DASHBOARD_ANALYTICS_ALL_TIME)) :> API.Types.ProviderPlatform.Operator.Driver.GetDriverOperatorDashboardAnalyticsAllTime)
type GetDriverOperatorDashboardAnalytics = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                    ('DSL)
                                                    (('PROVIDER_OPERATOR) / ('API.Types.ProviderPlatform.Operator.DRIVER) / ('API.Types.ProviderPlatform.Operator.Driver.GET_DRIVER_OPERATOR_DASHBOARD_ANALYTICS)) :> API.Types.ProviderPlatform.Operator.Driver.GetDriverOperatorDashboardAnalytics)
