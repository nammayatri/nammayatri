...
getDriverOperatorList merchantShortId opCity apiTokenInfo isActive limit offset vehicleNo mbSearchString onlyMandatoryDocs useMessageTranslation = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Operator.Driver.getDriverOperatorList merchantShortId opCity apiTokenInfo isActive limit offset vehicleNo mbSearchString onlyMandatoryDocs useMessageTranslation
