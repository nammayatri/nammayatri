...
getDriverOperatorList merchantShortId opCity apiTokenInfo isActive limit offset driverId vehicleNo = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Operator.Driver.getDriverOperatorList merchantShortId opCity apiTokenInfo isActive limit offset driverId vehicleNo
