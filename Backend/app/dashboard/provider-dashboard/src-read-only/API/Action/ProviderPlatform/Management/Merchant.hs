...
type PostMerchantConfigFailover = (ApiAuth 'DRIVER_OFFER_BPP_MANAGEMENT 'MERCHANT 'TOGGLE_CONFIG_PRIORITY :> API.Types.ProviderPlatform.Management.Merchant.PostMerchantConfigFailover)
