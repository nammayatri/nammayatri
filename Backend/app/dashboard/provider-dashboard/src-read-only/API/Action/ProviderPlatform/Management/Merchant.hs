...
type PostMerchantUpdateVehicleServiceTier =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.MERCHANT / 'API.Types.ProviderPlatform.Management.Merchant.POST_MERCHANT_UPDATE_VEHICLE_SERVICE_TIER)
      :> API.Types.ProviderPlatform.Management.Merchant.PostMerchantUpdateVehicleServiceTier
  )
...
postMerchantUpdateVehicleServiceTier :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> API.Types.ProviderPlatform.Management.Merchant.UpdateVehicleServiceTierReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postMerchantUpdateVehicleServiceTier merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Merchant.postMerchantUpdateVehicleServiceTier merchantShortId opCity apiTokenInfo req
