...
type PostMerchantConfigOnboardingDocumentReplicate =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.MERCHANT / 'API.Types.ProviderPlatform.Management.Merchant.POST_MERCHANT_CONFIG_ONBOARDING_DOCUMENT_REPLICATE)
      :> API.Types.ProviderPlatform.Management.Merchant.PostMerchantConfigOnboardingDocumentReplicate
  )
...
postMerchantConfigOnboardingDocumentReplicate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> API.Types.ProviderPlatform.Management.Merchant.DocumentVerificationConfigReplicateReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postMerchantConfigOnboardingDocumentReplicate merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Merchant.postMerchantConfigOnboardingDocumentReplicate merchantShortId opCity apiTokenInfo req
