...
type GetMerchantListWithCities =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.MERCHANT / 'API.Types.ProviderPlatform.Management.Merchant.GET_MERCHANT_LIST_WITH_CITIES)
      :> API.Types.ProviderPlatform.Management.Merchant.GetMerchantListWithCities
  )
...
getMerchantListWithCities :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Environment.FlowHandler [Dashboard.Common.Merchant.MerchantWithCities])
getMerchantListWithCities merchantShortId opCity apiTokenInfo = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Merchant.getMerchantListWithCities merchantShortId opCity apiTokenInfo
