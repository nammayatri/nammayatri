...
type PostMerchantSchedulerRevive =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.MERCHANT) / ('API.Types.ProviderPlatform.Management.Merchant.POST_MERCHANT_SCHEDULER_REVIVE))
      :> API.Types.ProviderPlatform.Management.Merchant.PostMerchantSchedulerRevive
  )
...
postMerchantSchedulerRevive :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> API.Types.ProviderPlatform.Management.Merchant.ReviveSchedulerJobsReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.ReviveSchedulerJobsRes)
postMerchantSchedulerRevive merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Merchant.postMerchantSchedulerRevive merchantShortId opCity apiTokenInfo req
