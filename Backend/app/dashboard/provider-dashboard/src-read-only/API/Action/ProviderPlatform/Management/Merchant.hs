...
type PostMerchantVehicleServiceTierUpsert =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.MERCHANT / 'API.Types.ProviderPlatform.Management.Merchant.POST_MERCHANT_VEHICLE_SERVICE_TIER_UPSERT)
      :> API.Types.ProviderPlatform.Management.Merchant.PostMerchantVehicleServiceTierUpsert
  )
...
postMerchantVehicleServiceTierUpsert :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> API.Types.ProviderPlatform.Management.Merchant.UpdateVehicleServiceTierReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postMerchantVehicleServiceTierUpsert merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Merchant.postMerchantVehicleServiceTierUpsert merchantShortId opCity apiTokenInfo req
