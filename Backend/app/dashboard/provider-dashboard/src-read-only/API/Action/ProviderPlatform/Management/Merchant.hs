...
type GetMerchantConfigPushNotification =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.MERCHANT / 'API.Types.ProviderPlatform.Management.Merchant.GET_MERCHANT_CONFIG_PUSH_NOTIFICATION)
      :> API.Types.ProviderPlatform.Management.Merchant.GetMerchantConfigPushNotification
  )
...
type GetMerchantConfigPushNotificationKeys =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.MERCHANT / 'API.Types.ProviderPlatform.Management.Merchant.GET_MERCHANT_CONFIG_PUSH_NOTIFICATION_KEYS)
      :> API.Types.ProviderPlatform.Management.Merchant.GetMerchantConfigPushNotificationKeys
  )
...
type PostMerchantConfigPushNotificationUpsert =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.MERCHANT / 'API.Types.ProviderPlatform.Management.Merchant.POST_MERCHANT_CONFIG_PUSH_NOTIFICATION_UPSERT)
      :> API.Types.ProviderPlatform.Management.Merchant.PostMerchantConfigPushNotificationUpsert
  )
...
type DeleteMerchantConfigPushNotificationDelete =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.MERCHANT / 'API.Types.ProviderPlatform.Management.Merchant.DELETE_MERCHANT_CONFIG_PUSH_NOTIFICATION_DELETE)
      :> API.Types.ProviderPlatform.Management.Merchant.DeleteMerchantConfigPushNotificationDelete
  )
...
type PostMerchantMerchantMessageDelete =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.MERCHANT / 'API.Types.ProviderPlatform.Management.Merchant.POST_MERCHANT_MERCHANT_MESSAGE_DELETE)
      :> API.Types.ProviderPlatform.Management.Merchant.PostMerchantMerchantMessageDelete
  )
...
postMerchantConfigDriverPoolUpsert :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Dashboard.Common.Merchant.UpsertDriverPoolConfigCsvReq -> Environment.FlowHandler Dashboard.Common.Merchant.APISuccessWithUnprocessedEntities)
...
getMerchantConfigDriverPoolList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.DriverPoolConfigListRes)
...
getMerchantConfigFarePolicyDetails :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.FarePolicy -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.FarePolicyDetailsResp)
...
getMerchantConfigSpecialLocationList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Lib.Types.SpecialLocation.SpecialLocationType -> Kernel.Prelude.Maybe [Lib.Types.SpecialLocation.SpecialLocationType] -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.SpecialLocationResp)
...
getMerchantConfigGeometryList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.GeometryResp)
...
getMerchantConfigTollList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.TollListResp)
...
getMerchantConfigVehicleServiceTier :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe Dashboard.Common.ServiceTierType -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.VehicleServiceTierRes)
...
getMerchantConfigVehicleServiceTierList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.VehicleServiceTierListRes)
...
postMerchantConfigVehicleServiceTierUpdate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Dashboard.Common.ServiceTierType -> API.Types.ProviderPlatform.Management.Merchant.VehicleServiceTierConfigUpdateReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
postMerchantConfigVehicleServiceTierCreate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> API.Types.ProviderPlatform.Management.Merchant.VehicleServiceTierConfigCreateReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
getMerchantConfigPushNotification merchantShortId opCity apiTokenInfo limit offset key language isCritical shouldTrigger = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Merchant.getMerchantConfigPushNotification merchantShortId opCity apiTokenInfo limit offset key language isCritical shouldTrigger
...
getMerchantConfigPushNotificationKeys merchantShortId opCity apiTokenInfo = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Merchant.getMerchantConfigPushNotificationKeys merchantShortId opCity apiTokenInfo
...
postMerchantConfigPushNotificationUpsert merchantShortId opCity apiTokenInfo toggle allLanguages req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Merchant.postMerchantConfigPushNotificationUpsert merchantShortId opCity apiTokenInfo toggle allLanguages req
...
deleteMerchantConfigPushNotificationDelete merchantShortId opCity apiTokenInfo notificationId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Merchant.deleteMerchantConfigPushNotificationDelete merchantShortId opCity apiTokenInfo notificationId

getMerchantMerchantDocumentList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe Kernel.External.Types.Language -> API.Types.ProviderPlatform.Management.Merchant.MerchantDocumentRoleT -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.MerchantDocumentListResp)
...
postMerchantMerchantDocumentCreate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> API.Types.ProviderPlatform.Management.Merchant.CreateMerchantDocumentReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.MerchantDocumentItem)
...
postMerchantMerchantDocumentUpdate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> API.Types.ProviderPlatform.Management.Merchant.UpdateMerchantDocumentReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.MerchantDocumentItem)
...
postMerchantMerchantMessageDelete :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> API.Types.ProviderPlatform.Management.Merchant.DeleteMerchantMessageReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postMerchantMerchantMessageDelete merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Merchant.postMerchantMerchantMessageDelete merchantShortId opCity apiTokenInfo req
