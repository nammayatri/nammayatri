...
getDriverFleetOperatorInfo merchantShortId opCity apiTokenInfo mobileCountryCode mobileNumber personId role = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetOperatorInfo merchantShortId opCity apiTokenInfo mobileCountryCode mobileNumber personId role
