...
type PostDriverFleetChangeDriver =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_FLEET / 'API.Types.ProviderPlatform.Fleet.DRIVER / 'API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_FLEET_CHANGE_DRIVER)
      :> API.Types.ProviderPlatform.Fleet.Driver.PostDriverFleetChangeDriver
  )
...
postDriverFleetChangeDriver :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> API.Types.ProviderPlatform.Fleet.Driver.ChangeFleetDriverReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetChangeDriver merchantShortId opCity apiTokenInfo driverId fleetOwnerId req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetChangeDriver merchantShortId opCity apiTokenInfo driverId fleetOwnerId req
