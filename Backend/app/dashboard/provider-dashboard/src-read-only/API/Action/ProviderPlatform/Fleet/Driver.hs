...
type GetDriverFleetOwnerList =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.GET_DRIVER_FLEET_OWNER_LIST))
      :> API.Types.ProviderPlatform.Fleet.Driver.GetDriverFleetOwnerList
  )
...
type PostDriverAddRidePayoutAccountNumber =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_ADD_RIDE_PAYOUT_ACCOUNT_NUMBER))
...
type PostDriverFleetCashRideUpdate =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_FLEET_CASH_RIDE_UPDATE))
...
type GetDriverFleetDriverListStats =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.GET_DRIVER_FLEET_DRIVER_LIST_STATS))
...
type PostDriverFleetVehicleEdit =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_FLEET_VEHICLE_EDIT))
...
type PostDriverFleetDashboardAnalyticsCache =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_FLEET_DASHBOARD_ANALYTICS_CACHE))
...
type PostDriverFleetApproveDriver =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_FLEET_APPROVE_DRIVER))
...
type PostDriverFleetDriverUpdate =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_FLEET_DRIVER_UPDATE))
...
type PostDriverFleetDriverChangeFleetOwner =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_FLEET_DRIVER_CHANGE_FLEET_OWNER))
...
type PostDriverFleetVehicleChangeFleetOwner =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_FLEET_VEHICLE_CHANGE_FLEET_OWNER))
...
type GetDriverFleetDriverDetails =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.GET_DRIVER_FLEET_DRIVER_DETAILS))
...
type PostDriverFleetTripTransactionsV2 =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_FLEET_TRIP_TRANSACTIONS_V2))
...
type GetDriverFleetVehicleListStats =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.GET_DRIVER_FLEET_VEHICLE_LIST_STATS))
...
type GetDriverFleetDriverOnboardedDriversAndUnlinkedVehicles =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.GET_DRIVER_FLEET_DRIVER_ONBOARDED_DRIVERS_AND_UNLINKED_VEHICLES))
...
type GetDriverFleetStatusSummary =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.GET_DRIVER_FLEET_STATUS_SUMMARY))
...
type GetDriverFleetScheduledBookingList =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.GET_DRIVER_FLEET_SCHEDULED_BOOKING_LIST))
...
type PostDriverFleetScheduledBookingAssign =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_FLEET_SCHEDULED_BOOKING_ASSIGN))
...
type PostDriverFleetScheduledBookingCancel =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_FLEET_SCHEDULED_BOOKING_CANCEL))
...
type PostDriverFleetScheduledBookingReassign =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_FLEET_SCHEDULED_BOOKING_REASSIGN))
      :> API.Types.ProviderPlatform.Fleet.Driver.PostDriverFleetScheduledBookingReassign
  )

type GetDriverVehicleInfo =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_FLEET) / ('API.Types.ProviderPlatform.Fleet.DRIVER) / ('API.Types.ProviderPlatform.Fleet.Driver.GET_DRIVER_VEHICLE_INFO))
      :> API.Types.ProviderPlatform.Fleet.Driver.GetDriverVehicleInfo
  )

getDriverFleetAccessList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.FleetOwnerListRes)
...
postDriverFleetAddVehicles :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> API.Types.ProviderPlatform.Fleet.Driver.CreateVehiclesReq -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.APISuccessWithUnprocessedEntities)
...
postDriverAddRidePayoutAccountNumber :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.ProviderPlatform.Fleet.Driver.AddRidePayoutAccountNumberReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverAddRidePayoutAccountNumber merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverAddRidePayoutAccountNumber merchantShortId opCity apiTokenInfo req
...
postDriverFleetRespondDriverRequest :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> API.Types.ProviderPlatform.Fleet.Driver.RequestRespondReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
postDriverFleetAddRCWithoutDriver :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Dashboard.ProviderPlatform.Management.DriverRegistration.RegisterRCReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
getDriverFleetGetAllVehicle merchantShortId opCity apiTokenInfo mblimit mboffset mbRegNumberString mbFleetOwnerId mbIsActive mbMemberPersonId mbSendDriverMobileNumber verified approvalStatus isRcActive = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetGetAllVehicle merchantShortId opCity apiTokenInfo mblimit mboffset mbRegNumberString mbFleetOwnerId mbIsActive mbMemberPersonId mbSendDriverMobileNumber verified approvalStatus isRcActive
...
getDriverFleetGetAllDriver merchantShortId opCity apiTokenInfo mblimit mboffset mbMobileNumberString mbNameString mbSearchString mbFleetOwnerId mbIsActive mbMemberPersonId verified approvalStatus enabled blocked onboardingAs fleetDriverAssociationConsent = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetGetAllDriver merchantShortId opCity apiTokenInfo mblimit mboffset mbMobileNumberString mbNameString mbSearchString mbFleetOwnerId mbIsActive mbMemberPersonId verified approvalStatus enabled blocked onboardingAs fleetDriverAssociationConsent
...
postDriverFleetUnlink :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Text -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
postDriverFleetRemoveVehicle :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Text -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
postDriverFleetCashRideUpdate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> API.Types.ProviderPlatform.Fleet.Driver.UpdateCashRideReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetCashRideUpdate merchantShortId opCity apiTokenInfo fleetOwnerId req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetCashRideUpdate merchantShortId opCity apiTokenInfo fleetOwnerId req

postDriverFleetRemoveDriver :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetRemoveDriver merchantShortId opCity apiTokenInfo driverId fleetOwnerId operatorCode = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetRemoveDriver merchantShortId opCity apiTokenInfo driverId fleetOwnerId operatorCode
...
getDriverFleetAssignments merchantShortId opCity apiTokenInfo limit offset from to vehicleNo mainAssignmentId bookingId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetAssignments merchantShortId opCity apiTokenInfo limit offset from to vehicleNo mainAssignmentId bookingId
...
getDriverFleetDriverListStats :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Data.Time.Day) -> Kernel.Prelude.Maybe (Data.Time.Day) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Bool) -> Kernel.Prelude.Maybe (API.Types.ProviderPlatform.Fleet.Driver.FleetDriverListStatsSortOn) -> Kernel.Prelude.Maybe (API.Types.ProviderPlatform.Fleet.Driver.FleetDriverStatsResponseType) -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.FleetDriverStatsListRes)
getDriverFleetDriverListStats merchantShortId opCity apiTokenInfo from to fleetOwnerId search driverNumber driverPhoneCountryCode limit offset sortDesc sortOn responseType = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetDriverListStats merchantShortId opCity apiTokenInfo from to fleetOwnerId search driverNumber driverPhoneCountryCode limit offset sortDesc sortOn responseType
...
getDriverFleetDriverAssociation merchantShortId opCity apiTokenInfo isActive limit offset countryCode phoneNo includeStats from to status name mbSearchString fleetOwnerId mbRequestorId hasFleetMemberHierarchy isRequestorFleerOwner hasRequestReason mbServiceTier enabled approved driverDocsVerificationStatus driverId pickLatestDoc = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetDriverAssociation merchantShortId opCity apiTokenInfo isActive limit offset countryCode phoneNo includeStats from to status name mbSearchString fleetOwnerId mbRequestorId hasFleetMemberHierarchy isRequestorFleerOwner hasRequestReason mbServiceTier enabled approved driverDocsVerificationStatus driverId pickLatestDoc
...
getDriverFleetVehicleAssociation merchantShortId opCity apiTokenInfo limit offset vehicleNo includeStats from to status mbSearchString statusAwareVehicleNo fleetOwnerId mbRequestorId hasFleetMemberHierarchy isRequestorFleerOwner approved vehicleDocsVerificationStatus pickLatestDoc = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetVehicleAssociation merchantShortId opCity apiTokenInfo limit offset vehicleNo includeStats from to status mbSearchString statusAwareVehicleNo fleetOwnerId mbRequestorId hasFleetMemberHierarchy isRequestorFleerOwner approved vehicleDocsVerificationStatus pickLatestDoc
...
postDriverFleetVehicleEdit merchantShortId opCity apiTokenInfo fleetOwnerId driverId vehicleNo rcId req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetVehicleEdit merchantShortId opCity apiTokenInfo fleetOwnerId driverId vehicleNo rcId req

postDriverFleetVehicleDriverRcStatus :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> API.Types.ProviderPlatform.Fleet.Driver.RCStatusReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
postDriverUpdateFleetOwnerInfo :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> API.Types.ProviderPlatform.Fleet.Driver.UpdateFleetOwnerInfoReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
getDriverFleetOwnerInfo :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.FleetOwnerInfoRes)
...
getDriverFleetOperatorInfo merchantShortId opCity apiTokenInfo mobileCountryCode mobileNumber personId walletId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetOperatorInfo merchantShortId opCity apiTokenInfo mobileCountryCode mobileNumber personId walletId

postDriverFleetSendJoiningOtp :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Dashboard.ProviderPlatform.Management.DriverRegistration.AuthReq -> Environment.FlowHandler Dashboard.ProviderPlatform.Management.DriverRegistration.AuthRes)
...
getDriverFleetRoutes :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.External.Maps.Types.LatLong) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Int -> Kernel.Prelude.Int -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.RouteAPIResp)
...
getDriverFleetPossibleRoutes :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Text -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.RouteAPIResp)
...
postDriverFleetTripPlanner :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> API.Types.ProviderPlatform.Fleet.Driver.TripPlannerReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
postDriverFleetAddDrivers :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> API.Types.ProviderPlatform.Fleet.Driver.CreateDriversReq -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.AddDriversResp)
...
postDriverFleetAddDriverBusRouteMapping :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> API.Types.ProviderPlatform.Fleet.Driver.CreateDriverBusRouteMappingReq -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.APISuccessWithUnprocessedEntities)
...
postDriverFleetLinkRCWithDriver :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> API.Types.ProviderPlatform.Fleet.Driver.LinkRCWithDriverForFleetReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
postDriverDashboardFleetWmbTripEnd :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Types.Id.Id Dashboard.Common.TripTransaction -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Dashboard.Common.ActionSource) -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
getDriverFleetWmbRouteDetails :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Text -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.RouteDetails)
...
postDriverFleetGetNearbyDrivers :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.ProviderPlatform.Fleet.Driver.NearbyDriverReq -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.NearbyDriverRespT)
...
postDriverDashboardFleetTrackDriver :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> API.Types.ProviderPlatform.Fleet.Driver.TrackDriverLocationsReq -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.TrackDriverLocationsRes)
...
getDriverFleetStatus :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.DriverStatusRes)
...
postDriverFleetLocationList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.ProviderPlatform.Fleet.Driver.DriverLocationListReq -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.DriverLocationListResp)
...
postDriverFleetGetDriverDetails :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.ProviderPlatform.Fleet.Driver.DriverDetailsReq -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.DriverDetailsResp)
...
postDriverFleetGetNearbyDriversV2 :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.ProviderPlatform.Fleet.Driver.NearbyDriversReqV2 -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.NearbyDriversRespTV2)
...
getDriverFleetDashboardAnalyticsAllTime :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.AllTimeFleetAnalyticsRes)
getDriverFleetDashboardAnalyticsAllTime merchantShortId opCity apiTokenInfo fleetOwnerId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetDashboardAnalyticsAllTime merchantShortId opCity apiTokenInfo fleetOwnerId
...
getDriverFleetDashboardAnalytics merchantShortId opCity apiTokenInfo fleetOwnerId responseType from to = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetDashboardAnalytics merchantShortId opCity apiTokenInfo fleetOwnerId responseType from to

postDriverFleetDashboardAnalyticsCache :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.ProviderPlatform.Fleet.Driver.FleetDashboardAnalyticsCacheReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetDashboardAnalyticsCache merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetDashboardAnalyticsCache merchantShortId opCity apiTokenInfo req

postDriverDashboardFleetEstimateRoute :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> API.Types.ProviderPlatform.Fleet.Driver.EstimateRouteReq -> Environment.FlowHandler Kernel.External.Maps.GetRoutesResp)
...
postDriverFleetApproveDriver :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.ProviderPlatform.Fleet.Driver.ApproveDriverReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetApproveDriver merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetApproveDriver merchantShortId opCity apiTokenInfo req

postDriverFleetDriverUpdate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Types.Id.Id Dashboard.Common.Driver -> API.Types.ProviderPlatform.Fleet.Driver.UpdateDriverReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetDriverUpdate merchantShortId opCity apiTokenInfo driverId req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetDriverUpdate merchantShortId opCity apiTokenInfo driverId req

postDriverFleetDriverChangeFleetOwner :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Types.Id.Id Dashboard.Common.Driver -> API.Types.ProviderPlatform.Fleet.Driver.ChangeFleetOwnerReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetDriverChangeFleetOwner merchantShortId opCity apiTokenInfo driverId req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetDriverChangeFleetOwner merchantShortId opCity apiTokenInfo driverId req

postDriverFleetVehicleChangeFleetOwner :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Text -> API.Types.ProviderPlatform.Fleet.Driver.ChangeFleetOwnerReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetVehicleChangeFleetOwner merchantShortId opCity apiTokenInfo rcNo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetVehicleChangeFleetOwner merchantShortId opCity apiTokenInfo rcNo req

getDriverFleetDriverDetails :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.DriverDetailsRes)
getDriverFleetDriverDetails merchantShortId opCity apiTokenInfo driverId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetDriverDetails merchantShortId opCity apiTokenInfo driverId
...
postDriverFleetTripTransactionsV2 merchantShortId opCity apiTokenInfo mbFrom mbTo mbVehicleNumber fleetOwnerId mbMemberPersonId mbStatus mbDriverId mbDutyType limit offset = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetTripTransactionsV2 merchantShortId opCity apiTokenInfo mbFrom mbTo mbVehicleNumber fleetOwnerId mbMemberPersonId mbStatus mbDriverId mbDutyType limit offset
...
getDriverFleetVehicleListStats merchantShortId opCity apiTokenInfo fleetOwnerId vehicleNo limit offset from to = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetVehicleListStats merchantShortId opCity apiTokenInfo fleetOwnerId vehicleNo limit offset from to
...
getDriverFleetDriverOnboardedDriversAndUnlinkedVehicles merchantShortId opCity apiTokenInfo fleetOwnerId limit offset = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetDriverOnboardedDriversAndUnlinkedVehicles merchantShortId opCity apiTokenInfo fleetOwnerId limit offset

getDriverFleetStatusSummary :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.ProviderPlatform.Fleet.Driver.EntityOperationType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.StatusSummaryResponse)
getDriverFleetStatusSummary merchantShortId opCity apiTokenInfo entityOperationType fleetOwnerId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetStatusSummary merchantShortId opCity apiTokenInfo entityOperationType fleetOwnerId

getDriverFleetScheduledBookingList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Data.Time.Day) -> Kernel.Prelude.Maybe (Data.Time.Day) -> Kernel.Prelude.Maybe (Dashboard.Common.TripCategory) -> Kernel.Prelude.Maybe (Kernel.External.Maps.Types.LatLong) -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.FleetScheduledBookingListRes)
getDriverFleetScheduledBookingList merchantShortId opCity apiTokenInfo limit offset from to tripCategory currentLocation = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetScheduledBookingList merchantShortId opCity apiTokenInfo limit offset from to tripCategory currentLocation

postDriverFleetScheduledBookingAssign :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.ProviderPlatform.Fleet.Driver.AssignScheduledBookingReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetScheduledBookingAssign merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetScheduledBookingAssign merchantShortId opCity apiTokenInfo req

postDriverFleetScheduledBookingCancel :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.ProviderPlatform.Fleet.Driver.CancelScheduledBookingReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetScheduledBookingCancel merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetScheduledBookingCancel merchantShortId opCity apiTokenInfo req

postDriverFleetScheduledBookingReassign :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.ProviderPlatform.Fleet.Driver.ReassignScheduledBookingReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetScheduledBookingReassign merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetScheduledBookingReassign merchantShortId opCity apiTokenInfo req

getDriverVehicleInfo :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.VehicleInfo)
getDriverVehicleInfo merchantShortId opCity apiTokenInfo vehicleNo rcId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverVehicleInfo merchantShortId opCity apiTokenInfo vehicleNo rcId
