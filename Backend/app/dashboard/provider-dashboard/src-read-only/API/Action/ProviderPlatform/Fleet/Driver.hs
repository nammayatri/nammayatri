...
type PostDriverFleetUnlinkDocument =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_FLEET / 'API.Types.ProviderPlatform.Fleet.DRIVER / 'API.Types.ProviderPlatform.Fleet.Driver.POST_DRIVER_FLEET_UNLINK_DOCUMENT)
      :> API.Types.ProviderPlatform.Fleet.Driver.PostDriverFleetUnlinkDocument
  )
...
getDriverFleetGetDriverRequests merchantShortId opCity apiTokenInfo mbFrom mbTo mbRequestType mbRouteCode mbDriverId mbBadgeName mbFleetOwnerId mbLimit mbOffset = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetGetDriverRequests merchantShortId opCity apiTokenInfo mbFrom mbTo mbRequestType mbRouteCode mbDriverId mbBadgeName mbFleetOwnerId mbLimit mbOffset
...
postDriverFleetUnlinkDocument :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.Driver -> API.Types.ProviderPlatform.Fleet.Driver.DocumentType -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetUnlinkDocument merchantShortId opCity apiTokenInfo driverId documentType fleetOwnerId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.postDriverFleetUnlinkDocument merchantShortId opCity apiTokenInfo driverId documentType fleetOwnerId
