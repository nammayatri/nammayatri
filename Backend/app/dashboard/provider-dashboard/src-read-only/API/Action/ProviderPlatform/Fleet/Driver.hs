...
getDriverFleetDriverListStats merchantShortId opCity apiTokenInfo from to fleetOwnerId search limit offset sortDesc sortOn responseType = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetDriverListStats merchantShortId opCity apiTokenInfo from to fleetOwnerId search limit offset sortDesc sortOn responseType
