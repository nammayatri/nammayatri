...
postDriverFleetCashRideUpdate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> API.Types.ProviderPlatform.Fleet.Driver.UpdateCashRideReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
postDriverFleetDriverChangeFleetOwner :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.Driver -> API.Types.ProviderPlatform.Fleet.Driver.ChangeFleetOwnerReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
postDriverFleetVehicleChangeFleetOwner :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Text -> API.Types.ProviderPlatform.Fleet.Driver.ChangeFleetOwnerReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
