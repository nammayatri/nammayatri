...
getDriverDashboardFleetTripWaypoints :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.TripTransaction -> Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.TripTransactionWaypointsRes)
getDriverDashboardFleetTripWaypoints merchantShortId opCity apiTokenInfo tripTransactionId fleetOwnerId memberPersonId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverDashboardFleetTripWaypoints merchantShortId opCity apiTokenInfo tripTransactionId fleetOwnerId memberPersonId
