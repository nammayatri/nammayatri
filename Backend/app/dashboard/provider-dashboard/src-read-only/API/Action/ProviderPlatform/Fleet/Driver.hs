...
getDriverFleetDriverListStats merchantShortId opCity apiTokenInfo from to search limit offset sortDesc sortOn responseType = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetDriverListStats merchantShortId opCity apiTokenInfo from to search limit offset sortDesc sortOn responseType
...
getDriverFleetDashboardAnalytics :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe API.Types.ProviderPlatform.Fleet.Driver.FleetAnalyticsResponseType -> Data.Time.Day -> Data.Time.Day -> Environment.FlowHandler API.Types.ProviderPlatform.Fleet.Driver.FleetAnalyticsRes)
getDriverFleetDashboardAnalytics merchantShortId opCity apiTokenInfo responseType from to = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetDashboardAnalytics merchantShortId opCity apiTokenInfo responseType from to
...
getDriverFleetVehicleListStats merchantShortId opCity apiTokenInfo vehicleNo limit offset from to = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetVehicleListStats merchantShortId opCity apiTokenInfo vehicleNo limit offset from to
