...
getDriverFleetVehicleListStats merchantShortId opCity apiTokenInfo vehicleNo limit offset useDb from to = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Fleet.Driver.getDriverFleetVehicleListStats merchantShortId opCity apiTokenInfo vehicleNo limit offset useDb from to
