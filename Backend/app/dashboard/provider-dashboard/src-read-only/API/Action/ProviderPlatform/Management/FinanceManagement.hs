...
type GetFinanceManagementFinanceInvoicePdfUrl =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.FINANCE_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.FinanceManagement.GET_FINANCE_MANAGEMENT_FINANCE_INVOICE_PDF_URL))
      :> API.Types.ProviderPlatform.Management.FinanceManagement.GetFinanceManagementFinanceInvoicePdfUrl
  )
...
getFinanceManagementFinanceInvoicePdfUrl :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Text -> Environment.FlowHandler API.Types.ProviderPlatform.Management.FinanceManagement.FinanceInvoicePdfUrlResp)
getFinanceManagementFinanceInvoicePdfUrl merchantShortId opCity apiTokenInfo invoiceId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.FinanceManagement.getFinanceManagementFinanceInvoicePdfUrl merchantShortId opCity apiTokenInfo invoiceId
