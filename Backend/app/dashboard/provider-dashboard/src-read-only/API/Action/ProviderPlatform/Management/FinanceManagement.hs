...
getFinanceManagementFinanceSapJournalsTransactions merchantShortId opCity apiTokenInfo description limit offset subscriptionId sapBatchId transactionType = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.FinanceManagement.getFinanceManagementFinanceSapJournalsTransactions merchantShortId opCity apiTokenInfo description limit offset subscriptionId sapBatchId transactionType
