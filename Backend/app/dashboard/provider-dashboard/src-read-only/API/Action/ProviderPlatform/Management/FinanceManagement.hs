...
getFinanceManagementFinanceSapJournalsTransactions merchantShortId opCity apiTokenInfo description fromTime limit offset subscriptionId toTime periodEndTime periodStartTime transactionType = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.FinanceManagement.getFinanceManagementFinanceSapJournalsTransactions merchantShortId opCity apiTokenInfo description fromTime limit offset subscriptionId toTime periodEndTime periodStartTime transactionType
