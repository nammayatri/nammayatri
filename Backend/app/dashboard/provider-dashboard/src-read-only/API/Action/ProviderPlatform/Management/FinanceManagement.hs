...
getFinanceManagementFinanceInvoicePdf merchantShortId opCity apiTokenInfo from invoiceId invoiceSource invoiceType limit offset referenceId to = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.FinanceManagement.getFinanceManagementFinanceInvoicePdf merchantShortId opCity apiTokenInfo from invoiceId invoiceSource invoiceType limit offset referenceId to
