...
getFinanceManagementFinanceSapJournalsTransactions merchantShortId opCity apiTokenInfo fromTime limit offset subscriptionId toTime periodEndTime periodStartTime status transactionType = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.FinanceManagement.getFinanceManagementFinanceSapJournalsTransactions merchantShortId opCity apiTokenInfo fromTime limit offset subscriptionId toTime periodEndTime periodStartTime status transactionType
