...
getFinanceManagementFinanceInvoiceList merchantShortId opCity apiTokenInfo from invoiceId invoiceNumber invoiceType limit offset status to = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.FinanceManagement.getFinanceManagementFinanceInvoiceList merchantShortId opCity apiTokenInfo from invoiceId invoiceNumber invoiceType limit offset status to
