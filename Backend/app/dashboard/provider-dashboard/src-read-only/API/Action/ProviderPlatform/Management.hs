...
type API = (API.Action.ProviderPlatform.Management.Account.API :<|> API.Action.ProviderPlatform.Management.Booking.API :<|> API.Action.ProviderPlatform.Management.CoinsConfig.API :<|> API.Action.ProviderPlatform.Management.Driver.API :<|> API.Action.ProviderPlatform.Management.DriverCoins.API :<|> API.Action.ProviderPlatform.Management.DriverGoHome.API :<|> API.Action.ProviderPlatform.Management.DriverReferral.API :<|> API.Action.ProviderPlatform.Management.DriverRegistration.API :<|> API.Action.ProviderPlatform.Management.EntityInfo.API :<|> API.Action.ProviderPlatform.Management.Media.API :<|> API.Action.ProviderPlatform.Management.MediaFileDocument.API :<|> API.Action.ProviderPlatform.Management.Merchant.API :<|> API.Action.ProviderPlatform.Management.Message.API :<|> API.Action.ProviderPlatform.Management.NammaTag.API :<|> API.Action.ProviderPlatform.Management.Payout.API :<|> API.Action.ProviderPlatform.Management.PlanManagement.API :<|> API.Action.ProviderPlatform.Management.Revenue.API :<|> API.Action.ProviderPlatform.Management.Ride.API :<|> API.Action.ProviderPlatform.Management.SosMedia.API :<|> API.Action.ProviderPlatform.Management.System.API :<|> API.Action.ProviderPlatform.Management.VehicleInfo.API :<|> API.Action.ProviderPlatform.Management.Volunteer.API)
