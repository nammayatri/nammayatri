...
type PostDriverInvalidatePanCard =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.DRIVER / 'API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_INVALIDATE_PAN_CARD)
      :> API.Types.ProviderPlatform.Management.Driver.PostDriverInvalidatePanCard
  )
...
postDriverInvalidatePanCard :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> API.Types.ProviderPlatform.Management.Driver.InvalidatePanCardReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverInvalidatePanCard merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Driver.postDriverInvalidatePanCard merchantShortId opCity apiTokenInfo req
