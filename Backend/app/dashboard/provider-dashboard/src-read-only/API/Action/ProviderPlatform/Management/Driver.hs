...
getDriverStats :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe (Kernel.Types.Id.Id Dashboard.Common.Driver) -> Kernel.Prelude.Maybe Data.Time.Calendar.Day -> Kernel.Prelude.Maybe Data.Time.Calendar.Day -> API.Types.ProviderPlatform.Management.Driver.DriverStatReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Driver.DriverStatsRes)
getDriverStats merchantShortId opCity apiTokenInfo entityId fromDate toDate req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Driver.getDriverStats merchantShortId opCity apiTokenInfo entityId fromDate toDate req
