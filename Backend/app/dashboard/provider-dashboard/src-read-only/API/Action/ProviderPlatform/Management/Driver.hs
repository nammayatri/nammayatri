...
type PostDriverOperatorChange =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.DRIVER / 'API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_OPERATOR_CHANGE)
      :> API.Types.ProviderPlatform.Management.Driver.PostDriverOperatorChange
  )

type PostDriverFleetOperatorChange =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.DRIVER / 'API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_FLEET_OPERATOR_CHANGE)
      :> API.Types.ProviderPlatform.Management.Driver.PostDriverFleetOperatorChange
  )

type PostDriverFleetOperatorCreate =
  ( ApiAuth
      'DRIVER_OFFER_BPP_MANAGEMENT
      'DSL
      ('PROVIDER_MANAGEMENT / 'API.Types.ProviderPlatform.Management.DRIVER / 'API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_FLEET_OPERATOR_CREATE)
      :> API.Types.ProviderPlatform.Management.Driver.PostDriverFleetOperatorCreate
  )
...
getDriverAirportPreference :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Driver.AirportPreferenceRes)
getDriverAirportPreference merchantShortId opCity apiTokenInfo phoneNumber vehicleNumber = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Driver.getDriverAirportPreference merchantShortId opCity apiTokenInfo phoneNumber vehicleNumber
...
=======
postDriverOperatorChange :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.Driver -> API.Types.ProviderPlatform.Management.Driver.ChangeDriverOperatorReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverOperatorChange merchantShortId opCity apiTokenInfo driverId req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Driver.postDriverOperatorChange merchantShortId opCity apiTokenInfo driverId req

postDriverFleetOperatorChange :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Text -> API.Types.ProviderPlatform.Management.Driver.ChangeFleetOperatorReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetOperatorChange merchantShortId opCity apiTokenInfo fleetOwnerId req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Driver.postDriverFleetOperatorChange merchantShortId opCity apiTokenInfo fleetOwnerId req

postDriverFleetOperatorCreate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Text -> API.Types.ProviderPlatform.Management.Driver.CreateFleetOperatorReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetOperatorCreate merchantShortId opCity apiTokenInfo fleetOwnerId req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Driver.postDriverFleetOperatorCreate merchantShortId opCity apiTokenInfo fleetOwnerId req
>>>>>>> 64d672fb95 (backend/refactor: storing history association of driver/fleet/operator/rc association)
