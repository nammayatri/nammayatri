...
type GetDriverPlanDrivers =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_PLAN_DRIVERS))
      :> API.Types.ProviderPlatform.Management.Driver.GetDriverPlanDrivers
  )

type PostDriverPlanMigrate =
  ( ApiAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      ('DSL)
      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_PLAN_MIGRATE))
      :> API.Types.ProviderPlatform.Management.Driver.PostDriverPlanMigrate
  )
...
getDriverPlanDrivers :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Text -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Driver.GetDriversOnPlanRes)
getDriverPlanDrivers merchantShortId opCity apiTokenInfo planId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Driver.getDriverPlanDrivers merchantShortId opCity apiTokenInfo planId

postDriverPlanMigrate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.ProviderPlatform.Management.Driver.MigratePlanReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Driver.MigratePlanRes)
postDriverPlanMigrate merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Driver.postDriverPlanMigrate merchantShortId opCity apiTokenInfo req
