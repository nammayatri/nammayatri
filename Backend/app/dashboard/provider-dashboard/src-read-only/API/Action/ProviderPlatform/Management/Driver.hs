...
getDriverDriverLicenseDetails :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.Driver.DriverLicense -> Environment.FlowHandler Dashboard.Common.Driver.DriverLicenseD)
getDriverDriverLicenseDetails merchantShortId opCity apiTokenInfo licenseId = withFlowHandlerAPI' $ Domain.Action.ProviderPlatform.Management.Driver.getDriverDriverLicenseDetails merchantShortId opCity apiTokenInfo licenseId
