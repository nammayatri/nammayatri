...
type PostDriverDriverDataDecryption = (ApiAuth 'DRIVER_OFFER_BPP_MANAGEMENT 'DRIVERS 'DRIVER_DECRYPTION :> API.Types.ProviderPlatform.Management.Driver.PostDriverDriverDataDecryption)
