...
type GetDriverDocumentsInfo = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                       ('DSL)
                                       (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_DOCUMENTS_INFO)) :> API.Types.ProviderPlatform.Management.Driver.GetDriverDocumentsInfo)
type PostDriverPersonNumbers = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                        ('DSL)
                                        (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_PERSON_NUMBERS)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverPersonNumbers)
type PostDriverUpdateTagBulk = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                        ('DSL)
                                        (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_UPDATE_TAG_BULK)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverUpdateTagBulk)
type PostDriverDriverDataDecryption = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                               ('DSL)
                                               (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_DRIVER_DATA_DECRYPTION)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverDriverDataDecryption)
type PostDriverPersonId = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                   ('DSL)
                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_PERSON_ID)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverPersonId)
type GetDriverAadhaarInfo = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                     ('DSL)
                                     (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_AADHAAR_INFO)) :> API.Types.ProviderPlatform.Management.Driver.GetDriverAadhaarInfo)
type GetDriverAadhaarInfobyMobileNumber = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                   ('DSL)
                                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_AADHAAR_INFOBY_MOBILE_NUMBER)) :> API.Types.ProviderPlatform.Management.Driver.GetDriverAadhaarInfobyMobileNumber)
type GetDriverList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                              ('DSL)
                              (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_LIST)) :> API.Types.ProviderPlatform.Management.Driver.GetDriverList)
type GetDriverActivity = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                  ('DSL)
                                  (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_ACTIVITY)) :> API.Types.ProviderPlatform.Management.Driver.GetDriverActivity)
type PostDriverDisable = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                  ('DSL)
                                  (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_DISABLE)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverDisable)
type PostDriverAcRestrictionUpdate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                              ('DSL)
                                              (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_AC_RESTRICTION_UPDATE)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverAcRestrictionUpdate)
type PostDriverBlockWithReason = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                          ('DSL)
                                          (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_BLOCK_WITH_REASON)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverBlockWithReason)
type PostDriverBlock = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                ('DSL)
                                (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_BLOCK)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverBlock)
type GetDriverBlockReasonList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                         ('DSL)
                                         (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_BLOCK_REASON_LIST)) :> API.Types.ProviderPlatform.Management.Driver.GetDriverBlockReasonList)
type PostDriverUnblock = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                  ('DSL)
                                  (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_UNBLOCK)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverUnblock)
type GetDriverLocation = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                  ('DSL)
                                  (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_LOCATION)) :> API.Types.ProviderPlatform.Management.Driver.GetDriverLocation)
type DeleteDriverPermanentlyDelete = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                              ('DSL)
                                              (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.DELETE_DRIVER_PERMANENTLY_DELETE)) :> API.Types.ProviderPlatform.Management.Driver.DeleteDriverPermanentlyDelete)
type PostDriverUnlinkDL = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                   ('DSL)
                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_UNLINK_DL)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverUnlinkDL)
type PostDriverUnlinkAadhaar = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                        ('DSL)
                                        (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_UNLINK_AADHAAR)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverUnlinkAadhaar)
type PostDriverUpdatePhoneNumber = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                            ('DSL)
                                            (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_UPDATE_PHONE_NUMBER)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverUpdatePhoneNumber)
type PostDriverUpdateByPhoneNumber = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                              ('DSL)
                                              (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_UPDATE_BY_PHONE_NUMBER)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverUpdateByPhoneNumber)
type PostDriverUpdateName = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                     ('DSL)
                                     (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_UPDATE_NAME)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverUpdateName)
type PostDriverDeleteRC = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                   ('DSL)
                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_DELETE_RC)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverDeleteRC)
type GetDriverClearStuckOnRide = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                          ('DSL)
                                          (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_CLEAR_STUCK_ON_RIDE)) :> API.Types.ProviderPlatform.Management.Driver.GetDriverClearStuckOnRide)
type PostDriverSendDummyNotification = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                ('DSL)
                                                (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_SEND_DUMMY_NOTIFICATION)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverSendDummyNotification)
type PostDriverChangeOperatingCity = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                              ('DSL)
                                              (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_CHANGE_OPERATING_CITY)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverChangeOperatingCity)
type GetDriverGetOperatingCity = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                          ('DSL)
                                          (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_GET_OPERATING_CITY)) :> API.Types.ProviderPlatform.Management.Driver.GetDriverGetOperatingCity)
type PostDriverPauseOrResumeServiceCharges = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                      ('DSL)
                                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_PAUSE_OR_RESUME_SERVICE_CHARGES)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverPauseOrResumeServiceCharges)
type PostDriverUpdateRCInvalidStatus = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                ('DSL)
                                                (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_UPDATE_RC_INVALID_STATUS)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverUpdateRCInvalidStatus)
type PostDriverUpdateRCInvalidStatusByRCNumber = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                          ('DSL)
                                                          (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_UPDATE_RC_INVALID_STATUS_BY_RC_NUMBER)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverUpdateRCInvalidStatusByRCNumber)
type PostDriverUpdateVehicleVariant = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                               ('DSL)
                                               (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_UPDATE_VEHICLE_VARIANT)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverUpdateVehicleVariant)
type PostDriverBulkReviewRCVariant = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                              ('DSL)
                                              (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_BULK_REVIEW_RC_VARIANT)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverBulkReviewRCVariant)
type PostDriverUpdateDriverTag = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                          ('DSL)
                                          (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_UPDATE_DRIVER_TAG)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverUpdateDriverTag)
type PostDriverClearFee = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                   ('DSL)
                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_CLEAR_FEE)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverClearFee)
type GetDriverPanAadharSelfieDetails = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                ('DSL)
                                                (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_PAN_AADHAR_SELFIE_DETAILS)) :> API.Types.ProviderPlatform.Management.Driver.GetDriverPanAadharSelfieDetails)
type PostDriverSyncDocAadharPan = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                           ('DSL)
                                           (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_SYNC_DOC_AADHAR_PAN)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverSyncDocAadharPan)
type PostDriverUpdateVehicleManufacturing = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                     ('DSL)
                                                     (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_UPDATE_VEHICLE_MANUFACTURING)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverUpdateVehicleManufacturing)
type PostDriverVehicleAppendSelectedServiceTiers = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                            ('DSL)
                                                            (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_VEHICLE_APPEND_SELECTED_SERVICE_TIERS)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverVehicleAppendSelectedServiceTiers)
type PostDriverVehicleUpsertSelectedServiceTiers = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                            ('DSL)
                                                            (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_VEHICLE_UPSERT_SELECTED_SERVICE_TIERS)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverVehicleUpsertSelectedServiceTiers)
type PostDriverRefundByPayout = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                         ('DSL)
                                         (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_REFUND_BY_PAYOUT)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverRefundByPayout)
type GetDriverSecurityDepositStatus = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                               ('DSL)
                                               (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_SECURITY_DEPOSIT_STATUS)) :> API.Types.ProviderPlatform.Management.Driver.GetDriverSecurityDepositStatus)
type GetDriverPanAadharSelfieDetailsList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                    ('DSL)
                                                    (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_PAN_AADHAR_SELFIE_DETAILS_LIST)) :> API.Types.ProviderPlatform.Management.Driver.GetDriverPanAadharSelfieDetailsList)
type PostDriverBulkSubscriptionServiceUpdate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                        ('DSL)
                                                        (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_BULK_SUBSCRIPTION_SERVICE_UPDATE)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverBulkSubscriptionServiceUpdate)
type GetDriverStats = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                               ('DSL)
                               (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_STATS)) :> API.Types.ProviderPlatform.Management.Driver.GetDriverStats)
type GetDriverEarnings = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                  ('DSL)
                                  (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.GET_DRIVER_EARNINGS)) :> API.Types.ProviderPlatform.Management.Driver.GetDriverEarnings)
type PostDriverTdsRateUpdate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                        ('DSL)
                                        (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_TDS_RATE_UPDATE)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverTdsRateUpdate)
type PostDriverUpdateMerchant = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                         ('DSL)
                                         (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.DRIVER) / ('API.Types.ProviderPlatform.Management.Driver.POST_DRIVER_UPDATE_MERCHANT)) :> API.Types.ProviderPlatform.Management.Driver.PostDriverUpdateMerchant)
...
postDriverSendDummyNotification :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Driver.DummyRideRequestRes)
...
postDriverTdsRateUpdate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> API.Types.ProviderPlatform.Management.Driver.UpdateTdsRateReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
