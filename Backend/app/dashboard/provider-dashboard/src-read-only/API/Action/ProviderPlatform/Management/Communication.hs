...
type PostCommunicationCreate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                        ('DSL)
                                        (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.COMMUNICATION) / ('API.Types.ProviderPlatform.Management.Communication.POST_COMMUNICATION_CREATE)) :> API.Types.ProviderPlatform.Management.Communication.PostCommunicationCreate)
type GetCommunicationList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                     ('DSL)
                                     (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.COMMUNICATION) / ('API.Types.ProviderPlatform.Management.Communication.GET_COMMUNICATION_LIST)) :> API.Types.ProviderPlatform.Management.Communication.GetCommunicationList)
type GetCommunicationInfo = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                     ('DSL)
                                     (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.COMMUNICATION) / ('API.Types.ProviderPlatform.Management.Communication.GET_COMMUNICATION_INFO)) :> API.Types.ProviderPlatform.Management.Communication.GetCommunicationInfo)
type PostCommunicationSend = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                      ('DSL)
                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.COMMUNICATION) / ('API.Types.ProviderPlatform.Management.Communication.POST_COMMUNICATION_SEND)) :> API.Types.ProviderPlatform.Management.Communication.PostCommunicationSend)
type PutCommunicationEdit = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                     ('DSL)
                                     (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.COMMUNICATION) / ('API.Types.ProviderPlatform.Management.Communication.PUT_COMMUNICATION_EDIT)) :> API.Types.ProviderPlatform.Management.Communication.PutCommunicationEdit)
type DeleteCommunicationDelete = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                          ('DSL)
                                          (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.COMMUNICATION) / ('API.Types.ProviderPlatform.Management.Communication.DELETE_COMMUNICATION_DELETE)) :> API.Types.ProviderPlatform.Management.Communication.DeleteCommunicationDelete)
type GetCommunicationDeliveryStatus = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                               ('DSL)
                                               (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.COMMUNICATION) / ('API.Types.ProviderPlatform.Management.Communication.GET_COMMUNICATION_DELIVERY_STATUS)) :> API.Types.ProviderPlatform.Management.Communication.GetCommunicationDeliveryStatus)
type GetCommunicationRecipients = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                           ('DSL)
                                           (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.COMMUNICATION) / ('API.Types.ProviderPlatform.Management.Communication.GET_COMMUNICATION_RECIPIENTS)) :> API.Types.ProviderPlatform.Management.Communication.GetCommunicationRecipients)
type GetCommunicationTemplate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                         ('DSL)
                                         (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.COMMUNICATION) / ('API.Types.ProviderPlatform.Management.Communication.GET_COMMUNICATION_TEMPLATE)) :> API.Types.ProviderPlatform.Management.Communication.GetCommunicationTemplate)
