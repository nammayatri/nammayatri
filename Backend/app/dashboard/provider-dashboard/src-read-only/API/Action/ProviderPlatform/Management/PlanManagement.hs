...
type PostPlanManagementCreate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                         ('DSL)
                                         (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PLAN_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PlanManagement.POST_PLAN_MANAGEMENT_CREATE)) :> API.Types.ProviderPlatform.Management.PlanManagement.PostPlanManagementCreate)
type PostPlanManagementDeletePlan = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                             ('DSL)
                                             (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PLAN_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PlanManagement.POST_PLAN_MANAGEMENT_DELETE_PLAN)) :> API.Types.ProviderPlatform.Management.PlanManagement.PostPlanManagementDeletePlan)
type PostPlanManagementActivatePlan = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                               ('DSL)
                                               (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PLAN_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PlanManagement.POST_PLAN_MANAGEMENT_ACTIVATE_PLAN)) :> API.Types.ProviderPlatform.Management.PlanManagement.PostPlanManagementActivatePlan)
type GetPlanManagementListPlans = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                           ('DSL)
                                           (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PLAN_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.PlanManagement.GET_PLAN_MANAGEMENT_LIST_PLANS)) :> API.Types.ProviderPlatform.Management.PlanManagement.GetPlanManagementListPlans)
...
postPlanManagementActivatePlan :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Text -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
