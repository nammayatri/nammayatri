...
type GetRideAgentList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                 ('DSL)
                                 (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.RIDE) / ('API.Types.ProviderPlatform.Management.Ride.GET_RIDE_AGENT_LIST)) :> API.Types.ProviderPlatform.Management.Ride.GetRideAgentList)
type GetRideList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                            ('DSL)
                            (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.RIDE) / ('API.Types.ProviderPlatform.Management.Ride.GET_RIDE_LIST)) :> API.Types.ProviderPlatform.Management.Ride.GetRideList)
type GetRideListV2 = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                              ('DSL)
                              (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.RIDE) / ('API.Types.ProviderPlatform.Management.Ride.GET_RIDE_LIST_V2)) :> API.Types.ProviderPlatform.Management.Ride.GetRideListV2)
type PostRideEndMultiple = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                    ('DSL)
                                    (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.RIDE) / ('API.Types.ProviderPlatform.Management.Ride.POST_RIDE_END_MULTIPLE)) :> API.Types.ProviderPlatform.Management.Ride.PostRideEndMultiple)
type PostRideCancelMultiple = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                       ('DSL)
                                       (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.RIDE) / ('API.Types.ProviderPlatform.Management.Ride.POST_RIDE_CANCEL_MULTIPLE)) :> API.Types.ProviderPlatform.Management.Ride.PostRideCancelMultiple)
type GetRideInfo = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                            ('DSL)
                            (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.RIDE) / ('API.Types.ProviderPlatform.Management.Ride.GET_RIDE_INFO)) :> API.Types.ProviderPlatform.Management.Ride.GetRideInfo)
type PostRideSync = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                             ('DSL)
                             (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.RIDE) / ('API.Types.ProviderPlatform.Management.Ride.POST_RIDE_SYNC)) :> API.Types.ProviderPlatform.Management.Ride.PostRideSync)
type PostRideSyncMultiple = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                     ('DSL)
                                     (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.RIDE) / ('API.Types.ProviderPlatform.Management.Ride.POST_RIDE_SYNC_MULTIPLE)) :> API.Types.ProviderPlatform.Management.Ride.PostRideSyncMultiple)
type PostRideRoute = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                              ('DSL)
                              (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.RIDE) / ('API.Types.ProviderPlatform.Management.Ride.POST_RIDE_ROUTE)) :> API.Types.ProviderPlatform.Management.Ride.PostRideRoute)
type GetRideKaptureList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                   ('DSL)
                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.RIDE) / ('API.Types.ProviderPlatform.Management.Ride.GET_RIDE_KAPTURE_LIST)) :> API.Types.ProviderPlatform.Management.Ride.GetRideKaptureList)
type GetRideFareBreakUp = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                   ('DSL)
                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.RIDE) / ('API.Types.ProviderPlatform.Management.Ride.GET_RIDE_FARE_BREAK_UP)) :> API.Types.ProviderPlatform.Management.Ride.GetRideFareBreakUp)
type PostRideWaiverRideCancellationPenalty = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                      ('DSL)
                                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.RIDE) / ('API.Types.ProviderPlatform.Management.Ride.POST_RIDE_WAIVER_RIDE_CANCELLATION_PENALTY)) :> API.Types.ProviderPlatform.Management.Ride.PostRideWaiverRideCancellationPenalty)
