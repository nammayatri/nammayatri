...
type GetVehicleInfoList = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                   ('DSL)
                                   (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.VEHICLE_INFO) / ('API.Types.ProviderPlatform.Management.VehicleInfo.GET_VEHICLE_INFO_LIST)) :> API.Types.ProviderPlatform.Management.VehicleInfo.GetVehicleInfoList)
type PostVehicleInfoUpdate = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                      ('DSL)
                                      (('PROVIDER_MANAGEMENT) / ('API.Types.ProviderPlatform.Management.VEHICLE_INFO) / ('API.Types.ProviderPlatform.Management.VehicleInfo.POST_VEHICLE_INFO_UPDATE)) :> API.Types.ProviderPlatform.Management.VehicleInfo.PostVehicleInfoUpdate)
