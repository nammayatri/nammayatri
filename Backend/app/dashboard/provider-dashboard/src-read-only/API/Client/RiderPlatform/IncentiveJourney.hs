...
module API.Client.RiderPlatform.IncentiveJourney where
...
newtype IncentiveJourneyAPIs = IncentiveJourneyAPIs {incentiveJourneyDSL :: API.Types.RiderPlatform.IncentiveJourney.IncentiveJourney.IncentiveJourneyAPIs}
...
mkIncentiveJourneyAPIs merchantId city token = do
  let incentiveJourneyDSL = API.Types.RiderPlatform.IncentiveJourney.IncentiveJourney.mkIncentiveJourneyAPIs incentiveJourneyClientDSL
...
callIncentiveJourneyAPI merchantId city = Tools.Client.callServerAPI @_ @m @r Domain.Types.ServerName.APP_BACKEND_MANAGEMENT (mkIncentiveJourneyAPIs merchantId city) "callIncentiveJourneyAPI"
