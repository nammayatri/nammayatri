...
data AppManagementAPIs
    = AppManagementAPIs {driverDSL :: API.Types.Dashboard.AppManagement.Driver.DriverAPIs,
...
mkAppManagementAPIs merchantId city token = do {let {driverDSL = API.Types.Dashboard.AppManagement.Driver.mkDriverAPIs driverClientDSL};
                                                ...
                                                (AppManagementAPIs {..})}
                        where driverClientDSL :<|> driverSubscriptionClientDSL :<|> driverWalletClientDSL :<|> overlayClientDSL :<|> penaltyClientDSL :<|> subscriptionClientDSL :<|> subscriptionTransactionClientDSL = Tools.Client.clientWithMerchantAndCity (Proxy :: Proxy API.Dashboard.AppManagementDSLAPI) merchantId city token
callAppManagementAPI :: forall m r b c . Tools.Client.DashboardClient AppManagementAPIs m r b c =>
