...
data ManagementAPIs
    = ManagementAPIs {accountDSL :: API.Types.ProviderPlatform.Management.Account.AccountAPIs,
...
mkManagementAPIs merchantId city token = do {let {accountDSL = API.Types.ProviderPlatform.Management.Account.mkAccountAPIs accountClientDSL};
