...
issueList :: ShortId DM.Merchant -> City.City -> ApiTokenInfo -> Maybe Int -> Maybe Int -> Maybe Common.IssueStatus -> Maybe (Id Common.IssueCategory) -> Maybe Text -> FlowHandler Common.IssueReportListResponse
...
issueInfo :: ShortId DM.Merchant -> City.City -> ApiTokenInfo -> Id Common.IssueReport -> FlowHandler Common.IssueInfoRes
...
issueUpdate :: ShortId DM.Merchant -> City.City -> ApiTokenInfo -> Id Common.IssueReport -> Common.IssueUpdateReq -> FlowHandler APISuccess
...
issueAddComment :: ShortId DM.Merchant -> City.City -> ApiTokenInfo -> Id Common.IssueReport -> Common.IssueAddCommentReq -> FlowHandler APISuccess
