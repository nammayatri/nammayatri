...
merchantUpdate merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI $ do
  ...
  T.withTransactionStoring transaction $
    Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.merchantUpdate) req
...
merchantCommonConfig merchantShortId opCity apiTokenInfo = withFlowHandlerAPI $ do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.merchantCommonConfig)
...
merchantCommonConfigUpdate merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI $ do
  ...
  T.withTransactionStoring transaction $
    Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.merchantCommonConfigUpdate) req
...
driverPoolConfig merchantShortId opCity apiTokenInfo tripDistance = withFlowHandlerAPI $ do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.driverPoolConfig) tripDistance
...
driverPoolConfigUpdate merchantShortId opCity apiTokenInfo tripDistance variant req = withFlowHandlerAPI $ do
  ...
  T.withTransactionStoring transaction $
    Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.driverPoolConfigUpdate) tripDistance variant req
...
driverPoolConfigCreate merchantShortId opCity apiTokenInfo tripDistance variant req = withFlowHandlerAPI $ do
  ...
  T.withTransactionStoring transaction $
    Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.driverPoolConfigCreate) tripDistance variant req
...
driverIntelligentPoolConfig merchantShortId opCity apiTokenInfo = withFlowHandlerAPI $ do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.driverIntelligentPoolConfig)
...
driverIntelligentPoolConfigUpdate merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI $ do
  ...
  T.withTransactionStoring transaction $
    Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.driverIntelligentPoolConfigUpdate) req
...
onboardingDocumentConfig merchantShortId opCity apiTokenInfo documentType = withFlowHandlerAPI $ do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.onboardingDocumentConfig) documentType
...
onboardingDocumentConfigUpdate merchantShortId opCity apiTokenInfo documentType req = withFlowHandlerAPI $ do
  ...
  T.withTransactionStoring transaction $
    Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.onboardingDocumentConfigUpdate) documentType req
...
onboardingDocumentConfigCreate merchantShortId opCity apiTokenInfo documentType req = withFlowHandlerAPI $ do
  ...
  T.withTransactionStoring transaction $
    Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.onboardingDocumentConfigCreate) documentType req
...
serviceUsageConfig merchantShortId opCity apiTokenInfo = withFlowHandlerAPI $ do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.serviceUsageConfig)
...
mapsServiceConfigUpdate merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI $ do
  ...
  T.withTransactionStoring transaction $
    Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.mapsServiceConfigUpdate) req
...
mapsServiceUsageConfigUpdate merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI $ do
  ...
  T.withTransactionStoring transaction $
    Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.mapsServiceUsageConfigUpdate) req
...
smsServiceConfigUpdate merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI $ do
  ...
  T.withTransactionStoring transaction $
    Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.smsServiceConfigUpdate) req
...
smsServiceUsageConfigUpdate merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI $ do
  ...
  T.withTransactionStoring transaction $
    Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.smsServiceUsageConfigUpdate) req
...
verificationServiceConfigUpdate merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI $ do
  ...
  T.withTransactionStoring transaction $
    Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.verificationServiceConfigUpdate) req
...
createFPDriverExtraFee merchantShortId opCity apiTokenInfo farePolicyId startDistance req = withFlowHandlerAPI $ do
  ...
  T.withTransactionStoring transaction $ Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.createFPDriverExtraFee) farePolicyId startDistance req
...
updateFPDriverExtraFee merchantShortId opCity apiTokenInfo farePolicyId startDistance req = withFlowHandlerAPI $ do
  ...
  T.withTransactionStoring transaction $ Client.callDriverOfferBPP checkedMerchantId opCity (.merchant.updateFPDriverExtraFee) farePolicyId startDistance req
