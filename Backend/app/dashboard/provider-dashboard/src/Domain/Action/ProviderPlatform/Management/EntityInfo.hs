...
getEntityInfoList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Text -> Kernel.Prelude.Text -> Environment.Flow API.Types.ProviderPlatform.Management.EntityInfo.EntityExtraInformation)
...
postEntityInfoUpdate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.ProviderPlatform.Management.EntityInfo.UpdateEntityInfoReq -> Environment.Flow Kernel.Types.APISuccess.APISuccess)
postEntityInfoUpdate merchantShortId opCity apiTokenInfo req = do
  ...
  SharedLogic.Transaction.withTransactionStoring transaction $ (do API.Client.ProviderPlatform.Management.callManagementAPI checkedMerchantId opCity (.entityInfoDSL.postEntityInfoUpdate) req)
