...
putMerchantConfigGeometryUpdate :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo -> Common.UpdateGeometryReq -> Environment.Flow Kernel.Types.APISuccess.APISuccess)
...
getMerchantConfigVehicleServiceTier :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe (Dashboard.Common.ServiceTierType) -> Environment.Flow API.Types.ProviderPlatform.Management.Merchant.VehicleServiceTierRes)
getMerchantConfigVehicleServiceTier merchantShortId opCity apiTokenInfo serviceTierType = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  API.Client.ProviderPlatform.Management.callManagementAPI checkedMerchantId opCity (.merchantDSL.getMerchantConfigVehicleServiceTier) serviceTierType

postMerchantConfigVehicleServiceTierUpdate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Dashboard.Common.ServiceTierType -> API.Types.ProviderPlatform.Management.Merchant.VehicleServiceTierConfigUpdateReq -> Environment.Flow Kernel.Types.APISuccess.APISuccess)
postMerchantConfigVehicleServiceTierUpdate merchantShortId opCity apiTokenInfo serviceTierType req = do
  ...
  SharedLogic.Transaction.withTransactionStoring transaction $ (do API.Client.ProviderPlatform.Management.callManagementAPI checkedMerchantId opCity (.merchantDSL.postMerchantConfigVehicleServiceTierUpdate) serviceTierType req)
