...
import qualified "dynamic-offer-driver-app" API.Types.ProviderPlatform.Management.Message as Common
...
postMessageUploadFile :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.UploadFileRequest -> Flow Common.UploadFileResponse
...
postMessageAddLink :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.AddLinkAsMedia -> Flow Common.UploadFileResponse
...
postMessageAdd :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.AddMessageRequest -> Flow Common.AddMessageResponse
...
postMessageSend :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.SendMessageRequest -> Flow APISuccess
...
getMessageList :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Int -> Maybe Int -> Flow Common.MessageListResponse
...
getMessageInfo :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Id Common.Message -> Flow Common.MessageInfoResponse
...
getMessageDeliveryInfo :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Id Common.Message -> Flow Common.MessageDeliveryInfoResponse
...
getMessageReceiverList :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Id Common.Message -> Maybe Text -> Maybe Common.MessageDeliveryStatus -> Maybe Int -> Maybe Int -> Flow Common.MessageReceiverListResponse
...
postMessageEdit :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.EditMessageRequest -> Flow APISuccess
