...
getDriverOperatorList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe (Kernel.Prelude.Bool) -> Kernel.Prelude.Maybe (Kernel.Prelude.Bool) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Environment.Flow [API.Types.ProviderPlatform.Operator.Driver.DriverInfo])
getDriverOperatorList merchantShortId opCity apiTokenInfo isActive verified limit offset = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  error "Client call .driverDSL.getDriverOperatorList for separate helperApi couldn't be autogenerated. Logic yet to be decided" checkedMerchantId isActive verified limit offset
