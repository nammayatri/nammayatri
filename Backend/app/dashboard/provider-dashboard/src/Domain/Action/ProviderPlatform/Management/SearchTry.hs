...
module Domain.Action.ProviderPlatform.Management.SearchTry (postSearchTryRecentSearchTries) where
...
postSearchTryRecentSearchTries :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.ProviderPlatform.Management.SearchTry.RecentSearchTriesReq -> Environment.Flow API.Types.ProviderPlatform.Management.SearchTry.RecentSearchTriesRes)
postSearchTryRecentSearchTries merchantShortId opCity apiTokenInfo req = do
  ...
  SharedLogic.Transaction.withTransactionStoring transaction $ (do API.Client.ProviderPlatform.Management.callManagementAPI checkedMerchantId opCity (.searchTryDSL.postSearchTryRecentSearchTries) req)
