...
getAccountFetchUnverifiedAccounts _merchantShortId _opCity _apiTokenInfo mbFromDate mbToDate mbMobileNumber mbStatus =
...
instance FromHttpApiData API.Types.ProviderPlatform.Management.Account.FleetOwnerStatus where
