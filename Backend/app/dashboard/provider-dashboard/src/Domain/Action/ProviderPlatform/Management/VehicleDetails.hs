...
getVehicleDetailsVehicleModels :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Environment.Flow [API.Types.ProviderPlatform.Management.VehicleDetails.VehicleMakeModelsItem])
