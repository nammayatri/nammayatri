...
putDriverDashboardFleetWmbTripEnd :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.TripTransaction -> Environment.Flow Kernel.Types.APISuccess.APISuccess)
putDriverDashboardFleetWmbTripEnd merchantShortId opCity apiTokenInfo tripTransactionId = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  ...
  SharedLogic.Transaction.withTransactionStoring transaction $ (do error "Client call .driverDSL.putDriverDashboardFleetWmbTripEnd for separate helperApi couldn't be autogenerated. Logic yet to be decided" checkedMerchantId tripTransactionId)

--- << AUTOGENERATED Check this code, update export list and remove comment >> ---

postDriverDashboardFleetWmbTripEnd :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.TripTransaction -> Environment.Flow Kernel.Types.APISuccess.APISuccess)
postDriverDashboardFleetWmbTripEnd merchantShortId opCity apiTokenInfo tripTransactionId = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  transaction <- SharedLogic.Transaction.buildTransaction (Domain.Types.Transaction.castEndpoint apiTokenInfo.userActionType) (Kernel.Prelude.Just DRIVER_OFFER_BPP_MANAGEMENT) (Kernel.Prelude.Just apiTokenInfo) Kernel.Prelude.Nothing Kernel.Prelude.Nothing SharedLogic.Transaction.emptyRequest
  SharedLogic.Transaction.withTransactionStoring transaction $ (do error "Client call .driverDSL.postDriverDashboardFleetWmbTripEnd for separate helperApi couldn't be autogenerated. Logic yet to be decided" checkedMerchantId tripTransactionId)
