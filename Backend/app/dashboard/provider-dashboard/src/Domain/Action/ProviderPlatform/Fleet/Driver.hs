...
import qualified "dynamic-offer-driver-app" Dashboard.ProviderPlatform.Management.DriverRegistration as Registration
...
getFleetOwnerAndRequestorIdMerchantBased :: ApiTokenInfo UserActionType -> Maybe Text -> Flow (Text, Text)
...
getMbFleetOwnerAndRequestorIdMerchantBased :: ApiTokenInfo UserActionType -> Maybe Text -> Flow (Maybe Text, Text)
...
-- getFleetOwnersInfoMerchantBased :: ApiTokenInfo UserActionType -> Maybe Text -> Flow [FleetOwnerInfo]
...
postDriverFleetAccessSelect :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Text -> Maybe Text -> Maybe Bool -> Bool -> Flow APISuccess
...
postDriverFleetV2AccessSelect :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Bool -> Bool -> Flow APISuccess
...
getDriverFleetAccessList :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Flow Common.FleetOwnerListRes
...
postDriverFleetAddVehicle :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Text -> Maybe Text -> Maybe Text -> Maybe Common.Role -> Common.AddVehicleReq -> Flow APISuccess
...
postDriverFleetAddRCWithoutDriver :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Registration.RegisterRCReq -> Flow APISuccess
...
postDriverFleetVehicleDriverRcStatus :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Id Common.Driver -> Maybe Text -> Common.RCStatusReq -> Flow APISuccess
...
postDriverUpdateFleetOwnerInfo :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Id Common.Driver -> Maybe Text -> Common.UpdateFleetOwnerInfoReq -> Flow APISuccess
...
postDriverFleetSendJoiningOtp :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Registration.AuthReq -> Flow Registration.AuthRes
...
postDriverFleetVerifyJoiningOtp :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Maybe Text -> Common.VerifyFleetJoiningOtpReq -> Flow APISuccess
...
postDriverFleetLinkRCWithDriver :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Common.LinkRCWithDriverForFleetReq -> Flow APISuccess
...
postDriverFleetAddVehicles :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Common.CreateVehiclesReq -> Flow Common.APISuccessWithUnprocessedEntities
...
postDriverFleetTripPlanner :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Common.TripPlannerReq -> Flow APISuccess
...
postDriverFleetAddDrivers :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Common.CreateDriversReq -> Flow Common.AddDriversResp
...
postDriverFleetAddDriverBusRouteMapping :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Common.CreateDriverBusRouteMappingReq -> Flow Common.APISuccessWithUnprocessedEntities
...
postDriverFleetRespondDriverRequest :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Common.RequestRespondReq -> Flow APISuccess
...
postDriverDashboardFleetWmbTripEnd :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Id Common.TripTransaction -> Maybe Text -> Maybe Common.ActionSource -> Flow APISuccess
...
postDriverFleetUnlink :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Id Common.Driver -> Text -> Maybe Text -> Flow APISuccess
...
postDriverFleetRemoveVehicle :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Text -> Maybe Text -> Flow APISuccess
...
postDriverFleetRemoveDriver :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Id Common.Driver -> Maybe Text -> Maybe Text -> Flow APISuccess
...
getDriverFleetTotalEarning :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe UTCTime -> Maybe UTCTime -> Flow Common.FleetTotalEarningResponse
...
getDriverFleetVehicleEarning :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Maybe Int -> Maybe Int -> Maybe UTCTime -> Maybe UTCTime -> Flow Common.FleetEarningListRes
...
getDriverFleetDriverEarning :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Maybe Text -> Maybe Int -> Maybe Int -> Maybe UTCTime -> Maybe UTCTime -> Maybe Bool -> Maybe Common.SortOn -> Flow Common.FleetEarningListRes
...
getDriverFleetDriverVehicleAssociation :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Int -> Maybe Int -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Bool -> Maybe UTCTime -> Maybe UTCTime -> Flow Common.DrivertoVehicleAssociationRes
...
getDriverFleetRoutes :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe LatLong -> Maybe Text -> Maybe Text -> Int -> Int -> Flow Common.RouteAPIResp
...
getDriverFleetPossibleRoutes :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Text -> Flow Common.RouteAPIResp
...
getDriverFleetWmbRouteDetails :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Text -> Maybe Text -> Flow Common.RouteDetails
...
postDriverDashboardFleetTrackDriver :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Common.TrackDriverLocationsReq -> Flow Common.TrackDriverLocationsRes
...
getDriverFleetOwnerInfo :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Id Common.Driver -> Flow Common.FleetOwnerInfoRes
...
getDriverFleetStatus :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Flow Common.DriverStatusRes
...
getDriverFleetDashboardAnalyticsAllTime :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Flow Common.AllTimeFleetAnalyticsRes
...
getDriverFleetDashboardAnalytics :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Maybe Common.FleetAnalyticsResponseType -> Day -> Day -> Flow Common.FleetAnalyticsRes
...
getDriverFleetDriverListStats :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Day -> Maybe Day -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Int -> Maybe Int -> Maybe Bool -> Maybe Common.FleetDriverListStatsSortOn -> Maybe Common.FleetDriverStatsResponseType -> Flow Common.FleetDriverStatsListRes
getDriverFleetDriverListStats merchantShortId opCity apiTokenInfo from to mbFleetOwnerId search driverNumber driverPhoneCountryCode limit offset sortDesc sortOn responseType = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  (mbFleetOwnerId', requestorId) <- getMbFleetOwnerAndRequestorIdMerchantBased apiTokenInfo mbFleetOwnerId
  Client.callFleetAPI checkedMerchantId opCity (.driverDSL.getDriverFleetDriverListStats) requestorId from to mbFleetOwnerId' search driverNumber driverPhoneCountryCode limit offset sortDesc sortOn responseType

---------------------------------------------------------------------------------------------------------------------------------
----------------------------------------------- READ LAYER (Multi Fleet Level) --------------------------------------------------
---------------------------------------------------------------------------------------------------------------------------------

getDriverFleetGetAllBadge :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Int -> Maybe Int -> Maybe Text -> Maybe Text -> Maybe DFBT.FleetBadgeType -> Maybe Bool -> Maybe Text -> Flow Common.FleetBadgeResT
...
getDriverFleetGetAllVehicle :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Int -> Maybe Int -> Maybe Text -> Maybe Text -> Maybe Bool -> Maybe Text -> Maybe Bool -> Maybe Bool -> Maybe Common.ApprovalStatusFilter -> Maybe Bool -> Flow Common.ListVehicleResT
...
getDriverFleetGetAllDriver :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Int -> Maybe Int -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Bool -> Maybe Text -> Maybe Bool -> Maybe Common.ApprovalStatusFilter -> Maybe Bool -> Maybe Bool -> Maybe Common.OnboardingAs -> Maybe Bool -> Flow Common.FleetListDriverResT
...
getDriverFleetTripTransactions :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Id Common.Driver -> Maybe UTCTime -> Maybe UTCTime -> Maybe Text -> Maybe Text -> Maybe Text -> Int -> Int -> Flow Common.TripTransactionRespT
...
getDriverFleetDriverAssociation :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Bool -> Maybe Int -> Maybe Int -> Maybe Text -> Maybe Text -> Maybe Bool -> Maybe UTCTime -> Maybe UTCTime -> Maybe Common.DriverMode -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Bool -> Maybe Bool -> Maybe Bool -> Maybe Text -> Maybe Bool -> Maybe Bool -> Maybe Common.DocsVerificationStatus -> Maybe Text -> Maybe Bool -> Flow Common.DrivertoVehicleAssociationResT
...
getDriverFleetVehicleAssociation :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Int -> Maybe Int -> Maybe Text -> Maybe Bool -> Maybe UTCTime -> Maybe UTCTime -> Maybe Common.FleetVehicleStatus -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Bool -> Maybe Bool -> Maybe Bool -> Maybe Common.DocsVerificationStatus -> Maybe Bool -> Flow Common.DrivertoVehicleAssociationResT
...
getDriverFleetGetDriverRequests :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe UTCTime -> Maybe UTCTime -> Maybe AlertRequestType -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe AlertRequestStatus -> Maybe Int -> Maybe Int -> Flow Common.DriverRequestRespT
...
postDriverFleetGetNearbyDrivers :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.NearbyDriverReq -> Flow Common.NearbyDriverRespT
...
postDriverFleetV2AccessMultiOwnerIdSelect :: (ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Kernel.Prelude.Bool -> Common.MultiOwnerSelect -> Environment.Flow APISuccess)
...
getDriverFleetBookings :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Environment.Flow Common.FleetBookingsInformationResponse)
...
getDriverFleetAssignments :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Environment.Flow Common.FleetBookingAssignmentsResponse)
...
getDriverFleetOperatorInfo :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Environment.Flow Common.FleetOwnerInfoRes)
...
postDriverFleetLocationList :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.DriverLocationListReq -> Environment.Flow Common.DriverLocationListResp)
...
postDriverFleetGetDriverDetails :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.DriverDetailsReq -> Environment.Flow Common.DriverDetailsResp)
...
postDriverFleetGetNearbyDriversV2 :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.NearbyDriversReqV2 -> Environment.Flow Common.NearbyDriversRespTV2)
...
getDriverDashboardFleetTripWaypoints :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Types.Id.Id Common.TripTransaction -> Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Environment.Flow Common.TripTransactionWaypointsRes)
...
postDriverDashboardFleetEstimateRoute :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Common.EstimateRouteReq -> Environment.Flow Kernel.External.Maps.GetRoutesResp)
...
postDriverFleetTripTransactionsV2 :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Common.TripStatus -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Int -> Kernel.Prelude.Int -> Environment.Flow Common.TripTransactionRespT)
...
postDriverFleetApproveDriver :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.ApproveDriverReq -> Environment.Flow APISuccess)
...
getDriverFleetVehicleListStats :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Data.Time.Day -> Data.Time.Day -> Environment.Flow Common.FleetVehicleStatsRes)
...
getDriverFleetDriverOnboardedDriversAndUnlinkedVehicles :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Environment.Flow Common.OnboardedDriversAndUnlinkedVehiclesRes)
...
getDriverFleetDriverDetails :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Types.Id.Id Common.Driver -> Environment.Flow Common.DriverDetailsRes)
...
getDriverFleetScheduledBookingList :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Data.Time.Day -> Kernel.Prelude.Maybe Data.Time.Day -> Kernel.Prelude.Maybe Common.TripCategory -> Kernel.Prelude.Maybe Kernel.External.Maps.Types.LatLong -> Environment.Flow Common.FleetScheduledBookingListRes)
...
postDriverFleetScheduledBookingAssign :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.AssignScheduledBookingReq -> Environment.Flow Kernel.Types.APISuccess.APISuccess)
...
postDriverFleetDashboardAnalyticsCache :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.FleetDashboardAnalyticsCacheReq -> Environment.Flow Kernel.Types.APISuccess.APISuccess)
...
postDriverFleetScheduledBookingCancel :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.CancelScheduledBookingReq -> Environment.Flow Kernel.Types.APISuccess.APISuccess)
...
postDriverAddRidePayoutAccountNumber :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.AddRidePayoutAccountNumberReq -> Environment.Flow Kernel.Types.APISuccess.APISuccess)
...
postDriverFleetScheduledBookingReassign :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.ReassignScheduledBookingReq -> Environment.Flow Kernel.Types.APISuccess.APISuccess)
...
getDriverFleetOwnerList :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe Common.ApprovalStatusFilter -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Kernel.Prelude.Maybe Common.DocsVerificationStatus -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Kernel.Prelude.Maybe RegV2.FleetType -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Environment.Flow [Common.FleetOwnerListItem])
...
postDriverFleetVehicleEdit :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Common.EditVehicleReq -> Environment.Flow Kernel.Types.APISuccess.APISuccess)
...
getDriverFleetStatusSummary :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Common.EntityOperationType -> Maybe Kernel.Prelude.Text -> Environment.Flow Common.StatusSummaryResponse)
...
getDriverVehicleInfo :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Maybe Text -> Flow Common.VehicleInfo
...
postDriverFleetDriverChangeFleetOwner :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Types.Id.Id Common.Driver -> Common.ChangeFleetOwnerReq -> Environment.Flow Kernel.Types.APISuccess.APISuccess)
...
postDriverFleetVehicleChangeFleetOwner :: (Kernel.Types.Id.ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Kernel.Prelude.Text -> Common.ChangeFleetOwnerReq -> Environment.Flow Kernel.Types.APISuccess.APISuccess)
...
postDriverFleetCashRideUpdate :: ShortId DM.Merchant -> City.City -> ApiTokenInfo UserActionType -> Maybe Text -> Common.UpdateCashRideReq -> Flow APISuccess
postDriverFleetCashRideUpdate merchantShortId opCity apiTokenInfo mbFleetOwnerId req = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  transaction <- buildTransaction apiTokenInfo Nothing (Just req)
  T.withTransactionStoring transaction $
    Client.callFleetAPI checkedMerchantId opCity (.driverDSL.postDriverFleetCashRideUpdate) apiTokenInfo.personId.getId mbFleetOwnerId req
