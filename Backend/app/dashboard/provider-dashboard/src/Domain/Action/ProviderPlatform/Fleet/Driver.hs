...
postDriverFleetAddVehicle merchantShortId opCity apiTokenInfo phoneNo mbMobileCountryCode req = do
  ...
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.postDriverFleetAddVehicle) phoneNo apiTokenInfo.personId.getId mbMobileCountryCode req
...
postDriverFleetAddRCWithoutDriver merchantShortId opCity apiTokenInfo req = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.postDriverFleetAddRCWithoutDriver) apiTokenInfo.personId.getId req
...
getDriverFleetGetAllVehicle merchantShortId opCity apiTokenInfo mbLimit mbOffset = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.getDriverFleetGetAllVehicle) apiTokenInfo.personId.getId mbLimit mbOffset
...
getDriverFleetGetAllDriver merchantShortId opCity apiTokenInfo mbLimit mbOffset = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.getDriverFleetGetAllDriver) apiTokenInfo.personId.getId mbLimit mbOffset
...
postDriverFleetUnlink merchantShortId opCity apiTokenInfo driverId vehicleNo = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.postDriverFleetUnlink) apiTokenInfo.personId.getId driverId vehicleNo
...
postDriverFleetRemoveVehicle merchantShortId opCity apiTokenInfo vehicleNo = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.postDriverFleetRemoveVehicle) apiTokenInfo.personId.getId vehicleNo
...
postDriverFleetRemoveDriver merchantShortId opCity apiTokenInfo driverId = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.postDriverFleetRemoveDriver) apiTokenInfo.personId.getId driverId
...
getDriverFleetTotalEarning merchantShortId opCity apiTokenInfo mbFrom mbTo = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.getDriverFleetTotalEarning) apiTokenInfo.personId.getId mbFrom mbTo
...
getDriverFleetVehicleEarning merchantShortId opCity apiTokenInfo mbVehicleNo mbLimit mbOffset mbFrom mbTo = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.getDriverFleetVehicleEarning) apiTokenInfo.personId.getId mbVehicleNo mbLimit mbOffset mbFrom mbTo
...
getDriverFleetDriverEarning merchantShortId opCity apiTokenInfo mbMobileCountryCode mbMobileNo mbLimit mbOffset mbFrom mbTo mbSortDesc mbSortOn = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.getDriverFleetDriverEarning) apiTokenInfo.personId.getId mbMobileCountryCode mbMobileNo mbLimit mbOffset mbFrom mbTo mbSortDesc mbSortOn
...
getDriverFleetDriverVehicleAssociation merchantId opCity apiTokenInfo mbLimit mbOffset mbCountryCode mbPhoneNo mbVehicleNo mbStatus mbFrom mbTo = do
  ...
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.getDriverFleetDriverVehicleAssociation) apiTokenInfo.personId.getId mbLimit mbOffset mbCountryCode mbPhoneNo mbVehicleNo mbStatus mbFrom mbTo
...
getDriverFleetDriverAssociation merhcantId opCity apiTokenInfo mbIsActive mbLimit mbOffset mbCountryCode mbPhoneNo mbStats mbFrom mbTo mbMode = do
  ...
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.getDriverFleetDriverAssociation) apiTokenInfo.personId.getId mbIsActive mbLimit mbOffset mbCountryCode mbPhoneNo mbStats mbFrom mbTo mbMode
...
postDriverUpdateFleetOwnerInfo merchantShortId opCity apiTokenInfo driverId req = do
  ...
  T.withTransactionStoring transaction $ do
    ...
    _ <- Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.postDriverUpdateFleetOwnerInfo) driverId req
    let updateDriverReq =
...
getDriverFleetOwnerInfo merchantShortId opCity apiTokenInfo driverId = do
  unless (apiTokenInfo.personId.getId == driverId.getId) $
    throwError AccessDenied
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.getDriverFleetOwnerInfo) driverId
...
postDriverFleetSendJoiningOtp merchantShortId opCity apiTokenInfo req = do
  ...
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.postDriverFleetSendJoiningOtp) dashboardUserName req
...
postDriverFleetVerifyJoiningOtp merchantShortId opCity apiTokenInfo mbAuthId req = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.postDriverFleetVerifyJoiningOtp) apiTokenInfo.personId.getId mbAuthId req
...
postDriverFleetLinkRCWithDriver merchantShortId opCity apiTokenInfo req = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  Client.callDynamicOfferDriverAppFleetApi checkedMerchantId opCity (.driverDSL.postDriverFleetLinkRCWithDriver) apiTokenInfo.personId.getId req
