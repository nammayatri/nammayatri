...
getFinanceManagementFinanceInvoiceList ::
  ( Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant ->
    ...
    Kernel.Prelude.Maybe (Lib.Finance.Domain.Types.Invoice.InvoiceType) -> -- invoiceType
    Kernel.Prelude.Maybe Kernel.Prelude.Int -> -- limit
    Kernel.Prelude.Maybe Kernel.Prelude.Int -> -- offset
...
getFinanceManagementFinanceInvoicePdf merchantShortId opCity apiTokenInfo from invoiceSource invoiceType limit offset referenceId to = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  API.Client.ProviderPlatform.Management.callManagementAPI checkedMerchantId opCity (.financeManagementDSL.getFinanceManagementFinanceInvoicePdf) from invoiceSource invoiceType limit offset referenceId to
