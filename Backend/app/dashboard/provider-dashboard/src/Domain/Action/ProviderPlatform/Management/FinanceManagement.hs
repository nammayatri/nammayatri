...
getFinanceManagementSubscriptionPurchaseList merchantShortId opCity apiTokenInfo amountMax amountMin driverId fleetOperatorId from limit offset serviceName status subscriptionId to = do
  ...
  SharedLogic.Transaction.withGetTransactionStoring
    ...
    ( API.Client.ProviderPlatform.Management.callManagementAPI
        checkedMerchantId
        opCity
        (.financeManagementDSL.getFinanceManagementSubscriptionPurchaseList)
        amountMax
        amountMin
        driverId
        fleetOperatorId
...
getFinanceManagementInvoiceList merchantShortId opCity apiTokenInfo from invoiceId invoiceType limit offset status to = do
  ...
  SharedLogic.Transaction.withGetTransactionStoring
    ...
    ( API.Client.ProviderPlatform.Management.callManagementAPI
        checkedMerchantId
        opCity
        (.financeManagementDSL.getFinanceManagementInvoiceList)
        from
        invoiceId
        invoiceType
        limit
...
getFinanceManagementReconciliation merchantShortId opCity apiTokenInfo fromDate limit offset reconciliationType toDate = do
  ...
  SharedLogic.Transaction.withGetTransactionStoring
    ...
    ( API.Client.ProviderPlatform.Management.callManagementAPI
        checkedMerchantId
        opCity
        (.financeManagementDSL.getFinanceManagementReconciliation)
        fromDate
        limit
        offset
        reconciliationType
...
getFinanceManagementFleetOperatorFinanceList merchantShortId opCity apiTokenInfo fleetOperatorId from limit offset settlementStatus to = do
  ...
  SharedLogic.Transaction.withGetTransactionStoring
    ...
    ( API.Client.ProviderPlatform.Management.callManagementAPI
        checkedMerchantId
        opCity
        (.financeManagementDSL.getFinanceManagementFleetOperatorFinanceList)
        fleetOperatorId
        from
        limit
        offset
