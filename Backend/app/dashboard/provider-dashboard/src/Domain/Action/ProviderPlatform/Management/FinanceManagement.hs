...
getFinanceManagementFinanceSapJournalsTransactions merchantShortId opCity apiTokenInfo description limit offset subscriptionId batchId transactionType = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  API.Client.ProviderPlatform.Management.callManagementAPI checkedMerchantId opCity (.financeManagementDSL.getFinanceManagementFinanceSapJournalsTransactions) description limit offset subscriptionId batchId transactionType
