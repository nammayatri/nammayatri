...
postPassettoEncrypt :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.Dashboard.AppManagement.Passetto.PassettoEncryptReq -> Environment.Flow API.Types.Dashboard.AppManagement.Passetto.PassettoEncryptResp)
...
postPassettoDecrypt :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.Dashboard.AppManagement.Passetto.PassettoDecryptReq -> Environment.Flow API.Types.Dashboard.AppManagement.Passetto.PassettoDecryptResp)
