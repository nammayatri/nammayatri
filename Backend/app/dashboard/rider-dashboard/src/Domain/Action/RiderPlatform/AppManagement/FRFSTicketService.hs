...
postFRFSTicketServiceCustomerFrfsRouteServiceability merchantShortId opCity apiTokenInfo customerId routeId req = do
  ...
  SharedLogic.Transaction.withTransactionStoring transaction $ (do API.Client.RiderPlatform.AppManagement.callAppManagementAPI checkedMerchantId opCity (.fRFSTicketServiceDSL.postFRFSTicketServiceCustomerFrfsRouteServiceability) customerId routeId req)
