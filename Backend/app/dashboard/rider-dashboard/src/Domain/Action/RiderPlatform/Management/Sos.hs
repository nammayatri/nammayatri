...
module Domain.Action.RiderPlatform.Management.Sos (getSosTracking, getSosDetails, postSosCallExternalSOS, postSosErssStatusUpdate) where
...
postSosCallExternalSOS :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Types.Id.Id Dashboard.Common.Sos -> API.Types.RiderPlatform.Management.Sos.CallExternalSOSReq -> Environment.Flow Kernel.Types.APISuccess.APISuccess)
postSosCallExternalSOS merchantShortId opCity apiTokenInfo sosId req = do
  ...
  SharedLogic.Transaction.withTransactionStoring transaction $ (do API.Client.RiderPlatform.Management.callManagementAPI checkedMerchantId opCity (.sosDSL.postSosCallExternalSOS) sosId req)
...
postSosErssStatusUpdate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> API.Types.RiderPlatform.Management.Sos.ErssStatusUpdateReq -> Environment.Flow API.Types.RiderPlatform.Management.Sos.ErssStatusUpdateRes)
postSosErssStatusUpdate merchantShortId opCity apiTokenInfo req = do
  checkedMerchantId <- merchantCityAccessCheck merchantShortId apiTokenInfo.merchant.shortId opCity apiTokenInfo.city
  transaction <- SharedLogic.Transaction.buildTransaction (Domain.Types.Transaction.ActionAPI apiTokenInfo.userActionType) (Kernel.Prelude.Just APP_BACKEND_MANAGEMENT) (Kernel.Prelude.Just apiTokenInfo) Kernel.Prelude.Nothing Kernel.Prelude.Nothing SharedLogic.Transaction.emptyRequest
  SharedLogic.Transaction.withTransactionStoring transaction $ do API.Client.RiderPlatform.Management.callManagementAPI checkedMerchantId opCity (.sosDSL.postSosErssStatusUpdate) req
