...
data ManagementAPIs
    = ManagementAPIs {alertIncidentDSL :: API.Types.RiderPlatform.Management.AlertIncident.AlertIncidentAPIs,
...
mkManagementAPIs merchantId city token = do {let {alertIncidentDSL = API.Types.RiderPlatform.Management.AlertIncident.mkAlertIncidentAPIs alertIncidentClientDSL};
