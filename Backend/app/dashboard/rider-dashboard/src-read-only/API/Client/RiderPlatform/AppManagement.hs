...
data AppManagementAPIs
    = AppManagementAPIs {customerDSL :: API.Types.Dashboard.AppManagement.Customer.CustomerAPIs,
...
mkAppManagementAPIs merchantId city token = do {let {customerDSL = API.Types.Dashboard.AppManagement.Customer.mkCustomerAPIs customerClientDSL};
