...
data RideBookingAPIs
    = RideBookingAPIs {bookingDSL :: API.Types.Dashboard.RideBooking.Booking.BookingAPIs,
...
mkRideBookingAPIs merchantId city token = do {let {bookingDSL = API.Types.Dashboard.RideBooking.Booking.mkBookingAPIs bookingClientDSL};
