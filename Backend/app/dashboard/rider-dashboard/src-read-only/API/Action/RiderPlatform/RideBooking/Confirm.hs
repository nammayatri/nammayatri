...
postConfirmRideSearchQuotes merchantShortId opCity apiTokenInfo customerId quoteId paymentMethodId paymentInstrument isAdvancedBookingEnabled requiresPaymentBeforeConfirm = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.RideBooking.Confirm.postConfirmRideSearchQuotes merchantShortId opCity apiTokenInfo customerId quoteId paymentMethodId paymentInstrument isAdvancedBookingEnabled requiresPaymentBeforeConfirm
