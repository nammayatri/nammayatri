...
type PostSelectEstimate = (ApiAuth ('APP_BACKEND)
                                   ('DSL)
                                   (('RIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.SELECT) / ('API.Types.Dashboard.RideBooking.Select.POST_SELECT_ESTIMATE)) :> API.Types.Dashboard.RideBooking.Select.PostSelectEstimate)
type GetSelectQuotes = (ApiAuth ('APP_BACKEND)
                                ('DSL)
                                (('RIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.SELECT) / ('API.Types.Dashboard.RideBooking.Select.GET_SELECT_QUOTES)) :> API.Types.Dashboard.RideBooking.Select.GetSelectQuotes)
type GetSelectResult = (ApiAuth ('APP_BACKEND)
                                ('DSL)
                                (('RIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.SELECT) / ('API.Types.Dashboard.RideBooking.Select.GET_SELECT_RESULT)) :> API.Types.Dashboard.RideBooking.Select.GetSelectResult)
type PostSelectCancelSearch = (ApiAuth ('APP_BACKEND)
                                       ('DSL)
                                       (('RIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.SELECT) / ('API.Types.Dashboard.RideBooking.Select.POST_SELECT_CANCEL_SEARCH)) :> API.Types.Dashboard.RideBooking.Select.PostSelectCancelSearch)
