...
type GetIssueListV1 = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                               ('DSL)
                               (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE_LIST) / ('API.Types.RiderPlatform.IssueManagement.IssueList.GET_ISSUE_LIST_V1)) :> API.Types.RiderPlatform.IssueManagement.IssueList.GetIssueListV1)
type PostIssueListTicketStatusCallBack = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                  ('DSL)
                                                  (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE_LIST) / ('API.Types.RiderPlatform.IssueManagement.IssueList.POST_ISSUE_LIST_TICKET_STATUS_CALL_BACK)) :> API.Types.RiderPlatform.IssueManagement.IssueList.PostIssueListTicketStatusCallBack)
