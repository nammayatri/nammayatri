...
type GetMultiModalList = (ApiAuth ('APP_BACKEND)
                                  ('DSL)
                                  (('RIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.MULTI_MODAL) / ('API.Types.Dashboard.RideBooking.MultiModal.GET_MULTI_MODAL_LIST)) :> API.Types.Dashboard.RideBooking.MultiModal.GetMultiModalList)
type PostMultiModalSendMessage = (ApiAuth ('APP_BACKEND)
                                          ('DSL)
                                          (('RIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.MULTI_MODAL) / ('API.Types.Dashboard.RideBooking.MultiModal.POST_MULTI_MODAL_SEND_MESSAGE)) :> API.Types.Dashboard.RideBooking.MultiModal.PostMultiModalSendMessage)
type PostMultiModalAddComment = (ApiAuth ('APP_BACKEND)
                                         ('DSL)
                                         (('RIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.MULTI_MODAL) / ('API.Types.Dashboard.RideBooking.MultiModal.POST_MULTI_MODAL_ADD_COMMENT)) :> API.Types.Dashboard.RideBooking.MultiModal.PostMultiModalAddComment)
type GetMultiModalGetComments = (ApiAuth ('APP_BACKEND)
                                         ('DSL)
                                         (('RIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.MULTI_MODAL) / ('API.Types.Dashboard.RideBooking.MultiModal.GET_MULTI_MODAL_GET_COMMENTS)) :> API.Types.Dashboard.RideBooking.MultiModal.GetMultiModalGetComments)
