...
type PostNammaTagTagCreate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                      ('DSL)
                                      (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_TAG_CREATE)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagTagCreate)
type PostNammaTagTagUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                      ('DSL)
                                      (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_TAG_UPDATE)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagTagUpdate)
type PostNammaTagTagVerify = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                      ('DSL)
                                      (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_TAG_VERIFY)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagTagVerify)
type DeleteNammaTagTagDelete = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                        ('DSL)
                                        (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.DELETE_NAMMA_TAG_TAG_DELETE)) :> API.Types.RiderPlatform.Management.NammaTag.DeleteNammaTagTagDelete)
type GetNammaTagTagAll = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                  ('DSL)
                                  (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_TAG_ALL)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagTagAll)
type GetNammaTagTagDetails = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                      ('DSL)
                                      (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_TAG_DETAILS)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagTagDetails)
type PostNammaTagQueryCreate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                        ('DSL)
                                        (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_QUERY_CREATE)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagQueryCreate)
type PostNammaTagQueryUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                        ('DSL)
                                        (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_QUERY_UPDATE)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagQueryUpdate)
type DeleteNammaTagQueryDelete = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                          ('DSL)
                                          (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.DELETE_NAMMA_TAG_QUERY_DELETE)) :> API.Types.RiderPlatform.Management.NammaTag.DeleteNammaTagQueryDelete)
type GetNammaTagQueryDetails = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                        ('DSL)
                                        (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_QUERY_DETAILS)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagQueryDetails)
type PostNammaTagAppDynamicLogicVerify = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                  ('DSL)
                                                  (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_APP_DYNAMIC_LOGIC_VERIFY)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagAppDynamicLogicVerify)
type GetNammaTagAppDynamicLogic = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                           ('DSL)
                                           (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_APP_DYNAMIC_LOGIC)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagAppDynamicLogic)
type PostNammaTagRunJob = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                   ('DSL)
                                   (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_RUN_JOB)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagRunJob)
type GetNammaTagTimeBounds = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                      ('DSL)
                                      (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_TIME_BOUNDS)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagTimeBounds)
type PostNammaTagTimeBoundsCreate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                             ('DSL)
                                             (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_TIME_BOUNDS_CREATE)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagTimeBoundsCreate)
type DeleteNammaTagTimeBoundsDelete = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                               ('DSL)
                                               (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.DELETE_NAMMA_TAG_TIME_BOUNDS_DELETE)) :> API.Types.RiderPlatform.Management.NammaTag.DeleteNammaTagTimeBoundsDelete)
type GetNammaTagAppDynamicLogicGetLogicRollout = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                          ('DSL)
                                                          (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_APP_DYNAMIC_LOGIC_GET_LOGIC_ROLLOUT)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagAppDynamicLogicGetLogicRollout)
type PostNammaTagAppDynamicLogicUpsertLogicRollout = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                              ('DSL)
                                                              (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_APP_DYNAMIC_LOGIC_UPSERT_LOGIC_ROLLOUT)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagAppDynamicLogicUpsertLogicRollout)
type GetNammaTagAppDynamicLogicVersions = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                   ('DSL)
                                                   (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_APP_DYNAMIC_LOGIC_VERSIONS)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagAppDynamicLogicVersions)
type GetNammaTagAppDynamicLogicDomains = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                  ('DSL)
                                                  (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_APP_DYNAMIC_LOGIC_DOMAINS)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagAppDynamicLogicDomains)
type GetNammaTagAppDynamicLogicDomainsAndEvents = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                           ('DSL)
                                                           (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_APP_DYNAMIC_LOGIC_DOMAINS_AND_EVENTS)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagAppDynamicLogicDomainsAndEvents)
type GetNammaTagAppDynamicLogicGetDomainSchema = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                          ('DSL)
                                                          (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_APP_DYNAMIC_LOGIC_GET_DOMAIN_SCHEMA)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagAppDynamicLogicGetDomainSchema)
type GetNammaTagQueryAll = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                    ('DSL)
                                    (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_QUERY_ALL)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagQueryAll)
type PostNammaTagUpdateCustomerTag = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                              ('DSL)
                                              (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_UPDATE_CUSTOMER_TAG)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagUpdateCustomerTag)
type PostNammaTagConfigPilotGetVersion = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                  ('DSL)
                                                  (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_CONFIG_PILOT_GET_VERSION)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagConfigPilotGetVersion)
type PostNammaTagConfigPilotGetConfig = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                 ('DSL)
                                                 (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_CONFIG_PILOT_GET_CONFIG)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagConfigPilotGetConfig)
type PostNammaTagConfigPilotCreateUiConfig = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                      ('DSL)
                                                      (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_CONFIG_PILOT_CREATE_UI_CONFIG)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagConfigPilotCreateUiConfig)
type GetNammaTagConfigPilotAllConfigs = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                 ('DSL)
                                                 (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_ALL_CONFIGS)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagConfigPilotAllConfigs)
type GetNammaTagConfigPilotConfigDetails = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                    ('DSL)
                                                    (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_CONFIG_DETAILS)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagConfigPilotConfigDetails)
type GetNammaTagConfigPilotGetTableData = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                   ('DSL)
                                                   (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_GET_TABLE_DATA)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagConfigPilotGetTableData)
type GetNammaTagConfigPilotAllUiConfigs = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                   ('DSL)
                                                   (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_ALL_UI_CONFIGS)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagConfigPilotAllUiConfigs)
type GetNammaTagConfigPilotUiConfigDetails = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                      ('DSL)
                                                      (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_UI_CONFIG_DETAILS)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagConfigPilotUiConfigDetails)
type GetNammaTagConfigPilotGetUiTableData = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                     ('DSL)
                                                     (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_GET_UI_TABLE_DATA)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagConfigPilotGetUiTableData)
type GetNammaTagConfigPilotAlwaysOnList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                   ('DSL)
                                                   (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_ALWAYS_ON_LIST)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagConfigPilotAlwaysOnList)
type PostNammaTagConfigPilotActionChange = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                    ('DSL)
                                                    (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_CONFIG_PILOT_ACTION_CHANGE)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagConfigPilotActionChange)
type PostNammaTagConfigPilotGetConfigWithDimensions = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                               ('DSL)
                                                               (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_CONFIG_PILOT_GET_CONFIG_WITH_DIMENSIONS)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagConfigPilotGetConfigWithDimensions)
type GetNammaTagConfigPilotGetDimensionSchema = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                         ('DSL)
                                                         (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.GET_NAMMA_TAG_CONFIG_PILOT_GET_DIMENSION_SCHEMA)) :> API.Types.RiderPlatform.Management.NammaTag.GetNammaTagConfigPilotGetDimensionSchema)
type PostNammaTagConfigPilotCreateRow = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                 ('DSL)
                                                 (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.NAMMA_TAG) / ('API.Types.RiderPlatform.Management.NammaTag.POST_NAMMA_TAG_CONFIG_PILOT_CREATE_ROW)) :> API.Types.RiderPlatform.Management.NammaTag.PostNammaTagConfigPilotCreateRow)
