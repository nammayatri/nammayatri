...
type GetIncentiveJourneyPersonAssignments =
  ( ApiAuth
      'APP_BACKEND_MANAGEMENT
      'DSL
      ('RIDER_MANAGEMENT / 'API.Types.RiderPlatform.Management.INCENTIVE_JOURNEY / 'API.Types.RiderPlatform.Management.IncentiveJourney.GET_INCENTIVE_JOURNEY_PERSON_ASSIGNMENTS)
      :> API.Types.RiderPlatform.Management.IncentiveJourney.GetIncentiveJourneyPersonAssignments
  )
...
type GetIncentiveJourneyCohortJourneyList =
  ( ApiAuth
      'APP_BACKEND_MANAGEMENT
      'DSL
      ('RIDER_MANAGEMENT / 'API.Types.RiderPlatform.Management.INCENTIVE_JOURNEY / 'API.Types.RiderPlatform.Management.IncentiveJourney.GET_INCENTIVE_JOURNEY_COHORT_JOURNEY_LIST)
      :> API.Types.RiderPlatform.Management.IncentiveJourney.GetIncentiveJourneyCohortJourneyList
  )
...
getIncentiveJourneyPersonAssignments :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Dashboard.Common.Person -> Environment.FlowHandler API.Types.RiderPlatform.Management.IncentiveJourney.IncentiveJourneyPersonAssignmentListRes)
getIncentiveJourneyPersonAssignments merchantShortId opCity apiTokenInfo personId = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.Management.IncentiveJourney.getIncentiveJourneyPersonAssignments merchantShortId opCity apiTokenInfo personId
...
getIncentiveJourneyCohortJourneyList :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Environment.FlowHandler API.Types.RiderPlatform.Management.IncentiveJourney.CohortJourneyMappingListRes)
getIncentiveJourneyCohortJourneyList merchantShortId opCity apiTokenInfo limit offset cohortName = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.Management.IncentiveJourney.getIncentiveJourneyCohortJourneyList merchantShortId opCity apiTokenInfo limit offset cohortName
