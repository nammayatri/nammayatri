...
type PostEventManagementTicketdashboardTicketplaceApproveDraft =
  ( ApiAuth
      'APP_BACKEND_MANAGEMENT
      'DSL
      ('RIDER_APP_MANAGEMENT / 'API.Types.Dashboard.AppManagement.EVENT_MANAGEMENT / 'API.Types.Dashboard.AppManagement.EventManagement.POST_EVENT_MANAGEMENT_TICKETDASHBOARD_TICKETPLACE_APPROVE_DRAFT)
      :> API.Types.Dashboard.AppManagement.EventManagement.PostEventManagementTicketdashboardTicketplaceApproveDraft
  )
...
postEventManagementTicketdashboardTicketplaceApproveDraft merchantShortId opCity apiTokenInfo ticketPlaceId requestorId requestorRole = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.AppManagement.EventManagement.postEventManagementTicketdashboardTicketplaceApproveDraft merchantShortId opCity apiTokenInfo ticketPlaceId requestorId requestorRole
