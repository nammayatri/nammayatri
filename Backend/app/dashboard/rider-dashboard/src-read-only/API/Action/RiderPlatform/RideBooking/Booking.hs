...
type PostBookingStatus = (ApiAuth ('APP_BACKEND)
                                  ('DSL)
                                  (('RIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.BOOKING) / ('API.Types.Dashboard.RideBooking.Booking.POST_BOOKING_STATUS)) :> API.Types.Dashboard.RideBooking.Booking.PostBookingStatus)
type GetBookingBooking = API.Types.Dashboard.RideBooking.Booking.GetBookingBooking
type GetBookingList = (ApiAuth ('APP_BACKEND)
                               ('DSL)
                               (('RIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.BOOKING) / ('API.Types.Dashboard.RideBooking.Booking.GET_BOOKING_LIST)) :> API.Types.Dashboard.RideBooking.Booking.GetBookingList)
type GetBookingAgentL1List = (ApiAuth ('APP_BACKEND)
                                      ('DSL)
                                      (('RIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.BOOKING) / ('API.Types.Dashboard.RideBooking.Booking.GET_BOOKING_AGENT_L1_LIST)) :> API.Types.Dashboard.RideBooking.Booking.GetBookingAgentL1List)
type GetBookingAgentL2List = (ApiAuth ('APP_BACKEND)
                                      ('DSL)
                                      (('RIDER_RIDE_BOOKING) / ('API.Types.Dashboard.RideBooking.BOOKING) / ('API.Types.Dashboard.RideBooking.Booking.GET_BOOKING_AGENT_L2_LIST)) :> API.Types.Dashboard.RideBooking.Booking.GetBookingAgentL2List)
