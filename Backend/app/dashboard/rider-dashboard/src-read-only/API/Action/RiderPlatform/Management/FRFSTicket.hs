...
postFRFSTicketFrfsRouteAdd merchantShortId opCity apiTokenInfo code integratedBppConfigId vehicleType req = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.Management.FRFSTicket.postFRFSTicketFrfsRouteAdd merchantShortId opCity apiTokenInfo code integratedBppConfigId vehicleType req

postFRFSTicketFrfsRouteDelete :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Data.Text.Text -> Kernel.Types.Id.Id Dashboard.Common.IntegratedBPPConfig -> BecknV2.FRFS.Enums.VehicleCategory -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postFRFSTicketFrfsRouteDelete merchantShortId opCity apiTokenInfo code integratedBppConfigId vehicleType = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.Management.FRFSTicket.postFRFSTicketFrfsRouteDelete merchantShortId opCity apiTokenInfo code integratedBppConfigId vehicleType
...
postFRFSTicketFrfsStationAdd merchantShortId opCity apiTokenInfo code integratedBppConfigId vehicleType req = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.Management.FRFSTicket.postFRFSTicketFrfsStationAdd merchantShortId opCity apiTokenInfo code integratedBppConfigId vehicleType req

postFRFSTicketFrfsStationDelete :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Data.Text.Text -> Kernel.Types.Id.Id Dashboard.Common.IntegratedBPPConfig -> BecknV2.FRFS.Enums.VehicleCategory -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postFRFSTicketFrfsStationDelete merchantShortId opCity apiTokenInfo code integratedBppConfigId vehicleType = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.Management.FRFSTicket.postFRFSTicketFrfsStationDelete merchantShortId opCity apiTokenInfo code integratedBppConfigId vehicleType
