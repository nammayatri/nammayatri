...
type GetPassCustomerAvailablePasses = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                               ('DSL)
                                               (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.PASS) / ('API.Types.Dashboard.AppManagement.Pass.GET_PASS_CUSTOMER_AVAILABLE_PASSES)) :> API.Types.Dashboard.AppManagement.Pass.GetPassCustomerAvailablePasses)
type GetPassCustomerPurchasedPasses = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                               ('DSL)
                                               (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.PASS) / ('API.Types.Dashboard.AppManagement.Pass.GET_PASS_CUSTOMER_PURCHASED_PASSES)) :> API.Types.Dashboard.AppManagement.Pass.GetPassCustomerPurchasedPasses)
type GetPassCustomerTransactions = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                            ('DSL)
                                            (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.PASS) / ('API.Types.Dashboard.AppManagement.Pass.GET_PASS_CUSTOMER_TRANSACTIONS)) :> API.Types.Dashboard.AppManagement.Pass.GetPassCustomerTransactions)
type PostPassCustomerActivateToday = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                              ('DSL)
                                              (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.PASS) / ('API.Types.Dashboard.AppManagement.Pass.POST_PASS_CUSTOMER_ACTIVATE_TODAY)) :> API.Types.Dashboard.AppManagement.Pass.PostPassCustomerActivateToday)
type PostPassCustomerPassSelect = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                           ('DSL)
                                           (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.PASS) / ('API.Types.Dashboard.AppManagement.Pass.POST_PASS_CUSTOMER_PASS_SELECT)) :> API.Types.Dashboard.AppManagement.Pass.PostPassCustomerPassSelect)
type GetPassCustomerPaymentStatus = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                             ('DSL)
                                             (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.PASS) / ('API.Types.Dashboard.AppManagement.Pass.GET_PASS_CUSTOMER_PAYMENT_STATUS)) :> API.Types.Dashboard.AppManagement.Pass.GetPassCustomerPaymentStatus)
type PostPassCustomerPassResetDeviceSwitchCount = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                           ('DSL)
                                                           (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.PASS) / ('API.Types.Dashboard.AppManagement.Pass.POST_PASS_CUSTOMER_PASS_RESET_DEVICE_SWITCH_COUNT)) :> API.Types.Dashboard.AppManagement.Pass.PostPassCustomerPassResetDeviceSwitchCount)
type PostPassCustomerPassUpdateProfilePicture = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                         ('DSL)
                                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.PASS) / ('API.Types.Dashboard.AppManagement.Pass.POST_PASS_CUSTOMER_PASS_UPDATE_PROFILE_PICTURE)) :> API.Types.Dashboard.AppManagement.Pass.PostPassCustomerPassUpdateProfilePicture)
...
postPassCustomerActivateToday :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Domain.Types.Person.Person -> Kernel.Prelude.Int -> Kernel.Prelude.Maybe (Data.Time.Day) -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postPassCustomerActivateToday merchantShortId opCity apiTokenInfo customerId passNumber startDay = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.AppManagement.Pass.postPassCustomerActivateToday merchantShortId opCity apiTokenInfo customerId passNumber startDay
