...
type GetFRFSAlertsFrfsLiveMetrics = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                             ('DSL)
                                             (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.FRFS_ALERTS) / ('API.Types.RiderPlatform.Management.FRFSAlerts.GET_FRFS_ALERTS_FRFS_LIVE_METRICS)) :> API.Types.RiderPlatform.Management.FRFSAlerts.GetFRFSAlertsFrfsLiveMetrics)
