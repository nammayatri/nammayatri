...
type PostBookingCancelAllStuck = (ApiAuth 'APP_BACKEND_MANAGEMENT 'RIDES 'STUCK_BOOKING_CANCEL :> API.Types.RiderPlatform.Management.Booking.PostBookingCancelAllStuck)

type PostBookingSyncMultiple = (ApiAuth 'APP_BACKEND_MANAGEMENT 'RIDES 'MULTIPLE_BOOKING_SYNC :> API.Types.RiderPlatform.Management.Booking.PostBookingSyncMultiple)
