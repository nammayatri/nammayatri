...
type ListVehicleSeatLayoutMapping = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                             ('DSL)
                                             (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.VEHICLE_SEAT_LAYOUT_MAPPING) / ('API.Types.Dashboard.AppManagement.VehicleSeatLayoutMapping.LIST_VEHICLE_SEAT_LAYOUT_MAPPING)) :> API.Types.Dashboard.AppManagement.VehicleSeatLayoutMapping.ListVehicleSeatLayoutMapping)
type UpsertVehicleSeatLayoutMapping = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                               ('DSL)
                                               (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.VEHICLE_SEAT_LAYOUT_MAPPING) / ('API.Types.Dashboard.AppManagement.VehicleSeatLayoutMapping.UPSERT_VEHICLE_SEAT_LAYOUT_MAPPING)) :> API.Types.Dashboard.AppManagement.VehicleSeatLayoutMapping.UpsertVehicleSeatLayoutMapping)
type DeleteVehicleSeatLayoutMapping = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                               ('DSL)
                                               (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.VEHICLE_SEAT_LAYOUT_MAPPING) / ('API.Types.Dashboard.AppManagement.VehicleSeatLayoutMapping.DELETE_VEHICLE_SEAT_LAYOUT_MAPPING)) :> API.Types.Dashboard.AppManagement.VehicleSeatLayoutMapping.DeleteVehicleSeatLayoutMapping)
