...
type GetAlertIncidentAlertsIncidents = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                ('DSL)
                                                (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.ALERT_INCIDENT) / ('API.Types.RiderPlatform.Management.AlertIncident.GET_ALERT_INCIDENT_ALERTS_INCIDENTS)) :> API.Types.RiderPlatform.Management.AlertIncident.GetAlertIncidentAlertsIncidents)
