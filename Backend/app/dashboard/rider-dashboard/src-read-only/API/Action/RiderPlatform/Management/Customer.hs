...
type GetCustomerList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                ('DSL)
                                (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.CUSTOMER) / ('API.Types.RiderPlatform.Management.Customer.GET_CUSTOMER_LIST)) :> API.Types.RiderPlatform.Management.Customer.GetCustomerList)
type DeleteCustomerDelete = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                     ('DSL)
                                     (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.CUSTOMER) / ('API.Types.RiderPlatform.Management.Customer.DELETE_CUSTOMER_DELETE)) :> API.Types.RiderPlatform.Management.Customer.DeleteCustomerDelete)
type PostCustomerBlock = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                  ('DSL)
                                  (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.CUSTOMER) / ('API.Types.RiderPlatform.Management.Customer.POST_CUSTOMER_BLOCK)) :> API.Types.RiderPlatform.Management.Customer.PostCustomerBlock)
type PostCustomerUnblock = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                    ('DSL)
                                    (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.CUSTOMER) / ('API.Types.RiderPlatform.Management.Customer.POST_CUSTOMER_UNBLOCK)) :> API.Types.RiderPlatform.Management.Customer.PostCustomerUnblock)
type GetCustomerInfo = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                ('DSL)
                                (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.CUSTOMER) / ('API.Types.RiderPlatform.Management.Customer.GET_CUSTOMER_INFO)) :> API.Types.RiderPlatform.Management.Customer.GetCustomerInfo)
type PostCustomerCancellationDuesSync = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                 ('DSL)
                                                 (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.CUSTOMER) / ('API.Types.RiderPlatform.Management.Customer.POST_CUSTOMER_CANCELLATION_DUES_SYNC)) :> API.Types.RiderPlatform.Management.Customer.PostCustomerCancellationDuesSync)
type GetCustomerCancellationDuesDetails = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                   ('DSL)
                                                   (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.CUSTOMER) / ('API.Types.RiderPlatform.Management.Customer.GET_CUSTOMER_CANCELLATION_DUES_DETAILS)) :> API.Types.RiderPlatform.Management.Customer.GetCustomerCancellationDuesDetails)
type PostCustomerUpdateSafetyCenterBlocking = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                       ('DSL)
                                                       (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.CUSTOMER) / ('API.Types.RiderPlatform.Management.Customer.POST_CUSTOMER_UPDATE_SAFETY_CENTER_BLOCKING)) :> API.Types.RiderPlatform.Management.Customer.PostCustomerUpdateSafetyCenterBlocking)
type PostCustomerPersonNumbers = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                          ('DSL)
                                          (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.CUSTOMER) / ('API.Types.RiderPlatform.Management.Customer.POST_CUSTOMER_PERSON_NUMBERS)) :> API.Types.RiderPlatform.Management.Customer.PostCustomerPersonNumbers)
type PostCustomerPersonId = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                     ('DSL)
                                     (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.CUSTOMER) / ('API.Types.RiderPlatform.Management.Customer.POST_CUSTOMER_PERSON_ID)) :> API.Types.RiderPlatform.Management.Customer.PostCustomerPersonId)
type PostCustomerUpdatePaymentMode = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                              ('DSL)
                                              (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.CUSTOMER) / ('API.Types.RiderPlatform.Management.Customer.POST_CUSTOMER_UPDATE_PAYMENT_MODE)) :> API.Types.RiderPlatform.Management.Customer.PostCustomerUpdatePaymentMode)
