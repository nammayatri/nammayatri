...
type PostCustomerPersonNumbers = (ApiAuth 'APP_BACKEND_MANAGEMENT 'CUSTOMERS 'PERSON_NUMBERS :> API.Types.RiderPlatform.Management.Customer.PostCustomerPersonNumbers)

type PostCustomerPersonId = (ApiAuth 'APP_BACKEND_MANAGEMENT 'CUSTOMERS 'FETCH_PERSON_ID :> API.Types.RiderPlatform.Management.Customer.PostCustomerPersonId)
