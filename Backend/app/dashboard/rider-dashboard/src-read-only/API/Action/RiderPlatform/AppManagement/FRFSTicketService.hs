...
type GetFRFSTicketServiceCustomerFrfsBookingPaymentAttempts =
  ( ApiAuth
      ('APP_BACKEND_MANAGEMENT)
      ('DSL)
      (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.FRFS_TICKET_SERVICE) / ('API.Types.Dashboard.AppManagement.FRFSTicketService.GET_FRFS_TICKET_SERVICE_CUSTOMER_FRFS_BOOKING_PAYMENT_ATTEMPTS))
...
type GetFRFSTicketServiceCustomerFrfsPaymentAttempts =
  ( ApiAuth
      ('APP_BACKEND_MANAGEMENT)
      ('DSL)
      (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.FRFS_TICKET_SERVICE) / ('API.Types.Dashboard.AppManagement.FRFSTicketService.GET_FRFS_TICKET_SERVICE_CUSTOMER_FRFS_PAYMENT_ATTEMPTS))
...
getFRFSTicketServiceCustomerFrfsConfig :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo UserActionType -> Kernel.Types.Id.Id Domain.Types.Person.Person -> Kernel.Types.Beckn.Context.City -> Environment.FlowHandler API.Types.UI.FRFSTicketService.FRFSConfigAPIRes)
...
getFRFSTicketServiceCustomerFrfsBookingPaymentAttempts merchantShortId opCity apiTokenInfo customerId bookingId = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.AppManagement.FRFSTicketService.getFRFSTicketServiceCustomerFrfsBookingPaymentAttempts merchantShortId opCity apiTokenInfo customerId bookingId
...
getFRFSTicketServiceCustomerFrfsPaymentAttempts merchantShortId opCity apiTokenInfo customerId limit offset = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.AppManagement.FRFSTicketService.getFRFSTicketServiceCustomerFrfsPaymentAttempts merchantShortId opCity apiTokenInfo customerId limit offset
