...
type GetRideList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                            ('DSL)
                            (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.RIDE) / ('API.Types.RiderPlatform.Management.Ride.GET_RIDE_LIST)) :> API.Types.RiderPlatform.Management.Ride.GetRideList)
type GetRideInfo = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                            ('DSL)
                            (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.RIDE) / ('API.Types.RiderPlatform.Management.Ride.GET_RIDE_INFO)) :> API.Types.RiderPlatform.Management.Ride.GetRideInfo)
type CancellationChargesWaiveOff = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                            ('DSL)
                                            (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.RIDE) / ('API.Types.RiderPlatform.Management.Ride.CANCELLATION_CHARGES_WAIVE_OFF)) :> API.Types.RiderPlatform.Management.Ride.CancellationChargesWaiveOff)
...
type PostRideSyncMultiple = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                     ('DSL)
                                     (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.RIDE) / ('API.Types.RiderPlatform.Management.Ride.POST_RIDE_SYNC_MULTIPLE)) :> API.Types.RiderPlatform.Management.Ride.PostRideSyncMultiple)
type PostRideCancelMultiple = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                       ('DSL)
                                       (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.RIDE) / ('API.Types.RiderPlatform.Management.Ride.POST_RIDE_CANCEL_MULTIPLE)) :> API.Types.RiderPlatform.Management.Ride.PostRideCancelMultiple)
type GetRideKaptureList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                   ('DSL)
                                   (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.RIDE) / ('API.Types.RiderPlatform.Management.Ride.GET_RIDE_KAPTURE_LIST)) :> API.Types.RiderPlatform.Management.Ride.GetRideKaptureList)
