...
type GetPaymentRefundRequestList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                            ('DSL)
                                            (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.PAYMENT) / ('API.Types.Dashboard.AppManagement.Payment.GET_PAYMENT_REFUND_REQUEST_LIST)) :> API.Types.Dashboard.AppManagement.Payment.GetPaymentRefundRequestList)
type GetPaymentRefundRequestInfo = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                            ('DSL)
                                            (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.PAYMENT) / ('API.Types.Dashboard.AppManagement.Payment.GET_PAYMENT_REFUND_REQUEST_INFO)) :> API.Types.Dashboard.AppManagement.Payment.GetPaymentRefundRequestInfo)
type PostPaymentRefundRequestRespond = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                ('DSL)
                                                (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.PAYMENT) / ('API.Types.Dashboard.AppManagement.Payment.POST_PAYMENT_REFUND_REQUEST_RESPOND)) :> API.Types.Dashboard.AppManagement.Payment.PostPaymentRefundRequestRespond)
