...
ticketDashboardUploadAsset merchantShortId opCity apiTokenInfo ticketPlaceId req = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.AppManagement.TicketDashboard.ticketDashboardUploadAsset merchantShortId opCity apiTokenInfo ticketPlaceId req
...
ticketDashboardDeleteAsset merchantShortId opCity apiTokenInfo ticketPlaceId req = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.AppManagement.TicketDashboard.ticketDashboardDeleteAsset merchantShortId opCity apiTokenInfo ticketPlaceId req
...
ticketDashboardCurrentSeatStatus merchantShortId opCity apiTokenInfo ticketPlaceId req = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.AppManagement.TicketDashboard.ticketDashboardCurrentSeatStatus merchantShortId opCity apiTokenInfo ticketPlaceId req
...
ticketDashboardSeatManagement merchantShortId opCity apiTokenInfo ticketPlaceId req = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.AppManagement.TicketDashboard.ticketDashboardSeatManagement merchantShortId opCity apiTokenInfo ticketPlaceId req
