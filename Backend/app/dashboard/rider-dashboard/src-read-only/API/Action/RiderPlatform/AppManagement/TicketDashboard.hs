...
type TicketDashboardUploadAsset = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                           ('DSL)
                                           (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKET_DASHBOARD) / ('API.Types.Dashboard.AppManagement.TicketDashboard.TICKET_DASHBOARD_UPLOAD_ASSET)) :> API.Types.Dashboard.AppManagement.TicketDashboard.TicketDashboardUploadAsset)
type TicketDashboardDeleteAsset = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                           ('DSL)
                                           (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKET_DASHBOARD) / ('API.Types.Dashboard.AppManagement.TicketDashboard.TICKET_DASHBOARD_DELETE_ASSET)) :> API.Types.Dashboard.AppManagement.TicketDashboard.TicketDashboardDeleteAsset)
type TicketDashboardCurrentSeatStatus = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                 ('DSL)
                                                 (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKET_DASHBOARD) / ('API.Types.Dashboard.AppManagement.TicketDashboard.TICKET_DASHBOARD_CURRENT_SEAT_STATUS)) :> API.Types.Dashboard.AppManagement.TicketDashboard.TicketDashboardCurrentSeatStatus)
type TicketDashboardSeatManagement = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                              ('DSL)
                                              (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKET_DASHBOARD) / ('API.Types.Dashboard.AppManagement.TicketDashboard.TICKET_DASHBOARD_SEAT_MANAGEMENT)) :> API.Types.Dashboard.AppManagement.TicketDashboard.TicketDashboardSeatManagement)
