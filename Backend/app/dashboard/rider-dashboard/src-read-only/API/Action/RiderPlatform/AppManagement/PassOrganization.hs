...
getPassOrganizationPassDetailsDepot merchantShortId opCity apiTokenInfo passEnum depotPersonId status limit offset = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.AppManagement.PassOrganization.getPassOrganizationPassDetailsDepot merchantShortId opCity apiTokenInfo passEnum depotPersonId status limit offset
