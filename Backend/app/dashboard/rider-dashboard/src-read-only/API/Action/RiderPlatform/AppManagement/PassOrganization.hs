...
postPassOrganizationAssignDepot :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Domain.Types.Person.Person -> API.Types.Dashboard.AppManagement.PassOrganization.AssignDepotReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postPassOrganizationAssignDepot merchantShortId opCity apiTokenInfo depotPersonId req = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.AppManagement.PassOrganization.postPassOrganizationAssignDepot merchantShortId opCity apiTokenInfo depotPersonId req
