...
type API = (API.Action.RiderPlatform.RideBooking.Booking.API :<|> API.Action.RiderPlatform.RideBooking.Cancel.API :<|> API.Action.RiderPlatform.RideBooking.Confirm.API :<|> API.Action.RiderPlatform.RideBooking.Frontend.API :<|> API.Action.RiderPlatform.RideBooking.Maps.API :<|> API.Action.RiderPlatform.RideBooking.Profile.API :<|> API.Action.RiderPlatform.RideBooking.Quote.API :<|> API.Action.RiderPlatform.RideBooking.Registration.API :<|> API.Action.RiderPlatform.RideBooking.Search.API :<|> API.Action.RiderPlatform.RideBooking.Select.API)
