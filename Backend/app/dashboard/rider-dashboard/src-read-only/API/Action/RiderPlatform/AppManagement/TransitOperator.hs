...
type TransitOperatorGetRow = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                      ('DSL)
                                      (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_ROW)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetRow)
type TransitOperatorGetAllRows = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                          ('DSL)
                                          (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_ALL_ROWS)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetAllRows)
type TransitOperatorDeleteRow = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                         ('DSL)
                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_DELETE_ROW)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorDeleteRow)
type TransitOperatorUpsertRow = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                         ('DSL)
                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_UPSERT_ROW)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorUpsertRow)
type TransitOperatorQueryRows = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                         ('DSL)
                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_QUERY_ROWS)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorQueryRows)
type TransitOperatorGetServiceTypes = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                               ('DSL)
                                               (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_SERVICE_TYPES)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetServiceTypes)
type TransitOperatorGetRoutes = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                         ('DSL)
                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_ROUTES)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetRoutes)
type TransitOperatorGetDepots = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                         ('DSL)
                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_DEPOTS)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetDepots)
type TransitOperatorGetShiftTypes = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                             ('DSL)
                                             (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_SHIFT_TYPES)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetShiftTypes)
type TransitOperatorGetScheduleNumbers = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                  ('DSL)
                                                  (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_SCHEDULE_NUMBERS)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetScheduleNumbers)
type TransitOperatorGetDayTypes = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                           ('DSL)
                                           (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_DAY_TYPES)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetDayTypes)
type TransitOperatorGetTripTypes = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                            ('DSL)
                                            (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_TRIP_TYPES)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetTripTypes)
type TransitOperatorGetBreakTypes = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                             ('DSL)
                                             (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_BREAK_TYPES)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetBreakTypes)
type TransitOperatorGetTripDetails = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                              ('DSL)
                                              (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_TRIP_DETAILS)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetTripDetails)
type TransitOperatorGetFleets = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                         ('DSL)
                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_FLEETS)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetFleets)
type TransitOperatorGetConductor = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                            ('DSL)
                                            (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_CONDUCTOR)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetConductor)
type TransitOperatorGetDriver = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                         ('DSL)
                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_DRIVER)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetDriver)
type TransitOperatorGetDeviceIds = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                            ('DSL)
                                            (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_DEVICE_IDS)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetDeviceIds)
type TransitOperatorGetTabletIds = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                            ('DSL)
                                            (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_TABLET_IDS)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetTabletIds)
type TransitOperatorGetOperators = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                            ('DSL)
                                            (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_OPERATORS)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetOperators)
type TransitOperatorUpdateWaybillStatus = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                   ('DSL)
                                                   (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_UPDATE_WAYBILL_STATUS)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorUpdateWaybillStatus)
type TransitOperatorUpdateWaybillFleet = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                  ('DSL)
                                                  (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_UPDATE_WAYBILL_FLEET)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorUpdateWaybillFleet)
type TransitOperatorUpdateWaybillTablet = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                   ('DSL)
                                                   (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_UPDATE_WAYBILL_TABLET)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorUpdateWaybillTablet)
type TransitOperatorGetWaybills = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                           ('DSL)
                                           (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_WAYBILLS)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetWaybills)
type TransitOperatorGetDeviceVehicleMappingList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                           ('DSL)
                                                           (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_GET_DEVICE_VEHICLE_MAPPING_LIST)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorGetDeviceVehicleMappingList)
type TransitOperatorUpsertDeviceVehicleMapping = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                          ('DSL)
                                                          (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TRANSIT_OPERATOR) / ('API.Types.Dashboard.AppManagement.TransitOperator.TRANSIT_OPERATOR_UPSERT_DEVICE_VEHICLE_MAPPING)) :> API.Types.Dashboard.AppManagement.TransitOperator.TransitOperatorUpsertDeviceVehicleMapping)
