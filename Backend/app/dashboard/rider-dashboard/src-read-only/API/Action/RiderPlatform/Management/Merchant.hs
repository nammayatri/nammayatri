...
type PostMerchantToggleGateWayAndRegistry = (ApiAuth 'APP_BACKEND_MANAGEMENT 'MERCHANT 'MERCHANT_UPDATE :> API.Types.RiderPlatform.Management.Merchant.PostMerchantToggleGateWayAndRegistry)
...
deleteMerchantSpecialLocationGatesDelete :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> Kernel.Types.Id.Id Lib.Types.SpecialLocation.SpecialLocation -> Data.Text.Text -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
...
postMerchantToggleGateWayAndRegistry :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> ApiTokenInfo -> API.Types.RiderPlatform.Management.Merchant.SwitchGateWayAndRegistry -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postMerchantToggleGateWayAndRegistry merchantShortId opCity apiTokenInfo req = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.Management.Merchant.postMerchantToggleGateWayAndRegistry merchantShortId opCity apiTokenInfo req
