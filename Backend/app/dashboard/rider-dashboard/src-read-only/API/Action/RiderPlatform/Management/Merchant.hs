...
type PostMerchantConfigFailover = (ApiAuth 'APP_BACKEND_MANAGEMENT 'MERCHANT 'TOGGLE_CONFIG_PRIORITY :> API.Types.RiderPlatform.Management.Merchant.PostMerchantConfigFailover)
