...
type API = ("merchant" :> (PostMerchantUpdate :<|> GetMerchantServiceUsageConfig :<|> PostMerchantServiceConfigMapsUpdate :<|> PostMerchantServiceUsageConfigMapsUpdate :<|> PostMerchantServiceConfigSmsUpdate :<|> PostMerchantServiceUsageConfigSmsUpdate :<|> PostMerchantConfigOperatingCityCreate :<|> PostMerchantConfigSpecialLocationUpsert :<|> GetMerchantConfigSpecialLocationList :<|> GetMerchantConfigGeometryList :<|> PutMerchantConfigGeometryUpdate :<|> PostMerchantSpecialLocationUpsert :<|> DeleteMerchantSpecialLocationDelete :<|> PostMerchantSpecialLocationGatesUpsert :<|> DeleteMerchantSpecialLocationGatesDelete :<|> PostMerchantConfigFailover :<|> PostMerchantTicketConfigUpsert :<|> PostMerchantSchedulerTrigger :<|> PostMerchantConfigOperatingCityWhiteList :<|> PostMerchantConfigMerchantCreate :<|> GetMerchantRiderConfigEstimatesOrder :<|> PostMerchantRiderConfigEstimatesOrderUpdate :<|> PostMerchantConfigDebugLogUpdate))
handler :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Environment.FlowServer API)
handler merchantId city = postMerchantUpdate merchantId city :<|> getMerchantServiceUsageConfig merchantId city :<|> postMerchantServiceConfigMapsUpdate merchantId city :<|> postMerchantServiceUsageConfigMapsUpdate merchantId city :<|> postMerchantServiceConfigSmsUpdate merchantId city :<|> postMerchantServiceUsageConfigSmsUpdate merchantId city :<|> postMerchantConfigOperatingCityCreate merchantId city :<|> postMerchantConfigSpecialLocationUpsert merchantId city :<|> getMerchantConfigSpecialLocationList merchantId city :<|> getMerchantConfigGeometryList merchantId city :<|> putMerchantConfigGeometryUpdate merchantId city :<|> postMerchantSpecialLocationUpsert merchantId city :<|> deleteMerchantSpecialLocationDelete merchantId city :<|> postMerchantSpecialLocationGatesUpsert merchantId city :<|> deleteMerchantSpecialLocationGatesDelete merchantId city :<|> postMerchantConfigFailover merchantId city :<|> postMerchantTicketConfigUpsert merchantId city :<|> postMerchantSchedulerTrigger merchantId city :<|> postMerchantConfigOperatingCityWhiteList merchantId city :<|> postMerchantConfigMerchantCreate merchantId city :<|> getMerchantRiderConfigEstimatesOrder merchantId city :<|> postMerchantRiderConfigEstimatesOrderUpdate merchantId city :<|> postMerchantConfigDebugLogUpdate merchantId city
type PostMerchantUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                   ('DSL)
                                   (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_UPDATE)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantUpdate)
type GetMerchantServiceUsageConfig = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                              ('DSL)
                                              (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.GET_MERCHANT_SERVICE_USAGE_CONFIG)) :> API.Types.RiderPlatform.Management.Merchant.GetMerchantServiceUsageConfig)
type PostMerchantServiceConfigMapsUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                    ('DSL)
                                                    (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_SERVICE_CONFIG_MAPS_UPDATE)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantServiceConfigMapsUpdate)
type PostMerchantServiceUsageConfigMapsUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                         ('DSL)
                                                         (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_SERVICE_USAGE_CONFIG_MAPS_UPDATE)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantServiceUsageConfigMapsUpdate)
type PostMerchantServiceConfigSmsUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                   ('DSL)
                                                   (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_SERVICE_CONFIG_SMS_UPDATE)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantServiceConfigSmsUpdate)
type PostMerchantServiceUsageConfigSmsUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                        ('DSL)
                                                        (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_SERVICE_USAGE_CONFIG_SMS_UPDATE)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantServiceUsageConfigSmsUpdate)
type PostMerchantConfigOperatingCityCreate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                      ('DSL)
                                                      (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_CONFIG_OPERATING_CITY_CREATE)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantConfigOperatingCityCreate)
type PostMerchantConfigSpecialLocationUpsert = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                        ('DSL)
                                                        (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_CONFIG_SPECIAL_LOCATION_UPSERT)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantConfigSpecialLocationUpsert)
type GetMerchantConfigSpecialLocationList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                     ('DSL)
                                                     (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.GET_MERCHANT_CONFIG_SPECIAL_LOCATION_LIST)) :> API.Types.RiderPlatform.Management.Merchant.GetMerchantConfigSpecialLocationList)
type GetMerchantConfigGeometryList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                              ('DSL)
                                              (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.GET_MERCHANT_CONFIG_GEOMETRY_LIST)) :> API.Types.RiderPlatform.Management.Merchant.GetMerchantConfigGeometryList)
type PutMerchantConfigGeometryUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                ('DSL)
                                                (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.PUT_MERCHANT_CONFIG_GEOMETRY_UPDATE)) :> API.Types.RiderPlatform.Management.Merchant.PutMerchantConfigGeometryUpdate)
type PostMerchantSpecialLocationUpsert = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                  ('DSL)
                                                  (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_SPECIAL_LOCATION_UPSERT)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantSpecialLocationUpsert)
type DeleteMerchantSpecialLocationDelete = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                    ('DSL)
                                                    (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.DELETE_MERCHANT_SPECIAL_LOCATION_DELETE)) :> API.Types.RiderPlatform.Management.Merchant.DeleteMerchantSpecialLocationDelete)
type PostMerchantSpecialLocationGatesUpsert = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                       ('DSL)
                                                       (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_SPECIAL_LOCATION_GATES_UPSERT)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantSpecialLocationGatesUpsert)
type DeleteMerchantSpecialLocationGatesDelete = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                         ('DSL)
                                                         (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.DELETE_MERCHANT_SPECIAL_LOCATION_GATES_DELETE)) :> API.Types.RiderPlatform.Management.Merchant.DeleteMerchantSpecialLocationGatesDelete)
type PostMerchantConfigFailover = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                           ('DSL)
                                           (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_CONFIG_FAILOVER)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantConfigFailover)
type PostMerchantTicketConfigUpsert = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                               ('DSL)
                                               (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_TICKET_CONFIG_UPSERT)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantTicketConfigUpsert)
type PostMerchantSchedulerTrigger = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                             ('DSL)
                                             (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_SCHEDULER_TRIGGER)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantSchedulerTrigger)
type PostMerchantConfigOperatingCityWhiteList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                         ('DSL)
                                                         (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_CONFIG_OPERATING_CITY_WHITE_LIST)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantConfigOperatingCityWhiteList)
type PostMerchantConfigMerchantCreate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                 ('DSL)
                                                 (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_CONFIG_MERCHANT_CREATE)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantConfigMerchantCreate)
type GetMerchantRiderConfigEstimatesOrder = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                     ('DSL)
                                                     (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.GET_MERCHANT_RIDER_CONFIG_ESTIMATES_ORDER)) :> API.Types.RiderPlatform.Management.Merchant.GetMerchantRiderConfigEstimatesOrder)
type PostMerchantRiderConfigEstimatesOrderUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                            ('DSL)
                                                            (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_RIDER_CONFIG_ESTIMATES_ORDER_UPDATE)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantRiderConfigEstimatesOrderUpdate)
type PostMerchantConfigDebugLogUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                 ('DSL)
                                                 (('RIDER_MANAGEMENT) / ('API.Types.RiderPlatform.Management.MERCHANT) / ('API.Types.RiderPlatform.Management.Merchant.POST_MERCHANT_CONFIG_DEBUG_LOG_UPDATE)) :> API.Types.RiderPlatform.Management.Merchant.PostMerchantConfigDebugLogUpdate)
