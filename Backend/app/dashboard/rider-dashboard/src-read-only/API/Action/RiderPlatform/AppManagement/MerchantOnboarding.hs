...
merchantOnboadingListAll merchantShortId opCity apiTokenInfo requestorId requestorRole status = withFlowHandlerAPI' $ Domain.Action.RiderPlatform.AppManagement.MerchantOnboarding.merchantOnboadingListAll merchantShortId opCity apiTokenInfo requestorId requestorRole status
