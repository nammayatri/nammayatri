...
type MerchantOnboardingInfo = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                       ('DSL)
                                       (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.MERCHANT_ONBOARDING) / ('API.Types.Dashboard.AppManagement.MerchantOnboarding.MERCHANT_ONBOARDING_INFO)) :> API.Types.Dashboard.AppManagement.MerchantOnboarding.MerchantOnboardingInfo)
type MerchantOnboardingStart = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                        ('DSL)
                                        (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.MERCHANT_ONBOARDING) / ('API.Types.Dashboard.AppManagement.MerchantOnboarding.MERCHANT_ONBOARDING_START)) :> API.Types.Dashboard.AppManagement.MerchantOnboarding.MerchantOnboardingStart)
type MerchantOnboardingList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                       ('DSL)
                                       (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.MERCHANT_ONBOARDING) / ('API.Types.Dashboard.AppManagement.MerchantOnboarding.MERCHANT_ONBOARDING_LIST)) :> API.Types.Dashboard.AppManagement.MerchantOnboarding.MerchantOnboardingList)
type MerchantOnboardingStepSubmit = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                             ('DSL)
                                             (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.MERCHANT_ONBOARDING) / ('API.Types.Dashboard.AppManagement.MerchantOnboarding.MERCHANT_ONBOARDING_STEP_SUBMIT)) :> API.Types.Dashboard.AppManagement.MerchantOnboarding.MerchantOnboardingStepSubmit)
type MerchantOnboardingStepUpdatePayload = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                    ('DSL)
                                                    (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.MERCHANT_ONBOARDING) / ('API.Types.Dashboard.AppManagement.MerchantOnboarding.MERCHANT_ONBOARDING_STEP_UPDATE_PAYLOAD)) :> API.Types.Dashboard.AppManagement.MerchantOnboarding.MerchantOnboardingStepUpdatePayload)
type MerchantOnboardingStepReject = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                             ('DSL)
                                             (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.MERCHANT_ONBOARDING) / ('API.Types.Dashboard.AppManagement.MerchantOnboarding.MERCHANT_ONBOARDING_STEP_REJECT)) :> API.Types.Dashboard.AppManagement.MerchantOnboarding.MerchantOnboardingStepReject)
type MerchantOnboardingStepApprove = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                              ('DSL)
                                              (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.MERCHANT_ONBOARDING) / ('API.Types.Dashboard.AppManagement.MerchantOnboarding.MERCHANT_ONBOARDING_STEP_APPROVE)) :> API.Types.Dashboard.AppManagement.MerchantOnboarding.MerchantOnboardingStepApprove)
type MerchantOnboardingStepUploadFile = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                 ('DSL)
                                                 (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.MERCHANT_ONBOARDING) / ('API.Types.Dashboard.AppManagement.MerchantOnboarding.MERCHANT_ONBOARDING_STEP_UPLOAD_FILE)) :> API.Types.Dashboard.AppManagement.MerchantOnboarding.MerchantOnboardingStepUploadFile)
type MerchantOnboardingReject = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                         ('DSL)
                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.MERCHANT_ONBOARDING) / ('API.Types.Dashboard.AppManagement.MerchantOnboarding.MERCHANT_ONBOARDING_REJECT)) :> API.Types.Dashboard.AppManagement.MerchantOnboarding.MerchantOnboardingReject)
type MerchantOnboadingListAll = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                         ('DSL)
                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.MERCHANT_ONBOARDING) / ('API.Types.Dashboard.AppManagement.MerchantOnboarding.MERCHANT_ONBOADING_LIST_ALL)) :> API.Types.Dashboard.AppManagement.MerchantOnboarding.MerchantOnboadingListAll)
type MerchantOnboardingStepList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                           ('DSL)
                                           (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.MERCHANT_ONBOARDING) / ('API.Types.Dashboard.AppManagement.MerchantOnboarding.MERCHANT_ONBOARDING_STEP_LIST)) :> API.Types.Dashboard.AppManagement.MerchantOnboarding.MerchantOnboardingStepList)
type MerchantOnboardingGetFile = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                          ('DSL)
                                          (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.MERCHANT_ONBOARDING) / ('API.Types.Dashboard.AppManagement.MerchantOnboarding.MERCHANT_ONBOARDING_GET_FILE)) :> API.Types.Dashboard.AppManagement.MerchantOnboarding.MerchantOnboardingGetFile)
type MerchantOnboardingCancel = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                         ('DSL)
                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.MERCHANT_ONBOARDING) / ('API.Types.Dashboard.AppManagement.MerchantOnboarding.MERCHANT_ONBOARDING_CANCEL)) :> API.Types.Dashboard.AppManagement.MerchantOnboarding.MerchantOnboardingCancel)
