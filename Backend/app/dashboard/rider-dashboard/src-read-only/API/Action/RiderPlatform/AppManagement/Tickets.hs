...
type PostTicketsVerify = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                  ('DSL)
                                  (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.POST_TICKETS_VERIFY)) :> API.Types.Dashboard.AppManagement.Tickets.PostTicketsVerify)
type PostTicketsServices = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                    ('DSL)
                                    (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.POST_TICKETS_SERVICES)) :> API.Types.Dashboard.AppManagement.Tickets.PostTicketsServices)
type GetTicketsPlaces = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                 ('DSL)
                                 (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKETS_PLACES)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketsPlaces)
type PostTicketsUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                  ('DSL)
                                  (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.POST_TICKETS_UPDATE)) :> API.Types.Dashboard.AppManagement.Tickets.PostTicketsUpdate)
type PostTicketsBookingsCancel = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                          ('DSL)
                                          (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.POST_TICKETS_BOOKINGS_CANCEL)) :> API.Types.Dashboard.AppManagement.Tickets.PostTicketsBookingsCancel)
type PostTicketsServiceCancel = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                         ('DSL)
                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.POST_TICKETS_SERVICE_CANCEL)) :> API.Types.Dashboard.AppManagement.Tickets.PostTicketsServiceCancel)
type GetTicketsBookingDetails = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                         ('DSL)
                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKETS_BOOKING_DETAILS)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketsBookingDetails)
...
type GetTicketsTicketdashboardAgreement = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                   ('DSL)
                                                   (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKETS_TICKETDASHBOARD_AGREEMENT)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketsTicketdashboardAgreement)
type GetTicketsTicketdashboardUserInfo = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                  ('DSL)
                                                  (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKETS_TICKETDASHBOARD_USER_INFO)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketsTicketdashboardUserInfo)
type GetTicketsTicketdashboardFile = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                              ('DSL)
                                              (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKETS_TICKETDASHBOARD_FILE)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketsTicketdashboardFile)
...
type GetTicketsTicketdashboardTicketplaceInfo = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                         ('DSL)
                                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKETS_TICKETDASHBOARD_TICKETPLACE_INFO)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketsTicketdashboardTicketplaceInfo)
type PostTicketsTicketdashboardTicketplaceUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                            ('DSL)
                                                            (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.POST_TICKETS_TICKETDASHBOARD_TICKETPLACE_UPDATE)) :> API.Types.Dashboard.AppManagement.Tickets.PostTicketsTicketdashboardTicketplaceUpdate)
type GetTicketsTicketdashboardTicketplaces = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                      ('DSL)
                                                      (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKETS_TICKETDASHBOARD_TICKETPLACES)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketsTicketdashboardTicketplaces)
type GetTicketsTicketdashboardTicketplaceSubPlaces = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                              ('DSL)
                                                              (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKETS_TICKETDASHBOARD_TICKETPLACE_SUB_PLACES)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketsTicketdashboardTicketplaceSubPlaces)
type PostTicketsTicketdashboardTicketplaceUpdateSubPlaces = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                                     ('DSL)
                                                                     (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.POST_TICKETS_TICKETDASHBOARD_TICKETPLACE_UPDATE_SUB_PLACES)) :> API.Types.Dashboard.AppManagement.Tickets.PostTicketsTicketdashboardTicketplaceUpdateSubPlaces)
type GetTicketFleetVehicles = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                       ('DSL)
                                       (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKET_FLEET_VEHICLES)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketFleetVehicles)
type GetTicketFleetVehiclesV2 = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                         ('DSL)
                                         (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKET_FLEET_VEHICLES_V2)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketFleetVehiclesV2)
type PostTicketBookingsVerifyV2 = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                           ('DSL)
                                           (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.POST_TICKET_BOOKINGS_VERIFY_V2)) :> API.Types.Dashboard.AppManagement.Tickets.PostTicketBookingsVerifyV2)
type PostTicketPlacesBook = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                     ('DSL)
                                     (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.POST_TICKET_PLACES_BOOK)) :> API.Types.Dashboard.AppManagement.Tickets.PostTicketPlacesBook)
type GetTicketPlaces = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                ('DSL)
                                (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKET_PLACES)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketPlaces)
type GetTicketPlaceServices = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                       ('DSL)
                                       (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKET_PLACE_SERVICES)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketPlaceServices)
type GetTicketBookingDetails = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                        ('DSL)
                                        (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKET_BOOKING_DETAILS)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketBookingDetails)
type GetTicketsDashboardBookingStatus = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                 ('DSL)
                                                 (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKETS_DASHBOARD_BOOKING_STATUS)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketsDashboardBookingStatus)
type GetAllTicketBookings = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                     ('DSL)
                                     (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_ALL_TICKET_BOOKINGS)) :> API.Types.Dashboard.AppManagement.Tickets.GetAllTicketBookings)
type PostTicketBookingCashCollect = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                             ('DSL)
                                             (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.POST_TICKET_BOOKING_CASH_COLLECT)) :> API.Types.Dashboard.AppManagement.Tickets.PostTicketBookingCashCollect)
type PostTicketPlacesDirectBook = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                           ('DSL)
                                           (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.POST_TICKET_PLACES_DIRECT_BOOK)) :> API.Types.Dashboard.AppManagement.Tickets.PostTicketPlacesDirectBook)
type GetTicketPlaceBookings = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                       ('DSL)
                                       (('RIDER_APP_MANAGEMENT) / ('API.Types.Dashboard.AppManagement.TICKETS) / ('API.Types.Dashboard.AppManagement.Tickets.GET_TICKET_PLACE_BOOKINGS)) :> API.Types.Dashboard.AppManagement.Tickets.GetTicketPlaceBookings)
