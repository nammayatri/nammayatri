...
type GetIssueCategoryList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                     ('DSL)
                                     (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.GET_ISSUE_CATEGORY_LIST)) :> API.Types.RiderPlatform.IssueManagement.Issue.GetIssueCategoryList)
type GetIssueList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                             ('DSL)
                             (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.GET_ISSUE_LIST)) :> API.Types.RiderPlatform.IssueManagement.Issue.GetIssueList)
type GetIssueInfo = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                             ('DSL)
                             (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.GET_ISSUE_INFO)) :> API.Types.RiderPlatform.IssueManagement.Issue.GetIssueInfo)
type GetIssueInfoV2 = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                               ('DSL)
                               (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.GET_ISSUE_INFO_V2)) :> API.Types.RiderPlatform.IssueManagement.Issue.GetIssueInfoV2)
type PutIssueUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                               ('DSL)
                               (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.PUT_ISSUE_UPDATE)) :> API.Types.RiderPlatform.IssueManagement.Issue.PutIssueUpdate)
type PostIssueComment = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                 ('DSL)
                                 (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.POST_ISSUE_COMMENT)) :> API.Types.RiderPlatform.IssueManagement.Issue.PostIssueComment)
type GetIssueMedia = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                              ('DSL)
                              (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.GET_ISSUE_MEDIA)) :> API.Types.RiderPlatform.IssueManagement.Issue.GetIssueMedia)
type PostIssueTicketStatusCallBack = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                              ('DSL)
                                              (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.POST_ISSUE_TICKET_STATUS_CALL_BACK)) :> API.Types.RiderPlatform.IssueManagement.Issue.PostIssueTicketStatusCallBack)
type PostIssueCategoryCreate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                        ('DSL)
                                        (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.POST_ISSUE_CATEGORY_CREATE)) :> API.Types.RiderPlatform.IssueManagement.Issue.PostIssueCategoryCreate)
type PostIssueCategoryUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                        ('DSL)
                                        (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.POST_ISSUE_CATEGORY_UPDATE)) :> API.Types.RiderPlatform.IssueManagement.Issue.PostIssueCategoryUpdate)
type PostIssueOptionCreate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                      ('DSL)
                                      (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.POST_ISSUE_OPTION_CREATE)) :> API.Types.RiderPlatform.IssueManagement.Issue.PostIssueOptionCreate)
type PostIssueOptionUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                      ('DSL)
                                      (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.POST_ISSUE_OPTION_UPDATE)) :> API.Types.RiderPlatform.IssueManagement.Issue.PostIssueOptionUpdate)
type PostIssueMessageUpsert = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                       ('DSL)
                                       (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.POST_ISSUE_MESSAGE_UPSERT)) :> API.Types.RiderPlatform.IssueManagement.Issue.PostIssueMessageUpsert)
type PostIssueKaptureCreate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                       ('DSL)
                                       (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.POST_ISSUE_KAPTURE_CREATE)) :> API.Types.RiderPlatform.IssueManagement.Issue.PostIssueKaptureCreate)
type GetIssueCategoryDetail = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                       ('DSL)
                                       (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.GET_ISSUE_CATEGORY_DETAIL)) :> API.Types.RiderPlatform.IssueManagement.Issue.GetIssueCategoryDetail)
type GetIssueOptionDetail = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                     ('DSL)
                                     (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.GET_ISSUE_OPTION_DETAIL)) :> API.Types.RiderPlatform.IssueManagement.Issue.GetIssueOptionDetail)
type GetIssueMessageDetail = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                      ('DSL)
                                      (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.GET_ISSUE_MESSAGE_DETAIL)) :> API.Types.RiderPlatform.IssueManagement.Issue.GetIssueMessageDetail)
type GetIssueMessageList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                    ('DSL)
                                    (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.GET_ISSUE_MESSAGE_LIST)) :> API.Types.RiderPlatform.IssueManagement.Issue.GetIssueMessageList)
type GetIssueOptionList = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                   ('DSL)
                                   (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.GET_ISSUE_OPTION_LIST)) :> API.Types.RiderPlatform.IssueManagement.Issue.GetIssueOptionList)
type DeleteIssueCategory = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                    ('DSL)
                                    (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.DELETE_ISSUE_CATEGORY)) :> API.Types.RiderPlatform.IssueManagement.Issue.DeleteIssueCategory)
type DeleteIssueOption = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                  ('DSL)
                                  (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.DELETE_ISSUE_OPTION)) :> API.Types.RiderPlatform.IssueManagement.Issue.DeleteIssueOption)
type DeleteIssueMessage = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                   ('DSL)
                                   (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.DELETE_ISSUE_MESSAGE)) :> API.Types.RiderPlatform.IssueManagement.Issue.DeleteIssueMessage)
type GetIssueCategoryFlowPreview = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                            ('DSL)
                                            (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.GET_ISSUE_CATEGORY_FLOW_PREVIEW)) :> API.Types.RiderPlatform.IssueManagement.Issue.GetIssueCategoryFlowPreview)
type GetIssueTranslations = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                     ('DSL)
                                     (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.GET_ISSUE_TRANSLATIONS)) :> API.Types.RiderPlatform.IssueManagement.Issue.GetIssueTranslations)
type PostIssueBulkUpsertTranslations = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                                ('DSL)
                                                (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.POST_ISSUE_BULK_UPSERT_TRANSLATIONS)) :> API.Types.RiderPlatform.IssueManagement.Issue.PostIssueBulkUpsertTranslations)
type GetIssueConfig = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                               ('DSL)
                               (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.GET_ISSUE_CONFIG)) :> API.Types.RiderPlatform.IssueManagement.Issue.GetIssueConfig)
type PostIssueConfigUpdate = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                      ('DSL)
                                      (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.POST_ISSUE_CONFIG_UPDATE)) :> API.Types.RiderPlatform.IssueManagement.Issue.PostIssueConfigUpdate)
type PostIssueCategoryReorder = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                         ('DSL)
                                         (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.POST_ISSUE_CATEGORY_REORDER)) :> API.Types.RiderPlatform.IssueManagement.Issue.PostIssueCategoryReorder)
type PostIssueOptionReorder = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                       ('DSL)
                                       (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.POST_ISSUE_OPTION_REORDER)) :> API.Types.RiderPlatform.IssueManagement.Issue.PostIssueOptionReorder)
type PostIssueMessageReorder = (ApiAuth ('APP_BACKEND_MANAGEMENT)
                                        ('DSL)
                                        (('RIDER_ISSUE_MANAGEMENT) / ('API.Types.RiderPlatform.IssueManagement.ISSUE) / ('API.Types.RiderPlatform.IssueManagement.Issue.POST_ISSUE_MESSAGE_REORDER)) :> API.Types.RiderPlatform.IssueManagement.Issue.PostIssueMessageReorder)
