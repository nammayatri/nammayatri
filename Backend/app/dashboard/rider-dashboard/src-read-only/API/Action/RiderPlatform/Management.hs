...
import qualified API.Action.RiderPlatform.Management.MultiModal
...
type API = (API.Action.RiderPlatform.Management.Booking.API :<|> API.Action.RiderPlatform.Management.Customer.API :<|> API.Action.RiderPlatform.Management.FRFSTicket.API :<|> API.Action.RiderPlatform.Management.Invoice.API :<|> API.Action.RiderPlatform.Management.Merchant.API :<|> API.Action.RiderPlatform.Management.MultiModal.API :<|> API.Action.RiderPlatform.Management.NammaTag.API :<|> API.Action.RiderPlatform.Management.Ride.API :<|> API.Action.RiderPlatform.Management.System.API)

handler :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Environment.FlowServer API)
handler merchantId city = API.Action.RiderPlatform.Management.Booking.handler merchantId city :<|> API.Action.RiderPlatform.Management.Customer.handler merchantId city :<|> API.Action.RiderPlatform.Management.FRFSTicket.handler merchantId city :<|> API.Action.RiderPlatform.Management.Invoice.handler merchantId city :<|> API.Action.RiderPlatform.Management.Merchant.handler merchantId city :<|> API.Action.RiderPlatform.Management.MultiModal.handler merchantId city :<|> API.Action.RiderPlatform.Management.NammaTag.handler merchantId city :<|> API.Action.RiderPlatform.Management.Ride.handler merchantId city :<|> API.Action.RiderPlatform.Management.System.handler merchantId city
