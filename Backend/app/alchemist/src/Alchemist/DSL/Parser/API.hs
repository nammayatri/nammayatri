...
makeTypeQualified obj txt =
  let defaultImportModule = "Domain.Action.UI."
   in T.pack $ U.makeTypeQualified Nothing Nothing Nothing defaultImportModule obj (T.unpack txt)
