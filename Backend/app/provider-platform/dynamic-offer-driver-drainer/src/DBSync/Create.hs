...
runCreateCommands cmds streamKey = do
  ...
  runCreateInKafkaAndDb dbConf streamKey ("RegistrationToken" :: Text) [(obj, val, entryId, RegistrationTokenObject obj) | (CreateDBCommand entryId _ _ _ _ (RegistrationTokenObject obj), val) <- cmds]
    ...
    |::| runCreateInKafkaAndDb dbConf streamKey ("MerchantDocumentVerificationConfig" :: Text) [(obj, val, entryId, MerchantDocumentVerificationConfigObject obj) | (CreateDBCommand entryId _ _ _ _ (MerchantDocumentVerificationConfigObject obj), val) <- cmds]
