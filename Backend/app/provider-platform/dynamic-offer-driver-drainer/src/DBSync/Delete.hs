...
runDeleteCommands (cmd, val) dbStreamKey = do
  ...
  case cmd of
    ...
    DeleteDBCommand id _ _ _ _ (MerchantDocumentVerificationConfigDeleteOptions _ whereClause) -> runDeleteInKafkaAndDb id val dbStreamKey whereClause ("MerchantDocumentVerificationConfig" :: Text) =<< dbConf
