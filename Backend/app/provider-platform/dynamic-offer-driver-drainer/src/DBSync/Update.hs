...
runUpdateCommands (cmd, val) dbStreamKey = do
  ...
  case cmd of
    ...
    UpdateDBCommand id _ tag _ _ (MerchantDocumentVerificationConfigOptions _ setClauses whereClause) -> runUpdateInKafkaAndDb id val dbStreamKey setClauses tag whereClause ("MerchantDocumentVerificationConfig" :: Text) =<< dbConf
