...
getDriverRegistrationDocumentsList a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.DriverRegistration.getDriverRegistrationDocumentsList a3 a2 a1
...
getDriverRegistrationGetDocument a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.DriverRegistration.getDriverRegistrationGetDocument a3 a2 a1
...
postDriverRegistrationDocumentUpload a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.DriverRegistration.postDriverRegistrationDocumentUpload a4 a3 a2 a1
...
postDriverRegistrationRegisterDl a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.DriverRegistration.postDriverRegistrationRegisterDl a4 a3 a2 a1
...
postDriverRegistrationRegisterRc a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.DriverRegistration.postDriverRegistrationRegisterRc a4 a3 a2 a1
...
postDriverRegistrationRegisterGenerateAadhaarOtp a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.DriverRegistration.postDriverRegistrationRegisterGenerateAadhaarOtp a4 a3 a2 a1
...
postDriverRegistrationRegisterVerifyAadhaarOtp a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.DriverRegistration.postDriverRegistrationRegisterVerifyAadhaarOtp a4 a3 a2 a1
...
getDriverRegistrationUnderReviewDrivers a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.DriverRegistration.getDriverRegistrationUnderReviewDrivers a4 a3 a2 a1
...
getDriverRegistrationDocumentsInfo a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.DriverRegistration.getDriverRegistrationDocumentsInfo a3 a2 a1
...
postDriverRegistrationDocumentsUpdate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.DriverRegistration.postDriverRegistrationDocumentsUpdate a3 a2 a1
