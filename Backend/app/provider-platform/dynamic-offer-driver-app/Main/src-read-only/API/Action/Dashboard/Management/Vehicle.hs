...
postVehicleParkingFeeExemption :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Kernel.Prelude.Text -> API.Types.ProviderPlatform.Management.Vehicle.ParkingFeeExemptionReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postVehicleParkingFeeExemption a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Vehicle.postVehicleParkingFeeExemption a4 a3 a2 a1
