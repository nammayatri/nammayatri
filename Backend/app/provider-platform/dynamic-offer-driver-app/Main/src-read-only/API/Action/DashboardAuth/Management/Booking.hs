...
postBookingCancelAllStuck a4 a3 _a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Booking.postBookingCancelAllStuck a4 a3 a1
...
postBookingSyncMultiple a4 a3 _a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Booking.postBookingSyncMultiple a4 a3 a1
