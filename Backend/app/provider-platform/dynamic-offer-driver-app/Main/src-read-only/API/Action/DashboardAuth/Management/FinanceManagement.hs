...
type PostFinanceManagementFinanceAdjustmentSubmitHelper =
  ( DashboardUserAuth
      ...
      :> API.Types.ProviderPlatform.Management.FinanceManagement.PostFinanceManagementFinanceAdjustmentSubmitHelper
  )
...
type GetFinanceManagementFinanceAdjustmentListHelper =
  ( DashboardUserAuth
      ...
      :> API.Types.ProviderPlatform.Management.FinanceManagement.GetFinanceManagementFinanceAdjustmentListHelper
  )
...
type PostFinanceManagementFinanceAdjustmentApproveHelper =
  ( DashboardUserAuth
      ...
      :> API.Types.ProviderPlatform.Management.FinanceManagement.PostFinanceManagementFinanceAdjustmentApproveHelper
  )
...
type PostFinanceManagementFinanceAdjustmentRejectHelper =
  ( DashboardUserAuth
      ...
      :> API.Types.ProviderPlatform.Management.FinanceManagement.PostFinanceManagementFinanceAdjustmentRejectHelper
  )
...
type PostFinanceManagementTdsReimbursementRequestSubmitHelper =
  ( DashboardUserAuth
      ...
      :> API.Types.ProviderPlatform.Management.FinanceManagement.PostFinanceManagementTdsReimbursementRequestSubmitHelper
  )
...
type GetFinanceManagementTdsReimbursementStatusHelper =
  ( DashboardUserAuth
      ...
      :> API.Types.ProviderPlatform.Management.FinanceManagement.GetFinanceManagementTdsReimbursementStatusHelper
  )
...
type GetFinanceManagementTdsReimbursementListHelper =
  ( DashboardUserAuth
      ...
      :> API.Types.ProviderPlatform.Management.FinanceManagement.GetFinanceManagementTdsReimbursementListHelper
  )
...
type PostFinanceManagementTdsReimbursementRejectHelper =
  ( DashboardUserAuth
      ...
      :> API.Types.ProviderPlatform.Management.FinanceManagement.PostFinanceManagementTdsReimbursementRejectHelper
  )
...
postFinanceManagementFinanceAdjustmentSubmit :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> DashboardUser -> Kernel.Prelude.Text -> Kernel.Prelude.Text -> API.Types.ProviderPlatform.Management.FinanceManagement.SubmitLedgerAdjustmentReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postFinanceManagementFinanceAdjustmentSubmit a6 a5 _a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.FinanceManagement.postFinanceManagementFinanceAdjustmentSubmit a6 a5 a3 a2 a1
...
getFinanceManagementFinanceAdjustmentList a17 a16 _a15 a14 a13 a12 a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.FinanceManagement.getFinanceManagementFinanceAdjustmentList a17 a16 a14 a13 a12 a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a15)

postFinanceManagementFinanceAdjustmentApprove :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> DashboardUser -> Kernel.Types.Id.Id Dashboard.Common.LedgerAdjustmentRequest -> Kernel.Prelude.Text -> Kernel.Prelude.Text -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postFinanceManagementFinanceAdjustmentApprove a6 a5 _a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.FinanceManagement.postFinanceManagementFinanceAdjustmentApprove a6 a5 a3 a2 a1

postFinanceManagementFinanceAdjustmentReject :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> DashboardUser -> Kernel.Types.Id.Id Dashboard.Common.LedgerAdjustmentRequest -> Kernel.Prelude.Text -> Kernel.Prelude.Text -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postFinanceManagementFinanceAdjustmentReject a6 a5 _a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.FinanceManagement.postFinanceManagementFinanceAdjustmentReject a6 a5 a3 a2 a1
...
postFinanceManagementTdsReimbursementRequestSubmit a4 a3 _a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.FinanceManagement.postFinanceManagementTdsReimbursementRequestSubmit a4 a3 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a2) a1
...
getFinanceManagementTdsReimbursementStatus a5 a4 _a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.FinanceManagement.getFinanceManagementTdsReimbursementStatus a5 a4 a1 a2 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a3)
...
getFinanceManagementTdsReimbursementList a13 a12 _a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.FinanceManagement.getFinanceManagementTdsReimbursementList a13 a12 a6 a5 a8 a2 a4 a10 a9 a3 a7 a1 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a11)
...
postFinanceManagementTdsReimbursementReject :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> DashboardUser -> Kernel.Types.Id.Id Dashboard.Common.FinanceTdsReimbursementRequest -> Kernel.Prelude.Text -> Kernel.Prelude.Text -> API.Types.ProviderPlatform.Management.FinanceManagement.TdsReimbursementRejectReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postFinanceManagementTdsReimbursementReject a7 a6 _a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.FinanceManagement.postFinanceManagementTdsReimbursementReject a7 a6 a4 a3 a2 a1
