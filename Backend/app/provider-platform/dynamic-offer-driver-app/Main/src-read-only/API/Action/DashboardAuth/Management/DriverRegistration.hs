...
postDriverRegistrationGenerateTempAppCode a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.DriverRegistration.postDriverRegistrationGenerateTempAppCode a4 a3 a1 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a2)
    )
...
postDriverRegistrationDocumentUpload a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.DashboardAuth.Management.DriverRegistration.postDriverRegistrationDocumentUpload a5 a4 a3 a2 a1
    )
...
postDriverRegistrationRegisterDl a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.DriverRegistration.postDriverRegistrationRegisterDl a5 a4 a2 a1
    )
...
postDriverRegistrationVerifyBankAccount a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.DriverRegistration.postDriverRegistrationVerifyBankAccount a5 a4 a2 a1
    )
...
postDriverRegistrationDeleteBankAccount a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.DriverRegistration.postDriverRegistrationDeleteBankAccount a4 a3 a1
    )
...
postDriverRegistrationRegisterRc a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.DriverRegistration.postDriverRegistrationRegisterRc a5 a4 a2 a1
    )
...
postDriverRegistrationRegisterAadhaar a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.DriverRegistration.postDriverRegistrationRegisterAadhaar a5 a4 a2 a1
    )
...
postDriverRegistrationRegisterGenerateAadhaarOtp a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.DriverRegistration.postDriverRegistrationRegisterGenerateAadhaarOtp a5 a4 a2 a1
    )
...
postDriverRegistrationRegisterVerifyAadhaarOtp a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.DriverRegistration.postDriverRegistrationRegisterVerifyAadhaarOtp a5 a4 a2 a1
    )
...
postDriverRegistrationDocumentsUpdate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.DashboardAuth.Management.DriverRegistration.postDriverRegistrationDocumentsUpdate a4 a3 a2 a1
    )
...
postDriverRegistrationUnlinkDocument a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.DashboardAuth.Management.DriverRegistration.postDriverRegistrationUnlinkDocument a5 a4 a3 a2 a1
    )
...
postDriverRegistrationTriggerReminder a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.DashboardAuth.Management.DriverRegistration.postDriverRegistrationTriggerReminder a5 a4 a3 a2 a1
    )
