...
postRadarTicketsUpload :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.ProviderPlatform.Management.RadarTickets.RadarUploadReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.RadarTickets.RadarUploadRes)
postRadarTicketsUpload a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.RadarTickets.postRadarTicketsUpload a3 a2 a1
