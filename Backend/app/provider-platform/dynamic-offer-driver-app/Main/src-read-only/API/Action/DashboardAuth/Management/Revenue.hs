...
getRevenueCollectionHistory a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a5 $ Domain.Action.Dashboard.Management.Revenue.getRevenueCollectionHistory a7 a6 a4 a3 a2 a1
...
getRevenueAllFeeHistory a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.Dashboard.Management.Revenue.getRevenueAllFeeHistory a5 a4 a2 a1
