...
postNammaTagTagCreate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.NammaTag.postNammaTagTagCreate a4 a3 a1
    )
...
postNammaTagTagVerify a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.NammaTag.postNammaTagTagVerify a4 a3 a1
    )
...
postNammaTagTagUpdate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.NammaTag.postNammaTagTagUpdate a4 a3 a1
    )
...
deleteNammaTagTagDelete a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.NammaTag.deleteNammaTagTagDelete a4 a3 a1
    )
...
postNammaTagQueryCreate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.NammaTag.postNammaTagQueryCreate a4 a3 a1
    )
...
postNammaTagQueryUpdate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.NammaTag.postNammaTagQueryUpdate a4 a3 a1
    )
...
deleteNammaTagQueryDelete a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.NammaTag.deleteNammaTagQueryDelete a4 a3 a1
    )
...
postNammaTagRunJob a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.NammaTag.postNammaTagRunJob a4 a3 a1
    )
...
postNammaTagTimeBoundsCreate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.NammaTag.postNammaTagTimeBoundsCreate a4 a3 a1
    )
...
postNammaTagAppDynamicLogicUpsertLogicRollout a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.NammaTag.postNammaTagAppDynamicLogicUpsertLogicRollout a4 a3 a1
    )
...
postNammaTagAppDynamicLogicBulkUpsertLogicRollout a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.DashboardAuth.Management.NammaTag.postNammaTagAppDynamicLogicBulkUpsertLogicRollout a4 a3 a2 a1
    )
...
postNammaTagConfigPilotGetVersion a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.NammaTag.postNammaTagConfigPilotGetVersion a4 a3 a1
    )
...
postNammaTagConfigPilotGetConfig a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.NammaTag.postNammaTagConfigPilotGetConfig a4 a3 a1
    )
...
postNammaTagConfigPilotActionChange a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.NammaTag.postNammaTagConfigPilotActionChange a4 a3 a1
    )
