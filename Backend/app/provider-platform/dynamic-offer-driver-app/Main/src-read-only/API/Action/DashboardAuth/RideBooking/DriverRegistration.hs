...
postDriverRegistrationAuth a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.DriverRegistration.postDriverRegistrationAuth a4 a3 a1
    )
...
postDriverRegistrationVerify a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.DashboardAuth.RideBooking.DriverRegistration.postDriverRegistrationVerify a5 a4 a3 a2 a1
    )
