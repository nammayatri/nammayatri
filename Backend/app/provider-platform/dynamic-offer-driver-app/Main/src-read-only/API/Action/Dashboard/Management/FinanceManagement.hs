...
getFinanceManagementFinanceInvoicePdf a12 a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.FinanceManagement.getFinanceManagementFinanceInvoicePdf a12 a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1
...
getFinanceManagementFinanceInvoiceList a12 a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.FinanceManagement.getFinanceManagementFinanceInvoiceList a12 a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1
...
getFinanceManagementFinanceWalletLedger a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.FinanceManagement.getFinanceManagementFinanceWalletLedger a10 a9 a8 a7 a6 a5 a4 a3 a2 a1
...
postFinanceManagementAggregatedCommissionTrigger :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.ProviderPlatform.Management.FinanceManagement.AggregatedCommissionTriggerReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.FinanceManagement.AggregatedCommissionTriggerRes)
postFinanceManagementAggregatedCommissionTrigger a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.FinanceManagement.postFinanceManagementAggregatedCommissionTrigger a3 a2 a1
