...
getFinanceManagementFinanceInvoiceList a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.FinanceManagement.getFinanceManagementFinanceInvoiceList a10 a9 a8 a7 a6 a5 a4 a3 a2 a1
