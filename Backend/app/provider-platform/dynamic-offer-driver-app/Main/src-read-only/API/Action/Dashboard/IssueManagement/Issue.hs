...
postIGMIssueResolve a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.IssueManagement.Issue.postIGMIssueResolve a4 a3 a2 a1

postIGMIssueRaise :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> IssueManagement.Common.Dashboard.Issue.RaiseIssuePayload -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postIGMIssueRaise a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.IssueManagement.Issue.postIGMIssueRaise a3 a2 a1
...
postIGMIssueTriggerAction a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.IssueManagement.Issue.postIGMIssueTriggerAction a4 a3 a2 a1
