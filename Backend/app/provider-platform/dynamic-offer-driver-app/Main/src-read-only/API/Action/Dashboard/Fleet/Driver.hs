...
getDriverDashboardFleetTripWaypoints a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Fleet.Driver.getDriverDashboardFleetTripWaypoints a5 a4 a3 a2 a1
