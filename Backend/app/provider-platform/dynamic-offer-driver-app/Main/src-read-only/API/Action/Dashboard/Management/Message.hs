...
postMessageUploadFile a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Message.postMessageUploadFile a3 a2 a1
...
postMessageAddLink a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Message.postMessageAddLink a3 a2 a1
...
postMessageAdd a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Message.postMessageAdd a3 a2 a1
...
postMessageSend a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Message.postMessageSend a3 a2 a1
...
getMessageList a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Message.getMessageList a4 a3 a2 a1
...
getMessageInfo a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Message.getMessageInfo a3 a2 a1
...
getMessageDeliveryInfo a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Message.getMessageDeliveryInfo a3 a2 a1
...
getMessageReceiverList a7 a6 a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Message.getMessageReceiverList a7 a6 a5 a4 a3 a2 a1
