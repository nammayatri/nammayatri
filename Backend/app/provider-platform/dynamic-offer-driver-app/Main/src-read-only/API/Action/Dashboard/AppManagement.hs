...
type API = (API.Action.Dashboard.AppManagement.Driver.API :<|> API.Action.Dashboard.AppManagement.DriverSubscription.API :<|> API.Action.Dashboard.AppManagement.Overlay.API :<|> API.Action.Dashboard.AppManagement.Payment.API :<|> API.Action.Dashboard.AppManagement.Subscription.API)

handler :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Environment.FlowServer API)
handler merchantId city = API.Action.Dashboard.AppManagement.Driver.handler merchantId city :<|> API.Action.Dashboard.AppManagement.DriverSubscription.handler merchantId city :<|> API.Action.Dashboard.AppManagement.Overlay.handler merchantId city :<|> API.Action.Dashboard.AppManagement.Payment.handler merchantId city :<|> API.Action.Dashboard.AppManagement.Subscription.handler merchantId city
