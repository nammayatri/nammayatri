...
postOverlayCreate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Overlay.postOverlayCreate a4 a3 a1
    )
...
postOverlayDelete a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Overlay.postOverlayDelete a4 a3 a1
    )
...
postOverlaySchedule a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Overlay.postOverlaySchedule a4 a3 a1
    )
