...
postSocialUpdateProfile :: ((Kernel.Types.Id.Id Domain.Types.Person.Person,
                             ...
                             Kernel.Types.Id.Id Domain.Types.MerchantOperatingCity.MerchantOperatingCity) -> API.Types.UI.SocialLogin.SocialUpdateProfileReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
