...
import qualified Domain.Action.UI.SubscriptionTransaction as Domain.Action.UI.SubscriptionTransaction
...
getSubscriptionTransactions ::
  ( ( Kernel.Types.Id.Id Domain.Types.Person.Person,
    ...
    Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney ->
    Kernel.Prelude.Maybe Kernel.Prelude.Int ->
    Kernel.Prelude.Maybe Kernel.External.Payment.Juspay.Types.Common.TransactionStatus ->
    Kernel.Prelude.Maybe Data.Time.UTCTime ->
