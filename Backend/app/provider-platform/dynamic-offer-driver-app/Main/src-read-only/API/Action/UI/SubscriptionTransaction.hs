...
type API = (TokenAuth :> "subscription" :> "transactions" :> QueryParam "fromDate" Data.Time.UTCTime :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "maxAmount"
                                                                                                                                                            Kernel.Types.Common.HighPrecMoney :> QueryParam "minAmount" Kernel.Types.Common.HighPrecMoney :> QueryParam "offset"
...
getSubscriptionTransactions :: ((Kernel.Types.Id.Id Domain.Types.Person.Person,
