...
module API.Action.Dashboard.RideBooking.Driver
  ( API.Types.ProviderPlatform.RideBooking.Driver.API,
    handler,
  )
where
...
handler :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Environment.FlowServer API.Types.ProviderPlatform.RideBooking.Driver.API)
...
getDriverPaymentDue :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Text -> Environment.FlowHandler [API.Types.ProviderPlatform.RideBooking.Driver.DriverOutstandingBalanceResp])
getDriverPaymentDue a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.RideBooking.Driver.getDriverPaymentDue a4 a3 a2 a1
...
postDriverEnable a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.RideBooking.Driver.postDriverEnable a3 a2 a1
...
postDriverCollectCash a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.RideBooking.Driver.postDriverCollectCash a4 a3 a2 a1
...
postDriverV2CollectCash a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.RideBooking.Driver.postDriverV2CollectCash a5 a4 a3 a2 a1
...
postDriverExemptCash a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.RideBooking.Driver.postDriverExemptCash a4 a3 a2 a1
...
postDriverV2ExemptCash a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.RideBooking.Driver.postDriverV2ExemptCash a5 a4 a3 a2 a1
...
getDriverInfo a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.RideBooking.Driver.getDriverInfo a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1
...
postDriverUnlinkVehicle a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.RideBooking.Driver.postDriverUnlinkVehicle a3 a2 a1
...
postDriverExemptDriverFee a6 a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.RideBooking.Driver.postDriverExemptDriverFee a6 a5 a4 a3 a2 a1
