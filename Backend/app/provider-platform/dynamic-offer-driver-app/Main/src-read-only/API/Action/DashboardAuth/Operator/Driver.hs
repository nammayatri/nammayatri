...
type GetDriverOperatorList = (DashboardUserAuth 'DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_OPERATOR/DRIVER/GET_DRIVER_OPERATOR_LIST" :> API.Types.ProviderPlatform.Operator.Driver.GetDriverOperatorList)
...
getDriverOperatorFetchHubRequests a15 a14 a13 a12 a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a13 $ Domain.Action.Dashboard.Operator.Driver.getDriverOperatorFetchHubRequests a15 a14 a12 a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1
...
getDriverOperationGetAllHubs a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a1 $ Domain.Action.Dashboard.Operator.Driver.getDriverOperationGetAllHubs a3 a2
...
postDriverOperatorRespondHubRequest a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_OPERATOR/DRIVER/POST_DRIVER_OPERATOR_RESPOND_HUB_REQUEST" a2 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.Operator.Driver.postDriverOperatorRespondHubRequest a4 a3 a1
    )
...
postDriverOperatorCreateRequest a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_OPERATOR/DRIVER/POST_DRIVER_OPERATOR_CREATE_REQUEST" a2 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.Operator.Driver.postDriverOperatorCreateRequest a4 a3 a1
    )
...
getDriverOperatorList a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a9 $ Domain.Action.Dashboard.Operator.Driver.getDriverOperatorList a11 a10 a8 a7 a6 a5 a4 a3 a2 a1 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a9)
...
postDriverOperatorSendJoiningOtp a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_OPERATOR/DRIVER/POST_DRIVER_OPERATOR_SEND_JOINING_OTP" a2 (Kernel.Prelude.Nothing :: Kernel.Prelude.Maybe ())
        Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.Operator.Driver.postDriverOperatorSendJoiningOtp a4 a3 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a2) a1
    )
...
postDriverOperatorVerifyJoiningOtp a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_OPERATOR/DRIVER/POST_DRIVER_OPERATOR_VERIFY_JOINING_OTP" a3 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.Dashboard.Operator.Driver.postDriverOperatorVerifyJoiningOtp a5 a4 a2 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a3) a1
    )
...
getDriverOperatorDashboardAnalyticsAllTime a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a1 $ Domain.Action.Dashboard.Operator.Driver.getDriverOperatorDashboardAnalyticsAllTime a3 a2 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a1)
...
getDriverOperatorDashboardAnalytics a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.Dashboard.Operator.Driver.getDriverOperatorDashboardAnalytics a5 a4 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a3) a2 a1
...
getDriverReviewQueueRequest a14 a13 a12 a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a12 $ Domain.Action.Dashboard.Operator.Driver.getDriverReviewQueueRequest a14 a13 a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1
...
postDriverSubmitReviewRequest a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_OPERATOR/DRIVER/POST_DRIVER_SUBMIT_REVIEW_REQUEST" a2 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.Operator.Driver.postDriverSubmitReviewRequest a4 a3 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a2) a1
    )
...
getDriverRequestReviewHistory a15 a14 a13 a12 a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a13 $ Domain.Action.Dashboard.Operator.Driver.getDriverRequestReviewHistory a15 a14 a12 a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1
