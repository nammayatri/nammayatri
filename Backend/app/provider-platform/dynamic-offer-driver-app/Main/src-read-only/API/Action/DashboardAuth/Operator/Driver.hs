...
postDriverOperatorRespondHubRequest a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Operator.Driver.postDriverOperatorRespondHubRequest a4 a3 a1
    )
...
postDriverOperatorCreateRequest a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Operator.Driver.postDriverOperatorCreateRequest a4 a3 a1
    )
...
postDriverOperatorSendJoiningOtp a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Operator.Driver.postDriverOperatorSendJoiningOtp a4 a3 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a2) a1
    )
...
postDriverOperatorVerifyJoiningOtp a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Operator.Driver.postDriverOperatorVerifyJoiningOtp a5 a4 a2 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a3) a1
    )
...
postDriverSubmitReviewRequest a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Operator.Driver.postDriverSubmitReviewRequest a4 a3 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a2) a1
    )
