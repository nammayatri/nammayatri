...
postDriverEnable a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Driver.postDriverEnable a4 a3 a1
    )
...
postDriverCollectCash a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.DashboardAuth.RideBooking.Driver.postDriverCollectCash a5 a4 a3 a2 a1
    )
...
postDriverV2CollectCash a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Driver.postDriverV2CollectCash a6 a5 a3 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a4) a2 a1
    )
...
postDriverExemptCash a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.DashboardAuth.RideBooking.Driver.postDriverExemptCash a4 a3 a2 a1
    )
...
postDriverV2ExemptCash a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Driver.postDriverV2ExemptCash a5 a4 a2 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a3) a1
    )
...
getDriverInfo a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.DashboardAuth.RideBooking.Driver.getDriverInfo a11 a10 a9 a8 a7 a6 a5 a4 a3 a2 a1
...
postDriverUnlinkVehicle a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Driver.postDriverUnlinkVehicle a4 a3 a1
    )
...
postDriverEndRCAssociation a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Driver.postDriverEndRCAssociation a4 a3 a1
    )
...
postDriverDeleteAadhaar a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Driver.postDriverDeleteAadhaar a4 a3 a1
    )
...
postDriverDeletePanCard a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Driver.postDriverDeletePanCard a4 a3 a1
    )
...
postDriverAddVehicle a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Driver.postDriverAddVehicle a5 a4 a2 a1
    )
...
postDriverSetRCStatus a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Driver.postDriverSetRCStatus a5 a4 a2 a1
    )
...
postDriverExemptDriverFee a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.RideBooking.Driver.postDriverExemptDriverFee a6 a5 a3 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a4) a2 a1
    )
