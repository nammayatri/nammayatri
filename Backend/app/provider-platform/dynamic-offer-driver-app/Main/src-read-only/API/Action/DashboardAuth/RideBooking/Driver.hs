...
postDriverCollectCash a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP "PROVIDER_RIDE_BOOKING/DRIVER/POST_DRIVER_COLLECT_CASH" a4 (Kernel.Prelude.Nothing :: Kernel.Prelude.Maybe ())
        Domain.Action.Dashboard.RideBooking.Driver.postDriverCollectCash a6 a5 a3 a2 a1
    )
...
postDriverExemptCash a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP "PROVIDER_RIDE_BOOKING/DRIVER/POST_DRIVER_EXEMPT_CASH" a3 (Kernel.Prelude.Nothing :: Kernel.Prelude.Maybe ())
        Domain.Action.Dashboard.RideBooking.Driver.postDriverExemptCash a5 a4 a2 a1
    )
