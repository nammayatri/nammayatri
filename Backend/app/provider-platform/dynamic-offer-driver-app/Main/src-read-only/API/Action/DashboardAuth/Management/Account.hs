...
getAccountFetchUnverifiedAccounts a9 a8 a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.DashboardAuth.Management.Account.getAccountFetchUnverifiedAccounts a9 a8 a7 a6 a5 a4 a3 a2 a1
...
postAccountVerifyAccount a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Account.postAccountVerifyAccount a4 a3 a1
    )
...
putAccountUpdateRole a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.DashboardAuth.Management.Account.putAccountUpdateRole a5 a4 a3 a2 a1
    )
