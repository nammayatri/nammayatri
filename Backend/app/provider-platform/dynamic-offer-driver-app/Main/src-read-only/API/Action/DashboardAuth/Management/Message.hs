...
postMessageUploadFile a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Message.postMessageUploadFile a4 a3 a1
    )
...
postMessageAddLink a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Message.postMessageAddLink a4 a3 a1
    )
...
postMessageAdd a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Message.postMessageAdd a4 a3 a1
    )
...
postMessageSend a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Message.postMessageSend a4 a3 a1
    )
...
postMessageEdit a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Message.postMessageEdit a4 a3 a1
    )
