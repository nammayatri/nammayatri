...
module API.Action.Dashboard.Management.Booking
  ( API.Types.ProviderPlatform.Management.Booking.API,
    handler,
  )
where
...
import qualified Domain.Action.Dashboard.Management.Booking as Domain.Action.Dashboard.Management.Booking
...
handler :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Environment.FlowServer API.Types.ProviderPlatform.Management.Booking.API)
...
postBookingCancelAllStuck a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Booking.postBookingCancelAllStuck a3 a2 a1
...
postBookingSyncMultiple a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Booking.postBookingSyncMultiple a3 a2 a1
