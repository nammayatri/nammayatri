...
postBookingCancelAllStuck a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Booking.postBookingCancelAllStuck a3 a2 a1
...
postBookingSyncMultiple a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Booking.postBookingSyncMultiple a3 a2 a1
