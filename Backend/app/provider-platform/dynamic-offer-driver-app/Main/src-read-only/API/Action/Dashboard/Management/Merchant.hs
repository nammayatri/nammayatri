...
postMerchantConfigMerchantPushNotificationUpsert :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.ProviderPlatform.Management.Merchant.UpsertMerchantPushNotificationCsvReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.UpsertMerchantPushNotificationCsvResp)
postMerchantConfigMerchantPushNotificationUpsert a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigMerchantPushNotificationUpsert a3 a2 a1

postMerchantConfigMerchantOverlayUpsert :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.ProviderPlatform.Management.Merchant.UpsertMerchantOverlayCsvReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.UpsertMerchantOverlayCsvResp)
postMerchantConfigMerchantOverlayUpsert a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigMerchantOverlayUpsert a3 a2 a1

postMerchantConfigMerchantMessageUpsert :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.ProviderPlatform.Management.Merchant.UpsertMerchantMessageCsvReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.UpsertMerchantMessageCsvResp)
postMerchantConfigMerchantMessageUpsert a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigMerchantMessageUpsert a3 a2 a1

postMerchantConfigTranslationsUpsert :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.ProviderPlatform.Management.Merchant.UpsertTranslationsCsvReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.UpsertTranslationsCsvResp)
postMerchantConfigTranslationsUpsert a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigTranslationsUpsert a3 a2 a1

postMerchantConfigPlanTranslationUpsert :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.ProviderPlatform.Management.Merchant.UpsertPlanTranslationCsvReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.UpsertPlanTranslationCsvResp)
postMerchantConfigPlanTranslationUpsert a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigPlanTranslationUpsert a3 a2 a1
