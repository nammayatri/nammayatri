...
postMerchantConfigClearCacheSubscription a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigClearCacheSubscription a3 a2 a1
...
postMerchantConfigFailover a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigFailover a4 a3 a2 a1
