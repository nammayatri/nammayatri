...
postMerchantSchedulerRevive :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.ProviderPlatform.Management.Merchant.ReviveSchedulerJobsReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Merchant.ReviveSchedulerJobsRes)
postMerchantSchedulerRevive a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantSchedulerRevive a3 a2 a1
