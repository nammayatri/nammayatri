...
postMerchantUpdate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantUpdate a3 a2 a1
...
getMerchantConfigCommon a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.getMerchantConfigCommon a2 a1
...
postMerchantConfigCommonUpdate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigCommonUpdate a3 a2 a1
...
getMerchantConfigDriverPool a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.getMerchantConfigDriverPool a5 a4 a3 a2 a1

postMerchantConfigDriverPoolUpdate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecDistance -> Kernel.Prelude.Maybe Kernel.Types.Common.DistanceUnit -> Kernel.Prelude.Maybe Dashboard.Common.Variant -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Types.Common.Meters -> Lib.Types.SpecialLocation.Area -> API.Types.ProviderPlatform.Management.Merchant.DriverPoolConfigUpdateReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postMerchantConfigDriverPoolUpdate a9 a8 a7 a6 a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigDriverPoolUpdate a9 a8 a7 a6 a5 a4 a3 a2 a1
...
postMerchantConfigDriverPoolCreate a9 a8 a7 a6 a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigDriverPoolCreate a9 a8 a7 a6 a5 a4 a3 a2 a1
...
getMerchantConfigDriverIntelligentPool a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.getMerchantConfigDriverIntelligentPool a2 a1
...
postMerchantConfigDriverIntelligentPoolUpdate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigDriverIntelligentPoolUpdate a3 a2 a1
...
getMerchantConfigOnboardingDocument a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.getMerchantConfigOnboardingDocument a4 a3 a2 a1

postMerchantConfigOnboardingDocumentUpdate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.ProviderPlatform.Management.Merchant.DocumentType -> Dashboard.Common.Category -> API.Types.ProviderPlatform.Management.Merchant.DocumentVerificationConfigUpdateReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postMerchantConfigOnboardingDocumentUpdate a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigOnboardingDocumentUpdate a5 a4 a3 a2 a1

postMerchantConfigOnboardingDocumentCreate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.ProviderPlatform.Management.Merchant.DocumentType -> Dashboard.Common.Category -> API.Types.ProviderPlatform.Management.Merchant.DocumentVerificationConfigCreateReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postMerchantConfigOnboardingDocumentCreate a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigOnboardingDocumentCreate a5 a4 a3 a2 a1
...
getMerchantServiceUsageConfig a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.getMerchantServiceUsageConfig a2 a1
...
postMerchantServiceConfigMapsUpdate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantServiceConfigMapsUpdate a3 a2 a1
...
postMerchantServiceUsageConfigMapsUpdate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantServiceUsageConfigMapsUpdate a3 a2 a1
...
postMerchantServiceConfigSmsUpdate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantServiceConfigSmsUpdate a3 a2 a1
...
postMerchantServiceUsageConfigSmsUpdate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantServiceUsageConfigSmsUpdate a3 a2 a1
...
postMerchantServiceConfigVerificationUpdate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantServiceConfigVerificationUpdate a3 a2 a1
...
postMerchantConfigFarePolicyDriverExtraFeeBoundsCreate a7 a6 a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigFarePolicyDriverExtraFeeBoundsCreate a7 a6 a5 a4 a3 a2 a1

postMerchantConfigFarePolicyDriverExtraFeeBoundsUpdate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Kernel.Types.Id.Id Dashboard.Common.FarePolicy -> Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecDistance -> Kernel.Prelude.Maybe Kernel.Types.Common.DistanceUnit -> Kernel.Types.Common.Meters -> API.Types.ProviderPlatform.Management.Merchant.CreateFPDriverExtraFeeReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postMerchantConfigFarePolicyDriverExtraFeeBoundsUpdate a7 a6 a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigFarePolicyDriverExtraFeeBoundsUpdate a7 a6 a5 a4 a3 a2 a1
...
postMerchantConfigFarePolicyPerExtraKmRateUpdate a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigFarePolicyPerExtraKmRateUpdate a5 a4 a3 a2 a1
...
postMerchantConfigFarePolicyUpdate a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigFarePolicyUpdate a4 a3 a2 a1
...
postMerchantConfigFarePolicyUpsert a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigFarePolicyUpsert a3 a2 a1
...
postMerchantConfigOperatingCityCreate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantConfigOperatingCityCreate a3 a2 a1
...
postMerchantSchedulerTrigger a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantSchedulerTrigger a3 a2 a1
...
postMerchantUpdateOnboardingVehicleVariantMapping a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantUpdateOnboardingVehicleVariantMapping a3 a2 a1
...
postMerchantSpecialLocationUpsert a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantSpecialLocationUpsert a4 a3 a2 a1
...
deleteMerchantSpecialLocationDelete a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.deleteMerchantSpecialLocationDelete a3 a2 a1
...
postMerchantSpecialLocationGatesUpsert a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.postMerchantSpecialLocationGatesUpsert a4 a3 a2 a1
...
deleteMerchantSpecialLocationGatesDelete a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Merchant.deleteMerchantSpecialLocationGatesDelete a4 a3 a2 a1
