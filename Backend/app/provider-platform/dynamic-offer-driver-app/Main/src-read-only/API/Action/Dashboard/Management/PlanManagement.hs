...
handler merchantId city = postPlanManagementCreate merchantId city :<|> getPlanManagementPlan merchantId city :<|> postPlanManagementDeletePlan merchantId city :<|> getPlanManagementListPlans merchantId city
...
getPlanManagementPlan :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Kernel.Prelude.Text -> Environment.FlowHandler API.Types.ProviderPlatform.Management.PlanManagement.PlanAPIEntity)
getPlanManagementPlan a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.PlanManagement.getPlanManagementPlan a3 a2 a1
