...
getSubscriptionSyncMandateStatus :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Kernel.Types.Id.Id API.Types.ProviderPlatform.Fleet.Driver.Driver -> Kernel.Prelude.Maybe Domain.Types.Plan.ServiceNames -> Environment.FlowHandler Domain.Action.UI.Payment.PaymentStatusResp)
getSubscriptionSyncMandateStatus a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.AppManagement.Subscription.getSubscriptionSyncMandateStatus a4 a3 a2 a1
