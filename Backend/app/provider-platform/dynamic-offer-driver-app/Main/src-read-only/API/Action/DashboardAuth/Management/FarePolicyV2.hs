...
postFarePolicyV2ProductRemove a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2ProductRemove a5 a4 a2 a1
    )
...
postFarePolicyV2ChangeRequestDecide a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2ChangeRequestDecide a5 a4 a2 a1
    )
