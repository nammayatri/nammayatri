...
postFarePolicyV2PolicyReplace a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2PolicyReplace a6 a5 a3 a2 a1
    )
...
postFarePolicyV2BulkReplace a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2BulkReplace a5 a4 a2 a1
    )
...
postFarePolicyV2Preview a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2Preview a4 a3 a1
    )
...
postFarePolicyV2ProductCreate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2ProductCreate a4 a3 a1
    )
...
postFarePolicyV2ProductUpdate a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2ProductUpdate a5 a4 a2 a1
    )
...
postFarePolicyV2ProductRemove a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.DashboardAuth.Management.FarePolicyV2.postFarePolicyV2ProductRemove a5 a4 a3 a2 a1
    )
...
postFarePolicyV2ChangeRequestDecide a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.DashboardAuth.Management.FarePolicyV2.postFarePolicyV2ChangeRequestDecide a5 a4 a3 a2 a1
    )
...
postFarePolicyV2AlertsSubscribe a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2AlertsSubscribe a4 a3 a1
    )
...
postFarePolicyV2AlertsUnsubscribe a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2AlertsUnsubscribe a4 a3 a1
    )
