...
import qualified Domain.Action.DashboardAuth.Management.FarePolicyV2
...
getFarePolicyV2List a7 a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a5 $ Domain.Action.Dashboard.Management.FarePolicyV2.getFarePolicyV2List a7 a6 a4 a3 a2 a1
...
getFarePolicyV2Policy a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.Management.FarePolicyV2.getFarePolicyV2Policy a4 a3 a1
...
postFarePolicyV2PolicyReplace a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_MANAGEMENT/FARE_POLICY_V2/POST_FARE_POLICY_V2_POLICY_REPLACE" a4 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a4 $ Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2PolicyReplace a6 a5 a3 a2 a1
    )
...
postFarePolicyV2BulkReplace a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_MANAGEMENT/FARE_POLICY_V2/POST_FARE_POLICY_V2_BULK_REPLACE" a3 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2BulkReplace a5 a4 a2 a1
    )
...
postFarePolicyV2Preview a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_MANAGEMENT/FARE_POLICY_V2/POST_FARE_POLICY_V2_PREVIEW" a2 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2Preview a4 a3 a1
    )
...
postFarePolicyV2ProductCreate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_MANAGEMENT/FARE_POLICY_V2/POST_FARE_POLICY_V2_PRODUCT_CREATE" a2 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2ProductCreate a4 a3 a1
    )
...
postFarePolicyV2ProductUpdate a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_MANAGEMENT/FARE_POLICY_V2/POST_FARE_POLICY_V2_PRODUCT_UPDATE" a3 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2ProductUpdate a5 a4 a2 a1
    )
...
postFarePolicyV2ProductRemove a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_MANAGEMENT/FARE_POLICY_V2/POST_FARE_POLICY_V2_PRODUCT_REMOVE" a3 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.DashboardAuth.Management.FarePolicyV2.postFarePolicyV2ProductRemove a5 a4 a3 a2 a1
    )
...
getFarePolicyV2ChangeRequestList a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.Management.FarePolicyV2.getFarePolicyV2ChangeRequestList a4 a3 a1
...
postFarePolicyV2ChangeRequestDecide a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_MANAGEMENT/FARE_POLICY_V2/POST_FARE_POLICY_V2_CHANGE_REQUEST_DECIDE" a3 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a3 $ Domain.Action.DashboardAuth.Management.FarePolicyV2.postFarePolicyV2ChangeRequestDecide a5 a4 a3 a2 a1
    )
...
getFarePolicyV2AlertsSubscriptions a3 a2 a1 = withDashboardFlowHandlerAPI $ Tools.ActorInfo.withDashboardUserActorInfo a1 $ Domain.Action.Dashboard.Management.FarePolicyV2.getFarePolicyV2AlertsSubscriptions a3 a2
...
postFarePolicyV2AlertsSubscribe a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_MANAGEMENT/FARE_POLICY_V2/POST_FARE_POLICY_V2_ALERTS_SUBSCRIBE" a2 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2AlertsSubscribe a4 a3 a1
    )
...
postFarePolicyV2AlertsUnsubscribe a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_MANAGEMENT/FARE_POLICY_V2/POST_FARE_POLICY_V2_ALERTS_UNSUBSCRIBE" a2 (Kernel.Prelude.Just a1)
        Tools.ActorInfo.withDashboardUserActorInfo a2 $ Domain.Action.Dashboard.Management.FarePolicyV2.postFarePolicyV2AlertsUnsubscribe a4 a3 a1
    )
