...
postPayoutScheduler :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.ProviderPlatform.Management.Payout.PayoutSchedulerReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Payout.PayoutSchedulerResp)
postPayoutScheduler a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Payout.postPayoutScheduler a3 a2 a1
