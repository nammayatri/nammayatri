...
getPayoutPayoutReferralHistory a10 a9 a8 a7 a6 a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Payout.getPayoutPayoutReferralHistory a10 a9 a8 a7 a6 a5 a4 a3 a2 a1
...
postPayoutPayoutPendingPayout a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Payout.postPayoutPayoutPendingPayout a3 a2 a1
...
postPayoutPayoutDeleteVPA a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Payout.postPayoutPayoutDeleteVPA a3 a2 a1
