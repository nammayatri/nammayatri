...
postDriverDriverDataDecryption a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Driver.postDriverDriverDataDecryption a3 a2 a1
...
postDriverPersonId a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Driver.postDriverPersonId a3 a2 a1
...
getDriverPanAadharSelfieDetails a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Driver.getDriverPanAadharSelfieDetails a4 a3 a2 a1
...
postDriverSyncDocAadharPan a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Driver.postDriverSyncDocAadharPan a3 a2 a1
...
postDriverUpdateVehicleManufacturing a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Driver.postDriverUpdateVehicleManufacturing a4 a3 a2 a1
...
postDriverRefundByPayout a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Driver.postDriverRefundByPayout a4 a3 a2 a1
...
getDriverPanAadharSelfieDetailsList a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Management.Driver.getDriverPanAadharSelfieDetailsList a4 a3 a2 a1
