...
postDriverOperatorChange :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Kernel.Prelude.Text -> Kernel.Types.Id.Id Dashboard.Common.Driver -> API.Types.ProviderPlatform.Management.Driver.ChangeDriverOperatorReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverOperatorChange a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Driver.postDriverOperatorChange a5 a4 a3 a2 a1

postDriverFleetOperatorChange :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Kernel.Prelude.Text -> Kernel.Prelude.Text -> API.Types.ProviderPlatform.Management.Driver.ChangeFleetOperatorReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetOperatorChange a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Driver.postDriverFleetOperatorChange a5 a4 a3 a2 a1

postDriverFleetOperatorCreate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> Kernel.Prelude.Text -> Kernel.Prelude.Text -> API.Types.ProviderPlatform.Management.Driver.CreateFleetOperatorReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverFleetOperatorCreate a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Driver.postDriverFleetOperatorCreate a5 a4 a3 a2 a1
