...
postDriverInvalidatePanCard :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> API.Types.ProviderPlatform.Management.Driver.InvalidatePanCardReq -> Environment.FlowHandler Kernel.Types.APISuccess.APISuccess)
postDriverInvalidatePanCard a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Driver.postDriverInvalidatePanCard a3 a2 a1
