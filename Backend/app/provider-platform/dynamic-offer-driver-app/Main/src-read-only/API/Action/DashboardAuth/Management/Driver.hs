...
type GetDriverPlanDrivers = (DashboardUserAuth ('DRIVER_OFFER_BPP_MANAGEMENT) "PROVIDER_MANAGEMENT/DRIVER/GET_DRIVER_PLAN_DRIVERS" :> API.Types.ProviderPlatform.Management.Driver.GetDriverPlanDrivers)

type PostDriverPlanMigrate =
  ( DashboardUserAuth
      ('DRIVER_OFFER_BPP_MANAGEMENT)
      "PROVIDER_MANAGEMENT/DRIVER/POST_DRIVER_PLAN_MIGRATE"
...
postDriverPersonNumbers a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverPersonNumbers a4 a3 a1
    )
...
postDriverUpdateTagBulk a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverUpdateTagBulk a4 a3 a1
    )
...
postDriverDriverDataDecryption a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverDriverDataDecryption a4 a3 a1
    )
...
postDriverPersonId a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverPersonId a4 a3 a1
    )
...
postDriverDisable a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverDisable a4 a3 a1
    )
...
postDriverAcRestrictionUpdate a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverAcRestrictionUpdate a5 a4 a2 a1
    )
...
postDriverBlockWithReason a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverBlockWithReason a5 a4 a2 (Tools.Auth.DashboardUserAuth.dashboardRequestorName a3) a1
    )
...
postDriverBlock a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverBlock a4 a3 a1
    )
...
postDriverUnblock a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverUnblock a6 a5 a3 (Tools.Auth.DashboardUserAuth.dashboardRequestorName a4) a2 a1
    )
...
deleteDriverPermanentlyDelete a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.DashboardAuth.Management.Driver.deleteDriverPermanentlyDelete a4 a3 a2 a1
    )
...
postDriverUnlinkDL a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverUnlinkDL a4 a3 a1
    )
...
postDriverUnlinkAadhaar a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverUnlinkAadhaar a4 a3 a1
    )
...
postDriverUpdatePhoneNumber a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverUpdatePhoneNumber a5 a4 a2 a1
    )
...
postDriverUpdateByPhoneNumber a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverUpdateByPhoneNumber a5 a4 a2 a1
    )
...
postDriverUpdateName a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverUpdateName a5 a4 a2 a1
    )
...
postDriverDeleteRC a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverDeleteRC a5 a4 a2 a1
    )
...
postDriverSendDummyNotification a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverSendDummyNotification a4 a3 a1
    )
...
postDriverChangeOperatingCity a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverChangeOperatingCity a5 a4 a2 a1
    )
...
postDriverPauseOrResumeServiceCharges a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverPauseOrResumeServiceCharges a5 a4 a2 a1
    )
...
postDriverUpdateRCInvalidStatus a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverUpdateRCInvalidStatus a5 a4 a2 a1
    )
...
postDriverUpdateRCInvalidStatusByRCNumber a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverUpdateRCInvalidStatusByRCNumber a4 a3 a1
    )
...
postDriverUpdateVehicleVariant a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverUpdateVehicleVariant a5 a4 a2 a1
    )
...
postDriverBulkReviewRCVariant a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverBulkReviewRCVariant a4 a3 a1
    )
...
postDriverUpdateDriverTag a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverUpdateDriverTag a5 a4 a2 a1
    )
...
postDriverUpdateSpecialLocWarrior a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverUpdateSpecialLocWarrior a5 a4 a2 a1
    )
...
postDriverClearFee a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverClearFee a5 a4 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a3)) a2 a1
    )
...
postDriverSyncDocAadharPan a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverSyncDocAadharPan a4 a3 a1
    )
...
postDriverUpdateVehicleManufacturing a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverUpdateVehicleManufacturing a5 a4 a2 a1
    )
...
postDriverVehicleAppendSelectedServiceTiers a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverVehicleAppendSelectedServiceTiers a5 a4 a2 a1
    )
...
postDriverVehicleRemoveSelectedServiceTiers a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverVehicleRemoveSelectedServiceTiers a5 a4 a2 a1
    )
...
postDriverVehicleUpsertSelectedServiceTiers a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverVehicleUpsertSelectedServiceTiers a5 a4 a2 a1
    )
...
postDriverRefundByPayout a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverRefundByPayout a5 a4 a2 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a3)) a1
    )
...
postDriverBulkSubscriptionServiceUpdate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverBulkSubscriptionServiceUpdate a4 a3 a1
    )

getDriverPlanDrivers :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> DashboardUser -> Kernel.Prelude.Text -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Driver.GetDriversOnPlanRes)
getDriverPlanDrivers a4 a3 _a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Driver.getDriverPlanDrivers a4 a3 a1

postDriverPlanMigrate :: (Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant -> Kernel.Types.Beckn.Context.City -> DashboardUser -> API.Types.ProviderPlatform.Management.Driver.MigratePlanReq -> Environment.FlowHandler API.Types.ProviderPlatform.Management.Driver.MigratePlanRes)
postDriverPlanMigrate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_MANAGEMENT/DRIVER/POST_DRIVER_PLAN_MIGRATE" a2 (Kernel.Prelude.Just a1)
        Domain.Action.Dashboard.Management.Driver.postDriverPlanMigrate a4 a3 a1
    )
...
getDriverFyEarnings a6 a5 a4 a3 a2 a1 = withDashboardFlowHandlerAPI $ Domain.Action.Dashboard.Management.Driver.getDriverFyEarnings a6 a5 a3 a2 a1 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a4)
...
postDriverTdsRateUpdate a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverTdsRateUpdate a4 a3 a1
    )
...
postDriverUpdateMerchant a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverUpdateMerchant a5 a4 a2 a1
    )
...
postDriverAirportPreference a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverAirportPreference a5 a4 a2 a1
    )
...
postDriverIdentityInfoUpdate a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverIdentityInfoUpdate a5 a4 a2 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a3) a1
    )
...
postDriverAssociationChange a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.Management.Driver.postDriverAssociationChange a5 a4 (Tools.Auth.DashboardUserAuth.dashboardRequestorId a3) a2 a1
    )
