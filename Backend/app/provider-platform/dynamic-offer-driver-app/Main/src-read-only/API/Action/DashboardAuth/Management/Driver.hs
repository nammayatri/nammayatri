...
postDriverVehicleUpsertSelectedServiceTiers a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        Tools.Auth.DashboardUserAuth.auditDashboardAction Tools.Auth.DashboardUserAuth.DRIVER_OFFER_BPP_MANAGEMENT "PROVIDER_MANAGEMENT/DRIVER/POST_DRIVER_VEHICLE_UPSERT_SELECTED_SERVICE_TIERS" a2 (Kernel.Prelude.Just a1)
        Domain.Action.Dashboard.Management.Driver.postDriverVehicleUpsertSelectedServiceTiers a4 a3 a1
    )
