...
putSubscriptionSelectPlan a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Subscription.putSubscriptionSelectPlan a5 a4 a2 a1 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a3))
    )
...
putSubscriptionSuspendPlan a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Subscription.putSubscriptionSuspendPlan a4 a3 a1 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a2))
    )
...
postSubscriptionSubscribePlan a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Subscription.postSubscriptionSubscribePlan a5 a4 a2 a1 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a3))
    )
...
putSubscriptionSelectPlanV2 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Subscription.putSubscriptionSelectPlanV2 a6 a5 a3 a2 a1 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a4))
    )
...
putSubscriptionSuspendPlanV2 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Subscription.putSubscriptionSuspendPlanV2 a5 a4 a2 a1 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a3))
    )
...
postSubscriptionSubscribePlanV2 a7 a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Subscription.postSubscriptionSubscribePlanV2 a7 a6 a4 a3 a2 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a5)) a1
    )
...
postSubscriptionCollectManualPayments a6 a5 a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Subscription.postSubscriptionCollectManualPayments a6 a5 a3 a2 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a4)) a1
    )
...
postSubscriptionFeeWaiveOff a4 a3 a2 a1 =
  withDashboardFlowHandlerAPI $
    ( do
        ...
        Domain.Action.Dashboard.AppManagement.Subscription.postSubscriptionFeeWaiveOff a4 a3 (Kernel.Prelude.Just (Tools.Auth.DashboardUserAuth.dashboardRequestorId a2)) a1
    )
