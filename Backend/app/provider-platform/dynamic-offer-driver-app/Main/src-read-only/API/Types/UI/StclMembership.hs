...
data Address
    = Address {city :: Kernel.Prelude.Text,
...
data BankDetails
    = BankDetails {accountNumber :: Kernel.Prelude.Text, bankName :: Kernel.Prelude.Text, branch :: Kernel.Prelude.Text, ifscCode :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data Declaration
    = Declaration {date :: Data.Time.Day, place :: Kernel.Prelude.Text, signature :: Kernel.Prelude.Text, termsAccepted :: Kernel.Prelude.Bool}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data FuelType
    = EV | Petrol | Diesel | CNG | Other
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MembershipApplicationReq
    = MembershipApplicationReq {aadharNumber :: Kernel.Prelude.Text,
                                address :: Address,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MembershipApplicationResp
    = MembershipApplicationResp {applicationId :: Kernel.Prelude.Text, message :: Kernel.Prelude.Text, status :: Domain.Types.StclMembership.ApplicationStatus, submittedAt :: Kernel.Prelude.UTCTime}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MembershipDetailsResp
    = MembershipDetailsResp {address :: Address,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data NomineeInfo
    = NomineeInfo {nomineeAadhar :: Kernel.Prelude.Maybe Kernel.Prelude.Text, nomineeName :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VehicleInfo
    = VehicleInfo {fuelTypes :: [FuelType], vehicleType :: VehicleType}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VehicleType
