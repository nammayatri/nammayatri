...
data SubscriptionWaiveOffConfig = SubscriptionWaiveOffConfig {daysValidFor :: Kernel.Prelude.Int, percentage :: Kernel.Prelude.Int, serviceName :: Data.Text.Text, waiveOffMode :: Data.Text.Text}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
