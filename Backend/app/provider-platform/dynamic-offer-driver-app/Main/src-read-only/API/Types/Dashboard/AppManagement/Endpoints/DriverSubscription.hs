...
data DriverFeeInfoToUpdate
    = DriverFeeInfoToUpdate {driverFeeId :: Kernel.Prelude.Text,
...
data InvoiceInfoToUpdate
    = InvoiceInfoToUpdate {invoiceId :: Kernel.Prelude.Text, driverFeeId :: Kernel.Prelude.Maybe Kernel.Prelude.Text, invoiceStatus :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SendSmsReq
    = SendSmsReq {channel :: Domain.Types.MerchantMessage.MediaChannel,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets SendSmsReq
    where hideSecrets = Kernel.Prelude.identity
data SubscriptionDriverFeesAndInvoicesToUpdate
    = SubscriptionDriverFeesAndInvoicesToUpdate {driverFees :: Kernel.Prelude.Maybe [DriverFeeInfoToUpdate],
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets SubscriptionDriverFeesAndInvoicesToUpdate
    where hideSecrets = Kernel.Prelude.identity
...
type PostDriverSubscriptionSendSmsHelper = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> Capture "volunteerId" Kernel.Prelude.Text :> "sendSms" :> ReqBody ('[JSON])
                                                                                                                                                                                 SendSmsReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostDriverSubscriptionUpdateDriverFeeAndInvoiceInfo = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "update" :> "driverFeeAndInvoiceInfo" :> Capture "serviceName"
                                                                                                                                                                                Dashboard.Common.ServiceNames :> ReqBody ('[JSON]) SubscriptionDriverFeesAndInvoicesToUpdate :> Post ('[JSON])
                                                                                                                                                                                                                                                                                     SubscriptionDriverFeesAndInvoicesToUpdate)
data DriverSubscriptionAPIs
    = DriverSubscriptionAPIs {postDriverSubscriptionSendSms :: (Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Text -> SendSmsReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess),
...
mkDriverSubscriptionAPIs driverSubscriptionClient = (DriverSubscriptionAPIs {..})
                             where postDriverSubscriptionSendSms :<|> postDriverSubscriptionUpdateDriverFeeAndInvoiceInfo = driverSubscriptionClient
data DriverSubscriptionUserActionType
    = POST_DRIVER_SUBSCRIPTION_SEND_SMS | POST_DRIVER_SUBSCRIPTION_UPDATE_DRIVER_FEE_AND_INVOICE_INFO
