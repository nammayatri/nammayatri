...
data AddDriversResp = AddDriversResp {processedDrivers :: [ProcessedDriverInfo], unprocessedEntities :: [Kernel.Prelude.Text]}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
...
instance Kernel.Types.HideSecrets.HideSecrets AddRidePayoutAccountNumberReq where
...
data CancelScheduledBookingReq = CancelScheduledBookingReq {rideId :: Kernel.Prelude.Text, reasonCode :: Dashboard.Common.Booking.CancellationReasonCode, additionalInfo :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

instance Kernel.Types.HideSecrets.HideSecrets CancelScheduledBookingReq where
  hideSecrets = Kernel.Prelude.identity
...
data ChangeFleetOwnerReq = ChangeFleetOwnerReq {newFleetOwnerId :: Kernel.Prelude.Text, reason :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

instance Kernel.Types.HideSecrets.HideSecrets ChangeFleetOwnerReq where
  hideSecrets = Kernel.Prelude.identity
...
data DriveVehicleAssociationListItem = DriveVehicleAssociationListItem
  { driverId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    driverDocsVerificationStatus :: Kernel.Prelude.Maybe Dashboard.Common.DocsVerificationStatus,
    vehicleDocsVerificationStatus :: Kernel.Prelude.Maybe Dashboard.Common.DocsVerificationStatus,
...
data DriveVehicleAssociationListItemT = DriveVehicleAssociationListItemT
  { driverId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    driverEmail :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    completedRides :: Kernel.Prelude.Int,
    vehicleType :: Kernel.Prelude.Maybe Dashboard.Common.VehicleVariant,
    earning :: Kernel.Prelude.Int,
    isDriverOnRide :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
...
data DrivertoVehicleAssociationResT = DrivertoVehicleAssociationResT {fleetOwnerId :: Kernel.Prelude.Text, listItem :: [DriveVehicleAssociationListItemT], summary :: Dashboard.Common.DriverSummary}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data FleetOwnerListItem = FleetOwnerListItem
  { fleetOwnerId :: Kernel.Types.Id.Id Dashboard.Common.Person,
    ...
    address :: Kernel.Prelude.Maybe Dashboard.Common.Driver.StripeAddress,
    fleetName :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    email :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    mobileNumber :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    docsVerificationStatus :: Kernel.Prelude.Maybe Dashboard.Common.DocsVerificationStatus,
...
data ProcessedDriverInfo = ProcessedDriverInfo {driverId :: Kernel.Types.Id.Id Dashboard.Common.Driver, phoneNo :: Kernel.Prelude.Text}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
...
data ReassignScheduledBookingReq = ReassignScheduledBookingReq {rideId :: Kernel.Prelude.Text, newDriverId :: Kernel.Types.Id.Id Dashboard.Common.Driver, clientId :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

instance Kernel.Types.HideSecrets.HideSecrets ReassignScheduledBookingReq where
  hideSecrets = Kernel.Prelude.identity
...
data UpdateCashRideReq = UpdateCashRideReq {enableCashRide :: Kernel.Prelude.Bool, targetIds :: Kernel.Prelude.Maybe [Kernel.Prelude.Text]}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

instance Kernel.Types.HideSecrets.HideSecrets UpdateCashRideReq where
  hideSecrets = Kernel.Prelude.identity
...
data VehicleAPIEntityT = VehicleAPIEntityT
  { variant :: Kernel.Prelude.Maybe Dashboard.Common.VehicleVariant,
    ...
    driverName :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    vehicleBalance :: Kernel.Prelude.Maybe Kernel.Prelude.Double,
    vehicleBalanceAdjustmentPercentage :: Kernel.Prelude.Maybe Kernel.Types.Common.Centesimal
  }
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
...
type GetDriverFleetOwnerList =
  ( "fleetOwner" :> "list" :> QueryParam "approvalStatus" Dashboard.Common.Driver.ApprovalStatusFilter
      :> QueryParam
           "blocked"
           Kernel.Prelude.Bool
      :> QueryParam "docsVerificationStatus" Dashboard.Common.DocsVerificationStatus
      :> QueryParam
           "enabled"
           Kernel.Prelude.Bool
      :> QueryParam
...
type PostDriverAddRidePayoutAccountNumber = ("addRidePayoutAccountNumber" :> ReqBody '[JSON] AddRidePayoutAccountNumberReq :> Post '[JSON] Kernel.Types.APISuccess.APISuccess)
...
type PostDriverFleetCashRideUpdate =
  ( "fleet" :> "cashRideUpdate" :> QueryParam "fleetOwnerId" Kernel.Prelude.Text :> ReqBody '[JSON] UpdateCashRideReq
      :> Post
           '[JSON]
           Kernel.Types.APISuccess.APISuccess
  )

type PostDriverFleetCashRideUpdateHelper =
  ( Capture "requestorId" Kernel.Prelude.Text :> "fleet" :> "cashRideUpdate" :> QueryParam "fleetOwnerId" Kernel.Prelude.Text
      :> ReqBody
           '[JSON]
           UpdateCashRideReq
      :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
...
type PostDriverFleetRemoveDriver =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "fleet" :> "remove" :> "driver"
      :> QueryParam
           "fleetOwnerId"
           Kernel.Prelude.Text
      :> QueryParam "operatorCode" Kernel.Prelude.Text
      :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
  )
...
type GetDriverFleetOperatorInfo =
  ( "fleetOperatorInfo" :> QueryParam "mobileCountryCode" Kernel.Prelude.Text :> QueryParam "mobileNumber" Kernel.Prelude.Text
      :> QueryParam
           "personId"
           Kernel.Prelude.Text
      :> QueryParam "walletId" Kernel.Prelude.Text
...
type GetDriverFleetDashboardAnalyticsAllTime = ("fleet" :> "dashboard" :> "analytics" :> "allTime" :> QueryParam "fleetOwnerId" Kernel.Prelude.Text :> Get '[JSON] AllTimeFleetAnalyticsRes)

type GetDriverFleetDashboardAnalyticsAllTimeHelper =
  ( Capture "fleetOwnerId" Kernel.Prelude.Text :> "fleet" :> "dashboard" :> "analytics" :> "allTime"
      :> QueryParam
           "requestorId"
           Kernel.Prelude.Text
      :> Get '[JSON] AllTimeFleetAnalyticsRes
  )

type GetDriverFleetDashboardAnalytics =
  ( "fleet" :> "dashboard" :> "analytics" :> QueryParam "fleetOwnerId" Kernel.Prelude.Text
      :> QueryParam
           "responseType"
...
type PostDriverFleetDriverChangeFleetOwner =
  ( "fleet" :> "driver" :> Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "changeFleetOwner"
      :> ReqBody
           '[JSON]
           ChangeFleetOwnerReq
      :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
...
type PostDriverFleetVehicleChangeFleetOwner =
  ( "fleet" :> "vehicle" :> Capture "rcNo" Kernel.Prelude.Text :> "changeFleetOwner" :> ReqBody '[JSON] ChangeFleetOwnerReq
      :> Post
           '[JSON]
           Kernel.Types.APISuccess.APISuccess
  )
...
type GetDriverFleetVehicleListStats =
  ( "fleet" :> "vehicle" :> "list" :> "stats" :> QueryParam "fleetOwnerId" Kernel.Prelude.Text :> QueryParam "vehicleNo" Kernel.Prelude.Text
      :> QueryParam
           "limit"
           Kernel.Prelude.Int
      :> QueryParam "offset" Kernel.Prelude.Int
...
type GetDriverFleetStatusSummary =
  ( "fleet" :> Capture "entityOperationType" EntityOperationType :> "statusSummary" :> QueryParam "fleetOwnerId" Kernel.Prelude.Text
      :> Get
           '[JSON]
...
type PostDriverFleetScheduledBookingCancel = ("fleet" :> "scheduledBooking" :> "cancel" :> ReqBody '[JSON] CancelScheduledBookingReq :> Post '[JSON] Kernel.Types.APISuccess.APISuccess)

type PostDriverFleetScheduledBookingCancelHelper =
  ( "fleet" :> Capture "fleetOwnerId" Kernel.Prelude.Text :> "scheduledBooking" :> "cancel"
      :> ReqBody
           '[JSON]
           CancelScheduledBookingReq
      :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
  )

type PostDriverFleetScheduledBookingReassign = ("fleet" :> "scheduledBooking" :> "reassign" :> ReqBody '[JSON] ReassignScheduledBookingReq :> Post '[JSON] Kernel.Types.APISuccess.APISuccess)

type PostDriverFleetScheduledBookingReassignHelper =
  ( "fleet" :> Capture "fleetOwnerId" Kernel.Prelude.Text :> "scheduledBooking" :> "reassign"
      :> ReqBody
           '[JSON]
           ReassignScheduledBookingReq
      :> Post '[JSON] Kernel.Types.APISuccess.APISuccess
  )

type GetDriverVehicleInfo = ("vehicle" :> "info" :> QueryParam "vehicleNo" Kernel.Prelude.Text :> QueryParam "rcId" Kernel.Prelude.Text :> Get '[JSON] VehicleInfo)
...
data DriverAPIs = DriverAPIs
  { getDriverFleetAccessList :: Kernel.Prelude.Maybe Kernel.Prelude.Text -> EulerHS.Types.EulerClient FleetOwnerListRes,
    ...
    postDriverAddRidePayoutAccountNumber :: AddRidePayoutAccountNumberReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
    ...
    postDriverFleetCashRideUpdate :: Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> UpdateCashRideReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
    postDriverFleetRemoveDriver :: Kernel.Prelude.Text -> Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
    ...
    getDriverFleetVehicleAssociation :: Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> Kernel.Prelude.Maybe FleetVehicleStatus -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Kernel.Prelude.Maybe Dashboard.Common.DocsVerificationStatus -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> EulerHS.Types.EulerClient DrivertoVehicleAssociationResT,
    ...
    postDriverFleetAddDrivers :: Kernel.Prelude.Maybe Kernel.Prelude.Text -> (Data.ByteString.Lazy.ByteString, CreateDriversReq) -> EulerHS.Types.EulerClient AddDriversResp,
    ...
    getDriverFleetDashboardAnalyticsAllTime :: Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> EulerHS.Types.EulerClient AllTimeFleetAnalyticsRes,
    getDriverFleetDashboardAnalytics :: Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe FleetAnalyticsResponseType -> Data.Time.Day -> Data.Time.Day -> EulerHS.Types.EulerClient FleetAnalyticsRes,
    ...
    postDriverFleetDriverChangeFleetOwner :: Kernel.Types.Id.Id Dashboard.Common.Driver -> ChangeFleetOwnerReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
    postDriverFleetVehicleChangeFleetOwner :: Kernel.Prelude.Text -> ChangeFleetOwnerReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
    ...
    getDriverFleetVehicleListStats :: Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Data.Time.Day -> Data.Time.Day -> EulerHS.Types.EulerClient FleetVehicleStatsRes,
    ...
    getDriverFleetStatusSummary :: EntityOperationType -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> EulerHS.Types.EulerClient StatusSummaryResponse,
...
data DriverUserActionType
  ...
  | POST_DRIVER_ADD_RIDE_PAYOUT_ACCOUNT_NUMBER
  ...
  | POST_DRIVER_FLEET_CASH_RIDE_UPDATE
  ...
  | POST_DRIVER_FLEET_DRIVER_CHANGE_FLEET_OWNER
  | POST_DRIVER_FLEET_VEHICLE_CHANGE_FLEET_OWNER
  ...
  | GET_DRIVER_FLEET_STATUS_SUMMARY
  ...
  | POST_DRIVER_FLEET_SCHEDULED_BOOKING_REASSIGN
...
$(mkHttpInstancesForEnum ''EntityOperationType)
