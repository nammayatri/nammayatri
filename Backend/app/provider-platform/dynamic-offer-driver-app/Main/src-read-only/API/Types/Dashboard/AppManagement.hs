...
instance Text.Read.Read AppManagementUserActionType
    where readsPrec d' = Text.Read.readParen (d' > app_prec) (\r -> [(DRIVER v1, r2) | r1 <- stripPrefix "DRIVER/" r, (v1, r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(DRIVER_SUBSCRIPTION v1,
                                                                                                                                                                              r2) | r1 <- stripPrefix "DRIVER_SUBSCRIPTION/" r, (v1, r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(DRIVER_WALLET v1,
                                                                                                                                                                                                                                                                                        r2) | r1 <- stripPrefix "DRIVER_WALLET/" r,
                                                                                                                                                                                                                                                                                              (v1,
                                                                                                                                                                                                                                                                                               r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(OVERLAY v1,
                                                                                                                                                                                                                                                                                                                                                  r2) | r1 <- stripPrefix "OVERLAY/" r,
                                                                                                                                                                                                                                                                                                                                                        (v1,
                                                                                                                                                                                                                                                                                                                                                         r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(PENALTY v1,
                                                                                                                                                                                                                                                                                                                                                                                                            r2) | r1 <- stripPrefix "PENALTY/" r,
                                                                                                                                                                                                                                                                                                                                                                                                                  (v1,
                                                                                                                                                                                                                                                                                                                                                                                                                   r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(SUBSCRIPTION v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      r2) | r1 <- stripPrefix "SUBSCRIPTION/" r,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            (v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                             r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(SUBSCRIPTION_TRANSACTION v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                r2) | r1 <- stripPrefix "SUBSCRIPTION_TRANSACTION/" r,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (v1,
