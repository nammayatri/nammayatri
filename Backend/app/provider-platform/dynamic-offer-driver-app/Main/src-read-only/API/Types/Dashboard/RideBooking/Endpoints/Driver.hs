...
data AadhaarAssociationAPIEntity
    = AadhaarAssociationAPIEntity {nameOnCard :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                                   driverGender :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                                   driverDob :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                                   aadharNumber :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
data ActionType
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverAssociationInfo
    = DriverAssociationInfo {personId :: Kernel.Types.Id.Id Dashboard.Common.Person,
...
data DriverBlockTransactions
    = DriverBlockTransactions {reasonCode :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverFeedbackAPIEntity
    = DriverFeedbackAPIEntity {rideId :: Kernel.Types.Id.Id Domain.Types.Ride.Ride,
                               createdAt :: Kernel.Prelude.UTCTime,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverInfoRes
    = DriverInfoRes {driverId :: Kernel.Types.Id.Id Dashboard.Common.Driver,
                     ...
                     aadharAssociationDetails :: Kernel.Prelude.Maybe AadhaarAssociationAPIEntity,
                     panCardDetails :: Kernel.Prelude.Maybe PanCardAPIEntity,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverLicenseAPIEntity
    = DriverLicenseAPIEntity {driverLicenseId :: Kernel.Types.Id.Id Dashboard.Common.Driver.DriverLicense,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverOutstandingBalanceResp
    = DriverOutstandingBalanceResp {driverFeeId :: Kernel.Types.Id.Id DriverOutstandingBalanceResp,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverRCAssociationAPIEntity
    = DriverRCAssociationAPIEntity {associatedOn :: Kernel.Prelude.UTCTime,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ExemptionAndCashCollectionDriverFeeReq
    = ExemptionAndCashCollectionDriverFeeReq {paymentIds :: [Kernel.Prelude.Text], isExempt :: Kernel.Prelude.Bool}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets ExemptionAndCashCollectionDriverFeeReq
    where hideSecrets = Kernel.Prelude.identity
data GetFeedbackListRes
    = GetFeedbackListRes {feedbacks :: [DriverFeedbackAPIEntity]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data OnboardingAs
    = FLEET_DRIVER | INDIVIDUAL
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PanCardAPIEntity
    = PanCardAPIEntity {panCardNumber :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                        verificationStatus :: Dashboard.Common.VerificationStatus,
                        driverDob :: Kernel.Prelude.Maybe Kernel.Prelude.UTCTime,
                        driverName :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PlatformFee
    = PlatformFee {fee :: Kernel.Types.Common.HighPrecMoney,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VehicleRegistrationCertificateAPIEntity
    = VehicleRegistrationCertificateAPIEntity {registrationCertificateId :: Kernel.Types.Id.Id Dashboard.Common.Driver.VehicleRegistrationCertificate,
...
type PostDriverCollectCash = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "collectCash" :> QueryParam "vendorId" Kernel.Prelude.Text :> Post ('[JSON])
                                                                                                                                                                    Kernel.Types.APISuccess.APISuccess)
type PostDriverCollectCashHelper = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "collectCash" :> QueryParam "vendorId" Kernel.Prelude.Text :> ReqBody ('[JSON])
                                                                                                                                                                             Kernel.Prelude.Text :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostDriverV2CollectCash = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "v2" :> "collectCash" :> Capture "serviceName"
                                                                                                                                    Dashboard.Common.Driver.ServiceNames :> QueryParam "vendorId" Kernel.Prelude.Text :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostDriverCollectCashV2Helper = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "collectCash" :> "v2" :> Capture "token" Kernel.Prelude.Text :> Capture "serviceName"
                                                                                                                                                                                 Dashboard.Common.Driver.ServiceNames :> QueryParam "vendorId" Kernel.Prelude.Text :> Post ('[JSON])
                                                                                                                                                                                                                                                                           Kernel.Types.APISuccess.APISuccess)
...
type PostDriverExemptCashHelper = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "exemptCash" :> ReqBody ('[JSON]) Kernel.Prelude.Text :> Post ('[JSON])
                                                                                                                                                                    Kernel.Types.APISuccess.APISuccess)
type PostDriverV2ExemptCash = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "v2" :> "exemptCash" :> Capture "serviceName" Dashboard.Common.Driver.ServiceNames :> Post ('[JSON])
                                                                                                                                                                                             Kernel.Types.APISuccess.APISuccess)
type PostDriverExemptCashV2Helper = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "exemptCash" :> "v2" :> Capture "token" Kernel.Prelude.Text :> Capture "serviceName"
                                                                                                                                                                               Dashboard.Common.Driver.ServiceNames :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type GetDriverInfo = ("info" :> QueryParam "mobileNumber" Kernel.Prelude.Text :> QueryParam "mobileCountryCode" Kernel.Prelude.Text :> QueryParam "vehicleNumber"
                                                                                                                                                  Kernel.Prelude.Text :> QueryParam "dlNumber" Kernel.Prelude.Text :> QueryParam "rcNumber" Kernel.Prelude.Text :> QueryParam "email"
                                                                                                                                                                                                                                                                              Kernel.Prelude.Text :> QueryParam "personId"
                                                                                                                                                                                                                                                                                                                (Kernel.Types.Id.Id Dashboard.Common.Driver) :> QueryParam "walletId"
                                                                                                                                                                                                                                                                                                                                                                           Kernel.Prelude.Text :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                      DriverInfoRes)
type GetDriverInfoHelper = ("info" :> Capture "fleetOwnerId" Kernel.Prelude.Text :> Capture "mbFleet" Kernel.Prelude.Bool :> QueryParam "mobileNumber"
                                                                                                                                        Kernel.Prelude.Text :> QueryParam "mobileCountryCode" Kernel.Prelude.Text :> QueryParam "vehicleNumber" Kernel.Prelude.Text :> QueryParam "dlNumber"
                                                                                                                                                                                                                                                                                  Kernel.Prelude.Text :> QueryParam "rcNumber"
                                                                                                                                                                                                                                                                                                                    Kernel.Prelude.Text :> QueryParam "email"
                                                                                                                                                                                                                                                                                                                                                      Kernel.Prelude.Text :> QueryParam "personId"
                                                                                                                                                                                                                                                                                                                                                                                        (Kernel.Types.Id.Id Dashboard.Common.Driver) :> QueryParam "walletId"
                                                                                                                                                                                                                                                                                                                                                                                                                                                   Kernel.Prelude.Text :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                              DriverInfoRes)
type GetDriverFeedbackList = ("feedback" :> "list" :> QueryParam "personId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> QueryParam "mobileNumber"
                                                                                                                                       Kernel.Prelude.Text :> QueryParam "mobileCountryCode" Kernel.Prelude.Text :> Get ('[JSON]) GetFeedbackListRes)
...
type PostDriverAddVehicle = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "addVehicle" :> ReqBody ('[JSON])
                                                                                                                        API.Types.ProviderPlatform.Fleet.Driver.AddVehicleReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostDriverSetRCStatus = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "setRCStatus" :> ReqBody ('[JSON])
                                                                                                                          API.Types.ProviderPlatform.Fleet.Driver.RCStatusReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostDriverExemptDriverFee = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "exemptDriverFee" :> Capture "serviceName"
                                                                                                                                  Dashboard.Common.Driver.ServiceNames :> ReqBody ('[JSON]) ExemptionAndCashCollectionDriverFeeReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostDriverExemptDriverFeeV2Helper = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "exemptDriverFee" :> "v2" :> Capture "token" Kernel.Prelude.Text :> Capture "serviceName"
                                                                                                                                                                                         Dashboard.Common.Driver.ServiceNames :> ReqBody ('[JSON]) ExemptionAndCashCollectionDriverFeeReq :> Post ('[JSON])
                                                                                                                                                                                                                                                                                                  Kernel.Types.APISuccess.APISuccess)
data DriverAPIs
    = DriverAPIs {getDriverPaymentDue :: (Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Text -> EulerHS.Types.EulerClient [DriverOutstandingBalanceResp]),
...
data DriverUserActionType
    ...
    | POST_DRIVER_DELETE_AADHAAR
    | POST_DRIVER_DELETE_PAN_CARD
