...
data AadhaarAssociationAPIEntity = AadhaarAssociationAPIEntity
...
data DriverInfoRes = DriverInfoRes
  { driverId :: Kernel.Types.Id.Id Dashboard.Common.Driver,
    ...
    lifetimeCancellationRate :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    lifetimeRidesCancelled :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    lifetimeRidesAssigned :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    ...
    activeFleetInfo :: Kernel.Prelude.Maybe Dashboard.Common.Driver.DriverAssociationInfo,
    recentFleetInfo :: Kernel.Prelude.Maybe Dashboard.Common.Driver.DriverAssociationInfo,
    operatorInfo :: Kernel.Prelude.Maybe Dashboard.Common.Driver.DriverAssociationInfo,
...
data PanCardAPIEntity = PanCardAPIEntity
  { panCardNumber :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    verificationStatus :: Dashboard.Common.VerificationStatus,
    driverDob :: Kernel.Prelude.Maybe Kernel.Prelude.UTCTime,
    driverName :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
type PostDriverCollectCash =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "collectCash" :> QueryParam "vendorId" Kernel.Prelude.Text
      :> Post
           '[JSON]
