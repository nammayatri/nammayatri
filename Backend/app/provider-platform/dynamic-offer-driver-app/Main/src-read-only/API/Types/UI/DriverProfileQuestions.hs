...
data DriverProfileQuesReq
    = DriverProfileQuesReq {aspirations :: [Kernel.Prelude.Text],
...
data DriverProfileQuesRes
    = DriverProfileQuesRes {aspirations :: [Kernel.Prelude.Text],
                            drivingSince :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                            hometown :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
