...
data BonusRes
    = BonusRes {coins :: Data.Maybe.Maybe Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CertificateInfo
    = CertificateInfo {certificateCourseName :: Data.Text.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LmsCertificateRes
    = LmsCertificateRes {certificateInfo :: Data.Maybe.Maybe CertificateInfo}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LmsEntityCompletionStatus
    = ENTITY_COMPLETED | ENTITY_INCOMPLETE
    deriving stock (Eq, Show, Generic)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LmsGetModuleRes
    = LmsGetModuleRes {completed :: [LmsModuleRes], remaining :: [LmsModuleRes]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LmsGetQuizRes
    = LmsGetQuizRes {questions :: [LmsQuestionRes], selectedModuleInfo :: LmsTranslatedModuleInfoRes}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LmsGetVideosRes
    = LmsGetVideosRes {completed :: [LmsVideoRes], pending :: [LmsVideoRes], quizEnabled :: Kernel.Prelude.Bool, quizStatus :: LmsEntityCompletionStatus, selectedModuleInfo :: LmsTranslatedModuleInfoRes}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LmsModuleRes
    = LmsModuleRes {bonusCoins :: Data.Maybe.Maybe Kernel.Prelude.Int,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LmsQuestionRes
    = LmsQuestionRes {language :: Kernel.External.Types.Language,
                      moduleId :: Kernel.Types.Id.Id Domain.Types.LmsModule.LmsModule,
                      options :: QuizOptions,
...
data LmsQuestionStatus
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LmsQuizHistory
    = LmsQuizHistory {attemptNumber :: Kernel.Prelude.Int, coinsEarned :: Data.Maybe.Maybe Kernel.Prelude.Int, selectedOptions :: [Data.Text.Text], status :: LmsQuestionStatus}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LmsTranslatedModuleInfoRes
    = LmsTranslatedModuleInfoRes {category :: Domain.Types.LmsModule.LmsCategory,
                                  description :: Data.Text.Text,
                                  duration :: Kernel.Prelude.Int,
                                  languagesAvailableForQuiz :: [Kernel.External.Types.Language],
                                  languagesAvailableForVideos :: [Kernel.External.Types.Language],
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LmsVideoRes
    = LmsVideoRes {attemptNumber :: Kernel.Prelude.Int,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data Options
    = Options {options :: [Domain.Types.QuestionInformation.OptionEntity]}
    deriving stock (Generic, Eq, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data QuestionConfirmReq
    = QuestionConfirmReq {language :: Kernel.External.Types.Language,
                          moduleId :: Kernel.Types.Id.Id Domain.Types.LmsModule.LmsModule,
                          questionId :: Kernel.Types.Id.Id Domain.Types.QuestionModuleMapping.QuestionModuleMapping,
                          selectedOption :: SelectedOption}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data QuestionConfirmRes
    = QuestionConfirmRes {bonusEarned :: Data.Maybe.Maybe Kernel.Prelude.Bool,
...
data QuestionValidation
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data QuizOptions
    = SingleSelect Options | MultiSelect Options
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SelectedOption
    = SingleSelectedOption Data.Text.Text | MultiSelectedOption [Data.Text.Text]
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SelectedOptionValidation
    = SingleSelectedOptionValidation ValidationResult | MultiSelectedOptionValidation [ValidationResult]
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ValidationResult
    = ValidationResult {id :: Data.Text.Text, isCorrect :: Kernel.Prelude.Bool}
    deriving stock (Generic, Show, Eq)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VideoUpdateAPIReq
    = VideoUpdateAPIReq {language :: Kernel.External.Types.Language,
                         moduleId :: Kernel.Types.Id.Id Domain.Types.LmsModule.LmsModule,
                         videoId :: Kernel.Types.Id.Id Domain.Types.LmsModuleVideoInformation.LmsModuleVideoInformation}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
