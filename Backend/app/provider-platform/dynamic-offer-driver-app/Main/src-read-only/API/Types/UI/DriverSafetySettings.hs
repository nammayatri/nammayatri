...
data GetDriverSafetySettingsRes
    = GetDriverSafetySettingsRes {aggregatedRideShareSetting :: Kernel.Prelude.Maybe Safety.Domain.Types.Common.RideShareOptions,
...
data UpdateDriverSafetySettingsReq
    = UpdateDriverSafetySettingsReq {aggregatedRideShareSetting :: Kernel.Prelude.Maybe Safety.Domain.Types.Common.RideShareOptions,
