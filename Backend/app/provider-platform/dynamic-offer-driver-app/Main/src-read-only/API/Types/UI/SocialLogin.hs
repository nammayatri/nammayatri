...
data SocialLoginReq
    = SocialLoginReq {email :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SocialLoginRes
    = SocialLoginRes {isNew :: Kernel.Prelude.Bool, token :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SocialUpdateProfileReq
    = SocialUpdateProfileReq {email :: Kernel.Prelude.Text,
