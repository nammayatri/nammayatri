...
instance Text.Show.Show RideBookingUserActionType
    where show = \case
...
instance Text.Read.Read RideBookingUserActionType
    where readsPrec d' = Text.Read.readParen (d' > app_prec) (\r -> [(DRIVER v1, r2) | r1 <- stripPrefix "DRIVER/" r, (v1, r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(DRIVER_REGISTRATION v1,
                                                                                                                                                                              r2) | r1 <- stripPrefix "DRIVER_REGISTRATION/" r, (v1, r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(MAPS v1,
                                                                                                                                                                                                                                                                                        r2) | r1 <- stripPrefix "MAPS/" r,
                                                                                                                                                                                                                                                                                              (v1,
                                                                                                                                                                                                                                                                                               r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(METER_RIDE v1,
                                                                                                                                                                                                                                                                                                                                                  r2) | r1 <- stripPrefix "METER_RIDE/" r,
                                                                                                                                                                                                                                                                                                                                                        (v1,
                                                                                                                                                                                                                                                                                                                                                         r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(RIDE v1,
                                                                                                                                                                                                                                                                                                                                                                                                            r2) | r1 <- stripPrefix "RIDE/" r,
                                                                                                                                                                                                                                                                                                                                                                                                                  (v1,
                                                                                                                                                                                                                                                                                                                                                                                                                   r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(SEARCH_REQUEST v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      r2) | r1 <- stripPrefix "SEARCH_REQUEST/" r,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            (v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                             r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(VOLUNTEER v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                r2) | r1 <- stripPrefix "VOLUNTEER/" r,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (v1,
