...
data AirportCashRechargeRequest
    = AirportCashRechargeRequest {amount :: Kernel.Types.Common.HighPrecMoney, referenceId :: Kernel.Prelude.Text}
...
type GetDriverWalletWalletTransactions = ("wallet" :> Capture "driverId" (Kernel.Types.Id.Id Domain.Types.Person.Driver) :> "transactions" :> QueryParam "fromDate"
                                                                                                                                                         Kernel.Prelude.UTCTime :> QueryParam "toDate" Kernel.Prelude.UTCTime :> Get ('[JSON]) API.Types.UI.DriverWallet.WalletSummaryResponse)
...
type PostDriverWalletWalletTopup = ("wallet" :> Capture "driverId" (Kernel.Types.Id.Id Domain.Types.Person.Driver) :> "topup" :> ReqBody ('[JSON])
                                                                                                                                         API.Types.UI.DriverWallet.TopUpRequest :> Post ('[JSON]) Domain.Action.UI.Plan.PlanSubscribeRes)
type PostDriverWalletWalletAirportCashRecharge = ("wallet" :> Capture "driverId" (Kernel.Types.Id.Id Domain.Types.Person.Driver) :> "airportCashRecharge" :> ReqBody ('[JSON])
                                                                                                                                                                     AirportCashRechargeRequest :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type GetDriverWalletWalletPayoutHistory = ("wallet" :> Capture "driverId" (Kernel.Types.Id.Id Domain.Types.Person.Driver) :> "payoutHistory" :> QueryParam "from"
                                                                                                                                                           Kernel.Prelude.UTCTime :> QueryParam "to" Kernel.Prelude.UTCTime :> QueryParam "status"
...
data DriverWalletAPIs
    = DriverWalletAPIs {getDriverWalletWalletTransactions :: (Kernel.Types.Id.Id Domain.Types.Person.Driver -> Kernel.Prelude.Maybe (Kernel.Prelude.UTCTime) -> Kernel.Prelude.Maybe (Kernel.Prelude.UTCTime) -> EulerHS.Types.EulerClient API.Types.UI.DriverWallet.WalletSummaryResponse),
...
mkDriverWalletAPIs driverWalletClient = (DriverWalletAPIs {..})
                       where getDriverWalletWalletTransactions :<|> postDriverWalletWalletPayout :<|> postDriverWalletWalletTopup :<|> postDriverWalletWalletAirportCashRecharge :<|> getDriverWalletWalletPayoutHistory = driverWalletClient
data DriverWalletUserActionType
    = GET_DRIVER_WALLET_WALLET_TRANSACTIONS | POST_DRIVER_WALLET_WALLET_PAYOUT | POST_DRIVER_WALLET_WALLET_TOPUP | POST_DRIVER_WALLET_WALLET_AIRPORT_CASH_RECHARGE | GET_DRIVER_WALLET_WALLET_PAYOUT_HISTORY
