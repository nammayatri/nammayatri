...
data MarkAsSafeReq
    = MarkAsSafeReq {contacts :: Kernel.Prelude.Maybe [Data.Text.Text], isEndLiveTracking :: Kernel.Prelude.Maybe Kernel.Prelude.Bool, isRideEnded :: Kernel.Prelude.Maybe Kernel.Prelude.Bool}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RideDetailsForDriverRes
    = RideDetailsForDriverRes {driverName :: Data.Text.Text,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SosDetailsRes
    = SosDetailsRes {sos :: Kernel.Prelude.Maybe Safety.Domain.Types.Sos.Sos}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SosReq
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SosRes
    = SosRes {sosId :: Kernel.Types.Id.Id Safety.Domain.Types.Sos.Sos}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
