...
data AadhaarCardReq
    = AadhaarCardReq {aadhaarBackImageId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Domain.Types.Image.Image),
...
data AirConditionedTier
    = AirConditionedTier {isWorking :: Kernel.Prelude.Bool,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data BankAccountLinkResp
    = BankAccountLinkResp {accountLink :: Servant.Client.Core.BaseUrl,
...
data BankAccountResp
    = BankAccountResp {chargesEnabled :: Kernel.Prelude.Bool, detailsSubmitted :: Kernel.Prelude.Bool, paymentMode :: Domain.Types.Extra.MerchantPaymentMethod.PaymentMode}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data CommonDocumentReq
    = CommonDocumentReq {documentData :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DigiLockerInitiateReq
    = DigiLockerInitiateReq {vehicleCategory :: Domain.Types.VehicleCategory.VehicleCategory}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DigiLockerInitiateResp
    = DigiLockerInitiateResp {authorizationUrl :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DocumentVerificationConfigAPIEntity
    = DocumentVerificationConfigAPIEntity {applicableTo :: Domain.Types.DocumentVerificationConfig.DocumentApplicableType,
...
data DocumentVerificationConfigList
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverGstinReq
    = DriverGstinReq {gstNumber :: Kernel.Prelude.Text,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverPanReq
    = DriverPanReq {consent :: Kernel.Prelude.Bool,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverVehicleServiceTier
    = DriverVehicleServiceTier {airConditioned :: Kernel.Prelude.Maybe Kernel.Prelude.Double,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data DriverVehicleServiceTiers
    = DriverVehicleServiceTiers {airConditioned :: Kernel.Prelude.Maybe AirConditionedTier,
...
data FarePolicyHour
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype FleetRCListRes
  = FleetRCListRes {rcs :: [Domain.Action.UI.DriverOnboarding.VehicleRegistrationCertificate.LinkedRC]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype GetLiveSelfieResp
  = GetLiveSelfieResp {image :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data HVSdkCallLogReq
    = HVSdkCallLogReq {callbackResponse :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LinkToFleetReq
    = LinkToFleetReq {fleetOwnerId :: Kernel.Types.Id.Id Domain.Types.Person.Person,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PullDocumentReq
    = PullDocumentReq {docType :: Domain.Types.DocumentVerificationConfig.DocumentType, drivingLicenseNumber :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RateCardItem
    = RateCardItem {price :: Kernel.Types.Common.Money, priceWithCurrency :: Kernel.Types.Common.PriceAPIEntity, title :: Kernel.Prelude.Text}
    deriving stock (Generic, Show)
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RateCardResp
    = RateCardResp {fareParams :: Domain.Types.FareParameters.FareParameters,
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data SSNReq
    = SSNReq {ssn :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TDSCertificateData
    = TDSCertificateData {overallTdsAmount :: Kernel.Types.Common.HighPrecMoney, tdsCertificates :: [TDSInvoiceEntry]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TDSCertificateValidationError
    = TDSCertificateValidationError {errorMessage :: Kernel.Prelude.Text, field :: Kernel.Prelude.Text, invoiceId :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TDSInvoiceEntry
    = TDSInvoiceEntry {assessmentYear :: Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
newtype UpdateAirConditionUpdateRequest
  = UpdateAirConditionUpdateRequest {isAirConditioned :: Kernel.Prelude.Bool}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ValidationStatus
    ...
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VehiclePhotosResp
    = VehiclePhotosResp {back :: [Kernel.Prelude.Text],
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VerifyBankAccReq
    = VerifyBankAccReq {bankAccountNo :: Kernel.Prelude.Text, bankIfscCode :: Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
