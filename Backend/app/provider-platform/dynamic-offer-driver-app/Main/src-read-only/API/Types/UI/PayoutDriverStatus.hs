...
data DriverPayoutStatusEvent = DriverPayoutStatusEvent {message :: Kernel.Prelude.Maybe Data.Text.Text, status :: Lib.Payment.Domain.Types.PayoutStatusHistory.ScheduledPayoutStatus, timestamp :: Kernel.Prelude.UTCTime}
