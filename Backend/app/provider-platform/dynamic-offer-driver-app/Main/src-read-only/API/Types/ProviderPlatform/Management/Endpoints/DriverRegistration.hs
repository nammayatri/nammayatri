...
data DocumentRegisterMetadata
  = DLData RegisterDLReq
  | RCData RegisterRCReq
  | AadhaarData AadhaarCardReq
  | PanData RegisterPanReq
...
instance Kernel.Types.HideSecrets.HideSecrets DocumentRegisterMetadata where
  hideSecrets = Kernel.Prelude.identity

data DocumentRegisterReq = DocumentRegisterReq {metadata :: DocumentRegisterMetadata}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

instance Kernel.Types.HideSecrets.HideSecrets DocumentRegisterReq where
  hideSecrets = Kernel.Prelude.identity
...
data RegisterGstReq = RegisterGstReq {gstin :: Kernel.Prelude.Text, imageId :: Kernel.Types.Id.Id Dashboard.Common.Image}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

instance Kernel.Types.HideSecrets.HideSecrets RegisterGstReq where
  hideSecrets = Kernel.Prelude.identity

data RegisterPanReq = RegisterPanReq
  { panNumber :: Kernel.Prelude.Text,
    imageId1 :: Kernel.Types.Id.Id Dashboard.Common.Image,
    imageId2 :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Dashboard.Common.Image),
    consent :: Kernel.Prelude.Bool,
...
instance Kernel.Types.HideSecrets.HideSecrets RegisterPanReq where
  hideSecrets = Kernel.Prelude.identity
...
data RegisterUdyamReq = RegisterUdyamReq {uamNumber :: Kernel.Prelude.Text, imageId1 :: Kernel.Types.Id.Id Dashboard.Common.Image}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)

instance Kernel.Types.HideSecrets.HideSecrets RegisterUdyamReq where
  hideSecrets = Kernel.Prelude.identity
...
data TempAppCodeRes = TempAppCodeRes {code :: Kernel.Prelude.Text, expiresAt :: Kernel.Prelude.UTCTime}
  deriving stock (Generic)
  deriving anyclass (ToJSON, FromJSON, ToSchema)
...
type PostDriverRegistrationGenerateTempAppCode = (Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "generateTempAppCode" :> Post '[JSON] TempAppCodeRes)

type PostDriverRegistrationGenerateTempAppCodeHelper =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "generateTempAppCode"
      :> MandatoryQueryParam
           "requestorId"
           Kernel.Prelude.Text
...
type PostDriverRegistrationDocumentRegister =
  ( Capture "driverId" (Kernel.Types.Id.Id Dashboard.Common.Driver) :> "document" :> "register"
      :> QueryParam
           "autoApprove"
           Kernel.Prelude.Bool
      :> ReqBody '[JSON] DocumentRegisterReq
...
data DriverRegistrationAPIs = DriverRegistrationAPIs
  { getDriverRegistrationDocumentsList :: Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe DocumentType -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> EulerHS.Types.EulerClient DocumentsListResponse,
    ...
    postDriverRegistrationDocumentRegister :: Kernel.Types.Id.Id Dashboard.Common.Driver -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> DocumentRegisterReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess,
...
data DriverRegistrationUserActionType
  ...
  | POST_DRIVER_REGISTRATION_DOCUMENT_REGISTER
