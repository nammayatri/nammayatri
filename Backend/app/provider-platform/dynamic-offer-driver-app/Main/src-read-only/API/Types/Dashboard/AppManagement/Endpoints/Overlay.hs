...
data CreateOverlayReq
    = CreateOverlayReq {overlayKey :: Kernel.Prelude.Text,
...
instance Kernel.Types.HideSecrets.HideSecrets CreateOverlayReq
    where hideSecrets = Kernel.Prelude.identity
data DeleteOverlayReq
    = DeleteOverlayReq {overlayKey :: Kernel.Prelude.Text, udf1 :: Kernel.Prelude.Maybe Kernel.Prelude.Text, vehicleCategory :: Kernel.Prelude.Maybe Domain.Types.VehicleCategory.VehicleCategory}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets DeleteOverlayReq
    where hideSecrets = Kernel.Prelude.identity
type ListOverlayResp = [OverlayItem]
data OverlayContent
    = OverlayContent {language :: Kernel.External.Types.Language,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets OverlayContent
    where hideSecrets = Kernel.Prelude.identity
type OverlayInfoResp = CreateOverlayReq
data OverlayItem
    = OverlayItem {overlayKey :: Kernel.Prelude.Text,
                   udf1 :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                   actions :: [Kernel.Prelude.Text],
                   link :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                   imageUrl :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets OverlayItem
    where hideSecrets = Kernel.Prelude.identity
data ScheduleOverlay
    = ScheduleOverlay {scheduleTime :: Kernel.Prelude.TimeOfDay,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets ScheduleOverlay
    where hideSecrets = Kernel.Prelude.identity
...
type GetOverlayList = ("listOverlay" :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> Get ('[JSON]) ListOverlayResp)
...
data OverlayAPIs
    = OverlayAPIs {postOverlayCreate :: (CreateOverlayReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess),
                   postOverlayDelete :: (DeleteOverlayReq -> EulerHS.Types.EulerClient Kernel.Types.APISuccess.APISuccess),
                   getOverlayList :: (Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> EulerHS.Types.EulerClient ListOverlayResp),
...
mkOverlayAPIs overlayClient = (OverlayAPIs {..})
                  where postOverlayCreate :<|> postOverlayDelete :<|> getOverlayList :<|> getOverlayInfo :<|> postOverlaySchedule = overlayClient
data OverlayUserActionType
    = POST_OVERLAY_CREATE | POST_OVERLAY_DELETE | GET_OVERLAY_LIST | GET_OVERLAY_INFO | POST_OVERLAY_SCHEDULE
