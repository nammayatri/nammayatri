...
data CollectManualPaymentsReq
    = CollectManualPaymentsReq {paymentIds :: Kernel.Prelude.Maybe [Kernel.Types.Id.Id Domain.Types.DriverFee.DriverFee]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets CollectManualPaymentsReq
    where hideSecrets = Kernel.Prelude.identity
newtype PlanSubscribeReq
  = PlanSubscribeReq {vehicleNumber :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets PlanSubscribeReq
    where hideSecrets = Kernel.Prelude.identity
newtype WaiveOffReq
  = WaiveOffReq {waiveOffEntities :: [Domain.Types.DriverPlan.WaiveOffEntity]}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
instance Kernel.Types.HideSecrets.HideSecrets WaiveOffReq
    where hideSecrets = Kernel.Prelude.identity
...
type PutSubscriptionSelectPlan = (Capture "driverId" (Kernel.Types.Id.Id API.Types.ProviderPlatform.Fleet.Driver.Driver) :> Capture "planId"
                                                                                                                                    (Kernel.Types.Id.Id Domain.Types.Plan.Plan) :> "select" :> Put ('[JSON]) Kernel.Types.APISuccess.APISuccess)
...
type PostSubscriptionSubscribePlan = (Capture "driverId" (Kernel.Types.Id.Id API.Types.ProviderPlatform.Fleet.Driver.Driver) :> Capture "planId"
                                                                                                                                        (Kernel.Types.Id.Id Domain.Types.Plan.Plan) :> "subscribe" :> Post ('[JSON]) Domain.Action.UI.Plan.PlanSubscribeRes)
...
type GetSubscriptionListPlanV2 = (Capture "driverId" (Kernel.Types.Id.Id API.Types.ProviderPlatform.Fleet.Driver.Driver) :> Capture "serviceName"
                                                                                                                                    Domain.Types.Plan.ServiceNames :> "v2" :> "list" :> Get ('[JSON]) Domain.Action.UI.Plan.PlanListAPIRes)
type PutSubscriptionSelectPlanV2 = (Capture "driverId" (Kernel.Types.Id.Id API.Types.ProviderPlatform.Fleet.Driver.Driver) :> Capture "planId"
                                                                                                                                      (Kernel.Types.Id.Id Domain.Types.Plan.Plan) :> Capture "serviceName" Domain.Types.Plan.ServiceNames :> "v2" :> "select" :> Put ('[JSON])
                                                                                                                                                                                                                                                                     Kernel.Types.APISuccess.APISuccess)
type PutSubscriptionSuspendPlanV2 = (Capture "driverId" (Kernel.Types.Id.Id API.Types.ProviderPlatform.Fleet.Driver.Driver) :> Capture "serviceName"
                                                                                                                                       Domain.Types.Plan.ServiceNames :> "v2" :> "suspend" :> Put ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostSubscriptionSubscribePlanV2 = (Capture "driverId" (Kernel.Types.Id.Id API.Types.ProviderPlatform.Fleet.Driver.Driver) :> Capture "planId"
                                                                                                                                          (Kernel.Types.Id.Id Domain.Types.Plan.Plan) :> Capture "serviceName" Domain.Types.Plan.ServiceNames :> "v2" :> "subscribe" :> ReqBody ('[JSON])
                                                                                                                                                                                                                                                                                PlanSubscribeReq :> Post ('[JSON])
                                                                                                                                                                                                                                                                                                         Domain.Action.UI.Plan.PlanSubscribeRes)
type GetSubscriptionCurrentPlanV2 = (Capture "driverId" (Kernel.Types.Id.Id API.Types.ProviderPlatform.Fleet.Driver.Driver) :> Capture "serviceName" Domain.Types.Plan.ServiceNames :> Get ('[JSON])
                                                                                                                                                                                           Domain.Action.UI.Plan.CurrentPlanRes)
type GetSubscriptionOrderStatus = (Capture "driverId" (Kernel.Types.Id.Id API.Types.ProviderPlatform.Fleet.Driver.Driver) :> Capture "orderId"
                                                                                                                                     (Kernel.Types.Id.Id Domain.Types.Invoice.Invoice) :> "status" :> Get ('[JSON]) Domain.Action.UI.Payment.PaymentStatusResp)
type GetSubscriptionDriverPaymentHistoryAPIV2 = (Capture "driverId" (Kernel.Types.Id.Id API.Types.ProviderPlatform.Fleet.Driver.Driver) :> "payments" :> "history" :> "v2" :> Capture "serviceName"
                                                                                                                                                                                      Domain.Types.Plan.ServiceNames :> QueryParam "paymentMode"
                                                                                                                                                                                                                                   Domain.Types.Invoice.InvoicePaymentMode :> QueryParam "limit"
                                                                                                                                                                                                                                                                                         Kernel.Prelude.Int :> QueryParam "offset"
                                                                                                                                                                                                                                                                                                                          Kernel.Prelude.Int :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                    Domain.Action.UI.Driver.HistoryEntityV2)
type GetSubscriptionDriverPaymentHistoryEntityDetailsV2 = (Capture "driverId"
                                                                   (Kernel.Types.Id.Id API.Types.ProviderPlatform.Fleet.Driver.Driver) :> "payments" :> "history" :> "v2" :> Capture "serviceName" Domain.Types.Plan.ServiceNames :> Capture "invoiceId"
                                                                                                                                                                                                                                             (Kernel.Types.Id.Id Domain.Types.Invoice.Invoice) :> "entity" :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                  Domain.Action.UI.Driver.HistoryEntryDetailsEntityV2)
type PostSubscriptionCollectManualPayments = (Capture "driverId" (Kernel.Types.Id.Id API.Types.ProviderPlatform.Fleet.Driver.Driver) :> Capture "serviceName"
                                                                                                                                                Domain.Types.Plan.ServiceNames :> "collect" :> ReqBody ('[JSON]) CollectManualPaymentsReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostSubscriptionFeeWaiveOff = ("waiveOff" :> "fee" :> ReqBody ('[JSON]) WaiveOffReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type GetSubscriptionPurchaseList = (Capture "driverId" (Kernel.Types.Id.Id API.Types.ProviderPlatform.Fleet.Driver.Driver) :> "subscriptionPurchases" :> QueryParam "limit"
                                                                                                                                                                    Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> QueryParam "status"
                                                                                                                                                                                                                                               Domain.Types.SubscriptionPurchase.SubscriptionPurchaseStatus :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                   Domain.Action.UI.Plan.SubscriptionPurchaseListRes)
data SubscriptionAPIs
    = SubscriptionAPIs {getSubscriptionListPlan :: (Kernel.Types.Id.Id API.Types.ProviderPlatform.Fleet.Driver.Driver -> EulerHS.Types.EulerClient Domain.Action.UI.Plan.PlanListAPIRes),
