...
data PayoutAccountStatusReq = PayoutAccountStatusReq
  { accountType :: PayoutAccountType,
    fleetOwnerId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
instance Kernel.Types.HideSecrets.HideSecrets PayoutAccountStatusReq where
  hideSecrets = Kernel.Prelude.identity

data PayoutAccountStatusResp = PayoutAccountStatusResp
  { accountType :: PayoutAccountType,
...
mkPayoutAccountAPIs payoutAccountClient = (PayoutAccountAPIs {..})
  where
    postPayoutAccount :<|> postPayoutAccountStatus = payoutAccountClient

data PayoutAccountUserActionType
  = POST_PAYOUT_ACCOUNT
  | POST_PAYOUT_ACCOUNT_STATUS
