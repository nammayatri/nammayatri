...
instance FromTType' Beam.Plan Domain.Types.Plan.Plan
    where fromTType' (Beam.PlanT {..}) = do {vehicleCategory' <- Storage.Queries.Transformers.Plan.getCategoryFromSubscriptionConfig vehicleCategory merchantOpCityId serviceName;
                                             pure $ Just Domain.Types.Plan.Plan{allowStrikeOff = Kernel.Prelude.fromMaybe True  allowStrikeOff,
                                                                                ...
                                                                                name = name,
                                                                                originalRegistrationAmount = originalRegistrationAmount,
...
instance ToTType' Beam.Plan Domain.Types.Plan.Plan
    where toTType' (Domain.Types.Plan.Plan {..}) = do Beam.PlanT{Beam.allowStrikeOff = Kernel.Prelude.Just allowStrikeOff,
                                                                 ...
                                                                 Beam.name = name,
                                                                 Beam.originalRegistrationAmount = originalRegistrationAmount,
