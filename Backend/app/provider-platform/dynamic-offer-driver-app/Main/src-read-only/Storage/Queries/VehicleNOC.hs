...
findByRcId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
              (Maybe Int -> Maybe Int -> Kernel.Types.Id.Id Domain.Types.VehicleRegistrationCertificate.VehicleRegistrationCertificate -> m ([Domain.Types.VehicleNOC.VehicleNOC]))
...
updateByPrimaryKey (Domain.Types.VehicleNOC.VehicleNOC {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.VehicleNOC Domain.Types.VehicleNOC.VehicleNOC
    where fromTType' (Beam.VehicleNOCT {..}) = do pure $ Just Domain.Types.VehicleNOC.VehicleNOC{documentImageId = Kernel.Types.Id.Id documentImageId,
                                                                                                 ...
                                                                                                 createdAt = createdAt,
                                                                                                 updatedAt = updatedAt}
instance ToTType' Beam.VehicleNOC Domain.Types.VehicleNOC.VehicleNOC
    where toTType' (Domain.Types.VehicleNOC.VehicleNOC {..}) = do Beam.VehicleNOCT{Beam.documentImageId = Kernel.Types.Id.getId documentImageId,
