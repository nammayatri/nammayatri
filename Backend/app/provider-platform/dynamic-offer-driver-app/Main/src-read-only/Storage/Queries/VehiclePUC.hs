...
findByRcId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
              (Maybe Int -> Maybe Int -> Kernel.Types.Id.Id Domain.Types.VehicleRegistrationCertificate.VehicleRegistrationCertificate -> m ([Domain.Types.VehiclePUC.VehiclePUC]))
...
updateByPrimaryKey (Domain.Types.VehiclePUC.VehiclePUC {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.VehiclePUC Domain.Types.VehiclePUC.VehiclePUC
    where fromTType' (Beam.VehiclePUCT {..}) = do pure $ Just Domain.Types.VehiclePUC.VehiclePUC{documentImageId = Kernel.Types.Id.Id documentImageId,
                                                                                                 ...
                                                                                                 createdAt = createdAt,
                                                                                                 updatedAt = updatedAt}
instance ToTType' Beam.VehiclePUC Domain.Types.VehiclePUC.VehiclePUC
    where toTType' (Domain.Types.VehiclePUC.VehiclePUC {..}) = do Beam.VehiclePUCT{Beam.documentImageId = Kernel.Types.Id.getId documentImageId,
