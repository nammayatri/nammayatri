...
findByDriverStatusAndType driverId requestStatus requestType = do
  findOneWithKV
    [ Se.And
...
updateByPrimaryKey (Domain.Types.OperationHubRequests.OperationHubRequests {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.driverId (Kernel.Types.Id.getId driverId),
      ...
      Se.Set Beam.operatorId (Kernel.Types.Id.getId <$> operatorId),
      Se.Set Beam.registrationNoEncrypted (registrationNo & unEncrypted . encrypted),
      Se.Set Beam.registrationNoHash (registrationNo & hash),
      Se.Set Beam.remarks remarks,
      Se.Set Beam.requestStatus requestStatus,
