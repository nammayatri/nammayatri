...
findAllByAreasCityAndVariant ::
  ...
  ([Kernel.Prelude.Maybe Lib.Types.SpecialLocation.Area] -> Kernel.Types.Id.Id Domain.Types.MerchantOperatingCity.MerchantOperatingCity -> Domain.Types.VehicleVariant.VehicleVariant -> m ([Domain.Types.PayoutSplitConfig.PayoutSplitConfig]))
...
findByPrimaryKey ::
  (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
  (Kernel.Prelude.Maybe Lib.Types.SpecialLocation.Area -> Kernel.Types.Id.Id Domain.Types.MerchantOperatingCity.MerchantOperatingCity -> Domain.Types.VehicleVariant.VehicleVariant -> Data.Text.Text -> m (Maybe Domain.Types.PayoutSplitConfig.PayoutSplitConfig))
...
updateByPrimaryKey (Domain.Types.PayoutSplitConfig.PayoutSplitConfig {..}) = do
  _now <- getCurrentTime
  updateWithKV
    [Se.Set Beam.bankDetails bankDetails, Se.Set Beam.vendorSplitAmount vendorSplitAmount, Se.Set Beam.createdAt createdAt, Se.Set Beam.updatedAt _now]
    [ Se.And
        [ Se.Is Beam.area $ Se.Eq area,
          Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
          Se.Is Beam.vehicleVariant $ Se.Eq vehicleVariant,
