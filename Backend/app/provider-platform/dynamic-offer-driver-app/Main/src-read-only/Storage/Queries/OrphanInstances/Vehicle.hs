...
instance FromTType' Beam.Vehicle Domain.Types.Vehicle.Vehicle
    where fromTType' (Beam.VehicleT {..}) = do pure $ Just Domain.Types.Vehicle.Vehicle{airConditioned = airConditioned,
                                                                                        capacity = capacity,
                                                                                        ...
                                                                                        createdAt = createdAt,
                                                                                        updatedAt = updatedAt}
instance ToTType' Beam.Vehicle Domain.Types.Vehicle.Vehicle
    where toTType' (Domain.Types.Vehicle.Vehicle {..}) = do Beam.VehicleT{Beam.airConditioned = airConditioned,
