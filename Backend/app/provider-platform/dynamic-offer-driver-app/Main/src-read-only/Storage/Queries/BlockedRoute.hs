...
findAllBlockedRoutesByMerchantOperatingCity :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByPrimaryKey (Domain.Types.BlockedRoute.BlockedRoute {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.BlockedRoute Domain.Types.BlockedRoute.BlockedRoute
    where fromTType' (Beam.BlockedRouteT {..}) = do pure $ Just Domain.Types.BlockedRoute.BlockedRoute{createdAt = createdAt,
                                                                                                       enabled = enabled,
...
instance ToTType' Beam.BlockedRoute Domain.Types.BlockedRoute.BlockedRoute
    where toTType' (Domain.Types.BlockedRoute.BlockedRoute {..}) = do Beam.BlockedRouteT{Beam.createdAt = createdAt,
