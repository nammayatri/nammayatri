...
findAllByDriverIdAndDocType limit offset driverId docType = do findAllWithOptionsKV [Se.And [Se.Is Beam.driverId $ Se.Eq (Kernel.Types.Id.getId driverId),
                                                                                             Se.Is Beam.docType $ Se.Eq docType]] (Se.Asc Beam.createdAt) limit offset
...
updateByPrimaryKey (Domain.Types.HyperVergeSdkLogs.HyperVergeSdkLogs {..}) = do {_now <- getCurrentTime;
                                                                                 updateWithKV [Se.Set Beam.callbackResponse callbackResponse,
                                                                                               ...
                                                                                               Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.txnId $ Se.Eq txnId]]}



instance FromTType' Beam.HyperVergeSdkLogs Domain.Types.HyperVergeSdkLogs.HyperVergeSdkLogs
    where fromTType' (Beam.HyperVergeSdkLogsT {..}) = do pure $ Just Domain.Types.HyperVergeSdkLogs.HyperVergeSdkLogs{callbackResponse = callbackResponse,
                                                                                                                      createdAt = createdAt,
                                                                                                                      docType = docType,
                                                                                                                      ...
                                                                                                                      txnId = txnId,
                                                                                                                      updatedAt = updatedAt}
instance ToTType' Beam.HyperVergeSdkLogs Domain.Types.HyperVergeSdkLogs.HyperVergeSdkLogs
    where toTType' (Domain.Types.HyperVergeSdkLogs.HyperVergeSdkLogs {..}) = do Beam.HyperVergeSdkLogsT{Beam.callbackResponse = callbackResponse,
