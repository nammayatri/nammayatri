      ...
      Just
        Domain.Types.FleetOwnerInformation.FleetOwnerInformation
          { aadhaarBackImageId = aadhaarBackImageId,
            ...
            companyTaxId = Storage.Queries.Transformers.FleetOwnerInformation.mkEncryptedItem companyTaxIdEncrypted companyTaxIdHash,
  ...
  toTType' (Domain.Types.FleetOwnerInformation.FleetOwnerInformation {..}) = do
    Beam.FleetOwnerInformationT
      { Beam.aadhaarBackImageId = aadhaarBackImageId,
        ...
        Beam.companyStructure = companyStructure,
        Beam.companyTaxIdEncrypted = Storage.Queries.Transformers.FleetOwnerInformation.mkFieldEncrypted companyTaxId,
        Beam.companyTaxIdHash = Storage.Queries.Transformers.FleetOwnerInformation.mkFieldHash companyTaxId,
