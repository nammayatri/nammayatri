...
instance FromTType' Beam.DriverPlan Domain.Types.DriverPlan.DriverPlan
    where fromTType' (Beam.DriverPlanT {..}) = do {isCategoryLevelSubscriptionEnabled' <- Storage.Queries.Transformers.DriverPlan.backfillIsSubscriptionEnabledAtCategory isCategoryLevelSubscriptionEnabled driverId serviceName;
                                                   ...
                                                   pure $ Just Domain.Types.DriverPlan.DriverPlan{autoPayStatus = autoPayStatus,
...
instance ToTType' Beam.DriverPlan Domain.Types.DriverPlan.DriverPlan
    where toTType' (Domain.Types.DriverPlan.DriverPlan {..}) = do Beam.DriverPlanT{Beam.autoPayStatus = autoPayStatus,
