...
instance FromTType' Beam.Invoice Domain.Types.Invoice.Invoice
    where fromTType' (Beam.InvoiceT {..}) = do {merchantOperatingCityId' <- Storage.Queries.Transformers.Invoice.getMerchantOperatingCityId merchantOperatingCityId driverFeeId id;
                                                pure $ Just Domain.Types.Invoice.Invoice{bankErrorCode = bankErrorCode,
                                                                                         ...
                                                                                         updatedAt = updatedAt}}
instance ToTType' Beam.Invoice Domain.Types.Invoice.Invoice
    where toTType' (Domain.Types.Invoice.Invoice {..}) = do Beam.InvoiceT{Beam.bankErrorCode = bankErrorCode,
