...
instance FromTType' Beam.DriverPanCard Domain.Types.DriverPanCard.DriverPanCard
    where fromTType' (Beam.DriverPanCardT {..}) = do pure $ Just Domain.Types.DriverPanCard.DriverPanCard{consent = consent,
                                                                                                          ...
                                                                                                          panAadhaarLinkage = panAadhaarLinkage,
                                                                                                          ...
                                                                                                          createdAt = createdAt,
                                                                                                          updatedAt = updatedAt}
instance ToTType' Beam.DriverPanCard Domain.Types.DriverPanCard.DriverPanCard
    where toTType' (Domain.Types.DriverPanCard.DriverPanCard {..}) = do Beam.DriverPanCardT{Beam.consent = consent,
                                                                                            ...
                                                                                            Beam.panAadhaarLinkage = panAadhaarLinkage,
