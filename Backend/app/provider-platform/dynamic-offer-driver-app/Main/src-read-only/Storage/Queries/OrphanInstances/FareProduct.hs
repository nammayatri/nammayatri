...
instance FromTType' Beam.FareProduct Domain.Types.FareProduct.FareProduct
    where fromTType' (Beam.FareProductT {..}) = do pure $ Just Domain.Types.FareProduct.FareProduct{area = area,
...
instance ToTType' Beam.FareProduct Domain.Types.FareProduct.FareProduct
    where toTType' (Domain.Types.FareProduct.FareProduct {..}) = do Beam.FareProductT{Beam.area = area,
