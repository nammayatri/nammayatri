...
instance FromTType' Beam.DailyStats Domain.Types.DailyStats.DailyStats
    where fromTType' (Beam.DailyStatsT {..}) = do pure $ Just Domain.Types.DailyStats.DailyStats{activatedValidRides = Kernel.Prelude.fromMaybe 0 activatedValidRides,
                                                                                                 ...
                                                                                                 d2dActivatedValidRides = Kernel.Prelude.fromMaybe 0 d2dActivatedValidRides,
                                                                                                 d2dReferralCounts = Kernel.Prelude.fromMaybe 0 d2dReferralCounts,
                                                                                                 d2dReferralEarnings = Kernel.Prelude.fromMaybe 0 d2dReferralEarnings,
                                                                                                 ...
                                                                                                 createdAt = createdAt,
                                                                                                 updatedAt = updatedAt}
instance ToTType' Beam.DailyStats Domain.Types.DailyStats.DailyStats
    where toTType' (Domain.Types.DailyStats.DailyStats {..}) = do Beam.DailyStatsT{Beam.activatedValidRides = Kernel.Prelude.Just activatedValidRides,
                                                                                   ...
                                                                                   Beam.d2dActivatedValidRides = Kernel.Prelude.Just d2dActivatedValidRides,
                                                                                   Beam.d2dReferralCounts = Kernel.Prelude.Just d2dReferralCounts,
                                                                                   Beam.d2dReferralEarnings = Kernel.Prelude.Just d2dReferralEarnings,
