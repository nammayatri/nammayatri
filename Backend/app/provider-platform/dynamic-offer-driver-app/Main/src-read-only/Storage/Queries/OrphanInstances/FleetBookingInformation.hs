...
instance FromTType' Beam.FleetBookingInformation Domain.Types.FleetBookingInformation.FleetBookingInformation
    where fromTType' (Beam.FleetBookingInformationT {..}) = do pure $ Just Domain.Types.FleetBookingInformation.FleetBookingInformation{amount = amount,
                                                                                                                                        ...
                                                                                                                                        vehicleNo = vehicleNo,
                                                                                                                                        visitDate = visitDate}
instance ToTType' Beam.FleetBookingInformation Domain.Types.FleetBookingInformation.FleetBookingInformation
    where toTType' (Domain.Types.FleetBookingInformation.FleetBookingInformation {..}) = do Beam.FleetBookingInformationT{Beam.amount = amount,
