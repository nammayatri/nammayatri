...
findOneFleetBadgeAssociationByFleetOwnerIdAndDriverIdAndBadgeTypeAndIsActive fleetOwnerId driverId badgeType isActive = do findOneWithKV [Se.And [Se.Is Beam.fleetOwnerId $ Se.Eq fleetOwnerId,
...
updateByPrimaryKey (Domain.Types.FleetBadgeAssociation.FleetBadgeAssociation {..}) = do {_now <- getCurrentTime;
