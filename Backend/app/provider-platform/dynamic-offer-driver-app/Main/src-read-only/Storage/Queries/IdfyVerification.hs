...
updateResponse status idfyResponse requestId = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.IdfyVerification.IdfyVerification {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.IdfyVerification Domain.Types.IdfyVerification.IdfyVerification
    where fromTType' (Beam.IdfyVerificationT {..}) = do pure $ Just Domain.Types.IdfyVerification.IdfyVerification{airConditioned = airConditioned,
                                                                                                                   docType = docType,
                                                                                                                   ...
                                                                                                                   createdAt = createdAt,
                                                                                                                   updatedAt = updatedAt}
instance ToTType' Beam.IdfyVerification Domain.Types.IdfyVerification.IdfyVerification
    where toTType' (Domain.Types.IdfyVerification.IdfyVerification {..}) = do Beam.IdfyVerificationT{Beam.airConditioned = airConditioned,
