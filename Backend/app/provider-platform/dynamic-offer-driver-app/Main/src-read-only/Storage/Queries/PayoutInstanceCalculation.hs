...
findByPrimaryKey ::
  ...
  (Data.Text.Text -> Kernel.Types.Id.Id Domain.Types.PayoutInstanceCalculation.PayoutInstanceCalculation -> Data.Text.Text -> m (Maybe Domain.Types.PayoutInstanceCalculation.PayoutInstanceCalculation))
...
updateByPrimaryKey (Domain.Types.PayoutInstanceCalculation.PayoutInstanceCalculation {..}) = do
  ...
  updateWithKV
    ...
    [Se.And [Se.Is Beam.fromVendorId $ Se.Eq fromVendorId, Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id), Se.Is Beam.toVendorId $ Se.Eq toVendorId]]
