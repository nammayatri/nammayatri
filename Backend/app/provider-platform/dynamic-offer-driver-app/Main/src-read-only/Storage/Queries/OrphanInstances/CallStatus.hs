...
instance FromTType' Beam.CallStatus Domain.Types.CallStatus.CallStatus
    where fromTType' (Beam.CallStatusT {..}) = do pure $ Just Domain.Types.CallStatus.CallStatus{aiCallAnalyzed = aiCallAnalyzed,
...
instance ToTType' Beam.CallStatus Domain.Types.CallStatus.CallStatus
    where toTType' (Domain.Types.CallStatus.CallStatus {..}) = do Beam.CallStatusT{Beam.aiCallAnalyzed = aiCallAnalyzed,
