...
updateByPrimaryKey (Domain.Types.BusinessEvent.BusinessEvent {..}) = do updateWithKV [Se.Set Beam.bookingId (Kernel.Types.Id.getId <$> bookingId),
                                                                                      ...
                                                                                      Se.Set Beam.whenPoolWasComputed whenPoolWasComputed] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]
