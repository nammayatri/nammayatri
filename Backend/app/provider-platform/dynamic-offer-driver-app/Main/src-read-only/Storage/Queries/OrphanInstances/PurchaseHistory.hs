...
instance FromTType' Beam.PurchaseHistory Domain.Types.PurchaseHistory.PurchaseHistory
    where fromTType' (Beam.PurchaseHistoryT {..}) = do pure $ Just Domain.Types.PurchaseHistory.PurchaseHistory{cash = cash,
...
instance ToTType' Beam.PurchaseHistory Domain.Types.PurchaseHistory.PurchaseHistory
    where toTType' (Domain.Types.PurchaseHistory.PurchaseHistory {..}) = do Beam.PurchaseHistoryT{Beam.cash = cash,
