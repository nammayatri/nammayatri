...
findAllByMerchantOpCityIdLanguageAndKey :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByMerchantOpCityIdLanguageAndKey merchantOperatingCityId language reelKey = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
updateByPrimaryKey (Domain.Types.ReelsData.ReelsData {..}) = do {_now <- getCurrentTime;
                                                                 updateWithKV [Se.Set Beam.bottomButtonConfig (convertBottomButtonConfigToTable bottomButtonConfig),
...
instance FromTType' Beam.ReelsData Domain.Types.ReelsData.ReelsData
    where fromTType' (Beam.ReelsDataT {..}) = do pure $ Just Domain.Types.ReelsData.ReelsData{bottomButtonConfig = getBottomButtonConfigFromTable bottomButtonConfig,
                                                                                              ...
                                                                                              createdAt = createdAt,
                                                                                              updatedAt = updatedAt}
instance ToTType' Beam.ReelsData Domain.Types.ReelsData.ReelsData
    where toTType' (Domain.Types.ReelsData.ReelsData {..}) = do Beam.ReelsDataT{Beam.bottomButtonConfig = convertBottomButtonConfigToTable bottomButtonConfig,
