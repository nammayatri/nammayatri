...
instance FromTType' Beam.Booking Domain.Types.Booking.Booking
    where fromTType' (Beam.BookingT {..}) = do {mappings <- Storage.Queries.LocationMapping.findByEntityId id;
                                                ...
                                                pure $ Just Domain.Types.Booking.Booking{area = area,
                                                                                         bapCity = bapCity,
                                                                                         ...
                                                                                         exotelDeclinedCallStatusReceivingTime = exotelDeclinedCallStatusReceivingTime,
                                                                                         ...
                                                                                         ledgerWriteMode = ledgerWriteMode,
...
instance ToTType' Beam.Booking Domain.Types.Booking.Booking
    where toTType' (Domain.Types.Booking.Booking {..}) = do Beam.BookingT{Beam.area = area,
                                                                          Beam.bapCity = bapCity,
                                                                          Beam.bapCountry = bapCountry,
                                                                          Beam.bapId = bapId,
                                                                          Beam.bapUri = bapUri,
                                                                          Beam.billingCategory = Just billingCategory,
                                                                          ...
                                                                          Beam.dqDurationToPickup = dqDurationToPickup,
                                                                          ...
                                                                          Beam.ledgerWriteMode = ledgerWriteMode,
