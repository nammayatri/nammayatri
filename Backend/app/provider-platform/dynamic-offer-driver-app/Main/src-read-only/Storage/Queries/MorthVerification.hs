  ...
  findAllWithOptionsKV
    [ Se.And
        [ Se.Is Beam.driverId $ Se.Eq (Kernel.Types.Id.getId driverId),
          ...
          Se.Is Beam.documentNumberHash $ Se.Eq documentNumberHashBeam
        ]
    ]
...
updateByPrimaryKey (Domain.Types.MorthVerification.MorthVerification {..}) = do
  _now <- getCurrentTime
  updateWithKV
...
instance FromTType' Beam.MorthVerification Domain.Types.MorthVerification.MorthVerification where
  fromTType' (Beam.MorthVerificationT {..}) = do
    pure $
      Just
...
instance ToTType' Beam.MorthVerification Domain.Types.MorthVerification.MorthVerification where
