...
findAllByMerchantOpCityIdAndRole :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByMerchantOpCityIdAndRole merchantOperatingCityId role = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
findByPrimaryKey documentType merchantOperatingCityId role = do findOneWithKV [Se.And [Se.Is Beam.documentType $ Se.Eq documentType,
...
updateByPrimaryKey (Domain.Types.FleetOwnerDocumentVerificationConfig.FleetOwnerDocumentVerificationConfig {..}) = do {_now <- getCurrentTime;
                                                                                                                       updateWithKV [Se.Set Beam.checkExpiry checkExpiry,
                                                                                                                                     ...
                                                                                                                                     Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.documentType $ Se.Eq documentType,
                                                                                                                                                                          Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
                                                                                                                                                                          Se.Is Beam.role $ Se.Eq role]]}



instance FromTType' Beam.FleetOwnerDocumentVerificationConfig Domain.Types.FleetOwnerDocumentVerificationConfig.FleetOwnerDocumentVerificationConfig
    where fromTType' (Beam.FleetOwnerDocumentVerificationConfigT {..}) = do pure $ Just Domain.Types.FleetOwnerDocumentVerificationConfig.FleetOwnerDocumentVerificationConfig{checkExpiry = checkExpiry,
                                                                                                                                                                               ...
                                                                                                                                                                               createdAt = createdAt,
                                                                                                                                                                               updatedAt = updatedAt}
instance ToTType' Beam.FleetOwnerDocumentVerificationConfig Domain.Types.FleetOwnerDocumentVerificationConfig.FleetOwnerDocumentVerificationConfig
    where toTType' (Domain.Types.FleetOwnerDocumentVerificationConfig.FleetOwnerDocumentVerificationConfig {..}) = do Beam.FleetOwnerDocumentVerificationConfigT{Beam.checkExpiry = checkExpiry,
