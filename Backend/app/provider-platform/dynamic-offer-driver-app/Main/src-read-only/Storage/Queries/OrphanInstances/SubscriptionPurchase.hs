...
instance FromTType' Beam.SubscriptionPurchase Domain.Types.SubscriptionPurchase.SubscriptionPurchase
    where fromTType' (Beam.SubscriptionPurchaseT {..}) = do pure $ Just Domain.Types.SubscriptionPurchase.SubscriptionPurchase{enableServiceUsageCharge = enableServiceUsageCharge,
                                                                                                                               ...
                                                                                                                               createdAt = createdAt,
                                                                                                                               updatedAt = updatedAt}
instance ToTType' Beam.SubscriptionPurchase Domain.Types.SubscriptionPurchase.SubscriptionPurchase
    where toTType' (Domain.Types.SubscriptionPurchase.SubscriptionPurchase {..}) = do Beam.SubscriptionPurchaseT{Beam.enableServiceUsageCharge = enableServiceUsageCharge,
