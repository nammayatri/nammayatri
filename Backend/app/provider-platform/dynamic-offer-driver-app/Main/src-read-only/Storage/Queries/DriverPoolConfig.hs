...
updateByPrimaryKey (Domain.Types.DriverPoolConfig.DriverPoolConfig {..}) = do {_now <- getCurrentTime;
                                                                               updateWithKV [Se.Set Beam.actualDistanceThreshold actualDistanceThreshold,
...
instance FromTType' Beam.DriverPoolConfig Domain.Types.DriverPoolConfig.DriverPoolConfig
    where fromTType' (Beam.DriverPoolConfigT {..}) = do pure $ Just Domain.Types.DriverPoolConfig.DriverPoolConfig{actualDistanceThreshold = actualDistanceThreshold,
...
instance ToTType' Beam.DriverPoolConfig Domain.Types.DriverPoolConfig.DriverPoolConfig
    where toTType' (Domain.Types.DriverPoolConfig.DriverPoolConfig {..}) = do Beam.DriverPoolConfigT{Beam.actualDistanceThreshold = actualDistanceThreshold,
