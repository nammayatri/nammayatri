...
updateByPrimaryKey (Domain.Types.DriverPoolConfig.DriverPoolConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.actualDistanceThreshold actualDistanceThreshold,
      ...
      Se.Set Beam.enableEarlyBatchAdvanceOnFullReject enableEarlyBatchAdvanceOnFullReject,
      Se.Set Beam.enableForwardAutoAssign enableForwardAutoAssign,
      ...
      Se.Set Beam.softMaxParallelSearchRequests softMaxParallelSearchRequests,
      ...
      Just
        Domain.Types.DriverPoolConfig.DriverPoolConfig
          { actualDistanceThreshold = actualDistanceThreshold,
            ...
            enableEarlyBatchAdvanceOnFullReject = enableEarlyBatchAdvanceOnFullReject,
            enableForwardAutoAssign = enableForwardAutoAssign,
            ...
            softMaxParallelSearchRequests = softMaxParallelSearchRequests,
  ...
  toTType' (Domain.Types.DriverPoolConfig.DriverPoolConfig {..}) = do
    Beam.DriverPoolConfigT
      { Beam.actualDistanceThreshold = actualDistanceThreshold,
        ...
        Beam.enableEarlyBatchAdvanceOnFullReject = enableEarlyBatchAdvanceOnFullReject,
        Beam.enableForwardAutoAssign = enableForwardAutoAssign,
        ...
        Beam.softMaxParallelSearchRequests = softMaxParallelSearchRequests,
