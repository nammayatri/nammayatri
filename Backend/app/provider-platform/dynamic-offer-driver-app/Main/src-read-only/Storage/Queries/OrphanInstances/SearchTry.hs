...
instance FromTType' Beam.SearchTry Domain.Types.SearchTry.SearchTry
    where fromTType' (Beam.SearchTryT {..}) = do {merchantOperatingCityId' <- Storage.Queries.Transformers.SearchRequestForDriver.getMerchantOpCId merchantOperatingCityId merchantId requestId;
                                                  pure $ Just Domain.Types.SearchTry.SearchTry{baseFare = Kernel.Types.Common.mkAmountWithDefault baseFareAmount baseFare,
...
instance ToTType' Beam.SearchTry Domain.Types.SearchTry.SearchTry
    where toTType' (Domain.Types.SearchTry.SearchTry {..}) = do Beam.SearchTryT{Beam.baseFare = Kernel.Prelude.roundToIntegral baseFare,
