...
updateVerificationStatusByImageId verificationStatus documentImageId = do {_now <- getCurrentTime;
...
updateVerificationStatusByRcId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateVerificationStatusByRcId verificationStatus rcId = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.VehiclePermit.VehiclePermit {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.VehiclePermit Domain.Types.VehiclePermit.VehiclePermit
    where fromTType' (Beam.VehiclePermitT {..}) = do pure $ Just Domain.Types.VehiclePermit.VehiclePermit{documentImageId = Kernel.Types.Id.Id documentImageId,
                                                                                                          ...
                                                                                                          createdAt = createdAt,
                                                                                                          updatedAt = updatedAt}
instance ToTType' Beam.VehiclePermit Domain.Types.VehiclePermit.VehiclePermit
    where toTType' (Domain.Types.VehiclePermit.VehiclePermit {..}) = do Beam.VehiclePermitT{Beam.documentImageId = Kernel.Types.Id.getId documentImageId,
