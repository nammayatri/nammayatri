...
instance FromTType' Beam.MerchantServiceConfig Domain.Types.MerchantServiceConfig.MerchantServiceConfig
    where fromTType' (Beam.MerchantServiceConfigT {..}) = do {serviceConfig' <- Storage.Queries.Transformers.MerchantServiceConfig.mkServiceConfig configJSON serviceName;
