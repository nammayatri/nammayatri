...
instance FromTType' Beam.RiderDetails Domain.Types.RiderDetails.RiderDetails
    where fromTType' (Beam.RiderDetailsT {..}) = do pure $ Just Domain.Types.RiderDetails.RiderDetails{bapId = bapId,
...
instance ToTType' Beam.RiderDetails Domain.Types.RiderDetails.RiderDetails
    where toTType' (Domain.Types.RiderDetails.RiderDetails {..}) = do Beam.RiderDetailsT{Beam.bapId = bapId,
