      ...
      Just
        Domain.Types.RiderDetails.RiderDetails
          { bapId = bapId,
            ...
            consentToShareMobileNumber = fromMaybe False consentToShareMobileNumber,
            createdAt = createdAt,
            ...
            riderFlaggedForDriverIncentives = fromMaybe False riderFlaggedForDriverIncentives,
  ...
  toTType' (Domain.Types.RiderDetails.RiderDetails {..}) = do
    Beam.RiderDetailsT
      { Beam.bapId = bapId,
        ...
        Beam.consentToShareMobileNumber = Kernel.Prelude.Just consentToShareMobileNumber,
        ...
        Beam.riderFlaggedForDriverIncentives = Kernel.Prelude.Just riderFlaggedForDriverIncentives,
