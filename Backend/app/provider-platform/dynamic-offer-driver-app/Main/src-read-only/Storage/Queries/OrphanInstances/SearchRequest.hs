...
instance FromTType' Beam.SearchRequest Domain.Types.SearchRequest.SearchRequest
    where fromTType' (Beam.SearchRequestT {..}) = do {now <- Kernel.Types.Common.getCurrentTime;
                                                      ...
                                                      pure $ Just Domain.Types.SearchRequest.SearchRequest{area = area,
...
instance ToTType' Beam.SearchRequest Domain.Types.SearchRequest.SearchRequest
    where toTType' (Domain.Types.SearchRequest.SearchRequest {..}) = do Beam.SearchRequestT{Beam.area = area,
