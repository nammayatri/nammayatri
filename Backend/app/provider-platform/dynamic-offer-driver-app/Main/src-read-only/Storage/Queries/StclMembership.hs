...
updateStatusAndPaymentStatus :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateStatusAndPaymentStatus status paymentStatus id = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.StclMembership.StclMembership {..}) = do {_now <- getCurrentTime;
                                                                           updateWithKV [Se.Set Beam.accountNumberEncrypted (((unEncrypted . (.encrypted) $ accountNumber))),
                                                                                         ...
                                                                                         Se.Set Beam.applicationCount applicationCount,
