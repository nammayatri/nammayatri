...
instance FromTType' Beam.DriverBankAccount Domain.Types.DriverBankAccount.DriverBankAccount
    where fromTType' (Beam.DriverBankAccountT {..}) = do {currentAccountLink' <- Kernel.Prelude.mapM parseBaseUrl currentAccountLink;
                                                          pure $ Just Domain.Types.DriverBankAccount.DriverBankAccount{accountId = accountId,
                                                                                                                       ...
                                                                                                                       createdAt = createdAt,
                                                                                                                       updatedAt = updatedAt}}
instance ToTType' Beam.DriverBankAccount Domain.Types.DriverBankAccount.DriverBankAccount
    where toTType' (Domain.Types.DriverBankAccount.DriverBankAccount {..}) = do Beam.DriverBankAccountT{Beam.accountId = accountId,
