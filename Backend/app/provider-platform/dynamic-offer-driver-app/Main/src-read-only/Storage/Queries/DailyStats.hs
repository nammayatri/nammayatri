...
updateD2dReferralCount d2dReferralCounts driverId merchantLocalDate = do
  _now <- getCurrentTime
  updateOneWithKV
    [Se.Set Beam.d2dReferralCounts (Kernel.Prelude.Just d2dReferralCounts), Se.Set Beam.updatedAt _now]
    [ Se.And
