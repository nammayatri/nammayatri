...
updateByPrimaryKey (Domain.Types.FleetConfig.FleetConfig {..}) = do {_now <- getCurrentTime;
                                                                     updateWithKV [Se.Set Beam.allowAutomaticRoundTripAssignment allowAutomaticRoundTripAssignment,
                                                                                   ...
                                                                                   Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.fleetOwnerId $ Se.Eq (Kernel.Types.Id.getId fleetOwnerId)]]}



instance FromTType' Beam.FleetConfig Domain.Types.FleetConfig.FleetConfig
    where fromTType' (Beam.FleetConfigT {..}) = do pure $ Just Domain.Types.FleetConfig.FleetConfig{allowAutomaticRoundTripAssignment = allowAutomaticRoundTripAssignment,
                                                                                                    ...
                                                                                                    createdAt = createdAt,
                                                                                                    updatedAt = updatedAt}
instance ToTType' Beam.FleetConfig Domain.Types.FleetConfig.FleetConfig
    where toTType' (Domain.Types.FleetConfig.FleetConfig {..}) = do Beam.FleetConfigT{Beam.allowAutomaticRoundTripAssignment = allowAutomaticRoundTripAssignment,
