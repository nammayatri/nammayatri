...
instance FromTType' Beam.DigilockerVerification Domain.Types.DigilockerVerification.DigilockerVerification
    where fromTType' (Beam.DigilockerVerificationT {..}) = do pure $ Just Domain.Types.DigilockerVerification.DigilockerVerification{accessToken = Encrypted <$> accessToken,
...
instance ToTType' Beam.DigilockerVerification Domain.Types.DigilockerVerification.DigilockerVerification
    where toTType' (Domain.Types.DigilockerVerification.DigilockerVerification {..}) = do Beam.DigilockerVerificationT{Beam.accessToken = accessToken <&> unEncrypted,
