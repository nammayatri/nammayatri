...
updateByPrimaryKey (Domain.Types.QuestionModuleMapping.QuestionModuleMapping {..}) = do {_now <- getCurrentTime;
                                                                                         updateWithKV [Se.Set Beam.quizCoinFunction quizCoinFunction, Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.moduleId $ Se.Eq (Kernel.Types.Id.getId moduleId),
                                                                                                                                                                                           Se.Is Beam.questionId $ Se.Eq (Kernel.Types.Id.getId questionId)]]}



instance FromTType' Beam.QuestionModuleMapping Domain.Types.QuestionModuleMapping.QuestionModuleMapping
    where fromTType' (Beam.QuestionModuleMappingT {..}) = do pure $ Just Domain.Types.QuestionModuleMapping.QuestionModuleMapping{moduleId = Kernel.Types.Id.Id moduleId,
                                                                                                                                  questionId = Kernel.Types.Id.Id questionId,
                                                                                                                                  quizCoinFunction = quizCoinFunction,
                                                                                                                                  createdAt = createdAt,
                                                                                                                                  updatedAt = updatedAt}
instance ToTType' Beam.QuestionModuleMapping Domain.Types.QuestionModuleMapping.QuestionModuleMapping
    where toTType' (Domain.Types.QuestionModuleMapping.QuestionModuleMapping {..}) = do Beam.QuestionModuleMappingT{Beam.moduleId = Kernel.Types.Id.getId moduleId,
