...
findByMerchantOpCityIdAndIsPayoutEnabled :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMerchantOpCityIdAndIsPayoutEnabled merchantOperatingCityId isPayoutEnabled = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
findByPrimaryKey merchantOperatingCityId vehicleCategory = do findOneWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
updateByPrimaryKey (Domain.Types.PayoutConfig.PayoutConfig {..}) = do {_now <- getCurrentTime;
                                                                       updateWithKV [Se.Set Beam.batchLimit batchLimit,
                                                                                     ...
                                                                                     Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId), Se.Is Beam.vehicleCategory $ Se.Eq vehicleCategory]]}
