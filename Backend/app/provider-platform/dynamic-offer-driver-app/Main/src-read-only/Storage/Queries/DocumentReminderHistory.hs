...
findAllByDocumentTypeAndEntity :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByDocumentTypeAndEntity documentType entityId entityType = do findAllWithKV [Se.And [Se.Is Beam.documentType $ Se.Eq documentType,
                                                                                            Se.Is Beam.entityId $ Se.Eq entityId,
                                                                                            Se.Is Beam.entityType $ Se.Eq entityType]]
findAllByDocumentTypeAndEntityType :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByDocumentTypeAndEntity :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByDocumentTypeAndEntity documentType entityId entityType = do findOneWithKV [Se.And [Se.Is Beam.documentType $ Se.Eq documentType,
                                                                                         Se.Is Beam.entityId $ Se.Eq entityId,
                                                                                         Se.Is Beam.entityType $ Se.Eq entityType]]
...
updateByPrimaryKey (Domain.Types.DocumentReminderHistory.DocumentReminderHistory {..}) = do {_now <- getCurrentTime;
                                                                                             updateWithKV [Se.Set Beam.completionDate completionDate,
...
instance FromTType' Beam.DocumentReminderHistory Domain.Types.DocumentReminderHistory.DocumentReminderHistory
    where fromTType' (Beam.DocumentReminderHistoryT {..}) = do pure $ Just Domain.Types.DocumentReminderHistory.DocumentReminderHistory{completionDate = completionDate,
                                                                                                                                        ...
                                                                                                                                        updatedAt = updatedAt,
                                                                                                                                        createdAt = createdAt}
instance ToTType' Beam.DocumentReminderHistory Domain.Types.DocumentReminderHistory.DocumentReminderHistory
    where toTType' (Domain.Types.DocumentReminderHistory.DocumentReminderHistory {..}) = do Beam.DocumentReminderHistoryT{Beam.completionDate = completionDate,
