...
updateByPrimaryKey (Domain.Types.BapMetadata.BapMetadata {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.BapMetadata Domain.Types.BapMetadata.BapMetadata
    where fromTType' (Beam.BapMetadataT {..}) = do {logoUrl' <- ((Kernel.Prelude.maybe (return Kernel.Prelude.Nothing) (Kernel.Prelude.fmap Kernel.Prelude.Just . parseBaseUrl))) logoUrl;
...
instance ToTType' Beam.BapMetadata Domain.Types.BapMetadata.BapMetadata
    where toTType' (Domain.Types.BapMetadata.BapMetadata {..}) = do Beam.BapMetadataT{Beam.domain = domain,
