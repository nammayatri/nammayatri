...
instance FromTType' Beam.MessageReport Domain.Types.MessageReport.MessageReport
    where fromTType' (Beam.MessageReportT {..}) = do pure $ Just Domain.Types.MessageReport.MessageReport{createdAt = Data.Time.localTimeToUTC Data.Time.utc createdAt,
...
instance ToTType' Beam.MessageReport Domain.Types.MessageReport.MessageReport
    where toTType' (Domain.Types.MessageReport.MessageReport {..}) = do Beam.MessageReportT{Beam.createdAt = Data.Time.utcToLocalTime Data.Time.utc createdAt,
