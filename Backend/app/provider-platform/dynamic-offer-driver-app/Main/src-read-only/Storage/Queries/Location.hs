...
updateInstructionsAndExtrasById :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateInstructionsAndExtrasById instructionsBeam extrasBeam id = do {_now <- getCurrentTime;
