...
findByRideId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByPrimaryKey (Domain.Types.BookingCancellationReason.BookingCancellationReason {..}) = do updateWithKV [Se.Set Beam.additionalInfo additionalInfo,
                                                                                                              ...
                                                                                                              Se.Set Beam.source source] [Se.And [Se.Is Beam.bookingId $ Se.Eq (Kernel.Types.Id.getId bookingId)]]
