...
findByMerchantOpCityIdAndDocumentType :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMerchantOpCityIdAndDocumentType merchantOperatingCityId documentType = do findOneWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
                                                                                                       Se.Is Beam.documentType $ Se.Eq documentType]]



instance FromTType' Beam.ReminderConfig Domain.Types.ReminderConfig.ReminderConfig
    where fromTType' (Beam.ReminderConfigT {..}) = do pure $ Just Domain.Types.ReminderConfig.ReminderConfig{createdAt = createdAt,
                                                                                                             ...
                                                                                                             updatedAt = updatedAt}
instance ToTType' Beam.ReminderConfig Domain.Types.ReminderConfig.ReminderConfig
    where toTType' (Domain.Types.ReminderConfig.ReminderConfig {..}) = do Beam.ReminderConfigT{Beam.createdAt = createdAt,
