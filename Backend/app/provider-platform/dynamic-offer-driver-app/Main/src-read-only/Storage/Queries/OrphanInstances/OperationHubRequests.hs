      ...
      Just
        Domain.Types.OperationHubRequests.OperationHubRequests
          { driverId = Kernel.Types.Id.Id driverId,
            ...
            registrationNo = EncryptedHashed (Encrypted registrationNoEncrypted) registrationNoHash,
            remarks = remarks,
  ...
  toTType' (Domain.Types.OperationHubRequests.OperationHubRequests {..}) = do
    Beam.OperationHubRequestsT
      { Beam.driverId = Kernel.Types.Id.getId driverId,
        ...
        Beam.registrationNoEncrypted = registrationNo & unEncrypted . encrypted,
        Beam.registrationNoHash = registrationNo & hash,
