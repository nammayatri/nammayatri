...
instance FromTType' Beam.OperationHubRequests Domain.Types.OperationHubRequests.OperationHubRequests
    where fromTType' (Beam.OperationHubRequestsT {..}) = do pure $ Just Domain.Types.OperationHubRequests.OperationHubRequests{creatorId = Kernel.Types.Id.Id creatorId,
                                                                                                                               ...
                                                                                                                               createdAt = createdAt,
                                                                                                                               updatedAt = updatedAt}
instance ToTType' Beam.OperationHubRequests Domain.Types.OperationHubRequests.OperationHubRequests
    where toTType' (Domain.Types.OperationHubRequests.OperationHubRequests {..}) = do Beam.OperationHubRequestsT{Beam.creatorId = Kernel.Types.Id.getId creatorId,
