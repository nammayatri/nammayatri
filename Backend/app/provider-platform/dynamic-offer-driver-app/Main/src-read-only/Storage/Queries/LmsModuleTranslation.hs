...
getByModuleIdAndLanguage :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByPrimaryKey (Domain.Types.LmsModuleTranslation.LmsModuleTranslation {..}) = do {_now <- getCurrentTime;
                                                                                       updateWithKV [Se.Set Beam.description description,
                                                                                                     Se.Set Beam.name name,
                                                                                                     Se.Set Beam.thumbnailImage thumbnailImage,
                                                                                                     Se.Set Beam.merchantId (Kernel.Types.Id.getId <$> merchantId),
                                                                                                     Se.Set Beam.merchantOperatingCityId (Kernel.Types.Id.getId <$> merchantOperatingCityId),
                                                                                                     Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.language $ Se.Eq language, Se.Is Beam.moduleId $ Se.Eq (Kernel.Types.Id.getId moduleId)]]}



instance FromTType' Beam.LmsModuleTranslation Domain.Types.LmsModuleTranslation.LmsModuleTranslation
    where fromTType' (Beam.LmsModuleTranslationT {..}) = do pure $ Just Domain.Types.LmsModuleTranslation.LmsModuleTranslation{description = description,
                                                                                                                               language = language,
                                                                                                                               ...
                                                                                                                               createdAt = createdAt,
                                                                                                                               updatedAt = updatedAt}
instance ToTType' Beam.LmsModuleTranslation Domain.Types.LmsModuleTranslation.LmsModuleTranslation
    where toTType' (Domain.Types.LmsModuleTranslation.LmsModuleTranslation {..}) = do Beam.LmsModuleTranslationT{Beam.description = description,
