...
instance FromTType' Beam.VehicleInsurance Domain.Types.VehicleInsurance.VehicleInsurance
    where fromTType' (Beam.VehicleInsuranceT {..}) = do pure $ Just Domain.Types.VehicleInsurance.VehicleInsurance{documentImageId = Kernel.Types.Id.Id documentImageId,
                                                                                                                   ...
                                                                                                                   createdAt = createdAt,
                                                                                                                   updatedAt = updatedAt}
instance ToTType' Beam.VehicleInsurance Domain.Types.VehicleInsurance.VehicleInsurance
    where toTType' (Domain.Types.VehicleInsurance.VehicleInsurance {..}) = do Beam.VehicleInsuranceT{Beam.documentImageId = Kernel.Types.Id.getId documentImageId,
