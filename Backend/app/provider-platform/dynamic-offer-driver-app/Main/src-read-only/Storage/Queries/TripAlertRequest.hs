...
findByPrimaryKey ::
  ...
  (Kernel.Types.Id.Id Domain.Types.AlertRequest.AlertRequest -> Kernel.Types.Id.Id Domain.Types.TripAlertRequest.TripAlertRequest -> m (Maybe Domain.Types.TripAlertRequest.TripAlertRequest))
findByPrimaryKey alertRequestId id = do findOneWithKV [Se.And [Se.Is Beam.alertRequestId $ Se.Eq (Kernel.Types.Id.getId alertRequestId), Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]
...
updateByPrimaryKey (Domain.Types.TripAlertRequest.TripAlertRequest {..}) = do
  ...
  updateWithKV
    ...
    [Se.And [Se.Is Beam.alertRequestId $ Se.Eq (Kernel.Types.Id.getId alertRequestId), Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]
