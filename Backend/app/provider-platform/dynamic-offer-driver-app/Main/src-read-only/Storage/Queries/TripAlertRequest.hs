...
updateByPrimaryKey (Domain.Types.TripAlertRequest.TripAlertRequest {..}) = do {_now <- getCurrentTime;
                                                                               updateWithKV [Se.Set Beam.alertRequestId (Kernel.Types.Id.getId alertRequestId),
