...
findByDriverId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByDriverIdAndDocumentType :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByImageId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateRejectReason rejectReason verificationStatus = do {_now <- getCurrentTime;
...
updateVerificationStatus verificationStatus id = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.CommonDriverOnboardingDocuments.CommonDriverOnboardingDocuments {..}) = do {_now <- getCurrentTime;
                                                                                                             updateWithKV [Se.Set Beam.documentData documentData,
...
instance FromTType' Beam.CommonDriverOnboardingDocuments Domain.Types.CommonDriverOnboardingDocuments.CommonDriverOnboardingDocuments
    where fromTType' (Beam.CommonDriverOnboardingDocumentsT {..}) = do pure $ Just Domain.Types.CommonDriverOnboardingDocuments.CommonDriverOnboardingDocuments{documentData = documentData,
                                                                                                                                                                ...
                                                                                                                                                                createdAt = createdAt,
                                                                                                                                                                updatedAt = updatedAt}
instance ToTType' Beam.CommonDriverOnboardingDocuments Domain.Types.CommonDriverOnboardingDocuments.CommonDriverOnboardingDocuments
    where toTType' (Domain.Types.CommonDriverOnboardingDocuments.CommonDriverOnboardingDocuments {..}) = do Beam.CommonDriverOnboardingDocumentsT{Beam.documentData = documentData,
