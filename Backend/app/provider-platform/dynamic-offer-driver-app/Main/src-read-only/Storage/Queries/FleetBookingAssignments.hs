...
findAllByMainAssignmentId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateAssignmentTiming :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateAssignmentTiming assignmentStartTime assignmentEndTime skuDurationMins id = do {_now <- getCurrentTime;
                                                                                      updateOneWithKV [Se.Set Beam.assignmentStartTime assignmentStartTime,
...
updateByPrimaryKey (Domain.Types.FleetBookingAssignments.FleetBookingAssignments {..}) = do {_now <- getCurrentTime;
