...
findAllByBookingId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByBookingIdAndStatus :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateMultipleById :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateMultipleById travelledDistance estimatedFare totalDistance currentPointLat currentPointLon id = do {_now <- getCurrentTime;
                                                                                                          updateOneWithKV [Se.Set Beam.travelledDistance travelledDistance,
...
updateStatusByBAPBookingUpdateRequestId status bapBookingUpdateRequestId = do {_now <- getCurrentTime;
...
updateTravelledDistanceById :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateTravelledDistanceById travelledDistance id = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.BookingUpdateRequest.BookingUpdateRequest {..}) = do {_now <- getCurrentTime;
                                                                                       updateWithKV [Se.Set Beam.bapBookingUpdateRequestId bapBookingUpdateRequestId,
                                                                                                     ...
                                                                                                     Se.Set Beam.validTill validTill] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]}



instance FromTType' Beam.BookingUpdateRequest Domain.Types.BookingUpdateRequest.BookingUpdateRequest
    where fromTType' (Beam.BookingUpdateRequestT {..}) = do pure $ Just Domain.Types.BookingUpdateRequest.BookingUpdateRequest{bapBookingUpdateRequestId = bapBookingUpdateRequestId,
                                                                                                                               ...
                                                                                                                               updatedAt = updatedAt,
                                                                                                                               validTill = validTill}
instance ToTType' Beam.BookingUpdateRequest Domain.Types.BookingUpdateRequest.BookingUpdateRequest
    where toTType' (Domain.Types.BookingUpdateRequest.BookingUpdateRequest {..}) = do Beam.BookingUpdateRequestT{Beam.bapBookingUpdateRequestId = bapBookingUpdateRequestId,
