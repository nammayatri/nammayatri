...
instance FromTType' Beam.RegistrationToken Domain.Types.RegistrationToken.RegistrationToken
    where fromTType' (Beam.RegistrationTokenT {..}) = do {merchantOperatingCityId' <- Storage.Queries.Transformers.RegistrationToken.getMerchantOperatingCityId merchantOperatingCityId merchantId;
                                                          pure $ Just Domain.Types.RegistrationToken.RegistrationToken{alternateNumberAttempts = alternateNumberAttempts,
                                                                                                                       attempts = attempts,
...
instance ToTType' Beam.RegistrationToken Domain.Types.RegistrationToken.RegistrationToken
    where toTType' (Domain.Types.RegistrationToken.RegistrationToken {..}) = do Beam.RegistrationTokenT{Beam.alternateNumberAttempts = alternateNumberAttempts,
