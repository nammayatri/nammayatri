...
findByIdAndVendorId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) => (Kernel.Types.Id.Id Domain.Types.Volunteer.Volunteer -> Data.Text.Text -> m (Maybe Domain.Types.Volunteer.Volunteer))
...
findByPrimaryKey :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) => (Kernel.Types.Id.Id Domain.Types.Volunteer.Volunteer -> Data.Text.Text -> m (Maybe Domain.Types.Volunteer.Volunteer))
findByPrimaryKey id vendorId = do findOneWithKV [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id), Se.Is Beam.vendorId $ Se.Eq vendorId]]
...
updateByPrimaryKey (Domain.Types.Volunteer.Volunteer {..}) = do
  ...
  updateWithKV
    ...
    [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id), Se.Is Beam.vendorId $ Se.Eq vendorId]]
