...
updateByPrimaryKey (Domain.Types.Volunteer.Volunteer {..}) = do {_now <- getCurrentTime;
                                                                 updateWithKV [Se.Set Beam.isActive ((Kernel.Prelude.Just . Kernel.Prelude.fromMaybe True) isActive),
