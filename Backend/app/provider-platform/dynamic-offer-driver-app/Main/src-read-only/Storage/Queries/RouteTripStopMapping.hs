...
findAllByRouteCodeForStops :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
                              (Kernel.Prelude.Text -> Kernel.Prelude.Int -> Data.Time.DayOfWeek -> m ([Domain.Types.RouteTripStopMapping.RouteTripStopMapping]))
findAllByRouteCodeForStops routeCode tripSequenceNum scheduledDay = do findAllWithKV [Se.And [Se.Is Beam.routeCode $ Se.Eq routeCode,
                                                                                              Se.Is Beam.tripSequenceNum $ Se.Eq tripSequenceNum,
                                                                                              Se.Is Beam.scheduledDay $ Se.Eq scheduledDay]]
findAllByStopCodeAndStopSequenceAndRoutes :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByStopCodeAndStopSequenceAndRoutes stopCode stopSequenceNum tripSequenceNum scheduledDay routeCode = do findAllWithKV [Se.And [Se.Is Beam.stopCode $ Se.Eq stopCode,
...
findByPrimaryKey routeCode scheduledDay stopCode tripCode tripSequenceNum = do findOneWithKV [Se.And [Se.Is Beam.routeCode $ Se.Eq routeCode,
                                                                                                      Se.Is Beam.scheduledDay $ Se.Eq scheduledDay,
...
updateByPrimaryKey (Domain.Types.RouteTripStopMapping.RouteTripStopMapping {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.RouteTripStopMapping Domain.Types.RouteTripStopMapping.RouteTripStopMapping
    where fromTType' (Beam.RouteTripStopMappingT {..}) = do pure $ Just Domain.Types.RouteTripStopMapping.RouteTripStopMapping{enabled = enabled,
                                                                                                                               ...
                                                                                                                               createdAt = createdAt,
                                                                                                                               updatedAt = updatedAt}
instance ToTType' Beam.RouteTripStopMapping Domain.Types.RouteTripStopMapping.RouteTripStopMapping
    where toTType' (Domain.Types.RouteTripStopMapping.RouteTripStopMapping {..}) = do Beam.RouteTripStopMappingT{Beam.enabled = enabled,
