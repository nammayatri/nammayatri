...
updateFleetMemberActiveStatus enabled fleetMemberId fleetOwnerId = do {_now <- getCurrentTime;
...
updateFleetMembersActiveStatus enabled fleetMemberId fleetOwnerId = do {_now <- getCurrentTime;
...
updateFleetMembersActiveStatusByGroupCode enabled fleetMemberId groupCode = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.FleetMemberAssociation.FleetMemberAssociation {..}) = do {_now <- getCurrentTime;
                                                                                           updateWithKV [Se.Set Beam.enabled enabled,
                                                                                                         ...
                                                                                                         Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.fleetMemberId $ Se.Eq fleetMemberId, Se.Is Beam.fleetOwnerId $ Se.Eq fleetOwnerId]]}
