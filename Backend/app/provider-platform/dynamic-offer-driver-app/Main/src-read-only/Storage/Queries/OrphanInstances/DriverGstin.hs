...
instance FromTType' Beam.DriverGstin Domain.Types.DriverGstin.DriverGstin
    where fromTType' (Beam.DriverGstinT {..}) = do pure $ Just Domain.Types.DriverGstin.DriverGstin{address = address,
                                                                                                    ...
                                                                                                    createdAt = createdAt,
                                                                                                    updatedAt = updatedAt}
instance ToTType' Beam.DriverGstin Domain.Types.DriverGstin.DriverGstin
    where toTType' (Domain.Types.DriverGstin.DriverGstin {..}) = do Beam.DriverGstinT{Beam.address = address,
