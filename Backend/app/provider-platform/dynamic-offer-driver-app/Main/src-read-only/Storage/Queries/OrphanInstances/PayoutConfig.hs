      ...
      Just
        Domain.Types.PayoutConfig.PayoutConfig
          { batchLimit = batchLimit,
            ...
            enableReferrals = fromMaybe False enableReferrals,
            expand = expand,
            isAutoRefundEnabled = fromMaybe False isAutoRefundEnabled,
  ...
  toTType' (Domain.Types.PayoutConfig.PayoutConfig {..}) = do
    Beam.PayoutConfigT
      { Beam.batchLimit = batchLimit,
        ...
        Beam.enableReferrals = Just enableReferrals,
        Beam.expand = expand,
        Beam.isAutoRefundEnabled = Just isAutoRefundEnabled,
