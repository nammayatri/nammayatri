...
instance FromTType' Beam.Message Domain.Types.Message.Message
    where fromTType' (Beam.MessageT {..}) = do {merchantOperatingCityId' <- Storage.Queries.Transformers.Message.getMerchantOperatingCityId merchantId;
                                                messageTranslations' <- Storage.Queries.Transformers.Message.getMsgTranslations id;
                                                pure $ Just Domain.Types.Message.Message{_type = messageType,
                                                                                         ...
                                                                                         title = title,
                                                                                         viewCount = viewCount}}
instance ToTType' Beam.Message Domain.Types.Message.Message
    where toTType' (Domain.Types.Message.Message {..}) = do Beam.MessageT{Beam.messageType = _type,
