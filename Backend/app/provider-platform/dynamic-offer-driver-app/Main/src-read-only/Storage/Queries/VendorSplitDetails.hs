...
findAllByAreasCityAndVariant :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByAreasCityAndVariant area merchantOperatingCityId vehicleVariant = do findAllWithKV [Se.And [Se.Is Beam.area $ Se.In area,
...
findByPrimaryKey area merchantOperatingCityId vehicleVariant vendorId = do findOneWithKV [Se.And [Se.Is Beam.area $ Se.Eq area,
                                                                                                  Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
                                                                                                  Se.Is Beam.vehicleVariant $ Se.Eq vehicleVariant,
...
updateByPrimaryKey (Domain.Types.VendorSplitDetails.VendorSplitDetails {..}) = do {_now <- getCurrentTime;
                                                                                   updateWithKV [Se.Set Beam.maxVendorFeeAmount maxVendorFeeAmount, Se.Set Beam.splitType splitType, Se.Set Beam.splitValue splitValue, Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.area $ Se.Eq area,
                                                                                                                                                                                                                                                             Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
                                                                                                                                                                                                                                                             Se.Is Beam.vehicleVariant $ Se.Eq vehicleVariant,
                                                                                                                                                                                                                                                             Se.Is Beam.vendorId $ Se.Eq vendorId]]}
...
instance FromTType' Beam.VendorSplitDetails Domain.Types.VendorSplitDetails.VendorSplitDetails
    where fromTType' (Beam.VendorSplitDetailsT {..}) = do pure $ Just Domain.Types.VendorSplitDetails.VendorSplitDetails{area = area,
                                                                                                                         ...
                                                                                                                         createdAt = createdAt,
                                                                                                                         updatedAt = updatedAt}
instance ToTType' Beam.VendorSplitDetails Domain.Types.VendorSplitDetails.VendorSplitDetails
    where toTType' (Domain.Types.VendorSplitDetails.VendorSplitDetails {..}) = do Beam.VendorSplitDetailsT{Beam.area = area,
