...
module Storage.Queries.VendorSplitDetails (module Storage.Queries.VendorSplitDetails, module ReExport) where
...
import Storage.Queries.VendorSplitDetailsExtra as ReExport
