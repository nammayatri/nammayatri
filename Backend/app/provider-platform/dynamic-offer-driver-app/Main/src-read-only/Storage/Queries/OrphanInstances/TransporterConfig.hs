      ...
      Just
        Domain.Types.TransporterConfig.TransporterConfig
          { aaEnabledClientSdkVersion = fromMaybe Storage.Queries.Transformers.TransporterConfig.fallBackVersionInText aaEnabledClientSdkVersion,
            ...
            docPullAttemptWindowSec = fromMaybe 7200 docPullAttemptWindowSec,
            docPullDedupeWindowSec = fromMaybe 30 docPullDedupeWindowSec,
            docPullMaxAttempts = fromMaybe 10 docPullMaxAttempts,
            docPullThrottleWindowSec = fromMaybe 120 docPullThrottleWindowSec,
            docPullWebhookGraceSec = fromMaybe 120 docPullWebhookGraceSec,
  ...
  toTType' (Domain.Types.TransporterConfig.TransporterConfig {..}) = do
    Beam.TransporterConfigT
      { Beam.aaEnabledClientSdkVersion = Just aaEnabledClientSdkVersion,
        ...
        Beam.docPullAttemptWindowSec = Just docPullAttemptWindowSec,
        Beam.docPullDedupeWindowSec = Just docPullDedupeWindowSec,
        Beam.docPullMaxAttempts = Just docPullMaxAttempts,
        Beam.docPullThrottleWindowSec = Just docPullThrottleWindowSec,
        Beam.docPullWebhookGraceSec = Just docPullWebhookGraceSec,
