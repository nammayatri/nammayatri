      ...
      Just
        Domain.Types.TransporterConfig.TransporterConfig
          { aaEnabledClientSdkVersion = fromMaybe Storage.Queries.Transformers.TransporterConfig.fallBackVersionInText aaEnabledClientSdkVersion,
            ...
            driverCallingOptionConfigs = (\val -> case Data.Aeson.fromJSON val of Data.Aeson.Success x -> Just x; Data.Aeson.Error _ -> Nothing) =<< driverCallingOptionConfigs,
            ...
            enableDriverWallet = enableDriverWallet,
            ...
            enableWalletPayout = enableWalletPayout,
            ...
            maxOnlineDurationDays = maxOnlineDurationDays,
            maxPayoutReferralForADay = maxPayoutReferralForADay,
            maxWalletPayoutsPerDay = maxWalletPayoutsPerDay,
            ...
            minimumWalletPayoutAmount = minimumWalletPayoutAmount,
            ...
            onlineDurationCalculateFrom = onlineDurationCalculateFrom,
            ...
            payoutCutOffDays = payoutCutOffDays,
            ...
            prepaidSubscriptionThreshold = prepaidSubscriptionThreshold,
  ...
  toTType' (Domain.Types.TransporterConfig.TransporterConfig {..}) = do
    Beam.TransporterConfigT
      { Beam.aaEnabledClientSdkVersion = Just aaEnabledClientSdkVersion,
        ...
        Beam.driverCallingOptionConfigs = Data.Aeson.toJSON <$> driverCallingOptionConfigs,
        ...
        Beam.enableDriverWallet = enableDriverWallet,
        ...
        Beam.enableWalletPayout = enableWalletPayout,
        Beam.enableWalletTopup = enableWalletTopup,
        ...
        Beam.gstPercentage = gstPercentage,
        ...
        Beam.maxOnlineDurationDays = maxOnlineDurationDays,
        Beam.maxPayoutReferralForADay = maxPayoutReferralForADay,
        Beam.maxWalletPayoutsPerDay = maxWalletPayoutsPerDay,
        ...
        Beam.minimumWalletPayoutAmount = minimumWalletPayoutAmount,
        ...
        Beam.onlineDurationCalculateFrom = onlineDurationCalculateFrom,
        ...
        Beam.payoutCutOffDays = payoutCutOffDays,
        ...
        Beam.prepaidSubscriptionThreshold = prepaidSubscriptionThreshold,
