...
instance FromTType' Beam.DriverQuote Domain.Types.DriverQuote.DriverQuote
    where fromTType' (Beam.DriverQuoteT {..}) = do {backendConfigVersion' <- (mapM Kernel.Utils.Version.readVersion (Data.Text.strip <$> backendConfigVersion));
                                                    clientBundleVersion' <- (mapM Kernel.Utils.Version.readVersion (Data.Text.strip <$> clientBundleVersion));
                                                    clientConfigVersion' <- (mapM Kernel.Utils.Version.readVersion (Data.Text.strip <$> clientConfigVersion));
                                                    clientSdkVersion' <- (mapM Kernel.Utils.Version.readVersion (Data.Text.strip <$> clientSdkVersion));
                                                    fareParams' <- getFareParams fareParametersId;
                                                    pure $ Just Domain.Types.DriverQuote.DriverQuote{backendAppVersion = backendAppVersion,
...
instance ToTType' Beam.DriverQuote Domain.Types.DriverQuote.DriverQuote
    where toTType' (Domain.Types.DriverQuote.DriverQuote {..}) = do Beam.DriverQuoteT{Beam.backendAppVersion = backendAppVersion,
