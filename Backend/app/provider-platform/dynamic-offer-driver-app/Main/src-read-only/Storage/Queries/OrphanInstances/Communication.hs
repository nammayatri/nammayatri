...
instance FromTType' Beam.Communication Domain.Types.Communication.Communication
    where fromTType' (Beam.CommunicationT {..}) = do pure $ Just Domain.Types.Communication.Communication{body = body,
                                                                                                          ...
                                                                                                          updatedAt = updatedAt,
                                                                                                          variables = variables}
instance ToTType' Beam.Communication Domain.Types.Communication.Communication
    where toTType' (Domain.Types.Communication.Communication {..}) = do Beam.CommunicationT{Beam.body = body,
