...
instance FromTType' Beam.AadhaarOtpReq Domain.Types.AadhaarOtpReq.AadhaarOtpReq
    where fromTType' (Beam.AadhaarOtpReqT {..}) = do pure $ Just Domain.Types.AadhaarOtpReq.AadhaarOtpReq{driverId = Kernel.Types.Id.Id driverId,
...
instance ToTType' Beam.AadhaarOtpReq Domain.Types.AadhaarOtpReq.AadhaarOtpReq
    where toTType' (Domain.Types.AadhaarOtpReq.AadhaarOtpReq {..}) = do Beam.AadhaarOtpReqT{Beam.driverId = Kernel.Types.Id.getId driverId,
