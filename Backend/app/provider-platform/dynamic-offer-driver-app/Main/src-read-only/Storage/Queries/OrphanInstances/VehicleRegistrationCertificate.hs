...
instance FromTType' Beam.VehicleRegistrationCertificate Domain.Types.VehicleRegistrationCertificate.VehicleRegistrationCertificate
    where fromTType' (Beam.VehicleRegistrationCertificateT {..}) = do pure $ Just Domain.Types.VehicleRegistrationCertificate.VehicleRegistrationCertificate{airConditioned = airConditioned,
                                                                                                                                                             approved = approved,
                                                                                                                                                             ...
                                                                                                                                                             createdAt = createdAt,
                                                                                                                                                             updatedAt = updatedAt}
instance ToTType' Beam.VehicleRegistrationCertificate Domain.Types.VehicleRegistrationCertificate.VehicleRegistrationCertificate
    where toTType' (Domain.Types.VehicleRegistrationCertificate.VehicleRegistrationCertificate {..}) = do Beam.VehicleRegistrationCertificateT{Beam.airConditioned = airConditioned,
