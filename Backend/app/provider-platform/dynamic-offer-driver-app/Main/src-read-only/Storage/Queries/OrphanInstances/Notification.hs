...
instance FromTType' Beam.Notification Domain.Types.Notification.Notification
    where fromTType' (Beam.NotificationT {..}) = do {merchantOperatingCityId' <- Storage.Queries.Transformers.Notification.getMerchantOperatingCityId merchantOperatingCityId id driverFeeId;
                                                     pure $ Just Domain.Types.Notification.Notification{createdAt = createdAt,
...
instance ToTType' Beam.Notification Domain.Types.Notification.Notification
    where toTType' (Domain.Types.Notification.Notification {..}) = do Beam.NotificationT{Beam.createdAt = createdAt,
