...
instance FromTType' Beam.TripAlertRequest Domain.Types.TripAlertRequest.TripAlertRequest
    where fromTType' (Beam.TripAlertRequestT {..}) = do pure $ Just Domain.Types.TripAlertRequest.TripAlertRequest{alertRequestId = Kernel.Types.Id.Id alertRequestId,
                                                                                                                   ...
                                                                                                                   updatedAt = updatedAt}
instance ToTType' Beam.TripAlertRequest Domain.Types.TripAlertRequest.TripAlertRequest
    where toTType' (Domain.Types.TripAlertRequest.TripAlertRequest {..}) = do Beam.TripAlertRequestT{Beam.alertRequestId = Kernel.Types.Id.getId alertRequestId,
