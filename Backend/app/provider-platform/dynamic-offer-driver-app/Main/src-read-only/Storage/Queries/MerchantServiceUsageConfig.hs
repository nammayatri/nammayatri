...
updateMerchantServiceUsageConfig (Domain.Types.MerchantServiceUsageConfig.MerchantServiceUsageConfig {..}) = do {_now <- getCurrentTime;
                                                                                                                 updateOneWithKV [Se.Set Beam.getDistances getDistances,
...
updateSmsProvidersPriorityList :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
                                  ([Kernel.External.SMS.Types.SmsService] -> Kernel.Types.Id.Id Domain.Types.MerchantOperatingCity.MerchantOperatingCity -> m ())
updateSmsProvidersPriorityList smsProvidersPriorityList merchantOperatingCityId = do {_now <- getCurrentTime;
...
updateSnapToRoadProvidersPriorityList :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
                                         ([Kernel.External.Maps.Types.MapsService] -> Kernel.Types.Id.Id Domain.Types.MerchantOperatingCity.MerchantOperatingCity -> m ())
updateSnapToRoadProvidersPriorityList snapToRoadProvidersList merchantOperatingCityId = do {_now <- getCurrentTime;
...
updateWhatsappProvidersPriorityList :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateWhatsappProvidersPriorityList whatsappProvidersPriorityList merchantOperatingCityId = do {_now <- getCurrentTime;
                                                                                                updateWithKV [Se.Set Beam.whatsappProvidersPriorityList whatsappProvidersPriorityList,
                                                                                                              Se.Set Beam.updatedAt _now] [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId)]}



instance FromTType' Beam.MerchantServiceUsageConfig Domain.Types.MerchantServiceUsageConfig.MerchantServiceUsageConfig
    where fromTType' (Beam.MerchantServiceUsageConfigT {..}) = do pure $ Just Domain.Types.MerchantServiceUsageConfig.MerchantServiceUsageConfig{aadhaarVerificationService = aadhaarVerificationService,
...
instance ToTType' Beam.MerchantServiceUsageConfig Domain.Types.MerchantServiceUsageConfig.MerchantServiceUsageConfig
    where toTType' (Domain.Types.MerchantServiceUsageConfig.MerchantServiceUsageConfig {..}) = do Beam.MerchantServiceUsageConfigT{Beam.aadhaarVerificationService = aadhaarVerificationService,
