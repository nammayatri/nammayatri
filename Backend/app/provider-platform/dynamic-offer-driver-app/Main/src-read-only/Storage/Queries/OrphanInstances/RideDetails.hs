...
instance FromTType' Beam.RideDetails Domain.Types.RideDetails.RideDetails
    where fromTType' (Beam.RideDetailsT {..}) = do pure $ Just Domain.Types.RideDetails.RideDetails{createdAt = createdAt,
...
instance ToTType' Beam.RideDetails Domain.Types.RideDetails.RideDetails
    where toTType' (Domain.Types.RideDetails.RideDetails {..}) = do Beam.RideDetailsT{Beam.createdAt = createdAt,
