...
updateByPrimaryKey (Domain.Types.BusinessLicense.BusinessLicense {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.BusinessLicense Domain.Types.BusinessLicense.BusinessLicense
    where fromTType' (Beam.BusinessLicenseT {..}) = do pure $ Just Domain.Types.BusinessLicense.BusinessLicense{documentImageId = Kernel.Types.Id.Id documentImageId,
                                                                                                                ...
                                                                                                                createdAt = createdAt,
                                                                                                                updatedAt = updatedAt}
instance ToTType' Beam.BusinessLicense Domain.Types.BusinessLicense.BusinessLicense
    where toTType' (Domain.Types.BusinessLicense.BusinessLicense {..}) = do Beam.BusinessLicenseT{Beam.documentImageId = Kernel.Types.Id.getId documentImageId,
