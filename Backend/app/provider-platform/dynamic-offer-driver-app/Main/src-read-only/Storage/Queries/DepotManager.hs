...
findAllByPersonId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) => (Kernel.Types.Id.Id Domain.Types.Person.Person -> m [Domain.Types.DepotManager.DepotManager])
findAllByPersonId personId = do findAllWithDb [Se.Is Beam.personId $ Se.Eq (Kernel.Types.Id.getId personId)]
