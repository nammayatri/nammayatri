...
update (Domain.Types.DriverIntelligentPoolConfig.DriverIntelligentPoolConfig {..}) = do {_now <- getCurrentTime;
                                                                                         updateOneWithKV [Se.Set Beam.availabilityTimeWeightage availabilityTimeWeightage,
...
instance FromTType' Beam.DriverIntelligentPoolConfig Domain.Types.DriverIntelligentPoolConfig.DriverIntelligentPoolConfig
    where fromTType' (Beam.DriverIntelligentPoolConfigT {..}) = do pure $ Just Domain.Types.DriverIntelligentPoolConfig.DriverIntelligentPoolConfig{acceptanceRatioWeightage = acceptanceRatioWeightage,
                                                                                                                                                    ...
                                                                                                                                                    updatedAt = updatedAt}
instance ToTType' Beam.DriverIntelligentPoolConfig Domain.Types.DriverIntelligentPoolConfig.DriverIntelligentPoolConfig
    where toTType' (Domain.Types.DriverIntelligentPoolConfig.DriverIntelligentPoolConfig {..}) = do Beam.DriverIntelligentPoolConfigT{Beam.acceptanceRatioWeightage = acceptanceRatioWeightage,
