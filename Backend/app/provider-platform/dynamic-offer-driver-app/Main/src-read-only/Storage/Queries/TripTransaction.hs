...
updateEndRideApprovalRequestId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateEndRideApprovalRequestId endRideApprovalRequestId id = do {_now <- getCurrentTime;
...
updateOnEnd :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateOnEnd status endLocation tripEndTime tripTerminationSource id = do {_now <- getCurrentTime;
                                                                          updateOneWithKV [Se.Set Beam.status status,
...
updateOnStart :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateOnStart tripCode startedNearStopCode startLocation status tripStartTime tripStartSource id = do {_now <- getCurrentTime;
                                                                                                       updateOneWithKV [Se.Set Beam.tripCode tripCode,
...
updateByPrimaryKey (Domain.Types.TripTransaction.TripTransaction {..}) = do {_now <- getCurrentTime;
                                                                             updateWithKV [Se.Set Beam.allowEndingMidRoute allowEndingMidRoute,
                                                                                           ...
                                                                                           Se.Set Beam.tripEndTime tripEndTime,
                                                                                           Se.Set Beam.tripEstimatedRouteDetails (Kernel.Prelude.toJSON <$> tripEstimatedRouteDetails ),
                                                                                           Se.Set Beam.tripStartSource tripStartSource,
                                                                                           Se.Set Beam.tripStartTime tripStartTime,
                                                                                           Se.Set Beam.tripTerminationSource tripTerminationSource,
                                                                                           ...
                                                                                           Se.Set Beam.vipName vipName] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]}
