...
instance FromTType' Beam.StclMembership Domain.Types.StclMembership.StclMembership
    where fromTType' (Beam.StclMembershipT {..}) = do pure $ Just Domain.Types.StclMembership.StclMembership{accountNumber = EncryptedHashed (Encrypted accountNumberEncrypted) accountNumberHash,
...
instance ToTType' Beam.StclMembership Domain.Types.StclMembership.StclMembership
    where toTType' (Domain.Types.StclMembership.StclMembership {..}) = do Beam.StclMembershipT{Beam.accountNumberEncrypted = ((unEncrypted . (.encrypted) $ accountNumber)),
