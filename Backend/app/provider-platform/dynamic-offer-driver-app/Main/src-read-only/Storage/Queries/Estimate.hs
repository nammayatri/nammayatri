...
updateByPrimaryKey (Domain.Types.Estimate.Estimate {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.createdAt createdAt,
      ...
      Se.Set Beam.driverPickUpCharge (Kernel.Prelude.fmap Kernel.Prelude.roundToIntegral driverPickUpCharge),
      Se.Set Beam.driverPickUpChargeAmount driverPickUpCharge,
      ...
      Just
        Domain.Types.Estimate.Estimate
          { createdAt = createdAt,
            ...
            driverPickUpCharge = Kernel.Types.Common.mkAmountWithDefault driverPickUpChargeAmount <$> driverPickUpCharge,
  ...
  toTType' (Domain.Types.Estimate.Estimate {..}) = do
    Beam.EstimateT
      { Beam.createdAt = createdAt,
        ...
        Beam.driverPickUpCharge = Kernel.Prelude.fmap Kernel.Prelude.roundToIntegral driverPickUpCharge,
        Beam.driverPickUpChargeAmount = driverPickUpCharge,
