...
findAllByMerchantOpCityId ::
  ...
  (Kernel.Prelude.Maybe (Kernel.Types.Id.Id Domain.Types.MerchantOperatingCity.MerchantOperatingCity) -> m [Domain.Types.SubscriptionConfig.SubscriptionConfig])
...
updateByPrimaryKey (Domain.Types.SubscriptionConfig.SubscriptionConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.allowDriverFeeCalcSchedule allowDriverFeeCalcSchedule,
      ...
      Se.Set Beam.autoEnrollNewDrivers autoEnrollNewDrivers,
      ...
      Se.Set Beam.enableDailyPlanVendorSplit enableDailyPlanVendorSplit,
      Se.Set Beam.enableOffersForMembers (Kernel.Prelude.Just enableOffersForMembers),
      ...
      Just
        Domain.Types.SubscriptionConfig.SubscriptionConfig
          { allowDriverFeeCalcSchedule = allowDriverFeeCalcSchedule,
            ...
            autoEnrollNewDrivers = autoEnrollNewDrivers,
            ...
            enableDailyPlanVendorSplit = enableDailyPlanVendorSplit,
            enableOffersForMembers = Kernel.Prelude.fromMaybe False enableOffersForMembers,
  ...
  toTType' (Domain.Types.SubscriptionConfig.SubscriptionConfig {..}) = do
    Beam.SubscriptionConfigT
      { Beam.allowDriverFeeCalcSchedule = allowDriverFeeCalcSchedule,
        ...
        Beam.autoEnrollNewDrivers = autoEnrollNewDrivers,
        ...
        Beam.enableDailyPlanVendorSplit = enableDailyPlanVendorSplit,
        Beam.enableOffersForMembers = Kernel.Prelude.Just enableOffersForMembers,
