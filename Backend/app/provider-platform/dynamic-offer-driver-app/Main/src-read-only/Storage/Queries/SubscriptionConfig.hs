...
findAllServicesUIEnabledByCity :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllServicesUIEnabledByCity merchantOperatingCityId isUIEnabled = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId <$> merchantOperatingCityId),
                                                                                               Se.Is Beam.isUIEnabled $ Se.Eq (Kernel.Prelude.Just isUIEnabled)]]
findSubscriptionConfigsByMerchantOpCityIdAndServiceName :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findSubscriptionConfigsByMerchantOpCityIdAndServiceName merchantOperatingCityId serviceName = do findOneWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId <$> merchantOperatingCityId),
...
findByPrimaryKey serviceName merchantOperatingCityId = do findOneWithKV [Se.And [Se.Is Beam.serviceName $ Se.Eq serviceName,
...
updateByPrimaryKey (Domain.Types.SubscriptionConfig.SubscriptionConfig {..}) = do {_now <- getCurrentTime;
                                                                                   updateWithKV [Se.Set Beam.allowDriverFeeCalcSchedule allowDriverFeeCalcSchedule,
                                                                                                 ...
                                                                                                 Se.Set Beam.manualPaymentLinkRateLimitExpirySeconds ((Kernel.Prelude.Just . Kernel.Utils.Common.nominalDiffTimeToSeconds . Kernel.Prelude.fromMaybe (Kernel.Utils.Common.secondsToNominalDiffTime 21600)) manualPaymentLinkRateLimitExpirySeconds),
                                                                                                 ...
                                                                                                 Se.Set Beam.vendorMigrationMappings (Kernel.Prelude.toJSON <$> vendorMigrationMappings ),
                                                                                                 ...
                                                                                                 Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.serviceName $ Se.Eq serviceName, Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId <$> merchantOperatingCityId)]]}



instance FromTType' Beam.SubscriptionConfig Domain.Types.SubscriptionConfig.SubscriptionConfig
    where fromTType' (Beam.SubscriptionConfigT {..}) = do pure $ Just Domain.Types.SubscriptionConfig.SubscriptionConfig{allowDriverFeeCalcSchedule = allowDriverFeeCalcSchedule,
                                                                                                                         ...
                                                                                                                         manualPaymentLinkRateLimitExpirySeconds = (Kernel.Prelude.Just . Kernel.Utils.Common.secondsToNominalDiffTime . Kernel.Prelude.fromMaybe 21600) manualPaymentLinkRateLimitExpirySeconds,
                                                                                                                         ...
                                                                                                                         vendorMigrationMappings = (\val -> case Data.Aeson.fromJSON val of Data.Aeson.Success x -> Just x; Data.Aeson.Error _ -> Nothing) =<< vendorMigrationMappings ,
                                                                                                                         ...
                                                                                                                         createdAt = createdAt,
                                                                                                                         updatedAt = updatedAt}
instance ToTType' Beam.SubscriptionConfig Domain.Types.SubscriptionConfig.SubscriptionConfig
    where toTType' (Domain.Types.SubscriptionConfig.SubscriptionConfig {..}) = do Beam.SubscriptionConfigT{Beam.allowDriverFeeCalcSchedule = allowDriverFeeCalcSchedule,
                                                                                                           ...
                                                                                                           Beam.manualPaymentLinkRateLimitExpirySeconds = (Kernel.Prelude.Just . Kernel.Utils.Common.nominalDiffTimeToSeconds . Kernel.Prelude.fromMaybe (Kernel.Utils.Common.secondsToNominalDiffTime 21600)) manualPaymentLinkRateLimitExpirySeconds,
                                                                                                           ...
                                                                                                           Beam.vendorMigrationMappings = Kernel.Prelude.toJSON <$> vendorMigrationMappings ,
