...
updateByPrimaryKey (Domain.Types.SubscriptionConfig.SubscriptionConfig {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.allowDriverFeeCalcSchedule allowDriverFeeCalcSchedule,
      ...
      Se.Set Beam.defaultServiceTierForCategory (Kernel.Prelude.toJSON <$> defaultServiceTierForCategory),
      ...
      Se.Set Beam.enableVendorPercentageSplit enableVendorPercentageSplit,
      ...
      Just
        Domain.Types.SubscriptionConfig.SubscriptionConfig
          { allowDriverFeeCalcSchedule = allowDriverFeeCalcSchedule,
            ...
            defaultServiceTierForCategory = (\val -> case Data.Aeson.fromJSON val of Data.Aeson.Success x -> Just x; Data.Aeson.Error _ -> Nothing) =<< defaultServiceTierForCategory,
            ...
            enableVendorPercentageSplit = (Kernel.Prelude.Just . Kernel.Prelude.fromMaybe False) enableVendorPercentageSplit,
  ...
  toTType' (Domain.Types.SubscriptionConfig.SubscriptionConfig {..}) = do
    Beam.SubscriptionConfigT
      { Beam.allowDriverFeeCalcSchedule = allowDriverFeeCalcSchedule,
        ...
        Beam.defaultServiceTierForCategory = Kernel.Prelude.toJSON <$> defaultServiceTierForCategory,
        ...
        Beam.enableVendorPercentageSplit = enableVendorPercentageSplit,
