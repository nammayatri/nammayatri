...
findByDeviceIdAndMerchant identifier merchantId = do findOneWithKV [Se.And [Se.Is Beam.identifier $ Se.Eq identifier, Se.Is Beam.merchantId $ Se.Eq (Kernel.Types.Id.getId merchantId)]]
