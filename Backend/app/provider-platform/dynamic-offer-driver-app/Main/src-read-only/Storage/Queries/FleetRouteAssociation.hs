...
findAllByFleetOwnerIdAndCityId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByFleetOwnerIdAndCityId fleetOwnerId merchantOperatingCityId = do findAllWithKV [Se.And [Se.Is Beam.fleetOwnerId $ Se.Eq (Kernel.Types.Id.getId fleetOwnerId),
...
updateByPrimaryKey (Domain.Types.FleetRouteAssociation.FleetRouteAssociation {..}) = do {_now <- getCurrentTime;
                                                                                         updateWithKV [Se.Set Beam.fleetOwnerId (Kernel.Types.Id.getId fleetOwnerId),
...
instance FromTType' Beam.FleetRouteAssociation Domain.Types.FleetRouteAssociation.FleetRouteAssociation
    where fromTType' (Beam.FleetRouteAssociationT {..}) = do pure $ Just Domain.Types.FleetRouteAssociation.FleetRouteAssociation{createdAt = createdAt,
                                                                                                                                  ...
                                                                                                                                  routeCode = routeCode,
                                                                                                                                  updatedAt = updatedAt}
instance ToTType' Beam.FleetRouteAssociation Domain.Types.FleetRouteAssociation.FleetRouteAssociation
    where toTType' (Domain.Types.FleetRouteAssociation.FleetRouteAssociation {..}) = do Beam.FleetRouteAssociationT{Beam.createdAt = createdAt,
