...
updateRating ratingValue feedbackDetails isSafe issueId wasOfferedAssistance isFavourite mediaId id driverId = do {_now <- getCurrentTime;
                                                                                                                   updateOneWithKV [Se.Set Beam.ratingValue ratingValue,
                                                                                                                                    ...
                                                                                                                                    Se.Set Beam.mediaId (Kernel.Types.Id.getId <$> mediaId)] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id),
