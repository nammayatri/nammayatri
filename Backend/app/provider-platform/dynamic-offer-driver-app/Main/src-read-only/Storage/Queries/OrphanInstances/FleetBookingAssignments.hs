...
instance FromTType' Beam.FleetBookingAssignments Domain.Types.FleetBookingAssignments.FleetBookingAssignments
    where fromTType' (Beam.FleetBookingAssignmentsT {..}) = do pure $ Just Domain.Types.FleetBookingAssignments.FleetBookingAssignments{amount = amount,
                                                                                                                                        ...
                                                                                                                                        vehicleNo = vehicleNo,
                                                                                                                                        visitDate = visitDate}
instance ToTType' Beam.FleetBookingAssignments Domain.Types.FleetBookingAssignments.FleetBookingAssignments
    where toTType' (Domain.Types.FleetBookingAssignments.FleetBookingAssignments {..}) = do Beam.FleetBookingAssignmentsT{Beam.amount = amount,
