...
findLeaderBoardConfigbyType :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findLeaderBoardConfigbyType leaderBoardType merchantOperatingCityId = do findOneWithKV [Se.And [Se.Is Beam.leaderBoardType $ Se.Eq leaderBoardType,
...
updateByPrimaryKey (Domain.Types.LeaderBoardConfigs.LeaderBoardConfigs {..}) = do {_now <- getCurrentTime;
                                                                                   updateWithKV [Se.Set Beam.isEnabled isEnabled,
...
instance FromTType' Beam.LeaderBoardConfigs Domain.Types.LeaderBoardConfigs.LeaderBoardConfigs
    where fromTType' (Beam.LeaderBoardConfigsT {..}) = do pure $ Just Domain.Types.LeaderBoardConfigs.LeaderBoardConfigs{id = Kernel.Types.Id.Id id,
                                                                                                                         isEnabled = isEnabled,
                                                                                                                         ...
                                                                                                                         createdAt = createdAt,
                                                                                                                         updatedAt = updatedAt}
instance ToTType' Beam.LeaderBoardConfigs Domain.Types.LeaderBoardConfigs.LeaderBoardConfigs
    where toTType' (Domain.Types.LeaderBoardConfigs.LeaderBoardConfigs {..}) = do Beam.LeaderBoardConfigsT{Beam.id = Kernel.Types.Id.getId id,
