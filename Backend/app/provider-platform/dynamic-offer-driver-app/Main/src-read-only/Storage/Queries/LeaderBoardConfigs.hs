...
findAllByMerchantOpCityId :: (MonadFlow m, CacheFlow m r, EsqDBFlow m r) => Kernel.Types.Id.Id Domain.Types.Merchant.MerchantOperatingCity.MerchantOperatingCity -> m ([Domain.Types.LeaderBoardConfigs.LeaderBoardConfigs])
findAllByMerchantOpCityId (Kernel.Types.Id.Id merchantOperatingCityId) = do
  findAllWithKV
    [ Se.Is Beam.merchantOperatingCityId $ Se.Eq merchantOperatingCityId
    ]

findLeaderBoardConfigbyType :: (MonadFlow m, CacheFlow m r, EsqDBFlow m r) => Domain.Types.LeaderBoardConfigs.LeaderBoardType -> Kernel.Types.Id.Id Domain.Types.Merchant.MerchantOperatingCity.MerchantOperatingCity -> m (Maybe (Domain.Types.LeaderBoardConfigs.LeaderBoardConfigs))
...
findByPrimaryKey :: (MonadFlow m, CacheFlow m r, EsqDBFlow m r) => Kernel.Types.Id.Id Domain.Types.LeaderBoardConfigs.LeaderBoardConfigs -> m (Maybe (Domain.Types.LeaderBoardConfigs.LeaderBoardConfigs))
...
updateByPrimaryKey :: (MonadFlow m, CacheFlow m r, EsqDBFlow m r) => Domain.Types.LeaderBoardConfigs.LeaderBoardConfigs -> m ()
