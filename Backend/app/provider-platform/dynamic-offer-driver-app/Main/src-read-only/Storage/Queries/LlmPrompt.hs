...
findByMerchantOpCityIdAndServiceNameAndUseCaseAndPromptKey :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMerchantOpCityIdAndServiceNameAndUseCaseAndPromptKey merchantOperatingCityId serviceName useCase promptKey = do findOneWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
instance FromTType' Beam.LlmPrompt Domain.Types.LlmPrompt.LlmPrompt
    where fromTType' (Beam.LlmPromptT {..}) = do pure $ Just Domain.Types.LlmPrompt.LlmPrompt{createdAt = createdAt,
                                                                                              ...
                                                                                              updatedAt = updatedAt,
                                                                                              useCase = useCase}
instance ToTType' Beam.LlmPrompt Domain.Types.LlmPrompt.LlmPrompt
    where toTType' (Domain.Types.LlmPrompt.LlmPrompt {..}) = do Beam.LlmPromptT{Beam.createdAt = createdAt,
