...
findByPrimaryKey documentType merchantOperatingCityId vehicleCategory = do findOneWithKV [Se.And [Se.Is Beam.documentType $ Se.Eq documentType,
...
updateByPrimaryKey (Domain.Types.DocumentVerificationConfig.DocumentVerificationConfig {..}) = do {_now <- getCurrentTime;
                                                                                                   updateWithKV [Se.Set Beam.allowLicenseTransfer allowLicenseTransfer,
