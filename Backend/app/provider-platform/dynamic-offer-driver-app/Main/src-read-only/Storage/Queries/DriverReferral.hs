...
findByDynamicReferralCodeAndMerchantCityIdAndDriversIn :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByDynamicReferralCodeAndMerchantCityIdAndDriversIn merchantOperatingCityId dynamicReferralCode driverIds = do findOneWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId <$> merchantOperatingCityId),
...
findByReferralCodeAndMerchantCityId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByReferralCodeAndMerchantCityId merchantOperatingCityId referralCode = do findOneWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId <$> merchantOperatingCityId),
...
updateDynamicReferralCode :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateDynamicReferralCode dynamicReferralCode dynamicReferralCodeValidTill merchantOperatingCityId merchantId driverId = do {_now <- getCurrentTime;
                                                                                                                             updateOneWithKV [Se.Set Beam.dynamicReferralCode dynamicReferralCode,
...
updateByPrimaryKey (Domain.Types.DriverReferral.DriverReferral {..}) = do {_now <- getCurrentTime;
                                                                           updateWithKV [Se.Set Beam.driverId (Kernel.Types.Id.getId driverId),
                                                                                         ...
                                                                                         Se.Set Beam.merchantId (Kernel.Types.Id.getId <$> merchantId),
                                                                                         Se.Set Beam.merchantOperatingCityId (Kernel.Types.Id.getId <$> merchantOperatingCityId),
                                                                                         Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.referralCode $ Se.Eq (Kernel.Types.Id.getId referralCode)]]}
