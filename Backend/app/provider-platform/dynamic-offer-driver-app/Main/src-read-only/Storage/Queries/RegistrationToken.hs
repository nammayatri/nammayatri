...
updateMerchantOperatingCityId merchantOperatingCityId entityId merchantId = do {_now <- getCurrentTime;
                                                                                updateWithKV [Se.Set Beam.merchantOperatingCityId (Kernel.Prelude.Just merchantOperatingCityId), Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.entityId $ Se.Eq entityId,
...
updateByPrimaryKey (Domain.Types.RegistrationToken.RegistrationToken {..}) = do {_now <- getCurrentTime;
                                                                                 updateWithKV [Se.Set Beam.alternateNumberAttempts alternateNumberAttempts,
                                                                                               ...
                                                                                               Se.Set Beam.verified verified] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]}
