      ...
      Just
        Domain.Types.SharedEntity.SharedEntity
          { bapSharedEntityId = bapSharedEntityId,
            ...
            searchRequestForDriverIds = (\val -> case Data.Aeson.fromJSON val of Data.Aeson.Success x -> Just x; Data.Aeson.Error _ -> Nothing) =<< searchRequestForDriverIds,
  ...
  toTType' (Domain.Types.SharedEntity.SharedEntity {..}) = do
    Beam.SharedEntityT
      { Beam.bapSharedEntityId = bapSharedEntityId,
        ...
        Beam.searchRequestForDriverIds = Data.Aeson.toJSON <$> searchRequestForDriverIds,
