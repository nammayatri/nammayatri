...
findByTransactionIdAndMerchantId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByPrimaryKey (Domain.Types.SearchRequest.SearchRequest {..}) = do updateWithKV [Se.Set Beam.area area,
                                                                                      ...
                                                                                      Se.Set Beam.validTill (Just validTill)] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]
