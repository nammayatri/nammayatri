...
findByTransactionId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) => (Kernel.Prelude.Text -> m (Maybe Domain.Types.SearchRequest.SearchRequest))
...
updateByPrimaryKey (Domain.Types.SearchRequest.SearchRequest {..}) = do
  updateWithKV
    [ Se.Set Beam.area area,
      ...
      Se.Set Beam.isPetRide (Kernel.Prelude.Just isPetRide),
      ...
      Se.Set Beam.riderName riderName,
