...
updateAddress address id = do {_now <- getCurrentTime;
                               updateOneWithKV [Se.Set Beam.area ((.area) address),
...
instance FromTType' Beam.BookingLocation Domain.Types.BookingLocation.BookingLocation
    where fromTType' (Beam.BookingLocationT {..}) = do pure $ Just Domain.Types.BookingLocation.BookingLocation{address = mkLocationAddress area areaCode building city country door extras instructions state street,
                                                                                                                createdAt = createdAt,
...
instance ToTType' Beam.BookingLocation Domain.Types.BookingLocation.BookingLocation
    where toTType' (Domain.Types.BookingLocation.BookingLocation {..}) = do Beam.BookingLocationT{Beam.area = (.area) address,
