...
findByRcId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
              (Maybe Int -> Maybe Int -> Kernel.Types.Id.Id Domain.Types.VehicleRegistrationCertificate.VehicleRegistrationCertificate -> m ([Domain.Types.VehicleFitnessCertificate.VehicleFitnessCertificate]))
...
updateByPrimaryKey (Domain.Types.VehicleFitnessCertificate.VehicleFitnessCertificate {..}) = do {_now <- getCurrentTime;
                                                                                                 updateWithKV [Se.Set Beam.applicationNumberEncrypted (((applicationNumber & unEncrypted . encrypted))),
...
instance FromTType' Beam.VehicleFitnessCertificate Domain.Types.VehicleFitnessCertificate.VehicleFitnessCertificate
    where fromTType' (Beam.VehicleFitnessCertificateT {..}) = do pure $ Just Domain.Types.VehicleFitnessCertificate.VehicleFitnessCertificate{applicationNumber = EncryptedHashed (Encrypted applicationNumberEncrypted) applicationNumberHash,
                                                                                                                                              ...
                                                                                                                                              createdAt = createdAt,
                                                                                                                                              updatedAt = updatedAt}
instance ToTType' Beam.VehicleFitnessCertificate Domain.Types.VehicleFitnessCertificate.VehicleFitnessCertificate
    where toTType' (Domain.Types.VehicleFitnessCertificate.VehicleFitnessCertificate {..}) = do Beam.VehicleFitnessCertificateT{Beam.applicationNumberEncrypted = ((applicationNumber & unEncrypted . encrypted)),
