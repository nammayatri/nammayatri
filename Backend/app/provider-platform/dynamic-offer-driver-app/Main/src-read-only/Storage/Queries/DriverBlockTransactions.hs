...
blockCountByDriverId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByPrimaryKey (Domain.Types.DriverBlockTransactions.DriverBlockTransactions {..}) = do {_now <- getCurrentTime;
                                                                                             updateWithKV [Se.Set Beam.actionType actionType,
...
instance FromTType' Beam.DriverBlockTransactions Domain.Types.DriverBlockTransactions.DriverBlockTransactions
    where fromTType' (Beam.DriverBlockTransactionsT {..}) = do pure $ Just Domain.Types.DriverBlockTransactions.DriverBlockTransactions{actionType = actionType,
                                                                                                                                        ...
                                                                                                                                        createdAt = createdAt,
                                                                                                                                        updatedAt = updatedAt}
instance ToTType' Beam.DriverBlockTransactions Domain.Types.DriverBlockTransactions.DriverBlockTransactions
    where toTType' (Domain.Types.DriverBlockTransactions.DriverBlockTransactions {..}) = do Beam.DriverBlockTransactionsT{Beam.actionType = actionType,
