...
instance FromTType' Beam.BusinessEvent Domain.Types.BusinessEvent.BusinessEvent
    where fromTType' (Beam.BusinessEventT {..}) = do pure $ Just Domain.Types.BusinessEvent.BusinessEvent{bookingId = Kernel.Types.Id.Id <$> bookingId,
...
instance ToTType' Beam.BusinessEvent Domain.Types.BusinessEvent.BusinessEvent
    where toTType' (Domain.Types.BusinessEvent.BusinessEvent {..}) = do Beam.BusinessEventT{Beam.bookingId = Kernel.Types.Id.getId <$> bookingId,
