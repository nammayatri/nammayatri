...
findByCategoryAndMerchantOperatingCityId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByCategoryAndMerchantOperatingCityId category merchantOperatingCityId = do findAllWithKV [Se.And [Se.Is Beam.category $ Se.Eq category,
...
findByMessageKey :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMessageKey messageKey merchantId merchantOperatingCityId = do findOneWithKV [Se.And [Se.Is Beam.messageKey $ Se.Eq messageKey,
...
updateByPrimaryKey (Domain.Types.CallFeedbackOptions.CallFeedbackOptions {..}) = do {_now <- getCurrentTime;
                                                                                     updateWithKV [Se.Set Beam.category category,
...
instance FromTType' Beam.CallFeedbackOptions Domain.Types.CallFeedbackOptions.CallFeedbackOptions
    where fromTType' (Beam.CallFeedbackOptionsT {..}) = do pure $ Just Domain.Types.CallFeedbackOptions.CallFeedbackOptions{category = category,
                                                                                                                            ...
                                                                                                                            createdAt = createdAt,
                                                                                                                            updatedAt = updatedAt}
instance ToTType' Beam.CallFeedbackOptions Domain.Types.CallFeedbackOptions.CallFeedbackOptions
    where toTType' (Domain.Types.CallFeedbackOptions.CallFeedbackOptions {..}) = do Beam.CallFeedbackOptionsT{Beam.category = category,
