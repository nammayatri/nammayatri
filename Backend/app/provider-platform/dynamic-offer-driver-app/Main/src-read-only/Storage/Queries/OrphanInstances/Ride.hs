...
instance FromTType' Beam.Ride Domain.Types.Ride.Ride
    where fromTType' (Beam.RideT {..}) = do {backendConfigVersion' <- (mapM Kernel.Utils.Version.readVersion (Data.Text.strip <$> backendConfigVersion));
                                             ...
                                             pure $ Just Domain.Types.Ride.Ride{backendAppVersion = backendAppVersion,
...
instance ToTType' Beam.Ride Domain.Types.Ride.Ride
    where toTType' (Domain.Types.Ride.Ride {..}) = do Beam.RideT{Beam.backendAppVersion = backendAppVersion,
