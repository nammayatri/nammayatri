      ...
      Just
        Domain.Types.Ride.Ride
          { backendAppVersion = backendAppVersion,
            ...
            chargeableRideDuration = Kernel.Types.Common.Minutes <$> chargeableRideDurationInMinutes,
  ...
  toTType' (Domain.Types.Ride.Ride {..}) = do
    Beam.RideT
      { Beam.backendAppVersion = backendAppVersion,
        ...
        Beam.chargeableRideDurationInMinutes = chargeableRideDuration <&> (.getMinutes),
