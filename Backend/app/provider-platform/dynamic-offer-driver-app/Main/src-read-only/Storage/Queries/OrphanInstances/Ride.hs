      ...
      Just
        Domain.Types.Ride.Ride
          { bookingId = Kernel.Types.Id.Id bookingId,
            ...
            shouldRectifyDistantPointsSnapToRoadFailure = shouldRectifyDistantPointsSnapToRoadFailure,
  ...
  toTType' (Domain.Types.Ride.Ride {..}) = do
    Beam.RideT
      { Beam.bookingId = Kernel.Types.Id.getId bookingId,
        ...
        Beam.shouldRectifyDistantPointsSnapToRoadFailure = shouldRectifyDistantPointsSnapToRoadFailure,
