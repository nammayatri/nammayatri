...
findByMerchantOperatingCityIdAndVehicleType :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMerchantOperatingCityIdAndVehicleType limit offset merchantOperatingCityId vehicleType = do findAllWithOptionsKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
                                                                                                                                Se.Is Beam.vehicleType $ Se.Eq vehicleType]] (Se.Desc Beam.createdAt) limit offset
...
findByStationCodeAndMerchantOperatingCityId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByStationCodeAndMerchantOperatingCityId code merchantOperatingCityId = do findOneWithKV [Se.And [Se.Is Beam.code $ Se.Eq code,
...
updateByPrimaryKey (Domain.Types.Station.Station {..}) = do {_now <- getCurrentTime;
