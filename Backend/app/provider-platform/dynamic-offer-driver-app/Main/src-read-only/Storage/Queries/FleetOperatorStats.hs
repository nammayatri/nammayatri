...
updateCustomerCancellationCountByFleetOperatorId customerCancellationCount fleetOperatorId = do {_now <- getCurrentTime;
...
updateDistanceEarningAndCompletedRidesByFleetOperatorId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateDistanceEarningAndCompletedRidesByFleetOperatorId totalDistance totalEarning totalCompletedRides fleetOperatorId = do {_now <- getCurrentTime;
                                                                                                                             updateOneWithKV [Se.Set Beam.totalDistance (getTotalDistance totalDistance),
                                                                                                                                              Se.Set Beam.totalEarning totalEarning,
                                                                                                                                              Se.Set Beam.totalCompletedRides totalCompletedRides,
                                                                                                                                              Se.Set Beam.updatedAt _now] [Se.Is Beam.fleetOperatorId $ Se.Eq fleetOperatorId]}
...
updateDriverCancellationCountByFleetOperatorId driverCancellationCount fleetOperatorId = do {_now <- getCurrentTime;
...
updateDriverFirstSubscriptionByFleetOperatorId driverFirstSubscription fleetOperatorId = do {_now <- getCurrentTime;
...
updateInspectionCompletedByFleetOperatorId inspectionCompleted fleetOperatorId = do {_now <- getCurrentTime;
...
updateRequestCountsByFleetOperatorId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
                                        (Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Text -> m ())
updateRequestCountsByFleetOperatorId acceptationRequestCount totalRequestCount fleetOperatorId = do {_now <- getCurrentTime;
                                                                                                     updateOneWithKV [Se.Set Beam.acceptationRequestCount acceptationRequestCount,
                                                                                                                      Se.Set Beam.totalRequestCount totalRequestCount,
                                                                                                                      Se.Set Beam.updatedAt _now] [Se.Is Beam.fleetOperatorId $ Se.Eq fleetOperatorId]}
updateTotalRatingCountAndTotalRatingScoreByFleetOperatorId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
                                                              (Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Maybe Kernel.Prelude.Int -> Kernel.Prelude.Text -> m ())
updateTotalRatingCountAndTotalRatingScoreByFleetOperatorId totalRatingCount totalRatingScore fleetOperatorId = do {_now <- getCurrentTime;
                                                                                                                   updateOneWithKV [Se.Set Beam.totalRatingCount totalRatingCount,
...
updateByPrimaryKey (Domain.Types.FleetOperatorStats.FleetOperatorStats {..}) = do {_now <- getCurrentTime;
                                                                                   updateWithKV [Se.Set Beam.acceptationRequestCount acceptationRequestCount,
                                                                                                 ...
                                                                                                 Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.fleetOperatorId $ Se.Eq fleetOperatorId]]}



instance FromTType' Beam.FleetOperatorStats Domain.Types.FleetOperatorStats.FleetOperatorStats
    where fromTType' (Beam.FleetOperatorStatsT {..}) = do pure $ Just Domain.Types.FleetOperatorStats.FleetOperatorStats{acceptationRequestCount = acceptationRequestCount,
                                                                                                                         currency = currency,
                                                                                                                         ...
                                                                                                                         createdAt = createdAt,
                                                                                                                         updatedAt = updatedAt}
instance ToTType' Beam.FleetOperatorStats Domain.Types.FleetOperatorStats.FleetOperatorStats
    where toTType' (Domain.Types.FleetOperatorStats.FleetOperatorStats {..}) = do Beam.FleetOperatorStatsT{Beam.acceptationRequestCount = acceptationRequestCount,
