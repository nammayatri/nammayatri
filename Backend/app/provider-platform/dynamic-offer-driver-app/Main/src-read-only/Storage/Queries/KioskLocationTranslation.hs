...
findByKioskLocationIdAndLanguage (Kernel.Types.Id.Id kioskLocationId) language = do findOneWithKV [Se.And [Se.Is Beam.kioskLocationId $ Se.Eq kioskLocationId, Se.Is Beam.language $ Se.Eq language]]
...
findByPrimaryKey (Kernel.Types.Id.Id kioskLocationId) = do findOneWithKV [Se.And [Se.Is Beam.kioskLocationId $ Se.Eq kioskLocationId]]
