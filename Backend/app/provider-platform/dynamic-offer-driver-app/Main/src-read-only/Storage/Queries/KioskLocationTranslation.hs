...
findByKioskLocationIdAndLanguage :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByPrimaryKey (Domain.Types.KioskLocationTranslation.KioskLocationTranslation {..}) = do updateWithKV [Se.Set Beam.address address,
                                                                                                            Se.Set Beam.landmark landmark,
                                                                                                            Se.Set Beam.language language] [Se.And [Se.Is Beam.kioskLocationId $ Se.Eq (Kernel.Types.Id.getId kioskLocationId)]]



instance FromTType' Beam.KioskLocationTranslation Domain.Types.KioskLocationTranslation.KioskLocationTranslation
    where fromTType' (Beam.KioskLocationTranslationT {..}) = do pure $ Just Domain.Types.KioskLocationTranslation.KioskLocationTranslation{address = address,
                                                                                                                                           kioskLocationId = Kernel.Types.Id.Id kioskLocationId,
                                                                                                                                           landmark = landmark,
                                                                                                                                           language = language}
instance ToTType' Beam.KioskLocationTranslation Domain.Types.KioskLocationTranslation.KioskLocationTranslation
    where toTType' (Domain.Types.KioskLocationTranslation.KioskLocationTranslation {..}) = do Beam.KioskLocationTranslationT{Beam.address = address,
