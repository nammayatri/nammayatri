...
updateByPrimaryKey (Domain.Types.CancellationFarePolicy.CancellationFarePolicy {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.CancellationFarePolicy Domain.Types.CancellationFarePolicy.CancellationFarePolicy
    where fromTType' (Beam.CancellationFarePolicyT {..}) = do pure $ Just Domain.Types.CancellationFarePolicy.CancellationFarePolicy{currency = currency,
                                                                                                                                     ...
                                                                                                                                     createdAt = createdAt,
                                                                                                                                     updatedAt = updatedAt}
instance ToTType' Beam.CancellationFarePolicy Domain.Types.CancellationFarePolicy.CancellationFarePolicy
    where toTType' (Domain.Types.CancellationFarePolicy.CancellationFarePolicy {..}) = do Beam.CancellationFarePolicyT{Beam.currency = currency,
