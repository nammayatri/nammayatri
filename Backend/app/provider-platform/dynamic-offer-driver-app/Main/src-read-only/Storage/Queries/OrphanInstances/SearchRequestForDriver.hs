...
instance FromTType' Beam.SearchRequestForDriver Domain.Types.SearchRequestForDriver.SearchRequestForDriver
    where fromTType' (Beam.SearchRequestForDriverT {..}) = do {backendConfigVersion' <- (mapM Kernel.Utils.Version.readVersion (Data.Text.strip <$> backendConfigVersion));
                                                               ...
                                                               pure $ Just Domain.Types.SearchRequestForDriver.SearchRequestForDriver{acceptanceRatio = acceptanceRatio,
...
instance ToTType' Beam.SearchRequestForDriver Domain.Types.SearchRequestForDriver.SearchRequestForDriver
    where toTType' (Domain.Types.SearchRequestForDriver.SearchRequestForDriver {..}) = do Beam.SearchRequestForDriverT{Beam.acceptanceRatio = acceptanceRatio,
