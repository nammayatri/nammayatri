...
findByVideoId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
getAllVideos :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
updateByPrimaryKey (Domain.Types.LmsModuleVideoInformation.LmsModuleVideoInformation {..}) = do {_now <- getCurrentTime;
                                                                                                 updateWithKV [Se.Set Beam.moduleId (Kernel.Types.Id.getId moduleId),
                                                                                                               Se.Set Beam.rank rank,
                                                                                                               Se.Set Beam.updatedAt _now,
                                                                                                               Se.Set Beam.videoStatus videoStatus] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]}



instance FromTType' Beam.LmsModuleVideoInformation Domain.Types.LmsModuleVideoInformation.LmsModuleVideoInformation
    where fromTType' (Beam.LmsModuleVideoInformationT {..}) = do pure $ Just Domain.Types.LmsModuleVideoInformation.LmsModuleVideoInformation{createdAt = createdAt,
                                                                                                                                              id = Kernel.Types.Id.Id id,
                                                                                                                                              moduleId = Kernel.Types.Id.Id moduleId,
                                                                                                                                              rank = rank,
                                                                                                                                              updatedAt = updatedAt,
                                                                                                                                              videoStatus = videoStatus}
instance ToTType' Beam.LmsModuleVideoInformation Domain.Types.LmsModuleVideoInformation.LmsModuleVideoInformation
    where toTType' (Domain.Types.LmsModuleVideoInformation.LmsModuleVideoInformation {..}) = do Beam.LmsModuleVideoInformationT{Beam.createdAt = createdAt,
