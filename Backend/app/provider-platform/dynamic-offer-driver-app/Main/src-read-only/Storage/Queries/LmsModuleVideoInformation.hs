...
getAllVideos moduleId videoStatus = do findAllWithDb [Se.And [Se.Is Beam.moduleId $ Se.Eq (Kernel.Types.Id.getId moduleId), Se.Is Beam.videoStatus $ Se.In videoStatus]]
