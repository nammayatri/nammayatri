      ...
      Just
        Domain.Types.Merchant.Merchant
          { city = city,
            ...
            generateReferredCodeForFleet = generateReferredCodeForFleet,
            generateReferredCodeForOperator = generateReferredCodeForOperator,
  ...
  toTType' (Domain.Types.Merchant.Merchant {..}) = do
    Beam.MerchantT
      { Beam.city = city,
        ...
        Beam.generateReferredCodeForFleet = generateReferredCodeForFleet,
        Beam.generateReferredCodeForOperator = generateReferredCodeForOperator,
