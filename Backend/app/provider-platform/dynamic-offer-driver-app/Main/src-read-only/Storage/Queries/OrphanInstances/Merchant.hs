...
instance FromTType' Beam.Merchant Domain.Types.Merchant.Merchant
    where fromTType' (Beam.MerchantT {..}) = do {registryUrl' <- Kernel.Prelude.parseBaseUrl registryUrl;
                                                 pure $ Just Domain.Types.Merchant.Merchant{cipherText = cipherText,
                                                                                            city = city,
                                                                                            country = country,
                                                                                            createdAt = createdAt,
...
instance ToTType' Beam.Merchant Domain.Types.Merchant.Merchant
    where toTType' (Domain.Types.Merchant.Merchant {..}) = do Beam.MerchantT{Beam.cipherText = cipherText,
                                                                             Beam.city = city,
