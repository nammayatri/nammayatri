      ...
      Just
        Domain.Types.DriverInformation.DriverInformation
          { aadhaarNumber = Storage.Queries.Transformers.FleetOwnerInformation.mkEncryptedItem aadhaarNumberEncrypted aadhaarNumberHash,
            ...
            airportBlockExpiryTime = airportBlockExpiryTime,
            approved = approved,
            ...
            driverBankAccountDetails = (\val -> case Data.Aeson.fromJSON val of Data.Aeson.Success x -> Just x; Data.Aeson.Error _ -> Nothing) =<< driverBankAccountDetails,
            driverDob = driverDob,
            ...
            enableForAirport = Kernel.Prelude.fromMaybe Domain.Types.DriverInformation.ENABLED enableForAirport,
            enabled = enabled,
            enabledAt = enabledAt,
            enabledReasonFlag = enabledReasonFlag,
            extraFareMitigationFlag = extraFareMitigationFlag,
            firstVerifiedAt = firstVerifiedAt,
            forwardAutoAcceptEnabled = Kernel.Prelude.fromMaybe Kernel.Prelude.False forwardAutoAcceptEnabled,
            forwardAutoAcceptMode = forwardAutoAcceptMode,
            ...
            unhygienicVehicleViolationCount = unhygienicVehicleViolationCount,
            vehicleUnsafeViolationCount = vehicleUnsafeViolationCount,
            verified = verified,
  ...
  toTType' (Domain.Types.DriverInformation.DriverInformation {..}) = do
    Beam.DriverInformationT
      { Beam.aadhaarNumberEncrypted = Storage.Queries.Transformers.FleetOwnerInformation.mkFieldEncrypted aadhaarNumber,
        ...
        Beam.airportBlockExpiryTime = airportBlockExpiryTime,
        ...
        Beam.disabledReasonFlag = disabledReasonFlag,
        ...
        Beam.driverBankAccountDetails = Kernel.Prelude.toJSON <$> driverBankAccountDetails,
        ...
        Beam.enableForAirport = Kernel.Prelude.Just enableForAirport,
        Beam.enabled = enabled,
        Beam.enabledAt = enabledAt,
        Beam.enabledReasonFlag = enabledReasonFlag,
        Beam.extraFareMitigationFlag = extraFareMitigationFlag,
        Beam.firstVerifiedAt = firstVerifiedAt,
        Beam.forwardAutoAcceptEnabled = Kernel.Prelude.Just forwardAutoAcceptEnabled,
        Beam.forwardAutoAcceptMode = forwardAutoAcceptMode,
        ...
        Beam.preferredMapProvider = preferredMapProvider,
        ...
        Beam.unhygienicVehicleViolationCount = unhygienicVehicleViolationCount,
        Beam.vehicleUnsafeViolationCount = vehicleUnsafeViolationCount,
