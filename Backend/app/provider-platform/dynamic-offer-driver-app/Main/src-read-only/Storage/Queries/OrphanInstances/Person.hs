...
instance FromTType' Beam.Person Domain.Types.Person.Person
    where fromTType' (Beam.PersonT {..}) = do {backendConfigVersion' <- (mapM Kernel.Utils.Version.readVersion (Data.Text.strip <$> backendConfigVersion));
                                               ...
                                               pure $ Just Domain.Types.Person.Person{alternateMobileNumber = EncryptedHashed <$> (Encrypted <$> alternateMobileNumberEncrypted) <*> alternateMobileNumberHash,
                                                                                      ...
                                                                                      lastName = lastName,
                                                                                      maskedMobileDigits = maskedMobileDigits,
                                                                                      merchantId = Kernel.Types.Id.Id merchantId,
                                                                                      merchantOperatingCityId = merchantOperatingCityId',
                                                                                      middleName = middleName,
                                                                                      mobileCountryCode = mobileCountryCode,
                                                                                      mobileNumber = EncryptedHashed <$> (Encrypted <$> mobileNumberEncrypted) <*> mobileNumberHash,
                                                                                      nyClubConsent = nyClubConsent,
...
instance ToTType' Beam.Person Domain.Types.Person.Person
    where toTType' (Domain.Types.Person.Person {..}) = do Beam.PersonT{Beam.alternateMobileNumberEncrypted = ((alternateMobileNumber <&> unEncrypted . (.encrypted))),
                                                                       ...
                                                                       Beam.maskedMobileDigits = maskedMobileDigits,
