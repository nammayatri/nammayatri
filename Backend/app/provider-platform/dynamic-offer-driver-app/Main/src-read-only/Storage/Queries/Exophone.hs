...
findByMerchantOpCityIdServiceAndExophoneType :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMerchantOpCityIdServiceAndExophoneType merchantOperatingCityId callService exophoneType = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
