...
deleteByMerchantOpCityId merchantOperatingCityId = do deleteWithDb [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId)]
