...
updateByPrimaryKey (Domain.Types.PlaceNameCache.PlaceNameCache {..}) = do updateWithKV [Se.Set Beam.addressComponents addressComponents,
                                                                                        Se.Set Beam.formattedAddress formattedAddress,
                                                                                        Se.Set Beam.geoHash geoHash,
                                                                                        Se.Set Beam.lat lat,
                                                                                        Se.Set Beam.lon lon,
                                                                                        Se.Set Beam.placeId placeId,
                                                                                        Se.Set Beam.plusCode plusCode] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]
