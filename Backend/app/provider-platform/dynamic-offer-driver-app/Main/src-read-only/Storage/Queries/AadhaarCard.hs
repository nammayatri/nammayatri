...
findByPhoneNumberAndUpdate nameOnCard driverGender dateOfBirth aadhaarNumberHash verificationStatus driverId = do {_now <- getCurrentTime;
                                                                                                                   updateWithKV [Se.Set Beam.nameOnCard nameOnCard,
...
updateDriverImagePath driverImagePath driverId = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.AadhaarCard.AadhaarCard {..}) = do {_now <- getCurrentTime;
                                                                     updateWithKV [Se.Set Beam.aadhaarBackImageId (Kernel.Types.Id.getId <$> aadhaarBackImageId),
                                                                                   ...
                                                                                   Se.Set Beam.verificationStatus verificationStatus] [Se.And [Se.Is Beam.driverId $ Se.Eq (Kernel.Types.Id.getId driverId)]]}
