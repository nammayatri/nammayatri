...
findAllByMerchantIdAndState :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMerchantIdAndCity :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMerchantShortIdAndCity :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
