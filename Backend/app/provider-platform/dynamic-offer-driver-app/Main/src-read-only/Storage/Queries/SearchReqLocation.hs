...
updateByPrimaryKey (Domain.Types.SearchReqLocation.SearchReqLocation {..}) = do {_now <- getCurrentTime;
                                                                                 updateWithKV [Se.Set Beam.area area,
...
instance FromTType' Beam.SearchReqLocation Domain.Types.SearchReqLocation.SearchReqLocation
    where fromTType' (Beam.SearchReqLocationT {..}) = do pure $ Just Domain.Types.SearchReqLocation.SearchReqLocation{area = area,
                                                                                                                      areaCode = areaCode,
                                                                                                                      building = building,
                                                                                                                      city = city,
                                                                                                                      country = country,
...
instance ToTType' Beam.SearchReqLocation Domain.Types.SearchReqLocation.SearchReqLocation
    where toTType' (Domain.Types.SearchReqLocation.SearchReqLocation {..}) = do Beam.SearchReqLocationT{Beam.area = area,
