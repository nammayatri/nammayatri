...
updateByPrimaryKey (Domain.Types.DriverUdyam.DriverUdyam {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.DriverUdyam Domain.Types.DriverUdyam.DriverUdyam
    where fromTType' (Beam.DriverUdyamT {..}) = do pure $ Just Domain.Types.DriverUdyam.DriverUdyam{driverId = Kernel.Types.Id.Id driverId,
                                                                                                    ...
                                                                                                    createdAt = createdAt,
                                                                                                    updatedAt = updatedAt}
instance ToTType' Beam.DriverUdyam Domain.Types.DriverUdyam.DriverUdyam
    where toTType' (Domain.Types.DriverUdyam.DriverUdyam {..}) = do Beam.DriverUdyamT{Beam.driverId = Kernel.Types.Id.getId driverId,
