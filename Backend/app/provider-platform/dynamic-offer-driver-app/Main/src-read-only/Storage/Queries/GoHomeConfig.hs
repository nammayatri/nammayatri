...
updateByPrimaryKey (Domain.Types.GoHomeConfig.GoHomeConfig {..}) = do {_now <- getCurrentTime;
                                                                       updateWithKV [Se.Set Beam.activeTime activeTime,
                                                                                     ...
                                                                                     Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId)]]}



instance FromTType' Beam.GoHomeConfig Domain.Types.GoHomeConfig.GoHomeConfig
    where fromTType' (Beam.GoHomeConfigT {..}) = do pure $ Just Domain.Types.GoHomeConfig.GoHomeConfig{activeTime = activeTime,
                                                                                                       ...
                                                                                                       updatedAt = updatedAt}
instance ToTType' Beam.GoHomeConfig Domain.Types.GoHomeConfig.GoHomeConfig
    where toTType' (Domain.Types.GoHomeConfig.GoHomeConfig {..}) = do Beam.GoHomeConfigT{Beam.activeTime = activeTime,
