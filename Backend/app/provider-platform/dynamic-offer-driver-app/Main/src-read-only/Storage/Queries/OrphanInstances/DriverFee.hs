...
instance FromTType' Beam.DriverFee Domain.Types.DriverFee.DriverFee
    where fromTType' (Beam.DriverFeeT {..}) = do {merchantOperatingCityId' <- Storage.Queries.Transformers.DriverFee.getMerchantOperatingCityId merchantOperatingCityId driverId id ;
                                                  ...
                                                  pure $ Just Domain.Types.DriverFee.DriverFee{addedToFeeId = Kernel.Types.Id.Id <$> addedToFeeId,
...
instance ToTType' Beam.DriverFee Domain.Types.DriverFee.DriverFee
    where toTType' (Domain.Types.DriverFee.DriverFee {..}) = do Beam.DriverFeeT{Beam.addedToFeeId = Kernel.Types.Id.getId <$> addedToFeeId,
