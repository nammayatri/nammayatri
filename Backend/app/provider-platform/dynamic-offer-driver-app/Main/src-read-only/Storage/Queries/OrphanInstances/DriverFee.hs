      ...
      Just
        Domain.Types.DriverFee.DriverFee
          { addedToFeeId = Kernel.Types.Id.Id <$> addedToFeeId,
            ...
            dailyBaseAmount = Kernel.Prelude.fromMaybe 0 dailyBaseAmount,
            dailyBaseCount = Kernel.Prelude.fromMaybe 0 dailyBaseCount,
            ...
            payBy = payBy,
            perRideBaseAmount = Kernel.Prelude.fromMaybe 0 perRideBaseAmount,
  ...
  toTType' (Domain.Types.DriverFee.DriverFee {..}) = do
    Beam.DriverFeeT
      { Beam.addedToFeeId = Kernel.Types.Id.getId <$> addedToFeeId,
        ...
        Beam.dailyBaseAmount = Kernel.Prelude.Just dailyBaseAmount,
        Beam.dailyBaseCount = Kernel.Prelude.Just dailyBaseCount,
        ...
        Beam.payBy = payBy,
        Beam.perRideBaseAmount = Kernel.Prelude.Just perRideBaseAmount,
