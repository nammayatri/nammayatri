      ...
      Just
        Domain.Types.DriverFee.DriverFee
          { amountPaidByCoin = amountPaidByCoin,
            ...
            cashCollectedAtVendorId = cashCollectedAtVendorId,
            collectedAt = collectedAt,
            collectedBy = collectedBy,
            createdAt = createdAt,
            currency = Kernel.Prelude.fromMaybe Kernel.Types.Common.INR currency,
            driverConsideredInPayoutSettlementAt = driverConsideredInPayoutSettlementAt,
  ...
  toTType' (Domain.Types.DriverFee.DriverFee {..}) = do
    Beam.DriverFeeT
      { Beam.amountPaidByCoin = amountPaidByCoin,
        ...
        Beam.cashCollectedAtVendorId = cashCollectedAtVendorId,
        Beam.collectedAt = collectedAt,
        Beam.collectedBy = collectedBy,
        Beam.createdAt = createdAt,
        Beam.currency = Kernel.Prelude.Just currency,
        Beam.driverConsideredInPayoutSettlementAt = driverConsideredInPayoutSettlementAt,
