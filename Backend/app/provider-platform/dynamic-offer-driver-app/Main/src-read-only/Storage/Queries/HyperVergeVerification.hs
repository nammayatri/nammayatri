...
findLatestByDriverIdAndDocType :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findLatestByDriverIdAndDocType limit offset driverId docType = do findAllWithOptionsKV [Se.And [Se.Is Beam.driverId $ Se.Eq (Kernel.Types.Id.getId driverId),
                                                                                                Se.Is Beam.docType $ Se.Eq docType]] (Se.Desc Beam.createdAt) limit offset
...
updateExtractValidationStatus imageExtractionValidation requestId = do {_now <- getCurrentTime;
...
updateResponse status hypervergeResponse requestId = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Domain.Types.HyperVergeVerification.HyperVergeVerification {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.HyperVergeVerification Domain.Types.HyperVergeVerification.HyperVergeVerification
    where fromTType' (Beam.HyperVergeVerificationT {..}) = do pure $ Just Domain.Types.HyperVergeVerification.HyperVergeVerification{airConditioned = airConditioned,
                                                                                                                                     docType = docType,
                                                                                                                                     ...
                                                                                                                                     createdAt = createdAt,
                                                                                                                                     updatedAt = updatedAt}
instance ToTType' Beam.HyperVergeVerification Domain.Types.HyperVergeVerification.HyperVergeVerification
    where toTType' (Domain.Types.HyperVergeVerification.HyperVergeVerification {..}) = do Beam.HyperVergeVerificationT{Beam.airConditioned = airConditioned,
