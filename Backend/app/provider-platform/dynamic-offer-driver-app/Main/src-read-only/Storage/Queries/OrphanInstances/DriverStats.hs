...
instance FromTType' Beam.DriverStats Domain.Types.DriverStats.DriverStats
    where fromTType' (Beam.DriverStatsT {..}) = do {rating' <- Storage.Queries.Transformers.DriverStats.getRating totalRatings totalRatingScore;
                                                    pure $ Just Domain.Types.DriverStats.DriverStats{blacklistCoinEvents = blacklistCoinEvents,
                                                                                                     ...
                                                                                                     d2cReferralCount = Kernel.Prelude.fromMaybe 0 d2cReferralCount,
                                                                                                     d2dReferralCount = Kernel.Prelude.fromMaybe 0 d2dReferralCount,
...
instance ToTType' Beam.DriverStats Domain.Types.DriverStats.DriverStats
    where toTType' (Domain.Types.DriverStats.DriverStats {..}) = do Beam.DriverStatsT{Beam.blacklistCoinEvents = blacklistCoinEvents,
                                                                                      ...
                                                                                      Beam.d2cReferralCount = Kernel.Prelude.Just d2cReferralCount,
                                                                                      Beam.d2dReferralCount = Kernel.Prelude.Just d2dReferralCount,
