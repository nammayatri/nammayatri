...
findAllFeedbackByMerchantOpCityIdAndRating merchantOperatingCityId rating = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId <$> merchantOperatingCityId),
...
updateByPrimaryKey (Domain.Types.FeedbackForm.FeedbackForm {..}) = do updateWithKV [Se.Set Beam.answer answer,
