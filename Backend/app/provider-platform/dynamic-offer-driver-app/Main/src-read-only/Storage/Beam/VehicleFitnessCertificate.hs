...
data VehicleFitnessCertificateT f
    = VehicleFitnessCertificateT {applicationNumberEncrypted :: (B.C f Kernel.Prelude.Text),
...
instance B.Table VehicleFitnessCertificateT
    where data PrimaryKey VehicleFitnessCertificateT f = VehicleFitnessCertificateId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
