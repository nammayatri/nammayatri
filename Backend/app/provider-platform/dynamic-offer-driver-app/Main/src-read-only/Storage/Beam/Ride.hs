...
data RideT f = RideT
  { backendAppVersion :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text)),
    ...
    estimatedStateEntryPermitCharges :: (B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney)),
    estimatedStateEntryPermitIds :: (B.C f (Kernel.Prelude.Maybe [Kernel.Prelude.Text])),
    estimatedStateEntryPermitNames :: (B.C f (Kernel.Prelude.Maybe [Kernel.Prelude.Text])),
    ...
    stateEntryPermitConfidence :: (B.C f (Kernel.Prelude.Maybe Kernel.Types.Confidence.Confidence)),
