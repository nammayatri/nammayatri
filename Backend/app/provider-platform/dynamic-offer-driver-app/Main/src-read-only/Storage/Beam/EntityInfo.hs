...
data EntityInfoT f
    = EntityInfoT {answer :: (B.C f Kernel.Prelude.Text),
...
instance B.Table EntityInfoT
    where data PrimaryKey EntityInfoT f = EntityInfoId (B.C f Kernel.Prelude.Text) (B.C f Domain.Types.DocumentReminderHistory.EntityType) (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
