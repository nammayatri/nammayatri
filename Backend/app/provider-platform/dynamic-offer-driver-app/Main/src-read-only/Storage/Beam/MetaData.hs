...
data MetaDataT f
    = MetaDataT {appPermissions :: (B.C f (Kernel.Prelude.Maybe Data.Text.Text)),
...
instance B.Table MetaDataT
    where data PrimaryKey MetaDataT f = MetaDataId (B.C f Data.Text.Text) deriving (Generic, B.Beamable)
