...
data FleetBookingInformationT f
    = FleetBookingInformationT {amount :: (B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney)),
...
instance B.Table FleetBookingInformationT
    where data PrimaryKey FleetBookingInformationT f = FleetBookingInformationId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
