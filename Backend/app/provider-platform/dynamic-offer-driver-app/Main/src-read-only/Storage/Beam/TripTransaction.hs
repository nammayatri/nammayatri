...
data TripTransactionT f
    = TripTransactionT {allowEndingMidRoute :: (B.C f Kernel.Prelude.Bool),
...
instance B.Table TripTransactionT
    where data PrimaryKey TripTransactionT f = TripTransactionId (B.C f Data.Text.Text) deriving (Generic, B.Beamable)
