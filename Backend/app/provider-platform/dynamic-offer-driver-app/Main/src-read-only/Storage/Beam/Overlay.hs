...
data OverlayT f
    = OverlayT {actions :: (B.C f [Kernel.Prelude.Text]),
...
instance B.Table OverlayT
    where data PrimaryKey OverlayT f = OverlayId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
