...
data MessageT f
    = MessageT {messageType :: (B.C f Domain.Types.Message.MessageType),
...
instance B.Table MessageT
    where data PrimaryKey MessageT f = MessageId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
