...
data BookingT f
    = BookingT {area :: (B.C f (Kernel.Prelude.Maybe Lib.Types.SpecialLocation.Area)),
                ...
                dqDurationToPickup :: (B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.Seconds)),
                ...
                searchTryId :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text)),
...
instance B.Table BookingT
    where data PrimaryKey BookingT f = BookingId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
