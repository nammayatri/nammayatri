...
data VolunteerT f
    = VolunteerT {createdAt :: (B.C f Kernel.Prelude.UTCTime),
...
instance B.Table VolunteerT
    where data PrimaryKey VolunteerT f = VolunteerId (B.C f Data.Text.Text) (B.C f Data.Text.Text) deriving (Generic, B.Beamable)
