...
data PurchaseHistoryT f
    = PurchaseHistoryT {cash :: (B.C f Kernel.Types.Common.HighPrecMoney),
...
instance B.Table PurchaseHistoryT
    where data PrimaryKey PurchaseHistoryT f = PurchaseHistoryId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
