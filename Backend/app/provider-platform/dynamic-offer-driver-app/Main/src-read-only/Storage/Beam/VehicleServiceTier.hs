...
data VehicleServiceTierT f
    = VehicleServiceTierT {airConditionedThreshold :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Double)),
...
instance B.Table VehicleServiceTierT
    where data PrimaryKey VehicleServiceTierT f = VehicleServiceTierId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
