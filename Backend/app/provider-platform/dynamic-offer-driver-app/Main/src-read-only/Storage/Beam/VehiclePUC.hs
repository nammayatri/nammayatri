...
data VehiclePUCT f
    = VehiclePUCT {documentImageId :: (B.C f Kernel.Prelude.Text),
...
instance B.Table VehiclePUCT
    where data PrimaryKey VehiclePUCT f = VehiclePUCId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
