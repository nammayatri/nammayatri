...
data DriverInformationT f = DriverInformationT
  { aadhaarNumberEncrypted :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    ...
    isAboveActive :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    isAcRidesEnabled :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    ...
    isPriorityRidesEnabled :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
