...
data DriverInformationT f
    = DriverInformationT {aadhaarNumberEncrypted :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text)),
                          ...
                          onboardingAs :: (B.C f (Kernel.Prelude.Maybe Domain.Types.DriverInformation.OnboardingAs)),
...
instance B.Table DriverInformationT
    where data PrimaryKey DriverInformationT f = DriverInformationId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
