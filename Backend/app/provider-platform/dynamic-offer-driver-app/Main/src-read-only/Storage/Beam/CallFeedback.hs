...
data CallFeedbackT f
    = CallFeedbackT {callId :: (B.C f Kernel.Prelude.Text),
...
instance B.Table CallFeedbackT
    where data PrimaryKey CallFeedbackT f = CallFeedbackId (B.C f Kernel.Prelude.Text) (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
