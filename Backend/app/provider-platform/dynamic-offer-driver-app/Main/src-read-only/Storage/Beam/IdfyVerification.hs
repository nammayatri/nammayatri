...
data IdfyVerificationT f
    = IdfyVerificationT {airConditioned :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool)),
...
instance B.Table IdfyVerificationT
    where data PrimaryKey IdfyVerificationT f = IdfyVerificationId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
