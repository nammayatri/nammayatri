...
data LmsModuleTranslationT f
    = LmsModuleTranslationT {description :: (B.C f Kernel.Prelude.Text),
...
instance B.Table LmsModuleTranslationT
    where data PrimaryKey LmsModuleTranslationT f = LmsModuleTranslationId (B.C f Kernel.External.Types.Language) (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
