...
instance B.Table ScheduledPayoutConfigT where
  data PrimaryKey ScheduledPayoutConfigT f = ScheduledPayoutConfigId (B.C f Kernel.Prelude.Text) (B.C f Lib.Payment.Domain.Types.Common.EntityName) deriving (Generic, B.Beamable)
