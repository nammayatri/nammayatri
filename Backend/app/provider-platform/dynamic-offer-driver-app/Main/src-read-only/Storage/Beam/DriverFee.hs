...
data DriverFeeT f
    = DriverFeeT {addedToFeeId :: (B.C f (Kernel.Prelude.Maybe (Kernel.Prelude.Text))),
...
instance B.Table DriverFeeT
    where data PrimaryKey DriverFeeT f = DriverFeeId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
