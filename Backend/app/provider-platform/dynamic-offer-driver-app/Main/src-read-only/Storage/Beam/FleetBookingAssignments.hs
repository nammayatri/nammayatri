...
data FleetBookingAssignmentsT f
    = FleetBookingAssignmentsT {amount :: (B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney)),
...
instance B.Table FleetBookingAssignmentsT
    where data PrimaryKey FleetBookingAssignmentsT f = FleetBookingAssignmentsId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
