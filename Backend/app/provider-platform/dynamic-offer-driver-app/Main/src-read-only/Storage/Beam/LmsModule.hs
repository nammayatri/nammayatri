...
data LmsModuleT f
    = LmsModuleT {bonusCoinEventFunction :: (B.C f (Kernel.Prelude.Maybe Lib.DriverCoins.Types.DriverCoinsFunctionType)),
...
instance B.Table LmsModuleT
    where data PrimaryKey LmsModuleT f = LmsModuleId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
