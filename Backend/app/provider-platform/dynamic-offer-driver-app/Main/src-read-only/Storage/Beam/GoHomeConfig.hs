...
data GoHomeConfigT f
    = GoHomeConfigT {activeTime :: (B.C f Kernel.Prelude.Int),
...
instance B.Table GoHomeConfigT
    where data PrimaryKey GoHomeConfigT f = GoHomeConfigId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
