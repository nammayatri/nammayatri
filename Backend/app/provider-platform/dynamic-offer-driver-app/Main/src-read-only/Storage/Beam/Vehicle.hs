...
data VehicleT f
    = VehicleT {airConditioned :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool)),
...
instance B.Table VehicleT
    where data PrimaryKey VehicleT f = VehicleId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
