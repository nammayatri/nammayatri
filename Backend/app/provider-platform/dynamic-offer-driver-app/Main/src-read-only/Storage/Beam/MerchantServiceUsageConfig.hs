...
data MerchantServiceUsageConfigT f = MerchantServiceUsageConfigT
  { aadhaarVerificationService :: B.C f Kernel.External.AadhaarVerification.Types.AadhaarVerificationService,
    ...
    editLocationToDriver :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Notification.Types.NotificationService]),
    ...
    notifyDriverStopDetectionToDriver :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Notification.Types.NotificationService]),
    notifyEmergencyContactsToDriver :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Notification.Types.NotificationService]),
    notifyExotelCallStatusToDriver :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Notification.Types.NotificationService]),
    notifyIssueChatMessageToDriver :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Notification.Types.NotificationService]),
    notifyMarketingEventsToDriver :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Notification.Types.NotificationService]),
    notifyOnCancelToDriver :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Notification.Types.NotificationService]),
    notifyRideRelatedUpdateToDriver :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Notification.Types.NotificationService]),
    notifyScheduledRideAlertToDriver :: B.C f (Kernel.Prelude.Maybe [Kernel.External.Notification.Types.NotificationService]),
