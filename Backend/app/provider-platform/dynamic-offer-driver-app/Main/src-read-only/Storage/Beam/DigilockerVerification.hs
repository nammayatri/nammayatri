...
data DigilockerVerificationT f
    = DigilockerVerificationT {accessToken :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text)),
...
instance B.Table DigilockerVerificationT
    where data PrimaryKey DigilockerVerificationT f = DigilockerVerificationId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
