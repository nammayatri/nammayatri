...
data DriverBankAccountT f
    = DriverBankAccountT {accountId :: (B.C f Kernel.External.Payment.Stripe.Types.AccountId),
...
instance B.Table DriverBankAccountT
    where data PrimaryKey DriverBankAccountT f = DriverBankAccountId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
