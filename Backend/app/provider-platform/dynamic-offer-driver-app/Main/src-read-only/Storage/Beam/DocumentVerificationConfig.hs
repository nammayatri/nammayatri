...
data DocumentVerificationConfigT f = DocumentVerificationConfigT
  { allowLicenseTransfer :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool)),
    ...
    documentOnboardingStage :: (B.C f (Kernel.Prelude.Maybe Domain.Types.DocumentVerificationConfig.DocumentOnboardingStage)),
    documentSubGroup :: (B.C f (Kernel.Prelude.Maybe Domain.Types.DocumentVerificationConfig.DocumentSubGroup)),
