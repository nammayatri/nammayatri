...
data DocumentVerificationConfigT f
    = DocumentVerificationConfigT {allowLicenseTransfer :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool)),
...
instance B.Table DocumentVerificationConfigT
    where data PrimaryKey DocumentVerificationConfigT f
