...
data SpecialZoneQueueRequestT f
    = SpecialZoneQueueRequestT {createdAt :: (B.C f Kernel.Prelude.UTCTime),
...
instance B.Table SpecialZoneQueueRequestT
    where data PrimaryKey SpecialZoneQueueRequestT f = SpecialZoneQueueRequestId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
