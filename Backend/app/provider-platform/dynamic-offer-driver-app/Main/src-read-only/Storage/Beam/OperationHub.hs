...
data OperationHubT f
    = OperationHubT {address :: (B.C f Kernel.Prelude.Text),
...
instance B.Table OperationHubT
    where data PrimaryKey OperationHubT f = OperationHubId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
