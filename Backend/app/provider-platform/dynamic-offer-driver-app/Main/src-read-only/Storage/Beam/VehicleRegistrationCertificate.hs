...
data VehicleRegistrationCertificateT f
    = VehicleRegistrationCertificateT {airConditioned :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool)),
...
instance B.Table VehicleRegistrationCertificateT
    where data PrimaryKey VehicleRegistrationCertificateT f = VehicleRegistrationCertificateId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
