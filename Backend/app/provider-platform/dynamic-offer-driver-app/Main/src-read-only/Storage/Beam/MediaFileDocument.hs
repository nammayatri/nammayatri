...
data MediaFileDocumentT f
    = MediaFileDocumentT {creatorId :: (B.C f Kernel.Prelude.Text),
...
instance B.Table MediaFileDocumentT
    where data PrimaryKey MediaFileDocumentT f = MediaFileDocumentId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
