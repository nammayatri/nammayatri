...
data DriverSSNT f
    = DriverSSNT {driverId :: (B.C f Kernel.Prelude.Text),
...
instance B.Table DriverSSNT
    where data PrimaryKey DriverSSNT f = DriverSSNId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
