...
data StclMembershipT f
    = StclMembershipT {accountNumberEncrypted :: (B.C f Kernel.Prelude.Text),
                       ...
                       applicationCount :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int)),
                       ...
                       shareEndCount :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int)),
                       shareStartCount :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int)),
...
instance B.Table StclMembershipT
    where data PrimaryKey StclMembershipT f = StclMembershipId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
