...
data FleetRCAssociationT f
    = FleetRCAssociationT {associatedOn :: (B.C f Kernel.Prelude.UTCTime),
...
instance B.Table FleetRCAssociationT
    where data PrimaryKey FleetRCAssociationT f = FleetRCAssociationId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
