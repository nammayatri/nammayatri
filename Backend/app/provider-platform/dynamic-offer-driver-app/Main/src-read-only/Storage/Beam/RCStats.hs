...
data RCStatsT f = RCStatsT {rcId :: (B.C f Kernel.Prelude.Text), totalRides :: (B.C f Kernel.Prelude.Int), updatedAt :: (B.C f Kernel.Prelude.UTCTime)} deriving (Generic, B.Beamable)
