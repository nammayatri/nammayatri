...
data VehiclePermitT f
    = VehiclePermitT {documentImageId :: (B.C f Kernel.Prelude.Text),
...
instance B.Table VehiclePermitT
    where data PrimaryKey VehiclePermitT f = VehiclePermitId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
