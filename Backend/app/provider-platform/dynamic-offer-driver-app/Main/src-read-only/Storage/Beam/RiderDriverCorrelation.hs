...
data RiderDriverCorrelationT f
    = RiderDriverCorrelationT {createdAt :: (B.C f Kernel.Prelude.UTCTime),
...
instance B.Table RiderDriverCorrelationT
    where data PrimaryKey RiderDriverCorrelationT f = RiderDriverCorrelationId (B.C f Kernel.Prelude.Text) (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
