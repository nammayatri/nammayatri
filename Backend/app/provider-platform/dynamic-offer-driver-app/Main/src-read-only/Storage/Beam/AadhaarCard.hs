...
data AadhaarCardT f
    = AadhaarCardT {aadhaarBackImageId :: (B.C f (Kernel.Prelude.Maybe (Kernel.Prelude.Text))),
...
instance B.Table AadhaarCardT
    where data PrimaryKey AadhaarCardT f = AadhaarCardId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
