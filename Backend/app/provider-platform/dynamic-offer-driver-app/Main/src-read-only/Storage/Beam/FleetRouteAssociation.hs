...
data FleetRouteAssociationT f
    = FleetRouteAssociationT {createdAt :: (B.C f Kernel.Prelude.UTCTime),
...
instance B.Table FleetRouteAssociationT
    where data PrimaryKey FleetRouteAssociationT f = FleetRouteAssociationId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
