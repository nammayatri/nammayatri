...
data RiderDetailsT f
    = RiderDetailsT {bapId :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text)),
...
instance B.Table RiderDetailsT
    where data PrimaryKey RiderDetailsT f = RiderDetailsId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
