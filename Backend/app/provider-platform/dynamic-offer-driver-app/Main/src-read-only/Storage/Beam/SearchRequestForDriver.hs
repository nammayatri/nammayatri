...
data SearchRequestForDriverT f
    = SearchRequestForDriverT {acceptanceRatio :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Double)),
...
instance B.Table SearchRequestForDriverT
    where data PrimaryKey SearchRequestForDriverT f = SearchRequestForDriverId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
