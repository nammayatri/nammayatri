...
data ReminderT f
    = ReminderT {createdAt :: (B.C f Kernel.Prelude.UTCTime),
...
instance B.Table ReminderT
    where data PrimaryKey ReminderT f = ReminderId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
