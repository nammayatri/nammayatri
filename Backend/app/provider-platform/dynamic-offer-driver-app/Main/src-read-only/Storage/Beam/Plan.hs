...
data PlanT f = PlanT
  { airportRideSubscription :: (B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney)),
    ...
    mahilaShaktiRideSubscription :: (B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney)),
