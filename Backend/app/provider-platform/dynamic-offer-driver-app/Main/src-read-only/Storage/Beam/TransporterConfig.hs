...
data TransporterConfigT f = TransporterConfigT
  { aadhaarImageResizeConfig :: B.C f (Kernel.Prelude.Maybe Data.Aeson.Value),
    ...
    currentScheduledDisplayDays :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    ...
    favouriteDriverBufferPercentage :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Double),
