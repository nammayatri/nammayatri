...
data TransporterConfigT f = TransporterConfigT
  { aaEnabledClientSdkVersion :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    ...
    allowDisableFleetOnRejectionDoc :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    allowDlReupload :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    ...
    allowInvalidRcDeletionOnReplacement :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    ...
    authIpBlockedUntilInMins :: B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.Minutes),
    ...
    autoApproveOnAdminUpload :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    automaticRCActivationCutOff :: B.C f Kernel.Types.Common.Seconds,
    availableForRidesDailyLimit :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    availableForRidesMaxSearchRequests :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    availableForRidesTagValidityMinutes :: B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.Minutes),
    ...
    dropQarCalRadiusInKm :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Double),
    ...
    isDropLocQARCalEnabled :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    ...
    preProcessDocumentIdentifiers :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    ...
    restrictMobileUpdateToDashboard :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    ...
    scheduledRideConfig :: B.C f (Kernel.Prelude.Maybe Data.Aeson.Value),
    ...
    scheduledRideOpenToAllThresholdMinutes :: B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.Minutes),
    ...
    stripeStatusRefreshCountThreshold :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    stripeStatusRefreshCountWindow :: B.C f (Kernel.Prelude.Maybe Kernel.Types.SlidingWindowCounters.SlidingWindowOptions),
    ...
    unifiedOnboardingFlagsRecompute :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
