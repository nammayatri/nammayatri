...
data TransporterConfigT f = TransporterConfigT
  { aaEnabledClientSdkVersion :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    ...
    allowCacheDriverFlowStatus :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    ...
    driverCallingOptionConfigs :: B.C f (Kernel.Prelude.Maybe Data.Aeson.Value),
    ...
    earningsWindowSize :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    ...
    enableDriverWallet :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    ...
    gstPercentage :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Double),
    ...
    maxWalletPayoutsPerDay :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    ...
    payoutCutOffDays :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    ...
    weekStartMode :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
