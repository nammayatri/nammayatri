...
data TransporterConfigT f = TransporterConfigT
  { aadhaarImageResizeConfig :: B.C f (Kernel.Prelude.Maybe Data.Aeson.Value),
    ...
    exotelStatusCheckSchedulerExpireTime :: B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.Seconds),
    ...
    scheduledRideNotificationsExpireTime :: B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.Seconds),
