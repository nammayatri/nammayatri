...
data TransporterConfigT f = TransporterConfigT
  { aaEnabledClientSdkVersion :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    ...
    docPullAttemptWindowSec :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    docPullDedupeWindowSec :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    docPullMaxAttempts :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Integer),
    docPullThrottleWindowSec :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    docPullWebhookGraceSec :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
