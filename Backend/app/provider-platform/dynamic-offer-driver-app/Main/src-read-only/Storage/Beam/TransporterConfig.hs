...
data TransporterConfigT f
    = TransporterConfigT {aaEnabledClientSdkVersion :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text)),
...
instance B.Table TransporterConfigT
    where data PrimaryKey TransporterConfigT f = TransporterConfigId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
