...
data TransporterConfigT f = TransporterConfigT
  { aadhaarImageResizeConfig :: B.C f (Kernel.Prelude.Maybe Data.Aeson.Value),
    ...
    rideDurationDiffThresholdInMinutes :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    rideDurationDownwardsRecomputeBufferInMinutes :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    rideDurationUpwardsRecomputeBufferInMinutes :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
