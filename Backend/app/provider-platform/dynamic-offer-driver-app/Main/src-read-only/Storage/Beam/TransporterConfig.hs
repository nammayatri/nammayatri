...
data TransporterConfigT f = TransporterConfigT
  { aadhaarImageResizeConfig :: B.C f (Kernel.Prelude.Maybe Data.Aeson.Value),
    ...
    cancellationChargePerMeter :: B.C f Kernel.Types.Common.HighPrecMoney,
    cancellationChargePerSecond :: B.C f Kernel.Types.Common.HighPrecMoney,
    ...
    cancellationFeePercentage :: B.C f Kernel.Prelude.Int,
