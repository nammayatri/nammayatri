...
data SubscriptionConfigT f = SubscriptionConfigT
  { allowDriverFeeCalcSchedule :: B.C f Kernel.Prelude.Bool,
    ...
    defaultServiceTierForCategory :: B.C f (Kernel.Prelude.Maybe Data.Aeson.Value),
    ...
    enableVendorPercentageSplit :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    ...
    vendorSplitApplicableAt :: B.C f (Kernel.Prelude.Maybe Domain.Types.SubscriptionConfig.VendorSplitApplicableAt),
