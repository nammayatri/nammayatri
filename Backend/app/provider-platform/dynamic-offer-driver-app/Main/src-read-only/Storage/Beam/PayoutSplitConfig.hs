...
instance B.Table PayoutSplitConfigT where
  data PrimaryKey PayoutSplitConfigT f
    = PayoutSplitConfigId (B.C f (Kernel.Prelude.Maybe Lib.Types.SpecialLocation.Area)) (B.C f Data.Text.Text) (B.C f Domain.Types.VehicleVariant.VehicleVariant) (B.C f Data.Text.Text)
    deriving (Generic, B.Beamable)
