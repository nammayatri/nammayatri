...
data DriverPoolConfigT f = DriverPoolConfigT
  { actualDistanceThreshold :: B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.Meters),
    ...
    enableEarlyBatchAdvanceOnFullReject :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool),
    ...
    idleBulkChunkSize :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    ...
    nextBatchScheduleTime :: B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.Seconds),
    ...
    softMaxParallelSearchRequests :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    srdCountersBulkChunkSize :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
