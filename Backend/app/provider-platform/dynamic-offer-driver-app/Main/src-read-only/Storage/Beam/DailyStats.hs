...
data DailyStatsT f
    = DailyStatsT {activatedValidRides :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int)),
                   ...
                   d2dActivatedValidRides :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int)),
...
instance B.Table DailyStatsT
    where data PrimaryKey DailyStatsT f = DailyStatsId (B.C f Data.Text.Text) deriving (Generic, B.Beamable)
