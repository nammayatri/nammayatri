...
data SearchTryT f
    = SearchTryT {baseFare :: (B.C f Kernel.Types.Common.Money),
...
instance B.Table SearchTryT
    where data PrimaryKey SearchTryT f = SearchTryId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
