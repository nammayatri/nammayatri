...
data CommunicationT f
    = CommunicationT {body :: (B.C f Kernel.Prelude.Text),
...
instance B.Table CommunicationT
    where data PrimaryKey CommunicationT f = CommunicationId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
