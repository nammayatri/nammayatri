...
data FleetConfigT f
    = FleetConfigT {allowAutomaticRoundTripAssignment :: (B.C f Kernel.Prelude.Bool),
...
instance B.Table FleetConfigT
    where data PrimaryKey FleetConfigT f = FleetConfigId (B.C f Data.Text.Text) deriving (Generic, B.Beamable)
