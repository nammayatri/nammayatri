...
data IffcoTokioInsuranceT f
    = IffcoTokioInsuranceT {certificateNumber :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text)),
...
instance B.Table IffcoTokioInsuranceT
    where data PrimaryKey IffcoTokioInsuranceT f = IffcoTokioInsuranceId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
