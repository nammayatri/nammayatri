...
data LeaderBoardConfigsT f
    = LeaderBoardConfigsT {id :: (B.C f Data.Text.Text),
...
instance B.Table LeaderBoardConfigsT
    where data PrimaryKey LeaderBoardConfigsT f = LeaderBoardConfigsId (B.C f Data.Text.Text) deriving (Generic, B.Beamable)
