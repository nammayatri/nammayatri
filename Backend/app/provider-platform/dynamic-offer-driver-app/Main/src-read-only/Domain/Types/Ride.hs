...
data Ride
    = Ride {backendAppVersion :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
data OdometerReading
    = OdometerReading {fileId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id IssueManagement.Domain.Types.MediaFile.MediaFile), value :: Kernel.Types.Common.Centesimal}
