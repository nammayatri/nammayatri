...
data DriverIntelligentPoolConfigD (s :: UsageSafety)
    = DriverIntelligentPoolConfig {acceptanceRatioWeightage :: Kernel.Prelude.Int,
...
data IntelligentScores
    = IntelligentScores {acceptanceRatio :: Kernel.Prelude.Maybe Kernel.Prelude.Double,
