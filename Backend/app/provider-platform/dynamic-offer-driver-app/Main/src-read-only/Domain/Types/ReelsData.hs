...
data ReelsData
    = ReelsData {bottomButtonConfig :: [Domain.Types.ReelsData.ReelRowButtonConfig],
...
data ReelButtonConfig
    = ReelButtonConfig {actions :: Kernel.Prelude.Maybe [Kernel.Prelude.Text],
...
data ReelVideoThresholdConfig
    = ReelVideoThresholdConfig {endThreshold :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
