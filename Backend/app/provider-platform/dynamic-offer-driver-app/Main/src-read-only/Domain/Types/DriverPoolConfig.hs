...
data DriverPoolConfig = DriverPoolConfig
  { actualDistanceThreshold :: Kernel.Prelude.Maybe Kernel.Types.Common.Distance,
    ...
    driverToDestinationDistanceThreshold :: Kernel.Types.Common.Distance,
