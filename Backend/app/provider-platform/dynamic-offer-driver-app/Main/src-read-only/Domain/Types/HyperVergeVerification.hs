...
data HyperVergeVerificationE e
    = HyperVergeVerification {airConditioned :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
...
instance EncryptedItem HyperVergeVerification
    where type Unencrypted HyperVergeVerification = (DecryptedHyperVergeVerification, HashSalt)
          encryptItem (entity, salt) = do {documentNumber_ <- encryptItem (documentNumber entity, salt);
                                           pure HyperVergeVerification{airConditioned = airConditioned entity,
          ...
          decryptItem entity = do {documentNumber_ <- fst <$> decryptItem (documentNumber entity);
                                   pure (HyperVergeVerification{airConditioned = airConditioned entity,
                                                                docType = docType entity,
                                                                documentImageId1 = documentImageId1 entity,
                                                                documentImageId2 = documentImageId2 entity,
                                         ...
                                         "")}
instance EncryptedItem' HyperVergeVerification
    where type UnencryptedItem HyperVergeVerification = DecryptedHyperVergeVerification
