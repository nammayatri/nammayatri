...
data DriverLicenseE e
    = DriverLicense {classOfVehicles :: [Kernel.Prelude.Text],
...
instance EncryptedItem DriverLicense
    where type Unencrypted DriverLicense = (DecryptedDriverLicense, HashSalt)
          encryptItem (entity, salt) = do {licenseNumber_ <- encryptItem (licenseNumber entity, salt);
                                           pure DriverLicense{classOfVehicles = classOfVehicles entity,
          ...
          decryptItem entity = do {licenseNumber_ <- fst <$> decryptItem (licenseNumber entity);
                                   pure (DriverLicense{classOfVehicles = classOfVehicles entity,
                                         ...
                                         "")}
instance EncryptedItem' DriverLicense
    where type UnencryptedItem DriverLicense = DecryptedDriverLicense
