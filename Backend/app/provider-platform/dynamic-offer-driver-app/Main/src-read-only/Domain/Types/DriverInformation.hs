...
data DriverInformationE e = DriverInformation
  { aadhaarNumber :: Kernel.Prelude.Maybe (Kernel.External.Encryption.EncryptedHashedField e Kernel.Prelude.Text),
    ...
    isAboveActive :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
    isAcRidesEnabled :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
    ...
    isPriorityRidesEnabled :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
    ...
    pure
      DriverInformation
        { aadhaarNumber = aadhaarNumber_,
          ...
          isAboveActive = isAboveActive entity,
          isAcRidesEnabled = isAcRidesEnabled entity,
          ...
          isPriorityRidesEnabled = isPriorityRidesEnabled entity,
