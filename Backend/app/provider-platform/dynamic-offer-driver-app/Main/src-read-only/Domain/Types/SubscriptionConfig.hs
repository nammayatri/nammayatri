...
data SubscriptionConfig
    = SubscriptionConfig {allowDriverFeeCalcSchedule :: Kernel.Prelude.Bool,
                          ...
                          manualPaymentLinkRateLimitExpirySeconds :: Kernel.Prelude.Maybe Data.Time.NominalDiffTime,
...
data WebhookConfig
    = WebhookConfig {batchSize :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
