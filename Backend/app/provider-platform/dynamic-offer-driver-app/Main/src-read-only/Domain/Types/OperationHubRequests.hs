...
data OperationHubRequests
    = OperationHubRequests {creatorId :: Kernel.Types.Id.Id Domain.Types.Person.Person,
...
data RequestType
    = ONBOARDING_INSPECTION | REGULAR_INSPECTION | DRIVER_ONBOARDING_INSPECTION | DRIVER_REGULAR_INSPECTION
