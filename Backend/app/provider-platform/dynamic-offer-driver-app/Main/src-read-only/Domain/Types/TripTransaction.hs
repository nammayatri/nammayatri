...
data TripTransaction
    = TripTransaction {allowEndingMidRoute :: Kernel.Prelude.Bool,
...
data ActionSource
    = DriverDirect | DriverOnApproval | AutoDetect | Dashboard | ForceDashboard | CronJob | AutoRecovery
    deriving (Show, ( Eq), ( Ord), ( Read), ( Generic), ( ToJSON), ( FromJSON), ( ToSchema), ( ToParamSchema))
data EstimatedRouteDetails
    = EstimatedRouteDetails {distance :: Kernel.Prelude.Maybe Kernel.Types.Common.Meters, duration :: Kernel.Prelude.Maybe Kernel.Types.Common.Seconds, polyline :: Kernel.Prelude.Maybe Data.Text.Text}
