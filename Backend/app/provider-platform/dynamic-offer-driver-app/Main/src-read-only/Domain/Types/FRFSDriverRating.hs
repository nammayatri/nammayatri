...
module Domain.Types.FRFSDriverRating where
...
data FRFSDriverRating = FRFSDriverRating
  { bookingId :: Data.Text.Text,
    ...
    id :: Kernel.Types.Id.Id Domain.Types.FRFSDriverRating.FRFSDriverRating,
    merchantId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Domain.Types.Merchant.Merchant),
    merchantOperatingCityId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Domain.Types.MerchantOperatingCity.MerchantOperatingCity),
    operatorBadgeToken :: Data.Text.Text,
