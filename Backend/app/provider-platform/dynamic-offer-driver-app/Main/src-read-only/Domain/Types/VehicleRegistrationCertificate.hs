...
data VehicleRegistrationCertificateE e
    = VehicleRegistrationCertificate {airConditioned :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
...
instance EncryptedItem VehicleRegistrationCertificate
    where type Unencrypted VehicleRegistrationCertificate = (DecryptedVehicleRegistrationCertificate, HashSalt)
          encryptItem (entity, salt) = do {certificateNumber_ <- encryptItem (certificateNumber entity, salt);
                                           pure VehicleRegistrationCertificate{airConditioned = airConditioned entity,
          ...
          decryptItem entity = do {certificateNumber_ <- fst <$> decryptItem (certificateNumber entity);
                                   pure (VehicleRegistrationCertificate{airConditioned = airConditioned entity,
                                                                        approved = approved entity,
                                                                        certificateNumber = certificateNumber_,
                                                                        dateOfRegistration = dateOfRegistration entity,
                                         ...
                                         "")}
instance EncryptedItem' VehicleRegistrationCertificate
    where type UnencryptedItem VehicleRegistrationCertificate = DecryptedVehicleRegistrationCertificate
