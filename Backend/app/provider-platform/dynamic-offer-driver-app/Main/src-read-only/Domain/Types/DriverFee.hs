...
data DriverFee
    = DriverFee {addedToFeeId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Domain.Types.DriverFee.DriverFee),
...
data AutopayPaymentStage
    = NOTIFICATION_SCHEDULED | NOTIFICATION_ATTEMPTING | EXECUTION_SCHEDULED | EXECUTION_ATTEMPTING | EXECUTION_SUCCESS | EXECUTION_FAILED
...
data DriverFeeStatus
    ...
    deriving (Read, ( Show), ( Eq), ( Generic), ( FromJSON), ( ToJSON), ( ToSchema), ( ToParamSchema), ( Ord))
data FeeType
    = MANDATE_REGISTRATION | RECURRING_INVOICE | RECURRING_EXECUTION_INVOICE | PAYOUT_REGISTRATION | ONE_TIME_SECURITY_DEPOSIT | PREPAID_RECHARGE | WALLET_TOPUP | CANCELLATION_PENALTY
    deriving (Read, ( Show), ( Eq), ( Generic), ( FromJSON), ( ToJSON), ( ToSchema), ( ToParamSchema), ( Ord), ( Enum))
data PlatformFee
    = PlatformFee {cgst :: Kernel.Types.Common.HighPrecMoney, currency :: Kernel.Types.Common.Currency, fee :: Kernel.Types.Common.HighPrecMoney, sgst :: Kernel.Types.Common.HighPrecMoney}
    deriving (Generic, ( Eq), ( Show))
data RefundInfo
    = RefundInfo {refundEntityId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
                  refundedAmount :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
                  refundedAt :: Kernel.Prelude.Maybe Kernel.Prelude.UTCTime,
                  refundedBy :: Kernel.Prelude.Maybe Domain.Types.DriverFee.RefundedBy,
