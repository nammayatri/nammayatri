...
data DriverFee = DriverFee
  { addedToFeeId :: Kernel.Prelude.Maybe (Kernel.Types.Id.Id Domain.Types.DriverFee.DriverFee),
    ...
    dailyBaseAmount :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
    dailyBaseCount :: Kernel.Prelude.Int,
    ...
    perRideBaseAmount :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
