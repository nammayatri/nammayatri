...
data RiderDetailsE e = RiderDetails
  { bapId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    customerGender :: Kernel.Prelude.Maybe Domain.Types.Person.Gender,
    customerRating :: Kernel.Prelude.Maybe Kernel.Types.Common.Centesimal,
    customerTotalRatings :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    ...
    riderFlaggedForDriverIncentives :: Kernel.Prelude.Bool,
    ...
    pure
      RiderDetails
        { bapId = bapId entity,
          ...
          consentToShareMobileNumber = consentToShareMobileNumber entity,
          createdAt = createdAt entity,
          currency = currency entity,
          customerGender = customerGender entity,
          customerRating = customerRating entity,
          customerTotalRatings = customerTotalRatings entity,
          ...
          riderFlaggedForDriverIncentives = riderFlaggedForDriverIncentives entity,
