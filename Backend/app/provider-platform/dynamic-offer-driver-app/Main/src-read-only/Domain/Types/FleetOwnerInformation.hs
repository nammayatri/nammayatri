...
data FleetOwnerInformationE e = FleetOwnerInformation
  { aadhaarBackImageId :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    isNew :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
    latestScheduledCommissionAggregationPeriodEnd :: Kernel.Prelude.Maybe Kernel.Prelude.UTCTime,
    ...
    pure
      FleetOwnerInformation
        { aadhaarBackImageId = aadhaarBackImageId entity,
          ...
          isNew = isNew entity,
          latestScheduledCommissionAggregationPeriodEnd = latestScheduledCommissionAggregationPeriodEnd entity,
