...
data DocumentVerificationConfig
    = DocumentVerificationConfig {allowLicenseTransfer :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
...
data FieldInfo
    = FieldInfo {_type :: Domain.Types.DocumentVerificationConfig.FieldType, isMandatory :: Kernel.Prelude.Bool, name :: Kernel.Prelude.Text, regexValidation :: Kernel.Prelude.Maybe Kernel.Prelude.Text}
    deriving (Eq, Ord, Show, Read, Generic, ToJSON, FromJSON, ToSchema)
...
data SupportedVehicleClasses
    = DLValidClasses [Kernel.Prelude.Text] | RCValidClasses [Domain.Types.DocumentVerificationConfig.VehicleClassVariantMap]
    deriving (Eq, Ord, Show, Read, Generic, ToJSON, FromJSON, ToSchema)
data VehicleClassCheckType = Infix | Prefix | Suffix deriving (Eq, Ord, Show, Read, Generic, ToJSON, FromJSON, ToSchema)
data VehicleClassVariantMap
    = VehicleClassVariantMap {bodyType :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
