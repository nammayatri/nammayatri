...
data VehicleFitnessCertificateE e
    = VehicleFitnessCertificate {applicationNumber :: Kernel.External.Encryption.EncryptedHashedField e Kernel.Prelude.Text,
...
instance EncryptedItem VehicleFitnessCertificate
    where type Unencrypted VehicleFitnessCertificate = (DecryptedVehicleFitnessCertificate, HashSalt)
          encryptItem (entity, salt) = do {applicationNumber_ <- encryptItem (applicationNumber entity, salt);
                                           pure VehicleFitnessCertificate{applicationNumber = applicationNumber_,
          ...
          decryptItem entity = do {applicationNumber_ <- fst <$> decryptItem (applicationNumber entity);
                                   pure (VehicleFitnessCertificate{applicationNumber = applicationNumber_,
                                                                   categoryOfVehicle = categoryOfVehicle entity,
                                                                   documentImageId = documentImageId entity,
                                                                   driverId = driverId entity,
                                         ...
                                         "")}
instance EncryptedItem' VehicleFitnessCertificate
    where type UnencryptedItem VehicleFitnessCertificate = DecryptedVehicleFitnessCertificate
