...
data Message
    = Message {_type :: Domain.Types.Message.MessageType,
...
data MessageDict
    = MessageDict {defaultMessage :: Domain.Types.Message.RawMessage, translations :: Data.Map.Map Kernel.Prelude.Text Domain.Types.Message.RawMessage}
    deriving (Generic, Show, ToJSON, FromJSON, ToSchema)
...
data RawMessage
    = RawMessage {_type :: Domain.Types.Message.MessageType,
                  alwaysTriggerOnOnboarding :: Kernel.Prelude.Bool,
                  createdAt :: Kernel.Prelude.UTCTime,
                  description :: Kernel.Prelude.Text,
                  id :: Kernel.Types.Id.Id Domain.Types.Message.Message,
