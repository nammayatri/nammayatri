...
data PersonE e = Person
  { alternateMobileNumber :: Kernel.Prelude.Maybe (Kernel.External.Encryption.EncryptedHashedField e Kernel.Prelude.Text),
    ...
    unencryptedAlternateMobileNumber :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    ...
    pure
      Person
        { alternateMobileNumber = alternateMobileNumber_,
          ...
          unencryptedAlternateMobileNumber = unencryptedAlternateMobileNumber entity,
...
data Role = DRIVER | ADMIN deriving (Show, Eq, Ord, Read, Generic, ToJSON, FromJSON, ToSchema, ToParamSchema)
