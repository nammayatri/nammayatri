...
data QuestionInformation
    = QuestionInformation {language :: Kernel.External.Types.Language,
...
data OptionEntity
    = OptionEntity {isCorrect :: Kernel.Prelude.Bool, option :: Domain.Types.QuestionInformation.SingleOption, optionId :: Kernel.Types.Id.Id Domain.Types.QuestionInformation.OptionEntity}
