...
data FeedbackForm
    = FeedbackForm {answer :: [Kernel.Prelude.Text],
...
data BadgeDetail
    = BadgeDetail {contentWithTranslations :: Kernel.Prelude.Maybe [IssueManagement.Common.Translation],
...
data FeedbackFormAPIEntity
    = FeedbackFormAPIEntity {questions :: [Domain.Types.FeedbackForm.FeedbackQuestion], rating :: Kernel.Prelude.Maybe Kernel.Prelude.Int}
    deriving (Generic, Show, ToJSON, FromJSON, ToSchema)
data FeedbackFormItem
    = FeedbackFormItem {answer :: [Kernel.Prelude.Text],
                        answerType :: Domain.Types.FeedbackForm.AnswerType,
                        badges :: Kernel.Prelude.Maybe [Domain.Types.FeedbackForm.BadgeDetail],
                        id :: Kernel.Types.Id.Id Domain.Types.FeedbackForm.FeedbackFormItem,
                        question :: Kernel.Prelude.Text,
...
data FeedbackFormReq
    = FeedbackFormReq {feedback :: Kernel.Prelude.Maybe [Domain.Types.FeedbackForm.FeedbackAnswer], rideId :: Kernel.Types.Id.Id Domain.Types.Ride.Ride}
    deriving (Generic, Show, ToJSON, FromJSON, ToSchema)
data FeedbackQuestion
    = FeedbackQuestion {badges :: [Domain.Types.FeedbackForm.BadgeItem],
                        question :: Kernel.Prelude.Text,
