...
data LoginType = OTP | PASSWORD | OAUTH deriving (Eq, Ord, Show, Read, Generic, ToJSON, FromJSON, ToSchema)

data Medium = SMS | EMAIL deriving (Eq, Ord, Show, Read, Generic, ToJSON, FromJSON, ToSchema)
