...
data RegistrationToken
    = RegistrationToken {alternateNumberAttempts :: Kernel.Prelude.Int,
...
data Medium = SMS | EMAIL | SIGNATURE | WHATSAPP deriving (Eq, Ord, Show, Read, Generic, ToJSON, FromJSON, ToSchema)
