...
data StclMembershipE e
    = StclMembership {accountNumber :: Kernel.External.Encryption.EncryptedHashedField e Kernel.Prelude.Text,
...
instance EncryptedItem StclMembership
    where type Unencrypted StclMembership = (DecryptedStclMembership, HashSalt)
          encryptItem (entity, salt) = do {accountNumber_ <- encryptItem (accountNumber entity, salt);
                                           ...
                                           pure StclMembership{accountNumber = accountNumber_,
                                                               ...
                                                               applicationCount = applicationCount entity,
                                                               ...
                                                               shareEndCount = shareEndCount entity,
                                                               shareStartCount = shareStartCount entity,
                                                               shortId = shortId entity,
                                                               status = status entity,
                                                               termsAccepted = termsAccepted entity,
                                                               updatedAt = updatedAt entity,
                                                               vehicleType = vehicleType entity}}
          decryptItem entity = do {accountNumber_ <- fst <$> decryptItem (accountNumber entity);
                                   ...
                                   pure (StclMembership{accountNumber = accountNumber_,
                                         ...
                                         "")}
instance EncryptedItem' StclMembership
    where type UnencryptedItem StclMembership = DecryptedStclMembership
