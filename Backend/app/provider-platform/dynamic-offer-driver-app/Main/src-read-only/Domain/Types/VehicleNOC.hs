...
data VehicleNOCE e
    = VehicleNOC {documentImageId :: Kernel.Types.Id.Id Domain.Types.Image.Image,
...
instance EncryptedItem VehicleNOC
    where type Unencrypted VehicleNOC = (DecryptedVehicleNOC, HashSalt)
          encryptItem (entity, salt) = do {nocNumber_ <- encryptItem (nocNumber entity, salt);
                                           pure VehicleNOC{documentImageId = documentImageId entity,
          ...
          decryptItem entity = do {nocNumber_ <- fst <$> decryptItem (nocNumber entity);
                                   pure (VehicleNOC{documentImageId = documentImageId entity,
                                                    driverId = driverId entity,
                                                    id = id entity,
                                                    nocExpiry = nocExpiry entity,
                                         ...
                                         "")}
instance EncryptedItem' VehicleNOC
    where type UnencryptedItem VehicleNOC = DecryptedVehicleNOC
