...
data BusinessLicenseE e
    = BusinessLicense {documentImageId :: Kernel.Types.Id.Id Domain.Types.Image.Image,
...
instance EncryptedItem BusinessLicense
    where type Unencrypted BusinessLicense = (DecryptedBusinessLicense, HashSalt)
          encryptItem (entity, salt) = do {licenseNumber_ <- encryptItem (licenseNumber entity, salt);
                                           pure BusinessLicense{documentImageId = documentImageId entity,
          ...
          decryptItem entity = do {licenseNumber_ <- fst <$> decryptItem (licenseNumber entity);
                                   pure (BusinessLicense{documentImageId = documentImageId entity,
                                                         driverId = driverId entity,
                                                         id = id entity,
                                                         licenseExpiry = licenseExpiry entity,
                                         ...
                                         "")}
instance EncryptedItem' BusinessLicense
    where type UnencryptedItem BusinessLicense = DecryptedBusinessLicense
