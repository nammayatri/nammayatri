...
data FleetBookingInformationE e
    = FleetBookingInformation {amount :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
...
instance EncryptedItem FleetBookingInformation
    where type Unencrypted FleetBookingInformation = (DecryptedFleetBookingInformation, HashSalt)
          encryptItem (entity, salt) = do {customerMobileNumber_ <- encryptItem $ (, salt) <$> customerMobileNumber entity;
                                           pure FleetBookingInformation{amount = amount entity,
          ...
          decryptItem entity = do {customerMobileNumber_ <- fmap fst <$> decryptItem (customerMobileNumber entity);
                                   pure (FleetBookingInformation{amount = amount entity,
                                                                 bookedSeats = bookedSeats entity,
                                                                 bookingId = bookingId entity,
                                                                 createdAt = createdAt entity,
                                         ...
                                         "")}
instance EncryptedItem' FleetBookingInformation
    where type UnencryptedItem FleetBookingInformation = DecryptedFleetBookingInformation
