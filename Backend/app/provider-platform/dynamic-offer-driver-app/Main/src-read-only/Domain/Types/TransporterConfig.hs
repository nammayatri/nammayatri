...
data TransporterConfigD (s :: UsageSafety) = TransporterConfig
  { aaEnabledClientSdkVersion :: Kernel.Prelude.Text,
    ...
    cancellationDeductionOnNextRideAmount :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
    ...
    maxCancellationDeductionOnNextRideAmount :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
