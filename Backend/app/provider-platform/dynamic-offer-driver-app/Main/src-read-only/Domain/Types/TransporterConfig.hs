...
data TransporterConfig = TransporterConfig
  { aaEnabledClientSdkVersion :: Kernel.Prelude.Text,
    ...
    docPullAttemptWindowSec :: Kernel.Prelude.Int,
    docPullDedupeWindowSec :: Kernel.Prelude.Int,
    docPullMaxAttempts :: Kernel.Prelude.Integer,
    docPullThrottleWindowSec :: Kernel.Prelude.Int,
    docPullWebhookGraceSec :: Kernel.Prelude.Int,
