...
data TransporterConfigD (s :: UsageSafety) = TransporterConfig
  { aadhaarImageResizeConfig :: Kernel.Prelude.Maybe Domain.Types.TransporterConfig.AadhaarImageResizeConfig,
    ...
    cancellationChargePerMeter :: Kernel.Types.Common.HighPrecMoney,
    cancellationChargePerSecond :: Kernel.Types.Common.HighPrecMoney,
    ...
    cancellationFeePercentage :: Kernel.Prelude.Int,
