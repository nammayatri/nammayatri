...
data TransporterConfigD (s :: UsageSafety)
    = TransporterConfig {aaEnabledClientSdkVersion :: Kernel.Prelude.Text,
    ...
    dontAutoEnableDriver :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
                         ...
                         enableFinancialNotifications :: Kernel.Prelude.Maybe Kernel.Prelude.Bool,
...
data AnalyticsConfig
    = AnalyticsConfig {allowCacheDriverFlowStatus :: Kernel.Prelude.Bool,
...
data ArrivalTimeBufferOfVehicle
    = ArrivalTimeBufferOfVehicle {ambulance :: Kernel.Prelude.Maybe Kernel.Types.Common.Seconds,
...
data CancellationRateBasedNudgingAndBlockingConfig
    = CancellationRateBasedNudgingAndBlockingConfig {cancellationRateSlabConfig :: Kernel.Prelude.Maybe Domain.Types.TransporterConfig.CancellationRateSlabConfig,
...
data CancellationRateSlab
    = CancellationRateSlab {cancellationPercentageThreshold :: Kernel.Prelude.Int, suspensionTimeInHours :: Kernel.Prelude.Int}
    deriving (Generic, ( Show), ( ToJSON), ( FromJSON), ( ToSchema), Eq)
data CancellationRateSlabConfig
    = CancellationRateSlabConfig {dailySlabs :: [Domain.Types.TransporterConfig.SlabType], weeklySlabs :: [Domain.Types.TransporterConfig.SlabType]}
    deriving (Generic,  Show,  ToJSON,  FromJSON,  ToSchema, Eq)
...
data DashboardMediaSendingLimit
    = DashboardMediaSendingLimit {alert :: Kernel.Prelude.Int, overlay :: Kernel.Prelude.Int, sms :: Kernel.Prelude.Int, whatsapp :: Kernel.Prelude.Int}
    deriving (Generic, ( Show), ( ToJSON), ( FromJSON), ( Read), Eq)
data DemandHotspotsConfig
    = DemandHotspotsConfig {analysisDurationMinutes :: Kernel.Prelude.Int,
    ...
    deriving (Generic, ( Show), ( ToJSON), ( FromJSON), ( ToSchema), Eq)
data DistanceRecomputeConfigs
    = DistanceRecomputeConfigs {estimatedDistanceUpper :: Kernel.Types.Common.Meters, minThresholdDistance :: Kernel.Types.Common.Meters, minThresholdPercentage :: Kernel.Prelude.Int}
    deriving (Generic, ( Show), ( ToJSON), ( FromJSON), ( Read), Eq)
data DriverWalletConfig
    = DriverWalletConfig {driverWalletPayoutThreshold :: Kernel.Types.Common.HighPrecMoney,
                          earningsBalanceWarningPct :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    ...
    deriving (Generic, ( Show), ( ToJSON), ( FromJSON), ( Read), ( Eq))
data FeedbackNotificationConfig
    = FeedbackNotificationConfig {allowNotificationOnEmptyBadge :: Kernel.Prelude.Bool, enableFeedbackNotification :: Kernel.Prelude.Bool, feedbackNotificationDelayInSec :: Kernel.Prelude.Int}
    deriving (Generic, ( Show), ( ToJSON), ( FromJSON), ( Read), Eq)
data GstBreakup
    = GstBreakup {cgstPercentage :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
...
data PayoutFeeConfig
    = PayoutFeeConfig {feeType :: Domain.Types.TransporterConfig.PayoutFeeType, feeValue :: Kernel.Types.Common.HighPrecMoney}
...
data SlabType
    = SlabType {minBookingsRange :: [Kernel.Prelude.Int], penalityForCancellation :: Domain.Types.TransporterConfig.CancellationRateSlab}
    deriving (Generic, ( Show), ( ToJSON), ( FromJSON), ( ToSchema), Eq)
...
data SubscriptionConfig
    = SubscriptionConfig {finPnMaxDailyCount :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                          finPnMinTriggerThreshold :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                          fleetPrepaidSubscriptionThreshold :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
                          fleetSubscriptionBalanceWarningPct :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                          prepaidSubscriptionThreshold :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
                          subscriptionBalanceWarningPct :: Kernel.Prelude.Maybe Kernel.Prelude.Int}
    deriving (Generic, ( Show), ( ToJSON), ( FromJSON), ( Read), ( Eq))
data TaxConfig
    = TaxConfig {airportEntryFeeGst :: Kernel.Prelude.Maybe Domain.Types.TransporterConfig.GstBreakup,
