...
data DriverGstinE e
    = DriverGstin {address :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
...
instance EncryptedItem DriverGstin
    where type Unencrypted DriverGstin = (DecryptedDriverGstin, HashSalt)
          encryptItem (entity, salt) = do {gstin_ <- encryptItem (gstin entity, salt);
                                           pure DriverGstin{address = address entity,
          ...
          decryptItem entity = do {gstin_ <- fst <$> decryptItem (gstin entity);
                                   pure (DriverGstin{address = address entity,
                                                     constitutionOfBusiness = constitutionOfBusiness entity,
                                                     dateOfLiability = dateOfLiability entity,
                                                     documentImageId1 = documentImageId1 entity,
                                         ...
                                         "")}
instance EncryptedItem' DriverGstin
    where type UnencryptedItem DriverGstin = DecryptedDriverGstin
