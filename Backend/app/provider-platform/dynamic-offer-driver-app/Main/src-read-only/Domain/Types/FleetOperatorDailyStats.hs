...
data FleetOperatorDailyStats
    = FleetOperatorDailyStats {acceptationRequestCount :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                               approvedDriverRequests :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                               approvedVehicleRequests :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                               cashPlatformFees :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
                               cashTotalEarning :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
                               ...
                               fleetDriverId :: Kernel.Prelude.Text,
                               ...
                               onlineTotalEarning :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
                               pulledRequestCount :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                               rejectedDriverRequests :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                               rejectedRequestCount :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
                               rejectedVehicleRequests :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
