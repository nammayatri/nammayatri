...
data MerchantServiceUsageConfigD (s :: UsageSafety) = MerchantServiceUsageConfig
  { aadhaarVerificationService :: Kernel.External.AadhaarVerification.Types.AadhaarVerificationService,
    ...
    autoCompletePriorityList :: [Kernel.External.Maps.Types.MapsService],
    ...
    getDistancesForCancelRidePriorityList :: [Kernel.External.Maps.Types.MapsService],
    getDistancesForScheduledRides :: Kernel.External.Maps.Types.MapsService,
    getDistancesForScheduledRidesPriorityList :: [Kernel.External.Maps.Types.MapsService],
    getDistancesPriorityList :: [Kernel.External.Maps.Types.MapsService],
    getEstimatedPickupDistances :: Kernel.External.Maps.Types.MapsService,
    getEstimatedPickupDistancesPriorityList :: [Kernel.External.Maps.Types.MapsService],
    getExophone :: Kernel.External.Call.CallService,
    getPickupRoutes :: Kernel.External.Maps.Types.MapsService,
    getPickupRoutesPriorityList :: [Kernel.External.Maps.Types.MapsService],
    getPlaceDetails :: Kernel.External.Maps.Types.MapsService,
    getPlaceDetailsPriorityList :: [Kernel.External.Maps.Types.MapsService],
    getPlaceName :: Kernel.External.Maps.Types.MapsService,
    getPlaceNamePriorityList :: [Kernel.External.Maps.Types.MapsService],
    getRoutes :: Kernel.External.Maps.Types.MapsService,
    getRoutesPriorityList :: [Kernel.External.Maps.Types.MapsService],
    getTripRoutes :: Kernel.External.Maps.Types.MapsService,
    getTripRoutesPriorityList :: [Kernel.External.Maps.Types.MapsService],
