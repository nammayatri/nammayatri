...
data MerchantServiceUsageConfigD (s :: UsageSafety) = MerchantServiceUsageConfig
  { aadhaarVerificationService :: Kernel.External.AadhaarVerification.Types.AadhaarVerificationService,
    ...
    editLocationToDriver :: [Kernel.External.Notification.Types.NotificationService],
    ...
    notifyDriverStopDetectionToDriver :: [Kernel.External.Notification.Types.NotificationService],
    notifyEmergencyContactsToDriver :: [Kernel.External.Notification.Types.NotificationService],
    notifyExotelCallStatusToDriver :: [Kernel.External.Notification.Types.NotificationService],
    notifyIssueChatMessageToDriver :: [Kernel.External.Notification.Types.NotificationService],
    notifyMarketingEventsToDriver :: [Kernel.External.Notification.Types.NotificationService],
    notifyOnCancelToDriver :: [Kernel.External.Notification.Types.NotificationService],
    notifyRideRelatedUpdateToDriver :: [Kernel.External.Notification.Types.NotificationService],
    notifyScheduledRideAlertToDriver :: [Kernel.External.Notification.Types.NotificationService],
