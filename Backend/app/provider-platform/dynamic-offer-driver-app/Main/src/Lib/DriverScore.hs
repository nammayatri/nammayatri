...
createDriverStat :: (KvDbFlow m r, EsqDBReplicaFlow m r) => Currency -> Id DP.Person -> m DS.DriverStats
...
getDriverStats :: (KvDbFlow m r, EsqDBReplicaFlow m r) => Currency -> Maybe DS.DriverStats -> Id DP.Person -> Maybe HighPrecMoney -> m DS.DriverStats
