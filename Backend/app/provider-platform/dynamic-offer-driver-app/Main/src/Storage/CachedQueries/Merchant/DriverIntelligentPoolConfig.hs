...
getDriverIntelligentPoolConfigFromDB :: KvDbFlow m r => Id MerchantOperatingCity -> m (Maybe DriverIntelligentPoolConfig)
...
getConfigFromCACStrict :: KvDbFlow m r => Maybe Text -> Maybe Text -> String -> Id MerchantOperatingCity -> m (Maybe DriverIntelligentPoolConfig)
...
cacFallbackHelper :: KvDbFlow m r => Maybe Text -> Maybe Text -> String -> Id MerchantOperatingCity -> m (Maybe DriverIntelligentPoolConfig)
...
getDriverIntelligentPoolConfigFromCAC :: KvDbFlow m r => Id MerchantOperatingCity -> Maybe Text -> Maybe Text -> m (Maybe DriverIntelligentPoolConfig)
...
getConfigFromInMemory :: KvDbFlow m r => Id MerchantOperatingCity -> Maybe Text -> Maybe Text -> m (Maybe DriverIntelligentPoolConfig)
...
findByMerchantOpCityId :: KvDbFlow m r => Id MerchantOperatingCity -> Maybe Text -> Maybe Text -> m (Maybe DriverIntelligentPoolConfig)
