...
findAllByLanguage :: (Hedis.CacheFlow m r, Esq.EsqDBFlow m r) => Language -> m [(IssueCategory, Maybe IssueTranslation)]
...
findById :: (Hedis.CacheFlow m r, Esq.EsqDBFlow m r) => Id IssueCategory -> m (Maybe IssueCategory)
...
findByIdAndLanguage :: (Hedis.CacheFlow m r, Esq.EsqDBFlow m r) => Id IssueCategory -> Language -> m (Maybe (IssueCategory, Maybe IssueTranslation))
...
clearIssueCategoryByLanguageCache :: (Hedis.CacheFlow m r) => Language -> m ()
clearIssueCategoryByLanguageCache = Hedis.withCrossAppRedis . Hedis.del . makeIssueCategoryByLanguageKey

cacheAllIssueCategoryByLanguage :: (Hedis.CacheFlow m r) => Language -> [(IssueCategory, Maybe IssueTranslation)] -> m ()
...
clearIssueCategoryByIdCache :: (Hedis.CacheFlow m r) => Id IssueCategory -> m ()
clearIssueCategoryByIdCache = Hedis.withCrossAppRedis . Hedis.del . makeIssueCategoryByIdKey

cacheIssueCategoryById :: (Hedis.CacheFlow m r) => Id IssueCategory -> Maybe IssueCategory -> m ()
...
clearIssueCategoryByIdAndLanguageCache :: (Hedis.CacheFlow m r) => Id IssueCategory -> Language -> m ()
...
cacheIssueCategoryByIdAndLanguage :: (Hedis.CacheFlow m r) => Id IssueCategory -> Language -> Maybe (IssueCategory, Maybe IssueTranslation) -> m ()
