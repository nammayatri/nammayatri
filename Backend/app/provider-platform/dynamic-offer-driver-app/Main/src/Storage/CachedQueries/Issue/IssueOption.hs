...
findAllByCategoryAndLanguage :: (Hedis.CacheFlow m r, Esq.EsqDBFlow m r) => Id IssueCategory -> Language -> m [(IssueOption, Maybe IssueTranslation)]
...
findById :: (Hedis.CacheFlow m r, Esq.EsqDBFlow m r) => Id IssueOption -> m (Maybe IssueOption)
...
findByIdAndLanguage :: (Hedis.CacheFlow m r, Esq.EsqDBFlow m r) => Id IssueOption -> Language -> m (Maybe (IssueOption, Maybe IssueTranslation))
...
findByIdAndCategoryId :: (Hedis.CacheFlow m r, Esq.EsqDBFlow m r) => Id IssueOption -> Id IssueCategory -> m (Maybe IssueOption)
...
clearIssueOptionByCategoryAndLanguageCache :: (Hedis.CacheFlow m r) => Id IssueCategory -> Language -> m ()
...
cacheAllIssueOptionByCategoryAndLanguage :: (Hedis.CacheFlow m r) => Id IssueCategory -> Language -> [(IssueOption, Maybe IssueTranslation)] -> m ()
...
clearIssueOptionByIdCache :: (Hedis.CacheFlow m r) => Id IssueOption -> m ()
clearIssueOptionByIdCache = Hedis.withCrossAppRedis . Hedis.del . makeIssueOptionByIdKey

cacheIssueOptionById :: (Hedis.CacheFlow m r) => Id IssueOption -> Maybe IssueOption -> m ()
...
clearIssueOptionByIdAndLanguageCache :: (Hedis.CacheFlow m r) => Id IssueOption -> Language -> m ()
...
cacheIssueOptionByIdAndLanguage :: (Hedis.CacheFlow m r) => Id IssueOption -> Language -> Maybe (IssueOption, Maybe IssueTranslation) -> m ()
...
clearIssueOptionByIdAndIssueCategoryIdCache :: (Hedis.CacheFlow m r) => Id IssueOption -> Id IssueCategory -> m ()
...
cacheIssueOptionByIdAndIssueCategoryId :: (Hedis.CacheFlow m r) => Id IssueOption -> Id IssueCategory -> Maybe IssueOption -> m ()
