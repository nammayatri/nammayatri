...
data NearestDriversReq = NearestDriversReq
  { cityServiceTiers :: [DVST.VehicleServiceTier],
    ...
    minimumWalletPayoutAmount :: Maybe HighPrecMoney,
...
getNearestDrivers NearestDriversReq {..} = do
  ...
  driverInfos <- Int.getDriverInfosWithCond (driverLocs <&> (.driverId)) True False isRental isInterCity prepaidSubscriptionThreshold rideFare minimumWalletPayoutAmount paymentInstrument
