...
findByMerchantOpCityId :: KvDbFlow m r => Id MerchantOperatingCity -> m (Maybe MerchantServiceUsageConfig)
  ...
  toTType' MerchantServiceUsageConfig {..} = do
    BeamMSUC.MerchantServiceUsageConfigT
      { BeamMSUC.merchantId = getId merchantId,
        ...
        BeamMSUC.verificationProvidersPriorityList = verificationProvidersPriorityList
      }
