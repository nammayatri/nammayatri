      ...
      Just
        Quote
          { id = Id id,
            ...
            driverMinFee = mkAmountWithDefault driverMinFeeAmount <$> driverMinFee,
            driverMaxFee = mkAmountWithDefault driverMaxFeeAmount <$> driverMaxFee,
            driverPickUpCharge = mkAmountWithDefault driverPickUpChargeAmount <$> driverPickUpCharge,
  ...
  toTType' Quote {..} = do
    BeamQSZ.QuoteSpecialZoneT
      { BeamQSZ.id = getId id,
        ...
        BeamQSZ.driverMinFee = roundToIntegral <$> driverMinFee,
        BeamQSZ.driverMaxFee = roundToIntegral <$> driverMaxFee,
        BeamQSZ.driverPickUpCharge = roundToIntegral <$> driverPickUpCharge,
        BeamQSZ.driverMinFeeAmount = driverMinFee,
        BeamQSZ.driverMaxFeeAmount = driverMaxFee,
        BeamQSZ.driverPickUpChargeAmount = driverPickUpCharge,
