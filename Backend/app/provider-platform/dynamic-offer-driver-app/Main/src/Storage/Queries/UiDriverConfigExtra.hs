...
findUIConfig YType.UiConfigRequest {..} merchantOperatingCityId =
  findOneWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Just (getId merchantOperatingCityId)), Se.Is Beam.os $ Se.Eq os, Se.Is Beam.language $ Se.Eq language]]
    |<|>| findOneWithKV [Se.And [Se.Is Beam.os $ Se.Eq os, Se.Is Beam.language $ Se.Eq language]]
