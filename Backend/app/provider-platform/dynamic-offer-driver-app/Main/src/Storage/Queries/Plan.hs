...
findDefaultPlanByMerchantId :: MonadFlow m => Id Merchant -> m [Plan]
findDefaultPlanByMerchantId (Id merchantId) = findAllWithKV [Se.And [Se.Is BeamP.merchantId $ Se.Eq merchantId, Se.Is BeamP.planType $ Se.Eq DEFAULT]]
