...
findAllMerchantIdsByPhone :: (MonadFlow m, EsqDBFlow m r, CacheFlow m r) => Text -> m [Id DM.Merchant]
...
findAllByMerchantId :: (MonadFlow m, EsqDBFlow m r, CacheFlow m r) => Id DM.Merchant -> m [Exophone]
...
findByMerchantServiceAndExophoneType :: (MonadFlow m, EsqDBFlow m r, CacheFlow m r) => Id DM.Merchant -> CallService -> DE.ExophoneType -> m [Exophone]
...
deleteByMerchantId :: (MonadFlow m, EsqDBFlow m r, CacheFlow m r) => Id DM.Merchant -> m ()
