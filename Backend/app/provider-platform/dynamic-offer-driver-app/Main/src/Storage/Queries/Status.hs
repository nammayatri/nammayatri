...
imagesAggTableCTEbyDoctype :: KvDbFlow m r => DVC.DocumentType -> m [(Text, Int)]
...
fetchDriverDocsInfo :: KvDbFlow m r => Merchant -> CQMOC.MerchantOperatingCity -> Maybe (NonEmpty (Id Driver)) -> m [DriverDocsInfo]
