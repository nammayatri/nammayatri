      ...
      Just
        Ride
          { id = Id id,
            ...
            previousActiveTripEndPos = LatLong <$> previousActiveTripEndLat <*> previousActiveTripEndLon,
  ...
  toTType' Ride {..} =
    BeamR.RideT
      { BeamR.id = getId id,
        ...
        BeamR.previousActiveTripEndLat = lat <$> previousActiveTripEndPos,
        BeamR.previousActiveTripEndLon = lon <$> previousActiveTripEndPos,
