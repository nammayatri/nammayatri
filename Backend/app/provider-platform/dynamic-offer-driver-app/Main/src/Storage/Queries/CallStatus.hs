...
updateCallError :: KvDbFlow m r => Text -> Maybe Text -> Maybe Text -> Maybe CallService -> m ()
...
updateCallStatusWithRideId :: KvDbFlow m r => Id CallStatus -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe CallService -> m ()
