...
createFeedbackBadge :: KvDbFlow m r => FeedbackBadge -> m ()
createFeedbackBadge = createWithKV

findFeedbackBadgeForDriver :: KvDbFlow m r => Id Person -> Text -> m (Maybe FeedbackBadge)
...
updateFeedbackBadge :: KvDbFlow m r => FeedbackBadge -> Int -> m ()
...
findAllFeedbackBadgeForDriver :: KvDbFlow m r => Id Person -> m [FeedbackBadge]
