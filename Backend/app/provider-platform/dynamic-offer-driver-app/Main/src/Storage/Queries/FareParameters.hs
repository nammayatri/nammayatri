...
updateFareParameters FareParameters {..} id_ = do
  ...
  updateOneWithKV
    [ Se.Set BeamFP.driverSelectedFare $ roundToIntegral <$> driverSelectedFare,
      ...
      Se.Set BeamFP.addOnCharges addOnCharges,
  ...
  toTType' FareParameters {..} = do
    BeamFP.FareParametersT
      { BeamFP.id = getId id,
        ...
        BeamFP.discountApplicableRideFareTax = discountApplicableRideFareTax,
        BeamFP.nonDiscountApplicableRideFareTaxExclusive = nonDiscountApplicableRideFareTaxExclusive,
        BeamFP.nonDiscountApplicableRideFareTax = nonDiscountApplicableRideFareTax,
        BeamFP.tollFareTaxExclusive = tollFareTaxExclusive,
        BeamFP.tollVat = tollFareTax,
        BeamFP.cancellationFeeTaxExclusive = cancellationFeeTaxExclusive,
        BeamFP.cancellationTax = cancellationTax,
        BeamFP.parkingChargeTaxExclusive = parkingChargeTaxExclusive,
        BeamFP.parkingChargeTax = parkingChargeTax,
        BeamFP.petCharges = petCharges,
        BeamFP.driverAllowance = driverAllowance,
        BeamFP.airportConvenienceFee = airportConvenienceFee,
        ...
        BeamFP.schedulingCharge = schedulingCharge,
        ...
        BeamFP.addOnCharges = addOnCharges
      }
