...
getConfigJSON = \case
  ...
  Domain.ChallanSearchServiceConfig challanCfg -> case challanCfg of
    ChallanSearch.SignzyChallanSearch cfg -> toJSON cfg
...
getServiceName = \case
  ...
  Domain.ChallanSearchServiceConfig challanCfg -> case challanCfg of
    ChallanSearch.SignzyChallanSearch _ -> Domain.ChallanSearchService ChallanSearch.Signzy
...
mkServiceConfig configJSON serviceName = either (\err -> throwError $ InternalError ("Unable to decode MerchantServiceConfigT.configJSON: " <> show configJSON <> " Error:" <> err)) return $ case serviceName of
  ...
  Domain.ChallanSearchService ChallanSearch.Signzy -> Domain.ChallanSearchServiceConfig . ChallanSearch.SignzyChallanSearch <$> eitherValue configJSON
