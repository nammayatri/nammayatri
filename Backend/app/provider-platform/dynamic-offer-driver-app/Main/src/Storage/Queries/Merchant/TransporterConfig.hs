  ...
  toTType' TransporterConfig {..} = do
    BeamTC.TransporterConfigT
      { BeamTC.merchantId = getId merchantId,
        ...
        BeamTC.actualRideDistanceDiffThresholdIfWithinPickupDrop = actualRideDistanceDiffThresholdIfWithinPickupDrop,
        ...
        BeamTC.safetyWebhookAuthToken = safetyWebhookAuthToken,
