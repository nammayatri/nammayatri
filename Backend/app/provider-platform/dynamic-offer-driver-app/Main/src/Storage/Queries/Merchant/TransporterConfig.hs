      ...
      Just
        TransporterConfig
          { merchantId = Id merchantId,
            ...
            limitOnSendingNumberOfOverlayOnMandateFailure = limitOnSendingNumberOfOverlayOnMandateFailure,
  ...
  toTType' TransporterConfig {..} = do
    BeamTC.TransporterConfigT
      { BeamTC.merchantId = getId merchantId,
        ...
        BeamTC.limitOnSendingNumberOfOverlayOnMandateFailure = limitOnSendingNumberOfOverlayOnMandateFailure,
