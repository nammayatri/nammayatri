...
-- findById :: (MonadFlow m, MonadReader r m) => Id Person -> m (Maybe DriverLocation)
...
-- upsertGpsCoord :: (MonadFlow m, MonadReader r m) => Id Person -> LatLong -> UTCTime -> Id Merchant -> m DriverLocation
