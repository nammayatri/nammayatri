      ...
      Just
        DriverPoolConfig
          { merchantId = Id merchantId,
            ...
            goHomeToLocationRadius = goHomeToLocationRadius,
  ...
  toTType' DriverPoolConfig {..} = do
    BeamDPC.DriverPoolConfigT
      { BeamDPC.merchantId = getId merchantId,
        ...
        BeamDPC.goHomeFromLocationRadius = goHomeFromLocationRadius,
        BeamDPC.goHomeToLocationRadius = goHomeToLocationRadius,
