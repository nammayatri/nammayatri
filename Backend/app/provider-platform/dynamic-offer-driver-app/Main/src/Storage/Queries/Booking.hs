...
updateSpecialZoneOtpCodeAndOtpValidTill :: MonadFlow m => Id Booking -> Text -> UTCTime -> m ()
updateSpecialZoneOtpCodeAndOtpValidTill bookingId specialZoneOtpCode specialZoneOtpValidTill = do
  now <- getCurrentTime
  updateOneWithKV
