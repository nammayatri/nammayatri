...
findDriverFeeInRangeWithNotifcationNotSentServiceNameAndStatusByDriverIds ::
  ...
  [Id Driver] ->
  m [DriverFee]
findDriverFeeInRangeWithNotifcationNotSentServiceNameAndStatusByDriverIds merchantId merchantOperatingCityId limit startTime endTime retryCount status serviceName driverIds = do
  findAllWithOptionsKV'
    [ Se.And
        [ Se.Is BeamDF.startTime $ Se.GreaterThanOrEq startTime,
          Se.Is BeamDF.endTime $ Se.LessThanOrEq endTime,
...
findDriverFeeInRangeWithOrderNotExecutedAndPendingByServiceNameByDriverIds ::
  ...
  [Id Driver] ->
  m [DriverFee]
findDriverFeeInRangeWithOrderNotExecutedAndPendingByServiceNameByDriverIds merchantId merchantOperatingCityId limit startTime endTime serviceName driverIds = do
  findAllWithOptionsKV'
    [ Se.And
        [ Se.Is BeamDF.startTime $ Se.GreaterThanOrEq startTime,
          Se.Is BeamDF.endTime $ Se.LessThanOrEq endTime,
