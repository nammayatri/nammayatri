...
getDriverInfosWithCond :: (MonadFlow m, EsqDBFlow m r, CacheFlow m r) => [Id DP.Person] -> Bool -> Bool -> Bool -> m [DriverInfo.DriverInformation]
getDriverInfosWithCond driverLocs onlyNotOnRide onlyOnRide isRental =
  findAllWithKV
    [ Se.And
