...
-- module Storage.Beam.FarePolicy.FarePolicyRentalSlabDetails.FarePolicyRentalSlabDetails where
...
-- type FarePolicyRentalSlabsDetails = FarePolicyRentalSlabDetailsT Identity

-- type FullFarePolicyRentalSlabsDetails = (KTI.Id Domain.FarePolicy, Domain.FPRentalSlabsDetails)

-- $(enableKVPG ''FarePolicyRentalSlabDetailsT ['id] [['farePolicyId]])

-- $(mkTableInstances ''FarePolicyRentalSlabDetailsT "fare_policy_rental_slabs_details")
