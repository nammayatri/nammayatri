...
data RideT f = RideT
  { id :: B.C f Text,
    ...
    distanceCalculation1 :: B.C f (Maybe Int),
    distanceCalculation2 :: B.C f (Maybe Int)
  }
...
rideTMod =
  B.tableModification
    { id = B.fieldNamed "id",
      ...
      distanceCalculation1 = B.fieldNamed "distance_calculation1",
      distanceCalculation2 = B.fieldNamed "distance_calculation2"
    }
