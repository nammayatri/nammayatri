...
data FarePolicyT f = FarePolicyT
  { id :: B.C f Text,
    ...
    fareRecomputeCapConfig :: B.C f (Maybe Domain.FareRecomputeCapConfig),
    ...
    negotiationFareMinTolerancePct :: B.C f (Maybe Double),
    negotiationFareMaxTolerancePct :: B.C f (Maybe Double),
