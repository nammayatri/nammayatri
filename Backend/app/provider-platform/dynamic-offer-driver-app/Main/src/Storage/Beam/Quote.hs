...
data QuoteSpecialZoneT f = QuoteSpecialZoneT
  { id :: B.C f Text,
    ...
    driverMinFeeAmount :: B.C f (Maybe Common.HighPrecMoney),
    driverMaxFeeAmount :: B.C f (Maybe Common.HighPrecMoney),
    driverPickUpChargeAmount :: B.C f (Maybe Common.HighPrecMoney),
