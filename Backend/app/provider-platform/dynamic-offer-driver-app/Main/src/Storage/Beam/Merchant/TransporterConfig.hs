...
data TransporterConfigT f = TransporterConfigT
  { merchantId :: B.C f Text,
    ...
    driverFeeMandateNotificationBatchSize :: B.C f Integer,
    driverFeeMandateExecutionBatchSize :: B.C f Integer,
...
transporterConfigTMod =
  B.tableModification
    { merchantId = B.fieldNamed "merchant_id",
      ...
      driverFeeMandateNotificationBatchSize = B.fieldNamed "driver_fee_mandate_notification_batch_size",
      driverFeeMandateExecutionBatchSize = B.fieldNamed "driver_fee_mandate_execution_batch_size",
      mandateNotificationRescheduleInterval = B.fieldNamed "mandate_notification_reschedule_interval",
      mandateExecutionRescheduleInterval = B.fieldNamed "mandate_execution_reschedule_interval",
