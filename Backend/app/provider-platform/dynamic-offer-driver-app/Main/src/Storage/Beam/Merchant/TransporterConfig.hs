...
data TransporterConfigT f = TransporterConfigT
  { merchantId :: B.C f Text,
    ...
    pickupLocThresholdValue :: B.C f (Maybe HighPrecDistance),
    dropLocThresholdValue :: B.C f (Maybe HighPrecDistance),
    ...
    actualRideDistanceDiffThresholdIfWithinPickupDrop :: B.C f HighPrecMeters,
    actualRideDistanceDiffThresholdValue :: B.C f (Maybe HighPrecDistance),
    actualRideDistanceDiffThresholdIfWithinPickupDropValue :: B.C f (Maybe HighPrecDistance),
    ...
    upwardsRecomputeBufferValue :: B.C f (Maybe HighPrecDistance),
    approxRideDistanceDiffThresholdValue :: B.C f (Maybe HighPrecDistance),
    ...
    driverLocationAccuracyBufferValue :: B.C f (Maybe HighPrecDistance),
    routeDeviationThresholdValue :: B.C f (Maybe HighPrecDistance),
    ...
    nightSafetyRouteDeviationThresholdValue :: B.C f (Maybe HighPrecDistance),
    ...
    driverDistanceTravelledOnPickupThresholdOnCancelValue :: B.C f (Maybe HighPrecDistance),
    ...
    driverDistanceToPickupThresholdOnCancelValue :: B.C f (Maybe HighPrecDistance),
    ...
    arrivedStopThresholdValue :: B.C f (Maybe HighPrecDistance),
