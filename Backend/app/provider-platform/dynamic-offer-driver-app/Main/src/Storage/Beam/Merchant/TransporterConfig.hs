...
transporterConfigTMod =
  B.tableModification
    { merchantId = B.fieldNamed "merchant_id",
      ...
      driverFeeCalculatorBatchGap = B.fieldNamed "driver_fee_calculator_batch_gap",
      ...
      driverFeeCalculationTime = B.fieldNamed "driver_fee_calculation_time",
      driverFeeCalculatorBatchSize = B.fieldNamed "driver_fee_calculator_batch_size",
