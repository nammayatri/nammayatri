...
blockDriver :: ShortId DM.Merchant -> Id Common.Driver -> Common.BlockDriverReq -> FlowHandler APISuccess
blockDriver merchantShortId driverId = withFlowHandlerAPI . DDriver.blockDriver merchantShortId driverId
