...
getAllVehicleForFleet :: ShortId DM.Merchant -> Context.City -> Text -> FlowHandler Common.ListVehicleRes
getAllVehicleForFleet merchantShortId opCity = withFlowHandlerAPI . DDriver.getAllVehicleForFleet merchantShortId opCity

fleetUnlinkVehicle :: ShortId DM.Merchant -> Context.City -> Text -> Text -> Maybe Text -> Text -> FlowHandler APISuccess
...
fleetStats :: ShortId DM.Merchant -> Context.City -> Text -> FlowHandler Common.FleetStatsRes
