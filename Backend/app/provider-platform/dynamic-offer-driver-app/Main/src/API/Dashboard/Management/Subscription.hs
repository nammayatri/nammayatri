...
getPaymentHistoryEntityDetailsV2 merchantShortId opCity driverId serviceName invoiceId = do
  withFlowHandlerAPI $ DSubscription.getPaymentHistoryEntityDetails merchantShortId opCity driverId invoiceId serviceName
...
getPaymentHistoryEntityDetails merchantShortId opCity driverId invoiceId = do
  withFlowHandlerAPI $ DSubscription.getPaymentHistoryEntityDetails merchantShortId opCity driverId invoiceId DPlan.YATRI_SUBSCRIPTION
