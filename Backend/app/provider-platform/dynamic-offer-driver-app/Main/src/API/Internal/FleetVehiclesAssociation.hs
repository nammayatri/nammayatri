...
getFleetVehicleAssociation :: Maybe Text -> Text -> FlowHandler Domain.BoatFleetVehicleListRes
getFleetVehicleAssociation apiKey placeId = withFlowHandlerAPI $ do
  Domain.getFleetVehicleAssociation apiKey placeId
