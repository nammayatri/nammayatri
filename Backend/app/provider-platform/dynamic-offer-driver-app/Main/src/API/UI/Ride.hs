...
startRide (requestorId, merchantId, merchantOpCityId) rideId StartRideReq {rideOtp, point, odometerStartReading, odometerStartImage, odometerStartImageExtension} = withFlowHandlerAPI $ do
