...
fetchMedia (driverId, merchantId, merchantOpCityId) filePath = withFlowHandlerAPI $ Common.fetchMedia (cast driverId, cast merchantId, cast merchantOpCityId) filePath
...
issueMediaUpload (driverId, merchantId, merchantOpCityId) req = withFlowHandlerAPI $ Common.issueMediaUpload (cast driverId, cast merchantId, cast merchantOpCityId) req (buildIssueMediaUploadConfig merchantOpCityId)
...
updateIssueOption (driverId, merchantId, merchantOpCityId) issueReportId req = withFlowHandlerAPI $ Common.updateIssueOption issueReportId (cast driverId, cast merchantId, cast merchantOpCityId) req Common.DRIVER

deleteIssue :: (Id SP.Person, Id DM.Merchant, Id DMOC.MerchantOperatingCity) -> Id Domain.IssueReport -> FlowHandler APISuccess
deleteIssue (driverId, merchantId, merchantOpCityId) issueReportId = withFlowHandlerAPI $ Common.deleteIssue issueReportId (cast driverId, cast merchantId, cast merchantOpCityId) Common.DRIVER
...
getIssueCategory (driverId, merchantId, merchantOpCityId) language = withFlowHandlerAPI $ Common.getIssueCategory (cast driverId, cast merchantId, cast merchantOpCityId) language driverIssueHandle Common.DRIVER
...
getIssueOption (driverId, merchantId, merchantOpCityId) issueCategoryId issueOptionId issueReportId language = withFlowHandlerAPI $ Common.getIssueOption (cast driverId, cast merchantId, cast merchantOpCityId) issueCategoryId issueOptionId issueReportId language driverIssueHandle Common.DRIVER
