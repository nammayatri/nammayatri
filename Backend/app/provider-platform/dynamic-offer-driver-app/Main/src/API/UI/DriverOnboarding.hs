...
verifyPan (personId, merchantId, merchantOpCityId) req = withFlowHandlerAPI $ do
  _ <- DriverOnboarding.verifyPan False Nothing (personId, merchantId, merchantOpCityId) req Nothing
  pure Success
...
verifyGstin (personId, merchantId, merchantOpCityId) req = withFlowHandlerAPI $ do
  _ <- DriverOnboarding.verifyGstin False Nothing (personId, merchantId, merchantOpCityId) req Nothing
  pure Success
...
verifyAadhaar (personId, merchantId, merchantOpCityId) req = withFlowHandlerAPI $ do
  _ <- DriverOnboarding.verifyAadhaar False Nothing (personId, merchantId, merchantOpCityId) req Nothing
  pure Success
