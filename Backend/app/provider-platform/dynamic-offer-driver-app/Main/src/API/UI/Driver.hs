...
setRental :: (Id SP.Person, Id Merchant.Merchant) -> Bool -> FlowHandler APISuccess
setRental (personId, driverId) = withFlowHandlerAPI . DDriver.setRental (personId, driverId) -- TODO:RENTAL We should add city here also ?
