  ...
  "org" :> "driver"
    ...
    :<|> "driver"
      :> ( "setActivity"
             ...
             :<|> "plan"
               :> TokenAuth
               :> Get '[JSON] DDriver.DriverPlanResp
         )
...
getDriverPlan :: (Id SP.Person, Id Merchant.Merchant) -> FlowHandler DDriver.DriverPlanResp
getDriverPlan = withFlowHandlerAPI . DDriver.getDriverPlan
