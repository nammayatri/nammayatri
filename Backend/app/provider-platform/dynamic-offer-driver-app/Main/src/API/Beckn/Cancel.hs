    ...
    DCancel.CancelRide cancelRideReq -> do
      ...
      case cancelStatus of
        ...
        Just Enums.SOFT_CANCEL -> do
          ...
          cancellationCharges <- maybe (return Nothing) (\ride -> DCancel.getCancellationCharges booking ride (DTCR.CancellationReasonCode <$> cancelRideReq.cancellationReason) DCancel.CustomerCancellationCharge) mbRide
