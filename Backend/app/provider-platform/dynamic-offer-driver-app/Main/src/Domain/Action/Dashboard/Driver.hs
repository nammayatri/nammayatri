...
driverDocumentsInfo :: ShortId DM.Merchant -> City.City -> Flow Common.DriverDocumentsInfoRes
...
---------------------------------------------------------------------
listDrivers :: ShortId DM.Merchant -> City.City -> Maybe Int -> Maybe Int -> Maybe Bool -> Maybe Bool -> Maybe Bool -> Maybe Bool -> Maybe Text -> Maybe Text -> Flow Common.DriverListRes
...
getDriverDue :: ShortId DM.Merchant -> City.City -> Maybe Text -> Text -> Flow [Common.DriverOutstandingBalanceResp] -- add mig and totalFee
...
---------------------------------------------------------------------
driverAadhaarInfo :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Flow Common.DriverAadhaarInfoRes
...
---------------------------------- -----------------------------------
driverActivity :: ShortId DM.Merchant -> City.City -> Flow Common.DriverActivityRes
driverActivity merchantShortId _ = do
  merchant <- findMerchantByShortId merchantShortId
  Common.mkDriverActivityRes <$> B.runInReplica (QDriverInfo.countDrivers merchant.id)

---------------------------------------------------------------------
enableDriver :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Flow APISuccess
...
---------------------------------------------------------------------
disableDriver :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Flow APISuccess
...
blockDriverWithReason :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Common.BlockDriverWithReasonReq -> Flow APISuccess
...
blockDriver :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Flow APISuccess
...
---------------------------------------------------------------------
collectCash :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Text -> Flow APISuccess
collectCash = recordPayment False

---------------------------------------------------------------------

exemptCash :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Text -> Flow APISuccess
...
recordPayment :: Bool -> ShortId DM.Merchant -> City.City -> Id Common.Driver -> Text -> Flow APISuccess
...
---------------------------------------------------------------------
unblockDriver :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Flow APISuccess
...
driverLocation :: ShortId DM.Merchant -> City.City -> Maybe Int -> Maybe Int -> Common.DriverIds -> Flow Common.DriverLocationRes
...
driverInfo :: ShortId DM.Merchant -> City.City -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> Text -> Bool -> Flow Common.DriverInfoRes
...
---------------------------------------------------------------------
deleteDriver :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Flow APISuccess
deleteDriver merchantShortId _ = DeleteDriver.deleteDriver merchantShortId . cast

---------------------------------------------------------------------
unlinkVehicle :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Flow APISuccess
...
---------------------------------------------------------------------
updatePhoneNumber :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Common.UpdatePhoneNumberReq -> Flow APISuccess
...
---------------------------------------------------------------------
addVehicle :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Common.AddVehicleReq -> Flow APISuccess
...
addVehicleForFleet :: ShortId DM.Merchant -> City.City -> Text -> Maybe Text -> Text -> Common.AddVehicleReq -> Flow APISuccess
...
---------------------------------------------------------------------
getAllVehicleForFleet :: ShortId DM.Merchant -> City.City -> Text -> Flow Common.ListVehicleRes
...
---------------------------------------------------------------------
updateDriverName :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Common.UpdateDriverNameReq -> Flow APISuccess
...
---------------------------------------------------------------------
unlinkDL :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Flow APISuccess
...
---------------------------------------------------------------------
unlinkAadhaar :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Flow APISuccess
...
---------------------------------------------------------------------
endRCAssociation :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Flow APISuccess
...
setRCStatus :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Common.RCStatusReq -> Flow APISuccess
...
deleteRC :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Common.DeleteRCReq -> Flow APISuccess
...
getPaymentHistory :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Maybe INV.InvoicePaymentMode -> Maybe Int -> Maybe Int -> Flow Driver.HistoryEntityV2
...
getPaymentHistoryEntityDetails :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Id INV.Invoice -> Flow Driver.HistoryEntryDetailsEntityV2
...
updateSubscriptionDriverFeeAndInvoice :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Common.SubscriptionDriverFeesAndInvoicesToUpdate -> Flow Common.SubscriptionDriverFeesAndInvoicesToUpdate
...
---------------------------------------------------------------------
clearOnRideStuckDrivers :: ShortId DM.Merchant -> City.City -> Maybe Int -> Flow Common.ClearOnRideStuckDriversRes
...
---------------------------------------------------------------------
getDriverHomeLocation :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Flow Common.GetHomeLocationsRes
...
updateDriverHomeLocation :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Common.UpdateDriverHomeLocationReq -> Flow APISuccess
...
incrementDriverGoToCount :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Flow APISuccess
...
---------------------------------------------------------------------
driverAadhaarInfoByPhone :: ShortId DM.Merchant -> City.City -> Text -> Flow Common.DriverAadhaarInfoByPhoneReq
...
---------------------------------------------------------------------
updateByPhoneNumber :: ShortId DM.Merchant -> City.City -> Text -> Common.UpdateDriverDataReq -> Flow APISuccess
...
fleetUnlinkVehicle :: ShortId DM.Merchant -> City.City -> Text -> Text -> Maybe Text -> Text -> Flow APISuccess
...
fleetRemoveVehicle :: ShortId DM.Merchant -> City.City -> Text -> Text -> Flow APISuccess
...
fleetStats :: ShortId DM.Merchant -> City.City -> Text -> Flow Common.FleetStatsRes
