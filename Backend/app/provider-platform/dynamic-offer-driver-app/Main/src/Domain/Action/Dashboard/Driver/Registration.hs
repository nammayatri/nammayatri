...
documentsList :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Flow Common.DocumentsListResponse
...
getDocument :: ShortId DM.Merchant -> City.City -> Id Common.Image -> Flow Common.GetDocumentResponse
...
uploadDocument :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Common.UploadDocumentReq -> Flow Common.UploadDocumentResp
...
registerDL :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Common.RegisterDLReq -> Flow APISuccess
...
registerRC :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Common.RegisterRCReq -> Flow APISuccess
...
generateAadhaarOtp :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Common.GenerateAadhaarOtpReq -> Flow Common.GenerateAadhaarOtpRes
...
verifyAadhaarOtp :: ShortId DM.Merchant -> City.City -> Id Common.Driver -> Common.VerifyAadhaarOtpReq -> Flow Common.VerifyAadhaarOtpRes
...
auth :: ShortId DM.Merchant -> City.City -> Common.AuthReq -> Flow Common.AuthRes
