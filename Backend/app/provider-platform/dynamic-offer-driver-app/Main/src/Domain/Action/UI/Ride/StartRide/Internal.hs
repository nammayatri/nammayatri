...
startRideTransaction :: (MonadFlow m, CacheFlow m r, EsqDBFlow m r, EventStreamFlow m r, HasField "enableLocationTrackingService" r Bool) => Id SP.Person -> SRide.Ride -> SRB.Booking -> LatLong -> Maybe Int -> m ()
