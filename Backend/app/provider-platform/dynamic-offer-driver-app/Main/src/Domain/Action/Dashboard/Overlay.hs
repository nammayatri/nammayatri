...
createOverlay :: ShortId DM.Merchant -> City.City -> CreateOverlayReq -> Flow APISuccess
...
deleteOverlay :: ShortId DM.Merchant -> City.City -> DeleteOverlayReq -> Flow APISuccess
...
listOverlay :: ShortId DM.Merchant -> City.City -> Flow ListOverlayResp
...
overlayInfo :: ShortId DM.Merchant -> City.City -> OverlayInfoReq -> Flow OverlayInfoResp
...
scheduleOverlay :: ShortId DM.Merchant -> City.City -> ScheduleOverlay -> Flow APISuccess
