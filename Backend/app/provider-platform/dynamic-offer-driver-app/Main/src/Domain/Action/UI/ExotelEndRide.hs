...
callBasedEndRide :: (EsqDBFlow m r, CacheFlow m r, HasField "enableAPILatencyLogging" r Bool, HasField "enableAPIPrometheusMetricLogging" r Bool, HasFlowEnv m r '["smsCfg" ::: SmsConfig], EncFlow m r, HasField "esqDBEnv" r EsqDBEnv, HasField "loggerEnv" r LoggerEnv) => EndRide.ServiceHandle m -> Id Merchant -> DbHash -> Text -> m AckResp
