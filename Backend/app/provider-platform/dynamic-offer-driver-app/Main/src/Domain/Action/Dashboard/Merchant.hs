...
merchantUpdate merchantShortId req = do
  ...
  Esq.runTransaction $ do
    ...
    whenJust req.fcmConfig $
      \fcmConfig -> CQTC.updateFCMConfig @Flow merchant.id fcmConfig.fcmUrl fcmConfig.fcmServiceAccount
...
mapsServiceConfigUpdate merchantShortId req = do
  ...
  Esq.runTransaction $ CQMSC.upsertMerchantServiceConfig @Flow merchantServiceConfig
