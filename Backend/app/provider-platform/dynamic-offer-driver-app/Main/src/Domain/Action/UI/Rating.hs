...
rating :: (EsqDBFlow m r, EsqDBReplicaFlow m r, CoreMetrics m, HasFlowEnv m r '["appBackendBapInternal" ::: AppBackendBapInternal]) => CallBAPInternal.FeedbackReq -> m APISuccess
rating request = do
