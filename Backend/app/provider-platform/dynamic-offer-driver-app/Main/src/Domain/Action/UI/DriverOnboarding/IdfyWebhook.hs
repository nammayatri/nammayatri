...
onVerify rsp respDump = do
  ...
  where
    ...
    makeVerificationReqRecord :: IV.IdfyVerification -> SLogicOnboarding.VerificationReqRecord
    makeVerificationReqRecord IV.IdfyVerification {..} =
      SLogicOnboarding.VerificationReqRecord
        { id = id.getId,
