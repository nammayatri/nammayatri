...
addLinkAsMedia :: ShortId DM.Merchant -> City.City -> Common.AddLinkAsMedia -> Flow Common.UploadFileResponse
...
uploadFile :: ShortId DM.Merchant -> City.City -> Common.UploadFileRequest -> Flow Common.UploadFileResponse
...
addMessage :: ShortId DM.Merchant -> City.City -> Common.AddMessageRequest -> Flow Common.AddMessageResponse
...
sendMessage :: ShortId DM.Merchant -> City.City -> Common.SendMessageRequest -> Flow APISuccess
...
messageList :: ShortId DM.Merchant -> City.City -> Maybe Int -> Maybe Int -> Flow Common.MessageListResponse
...
messageInfo :: ShortId DM.Merchant -> City.City -> Id Domain.Message -> Flow Common.MessageInfoResponse
...
messageDeliveryInfo :: ShortId DM.Merchant -> City.City -> Id Domain.Message -> Flow Common.MessageDeliveryInfoResponse
...
messageReceiverList :: ShortId DM.Merchant -> City.City -> Id Domain.Message -> Maybe Text -> Maybe Common.MessageDeliveryStatus -> Maybe Int -> Maybe Int -> Flow Common.MessageReceiverListResponse
