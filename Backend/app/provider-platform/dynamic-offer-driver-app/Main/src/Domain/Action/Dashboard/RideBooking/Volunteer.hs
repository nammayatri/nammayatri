...
getVolunteerBooking merchantShortId opCity otpCode = do
  ...
  where
    ...
    convertVehicleVariant DVST.EV_HATCHBACK = Common.EV_HATCHBACK
...
postVolunteerAssignStartOtpRide _ _ _mbRequestorId Common.AssignCreateAndStartOtpRideAPIReq {..} = do
