...
setDriverMode apiKey req = do
  ...
  void $ do
    ...
    processingChangeOnline (driverId, driver.merchantId, driver.merchantOperatingCityId) transporterConfig.timeDiffFromUtc transporterConfig.maxOnlineDurationDays driverInfo $ Just mode
  pure Success
