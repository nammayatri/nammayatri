...
updateDriverDailyZscore :: (Esq.EsqDBFlow m r, Esq.EsqDBReplicaFlow m r, Metrics.CoreMetrics m, CacheFlow m r, Hedis.HedisFlow m r, MonadFlow m) => Id DP.Person -> Day -> Maybe Double -> Maybe Meters -> Id Merchant -> LConfig.DriverLeaderBoardType -> Bool -> m ()
...
updateDriverWeeklyZscore :: (Esq.EsqDBFlow m r, Esq.EsqDBReplicaFlow m r, Metrics.CoreMetrics m, CacheFlow m r, Hedis.HedisFlow m r, MonadFlow m) => Id DP.Person -> Day -> Day -> Day -> Maybe Double -> Maybe Meters -> Id Merchant -> LConfig.DriverLeaderBoardType -> Bool -> m ()
