...
redeemCoins driverId merchantId merchantOpCityId transporterConfig vehCategory driver calculatedAmount = do
  ...
  void $ DPayment.createPayoutService (cast merchantId) (Just $ cast merchantOpCityId) (cast driverId) (Just [driverId.getId]) (Just entityName) (show merchantOperatingCity.city) createPayoutOrderReq createPayoutOrderCall
