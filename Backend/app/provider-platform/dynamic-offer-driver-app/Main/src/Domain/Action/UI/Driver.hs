        ...
        Accept -> do
          ...
          (fareParams, driverExtraFee) <- case organization.farePolicyType of
            Fare.SLAB -> do
              ...
              fareParams <- calculateFare organization.id (Right slabFarePolicy) sReq.estimatedDistance sReqFD.startTime mbOfferedFare sReq.customerExtraFee Nothing
            ...
            Fare.NORMAL -> do
              ...
              fareParams <- calculateFare organization.id (Left farePolicy) sReq.estimatedDistance sReqFD.startTime mbOfferedFare sReq.customerExtraFee Nothing
