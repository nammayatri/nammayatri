  ...
  withLogTag ("personId_" <> personId.getId) $ do
    case channel of
      SMS -> do
        ...
        (mbSender, message, templateId) <- MessageBuilder.buildGenericMessage merchantOpCityId (Just driverLanguage) mkey mbVehicleCategory MessageBuilder.BuildGenericMessageReq {}
