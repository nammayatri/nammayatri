...
getDriverOperatorList merchantShortId opCity isActive verified limit offset requestorId = do
  error "Client call .driverDSL.getDriverOperatorList for separate helperApi couldn't be autogenerated. Logic yet to be decided" merchantShortId opCity isActive verified limit offset requestorId
