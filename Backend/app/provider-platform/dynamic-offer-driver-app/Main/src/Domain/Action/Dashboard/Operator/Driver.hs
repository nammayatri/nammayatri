    ...
    case (opHubReq.requestStatus, reqDomainStatus) of
      ...
      _ -> do
        ...
        whenJust req.responses $ \responses -> do
          ...
          void $ SQOHR.updateInspectionResponse (Just (Data.Aeson.toJSON responses)) (Kernel.Types.Id.Id req.operationHubRequestId)
  ...
  pure $
    API.Types.ProviderPlatform.Operator.Driver.OperationHubDriverRequest
      { id = hubReq.id.getId,
        ...
        inspectionResponse = hubReq.inspectionResponse
      }
