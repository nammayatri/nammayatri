...
processMerchantCreateRequest merchantShortId opCity canCreateMerchant req@Dashboard.Common.Merchant.CreateMerchantOperatingCityReq {..} = do
  ...
  res <-
    Domain.Action.Dashboard.Management.Merchant.postMerchantConfigOperatingCityCreate
      merchantShortId
      opCity
...
postMerchantSpecialLocationUpsert a5 a4 _a3 a2 req@Dashboard.Common.Merchant.UpsertSpecialLocationReq {..} = do
  ...
  Domain.Action.Dashboard.Management.Merchant.postMerchantSpecialLocationUpsert a5 a4 a2 Dashboard.Common.Merchant.UpsertSpecialLocationReqT {geom = geom, ..}
...
postMerchantSpecialLocationGatesUpsert a5 a4 _a3 a2 req@Dashboard.Common.Merchant.UpsertSpecialLocationGateReq {..} = do
  geom <- maybe (pure Nothing) mkGeom req.file
  Domain.Action.Dashboard.Management.Merchant.postMerchantSpecialLocationGatesUpsert a5 a4 a2 Dashboard.Common.Merchant.UpsertSpecialLocationGateReqT {geom = geom, ..}
