...
data DriverRideRes = DriverRideRes
  { id :: Id DRide.Ride,
    ...
    estimatedStateEntryPermitCharges :: Maybe HighPrecMoney,
    ...
    estimatedStateEntryPermitChargesWithCurrency :: Maybe PriceAPIEntity,
  ...
  return $
    DriverRideRes
      { id = ride.id,
        ...
        estimatedStateEntryPermitCharges = fareParams.stateEntryPermitCharges,
        ...
        stateEntryPermitConfidence = ride.stateEntryPermitConfidence,
        ...
        estimatedStateEntryPermitChargesWithCurrency = flip PriceAPIEntity fareParams.currency <$> fareParams.stateEntryPermitCharges,
        ...
        stateEntryPermitChargesWithCurrency = flip PriceAPIEntity ride.currency <$> ride.stateEntryPermitCharges,
