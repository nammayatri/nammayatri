...
data TransporterConfigD u = TransporterConfig
  { merchantId :: Id Merchant,
    ...
    pickupLocThreshold :: Distance,
    dropLocThreshold :: Distance,
    ...
    actualRideDistanceDiffThreshold :: Distance,
    actualRideDistanceDiffThresholdIfWithinPickupDrop :: Distance,
    recomputeIfPickupDropNotOutsideOfThreshold :: Bool,
    upwardsRecomputeBuffer :: Distance,
    approxRideDistanceDiffThreshold :: Distance,
    ...
    driverLocationAccuracyBuffer :: Distance,
    routeDeviationThreshold :: Distance,
