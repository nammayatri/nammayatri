...
mkVehicleAgeTagGroupV2 :: Maybe Double -> Maybe [Spec.TagGroup]
...
convertQuoteToPricing specialLocationName (DQuote.Quote {..}, serviceTier, mbDriverLocations) =
  Pricing
    { pricingId = id.getId,
      pricingMaxFare = fromMaybe estimatedFare maxEstimatedFare,
      pricingMinFare = fromMaybe estimatedFare minEstimatedFare,
