...
tfCatalog res = do
  ...
  catalogProviders_ <- tfCatalogProviders res <&> Data.List.singleton <&> Just
...
tfVehicle pricing = do
  ...
  let vehicleVariant_ = Beckn.OnDemand.Utils.Common.castVariant pricing.vehicleVariant & Just
