        ...
        DFParams.Progressive ->
          title
            `elem` [ Just (show Enums.BASE_FARE),
                     ...
                     Just (show Enums.SCHEDULING_CHARGE),
  ...
  Just
    [ Spec.Item
        { itemDescriptor = Utils.tfItemDescriptor booking,
          ...
          itemTags = Utils.mkRateCardTag estimatedDistance booking.fareParams.customerCancellationDues Nothing booking.estimatedFare booking.fareParams.congestionChargeViaDp mbFarePolicy Nothing Nothing Nothing (not $ null booking.stops),
          itemAddOns = Nothing,
