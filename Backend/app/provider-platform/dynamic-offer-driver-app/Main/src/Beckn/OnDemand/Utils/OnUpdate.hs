  ...
  Just
    [ Spec.Item
        { itemDescriptor = Utils.tfItemDescriptor booking,
          ...
          itemTags = Utils.mkRateCardTag estimatedDistance booking.fareParams.customerCancellationDues Nothing Nothing booking.estimatedFare booking.fareParams.congestionChargeViaDp mbFarePolicy Nothing Nothing Nothing
        }
    ]
