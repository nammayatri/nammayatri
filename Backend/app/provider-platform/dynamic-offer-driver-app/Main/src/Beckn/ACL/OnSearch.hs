...
mkStartInfoV2 :: DSearch.DSearchRes -> OS.Stops
mkStartInfoV2 dReq =
  OS.Stops
    { location =
        OS.Location
...
mkStopInfoV2 :: DSearch.DSearchRes -> OS.Stops
mkStopInfoV2 res =
  OS.Stops
    { location =
        OS.Location
...
mkQuoteEntitiesV2 :: OS.Stops -> OS.Stops -> DM.Merchant -> DSearch.EstimateInfo -> QuoteEntitiesV2
...
mkQuoteEntitiesSpecialZoneV2 :: OS.Stops -> OS.Stops -> DM.Merchant -> DSearch.SpecialZoneQuoteInfo -> QuoteEntitiesV2
