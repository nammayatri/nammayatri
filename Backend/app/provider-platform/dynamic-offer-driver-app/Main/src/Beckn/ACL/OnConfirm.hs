...
mkFulfillmentInfo :: DL.Location -> DL.Location -> UTCTime -> OnConfirm.FulfillmentInfo
...
mkSpecialZoneFulfillmentInfo :: DL.Location -> DL.Location -> UTCTime -> Text -> OnConfirm.FulfillmentInfo
