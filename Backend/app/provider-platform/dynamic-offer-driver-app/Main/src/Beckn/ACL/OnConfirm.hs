...
module Beckn.ACL.OnConfirm (buildOnConfirmMessageV2, BPPInvoiceInfo (..), emptyBPPInvoiceInfo, mkBPPInvoiceInfoTagGroup, resolveBPPInvoiceInfo, resolveBPPInvoiceInfoForRide) where
...
import SharedLogic.Beckn.Common (BPPInvoiceInfo (..), buildBPPInvoiceInfo, emptyBPPInvoiceInfo, mkBPPInvoiceInfoTagGroup, resolveBPPInvoiceInfoForRide, resolveFleetInfo)
...
resolveBPPInvoiceInfo res = do
  ...
  mbFleetInfo <- case res.rideInfo of
    Just rideInfo -> resolveFleetInfo rideInfo.driver.id
