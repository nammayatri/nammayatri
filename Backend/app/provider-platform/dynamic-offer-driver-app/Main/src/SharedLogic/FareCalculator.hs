  ...
  where
    ...
    processFPInterCityDetails DFP.FPInterCityDetails {..} = do
      let estimatedDuration = maybe 0 (.getSeconds) params.estimatedRideDuration
          ...
          allowanceMins' = maybe 0 (\rt -> (calculateAllowanceMins (fromMaybe 19800 params.timeDiffFromUtc) perDayMaxHourAllowance.getMinutes params.rideTime rt) - estimatedDuration) params.returnTime
