...
executeSpecialZonePayout payoutRequest = do
  ...
  mbPayoutOrder <- PayoutRequest.executePayoutRequest merchantOperatingCity.currency payoutServiceFlow payoutRequest payoutCall (Just afterPayoutOrderCreated)
            ...
            then do
              ...
              case merchantId of
                ...
                Just mId -> do
                  ...
                  result <- try $ Payout.createPayoutService (cast mId) (Just $ cast opCityId) (cast driverId) (Just [scheduledPayout.id.getId]) (Just entityName) (show merchantOperatingCity.city) createPayoutOrderReq createPayoutOrderCall Nothing (Just afterPayoutOrderCreated)
