...
cacheAssignedRideIdAndStatus :: (Hedis.CacheFlow m r) => Id Person -> (Id Ride, RideStatus) -> m ()
...
getInProgressOrNewRideIdAndStatusByDriverId :: (Hedis.CacheFlow m r, EsqDBReplicaFlow m r) => Id Person -> m (Maybe (Id Ride, RideStatus))
