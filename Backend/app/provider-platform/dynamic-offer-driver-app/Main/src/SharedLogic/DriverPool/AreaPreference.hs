...
minSelectableCellsDefault = 1

-- | Safety ceiling on how many cells are ever accepted or matched against. Not a
-- product-facing maximum (product wants no real cap) -- purely a guard against an
-- absurd payload turning into thousands of tags on one driver.
maxSelectableCells :: Int
maxSelectableCells = 2000
