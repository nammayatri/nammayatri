...
data DriverPoolDataUpdate = DriverPoolDataUpdate
  { -- Class 2 fields (sync, LTS authoritative for dispatch)
    ...
    forwardAutoAcceptEnabled :: SetField (Maybe Bool),
    forwardAutoAcceptMode :: SetField (Maybe DI.ForwardAutoAcceptMode),
...
emptyUpdate =
  DriverPoolDataUpdate
    { active = Unchanged,
      ...
      forwardAutoAcceptEnabled = Unchanged,
      forwardAutoAcceptMode = Unchanged,
...
applyUpdate now u d =
  d
    { DPD.lastUpdatedAt = Just now,
      ...
      DPD.forwardAutoAcceptEnabled = applyField u.forwardAutoAcceptEnabled d.forwardAutoAcceptEnabled,
      DPD.forwardAutoAcceptMode = applyField u.forwardAutoAcceptMode d.forwardAutoAcceptMode,
