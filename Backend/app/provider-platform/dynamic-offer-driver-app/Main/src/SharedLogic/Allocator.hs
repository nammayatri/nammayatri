...
import Kernel.Types.Common (DistanceUnit, HighPrecDistance, Meters, Seconds)
...
data SendSearchRequestToDriverJobData = SendSearchRequestToDriverJobData
  { searchTryId :: Id DST.SearchTry,
    estimatedRideDistance1 :: Maybe Meters, -- FIXME
    estimatedRideDistanceValue :: Maybe HighPrecDistance,
