...
module SharedLogic.External.LocationTrackingService.API.PickupDriverLocation where
...
pickupDriverLocation :: Id DR.Ride -> DriverLocationReq -> ET.EulerClient DriverLocationResp
pickupDriverLocation = ET.client locationTrackingServiceAPI
