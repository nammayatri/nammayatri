...
import SharedLogic.Allocator.Jobs.Settlement.SAPReportDispatch (runSAPReportDispatchJob)
    ...
    { getTasksById = QAllJ.getTasksById,
      ...
      jobHandlers =
        emptyJobHandlerList
          ...
          & putJobHandlerInList (liftIO . runFlowR flowRt env . runSAPReportDispatchJob)
