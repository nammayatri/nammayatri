...
import SharedLogic.Allocator.Jobs.ProcessCancellationPenaltyStatus (processCancellationPenaltyStatus)
    ...
    { getTasksById = QAllJ.getTasksById,
      ...
      jobHandlers =
        emptyJobHandlerList
          ...
          & putJobHandlerInList (liftIO . runFlowR flowRt env . processCancellationPenaltyStatus)
