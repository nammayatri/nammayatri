...
import SharedLogic.Allocator.Jobs.SpecialZoneQueue.RetryTriggerNotify (retryTriggerNotify)
    ...
    { getTasksById = QAllJ.getTasksById,
      ...
      jobHandlers =
        emptyJobHandlerList
          ...
          & putJobHandlerInList (liftIO . runFlowR flowRt env . retryTriggerNotify)
