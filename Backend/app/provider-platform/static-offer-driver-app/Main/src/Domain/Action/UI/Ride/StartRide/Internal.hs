...
startRideTransaction :: EsqDBFlow m r => Id SP.Person -> Id SRide.Ride -> Id SRB.Booking -> LatLong -> Id Dmerch.Merchant -> m ()
startRideTransaction driverId rId bookingId firstPoint merchantId = Esq.runTransaction $ do
