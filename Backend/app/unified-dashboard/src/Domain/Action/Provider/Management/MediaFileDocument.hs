...
postMediaFileDocumentUploadLink merchantShortId opCity apiTokenInfo req = do
  ...
  Domain.Action.Management.Transaction.withResponseTransactionStoring transaction $ (do API.Client.Provider.Management.callManagementAPI checkedMerchantId opCity (.mediaFileDocumentDSL.postMediaFileDocumentUploadLink) requestorId req)
...
postMediaFileDocumentConfirm merchantShortId opCity apiTokenInfo req = do
  ...
  let requestorId = apiTokenInfo.personId.getId
  transaction <- Domain.Action.Management.Transaction.buildTransaction apiTokenInfo.userActionType (Kernel.Prelude.Just DRIVER_OFFER_BPP_MANAGEMENT) (Kernel.Prelude.Just apiTokenInfo) Kernel.Prelude.Nothing Kernel.Prelude.Nothing (Kernel.Prelude.Just req)
  Domain.Action.Management.Transaction.withTransactionStoring transaction $ (do API.Client.Provider.Management.callManagementAPI checkedMerchantId opCity (.mediaFileDocumentDSL.postMediaFileDocumentConfirm) requestorId req)
...
postMediaFileDocumentDelete merchantShortId opCity apiTokenInfo req = do
  ...
  let requestorId = apiTokenInfo.personId.getId
  transaction <- Domain.Action.Management.Transaction.buildTransaction apiTokenInfo.userActionType (Kernel.Prelude.Just DRIVER_OFFER_BPP_MANAGEMENT) (Kernel.Prelude.Just apiTokenInfo) Kernel.Prelude.Nothing Kernel.Prelude.Nothing (Kernel.Prelude.Just req)
  Domain.Action.Management.Transaction.withTransactionStoring transaction $ (do API.Client.Provider.Management.callManagementAPI checkedMerchantId opCity (.mediaFileDocumentDSL.postMediaFileDocumentDelete) requestorId req)
