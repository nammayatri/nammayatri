...
data AccessMatrixItemAPIEntity
    = AccessMatrixItemAPIEntity {serverName :: Kernel.Prelude.Maybe Domain.Types.AccessMatrix.ServerName, userActionType :: Domain.Types.AccessMatrix.UserActionType}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data AccessMatrixRowAPIEntity
    = AccessMatrixRowAPIEntity {accessMatrixRow :: [AccessMatrixItemAPIEntity], role :: Domain.Types.Role.RoleAPIEntity}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ChangeEmailByAdminReq
    = ChangeEmailByAdminReq {newEmail :: Data.Text.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ChangeEnabledStatusReq
    = ChangeEnabledStatusReq {enabled :: Kernel.Prelude.Bool}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ChangeMobileNumberByAdminReq
    = ChangeMobileNumberByAdminReq {newMobileNumber :: Data.Text.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ChangePasswordAfterExpiryReq
    = ChangePasswordAfterExpiryReq {email :: Data.Text.Text, newPassword :: Data.Text.Text, oldPassword :: Data.Text.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ChangePasswordByAdminReq
    = ChangePasswordByAdminReq {newPassword :: Data.Text.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ChangePasswordReq
    = ChangePasswordReq {newPassword :: Data.Text.Text, oldPassword :: Data.Text.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data ListPersonResp
    = ListPersonResp {list :: [PersonAPIEntity], summary :: Kernel.External.Verification.SafetyPortal.Types.Summary}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MerchantAccessResp
    = MerchantAccessResp {merchantId :: Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant, operatingCity :: Kernel.Types.Beckn.Context.City}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data MerchantCityAccessReq
    = MerchantCityAccessReq {merchantId :: Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant, operatingCity :: Kernel.Types.Beckn.Context.City}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data PersonAPIEntity
    = PersonAPIEntity {availableCitiesForMerchant :: Kernel.Prelude.Maybe [Domain.Types.Merchant.AvailableCitiesForMerchant],
...
type GetPersonList = ("person" :> "list" :> QueryParam "searchString" Data.Text.Text :> QueryParam "limit" Kernel.Prelude.Integer :> QueryParam "offset" Kernel.Prelude.Integer :> QueryParam "personId"
                                                                                                                                                                                              (Kernel.Types.Id.Id Domain.Types.Person.Person) :> Get ('[JSON]) ListPersonResp)
type PostPersonAssignRole = ("person" :> Capture "personId" (Kernel.Types.Id.Id Domain.Types.Person.Person) :> "assignRole" :> Capture "roleId"
                                                                                                                                       (Kernel.Types.Id.Id Domain.Types.Role.Role) :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostPersonAssignMerchantCityAccess = ("person" :> Capture "personId" (Kernel.Types.Id.Id Domain.Types.Person.Person) :> "assignMerchantCityAccess" :> ReqBody ('[JSON])
                                                                                                                                                                   MerchantCityAccessReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostPersonResetMerchantAccess = ("person" :> Capture "personId" (Kernel.Types.Id.Id Domain.Types.Person.Person) :> "resetMerchantAccess" :> ReqBody ('[JSON])
                                                                                                                                                         MerchantCityAccessReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostPersonResetMerchantCityAccess = ("person" :> Capture "personId" (Kernel.Types.Id.Id Domain.Types.Person.Person) :> "resetMerchantCityAccess" :> ReqBody ('[JSON])
                                                                                                                                                                 MerchantCityAccessReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
...
type PostPersonChangeEnabledStatus = ("person" :> Capture "personId" (Kernel.Types.Id.Id Domain.Types.Person.Person) :> "changeEnabledStatus" :> ReqBody ('[JSON])
                                                                                                                                                         ChangeEnabledStatusReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostPersonChangeEmailByAdmin = ("person" :> Capture "personId" (Kernel.Types.Id.Id Domain.Types.Person.Person) :> "change" :> "email" :> ReqBody ('[JSON]) ChangeEmailByAdminReq :> Post ('[JSON])
                                                                                                                                                                                              Kernel.Types.APISuccess.APISuccess)
type PostPersonChangePasswordByAdmin = ("person" :> Capture "personId" (Kernel.Types.Id.Id Domain.Types.Person.Person) :> "change" :> "password" :> ReqBody ('[JSON])
                                                                                                                                                            ChangePasswordByAdminReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
type PostPersonChangeMobileByAdmin = ("person" :> Capture "personId" (Kernel.Types.Id.Id Domain.Types.Person.Person) :> "change" :> "mobile" :> ReqBody ('[JSON])
                                                                                                                                                        ChangeMobileNumberByAdminReq :> Post ('[JSON]) Kernel.Types.APISuccess.APISuccess)
...
data PersonAPIs
    = PersonAPIs {getPersonList :: (Kernel.Prelude.Maybe (Data.Text.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Integer) -> Kernel.Prelude.Maybe (Kernel.Prelude.Integer) -> Kernel.Prelude.Maybe (Kernel.Types.Id.Id Domain.Types.Person.Person) -> EulerHS.Types.EulerClient ListPersonResp),
...
mkPersonAPIs personClient = (PersonAPIs {..})
                 where getPersonList :<|> postPersonAssignRole :<|> postPersonAssignMerchantCityAccess :<|> postPersonResetMerchantAccess :<|> postPersonResetMerchantCityAccess :<|> deletePerson :<|> postPersonChangeEnabledStatus :<|> postPersonChangeEmailByAdmin :<|> postPersonChangePasswordByAdmin :<|> postPersonChangeMobileByAdmin :<|> getUserProfile :<|> getUserCurrentMerchant :<|> postUserChangePassword :<|> getUserAccessMatrix :<|> postUserChangePasswordAfterExpiry = personClient
