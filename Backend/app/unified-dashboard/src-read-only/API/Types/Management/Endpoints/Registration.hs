...
data LoginReq
    = LoginReq {email :: Kernel.Prelude.Maybe Data.Text.Text, mobileNumber :: Kernel.Prelude.Maybe Data.Text.Text, mobileCountryCode :: Kernel.Prelude.Maybe Data.Text.Text, password :: Data.Text.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data LoginRes
    = LoginRes {token :: Data.Text.Text, city :: Kernel.Types.Beckn.Context.City, merchantId :: Kernel.Types.Id.ShortId Domain.Types.Merchant.Merchant}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data VerifyOtpReq
    = VerifyOtpReq {mobileNumber :: Data.Text.Text, mobileCountryCode :: Data.Text.Text, otp :: Data.Text.Text}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
...
mkRegistrationAPIs registrationClient = (RegistrationAPIs {..})
                       where postUserLogin :<|> postUserLoginVerifyOtp = registrationClient
data RegistrationUserActionType
    = POST_USER_LOGIN | POST_USER_LOGIN_VERIFY_OTP
