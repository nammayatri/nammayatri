...
data ListTransactionResp
    = ListTransactionResp {list :: [TransactionAPIEntity], summary :: Kernel.External.Verification.SafetyPortal.Types.Summary}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data RequestorAPIEntity
    = RequestorAPIEntity {email :: Kernel.Prelude.Maybe Data.Text.Text,
    ...
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data TransactionAPIEntity
    = TransactionAPIEntity {commonDriverId :: Kernel.Prelude.Maybe Data.Text.Text,
...
type GetTransactionList = ("list" :> QueryParam "searchString" Data.Text.Text :> QueryParam "limit" Kernel.Prelude.Integer :> QueryParam "offset" Kernel.Prelude.Integer :> QueryParam "requestorId"
                                                                                                                                                                                       (Kernel.Types.Id.Id Domain.Types.Person.Person) :> QueryParam "driverId" Data.Text.Text :> QueryParam "rideId"
                                                                                                                                                                                                                                                                                             Data.Text.Text :> QueryParam "endpoint"
                                                                                                                                                                                                                                                                                                                          Domain.Types.AccessMatrix.UserActionType :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                                          ListTransactionResp)
newtype TransactionAPIs
...
mkTransactionAPIs transactionClient = (TransactionAPIs {..})
                      where getTransactionList = transactionClient
data TransactionUserActionType
    = GET_TRANSACTION_LIST
    deriving stock (Show, Read, Generic, Eq, Ord)
    deriving anyclass ToSchema
instance ToJSON TransactionUserActionType
    where toJSON (GET_TRANSACTION_LIST) = Data.Aeson.String "GET_TRANSACTION_LIST"
instance FromJSON TransactionUserActionType
    where parseJSON (Data.Aeson.String "GET_TRANSACTION_LIST") = pure GET_TRANSACTION_LIST
