...
instance Text.Read.Read ManagementUserActionType
    where readsPrec d' = Text.Read.readParen (d' > app_prec) (\r -> [(ACCESS_MATRIX v1, r2) | r1 <- stripPrefix "ACCESS_MATRIX/" r, (v1, r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(MERCHANT v1,
                                                                                                                                                                                            r2) | r1 <- stripPrefix "MERCHANT/" r, (v1, r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(PERSON v1,
                                                                                                                                                                                                                                                                                           r2) | r1 <- stripPrefix "PERSON/" r,
                                                                                                                                                                                                                                                                                                 (v1,
                                                                                                                                                                                                                                                                                                  r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(REGISTRATION v1,
                                                                                                                                                                                                                                                                                                                                                     r2) | r1 <- stripPrefix "REGISTRATION/" r,
                                                                                                                                                                                                                                                                                                                                                           (v1,
                                                                                                                                                                                                                                                                                                                                                            r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(ROLE v1,
                                                                                                                                                                                                                                                                                                                                                                                                               r2) | r1 <- stripPrefix "ROLE/" r,
                                                                                                                                                                                                                                                                                                                                                                                                                     (v1,
                                                                                                                                                                                                                                                                                                                                                                                                                      r2) <- Text.Read.readsPrec (app_prec + 1) r1] ++ [(TRANSACTION v1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                         r2) | r1 <- stripPrefix "TRANSACTION/" r,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                               (v1,
