...
type PostPersonAssignMerchantCityAccess = (ApiAuth ('DRIVER_OFFER_BPP_MANAGEMENT)
                                                   ('POST_MANAGEMENT_PERSON_ASSIGN_MERCHANT_CITY_ACCESS) :> API.Types.Management.Person.PostPersonAssignMerchantCityAccess)
