...
data AccessMatrix
    = AccessMatrix {createdAt :: Kernel.Prelude.UTCTime,
...
data ApiAccessLevel
    = ApiAccessLevel {serverName :: Kernel.Prelude.Maybe Domain.Types.AccessMatrix.ServerName, userActionType :: Domain.Types.AccessMatrix.UserActionType}
    deriving (Generic, Show, ToJSON, FromJSON, ToSchema, Eq, Ord)
data ServerName
    = APP_BACKEND | APP_BACKEND_MANAGEMENT | DRIVER_OFFER_BPP | DRIVER_OFFER_BPP_MANAGEMENT | SPECIAL_ZONE | BHARAT_TAXI
