...
data TransactionT f
    = TransactionT {commonDriverId :: (B.C f (Kernel.Prelude.Maybe Data.Text.Text)),
...
instance B.Table TransactionT
    where data PrimaryKey TransactionT f = TransactionId (B.C f Data.Text.Text) deriving (Generic, B.Beamable)
