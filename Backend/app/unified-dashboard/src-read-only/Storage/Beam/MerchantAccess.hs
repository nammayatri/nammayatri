...
data MerchantAccessT f
    = MerchantAccessT {createdAt :: (B.C f Kernel.Prelude.UTCTime),
...
instance B.Table MerchantAccessT
    where data PrimaryKey MerchantAccessT f = MerchantAccessId (B.C f Data.Text.Text) deriving (Generic, B.Beamable)
