...
deletePerson :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) => (Kernel.Types.Id.Id Domain.Types.Person.Person -> m ())
deletePerson id = do deleteWithKV [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]
findByEmailAndPassword :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMobileNumberAndPassword :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMobileNumberAndPassword mobileNumberHashBeam mobileCountryCode passwordHashBeam = do findOneWithKV [Se.And [Se.Is Beam.mobileNumberHash $ Se.Eq mobileNumberHashBeam,
                                                                                                                  Se.Is Beam.mobileCountryCode $ Se.Eq mobileCountryCode,
                                                                                                                  Se.Is Beam.passwordHash $ Se.Eq passwordHashBeam]]
findByMobileNumberHash :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findByMobileNumberHash mobileNumberHashBeam mobileCountryCode = do findOneWithKV [Se.And [Se.Is Beam.mobileNumberHash $ Se.Eq mobileNumberHashBeam,
                                                                                          Se.Is Beam.mobileCountryCode $ Se.Eq mobileCountryCode]]
...
updateByPrimaryKey (Domain.Types.Person.Person {..}) = do {_now <- getCurrentTime;
                                                           updateWithKV [Se.Set Beam.approvedBy (Kernel.Types.Id.getId <$> approvedBy),
