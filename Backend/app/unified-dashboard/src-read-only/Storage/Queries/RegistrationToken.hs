...
deleteAllByPersonIdAndMerchantId personId merchantId = do deleteWithKV [Se.And [Se.Is Beam.personId $ Se.Eq (Kernel.Types.Id.getId personId),
                                                                                Se.Is Beam.merchantId $ Se.Eq (Kernel.Types.Id.getId merchantId)]]
deleteAllByPersonIdAndMerchantIdAndCity :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
deleteAllByPersonIdAndMerchantIdAndCity personId merchantId operatingCity = do deleteWithKV [Se.And [Se.Is Beam.personId $ Se.Eq (Kernel.Types.Id.getId personId),
                                                                                                     Se.Is Beam.merchantId $ Se.Eq (Kernel.Types.Id.getId merchantId),
...
findAllByMerchantIdAndCity :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByPersonIdAndMerchantId :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByPersonIdAndMerchantId personId merchantId = do findAllWithKV [Se.And [Se.Is Beam.personId $ Se.Eq (Kernel.Types.Id.getId personId),
                                                                               Se.Is Beam.merchantId $ Se.Eq (Kernel.Types.Id.getId merchantId)]]
findAllByPersonIdAndMerchantIdAndCity :: (EsqDBFlow m r, MonadFlow m, CacheFlow m r) =>
...
findAllByPersonIdAndMerchantIdAndCity personId merchantId operatingCity = do findAllWithKV [Se.And [Se.Is Beam.personId $ Se.Eq (Kernel.Types.Id.getId personId),
                                                                                                    Se.Is Beam.merchantId $ Se.Eq (Kernel.Types.Id.getId merchantId),
                                                                                                    Se.Is Beam.operatingCity $ Se.Eq operatingCity]]
...
updateByPrimaryKey (Domain.Types.RegistrationToken.RegistrationToken {..}) = do {_now <- getCurrentTime;
                                                                                 updateWithKV [Se.Set Beam.enabled enabled,
...
instance FromTType' Beam.RegistrationToken Domain.Types.RegistrationToken.RegistrationToken
    where fromTType' (Beam.RegistrationTokenT {..}) = do pure $ Just Domain.Types.RegistrationToken.RegistrationToken{createdAt = createdAt,
                                                                                                                      enabled = enabled,
...
instance ToTType' Beam.RegistrationToken Domain.Types.RegistrationToken.RegistrationToken
    where toTType' (Domain.Types.RegistrationToken.RegistrationToken {..}) = do Beam.RegistrationTokenT{Beam.createdAt = createdAt,
