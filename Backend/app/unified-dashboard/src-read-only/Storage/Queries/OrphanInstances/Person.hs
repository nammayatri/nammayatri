...
instance FromTType' Beam.Person Domain.Types.Person.Person
    where fromTType' (Beam.PersonT {..}) = do pure $ Just Domain.Types.Person.Person{approvedBy = Kernel.Types.Id.Id <$> approvedBy,
                                                                                     createdAt = createdAt,
                                                                                     ...
                                                                                     updatedAt = updatedAt,
                                                                                     verified = verified}
instance ToTType' Beam.Person Domain.Types.Person.Person
    where toTType' (Domain.Types.Person.Person {..}) = do Beam.PersonT{Beam.approvedBy = Kernel.Types.Id.getId <$> approvedBy,
