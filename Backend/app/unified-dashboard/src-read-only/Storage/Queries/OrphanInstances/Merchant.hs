...
instance FromTType' Beam.Merchant Domain.Types.Merchant.Merchant
    where fromTType' (Beam.MerchantT {..}) = do pure $ Just Domain.Types.Merchant.Merchant{authToken = EncryptedHashed <$> (Encrypted <$> authTokenEncrypted) <*> authTokenHash,
                                                                                           createdAt = createdAt,
                                                                                           ...
                                                                                           website = website,
                                                                                           updatedAt = updatedAt}
instance ToTType' Beam.Merchant Domain.Types.Merchant.Merchant
    where toTType' (Domain.Types.Merchant.Merchant {..}) = do Beam.MerchantT{Beam.authTokenEncrypted = ((authToken <&> unEncrypted . (.encrypted))),
