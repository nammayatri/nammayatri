...
let outputPrefixReadOnly =
      rootDir ++ "/Backend/app/public-transport-bpp/src-read-only/"

let outputPrefix = rootDir ++ "/Backend/app/public-transport-bpp/src/"

let migrationPath =
      rootDir ++ "/Backend/dev/migrations-read-only/public-transport-bpp/src/"
...
let outputPath =
      ...
      , _servantApiClient = ""
      , _sql = [ { _1 = migrationPath, _2 = "atlas_public_transport_bpp" } ]
      , _purescriptFrontend = ""
      }
