...
let outputPrefixReadOnly = rootDir ++ "/Backend/app/yudhishthira/src-read-only/"

let outputPrefix = rootDir ++ "/Backend/app/yudhishthira/src/"

let migrationPath = rootDir ++ "/Backend/dev/migrations-read-only/yudhishthira/"
