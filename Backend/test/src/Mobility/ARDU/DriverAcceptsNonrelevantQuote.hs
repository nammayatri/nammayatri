...
driverOffersOnAnIrrelevantSearchRequest clients = withBecknClients clients $ do
  ...
  Utils.offerQuote arduDriver1 defaultAllowedDriverFee searchReqForDriver.searchStepId
  ...
  --
  eithRes <- Utils.offerQuoteEither arduDriver2 defaultAllowedDriverFee searchReqForSecondDriver.searchStepId
