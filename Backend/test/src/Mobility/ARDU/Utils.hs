...
import qualified "dynamic-offer-driver-app" Domain.Types.SearchStep as ArduSStep
import HSpec
...
import qualified "dynamic-offer-driver-app" Storage.Queries.SearchStep as QSStep
import Utils
...
respondQuote :: DriverTestData -> Money -> Id ArduSStep.SearchStep -> SearchReqInfo.SearchRequestForDriverResponse -> ClientsM ()
...
offerQuote :: DriverTestData -> Money -> Id ArduSStep.SearchStep -> ClientsM ()
...
respondQuoteEither :: DriverTestData -> Money -> Id ArduSStep.SearchStep -> SearchReqInfo.SearchRequestForDriverResponse -> ClientsM (Either ClientError APISuccess)
...
offerQuoteEither :: DriverTestData -> Money -> Id ArduSStep.SearchStep -> ClientsM (Either ClientError APISuccess)
