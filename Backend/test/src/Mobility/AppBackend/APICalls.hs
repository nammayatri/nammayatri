...
appConfirmRideV2 :: Text -> Id AbeQuote.Quote -> Maybe Payment.PaymentMethodId -> Maybe BRB.ConfirmReqV2 -> ClientM ConfirmAPI.ConfirmRes
appConfirmRide :<|> appConfirmRideV2 = client (Proxy :: Proxy ConfirmAPI.API)
