...
testComplexScenariosWithRealFunctions =
  testGroup
    ...
    [ testCase "Different fleet types work correctly" $ do
        let rentalReq = Common.FleetOwnerRegisterReqV2 "John" "Doe" Nothing Nothing (Just Common.RENTAL_FLEET) Nothing Nothing Nothing Nothing Nothing Nothing
            normalReq = Common.FleetOwnerRegisterReqV2 "John" "Doe" Nothing Nothing (Just Common.NORMAL_FLEET) Nothing Nothing Nothing Nothing Nothing Nothing
            businessReq = Common.FleetOwnerRegisterReqV2 "John" "Doe" Nothing Nothing (Just Common.BUSINESS_FLEET) Nothing Nothing Nothing Nothing Nothing Nothing
      ...
      testCase "Optional fields work correctly" $ do
        let reqWithEmail = Common.FleetOwnerRegisterReqV2 "John" "Doe" Nothing (Just "john@example.com") (Just Common.NORMAL_FLEET) Nothing Nothing Nothing Nothing Nothing Nothing
            reqWithPersonId = Common.FleetOwnerRegisterReqV2 "John" "Doe" (Just (Id "person-123")) Nothing (Just Common.NORMAL_FLEET) Nothing Nothing Nothing Nothing Nothing Nothing
  ...
  testGroup
    ...
    [ testCase "Invalid mobile number format" $ do
      ...
      testCase "Empty name validation" $ do
        let invalidReq = Common.FleetOwnerRegisterReqV2 "" "Doe" Nothing Nothing (Just Common.NORMAL_FLEET) Nothing Nothing Nothing Nothing Nothing Nothing
