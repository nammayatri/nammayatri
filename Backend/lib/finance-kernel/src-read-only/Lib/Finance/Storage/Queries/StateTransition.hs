...
findByEntity :: (Lib.Finance.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
updateByPrimaryKey (Lib.Finance.Domain.Types.StateTransition.StateTransition {..}) = do {_now <- getCurrentTime;
                                                                                         updateWithKV [Se.Set Beam.actorId actorId,
...
instance FromTType' Beam.StateTransition Lib.Finance.Domain.Types.StateTransition.StateTransition
    where fromTType' (Beam.StateTransitionT {..}) = do pure $ Just Lib.Finance.Domain.Types.StateTransition.StateTransition{actorId = actorId,
                                                                                                                            actorType = actorType,
                                                                                                                            createdAt = createdAt,
                                                                                                                            entityId = entityId,
                                                                                                                            ...
                                                                                                                            toState = toState,
                                                                                                                            updatedAt = updatedAt}
instance ToTType' Beam.StateTransition Lib.Finance.Domain.Types.StateTransition.StateTransition
    where toTType' (Lib.Finance.Domain.Types.StateTransition.StateTransition {..}) = do Beam.StateTransitionT{Beam.actorId = actorId,
