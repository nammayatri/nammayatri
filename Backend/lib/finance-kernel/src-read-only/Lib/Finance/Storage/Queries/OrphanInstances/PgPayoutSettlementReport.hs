...
instance FromTType' Beam.PgPayoutSettlementReport Lib.Finance.Domain.Types.PgPayoutSettlementReport.PgPayoutSettlementReport
    where fromTType' (Beam.PgPayoutSettlementReportT {..}) = do pure $ Just Lib.Finance.Domain.Types.PgPayoutSettlementReport.PgPayoutSettlementReport{bankName = bankName,
                                                                                                                                                       ...
                                                                                                                                                       updatedAt = updatedAt,
                                                                                                                                                       utr = utr}
instance ToTType' Beam.PgPayoutSettlementReport Lib.Finance.Domain.Types.PgPayoutSettlementReport.PgPayoutSettlementReport
    where toTType' (Lib.Finance.Domain.Types.PgPayoutSettlementReport.PgPayoutSettlementReport {..}) = do Beam.PgPayoutSettlementReportT{Beam.bankName = bankName,
