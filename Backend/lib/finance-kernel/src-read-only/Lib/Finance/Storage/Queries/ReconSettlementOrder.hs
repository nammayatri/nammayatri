...
findByRideId :: (Lib.Finance.Storage.Beam.BeamFlow.BeamFlow m r) => (Kernel.Prelude.Maybe Kernel.Prelude.Text -> m (Maybe Lib.Finance.Domain.Types.ReconSettlementOrder.ReconSettlementOrder))
findByRideId rideId = do findOneWithKV [Se.Is Beam.rideId $ Se.Eq rideId]

findByUtrSettlementId ::
  (Lib.Finance.Storage.Beam.BeamFlow.BeamFlow m r) =>
  (Kernel.Types.Id.Id Lib.Finance.Domain.Types.ReconUtrSettlement.ReconUtrSettlement -> m ([Lib.Finance.Domain.Types.ReconSettlementOrder.ReconSettlementOrder]))
