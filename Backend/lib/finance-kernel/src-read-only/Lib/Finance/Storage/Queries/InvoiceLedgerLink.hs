...
findByLedgerEntry :: (Lib.Finance.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
updateByPrimaryKey (Lib.Finance.Domain.Types.InvoiceLedgerLink.InvoiceLedgerLink {..}) = do {_now <- getCurrentTime;
                                                                                             updateWithKV [Se.Set Beam.invoiceId (Kernel.Types.Id.getId invoiceId),
...
instance FromTType' Beam.InvoiceLedgerLink Lib.Finance.Domain.Types.InvoiceLedgerLink.InvoiceLedgerLink
    where fromTType' (Beam.InvoiceLedgerLinkT {..}) = do pure $ Just Lib.Finance.Domain.Types.InvoiceLedgerLink.InvoiceLedgerLink{createdAt = createdAt,
                                                                                                                                  ...
                                                                                                                                  updatedAt = updatedAt}
instance ToTType' Beam.InvoiceLedgerLink Lib.Finance.Domain.Types.InvoiceLedgerLink.InvoiceLedgerLink
    where toTType' (Lib.Finance.Domain.Types.InvoiceLedgerLink.InvoiceLedgerLink {..}) = do Beam.InvoiceLedgerLinkT{Beam.createdAt = createdAt,
