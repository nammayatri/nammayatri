...
updateByPrimaryKey (Lib.Finance.Domain.Types.AuditEntry.AuditEntry {..}) = do {_now <- getCurrentTime;
                                                                               updateWithKV [Se.Set Beam.action action,
...
instance FromTType' Beam.AuditEntry Lib.Finance.Domain.Types.AuditEntry.AuditEntry
    where fromTType' (Beam.AuditEntryT {..}) = do pure $ Just Lib.Finance.Domain.Types.AuditEntry.AuditEntry{action = action,
                                                                                                             actorId = actorId,
                                                                                                             actorType = actorType,
                                                                                                             createdAt = createdAt,
                                                                                                             entityId = entityId,
                                                                                                             ...
                                                                                                             updatedAt = updatedAt}
instance ToTType' Beam.AuditEntry Lib.Finance.Domain.Types.AuditEntry.AuditEntry
    where toTType' (Lib.Finance.Domain.Types.AuditEntry.AuditEntry {..}) = do Beam.AuditEntryT{Beam.action = action,
