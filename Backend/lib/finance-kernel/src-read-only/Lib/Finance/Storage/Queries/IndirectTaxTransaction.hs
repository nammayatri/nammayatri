...
updateByPrimaryKey (Lib.Finance.Domain.Types.IndirectTaxTransaction.IndirectTaxTransaction {..}) = do {_now <- getCurrentTime;
                                                                                                       updateWithKV [Se.Set Beam.cgstAmount cgstAmount,
...
instance FromTType' Beam.IndirectTaxTransaction Lib.Finance.Domain.Types.IndirectTaxTransaction.IndirectTaxTransaction
    where fromTType' (Beam.IndirectTaxTransactionT {..}) = do pure $ Just Lib.Finance.Domain.Types.IndirectTaxTransaction.IndirectTaxTransaction{cgstAmount = cgstAmount,
                                                                                                                                                 ...
                                                                                                                                                 updatedAt = updatedAt}
instance ToTType' Beam.IndirectTaxTransaction Lib.Finance.Domain.Types.IndirectTaxTransaction.IndirectTaxTransaction
    where toTType' (Lib.Finance.Domain.Types.IndirectTaxTransaction.IndirectTaxTransaction {..}) = do Beam.IndirectTaxTransactionT{Beam.cgstAmount = cgstAmount,
