...
findByDateRange :: (Lib.Finance.Storage.Beam.BeamFlow.BeamFlow m r) =>
                   (Kernel.Prelude.UTCTime -> Lib.Finance.Domain.Types.ReconciliationSummary.ReconciliationType -> m ([Lib.Finance.Domain.Types.ReconciliationSummary.ReconciliationSummary]))
...
updateStatus :: (Lib.Finance.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
updateByPrimaryKey (Lib.Finance.Domain.Types.ReconciliationSummary.ReconciliationSummary {..}) = do {_now <- getCurrentTime;
                                                                                                     updateWithKV [Se.Set Beam.errorMessage errorMessage,
                                                                                                                   ...
                                                                                                                   Se.Set Beam.varianceAmount varianceAmount] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]}



instance FromTType' Beam.ReconciliationSummary Lib.Finance.Domain.Types.ReconciliationSummary.ReconciliationSummary
    where fromTType' (Beam.ReconciliationSummaryT {..}) = do pure $ Just Lib.Finance.Domain.Types.ReconciliationSummary.ReconciliationSummary{createdAt = createdAt,
...
instance ToTType' Beam.ReconciliationSummary Lib.Finance.Domain.Types.ReconciliationSummary.ReconciliationSummary
    where toTType' (Lib.Finance.Domain.Types.ReconciliationSummary.ReconciliationSummary {..}) = do Beam.ReconciliationSummaryT{Beam.createdAt = createdAt,
