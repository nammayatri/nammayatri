...
instance FromTType' Beam.Invoice Lib.Finance.Domain.Types.Invoice.Invoice
    where fromTType' (Beam.InvoiceT {..}) = do pure $ Just Lib.Finance.Domain.Types.Invoice.Invoice{createdAt = createdAt,
                                                                                                    currency = currency,
                                                                                                    dueAt = dueAt,
                                                                                                    ...
                                                                                                    updatedAt = updatedAt}
instance ToTType' Beam.Invoice Lib.Finance.Domain.Types.Invoice.Invoice
    where toTType' (Lib.Finance.Domain.Types.Invoice.Invoice {..}) = do Beam.InvoiceT{Beam.createdAt = createdAt,
