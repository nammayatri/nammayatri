      ...
      Just
        Lib.Finance.Domain.Types.Invoice.Invoice
          { createdAt = createdAt,
            ...
            renderedInvoiceJson = renderedInvoiceJson,
  ...
  toTType' (Lib.Finance.Domain.Types.Invoice.Invoice {..}) = do
    Beam.InvoiceT
      { Beam.createdAt = createdAt,
        ...
        Beam.renderedInvoiceJson = renderedInvoiceJson,
        ...
        Beam.unsignedQRCode = unsignedQRCode,
