...
updateByPrimaryKey (Lib.Finance.Domain.Types.PgPayoutSettlementReport.PgPayoutSettlementReport {..}) = do
  _now <- getCurrentTime
  updateWithKV
    [ Se.Set Beam.bankName bankName,
      ...
      Se.Set Beam.fulfillmentOrderCreatedAt fulfillmentOrderCreatedAt,
      ...
      Se.Set Beam.fulfillmentTxnId fulfillmentTxnId,
