...
findReversalOf :: (Lib.Finance.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
updateSettled :: (Lib.Finance.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
updateSettled status settledAt id = do {_now <- getCurrentTime;
...
updateSettlementStatus :: (Lib.Finance.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
updateSettlementStatus settlementStatus settlementId settlementTimestamp id = do {_now <- getCurrentTime;
...
updateVoided :: (Lib.Finance.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
updateVoided status voidReason id = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Lib.Finance.Domain.Types.LedgerEntry.LedgerEntry {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.LedgerEntry Lib.Finance.Domain.Types.LedgerEntry.LedgerEntry
    where fromTType' (Beam.LedgerEntryT {..}) = do pure $ Just Lib.Finance.Domain.Types.LedgerEntry.LedgerEntry{amount = amount,
                                                                                                                createdAt = createdAt,
                                                                                                                currency = currency,
                                                                                                                entryType = entryType,
                                                                                                                ...
                                                                                                                updatedAt = updatedAt}
instance ToTType' Beam.LedgerEntry Lib.Finance.Domain.Types.LedgerEntry.LedgerEntry
    where toTType' (Lib.Finance.Domain.Types.LedgerEntry.LedgerEntry {..}) = do Beam.LedgerEntryT{Beam.amount = amount,
