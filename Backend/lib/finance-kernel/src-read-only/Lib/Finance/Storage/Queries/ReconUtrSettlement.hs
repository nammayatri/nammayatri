...
updateByPrimaryKey (Lib.Finance.Domain.Types.ReconUtrSettlement.ReconUtrSettlement {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.bankVerifiedAmount bankVerifiedAmount,
      ...
      Se.Set Beam.deadline deadline,
      Se.Set Beam.deadlineBreachedNotifiedAt deadlineBreachedNotifiedAt,
      ...
      Se.Set Beam.sendAttempts sendAttempts,
      Se.Set Beam.sendStatus sendStatus,
