...
updateState :: (Lib.Finance.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
updateState currentState entityType entityId = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Lib.Finance.Domain.Types.CurrentState.CurrentState {..}) = do {_now <- getCurrentTime;
                                                                                   updateWithKV [Se.Set Beam.currentState currentState,
                                                                                                 Se.Set Beam.entityType entityType,
                                                                                                 Se.Set Beam.merchantId merchantId,
                                                                                                 Se.Set Beam.merchantOperatingCityId merchantOperatingCityId,
                                                                                                 Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.entityId $ Se.Eq entityId]]}



instance FromTType' Beam.CurrentState Lib.Finance.Domain.Types.CurrentState.CurrentState
    where fromTType' (Beam.CurrentStateT {..}) = do pure $ Just Lib.Finance.Domain.Types.CurrentState.CurrentState{currentState = currentState,
                                                                                                                   entityId = entityId,
                                                                                                                   ...
                                                                                                                   updatedAt = updatedAt,
                                                                                                                   createdAt = createdAt}
instance ToTType' Beam.CurrentState Lib.Finance.Domain.Types.CurrentState.CurrentState
    where toTType' (Lib.Finance.Domain.Types.CurrentState.CurrentState {..}) = do Beam.CurrentStateT{Beam.currentState = currentState,
