...
updateByPrimaryKey (Lib.Finance.Domain.Types.DirectTaxTransaction.DirectTaxTransaction {..}) = do {_now <- getCurrentTime;
                                                                                                   updateWithKV [Se.Set Beam.counterpartyId counterpartyId,
...
instance FromTType' Beam.DirectTaxTransaction Lib.Finance.Domain.Types.DirectTaxTransaction.DirectTaxTransaction
    where fromTType' (Beam.DirectTaxTransactionT {..}) = do pure $ Just Lib.Finance.Domain.Types.DirectTaxTransaction.DirectTaxTransaction{counterpartyId = counterpartyId,
                                                                                                                                           createdAt = createdAt,
                                                                                                                                           ...
                                                                                                                                           updatedAt = updatedAt}
instance ToTType' Beam.DirectTaxTransaction Lib.Finance.Domain.Types.DirectTaxTransaction.DirectTaxTransaction
    where toTType' (Lib.Finance.Domain.Types.DirectTaxTransaction.DirectTaxTransaction {..}) = do Beam.DirectTaxTransactionT{Beam.counterpartyId = counterpartyId,
