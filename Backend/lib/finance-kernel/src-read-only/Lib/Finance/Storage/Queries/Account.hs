...
findByCounterparty :: (Lib.Finance.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
findByCounterpartyAndType :: (Lib.Finance.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
findByCounterpartyAndType counterpartyType counterpartyId accountType currency = do findOneWithKV [Se.And [Se.Is Beam.counterpartyType $ Se.Eq counterpartyType,
...
updateByPrimaryKey (Lib.Finance.Domain.Types.Account.Account {..}) = do {_now <- getCurrentTime;
                                                                         updateWithKV [Se.Set Beam.accountType accountType,
...
instance FromTType' Beam.Account Lib.Finance.Domain.Types.Account.Account
    where fromTType' (Beam.AccountT {..}) = do pure $ Just Lib.Finance.Domain.Types.Account.Account{accountType = accountType,
                                                                                                    balance = balance,
                                                                                                    ...
                                                                                                    status = status,
                                                                                                    updatedAt = updatedAt}
instance ToTType' Beam.Account Lib.Finance.Domain.Types.Account.Account
    where toTType' (Lib.Finance.Domain.Types.Account.Account {..}) = do Beam.AccountT{Beam.accountType = accountType,
