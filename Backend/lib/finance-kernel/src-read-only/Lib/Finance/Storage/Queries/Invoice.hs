...
updateIrnAndSignedQRByInvoiceId ::
  ...
  (Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Lib.Finance.Core.Types.Actor -> Kernel.Types.Id.Id Lib.Finance.Domain.Types.Invoice.Invoice -> m ())
updateIrnAndSignedQRByInvoiceId irn signedQRCode updatedBy id = do
  _now <- getCurrentTime
  updateWithKV [Se.Set Beam.irn irn, Se.Set Beam.signedQRCode signedQRCode, Se.Set Beam.updatedBy updatedBy, Se.Set Beam.updatedAt _now] [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]

updateStatus ::
  (Lib.Finance.Storage.Beam.BeamFlow.BeamFlow m r) =>
  (Lib.Finance.Domain.Types.Invoice.InvoiceStatus -> Kernel.Prelude.Maybe Lib.Finance.Core.Types.Actor -> Kernel.Types.Id.Id Lib.Finance.Domain.Types.Invoice.Invoice -> m ())
