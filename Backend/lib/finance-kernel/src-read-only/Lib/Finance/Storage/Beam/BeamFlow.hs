...
import qualified Lib.Yudhishthira.Storage.Beam.BeamFlow as LYTBeamFlow
...
type BeamFlow m r =
  ( MonadFlow m,
    ...
    HasSchemaName BeamRefTypeConfig.FinanceRefTypeConfigT,
    ...
    LYTBeamFlow.HasYudhishthiraTablesSchema
  )
