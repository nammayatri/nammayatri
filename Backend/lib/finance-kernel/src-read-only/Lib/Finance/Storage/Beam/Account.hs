...
data AccountT f
    = AccountT {accountType :: (B.C f Lib.Finance.Domain.Types.Account.AccountType),
...
instance B.Table AccountT
    where data PrimaryKey AccountT f = AccountId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
