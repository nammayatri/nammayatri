...
data PgPayoutSettlementReportT f
    = PgPayoutSettlementReportT {bankName :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text)),
...
instance B.Table PgPayoutSettlementReportT
    where data PrimaryKey PgPayoutSettlementReportT f = PgPayoutSettlementReportId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
