...
data InvoiceLedgerLinkT f
    = InvoiceLedgerLinkT {createdAt :: (B.C f Kernel.Prelude.UTCTime),
...
instance B.Table InvoiceLedgerLinkT
    where data PrimaryKey InvoiceLedgerLinkT f = InvoiceLedgerLinkId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
