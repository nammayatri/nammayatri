...
data InvoiceT f = InvoiceT
  { createdAt :: (B.C f Kernel.Prelude.UTCTime),
    ...
    renderedInvoiceJson :: (B.C f (Kernel.Prelude.Maybe Data.Aeson.Value)),
    ...
    unsignedQRCode :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text)),
