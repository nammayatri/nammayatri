...
data ReconSettlementOrderT f = ReconSettlementOrderT
  { allocatedBankCash :: (B.C f Kernel.Types.Common.HighPrecMoney),
    ...
    diffAmount :: (B.C f Kernel.Types.Common.HighPrecMoney),
    ...
    payoutEligible :: (B.C f Kernel.Prelude.Bool),
    ...
    utrSettlementId :: (B.C f Kernel.Prelude.Text),
