...
data ReconSettlementOrderT f = ReconSettlementOrderT
  { allocatedBankCash :: (B.C f (Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney)),
    ...
    correctionForOrderRowId :: (B.C f (Kernel.Prelude.Maybe (Kernel.Prelude.Text))),
    ...
    orderSequence :: (B.C f Kernel.Prelude.Int),
    ...
    payoutEligible :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Bool)),
    ...
    refundReference :: (B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text)),
    refundStatus :: (B.C f (Kernel.Prelude.Maybe Lib.Finance.Domain.Types.ReconSettlementOrder.RefundObligationStatus)),
    ...
    settlementDetailIndex :: (B.C f Kernel.Prelude.Int),
