...
data AccountType = Asset | Liability | Revenue | Expense | External | RideCredit | Control | PayoutLiability deriving (Eq, Ord, Show, Read, Generic, ToJSON, FromJSON, ToSchema, ToParamSchema)
