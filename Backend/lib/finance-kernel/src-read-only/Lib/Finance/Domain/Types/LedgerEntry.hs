...
data LedgerEntry = LedgerEntry
  { amount :: Kernel.Types.Common.HighPrecMoney,
    ...
    metadataV2 :: Kernel.Prelude.Maybe Lib.Finance.Domain.Types.Extra.LedgerEntry.LedgerEntryMetadata,
...
data SettlementStatus = UNSETTLED | PROCESSING | PAID_OUT | EXTERNAL_UNSETTLED deriving (Eq, Ord, Show, Read, Generic, ToJSON, FromJSON, ToSchema, ToParamSchema)
