...
data ReconSettlementOrder = ReconSettlementOrder
  { allocatedBankCash :: Kernel.Types.Common.HighPrecMoney,
    ...
    diffAmount :: Kernel.Types.Common.HighPrecMoney,
    ...
    utrSettlementId :: Kernel.Types.Id.Id Lib.Finance.Domain.Types.ReconUtrSettlement.ReconUtrSettlement,
