...
data IndirectTaxTransaction
    = IndirectTaxTransaction {cgstAmount :: Kernel.Types.Common.HighPrecMoney,
                              ...
                              saleType :: Kernel.Prelude.Maybe Lib.Finance.Domain.Types.IndirectTaxTransaction.SaleType,
                              sgstAmount :: Kernel.Types.Common.HighPrecMoney,
                              taxCreditType :: Kernel.Prelude.Maybe Lib.Finance.Domain.Types.IndirectTaxTransaction.GstCreditType,
