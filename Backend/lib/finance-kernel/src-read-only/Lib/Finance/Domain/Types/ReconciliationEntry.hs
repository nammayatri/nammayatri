...
data ReconciliationEntry
    = ReconciliationEntry {actualLedgerValue :: Kernel.Types.Common.HighPrecMoney,
...
data FinanceComponent
    = GROSS_RIDE_FARE | GST | USER_CANCELLATION | DRIVER_CANCELLATION | DRIVER_TAKE_HOME_EARNINGS | SUBSCRIPTION_PURCHASE | EXPIRY | PG_PAYMENT_SETTLEMENT | PG_PAYOUT_SETTLEMENT
