...
getFirstPoint :: LocationUpdates -> LatLong
getFirstPoint upd = NE.head $ NE.head upd

getLastPoint :: LocationUpdates -> LatLong
getLastPoint upd = NE.last $ NE.last upd

-- short curvy route
shortCurvyRoute :: LocationUpdates
shortCurvyRoute =
...
-- test case from production with far isolated point
farIsolatedPoint :: LocationUpdates
farIsolatedPoint =
