      ...
      Just
        Lib.Types.GateInfo.GateInfo
          { address = address,
            ...
            entryFeeDisabledServiceTiers = entryFeeDisabledServiceTiers,
            feeItems = Lib.Queries.Transformers.GateInfo.decodeFeeItems feeItems,
            gateConfig = Lib.Queries.Transformers.GateInfo.decodeGateConfig gateConfig,
            gateTags = gateTags,
            gateType = gateType,
  ...
  toTType' (Lib.Types.GateInfo.GateInfo {..}) = do
    Beam.GateInfoT
      { Beam.address = address,
        ...
        Beam.entryFeeDisabledServiceTiers = entryFeeDisabledServiceTiers,
        Beam.feeItems = Lib.Queries.Transformers.GateInfo.encodeFeeItems feeItems,
        Beam.gateConfig = Lib.Queries.Transformers.GateInfo.encodeGateConfig gateConfig,
        ...
        Beam.minBalanceRequired = minBalanceRequired,
