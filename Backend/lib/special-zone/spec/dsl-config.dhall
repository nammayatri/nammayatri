...
let outputPrefixReadOnly =
      rootDir ++ "/Backend/lib/special-zone/src-read-only/Lib/"

let outputPrefix = rootDir ++ "/Backend/lib/special-zone/src/Lib/"
...
let outputPath =
      ...
      , _beamQueries = outputPrefixReadOnly ++ "Queries"
      , _extraBeamQueries = outputPrefix ++ "Queries/"
      , _cachedQueries = outputPrefixReadOnly ++ "CachedQueries"
      , _extraCachedQueries = outputPrefix ++ "CachedQueries/"
      , _beamTable = outputPrefixReadOnly ++ "Storage/Beam"
      , _domainHandler = outputPrefix ++ "Domain/Action/UI"
      , _domainHandlerDashboard = ""
      , _domainType = outputPrefixReadOnly ++ "Types"
