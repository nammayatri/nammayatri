...
let outputPrefixReadOnly = rootDir ++ "/Backend/lib/webhook/src-read-only/"

let outputPrefix = rootDir ++ "/Backend/lib/webhook/src/"
...
let outputPath =
      { _apiRelatedTypes = outputPrefixReadOnly ++ "Lib/Webhook/API/Types"
      , _extraApiRelatedTypes = ""
      , _extraApiRelatedCommonTypes = ""
      , _beamQueries = outputPrefixReadOnly ++ "Lib/Webhook/Storage/Queries"
      , _extraBeamQueries = outputPrefix ++ "Lib/Webhook/Storage/Queries/"
      , _cachedQueries =
          outputPrefixReadOnly ++ "Lib/Webhook/Storage/CachedQueries"
      , _extraCachedQueries =
          outputPrefix ++ "Lib/Webhook/Storage/CachedQueries/"
      , _beamTable = outputPrefixReadOnly ++ "Lib/Webhook/Storage/Beam"
      , _domainHandler = outputPrefix ++ "Lib/Webhook/Domain/Action"
      ...
      , _purescriptFrontend = ""
      , _configPilot = outputPrefix ++ "Lib/Webhook/Storage/ConfigPilot/Config"
      }
