...
updateMultiple transaction = do
  ...
  updateWithKV
    [ Se.Set BeamPT.statusId transaction.statusId,
      ...
      Se.Set BeamPT.cardExpMonth transaction.cardExpMonth,
      Se.Set BeamPT.cardExpYear transaction.cardExpYear,
      Se.Set BeamPT.cardCountry transaction.cardCountry,
      Se.Set BeamPT.cardFingerprint transaction.cardFingerprint,
