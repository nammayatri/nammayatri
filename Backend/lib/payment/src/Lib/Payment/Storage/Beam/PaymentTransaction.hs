...
data PaymentTransactionT f = PaymentTransactionT
  { id :: B.C f Text,
    ...
    cardBrand :: B.C f (Maybe Text),
    cardIsin :: B.C f (Maybe Text),
    cardLastFourDigits :: B.C f (Maybe Text),
    cardIssuer :: B.C f (Maybe Text),
    cardExpMonth :: B.C f (Maybe Int),
    cardExpYear :: B.C f (Maybe Int),
    cardCountry :: B.C f (Maybe Text),
    cardFingerprint :: B.C f (Maybe Text),
    surchargeAmount :: B.C f (Maybe HighPrecMoney),
    taxAmount :: B.C f (Maybe HighPrecMoney),
    netAmount :: B.C f (Maybe HighPrecMoney),
    epgTxnId :: B.C f (Maybe Text),
    authorizationDateTime :: B.C f (Maybe UTCTime),
    captureDateTime :: B.C f (Maybe UTCTime),
