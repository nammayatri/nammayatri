...
instance FromField Payment.MandateStatus where
  fromField = fromFieldEnum

instance HasSqlValueSyntax be String => HasSqlValueSyntax be Payment.MandateStatus where
  sqlValueSyntax = autoSqlValueSyntax

instance BeamSqlBackend be => B.HasSqlEqualityCheck be Payment.MandateStatus

instance FromBackendRow Postgres Payment.MandateStatus

instance IsString Payment.MandateStatus where
  fromString = show

deriving stock instance Ord Payment.MandateStatus
...
deriving instance Ord Payment.TransactionStatus
...
deriving instance Ord Payment.Currency

instance FromField Payment.MandateFrequency where
  fromField = fromFieldEnum

instance HasSqlValueSyntax be String => HasSqlValueSyntax be Payment.MandateFrequency where
  sqlValueSyntax = autoSqlValueSyntax

instance BeamSqlBackend be => B.HasSqlEqualityCheck be Payment.MandateFrequency

instance FromBackendRow Postgres Payment.MandateFrequency

instance IsString Payment.MandateFrequency where
  fromString = show

deriving stock instance Ord Payment.MandateFrequency
