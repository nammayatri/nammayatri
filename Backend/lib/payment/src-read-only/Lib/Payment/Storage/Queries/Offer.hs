...
findAllActiveByMerchant merchantId merchantOperatingCityId isActive = do findAllWithKV [Se.And [Se.Is Beam.merchantId $ Se.Eq merchantId,
...
updateByPrimaryKey (Lib.Payment.Domain.Types.Offer.Offer {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.Offer Lib.Payment.Domain.Types.Offer.Offer
    where fromTType' (Beam.OfferT {..}) = do pure $ Just Lib.Payment.Domain.Types.Offer.Offer{createdAt = createdAt,
                                                                                              currency = currency,
                                                                                              ...
                                                                                              tnc = tnc,
                                                                                              updatedAt = updatedAt}
instance ToTType' Beam.Offer Lib.Payment.Domain.Types.Offer.Offer
    where toTType' (Lib.Payment.Domain.Types.Offer.Offer {..}) = do Beam.OfferT{Beam.createdAt = createdAt,
