...
updateByPrimaryKey (Lib.Payment.Domain.Types.PaymentOrderOffer.PaymentOrderOffer {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.PaymentOrderOffer Lib.Payment.Domain.Types.PaymentOrderOffer.PaymentOrderOffer
    where fromTType' (Beam.PaymentOrderOfferT {..}) = do pure $ Just Lib.Payment.Domain.Types.PaymentOrderOffer.PaymentOrderOffer{createdAt = createdAt,
                                                                                                                                  ...
                                                                                                                                  status = status,
                                                                                                                                  updatedAt = updatedAt}
instance ToTType' Beam.PaymentOrderOffer Lib.Payment.Domain.Types.PaymentOrderOffer.PaymentOrderOffer
    where toTType' (Lib.Payment.Domain.Types.PaymentOrderOffer.PaymentOrderOffer {..}) = do Beam.PaymentOrderOfferT{Beam.createdAt = createdAt,
