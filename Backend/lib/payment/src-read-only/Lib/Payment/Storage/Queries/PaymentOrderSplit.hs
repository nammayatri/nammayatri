...
findByPaymentOrder :: (Lib.Payment.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
updateByPrimaryKey (Lib.Payment.Domain.Types.PaymentOrderSplit.PaymentOrderSplit {..}) = do {_now <- getCurrentTime;
                                                                                             updateWithKV [Se.Set Beam.currency (((Kernel.Prelude.Just . (.currency))) amount),
...
instance FromTType' Beam.PaymentOrderSplit Lib.Payment.Domain.Types.PaymentOrderSplit.PaymentOrderSplit
    where fromTType' (Beam.PaymentOrderSplitT {..}) = do pure $ Just Lib.Payment.Domain.Types.PaymentOrderSplit.PaymentOrderSplit{amount = Kernel.Types.Common.mkPrice currency price,
                                                                                                                                  createdAt = createdAt,
                                                                                                                                  ...
                                                                                                                                  updatedAt = updatedAt,
                                                                                                                                  vendorId = vendorId}
instance ToTType' Beam.PaymentOrderSplit Lib.Payment.Domain.Types.PaymentOrderSplit.PaymentOrderSplit
    where toTType' (Lib.Payment.Domain.Types.PaymentOrderSplit.PaymentOrderSplit {..}) = do Beam.PaymentOrderSplitT{Beam.currency = ((Kernel.Prelude.Just . (.currency))) amount,
