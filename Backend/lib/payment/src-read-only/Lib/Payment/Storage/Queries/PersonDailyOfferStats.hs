...
findAllByDateAndPayoutStatus :: (Lib.Payment.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
findByPersonIdAndDate :: (Lib.Payment.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
updateByPrimaryKey (Lib.Payment.Domain.Types.PersonDailyOfferStats.PersonDailyOfferStats {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.PersonDailyOfferStats Lib.Payment.Domain.Types.PersonDailyOfferStats.PersonDailyOfferStats
    where fromTType' (Beam.PersonDailyOfferStatsT {..}) = do pure $ Just Lib.Payment.Domain.Types.PersonDailyOfferStats.PersonDailyOfferStats{createdAt = createdAt,
                                                                                                                                              currency = currency,
                                                                                                                                              date = date,
                                                                                                                                              ...
                                                                                                                                              updatedAt = updatedAt}
instance ToTType' Beam.PersonDailyOfferStats Lib.Payment.Domain.Types.PersonDailyOfferStats.PersonDailyOfferStats
    where toTType' (Lib.Payment.Domain.Types.PersonDailyOfferStats.PersonDailyOfferStats {..}) = do Beam.PersonDailyOfferStatsT{Beam.createdAt = createdAt,
