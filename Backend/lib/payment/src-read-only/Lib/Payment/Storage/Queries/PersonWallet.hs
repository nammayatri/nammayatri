...
updateByPrimaryKey (Lib.Payment.Domain.Types.PersonWallet.PersonWallet {..}) = do {_now <- getCurrentTime;
                                                                                   updateWithKV [Se.Set Beam.cashAmount cashAmount,
                                                                                                 ...
                                                                                                 Se.Set Beam.usablePointsAmount usablePointsAmount] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]}



instance FromTType' Beam.PersonWallet Lib.Payment.Domain.Types.PersonWallet.PersonWallet
    where fromTType' (Beam.PersonWalletT {..}) = do pure $ Just Lib.Payment.Domain.Types.PersonWallet.PersonWallet{cashAmount = cashAmount,
...
instance ToTType' Beam.PersonWallet Lib.Payment.Domain.Types.PersonWallet.PersonWallet
    where toTType' (Lib.Payment.Domain.Types.PersonWallet.PersonWallet {..}) = do Beam.PersonWalletT{Beam.cashAmount = cashAmount,
