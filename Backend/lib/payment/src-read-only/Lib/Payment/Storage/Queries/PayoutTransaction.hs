...
updatePayoutTransactionStatus status transactionRef = do {_now <- getCurrentTime;
...
updateByPrimaryKey (Lib.Payment.Domain.Types.PayoutTransaction.PayoutTransaction {..}) = do {_now <- getCurrentTime;
                                                                                             updateWithKV [Se.Set Beam.currency (((Kernel.Prelude.Just . (.currency))) amount),
                                                                                                           ...
                                                                                                           Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id), Se.Is Beam.transactionRef $ Se.Eq transactionRef]]}



instance FromTType' Beam.PayoutTransaction Lib.Payment.Domain.Types.PayoutTransaction.PayoutTransaction
    where fromTType' (Beam.PayoutTransactionT {..}) = do pure $ Just Lib.Payment.Domain.Types.PayoutTransaction.PayoutTransaction{amount = Kernel.Types.Common.mkPrice currency price,
                                                                                                                                  ...
                                                                                                                                  updatedAt = updatedAt}
instance ToTType' Beam.PayoutTransaction Lib.Payment.Domain.Types.PayoutTransaction.PayoutTransaction
    where toTType' (Lib.Payment.Domain.Types.PayoutTransaction.PayoutTransaction {..}) = do Beam.PayoutTransactionT{Beam.currency = ((Kernel.Prelude.Just . (.currency))) amount,
