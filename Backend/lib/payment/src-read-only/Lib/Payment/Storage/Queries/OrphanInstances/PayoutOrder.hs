...
instance FromTType' Beam.PayoutOrder Lib.Payment.Domain.Types.PayoutOrder.PayoutOrder
    where fromTType' (Beam.PayoutOrderT {..}) = do pure $ Just Lib.Payment.Domain.Types.PayoutOrder.PayoutOrder{accountDetailsType = accountDetailsType,
                                                                                                                ...
                                                                                                                updatedAt = updatedAt,
                                                                                                                vpa = vpa}
instance ToTType' Beam.PayoutOrder Lib.Payment.Domain.Types.PayoutOrder.PayoutOrder
    where toTType' (Lib.Payment.Domain.Types.PayoutOrder.PayoutOrder {..}) = do Beam.PayoutOrderT{Beam.accountDetailsType = accountDetailsType,
