      ...
      Just
        Lib.Payment.Domain.Types.PayoutOrder.PayoutOrder
          { accountDetailsType = accountDetailsType,
            ...
            entityId = Kernel.Prelude.maybe (entityIds Kernel.Prelude.>>= Kernel.Prelude.listToMaybe) Kernel.Prelude.Just entityId,
            entityIds = entityIds,
            ...
            merchantTopUpAmount = merchantTopUpAmount,
  ...
  toTType' (Lib.Payment.Domain.Types.PayoutOrder.PayoutOrder {..}) = do
    Beam.PayoutOrderT
      { Beam.accountDetailsType = accountDetailsType,
        ...
        Beam.merchantTopUpAmount = merchantTopUpAmount,
