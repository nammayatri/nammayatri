...
updateByPrimaryKey (Lib.Payment.Domain.Types.OfflineOffer.OfflineOffer {..}) = do
  _now <- getCurrentTime
  updateWithKV
...
instance FromTType' Beam.OfflineOffer Lib.Payment.Domain.Types.OfflineOffer.OfflineOffer where
  fromTType' (Beam.OfflineOfferT {..}) = do
    pure $
      Just
        Lib.Payment.Domain.Types.OfflineOffer.OfflineOffer
          { createdAt = createdAt,
...
instance ToTType' Beam.OfflineOffer Lib.Payment.Domain.Types.OfflineOffer.OfflineOffer where
  toTType' (Lib.Payment.Domain.Types.OfflineOffer.OfflineOffer {..}) = do
    Beam.OfflineOfferT
