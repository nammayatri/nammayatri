...
findAllByWalletId :: (Lib.Payment.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
findByWalletIdAndStatus :: (Lib.Payment.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
updateByPrimaryKey (Lib.Payment.Domain.Types.WalletRewardPosting.WalletRewardPosting {..}) = do {_now <- getCurrentTime;
                                                                                                 updateWithKV [Se.Set Beam.cashAmount cashAmount,
                                                                                                               ...
                                                                                                               Se.Set Beam.walletId (Kernel.Types.Id.getId walletId)] [Se.And [Se.Is Beam.id $ Se.Eq (Kernel.Types.Id.getId id)]]}



instance FromTType' Beam.WalletRewardPosting Lib.Payment.Domain.Types.WalletRewardPosting.WalletRewardPosting
    where fromTType' (Beam.WalletRewardPostingT {..}) = do pure $ Just Lib.Payment.Domain.Types.WalletRewardPosting.WalletRewardPosting{cashAmount = cashAmount,
                                                                                                                                        createdAt = createdAt,
...
instance ToTType' Beam.WalletRewardPosting Lib.Payment.Domain.Types.WalletRewardPosting.WalletRewardPosting
    where toTType' (Lib.Payment.Domain.Types.WalletRewardPosting.WalletRewardPosting {..}) = do Beam.WalletRewardPostingT{Beam.cashAmount = cashAmount,
