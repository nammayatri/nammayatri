...
updateIsApiCallSuccess isApiCallSuccess id = do {_now <- getCurrentTime;
...
updateRefundsEntryByResponse :: (Lib.Payment.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
updateRefundsEntryByResponse initiatedBy idAssignedByServiceProvider errorMessage errorCode status arn completedAt id = do {_now <- getCurrentTime;
                                                                                                                            updateWithKV [Se.Set Beam.initiatedBy initiatedBy,
...
updateRefundsEntryByStripeResponse :: (Lib.Payment.Storage.Beam.BeamFlow.BeamFlow m r) =>
                                      (Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.Prelude.Maybe Kernel.Prelude.Text -> Kernel.External.Payment.Interface.RefundStatus -> Kernel.Prelude.Maybe Kernel.Prelude.Bool -> Kernel.Prelude.Maybe Kernel.Prelude.UTCTime -> Kernel.Types.Id.Id Lib.Payment.Domain.Types.Refunds.Refunds -> m ())
updateRefundsEntryByStripeResponse idAssignedByServiceProvider errorCode status isApiCallSuccess completedAt id = do {_now <- getCurrentTime;
                                                                                                                      updateWithKV [Se.Set Beam.idAssignedByServiceProvider idAssignedByServiceProvider,
                                                                                                                                    Se.Set Beam.errorCode errorCode,
                                                                                                                                    Se.Set Beam.status status,
