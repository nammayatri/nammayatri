...
data PayoutRequest
    = PayoutRequest {amount :: Kernel.Prelude.Maybe Kernel.Types.Common.HighPrecMoney,
...
data PayoutRequestStatus
    = INITIATED | PROCESSING | CREDITED | AUTO_PAY_FAILED | RETRYING | FAILED | CANCELLED | CASH_PAID | CASH_PENDING
