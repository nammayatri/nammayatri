...
instance CompleteTag BecknTag where
  ...
  getTagGroup = \case
    ...
    PAYMENT_CHARGE_BEARER -> SETTLEMENT_DETAILS
    ...
    CUSTOMER_RATING -> CUSTOMER_INFO
    CUSTOMER_TOTAL_RATINGS -> CUSTOMER_INFO
    CUSTOMER_GENDER -> CUSTOMER_INFO
    ...
    SCHEDULING_CHARGE -> FARE_POLICY
    SCHEDULING_CHARGE_PERCENTAGE -> FARE_POLICY
