...
mapServiceTierToCategory = \case
  ...
  AUTO_DIDI -> Enums.AUTO_RICKSHAW
  CAB_DIDI -> Enums.CAB
  BIKE_DIDI -> Enums.MOTORCYCLE

getListOfServiceTireTypes :: Enums.VehicleCategory -> [DVST.ServiceTierType]
getListOfServiceTireTypes Enums.CAB = [DVST.SEDAN, DVST.SUV, DVST.HATCHBACK, DVST.TAXI, DVST.TAXI_PLUS, DVST.ECO, DVST.COMFY, DVST.PREMIUM, DVST.PREMIUM_SEDAN, DVST.BLACK, DVST.BLACK_XL, DVST.SUV_PLUS, DVST.HERITAGE_CAB, DVST.VIP_ESCORT, DVST.VIP_OFFICER, DVST.AC_PRIORITY, DVST.CAB_DIDI]
getListOfServiceTireTypes Enums.AUTO_RICKSHAW = [DVST.AUTO_RICKSHAW, DVST.EV_AUTO_RICKSHAW, DVST.AUTO_PLUS, DVST.E_RICKSHAW, DVST.AUTO_DIDI]
getListOfServiceTireTypes Enums.MOTORCYCLE = [DVST.BIKE, DVST.DELIVERY_BIKE, DVST.BIKE_PLUS, DVST.BIKE_DIDI]
getListOfServiceTireTypes Enums.TWO_WHEELER = [DVST.BIKE, DVST.DELIVERY_BIKE, DVST.BIKE_PLUS, DVST.BIKE_DIDI]
