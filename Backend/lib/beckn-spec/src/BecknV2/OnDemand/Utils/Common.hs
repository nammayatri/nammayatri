...
mapServiceTierToCategory = \case
  ...
  MAHILA_SHAKTI -> Enums.AUTO_RICKSHAW
  AUTO_ACCEPT -> Enums.AUTO_RICKSHAW
...
getListOfServiceTireTypes Enums.AUTO_RICKSHAW = [DVST.AUTO_RICKSHAW, DVST.EV_AUTO_RICKSHAW, DVST.AUTO_PLUS, DVST.E_RICKSHAW, DVST.AUTO_LITE, DVST.PINK_AUTO, DVST.MAHILA_SHAKTI, DVST.AUTO_ACCEPT]
