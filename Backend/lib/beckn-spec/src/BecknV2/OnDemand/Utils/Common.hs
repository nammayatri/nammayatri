...
getListOfServiceTireTypes Enums.AUTO_RICKSHAW = [DVST.AUTO_RICKSHAW]
getListOfServiceTireTypes Enums.MOTORCYCLE = [DVST.BIKE]
getListOfServiceTireTypes Enums.TWO_WHEELER = [DVST.BIKE]
