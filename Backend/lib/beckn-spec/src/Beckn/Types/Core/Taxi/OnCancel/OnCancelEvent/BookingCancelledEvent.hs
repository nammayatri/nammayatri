...
module Beckn.Types.Core.Taxi.OnCancel.OnCancelEvent.BookingCancelledEvent
  ( module Beckn.Types.Core.Taxi.OnCancel.OnCancelEvent.BookingCancelledEvent,
    module Reexport,
  )
where
...
import Beckn.Types.Core.Taxi.OnCancel.OnCancelEvent.OnCancelEventType (OnCancelEventType (RIDE_BOOKING_CANCELLED))
...
instance ToSchema BookingCancelledEvent where
  declareNamedSchema _ = do
    ...
    update_type <- declareSchemaRef (Proxy :: Proxy OnCancelEventType)
    let st =
          mempty
