...
module Beckn.Types.Core.Taxi.OnUpdate.Provider
  ( Provider (..),
    ProviderTags (..),
  )
where
...
-- import Beckn.Types.Core.Taxi.OnUpdate.Addon
-- import Beckn.Types.Core.Taxi.OnUpdate.Category
import Beckn.Types.Core.Taxi.OnUpdate.Descriptor
import Beckn.Types.Core.Taxi.OnUpdate.Fulfillment
import Beckn.Types.Core.Taxi.OnUpdate.Item
-- import Beckn.Types.Core.Taxi.OnUpdate.Offer
-- import Beckn.Types.Core.Taxi.OnUpdate.ProviderLocation
import Data.Aeson
...
data Provider = Provider
  { id :: Text,
    ...
    -- locations :: [LatLong],
    -- categories :: [Category],
    item :: [Item], --FIXME this should be list of only RENTAL or only ONE_WAY items
    -- offers :: [Offer],
    -- add_ons :: [Addon],
