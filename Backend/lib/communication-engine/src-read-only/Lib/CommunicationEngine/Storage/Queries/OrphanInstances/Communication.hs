...
module Lib.CommunicationEngine.Storage.Queries.OrphanInstances.Communication where
...
instance FromTType' Beam.Communication Lib.CommunicationEngine.Domain.Types.Communication.Communication where
  fromTType' (Beam.CommunicationT {..}) = do
    pure $
      Just
        Lib.CommunicationEngine.Domain.Types.Communication.Communication
          { body = body,
...
instance ToTType' Beam.Communication Lib.CommunicationEngine.Domain.Types.Communication.Communication where
  toTType' (Lib.CommunicationEngine.Domain.Types.Communication.Communication {..}) = do
    Beam.CommunicationT
      { Beam.body = body,
