...
module Lib.CommunicationEngine.Storage.Queries.OrphanInstances.CommunicationDelivery where
...
instance FromTType' Beam.CommunicationDelivery Lib.CommunicationEngine.Domain.Types.CommunicationDelivery.CommunicationDelivery where
  fromTType' (Beam.CommunicationDeliveryT {..}) = do
    pure $
      Just
        Lib.CommunicationEngine.Domain.Types.CommunicationDelivery.CommunicationDelivery
          { channel = channel,
...
instance ToTType' Beam.CommunicationDelivery Lib.CommunicationEngine.Domain.Types.CommunicationDelivery.CommunicationDelivery where
  toTType' (Lib.CommunicationEngine.Domain.Types.CommunicationDelivery.CommunicationDelivery {..}) = do
