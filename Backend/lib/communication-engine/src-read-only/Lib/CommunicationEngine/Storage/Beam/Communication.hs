...
module Lib.CommunicationEngine.Storage.Beam.Communication where
...
data CommunicationT f = CommunicationT
  { body :: (B.C f Kernel.Prelude.Text),
    ...
    contentType :: (B.C f Lib.CommunicationEngine.Domain.Types.Communication.CommunicationContentType),
    createdAt :: (B.C f Kernel.Prelude.UTCTime),
    ctaButton :: (B.C f (Kernel.Prelude.Maybe Data.Aeson.Value)),
    domain :: (B.C f Lib.CommunicationEngine.Domain.Types.Communication.CommunicationDomain),
    ...
    senderRole :: (B.C f Lib.CommunicationEngine.Domain.Types.Communication.CommunicationSenderRole),
    status :: (B.C f Lib.CommunicationEngine.Domain.Types.Communication.CommunicationStatus),
    ...
    triggerType :: (B.C f Lib.CommunicationEngine.Domain.Types.Communication.CommunicationTriggerType),
