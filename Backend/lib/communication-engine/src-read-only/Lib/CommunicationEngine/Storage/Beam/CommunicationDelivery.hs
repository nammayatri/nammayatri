...
module Lib.CommunicationEngine.Storage.Beam.CommunicationDelivery where
...
data CommunicationDeliveryT f = CommunicationDeliveryT
  { channel :: (B.C f Lib.CommunicationEngine.Domain.Types.Communication.ChannelType),
    ...
    recipientRole :: (B.C f Lib.CommunicationEngine.Domain.Types.CommunicationDelivery.CommunicationRecipientRole),
    status :: (B.C f Lib.CommunicationEngine.Domain.Types.CommunicationDelivery.DeliveryStatus),
