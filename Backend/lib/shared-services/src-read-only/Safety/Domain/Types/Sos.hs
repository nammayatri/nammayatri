...
data Sos
    = Sos {createdAt :: Kernel.Prelude.UTCTime,
...
data SosType
    = Police | CustomerCare | EmergencyContact Safety.Domain.Types.Sos.EmergencyContactId | SafetyFlow | CSAlertSosTicket | AudioRecording | KaptureDashboard
