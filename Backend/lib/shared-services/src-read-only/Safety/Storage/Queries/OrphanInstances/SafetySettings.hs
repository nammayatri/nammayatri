...
instance FromTType' Beam.SafetySettings Safety.Domain.Types.SafetySettings.SafetySettings
    where fromTType' (Beam.SafetySettingsT {..}) = do pure $ Just Safety.Domain.Types.SafetySettings.SafetySettings{aggregatedRideShareSetting = aggregatedRideShareSetting,
                                                                                                                    ...
                                                                                                                    updatedAt = updatedAt}
instance ToTType' Beam.SafetySettings Safety.Domain.Types.SafetySettings.SafetySettings
    where toTType' (Safety.Domain.Types.SafetySettings.SafetySettings {..}) = do Beam.SafetySettingsT{Beam.aggregatedRideShareSetting = aggregatedRideShareSetting,
