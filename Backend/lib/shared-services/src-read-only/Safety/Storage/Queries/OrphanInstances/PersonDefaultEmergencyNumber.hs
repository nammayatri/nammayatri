...
instance FromTType' Beam.PersonDefaultEmergencyNumber Safety.Domain.Types.PersonDefaultEmergencyNumber.PersonDefaultEmergencyNumber
    where fromTType' (Beam.PersonDefaultEmergencyNumberT {..}) = do pure $ Just Safety.Domain.Types.PersonDefaultEmergencyNumber.PersonDefaultEmergencyNumber{contactPersonId = Kernel.Types.Id.Id <$> contactPersonId,
                                                                                                                                                              createdAt = createdAt,
...
instance ToTType' Beam.PersonDefaultEmergencyNumber Safety.Domain.Types.PersonDefaultEmergencyNumber.PersonDefaultEmergencyNumber
    where toTType' (Safety.Domain.Types.PersonDefaultEmergencyNumber.PersonDefaultEmergencyNumber {..}) = do Beam.PersonDefaultEmergencyNumberT{Beam.contactPersonId = Kernel.Types.Id.getId <$> contactPersonId,
