...
data Issue
    = Issue {id :: Kernel.Types.Id.Id Issue,
...
data IssueListRes
    = IssueListRes {list :: [Issue], summary :: Summary}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
data Summary
    = Summary {totalCount :: Kernel.Prelude.Int, count :: Kernel.Prelude.Int}
    deriving stock Generic
    deriving anyclass (ToJSON, FromJSON, ToSchema)
type API = ("issue" :> (GetIssueListV1 :<|> PostIssueListTicketStatusCallBack))
type GetIssueListV1 = ("list" :> QueryParam "limit" Kernel.Prelude.Int :> QueryParam "offset" Kernel.Prelude.Int :> QueryParam "mobileCountryCode" Kernel.Prelude.Text :> QueryParam "mobileNumber"
                                                                                                                                                                                     Kernel.Prelude.Text :> QueryParam "from" Kernel.Prelude.UTCTime :> QueryParam "to"
...
data IssueListAPIs
    = IssueListAPIs {getIssueListV1 :: (Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Int) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.Text) -> Kernel.Prelude.Maybe (Kernel.Prelude.UTCTime) -> Kernel.Prelude.Maybe (Kernel.Prelude.UTCTime) -> EulerHS.Types.EulerClient IssueListRes),
...
mkIssueListAPIs issueListClient = (IssueListAPIs {..})
                    where getIssueListV1 :<|> postIssueListTicketStatusCallBack = issueListClient
data IssueListUserActionType
    = GET_ISSUE_LIST_V1 | POST_ISSUE_LIST_TICKET_STATUS_CALL_BACK
