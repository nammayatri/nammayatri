...
type GetIssueCategoryDetail = ("category" :> Capture "categoryId" (Kernel.Types.Id.Id IssueManagement.Domain.Types.Issue.IssueCategory.IssueCategory) :> "detail" :> QueryParam "language"
                                                                                                                                                                                Kernel.External.Types.Language :> Get ('[JSON]) IssueManagement.Common.Dashboard.Issue.IssueCategoryDetailRes)
type GetIssueOptionDetail = ("option" :> Capture "optionId" (Kernel.Types.Id.Id IssueManagement.Domain.Types.Issue.IssueOption.IssueOption) :> "detail" :> QueryParam "language"
                                                                                                                                                                      Kernel.External.Types.Language :> Get ('[JSON]) IssueManagement.Common.Dashboard.Issue.IssueOptionDetailRes)
type GetIssueMessageDetail = ("message" :> Capture "messageId" (Kernel.Types.Id.Id IssueManagement.Domain.Types.Issue.IssueMessage.IssueMessage) :> "detail" :> QueryParam "language"
                                                                                                                                                                           Kernel.External.Types.Language :> Get ('[JSON]) IssueManagement.Common.Dashboard.Issue.IssueMessageDetailRes)
type GetIssueMessageList = ("message" :> "list" :> QueryParam "categoryId" ((Kernel.Types.Id.Id IssueManagement.Domain.Types.Issue.IssueCategory.IssueCategory)) :> QueryParam "optionId"
                                                                                                                                                                               ((Kernel.Types.Id.Id IssueManagement.Domain.Types.Issue.IssueOption.IssueOption)) :> QueryParam "isActive"
                                                                                                                                                                                                                                                                               Kernel.Prelude.Bool :> QueryParam "language"
                                                                                                                                                                                                                                                                                                                 Kernel.External.Types.Language :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                       IssueManagement.Common.Dashboard.Issue.IssueMessageListRes)
type GetIssueOptionList = ("option" :> "list" :> QueryParam "categoryId" ((Kernel.Types.Id.Id IssueManagement.Domain.Types.Issue.IssueCategory.IssueCategory)) :> QueryParam "messageId"
                                                                                                                                                                             ((Kernel.Types.Id.Id IssueManagement.Domain.Types.Issue.IssueMessage.IssueMessage)) :> QueryParam "isActive"
                                                                                                                                                                                                                                                                               Kernel.Prelude.Bool :> QueryParam "language"
                                                                                                                                                                                                                                                                                                                 Kernel.External.Types.Language :> Get ('[JSON])
                                                                                                                                                                                                                                                                                                                                                       IssueManagement.Common.Dashboard.Issue.IssueOptionListDRes)
type DeleteIssueCategory = ("category" :> Capture "categoryId" (Kernel.Types.Id.Id IssueManagement.Domain.Types.Issue.IssueCategory.IssueCategory) :> "delete" :> Delete ('[JSON])
                                                                                                                                                                         Kernel.Types.APISuccess.APISuccess)
type DeleteIssueOption = ("option" :> Capture "optionId" (Kernel.Types.Id.Id IssueManagement.Domain.Types.Issue.IssueOption.IssueOption) :> "delete" :> Delete ('[JSON])
                                                                                                                                                               Kernel.Types.APISuccess.APISuccess)
type DeleteIssueMessage = ("message" :> Capture "messageId" (Kernel.Types.Id.Id IssueManagement.Domain.Types.Issue.IssueMessage.IssueMessage) :> "delete" :> Delete ('[JSON])
                                                                                                                                                                    Kernel.Types.APISuccess.APISuccess)
type GetIssueCategoryFlowPreview = ("category" :> Capture "categoryId" (Kernel.Types.Id.Id IssueManagement.Domain.Types.Issue.IssueCategory.IssueCategory) :> "preview" :> QueryParam "language"
                                                                                                                                                                                      Kernel.External.Types.Language :> Get ('[JSON]) IssueManagement.Common.Dashboard.Issue.IssueCategoryFlowPreviewRes)
...
type PostIssueBulkUpsertTranslations = ("translation" :> "bulk" :> ReqBody ('[JSON]) IssueManagement.Common.Dashboard.Issue.BulkUpsertTranslationsReq :> Post ('[JSON])
                                                                                                                                                              Kernel.Types.APISuccess.APISuccess)
