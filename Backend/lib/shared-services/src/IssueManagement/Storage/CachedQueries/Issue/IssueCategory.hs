...
findAllByLanguage :: (CacheFlow m r, BeamFlow m r) => Language -> Identifier -> m [(IssueCategory, Maybe IssueTranslation)]
...
findById :: (CacheFlow m r, BeamFlow m r) => Id IssueCategory -> Identifier -> m (Maybe IssueCategory)
...
findByIdAndLanguage :: (CacheFlow m r, BeamFlow m r) => Id IssueCategory -> Language -> Identifier -> m (Maybe (IssueCategory, Maybe IssueTranslation))
