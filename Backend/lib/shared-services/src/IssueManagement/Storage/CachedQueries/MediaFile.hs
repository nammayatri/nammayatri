...
findById :: (CacheFlow m r, BeamFlow m r) => Id MediaFile -> Identifier -> m (Maybe MediaFile)
...
findAllInForIssueReportId :: (CacheFlow m r, BeamFlow m r) => [Id MediaFile] -> Id IssueReport -> Identifier -> m [MediaFile]
