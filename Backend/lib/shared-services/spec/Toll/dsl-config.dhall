...
let outputPrefixReadOnly =
      rootDir ++ "/Backend/lib/shared-services/src-read-only/Toll/"

let outputPrefix = rootDir ++ "/Backend/lib/shared-services/src/Toll/"
...
let extraDefaultFields =
      [ { _1 = "merchantId", _2 = "Maybe Text" }
      , { _1 = "merchantOperatingCityId", _2 = "Maybe Text" }
