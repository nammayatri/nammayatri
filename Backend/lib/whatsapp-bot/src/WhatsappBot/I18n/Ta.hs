...
ta =
  LanguageStrings
    { languageName = "Tamil",
      ...
      welcomeBack = \name -> "மீண்டும் வரவேற்கிறோம், " <> name <> "! \128075",
      ...
      cancelFailed = ("ரத்து செய்ய இயலவில்லை: " <>),
      ...
      markSafeFailed = ("பாதுகாப்பானது எனக் குறிக்க இயலவில்லை: " <>),
      ...
      flexiCallDriver = ("📞 டிரைவரை அழைக்கவும்: " <>),
