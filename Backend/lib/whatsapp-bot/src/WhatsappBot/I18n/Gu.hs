...
gu =
  LanguageStrings
    { languageName = "Gujarati",
      ...
      welcomeBack = \name -> "પાછા સ્વાગત છે, " <> name <> "! \128075",
      ...
      otpResendFailed = ("OTP ફરીથી મોકલી શકાયો નહીં: " <>),
      ...
      cancelFailed = ("રદ કરી શકાયું નહીં: " <>),
      cancelled = "રદ થયું.",
      ...
      markSafeFailed = ("સુરક્ષિત ચિહ્નિત કરી શકાયું નથી: " <>),
      ...
      flexiCallDriver = ("📞 ડ્રાઈવરને કૉલ કરો: " <>),
