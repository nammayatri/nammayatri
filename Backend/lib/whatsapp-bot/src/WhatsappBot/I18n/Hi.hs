...
hi =
  LanguageStrings
    { languageName = "Hindi",
      ...
      welcomeBack = \name -> "वापसी पर स्वागत है, " <> name <> "! \128075",
      ...
      otpResendFailed = ("OTP दोबारा नहीं भेज पाए: " <>),
      ...
      markSafeFailed = ("सुरक्षित चिह्नित नहीं कर सके: " <>),
      ...
      flexiCallDriver = ("📞 ड्राइवर को कॉल करें: " <>),
