...
te =
  LanguageStrings
    { languageName = "Telugu",
      ...
      welcomeBack = \name -> "తిరిగి స్వాగతం, " <> name <> "! \128075",
      ...
      otpResendFailed = ("OTP మళ్ళీ పంపలేకపోయాము: " <>),
      ...
      cancelFailed = ("రద్దు చేయలేకపోయాము: " <>),
      ...
      markSafeFailed = ("సురక్షితం అని గుర్తించలేకపోయాము: " <>),
      ...
      flexiCallDriver = ("📞 డ్రైవర్\8204కు కాల్ చేయండి: " <>),
