...
kn =
  LanguageStrings
    { languageName = "Kannada",
      ...
      otpResendFailed = ("OTP ಮರುಕಳುಹಿಸಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ: " <>),
      ...
      cancelFailed = ("ರದ್ದು ಮಾಡಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ: " <>),
      cancelled = "ರದ್ದಾಗಿದೆ.",
      ...
      markSafeFailed = ("ಸುರಕ್ಷಿತ ಎಂದು ಗುರುತಿಸಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ: " <>),
      ...
      flexiCallDriver = ("📞 ಚಾಲಕರಿಗೆ ಕರೆ ಮಾಡಿ: " <>),
