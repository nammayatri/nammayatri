...
let outputPrefixReadOnly =
      rootDir ++ "/Backend/lib/journey-planner/src-read-only/"

let outputPrefix = rootDir ++ "/Backend/lib/journey-planner/src/"
...
let outputPath =
      { _apiRelatedTypes =
          outputPrefixReadOnly ++ "Lib/JourneyPlanner/API/Types"
      , _extraApiRelatedTypes = ""
      , _beamQueries =
          outputPrefixReadOnly ++ "Lib/JourneyPlanner/Storage/Queries"
      , _extraBeamQueries =
          outputPrefix ++ "Lib/JourneyPlanner/Storage/Queries/"
      , _cachedQueries =
          outputPrefixReadOnly ++ "Lib/JourneyPlanner/Storage/CachedQueries"
      , _extraCachedQueries =
          outputPrefix ++ "Lib/JourneyPlanner/Storage/CachedQueries/"
      , _beamTable = outputPrefixReadOnly ++ "Lib/JourneyPlanner/Storage/Beam"
      , _domainHandler = outputPrefix ++ "Lib/JourneyPlanner/Domain/Action"
      , _domainHandlerDashboard = ""
      , _domainType = outputPrefixReadOnly ++ "Lib/JourneyPlanner/Types"
      , _servantApi = outputPrefixReadOnly ++ "Lib/JourneyPlanner/API/Action"
...
in  { _output = outputPath
    , _storageConfig =
      ...
      , _defaultCachedQueryKeyPrefix = "journey-planner"
      }
