...
let outputPrefixReadOnly = rootDir ++ "/Backend/lib/yudhishthira/src-read-only/"

let outputPrefix = rootDir ++ "/Backend/lib/yudhishthira/src/"
...
let outputPath =
      ...
      , _cachedQueries =
          outputPrefixReadOnly ++ "Lib/Yudhishthira/Storage/CachedQueries"
      , _extraCachedQueries =
          outputPrefix ++ "Lib/Yudhishthira/Storage/CachedQueries/"
      , _beamTable = outputPrefixReadOnly ++ "Lib/Yudhishthira/Storage/Beam"
      , _domainHandler = outputPrefix ++ "Lib/Yudhishthira/Domain/Action"
      ...
      , _purescriptFrontend = ""
      , _configPilot =
          outputPrefix ++ "Lib/Yudhishthira/Storage/ConfigPilot/Config"
      }
