...
data TagActionNotificationConfig
    = TagActionNotificationConfig {id :: Kernel.Types.Id.Id Lib.Yudhishthira.Types.TagActionNotificationConfig.TagActionNotificationConfig,
