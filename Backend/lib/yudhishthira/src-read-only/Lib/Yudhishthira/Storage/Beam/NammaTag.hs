...
data NammaTagT f
    = NammaTagT {actionEngine :: (B.C f (Kernel.Prelude.Maybe Data.Aeson.Value)),
...
instance B.Table NammaTagT
    where data PrimaryKey NammaTagT f = NammaTagId (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
