...
data AppDynamicLogicElementT f
    = AppDynamicLogicElementT {description :: (B.C f (Kernel.Prelude.Maybe Data.Text.Text)),
...
instance B.Table AppDynamicLogicElementT
    where data PrimaryKey AppDynamicLogicElementT f
