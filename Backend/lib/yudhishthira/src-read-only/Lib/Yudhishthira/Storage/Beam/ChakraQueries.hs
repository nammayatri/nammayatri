...
data ChakraQueriesT f
    = ChakraQueriesT {chakra :: (B.C f Lib.Yudhishthira.Types.Chakra),
...
instance B.Table ChakraQueriesT
    where data PrimaryKey ChakraQueriesT f = ChakraQueriesId (B.C f Lib.Yudhishthira.Types.Chakra) (B.C f Kernel.Prelude.Text) deriving (Generic, B.Beamable)
