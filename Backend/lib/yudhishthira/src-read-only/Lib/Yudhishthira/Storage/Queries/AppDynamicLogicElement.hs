...
findByDomainAndVersion :: (Lib.Yudhishthira.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
findLatestVersion :: (Lib.Yudhishthira.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
updateByPrimaryKey (Lib.Yudhishthira.Types.AppDynamicLogicElement.AppDynamicLogicElement {..}) = do {_now <- getCurrentTime;
                                                                                                     updateWithKV [Se.Set Beam.description description,
                                                                                                                   ...
                                                                                                                   Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.domain $ Se.Eq domain, Se.Is Beam.order $ Se.Eq order, Se.Is Beam.version $ Se.Eq version]]}
