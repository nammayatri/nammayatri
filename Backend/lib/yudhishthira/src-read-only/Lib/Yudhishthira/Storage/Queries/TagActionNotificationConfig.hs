...
findAllByMerchantOperatingCityIdAndNotificationKey :: (Lib.Yudhishthira.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
findAllByMerchantOperatingCityIdAndNotificationKey merchantOperatingCityId notificationKey = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
updateByPrimaryKey (Lib.Yudhishthira.Types.TagActionNotificationConfig.TagActionNotificationConfig {..}) = do {_now <- getCurrentTime;
...
instance FromTType' Beam.TagActionNotificationConfig Lib.Yudhishthira.Types.TagActionNotificationConfig.TagActionNotificationConfig
    where fromTType' (Beam.TagActionNotificationConfigT {..}) = do pure $ Just Lib.Yudhishthira.Types.TagActionNotificationConfig.TagActionNotificationConfig{id = Kernel.Types.Id.Id id,
                                                                                                                                                              ...
                                                                                                                                                              createdAt = createdAt,
                                                                                                                                                              updatedAt = updatedAt}
instance ToTType' Beam.TagActionNotificationConfig Lib.Yudhishthira.Types.TagActionNotificationConfig.TagActionNotificationConfig
    where toTType' (Lib.Yudhishthira.Types.TagActionNotificationConfig.TagActionNotificationConfig {..}) = do Beam.TagActionNotificationConfigT{Beam.id = Kernel.Types.Id.getId id,
