...
findByCityAndDomain :: (Lib.Yudhishthira.Storage.Beam.BeamFlow.BeamFlow m r) =>
...
findByCityAndDomain merchantOperatingCityId timeBoundDomain = do findAllWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
findByPrimaryKey merchantOperatingCityId name timeBoundDomain = do findOneWithKV [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
...
updateByPrimaryKey (Lib.Yudhishthira.Types.TimeBoundConfig.TimeBoundConfig {..}) = do {_now <- getCurrentTime;
                                                                                       updateWithKV [Se.Set Beam.timeBounds timeBounds, Se.Set Beam.updatedAt _now] [Se.And [Se.Is Beam.merchantOperatingCityId $ Se.Eq (Kernel.Types.Id.getId merchantOperatingCityId),
                                                                                                                                                                             Se.Is Beam.name $ Se.Eq name,
                                                                                                                                                                             Se.Is Beam.timeBoundDomain $ Se.Eq timeBoundDomain]]}
