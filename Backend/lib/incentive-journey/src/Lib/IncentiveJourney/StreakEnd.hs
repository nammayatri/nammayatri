    ...
    { rewardKind = maybe IJ.Coins Convert.toLibRewardKind cjm.streakEndRewardType,
      ...
      subscriptionWaiveOff =
        IJ.mkSubscriptionWaiveOffSpec
          cjm.streakEndSubscriptionWaiveOffPercentage
          cjm.streakEndSubscriptionWaiveOffDaysValidFor
          cjm.streakEndSubscriptionWaiveOffServiceName
          cjm.streakEndSubscriptionWaiveOffMode
    }
