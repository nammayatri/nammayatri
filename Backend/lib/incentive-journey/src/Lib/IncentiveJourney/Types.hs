...
-- | Dashboard-configured subscription fee waive. Stored separately from Int rewardValue.
...
mkSubscriptionWaiveOffSpec :: Maybe Int -> Maybe Int -> Maybe Text -> Maybe Text -> Maybe SubscriptionWaiveOffSpec
mkSubscriptionWaiveOffSpec percentage daysValidFor serviceName waiveOffMode =
  SubscriptionWaiveOffSpec <$> percentage <*> daysValidFor <*> serviceName <*> waiveOffMode
