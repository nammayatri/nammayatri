...
data CohortJourneyMappingT f = CohortJourneyMappingT
  { cohortId :: B.C f Kernel.Prelude.Text,
    ...
    streakEndSubscriptionWaiveOffDaysValidFor :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    streakEndSubscriptionWaiveOffMode :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    streakEndSubscriptionWaiveOffPercentage :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    streakEndSubscriptionWaiveOffServiceName :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
