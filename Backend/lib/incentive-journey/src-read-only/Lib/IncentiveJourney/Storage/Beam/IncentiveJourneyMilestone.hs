...
data IncentiveJourneyMilestoneT f = IncentiveJourneyMilestoneT
  { areaType :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    ...
    subscriptionWaiveOffDaysValidFor :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    subscriptionWaiveOffMode :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
    subscriptionWaiveOffPercentage :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Int),
    subscriptionWaiveOffServiceName :: B.C f (Kernel.Prelude.Maybe Kernel.Prelude.Text),
