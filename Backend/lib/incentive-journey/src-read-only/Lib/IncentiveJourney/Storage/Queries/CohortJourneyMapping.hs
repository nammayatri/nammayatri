...
updateByPrimaryKey (Lib.IncentiveJourney.Domain.Types.CohortJourneyMapping.CohortJourneyMapping {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.cohortId (Kernel.Types.Id.getId cohortId),
      ...
      Se.Set Beam.streakEndSubscriptionWaiveOffDaysValidFor streakEndSubscriptionWaiveOffDaysValidFor,
      Se.Set Beam.streakEndSubscriptionWaiveOffMode streakEndSubscriptionWaiveOffMode,
      Se.Set Beam.streakEndSubscriptionWaiveOffPercentage streakEndSubscriptionWaiveOffPercentage,
      Se.Set Beam.streakEndSubscriptionWaiveOffServiceName streakEndSubscriptionWaiveOffServiceName,
