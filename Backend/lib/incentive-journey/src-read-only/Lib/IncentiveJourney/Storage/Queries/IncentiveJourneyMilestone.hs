...
updateByPrimaryKey (Lib.IncentiveJourney.Domain.Types.IncentiveJourneyMilestone.IncentiveJourneyMilestone {..}) = do
  ...
  updateWithKV
    [ Se.Set Beam.areaType (Kernel.Prelude.fmap (Data.Text.pack . Kernel.Prelude.show) areaType),
      ...
      Se.Set Beam.subscriptionWaiveOffDaysValidFor subscriptionWaiveOffDaysValidFor,
      Se.Set Beam.subscriptionWaiveOffMode subscriptionWaiveOffMode,
      Se.Set Beam.subscriptionWaiveOffPercentage subscriptionWaiveOffPercentage,
      Se.Set Beam.subscriptionWaiveOffServiceName subscriptionWaiveOffServiceName,
      ...
      Just
        Lib.IncentiveJourney.Domain.Types.IncentiveJourneyMilestone.IncentiveJourneyMilestone
          { areaType = Kernel.Prelude.maybe Nothing (Kernel.Prelude.readMaybe . Data.Text.unpack) areaType,
            ...
            subscriptionWaiveOffDaysValidFor = subscriptionWaiveOffDaysValidFor,
            subscriptionWaiveOffMode = subscriptionWaiveOffMode,
            subscriptionWaiveOffPercentage = subscriptionWaiveOffPercentage,
            subscriptionWaiveOffServiceName = subscriptionWaiveOffServiceName,
  ...
  toTType' (Lib.IncentiveJourney.Domain.Types.IncentiveJourneyMilestone.IncentiveJourneyMilestone {..}) = do
    Beam.IncentiveJourneyMilestoneT
      { Beam.areaType = Kernel.Prelude.fmap (Data.Text.pack . Kernel.Prelude.show) areaType,
        ...
        Beam.subscriptionWaiveOffDaysValidFor = subscriptionWaiveOffDaysValidFor,
        Beam.subscriptionWaiveOffMode = subscriptionWaiveOffMode,
        Beam.subscriptionWaiveOffPercentage = subscriptionWaiveOffPercentage,
        Beam.subscriptionWaiveOffServiceName = subscriptionWaiveOffServiceName,
