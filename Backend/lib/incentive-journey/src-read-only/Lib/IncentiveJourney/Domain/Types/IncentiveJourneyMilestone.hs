...
data IncentiveJourneyMilestone = IncentiveJourneyMilestone
  { areaType :: Kernel.Prelude.Maybe Lib.IncentiveJourney.Domain.Types.IncentiveJourneyMilestone.MilestoneAreaType,
    ...
    subscriptionWaiveOffDaysValidFor :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    subscriptionWaiveOffMode :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    subscriptionWaiveOffPercentage :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    subscriptionWaiveOffServiceName :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
