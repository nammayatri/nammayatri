...
data CohortJourneyMapping = CohortJourneyMapping
  { cohortId :: Kernel.Types.Id.Id Lib.IncentiveJourney.Domain.Types.CohortDetails.CohortDetails,
    ...
    streakEndSubscriptionWaiveOffDaysValidFor :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    streakEndSubscriptionWaiveOffMode :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
    streakEndSubscriptionWaiveOffPercentage :: Kernel.Prelude.Maybe Kernel.Prelude.Int,
    streakEndSubscriptionWaiveOffServiceName :: Kernel.Prelude.Maybe Kernel.Prelude.Text,
