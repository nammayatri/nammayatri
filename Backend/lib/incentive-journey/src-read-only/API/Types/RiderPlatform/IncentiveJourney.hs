...
module API.Types.RiderPlatform.IncentiveJourney where
...
newtype IncentiveJourneyUserActionType
  = INCENTIVE_JOURNEY API.Types.RiderPlatform.IncentiveJourney.IncentiveJourney.IncentiveJourneyUserActionType
