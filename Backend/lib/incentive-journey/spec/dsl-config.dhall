...
let outputPrefixReadOnly =
          rootDir
      ++  "/Backend/lib/incentive-journey/src-read-only/Lib/IncentiveJourney/"

let outputPrefix =
      rootDir ++ "/Backend/lib/incentive-journey/src/Lib/IncentiveJourney/"
...
let outputPath =
      { _apiRelatedTypes = outputPrefixReadOnly ++ "API/Types"
      ...
      , _domainHandler = outputPrefix ++ "Domain/Action"
...
in  { _output = outputPath
    , _storageConfig =
      ...
      , _defaultCachedQueryKeyPrefix = "incentive-journey"
