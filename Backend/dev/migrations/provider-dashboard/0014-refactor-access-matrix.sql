...
UPDATE atlas_bpp_dashboard.access_matrix set user_action_type = 'DriverOfferBPP (DRIVERS CLEAR_ON_RIDE_STUCK_DRIVER_IDS)' where id = 'aef13d16-8601-1d2c-084d-eebc1f476a24';

UPDATE atlas_bpp_dashboard.access_matrix set user_action_type = 'DriverOfferBPP (MERCHANT CREATE_FP_DRIVER_EXTRA_FEE)' where id = '286af0ed-b502-202e-5664-6e93074bb712';

UPDATE atlas_bpp_dashboard.access_matrix set user_action_type = 'DriverOfferBPP (MERCHANT UPDATE_FP_DRIVER_EXTRA_FEE)' where id = '8db8df35-4ac0-34ff-94eb-5eb0ce013825';

UPDATE atlas_bpp_dashboard.access_matrix set user_action_type = 'DriverOfferBPP (DRIVERS COLLECT_CASH)' where id = '00bf279c-d612-1ae6-90jb-210493c373c2';

UPDATE atlas_bpp_dashboard.access_matrix set user_action_type = 'DriverOfferBPP (DRIVERS BALANCE_DUE)' where id = '00cg279c-d612-1ae6-90jb-210493c377ui';
