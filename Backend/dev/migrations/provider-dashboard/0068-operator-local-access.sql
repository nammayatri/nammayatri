      ...
      unnest
        (ARRAY
          [ 'PROVIDER_OPERATOR/FLEET_MANAGEMENT/POST_FLEET_MANAGEMENT_FLEET_LINK_SEND_OTP',
            ...
            'PROVIDER_MANAGEMENT/DRIVER_REGISTRATION/POST_DRIVER_REGISTRATION_MEDIA_FILE_DOCUMENT_UPLOAD_LINK',
            'PROVIDER_MANAGEMENT/DRIVER_REGISTRATION/POST_DRIVER_REGISTRATION_MEDIA_FILE_DOCUMENT_CONFIRM',
            'PROVIDER_MANAGEMENT/DRIVER_REGISTRATION/POST_DRIVER_REGISTRATION_MEDIA_FILE_DOCUMENT_DELETE',
            'PROVIDER_MANAGEMENT/DRIVER_REGISTRATION/GET_DRIVER_REGISTRATION_MEDIA_FILE_DOCUMENT_DOWNLOAD_LINK'
          ]
        )
    )
