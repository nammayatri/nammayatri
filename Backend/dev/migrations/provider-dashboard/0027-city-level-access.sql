...
FROM atlas_bpp_dashboard.merchant
WHERE atlas_bpp_dashboard.merchant_access.merchant_id = atlas_bpp_dashboard.merchant.id;
...
SET operating_city = merchant.default_operating_city
FROM atlas_bpp_dashboard.merchant
WHERE atlas_bpp_dashboard.registration_token.merchant_id = atlas_bpp_dashboard.merchant.id;
