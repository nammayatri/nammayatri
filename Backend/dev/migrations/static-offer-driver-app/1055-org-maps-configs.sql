CREATE TABLE atlas_transporter.merchant_service_usage_config (
    merchant_id character(36) NOT NULL PRIMARY KEY REFERENCES atlas_transporter.merchant (id),
...
CREATE TABLE atlas_transporter.merchant_service_config (
...
INSERT INTO atlas_transporter.merchant_service_usage_config (merchant_id, get_distances, get_routes, snap_to_road, get_place_name, get_place_details, auto_complete)
