...
ALTER TABLE atlas_app.place_based_service_config ADD COLUMN service_name json NOT NULL;
ALTER TABLE atlas_app.place_based_service_config ALTER COLUMN service_name set data type text;
...
ALTER TABLE atlas_app.place_based_service_config ADD PRIMARY KEY ( place_id, service_name);