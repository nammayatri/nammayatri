ALTER TABLE atlas_app.merchant_service_usage_config DROP COLUMN send_s_m_s;
ALTER TABLE atlas_app.merchant_service_usage_config ADD COLUMN sms_providers_priority_list text[];
