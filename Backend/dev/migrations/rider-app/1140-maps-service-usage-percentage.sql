ALTER TABLE atlas_app.merchant_service_usage_config ADD COLUMN get_distances_percentage json;
ALTER TABLE atlas_app.merchant_service_usage_config ADD COLUMN get_routes_percentage json;
ALTER TABLE atlas_app.merchant_service_usage_config ADD COLUMN get_pickup_routes_percentage json;
ALTER TABLE atlas_app.merchant_service_usage_config ADD COLUMN get_trip_routes_percentage json;
ALTER TABLE atlas_app.merchant_service_usage_config ADD COLUMN snap_to_road_percentage json;
ALTER TABLE atlas_app.merchant_service_usage_config ADD COLUMN get_place_name_percentage json;
ALTER TABLE atlas_app.merchant_service_usage_config ADD COLUMN get_place_details_percentage json;
ALTER TABLE atlas_app.merchant_service_usage_config ADD COLUMN auto_complete_percentage json;
ALTER TABLE atlas_app.merchant_service_usage_config ADD COLUMN get_distances_for_cancel_ride_percentage json;

UPDATE atlas_app.merchant_service_usage_config SET
...
ALTER TABLE atlas_app.merchant_service_usage_config ALTER COLUMN get_distances_percentage SET NOT NULL;
ALTER TABLE atlas_app.merchant_service_usage_config ALTER COLUMN get_routes_percentage SET NOT NULL;
ALTER TABLE atlas_app.merchant_service_usage_config ALTER COLUMN get_pickup_routes_percentage SET NOT NULL;
ALTER TABLE atlas_app.merchant_service_usage_config ALTER COLUMN get_trip_routes_percentage SET NOT NULL;
ALTER TABLE atlas_app.merchant_service_usage_config ALTER COLUMN snap_to_road_percentage SET NOT NULL;
ALTER TABLE atlas_app.merchant_service_usage_config ALTER COLUMN get_place_name_percentage SET NOT NULL;
