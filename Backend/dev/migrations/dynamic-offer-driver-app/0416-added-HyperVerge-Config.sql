...
BEGIN
    ...
    FOR merchant_row IN SELECT merchant_id, id FROM atlas_driver_offer_bpp.merchant_operating_city LOOP
        ...
        VALUES (merchant_row.merchant_id, 'Tokenization_HyperVerge', '{ "url":"https://dummyUrl","appId":"dummy","appKey":"0.1.0|8|xgWOO3UTpKVvav8nc93+KVrEneQHUXMlXy1vpcsaoC/RKjHC3YTGcePB00hiZSsgENimo1Gy938="  }', merchant_row.id, NOW(), NOW());
    END LOOP;
END $$;