...
INSERT INTO atlas_driver_offer_bpp.merchant_push_notification (merchant_id, language, push_notification_key, udf1, notification_sub_type, icon, title, body) VALUES
