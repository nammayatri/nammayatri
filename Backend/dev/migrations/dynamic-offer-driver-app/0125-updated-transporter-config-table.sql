ALTER TABLE atlas_driver_offer_bpp.transporter_config DROP COLUMN ride_travelled_dist_threshold_when_pickup_or_dest_is_diff;
ALTER TABLE atlas_driver_offer_bpp.transporter_config DROP COLUMN ride_travelled_dist_threshold_when_pickup_and_dest_is_same;
...
ALTER TABLE atlas_driver_offer_bpp.transporter_config ALTER COLUMN waiting_time_estimated_threshold SET NOT NULL;