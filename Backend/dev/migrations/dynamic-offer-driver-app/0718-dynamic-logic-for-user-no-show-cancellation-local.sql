...
values
  (
    ...
    'USER-CANCELLATION-DUES',
    '{"cat":[{"var":""},{"cancellationCharges":{"if":[{"==":[{"var":"cancellationReasonSelected"},"CUSTOMER_NO_SHOW"]},{"if":[{"and":[{"==":[{"var":"isArrivedAtPickup"},true]},{">=":[{"var":"driverWaitingTime"},240]}]},6,0]},{"if":[{"var":"cancellationCharges"},{"var":"cancellationCharges"},0]}]}}]}',
    1,
    'favorit0-0000-0000-0000-00000favorit',
    1
  );

-- TODO cancelled by driver condition ---
...
values
  (
    ...
    null,
    '{Valid,Invalid}',
    '{"if":[{"==":[{"var":"cancellationReason.reasonCode"},"CUSTOMER_NO_SHOW"]},{"if":[{">=":[{"-":[{"var":"currentTime"},{"if":[{"==":[{"var":"driverArrivalTime"},null]},{"var":"currentTime"},{"var":"driverArrivalTime"}]}]},240]},"Valid","Invalid"]},null]}',
    now(),
    now()
  );
