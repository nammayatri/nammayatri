...
CREATE TABLE atlas_driver_offer_bpp.fare_policy_rental_details (
  ...
  per_extra_min_rate integer NOT NULL,
...
CREATE TABLE atlas_driver_offer_bpp.fare_parameters_rental_details (
  ...
  dist_based_fare integer NOT NULL
);
ALTER TABLE atlas_driver_offer_bpp.fare_parameters_rental_details OWNER TO atlas_driver_offer_bpp_user;

INSERT INTO atlas_driver_offer_bpp.fare_policy_rental_details (fare_policy_id, base_fare, per_hour_charge, per_extra_min_rate, per_extra_km_rate, night_shift_charge) VALUES
('71b52524-e773-03dc-5853-290132ce6fd5', 0, 180, 2, 18, '{"contents":250,"tag":"ConstantNightShiftCharge"}' :: json),
('51b42524-e113-03dc-5453-290032ce6fd5', 0, 220, 3, 22, '{"contents":250,"tag":"ConstantNightShiftCharge"}' :: json);
