...
((select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance Eco)'), 5, 0, 29.43, 'INR', '{"contents": 1.15, "tag": "ProgressiveNightShiftCharge"}', '{"contents":2,"tag":"PerMinuteWaitingCharge"}', 8),
((select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance Eco)'), 10, 0, 28.53, 'INR', '{"contents": 1.15, "tag": "ProgressiveNightShiftCharge"}', '{"contents":2,"tag":"PerMinuteWaitingCharge"}', 8);
...
((select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance Eco Oxy)'), 5, 0, 32.49, 'INR', '{"contents": 1.15, "tag": "ProgressiveNightShiftCharge"}', '{"contents":2,"tag":"PerMinuteWaitingCharge"}', 8),
((select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance Eco Oxy)'), 10, 0, 31.14, 'INR', '{"contents": 1.15, "tag": "ProgressiveNightShiftCharge"}', '{"contents":2,"tag":"PerMinuteWaitingCharge"}', 8);
...
((select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance AC)'), 5, 0, 32.7, 'INR', '{"contents": 1.15, "tag": "ProgressiveNightShiftCharge"}', '{"contents":2,"tag":"PerMinuteWaitingCharge"}', 8),
((select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance AC)'), 10, 0, 31.7, 'INR', '{"contents": 1.15, "tag": "ProgressiveNightShiftCharge"}', '{"contents":2,"tag":"PerMinuteWaitingCharge"}', 8);
...
((select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance AC Oxy)'), 5, 0, 36.1, 'INR', '{"contents": 1.15, "tag": "ProgressiveNightShiftCharge"}', '{"contents":2,"tag":"PerMinuteWaitingCharge"}', 8),
((select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance AC Oxy)'), 10, 0, 34.6, 'INR', '{"contents": 1.15, "tag": "ProgressiveNightShiftCharge"}', '{"contents":2,"tag":"PerMinuteWaitingCharge"}', 8);
...
((select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance Ventilator)'), 5, 0, 41.7, 'INR', '{"contents": 1.15, "tag": "ProgressiveNightShiftCharge"}', '{"contents":2,"tag":"PerMinuteWaitingCharge"}', 8),
((select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance Ventilator)'), 10, 0, 39.4, 'INR', '{"contents": 1.15, "tag": "ProgressiveNightShiftCharge"}', '{"contents":2,"tag":"PerMinuteWaitingCharge"}', 8);
...
SELECT 'Default', true, (select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance Eco)'), atlas_driver_offer_bpp.uuid_generate_v4(), m.merchant_id,m.id,'Unbounded','Ambulance_OnDemandStaticOffer','AMBULANCE_TAXI' FROM atlas_driver_offer_bpp.merchant_operating_city as m where m.city = 'Kolkata';

INSERT INTO atlas_driver_offer_bpp.fare_product (area,enabled,fare_policy_id,id,merchant_id,merchant_operating_city_id,time_bounds,trip_category,vehicle_variant)
SELECT 'Default', true, (select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance Eco Oxy)'), atlas_driver_offer_bpp.uuid_generate_v4(), m.merchant_id,m.id,'Unbounded','Ambulance_OnDemandStaticOffer','AMBULANCE_TAXI_OXY' FROM atlas_driver_offer_bpp.merchant_operating_city as m where m.city = 'Kolkata';

INSERT INTO atlas_driver_offer_bpp.fare_product (area,enabled,fare_policy_id,id,merchant_id,merchant_operating_city_id,time_bounds,trip_category,vehicle_variant)
SELECT 'Default', true, (select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance AC)'), atlas_driver_offer_bpp.uuid_generate_v4(), m.merchant_id,m.id,'Unbounded','Ambulance_OnDemandStaticOffer','AMBULANCE_AC' FROM atlas_driver_offer_bpp.merchant_operating_city as m where m.city = 'Kolkata';

INSERT INTO atlas_driver_offer_bpp.fare_product (area,enabled,fare_policy_id,id,merchant_id,merchant_operating_city_id,time_bounds,trip_category,vehicle_variant)
SELECT 'Default', true, (select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance AC Oxy)'), atlas_driver_offer_bpp.uuid_generate_v4(), m.merchant_id,m.id,'Unbounded','Ambulance_OnDemandStaticOffer','AMBULANCE_AC_OXY' FROM atlas_driver_offer_bpp.merchant_operating_city as m where m.city = 'Kolkata';

INSERT INTO atlas_driver_offer_bpp.fare_product (area,enabled,fare_policy_id,id,merchant_id,merchant_operating_city_id,time_bounds,trip_category,vehicle_variant)
SELECT 'Default', true, (select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance Ventilator)'), atlas_driver_offer_bpp.uuid_generate_v4(), m.merchant_id,m.id,'Unbounded','Ambulance_OnDemandStaticOffer','AMBULANCE_VENTILATOR' FROM atlas_driver_offer_bpp.merchant_operating_city as m where m.city = 'Kolkata';
...
INSERT INTO atlas_driver_offer_bpp.fare_product (area,enabled,fare_policy_id,id,merchant_id,merchant_operating_city_id,time_bounds,trip_category,vehicle_variant)
VALUES ('Default', true, (select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance Eco)'), atlas_driver_offer_bpp.uuid_generate_v4(), 'favorit0-0000-0000-0000-00000favorit','favorit0-0000-0000-0000-00000000city','Unbounded','Ambulance_OnDemandStaticOffer','AMBULANCE_TAXI');

INSERT INTO atlas_driver_offer_bpp.fare_product (area,enabled,fare_policy_id,id,merchant_id,merchant_operating_city_id,time_bounds,trip_category,vehicle_variant)
VALUES ('Default', true, (select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance Eco Oxy)'), atlas_driver_offer_bpp.uuid_generate_v4(), 'favorit0-0000-0000-0000-00000favorit','favorit0-0000-0000-0000-00000000city','Unbounded','Ambulance_OnDemandStaticOffer','AMBULANCE_TAXI_OXY');

INSERT INTO atlas_driver_offer_bpp.fare_product (area,enabled,fare_policy_id,id,merchant_id,merchant_operating_city_id,time_bounds,trip_category,vehicle_variant)
VALUES ('Default', true, (select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance AC)'), atlas_driver_offer_bpp.uuid_generate_v4(), 'favorit0-0000-0000-0000-00000favorit','favorit0-0000-0000-0000-00000000city','Unbounded','Ambulance_OnDemandStaticOffer','AMBULANCE_AC');

INSERT INTO atlas_driver_offer_bpp.fare_product (area,enabled,fare_policy_id,id,merchant_id,merchant_operating_city_id,time_bounds,trip_category,vehicle_variant)
VALUES ('Default', true, (select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance AC Oxy)'), atlas_driver_offer_bpp.uuid_generate_v4(), 'favorit0-0000-0000-0000-00000favorit','favorit0-0000-0000-0000-00000000city','Unbounded','Ambulance_OnDemandStaticOffer','AMBULANCE_AC_OXY');

INSERT INTO atlas_driver_offer_bpp.fare_product (area,enabled,fare_policy_id,id,merchant_id,merchant_operating_city_id,time_bounds,trip_category,vehicle_variant)
VALUES ('Default', true, (select id from atlas_driver_offer_bpp.fare_policy where description = 'Ambulance Fare Policy Kolkata (Ambulance Ventilator)'), atlas_driver_offer_bpp.uuid_generate_v4(), 'favorit0-0000-0000-0000-00000favorit','favorit0-0000-0000-0000-00000000city','Unbounded','Ambulance_OnDemandStaticOffer','AMBULANCE_VENTILATOR');
...
INSERT INTO atlas_driver_offer_bpp.beckn_config(
	buyer_finder_fee, collected_by, domain, gateway_url, id, payment_params_json, registry_url, settlement_type, settlement_window, static_terms_url, subscriber_id, subscriber_url, unique_key_id, vehicle_category, merchant_id, merchant_operating_city_id, created_at, updated_at, cancellation_fee_percentage, cancellation_fee_amount, on_select_ttl_sec, on_search_ttl_sec, on_init_ttl_sec, on_confirm_ttl_sec, on_track_ttl_sec, on_status_ttl_sec, on_cancel_ttl_sec, on_update_ttl_sec)
	VALUES (null, 'BPP', 'MOBILITY', 'http://localhost:8015/v1', 'dd22a05d-29a3-42c8-9c8d-2de340f9b607', '{"bankAccNumber": "xyz@upi","bankCode": "xyz"}', 'http://localhost:8020', null, null, null, 'NAMMA_YATRI', 'http://localhost:8013/beckn/cab/v1/da4e23a5-3ce6-4c37-8b9b-41377c3c1a52', 100, 'AMBULANCE', 'favorit0-0000-0000-0000-00000favorit', null, now(), now(), 0, 10, 120, 120, 120, 120, 120, 120, 120, 120);
