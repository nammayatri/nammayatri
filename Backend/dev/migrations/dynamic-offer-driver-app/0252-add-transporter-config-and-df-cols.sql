...
UPDATE atlas_driver_offer_bpp.plan SET cgst_percentage = 0.09 where merchant_id = '7f7896dd-787e-4a0b-8675-e9e6fe93bb8f';
UPDATE atlas_driver_offer_bpp.plan SET sgst_percentage = 0.09 where merchant_id = '7f7896dd-787e-4a0b-8675-e9e6fe93bb8f';

UPDATE atlas_driver_offer_bpp.transporter_config SET driver_fee_calculation_time = 0 where merchant_id = '7f7896dd-787e-4a0b-8675-e9e6fe93bb8f';
UPDATE atlas_driver_offer_bpp.transporter_config SET driver_fee_calculator_batch_size = 25 where merchant_id = '7f7896dd-787e-4a0b-8675-e9e6fe93bb8f';
UPDATE atlas_driver_offer_bpp.transporter_config SET driver_fee_calculator_batch_gap = 5 where merchant_id = '7f7896dd-787e-4a0b-8675-e9e6fe93bb8f';
