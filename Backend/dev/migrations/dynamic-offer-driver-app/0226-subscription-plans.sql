...
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD COLUMN subscription_start_time timestamp with time zone DEFAULT TIMESTAMP '2023-09-01 00:00:00' NOT NULL; -- Invoice generation from 1st September
