...
INSERT INTO atlas_driver_offer_bpp.go_home_config (id, enable_go_home, start_cnt, dest_radius, active_time, update_home_location_after_sec, cancecllation_cnt, created_at, updated_at) VALUES ('favorit0-0000-0000-0000-00000favorit', true, 2, 3000, 1800, 2592000, 2, now(), now());
