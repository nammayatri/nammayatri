...
UPDATE atlas_driver_offer_bpp.transporter_config
SET analytics_config = '{"weekStartMode": 3, "earningsWindowSize": 7, "allowCacheDriverFlowStatus": true, "maxOnlineDurationDays": 10, "onlineDurationCalculateFrom": "2025-01-01 00:00:00.000000+00"}' :: json
WHERE merchant_operating_city_id in (select id from atlas_driver_offer_bpp.merchant_operating_city where merchant_short_id = 'MSIL_PARTNER' and city = 'Delhi');
