-- Update dynamic_batch_size for Bharat Taxi operating cities.
-- Default [1] reaches only 4 drivers in a full search; progressive sizes
-- reach 25-80 drivers depending on city configuration.
