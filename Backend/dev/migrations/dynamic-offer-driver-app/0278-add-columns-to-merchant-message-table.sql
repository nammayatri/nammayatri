...
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD COLUMN volunteer_sms_sending_limit int DEFAULT 0;
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD COLUMN driver_sms_receiving_limit int DEFAULT 0;

UPDATE atlas_driver_offer_bpp.transporter_config SET volunteer_sms_sending_limit = 500;
UPDATE atlas_driver_offer_bpp.transporter_config SET driver_sms_receiving_limit = 5;

ALTER TABLE atlas_driver_offer_bpp.transporter_config ALTER COLUMN volunteer_sms_sending_limit SET NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.transporter_config ALTER COLUMN driver_sms_receiving_limit SET NOT NULL;
...
WITH MerchantMessages AS (
  SELECT T1.id, 'WHATSAPP_CLEAR_DUES_CALL_MISSED_MESSAGE', '6830100', CAST ('{"var1" : "https://nammayatri.in/p/?vp=plans", "var2" : "https://nammayatri.in/p/?vp=plans"}' AS json), 'Dear Namma Yatri Partner,
