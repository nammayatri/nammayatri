...
FROM
    (VALUES
        ...
        ('DRIVER_UNBLOCKED','UNBLOCK_DRIVER_KEY','ನೀವು ಈಗ ಅನ್ವೆಷಣೆ ಮುಗಿಸಿದ್ದೀರಿ','ನಿಮ್ಮ ಆಯೋಗ ರಹಿತ ಪ್ರಯಾಣವನ್ನು ಆನಂದಿಸಿ!','KANNADA'),
        ('DRIVER_UNBLOCKED','UNBLOCK_DRIVER_KEY','நீங்கள் இப்போது தடைகள் நீக்கப்பட்டுள்ளீர்கள்','உங்கள் கமிஷன் இல்லாத பயணத்தை அனுபவிக்கவும்!','TAMIL'),
        ...
        ('DRIVER_UNBLOCKED','UNBLOCK_DRIVER_KEY','আপনি এখন আনব্লকড হয়েছেন','আপনার কমিশন মুক্ত যাত্রা উপভোগ করুন!','BENGALI')
