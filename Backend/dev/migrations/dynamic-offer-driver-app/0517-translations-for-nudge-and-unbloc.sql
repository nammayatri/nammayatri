...
FROM
    (VALUES
        ...
        ('BENGALI', 'CANCELLATION_RATE_NUDGE_DAILY', 'https://assets.moving.tech/beckn/nammayatri/driver/images/ny_ic_frequent_cancellation_blocking.png', 'আপনার বাতিলের হার বেশি!', 'গ্আপনার স্কোর উন্নত করতে আরও রাইড সম্পূর্ণ করুন এবং বাতিলকরণ কম করুন', 'ঠিক আছে, বুঝেছি')
...
FROM
    (VALUES
        ...
        ('BENGALI', 'CANCELLATION_RATE_NUDGE_WEEKLY', 'https://assets.moving.tech/beckn/nammayatri/driver/images/ny_ic_frequent_cancellation_blocking.png', 'আপনার বাতিলের হার বেশি!', 'গ্আপনার স্কোর উন্নত করতে আরও রাইড সম্পূর্ণ করুন এবং বাতিলকরণ কম করুন', 'ঠিক আছে, বুঝেছি')
    ) AS event(language, overlay_key, image_url, title, description, ok_button_text),
    atlas_driver_offer_bpp.merchant_operating_city AS city;