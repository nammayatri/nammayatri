...
ALTER TABLE atlas_bpp_dashboard.access_matrix
...
CREATE UNIQUE INDEX unique_role_id_api_entity_user_action_type_null
    ON atlas_bpp_dashboard.access_matrix (role_id, api_entity, user_action_type)
    WHERE other_user_action_type IS NULL;

CREATE UNIQUE INDEX unique_role_id_api_entity_user_action_type_other
    ON atlas_bpp_dashboard.access_matrix (role_id, api_entity, user_action_type, other_user_action_type)
