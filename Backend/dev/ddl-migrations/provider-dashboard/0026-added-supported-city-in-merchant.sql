ALTER TABLE atlas_dashboard.merchant ADD COLUMN default_operating_city Text;
ALTER TABLE atlas_dashboard.merchant ADD COLUMN supported_operating_cities Text[];
ALTER TABLE atlas_dashboard.merchant_access ADD COLUMN merchant_short_id Text;
