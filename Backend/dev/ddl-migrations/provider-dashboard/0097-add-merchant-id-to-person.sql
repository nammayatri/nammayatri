...
-- Backfill for pre-existing rows lives in seed-migrations/provider-dashboard/0004-backfill-person-merchant-id.sql.
ALTER TABLE atlas_bpp_dashboard.person
  ADD COLUMN IF NOT EXISTS merchant_id character(36) REFERENCES atlas_bpp_dashboard.merchant (id);
