...
CREATE TABLE atlas_dashboard.deleted_user (
...
ALTER TABLE atlas_dashboard.deleted_user OWNER TO atlas_dashboard_user;
...
ALTER TABLE atlas_dashboard.person_capability DROP CONSTRAINT IF EXISTS person_capability_granted_by_fkey;
