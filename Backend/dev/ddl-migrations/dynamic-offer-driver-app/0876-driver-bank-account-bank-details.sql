...
ALTER TABLE atlas_driver_offer_bpp.driver_bank_account ADD COLUMN bank_name text;
ALTER TABLE atlas_driver_offer_bpp.driver_bank_account ADD COLUMN bank_account_last4 text;
