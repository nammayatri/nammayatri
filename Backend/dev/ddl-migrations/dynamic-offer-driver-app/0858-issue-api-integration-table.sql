...
CREATE TABLE IF NOT EXISTS atlas_driver_offer_bpp.issue_api_integration (
...
CREATE INDEX IF NOT EXISTS idx_issue_api_integration_merchant_id ON atlas_driver_offer_bpp.issue_api_integration (merchant_id);
