...
CREATE UNIQUE INDEX IF NOT EXISTS idx_finance_tds_reimbursement_request_period_unique
  ON atlas_driver_offer_bpp.finance_tds_reimbursement_request (fleet_owner_id, quarter, assessment_year, merchant_operating_city_id)
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_finance_tds_reimbursement_invoice_mapping_unique
  ON atlas_driver_offer_bpp.finance_tds_reimbursement_invoice_mapping (request_id, invoice_id);
