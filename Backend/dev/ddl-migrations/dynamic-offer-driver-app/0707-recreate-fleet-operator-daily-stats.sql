...
ALTER TABLE atlas_driver_offer_bpp.fleet_operator_daily_stats ADD COLUMN cash_total_earning double precision ;
...
ALTER TABLE atlas_driver_offer_bpp.fleet_operator_daily_stats ADD COLUMN fleet_driver_id text NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.fleet_operator_daily_stats ADD COLUMN online_total_earning double precision ;
