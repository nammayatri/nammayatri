...
-- Idempotent (fixed-value UPDATEs). ENGLISH only (scoped via mpn.language = 'ENGLISH'); other languages
-- once MSIL shares them. The hourly text reminder is a separate new PN key, seeded in config migration 0058.
