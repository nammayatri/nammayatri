...
SELECT
    'LocalResidenceProof', tmpl.merchant_id, tmpl.merchant_operating_city_id, tmpl.role,
    'Local Residence Proof', NULL, true, true, false, false,
    '{}', false, false, 'Driver',
    tmpl.is_default_enabled_on_manual_verification, true, false,
    17, tmpl.max_retry_count, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
