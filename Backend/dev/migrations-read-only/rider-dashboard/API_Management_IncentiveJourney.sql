...
INSERT INTO atlas_bap_dashboard.capability_endpoint (capability_id, server_name, endpoint_id) VALUES ( 'system-config.coins.read', 'DASHBOARD', 'RIDER_MANAGEMENT/INCENTIVE_JOURNEY/GET_INCENTIVE_JOURNEY_PERSON_ASSIGNMENTS' ) ON CONFLICT DO NOTHING;


------- SQL updates -------

-- {"api":"GetIncentiveJourneyCohortJourneyList","migration":"capability","param":"system-config.coins.read","schema":"atlas_bap_dashboard"}
INSERT INTO atlas_bap_dashboard.capability_endpoint (capability_id, server_name, endpoint_id) VALUES ( 'system-config.coins.read', 'DASHBOARD', 'RIDER_MANAGEMENT/INCENTIVE_JOURNEY/GET_INCENTIVE_JOURNEY_COHORT_JOURNEY_LIST' ) ON CONFLICT DO NOTHING;
