...
ALTER TABLE atlas_driver_offer_bpp.rc_stats ADD COLUMN merchant_id character varying(36) ;
ALTER TABLE atlas_driver_offer_bpp.rc_stats ADD COLUMN merchant_operating_city_id character varying(36) ;
ALTER TABLE atlas_driver_offer_bpp.rc_stats ADD COLUMN created_at timestamp with time zone NOT NULL default CURRENT_TIMESTAMP;
