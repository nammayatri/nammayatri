...
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN acceptance_ratio double precision ;
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN actual_distance_to_pickup integer NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN cancellation_ratio double precision ;
...
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN customer_cancellation_dues double precision NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN driver_available_time double precision ;
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN driver_id character varying(36) NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN driver_max_extra_fee integer ;
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN driver_min_extra_fee integer ;
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN driver_speed double precision ;
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN duration_to_pickup integer NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN estimate_id text ;
...
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN parallel_search_request_count integer ;
...
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN response text ;
...
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN status text NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN straight_line_distance_to_pickup integer NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.search_request_for_driver ADD COLUMN vehicle_variant text NOT NULL;
