...
ALTER TABLE atlas_driver_offer_bpp.driver_information ADD COLUMN driver_bank_account_details json;
...
ALTER TABLE atlas_driver_offer_bpp.driver_information ADD COLUMN tds_threshold_amount double precision ;
