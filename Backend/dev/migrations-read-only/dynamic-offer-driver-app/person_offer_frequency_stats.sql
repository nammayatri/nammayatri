...
CREATE INDEX CONCURRENTLY person_offer_frequency_stats_idx_entity_id ON atlas_driver_offer_bpp.person_offer_frequency_stats USING btree (entity_id);
ALTER TABLE atlas_driver_offer_bpp.person_offer_frequency_stats ADD CONSTRAINT person_offer_frequency_stats_unique_idx_entity_id_entity_type_offer_id UNIQUE (entity_id, entity_type, offer_id);