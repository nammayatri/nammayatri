...
ALTER TABLE atlas_driver_offer_bpp.plan ADD COLUMN created_at timestamp with time zone NOT NULL default CURRENT_TIMESTAMP;
ALTER TABLE atlas_driver_offer_bpp.plan ADD COLUMN updated_at timestamp with time zone NOT NULL default CURRENT_TIMESTAMP;
