...
ALTER TABLE atlas_driver_offer_bpp.person ADD COLUMN mobile_last_digts text ;


------- SQL updates -------

ALTER TABLE atlas_driver_offer_bpp.person ADD COLUMN mobile_last_digits text ;
