...
ALTER TABLE atlas_driver_offer_bpp.vendor_split_details ADD COLUMN vehicle_category text NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.vendor_split_details ADD PRIMARY KEY ( area, merchant_operating_city_id, vehicle_category, vendor_id);