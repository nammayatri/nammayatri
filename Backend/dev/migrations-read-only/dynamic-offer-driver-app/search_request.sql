...
ALTER TABLE atlas_driver_offer_bpp.search_request ADD COLUMN state_entry_permit_names text[] ;
ALTER TABLE atlas_driver_offer_bpp.search_request ADD COLUMN state_entry_permit_ids text[] ;
ALTER TABLE atlas_driver_offer_bpp.search_request ADD COLUMN state_entry_permit_charges double precision ;