...
ALTER TABLE atlas_driver_offer_bpp.document_verification_stages_config ADD PRIMARY KEY ( applicable_to, document_onboarding_stage, merchant_operating_city_id, vehicle_category);
