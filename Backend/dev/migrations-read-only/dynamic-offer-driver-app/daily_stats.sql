...
ALTER TABLE atlas_driver_offer_bpp.daily_stats ADD COLUMN last_online_to timestamp with time zone ;
ALTER TABLE atlas_driver_offer_bpp.daily_stats ADD COLUMN last_online_from timestamp with time zone ;