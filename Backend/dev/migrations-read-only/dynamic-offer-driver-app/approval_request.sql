...
ALTER TABLE atlas_driver_offer_bpp.approval_request ADD COLUMN request_type text NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.approval_request ADD COLUMN merchant_id character varying(36) ;
ALTER TABLE atlas_driver_offer_bpp.approval_request ADD COLUMN merchant_operating_city_id character varying(36) ;
...
ALTER TABLE atlas_driver_offer_bpp.approval_request ADD COLUMN lon double precision ;
ALTER TABLE atlas_driver_offer_bpp.approval_request ADD COLUMN lat double precision ;