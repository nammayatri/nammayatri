...
ALTER TABLE atlas_driver_offer_bpp.frfs_driver_rating ADD COLUMN rating_value integer NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.frfs_driver_rating ALTER COLUMN rating_value DROP NOT NULL;
