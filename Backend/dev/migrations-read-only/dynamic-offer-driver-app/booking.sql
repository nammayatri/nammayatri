...
ALTER TABLE atlas_driver_offer_bpp.booking ADD COLUMN is_pickup_or_destination_edited boolean ;
...
ALTER TABLE atlas_driver_offer_bpp.booking ADD COLUMN is_stucked boolean ;
