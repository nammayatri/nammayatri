...
ALTER TABLE atlas_driver_offer_bpp.merchant_message ADD COLUMN contains_url_button boolean NOT NULL default false;
ALTER TABLE atlas_driver_offer_bpp.merchant_message ADD COLUMN created_at timestamp with time zone NOT NULL default CURRENT_TIMESTAMP;
ALTER TABLE atlas_driver_offer_bpp.merchant_message ADD COLUMN json_data json ;
ALTER TABLE atlas_driver_offer_bpp.merchant_message ADD COLUMN merchant_id character varying(36) NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.merchant_message ADD COLUMN merchant_operating_city_id character varying(36) NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.merchant_message ADD COLUMN message text NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.merchant_message ADD COLUMN message_key character varying(255) NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.merchant_message ADD COLUMN category character varying(255) ;