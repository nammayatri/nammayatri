...
ALTER TABLE atlas_driver_offer_bpp.pg_payout_settlement_report ADD COLUMN fulfillment_txn_id text ;
ALTER TABLE atlas_driver_offer_bpp.pg_payout_settlement_report ADD COLUMN fulfillment_order_created_at timestamp with time zone ;