...
ALTER TABLE atlas_driver_offer_bpp.booking_update_request ADD COLUMN estimated_fare double precision ;
...
ALTER TABLE atlas_driver_offer_bpp.booking_update_request ALTER COLUMN old_estimated_distance SET NOT NULL;


------- SQL updates -------

ALTER TABLE atlas_driver_offer_bpp.booking_update_request ALTER COLUMN old_estimated_distance DROP NOT NULL;


------- SQL updates -------

ALTER TABLE atlas_driver_offer_bpp.booking_update_request ALTER COLUMN estimated_fare SET NOT NULL;
