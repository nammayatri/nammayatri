...
ALTER TABLE atlas_driver_offer_bpp.vendor_settlement ADD COLUMN settlement_mode text ;
...
ALTER TABLE atlas_driver_offer_bpp.vendor_settlement ALTER COLUMN status SET DEFAULT Pending;
ALTER TABLE atlas_driver_offer_bpp.vendor_settlement ALTER COLUMN settlement_mode SET DEFAULT Manual;
ALTER TABLE atlas_driver_offer_bpp.vendor_settlement ALTER COLUMN settlement_mode SET NOT NULL;