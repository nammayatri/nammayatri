...
ALTER TABLE atlas_driver_offer_bpp.finance_reconciliation_summary ADD COLUMN dispute_amount_total double precision NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.finance_reconciliation_summary ADD COLUMN domain text NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.finance_reconciliation_summary ADD COLUMN source text NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.finance_reconciliation_summary ADD COLUMN target text NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.finance_reconciliation_summary ADD COLUMN total_records integer NOT NULL;
