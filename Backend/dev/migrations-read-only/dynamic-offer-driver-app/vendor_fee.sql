...
ALTER TABLE atlas_driver_offer_bpp.vendor_fee ADD COLUMN vendor_fee_processed_at timestamp with time zone ;
ALTER TABLE atlas_driver_offer_bpp.vendor_fee ADD COLUMN split_method text ;
