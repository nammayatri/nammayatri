...
ALTER TABLE atlas_driver_offer_bpp.wallet_reward_posting ADD COLUMN order_id text ;


------- SQL updates -------

ALTER TABLE atlas_driver_offer_bpp.wallet_reward_posting ADD COLUMN txn_uuid text ;