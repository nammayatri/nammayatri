...
ALTER TABLE atlas_driver_offer_bpp.sap_journal_entry ADD COLUMN status text NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.sap_journal_entry ADD COLUMN updated_by text ;
ALTER TABLE atlas_driver_offer_bpp.sap_journal_entry ADD COLUMN created_by text ;