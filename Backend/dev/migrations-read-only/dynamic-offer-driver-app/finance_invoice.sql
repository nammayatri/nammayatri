...
ALTER TABLE atlas_driver_offer_bpp.finance_invoice ADD COLUMN line_items text NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.finance_invoice ALTER COLUMN line_items TYPE jsonb USING line_items::jsonb;