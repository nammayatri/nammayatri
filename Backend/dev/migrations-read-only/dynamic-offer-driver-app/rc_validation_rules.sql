...
ALTER TABLE atlas_driver_offer_bpp.rc_validation_rules ADD COLUMN fuel_type text[] NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.rc_validation_rules ADD COLUMN vehicle_class text[] NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.rc_validation_rules ADD COLUMN vehicle_oem text[] NOT NULL;
