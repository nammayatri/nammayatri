...
ALTER TABLE atlas_driver_offer_bpp.payout_batch ADD COLUMN inquiry_attempts_today integer NOT NULL default 0;
ALTER TABLE atlas_driver_offer_bpp.payout_batch ADD COLUMN inquiry_quota_date date ;
...
ALTER TABLE atlas_driver_offer_bpp.payout_batch ADD COLUMN next_inquiry_at timestamp with time zone ;
...
ALTER TABLE atlas_driver_offer_bpp.payout_batch ADD COLUMN partner_response_code text ;
ALTER TABLE atlas_driver_offer_bpp.payout_batch ADD COLUMN payout_rail text NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.payout_batch ADD COLUMN pending_count integer NOT NULL default 0;
ALTER TABLE atlas_driver_offer_bpp.payout_batch ADD COLUMN processed_count integer NOT NULL default 0;
ALTER TABLE atlas_driver_offer_bpp.payout_batch ADD COLUMN rejected_count integer NOT NULL default 0;
ALTER TABLE atlas_driver_offer_bpp.payout_batch ADD COLUMN resolved_at timestamp with time zone ;
ALTER TABLE atlas_driver_offer_bpp.payout_batch ADD COLUMN retry_of_batch_id character varying(36) ;
ALTER TABLE atlas_driver_offer_bpp.payout_batch ADD COLUMN run_id text ;
...
ALTER TABLE atlas_driver_offer_bpp.payout_batch ADD COLUMN total_amount double precision NOT NULL default 0;
...
ALTER TABLE atlas_driver_offer_bpp.payout_batch ADD COLUMN value_date date NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.payout_batch ADD COLUMN merchant_operating_city_id text ;