...
ALTER TABLE atlas_driver_offer_bpp.driver_block_reason ADD COLUMN created_at timestamp with time zone  default CURRENT_TIMESTAMP;
ALTER TABLE atlas_driver_offer_bpp.driver_block_reason ADD COLUMN reason_code character varying(36) NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.driver_block_reason ADD COLUMN updated_at timestamp with time zone  default CURRENT_TIMESTAMP;
