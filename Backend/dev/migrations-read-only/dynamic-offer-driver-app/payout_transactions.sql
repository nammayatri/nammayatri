...
ALTER TABLE atlas_driver_offer_bpp.payout_transactions ALTER COLUMN merchant_id SET NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.payout_transactions ALTER COLUMN merchant_id TYPE text;


------- SQL updates -------

ALTER TABLE atlas_driver_offer_bpp.payout_transactions ALTER COLUMN gate_way_ref_id DROP NOT NULL;