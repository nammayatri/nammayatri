...
ALTER TABLE atlas_driver_offer_bpp.lms_video_translation ADD COLUMN bottom_button_config text[] NOT NULL default '{}';
...
ALTER TABLE atlas_driver_offer_bpp.lms_video_translation ADD COLUMN side_button_config text[] NOT NULL default '{}';
