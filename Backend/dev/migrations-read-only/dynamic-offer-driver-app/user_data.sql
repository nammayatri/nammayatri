...
ALTER TABLE atlas_driver_offer_bpp.user_data ADD COLUMN event_id character varying(36) ;
ALTER TABLE atlas_driver_offer_bpp.user_data ADD COLUMN batch_number integer ;
