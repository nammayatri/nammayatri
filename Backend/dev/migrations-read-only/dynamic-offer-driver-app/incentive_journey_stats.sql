...
ALTER TABLE atlas_driver_offer_bpp.incentive_journey_stats ADD COLUMN person_id character varying(36) NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.incentive_journey_stats ADD CONSTRAINT incentive_journey_stats_unique_idx_journey_id_milestone_id_period_key_person_id UNIQUE (journey_id, milestone_id, period_key, person_id);

CREATE INDEX CONCURRENTLY incentive_journey_stats_idx_person_id ON atlas_driver_offer_bpp.incentive_journey_stats USING btree (person_id);