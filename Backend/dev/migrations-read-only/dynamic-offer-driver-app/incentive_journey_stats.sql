...
CREATE INDEX CONCURRENTLY incentive_journey_stats_idx_driver_id ON atlas_driver_offer_bpp.incentive_journey_stats USING btree (driver_id);
ALTER TABLE atlas_driver_offer_bpp.incentive_journey_stats ADD CONSTRAINT incentive_journey_stats_unique_idx_driver_id_journey_id_milestone_id_period_key UNIQUE (driver_id, journey_id, milestone_id, period_key);