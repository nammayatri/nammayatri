...
ALTER TABLE atlas_driver_offer_bpp.driver_ride_payout_bank_account ADD COLUMN bank_account_number_encrypted character varying(255) ;
ALTER TABLE atlas_driver_offer_bpp.driver_ride_payout_bank_account ADD COLUMN bank_account_number_hash bytea ;
ALTER TABLE atlas_driver_offer_bpp.driver_ride_payout_bank_account ADD COLUMN bank_ifsc_code_encrypted character varying(255) ;
ALTER TABLE atlas_driver_offer_bpp.driver_ride_payout_bank_account ADD COLUMN bank_ifsc_code_hash bytea ;
