CREATE TABLE atlas_driver_offer_bpp.journal_entry_transaction ();

ALTER TABLE atlas_driver_offer_bpp.journal_entry_transaction ADD COLUMN created_at timestamp with time zone NOT NULL default CURRENT_TIMESTAMP;
ALTER TABLE atlas_driver_offer_bpp.journal_entry_transaction ADD COLUMN created_by text NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.journal_entry_transaction ADD COLUMN credit_amount double precision NOT NULL default 0;
ALTER TABLE atlas_driver_offer_bpp.journal_entry_transaction ADD COLUMN currency text NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.journal_entry_transaction ADD COLUMN debit_amount double precision NOT NULL default 0;
ALTER TABLE atlas_driver_offer_bpp.journal_entry_transaction ADD COLUMN description text NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.journal_entry_transaction ADD COLUMN sap_journal_entry_id text NOT NULL;
