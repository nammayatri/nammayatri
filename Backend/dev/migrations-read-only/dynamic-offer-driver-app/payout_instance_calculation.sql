...
ALTER TABLE atlas_driver_offer_bpp.payout_instance_calculation ADD COLUMN running_balance double precision NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.payout_instance_calculation ADD COLUMN settlement_date timestamp with time zone ;
ALTER TABLE atlas_driver_offer_bpp.payout_instance_calculation ADD COLUMN settlement_mode text NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.payout_instance_calculation ADD COLUMN start_time timestamp with time zone NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.payout_instance_calculation ADD COLUMN status text NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.payout_instance_calculation ADD PRIMARY KEY ( id);
