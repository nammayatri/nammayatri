...
ALTER TABLE atlas_driver_offer_bpp.fleet_owner_information ADD COLUMN id character varying(36) NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.fleet_owner_information ADD PRIMARY KEY ( id);
