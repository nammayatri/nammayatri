...
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD COLUMN app_url text ;


------- SQL updates -------

ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD COLUMN bpp_dashboard_url text ;