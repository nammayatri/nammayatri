...
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD COLUMN send_sms_on_enablement boolean ;
...
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD COLUMN is_driver_name_mandatory_in_bulk_upload boolean  default true;
...
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD COLUMN allow_pan_reupload boolean  default false;
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD COLUMN allow_dl_reupload boolean  default false;
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD COLUMN allow_aadhaar_reupload boolean  default false;
...
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD COLUMN enable_downward_recompute_for_different_destination boolean ;
...
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD COLUMN disable_dynamic_congestion_for_otp_booking boolean ;