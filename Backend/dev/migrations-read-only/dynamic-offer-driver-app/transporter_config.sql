...
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD COLUMN driver_wallet_config json  default '{"enableDriverWallet": false, "driverWalletPayoutThreshold": 0, "gstPercentage": 0.0, "enableWalletPayout": false, "enableWalletTopup": false, "maxWalletPayoutsPerDay": null, "minimumWalletPayoutAmount": 0, "payoutCutOffDays": 0}' :: json;
