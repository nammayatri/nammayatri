...
CREATE INDEX CONCURRENTLY finance_ledger_entry_idx_settlement_id ON atlas_driver_offer_bpp.finance_ledger_entry USING btree (settlement_id);

------- SQL updates -------

CREATE INDEX CONCURRENTLY finance_ledger_entry_idx_settlement_timestamp ON atlas_driver_offer_bpp.finance_ledger_entry USING btree (settlement_timestamp);
