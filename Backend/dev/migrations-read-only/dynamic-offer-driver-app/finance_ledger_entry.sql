...
ALTER TABLE atlas_driver_offer_bpp.finance_ledger_entry ADD COLUMN concerned_individual_id text ;


------- SQL updates -------

CREATE INDEX CONCURRENTLY finance_ledger_entry_idx_concerned_individual_id ON atlas_driver_offer_bpp.finance_ledger_entry USING btree (concerned_individual_id);
CREATE INDEX CONCURRENTLY finance_ledger_entry_idx_from_account_id ON atlas_driver_offer_bpp.finance_ledger_entry USING btree (from_account_id);
CREATE INDEX CONCURRENTLY finance_ledger_entry_idx_to_account_id ON atlas_driver_offer_bpp.finance_ledger_entry USING btree (to_account_id);


------- SQL updates -------

CREATE INDEX CONCURRENTLY finance_ledger_entry_idx_concerned_individual_id_timestamp ON atlas_driver_offer_bpp.finance_ledger_entry USING btree (concerned_individual_id, timestamp);
CREATE INDEX CONCURRENTLY finance_ledger_entry_idx_from_account_id_timestamp ON atlas_driver_offer_bpp.finance_ledger_entry USING btree (from_account_id, timestamp);
CREATE INDEX CONCURRENTLY finance_ledger_entry_idx_to_account_id_timestamp ON atlas_driver_offer_bpp.finance_ledger_entry USING btree (to_account_id, timestamp);


------- SQL updates -------

ALTER TABLE atlas_driver_offer_bpp.finance_ledger_entry ADD COLUMN updated_by_id text ;
ALTER TABLE atlas_driver_offer_bpp.finance_ledger_entry ADD COLUMN updated_by text ;
ALTER TABLE atlas_driver_offer_bpp.finance_ledger_entry ADD COLUMN created_by_id text ;
ALTER TABLE atlas_driver_offer_bpp.finance_ledger_entry ADD COLUMN created_by text ;
...
ALTER TABLE atlas_driver_offer_bpp.finance_ledger_entry ADD COLUMN applied_tax_rate_value double precision ;
ALTER TABLE atlas_driver_offer_bpp.finance_ledger_entry ADD COLUMN applied_tax_rate_type text ;
ALTER TABLE atlas_driver_offer_bpp.finance_ledger_entry ADD COLUMN applied_tax_exclusive boolean ;
ALTER TABLE atlas_driver_offer_bpp.finance_ledger_entry ADD COLUMN applied_indirect_tax_direction text ;
ALTER TABLE atlas_driver_offer_bpp.finance_ledger_entry ADD COLUMN applied_direct_tax_rates json ;
ALTER TABLE atlas_driver_offer_bpp.finance_ledger_entry ADD COLUMN applied_commission_value_type text ;
ALTER TABLE atlas_driver_offer_bpp.finance_ledger_entry ADD COLUMN applied_commission_value_amount double precision ;
DROP INDEX finance_ledger_entry_idx_to_account_id_timestamp;
CREATE INDEX CONCURRENTLY finance_ledger_entry_idx_timestamp_to_account_id ON atlas_driver_offer_bpp.finance_ledger_entry USING btree (timestamp, to_account_id);
