...
ALTER TABLE atlas_driver_offer_bpp.vehicle_registration_certificate ADD COLUMN enable_for_airport boolean ;
...
ALTER TABLE atlas_driver_offer_bpp.vehicle_registration_certificate ADD COLUMN initiated_by text ;
...
ALTER TABLE atlas_driver_offer_bpp.vehicle_registration_certificate ADD COLUMN document_image_id2 character varying(36) ;


------- SQL updates -------

ALTER TABLE atlas_driver_offer_bpp.vehicle_registration_certificate ADD COLUMN is_new boolean;


------- SQL updates -------

ALTER TABLE atlas_driver_offer_bpp.vehicle_registration_certificate ADD COLUMN exempt_parking_fee boolean  default false;