...
ALTER TABLE atlas_driver_offer_bpp.operation_hub_requests ADD COLUMN driver_id character varying(36) ;
...
ALTER TABLE atlas_driver_offer_bpp.operation_hub_requests ADD COLUMN registration_no text ;
