...
ALTER TABLE atlas_driver_offer_bpp.operation_hub_requests ADD COLUMN registration_no_encrypted character varying(255) NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.operation_hub_requests ADD COLUMN registration_no_hash bytea NOT NULL;
