...
ALTER TABLE atlas_driver_offer_bpp.offer ADD COLUMN offer_eligibility_json_logic text ;
...
ALTER TABLE atlas_driver_offer_bpp.offer ALTER COLUMN offer_eligibility_json_logic TYPE json;