...
ALTER TABLE atlas_driver_offer_bpp.recon_settlement_order ADD COLUMN order_sequence integer NOT NULL default 0;
...
ALTER TABLE atlas_driver_offer_bpp.recon_settlement_order ADD COLUMN settlement_detail_index integer NOT NULL default 0;
