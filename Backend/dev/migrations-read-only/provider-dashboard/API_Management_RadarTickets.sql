...
-- {"api":"PostRadarTicketsUpload","migration":"capability","param":"support.radar.write","schema":"atlas_dashboard"}
INSERT INTO atlas_dashboard.capability_endpoint (capability_id, server_name, endpoint_id) VALUES ( 'support.radar.write', 'DASHBOARD', 'PROVIDER_MANAGEMENT/RADAR_TICKETS/POST_RADAR_TICKETS_UPLOAD' ) ON CONFLICT DO NOTHING;
