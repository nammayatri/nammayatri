...
ALTER TABLE atlas_app.beckn_config DROP CONSTRAINT beckn_config_pkey;
ALTER TABLE atlas_app.beckn_config ADD PRIMARY KEY ( id);


------- SQL updates -------

ALTER TABLE atlas_app.beckn_config ALTER COLUMN buyer_finder_fee TYPE double precision;
ALTER TABLE atlas_app.beckn_config ADD COLUMN bap_ifsc text ;
ALTER TABLE atlas_app.beckn_config DROP COLUMN vehicle_category;
ALTER TABLE atlas_app.beckn_config DROP COLUMN static_terms_url;
ALTER TABLE atlas_app.beckn_config DROP COLUMN settlement_window;
ALTER TABLE atlas_app.beckn_config DROP COLUMN select_ttl_sec;
ALTER TABLE atlas_app.beckn_config DROP COLUMN search_ttl_sec;
ALTER TABLE atlas_app.beckn_config DROP COLUMN confirm_buffer_ttl_sec;
ALTER TABLE atlas_app.beckn_config DROP COLUMN collected_by;
...
ALTER TABLE atlas_app.beckn_config ALTER COLUMN buyer_finder_fee TYPE text;