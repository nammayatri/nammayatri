CREATE TABLE atlas_app.pg_payout_settlement_report ();

ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN bank_name text ;
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN beneficiary_account_number text ;
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN beneficiary_ifsc text ;
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN beneficiary_type text ;
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN created_at timestamp with time zone NOT NULL default CURRENT_TIMESTAMP;
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN currency text NOT NULL;
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN fulfillment_amount double precision ;
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN fulfillment_date timestamp with time zone ;
...
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN settlement_date timestamp with time zone ;
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN settlement_id text ;
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN settlement_mode text ;
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN settlement_type text ;
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN txn_amount double precision NOT NULL;
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN txn_date timestamp with time zone ;
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN txn_id text ;
ALTER TABLE atlas_app.pg_payout_settlement_report ADD COLUMN txn_status text NOT NULL;
