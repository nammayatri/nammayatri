...
ALTER TABLE atlas_app.integrated_bpp_config ADD PRIMARY KEY ( domain, merchant_id, merchant_operating_city_id, vehicle_category);


------- SQL updates -------

ALTER TABLE atlas_app.integrated_bpp_config DROP CONSTRAINT integrated_bpp_config_pkey;
ALTER TABLE atlas_app.integrated_bpp_config ADD PRIMARY KEY ( domain, merchant_operating_city_id, vehicle_category);