...
ALTER TABLE atlas_app.booking_cancellation_reason ADD COLUMN driver_dist_to_pickup integer ;
ALTER TABLE atlas_app.booking_cancellation_reason ADD COLUMN merchant_id character varying(36) ;
ALTER TABLE atlas_app.booking_cancellation_reason ADD COLUMN reason_code text ;
ALTER TABLE atlas_app.booking_cancellation_reason ADD COLUMN reason_stage text ;
ALTER TABLE atlas_app.booking_cancellation_reason ADD COLUMN ride_id character varying(36) ;
ALTER TABLE atlas_app.booking_cancellation_reason ADD COLUMN source text NOT NULL;
...
ALTER TABLE atlas_app.booking_cancellation_reason ALTER COLUMN driver_dist_to_pickup TYPE text;
...
ALTER TABLE atlas_app.booking_cancellation_reason ALTER COLUMN driver_dist_to_pickup TYPE integer;