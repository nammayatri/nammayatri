...
ALTER TABLE atlas_app.ui_rider_config ADD COLUMN bundle_version text ;
ALTER TABLE atlas_app.ui_rider_config ADD COLUMN config text NOT NULL;
...
ALTER TABLE atlas_app.ui_rider_config ADD COLUMN language text NOT NULL;
...
ALTER TABLE atlas_app.ui_rider_config ADD COLUMN merchant_operating_city_id character varying(36) ;
