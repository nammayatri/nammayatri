...
ALTER TABLE atlas_app.igm_config ADD COLUMN expected_resolution_time timestamp with time zone NOT NULL;
ALTER TABLE atlas_app.igm_config ADD COLUMN expected_response_time timestamp with time zone NOT NULL;
