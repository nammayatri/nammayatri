...
ALTER TABLE atlas_app.search_request ADD COLUMN search_mode text ;
...
ALTER TABLE atlas_app.search_request ADD COLUMN multi_modal_search_request_id character varying(36) ;