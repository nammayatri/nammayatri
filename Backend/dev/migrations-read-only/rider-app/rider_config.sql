...
ALTER TABLE atlas_app.rider_config ADD COLUMN bus_tracking_config json  default '{"maxScoreDistance":15.0,"goodScoreDistance":30.0,"fairScoreDistance":45.0,"maxScore":10.0,"goodScore":7.0,"fairScore":4.0,"thresholdFactor":0.5,"thresholdSeconds":30.0,"movementThresholdInMeters":25.0}';
