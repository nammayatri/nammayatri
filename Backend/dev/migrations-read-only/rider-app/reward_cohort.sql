...
ALTER TABLE atlas_app.reward_cohort ALTER COLUMN eligibility_json_logic TYPE text;
...
ALTER TABLE atlas_app.reward_cohort ALTER COLUMN presentation TYPE text;