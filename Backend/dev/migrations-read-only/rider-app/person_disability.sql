...
ALTER TABLE atlas_app.person_disability ADD COLUMN created_at timestamp with time zone NOT NULL default CURRENT_TIMESTAMP;
...
ALTER TABLE atlas_app.person_disability ALTER COLUMN created_at DROP NOT NULL;