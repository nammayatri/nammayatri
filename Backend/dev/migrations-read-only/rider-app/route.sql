...
ALTER TABLE atlas_app.route ADD COLUMN route_id text NOT NULL;
...
ALTER TABLE atlas_app.route ADD COLUMN merchant_id character varying(36) ;
ALTER TABLE atlas_app.route ADD COLUMN merchant_operating_city_id character varying(36) ;
...
ALTER TABLE atlas_app.route ADD PRIMARY KEY ( route_id);