...
CREATE INDEX CONCURRENTLY customer_block_transactions_idx_action_type_customer_id ON atlas_app.customer_block_transactions USING btree (action_type, customer_id);
CREATE INDEX CONCURRENTLY customer_block_transactions_idx_customer_id ON atlas_app.customer_block_transactions USING btree (customer_id);