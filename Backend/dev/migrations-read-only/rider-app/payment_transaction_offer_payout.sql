...
ALTER TABLE atlas_app.payment_transaction_offer_payout ADD COLUMN is_consumed_by_cron boolean NOT NULL;
...
ALTER TABLE atlas_app.payment_transaction_offer_payout ADD COLUMN settled_amount double precision NOT NULL;
