...
ALTER TABLE atlas_app.merchant_config ALTER COLUMN fraud_search_count_window SET DEFAULT '{period:24, periodType:Hours}';
ALTER TABLE atlas_app.merchant_config ALTER COLUMN fraud_ride_count_window SET DEFAULT '{period:24, periodType:Hours}';
ALTER TABLE atlas_app.merchant_config ALTER COLUMN fraud_booking_cancelled_by_driver_count_window SET DEFAULT '{period:24, periodType:Hours}';
ALTER TABLE atlas_app.merchant_config ALTER COLUMN fraud_booking_cancellation_count_window SET DEFAULT '{period:24, periodType:Hours}';