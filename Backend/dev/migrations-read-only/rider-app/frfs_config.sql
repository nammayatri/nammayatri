...
ALTER TABLE atlas_app.frfs_config ADD COLUMN integrated_bpp_config_id character varying(36) NOT NULL;
...
ALTER TABLE atlas_app.frfs_config ADD PRIMARY KEY ( integrated_bpp_config_id);
...
ALTER TABLE atlas_app.frfs_config ALTER COLUMN integrated_bpp_config_id DROP NOT NULL;
