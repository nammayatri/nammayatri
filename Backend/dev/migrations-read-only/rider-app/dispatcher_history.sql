...
ALTER TABLE atlas_app.dispatcher_history ADD COLUMN conductor_code character varying(255) NOT NULL;
...
ALTER TABLE atlas_app.dispatcher_history ADD COLUMN driver_code character varying(255) NOT NULL;
