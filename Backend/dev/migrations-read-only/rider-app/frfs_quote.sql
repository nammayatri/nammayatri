...
ALTER TABLE atlas_app.frfs_quote ADD COLUMN from character varying(36) NOT NULL;
...
ALTER TABLE atlas_app.frfs_quote ADD COLUMN to character varying(36) NOT NULL;
