...
ALTER TABLE atlas_app.frfs_quote ADD COLUMN osrtc_trip_detail text ;
...
ALTER TABLE atlas_app.frfs_quote ALTER COLUMN osrtc_trip_detail TYPE json USING osrtc_trip_detail::json;