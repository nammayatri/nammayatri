...
ALTER TABLE atlas_app.incentive_journey_milestone ADD COLUMN subscription_waive_off_service_name text  default NULL;
ALTER TABLE atlas_app.incentive_journey_milestone ADD COLUMN subscription_waive_off_percentage integer  default NULL;
ALTER TABLE atlas_app.incentive_journey_milestone ADD COLUMN subscription_waive_off_mode text  default NULL;
ALTER TABLE atlas_app.incentive_journey_milestone ADD COLUMN subscription_waive_off_days_valid_for integer  default NULL;