...
ALTER TABLE atlas_app.booking ADD COLUMN is_insured boolean ;
...
ALTER TABLE atlas_app.booking ADD COLUMN selected_offer_id text ;
...
ALTER TABLE atlas_app.booking ADD COLUMN location_names text[] ;