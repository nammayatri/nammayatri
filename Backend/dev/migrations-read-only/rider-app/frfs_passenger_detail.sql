...
ALTER TABLE atlas_app.frfs_passenger_detail ADD COLUMN id_proof_number_encrypted character varying(255) ;
ALTER TABLE atlas_app.frfs_passenger_detail ADD COLUMN id_proof_number_hash bytea ;
