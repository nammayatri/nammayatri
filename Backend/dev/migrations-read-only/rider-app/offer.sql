...
ALTER TABLE atlas_app.offer ADD COLUMN offer_eligibility_json_logic text ;
...
ALTER TABLE atlas_app.offer ALTER COLUMN offer_eligibility_json_logic TYPE json;