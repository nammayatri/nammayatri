...
ALTER TABLE atlas_app.finance_invoice ADD COLUMN merchant_gstin text ;
...
ALTER TABLE atlas_app.finance_invoice ADD COLUMN rendered_invoice_json jsonb ;
ALTER TABLE atlas_app.finance_invoice ADD COLUMN pdf_s3_path text ;
...
ALTER TABLE atlas_app.finance_invoice ADD COLUMN place_of_supply text ;


------- SQL updates -------

ALTER TABLE atlas_app.finance_invoice ADD COLUMN unsigned_qr_code text ;
