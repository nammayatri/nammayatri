...
ALTER TABLE atlas_app.journal_entry_transaction ADD COLUMN created_by_id text ;
...
ALTER TABLE atlas_app.journal_entry_transaction ADD COLUMN reference_id text ;
ALTER TABLE atlas_app.journal_entry_transaction ADD COLUMN sap_batch_id text NOT NULL;
ALTER TABLE atlas_app.journal_entry_transaction ADD COLUMN sap_journal_entry_id character varying(36) NOT NULL;
...
ALTER TABLE atlas_app.journal_entry_transaction ADD COLUMN updated_by text NOT NULL;
ALTER TABLE atlas_app.journal_entry_transaction ADD COLUMN updated_by_id text ;
...
ALTER TABLE atlas_app.journal_entry_transaction ADD COLUMN reference_type text ;