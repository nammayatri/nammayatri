...
ALTER TABLE atlas_app.frfs_ticket_booking ADD COLUMN confirmed_payment_booking_id character varying(36) ;
...
ALTER TABLE atlas_app.frfs_ticket_booking ALTER COLUMN confirmed_payment_booking_id TYPE text;