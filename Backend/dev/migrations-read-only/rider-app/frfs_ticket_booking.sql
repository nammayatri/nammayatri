...
ALTER TABLE atlas_app.frfs_ticket_booking ADD COLUMN from character varying(36) NOT NULL;
...
ALTER TABLE atlas_app.frfs_ticket_booking ADD COLUMN to character varying(36) NOT NULL;
