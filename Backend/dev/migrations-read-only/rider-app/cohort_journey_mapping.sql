...
ALTER TABLE atlas_app.cohort_journey_mapping ADD COLUMN streak_end_subscription_waive_off_service_name text  default NULL;
ALTER TABLE atlas_app.cohort_journey_mapping ADD COLUMN streak_end_subscription_waive_off_percentage integer  default NULL;
ALTER TABLE atlas_app.cohort_journey_mapping ADD COLUMN streak_end_subscription_waive_off_mode text  default NULL;
ALTER TABLE atlas_app.cohort_journey_mapping ADD COLUMN streak_end_subscription_waive_off_days_valid_for integer  default NULL;