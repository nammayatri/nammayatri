...
ALTER TABLE atlas_app.cohort_journey_mapping ADD COLUMN merchant_id character varying(36) NOT NULL;
...
ALTER TABLE atlas_app.cohort_journey_mapping ADD COLUMN streak_end_reward_metadata json  default NULL;
...
CREATE INDEX CONCURRENTLY cohort_journey_mapping_idx_merchant_id ON atlas_app.cohort_journey_mapping USING btree (merchant_id);
