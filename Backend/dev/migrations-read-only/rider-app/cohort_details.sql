...
ALTER TABLE atlas_app.cohort_details ADD COLUMN description text  default NULL;
ALTER TABLE atlas_app.cohort_details ADD COLUMN cohort_rule json  default NULL;
ALTER TABLE atlas_app.cohort_details ADD COLUMN category text  default NULL;

ALTER TABLE atlas_app.cohort_details ADD CONSTRAINT cohort_details_unique_idx_category_name UNIQUE (category, name);