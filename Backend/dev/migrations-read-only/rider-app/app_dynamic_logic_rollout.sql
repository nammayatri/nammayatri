...
ALTER TABLE atlas_app.app_dynamic_logic_rollout ADD COLUMN logic_id character varying(36) NOT NULL;
...
ALTER TABLE atlas_app.app_dynamic_logic_rollout ADD PRIMARY KEY ( logic_id);
