CREATE TABLE atlas_app.finance_ledger_entry ();
...
ALTER TABLE atlas_app.finance_ledger_entry ADD COLUMN from_starting_balance double precision ;
ALTER TABLE atlas_app.finance_ledger_entry ADD COLUMN id character varying(36) NOT NULL;
...
ALTER TABLE atlas_app.finance_ledger_entry ADD COLUMN settled_at timestamp with time zone ;
ALTER TABLE atlas_app.finance_ledger_entry ADD COLUMN status text NOT NULL;
ALTER TABLE atlas_app.finance_ledger_entry ADD COLUMN timestamp timestamp with time zone NOT NULL;
ALTER TABLE atlas_app.finance_ledger_entry ADD COLUMN to_account_id character varying(36) NOT NULL;
ALTER TABLE atlas_app.finance_ledger_entry ADD COLUMN to_ending_balance double precision ;
ALTER TABLE atlas_app.finance_ledger_entry ADD COLUMN to_starting_balance double precision ;
...
ALTER TABLE atlas_app.finance_ledger_entry ALTER COLUMN to_starting_balance TYPE numeric(30,15);
ALTER TABLE atlas_app.finance_ledger_entry ALTER COLUMN to_ending_balance TYPE numeric(30,15);
