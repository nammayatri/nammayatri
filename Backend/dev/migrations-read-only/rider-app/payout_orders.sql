...
ALTER TABLE atlas_app.payout_orders ADD COLUMN entity_name text ;
ALTER TABLE atlas_app.payout_orders ADD COLUMN entity_id text ;


------- SQL updates -------

ALTER TABLE atlas_app.payout_orders ADD COLUMN last_status_checked_at timestamp with time zone ;