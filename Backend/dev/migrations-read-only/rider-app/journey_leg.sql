...
ALTER TABLE atlas_app.journey_leg ADD COLUMN end_location_lat double precision ;
ALTER TABLE atlas_app.journey_leg ADD COLUMN end_location_lon double precision ;
...
ALTER TABLE atlas_app.journey_leg ADD COLUMN polyline_points text NOT NULL;
...
ALTER TABLE atlas_app.journey_leg ADD COLUMN start_location_lat double precision ;
ALTER TABLE atlas_app.journey_leg ADD COLUMN start_location_lon double precision ;
