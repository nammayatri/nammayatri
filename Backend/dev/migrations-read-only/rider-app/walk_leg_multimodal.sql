...
ALTER TABLE atlas_app.walk_leg_multimodal ADD COLUMN distance_unit character varying(255) NOT NULL;
ALTER TABLE atlas_app.walk_leg_multimodal ADD COLUMN estimated_distance double precision NOT NULL;
...
ALTER TABLE atlas_app.walk_leg_multimodal ADD COLUMN merchant_id character varying(36) ;
ALTER TABLE atlas_app.walk_leg_multimodal ADD COLUMN merchant_operating_city_id character varying(36) ;
