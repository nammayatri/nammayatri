...
ALTER TABLE atlas_app.payment_order_offer ADD COLUMN payout_amount double precision ;
ALTER TABLE atlas_app.payment_order_offer ADD COLUMN discount_amount double precision ;