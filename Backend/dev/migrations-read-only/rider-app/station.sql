...
ALTER TABLE atlas_app.station ADD COLUMN merchant_operating_city_id character varying(36);
...
ALTER TABLE atlas_app.station ADD COLUMN merchant_id character varying(36) ;
...
ALTER TABLE atlas_app.station ADD COLUMN version_tag integer ;