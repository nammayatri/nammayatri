...
ALTER TABLE atlas_app.incentive_journey_stats ADD COLUMN condition_operator text  default 'GTE';
...
ALTER TABLE atlas_app.incentive_journey_stats ADD COLUMN merchant_id character varying(36) ;
ALTER TABLE atlas_app.incentive_journey_stats ADD COLUMN merchant_operating_city_id character varying(36) ;
