...
ALTER TABLE atlas_app.safety_settings ADD COLUMN enable_post_ride_safety_check text NOT NULL default false;
ALTER TABLE atlas_app.safety_settings ADD COLUMN enable_unexpected_events_check text NOT NULL default false;
