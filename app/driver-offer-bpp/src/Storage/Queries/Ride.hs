  ...
  res <- Esq.findAll $ do
    ...
    return
      ( ride ^. RideTId,
        ...
        toLocation ^. BookingLocationArea,
        bookingStatusVal
      )
  pure $ mkRideItem <$> res
  where
