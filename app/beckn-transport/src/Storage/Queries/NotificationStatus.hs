...
updateStatus :: DBFlow m r => Id SRB.RideBooking -> Id Driver -> NotificationStatus.AnswerStatus -> m ()
...
findActiveNotificationByRideId :: DBFlow m r => Id SRB.RideBooking -> m (Maybe NotificationStatus.NotificationStatus)
