...
getProfile :: (CacheFlow m r, EsqDBReplicaFlow m r, EncFlow m r) => SP.Person -> m TranspAdminProfileRes
getProfile admin = do
...
updateProfile :: (CacheFlow m r, EsqDBFlow m r, EsqDBReplicaFlow m r, EncFlow m r) => SP.Person -> UpdateTranspAdminProfileReq -> m UpdateTranspAdminProfileRes
