...
updateStatus :: CaseId -> Storage.CaseStatus -> Flow (Either T.DBError ())
...
updateStatusAndUdfs :: CaseId -> Storage.CaseStatus -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> Flow (Either T.DBError ())
