...
, authEntity =
  ...
  , uniqueKeyId = "api.sandbox.beckn.juspay.in/dev/dunzo/v1"
  , signatureExpiry = common.signatureExpiry
  }
, selfId = "api.sandbox.beckn.juspay.in/dev/dunzo/v1"
, graceTerminationPeriod = +90
, httpClientOptions = common.httpClientOptions
, hostName = "api.sandbox.beckn.juspay.in"
, nwAddress = "https://api.sandbox.beckn.juspay.in/dev/dunzo/v1/"
