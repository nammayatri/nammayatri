...
INSERT INTO atlas_mock_app_backend.organization (id, name, short_id, gstin, status, type, domain, verified, enabled, location_id, description, mobile_number, mobile_country_code, from_time, to_time, api_key, callback_url, head_count, created_at, updated_at, callback_api_key, info) VALUES 
    ('test-provider-2                     ', 'Test provider 1', 'JUSPAY.BPP.MOCK.1', NULL, 'APPROVED', 'PROVIDER', 'FINAL_MILE_DELIVERY', true, true, NULL, NULL, NULL, NULL, NULL, NULL, 'test-provider-1-key', 'http://localhost:8017/v1', NULL, '2020-06-08 18:37:00+00', '2020-06-08 18:37:00+00', 'test-provider-cb-1-key', NULL);
INSERT INTO atlas_mock_app_backend.organization (id, name, short_id, gstin, status, type, domain, verified, enabled, location_id, description, mobile_number, mobile_country_code, from_time, to_time, api_key, callback_url, head_count, created_at, updated_at, callback_api_key, info) VALUES 
...
INSERT INTO atlas_mock_app_backend.organization (id, name, short_id, gstin, status, type, domain, verified, enabled, location_id, description, mobile_number, mobile_country_code, from_time, to_time, api_key, callback_url, head_count, created_at, updated_at, callback_api_key, info) VALUES 
    ('provider-wrapper                    ', 'Fmd wrapper', 'JUSPAY.FMD.UAT.1', NULL, 'APPROVED', 'PROVIDER', 'FINAL_MILE_DELIVERY', true, true, NULL, NULL, NULL, NULL, NULL, NULL, 'fmd-wrapper-key', 'http://localhost:8018/v1', NULL, '2020-08-01 18:37:00+00', '2020-08-01 18:37:00+00', 'test-bpp-key', NULL);
INSERT INTO atlas_mock_app_backend.organization (id, name, short_id, gstin, status, type, domain, verified, enabled, location_id, description, mobile_number, mobile_country_code, from_time, to_time, api_key, callback_url, head_count, created_at, updated_at, callback_api_key, info) VALUES 
    ('test-app-2                          ', 'Test App 1', 'JUSPAY.BAP.MOCK.1', NULL, 'APPROVED', 'APP', 'FINAL_MILE_DELIVERY', true, true, NULL, NULL, NULL, NULL, NULL, NULL, 'test-app-1-key', 'http://localhost:8016/v1', NULL, '2020-06-08 18:37:00+00', '2020-06-08 18:37:00+00', 'test-app-cb-1-key', NULL);
INSERT INTO atlas_mock_app_backend.organization (id, name, short_id, gstin, status, type, domain, verified, enabled, location_id, description, mobile_number, mobile_country_code, from_time, to_time, api_key, callback_url, head_count, created_at, updated_at, callback_api_key, info) VALUES 
