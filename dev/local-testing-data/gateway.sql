...
INSERT INTO atlas_gateway.organization (id, name, short_id, gstin, status, type, domain, verified, enabled, location_id, description, mobile_number, mobile_country_code, from_time, to_time, api_key, callback_url, head_count, created_at, updated_at, callback_api_key, info) VALUES
    ...
    ('mock-public-transport-bpp', 'Public transport BPP mock', 'JUSPAY.MOBILITY.PROVIDER.MOCK.1', NULL, 'APPROVED', 'PROVIDER', 'PUBLIC_TRANSPORT', true, true, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'http://localhost:9091', NULL, now(), now(), NULL, NULL),
    ('public-transport-bap', 'Public transport BAP', 'JUSPAY.MOBILITY.APP.UAT.4', NULL, 'APPROVED', 'APP', 'PUBLIC_TRANSPORT', true, true, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'http://localhost:8023/beckn', NULL, now(), now(), NULL, NULL);
