...
INSERT INTO atlas_gateway.organization (id, name, short_id, gstin, status, type, domain, verified, enabled, location_id, description, mobile_number, mobile_country_code, from_time, to_time, api_key, callback_url, head_count, created_at, updated_at, callback_api_key, info) VALUES
    ...
    ('b4810ce6-07ed-4e3e-b2ae-50e0d214858d', 'mock parking BPP', 'mock-parking-bpp', NULL, 'APPROVED', 'PROVIDER', 'PARKING', true, true, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'http://localhost:8090', NULL, now(), now(), NULL, NULL);
...
INSERT INTO atlas_gateway.organization (id, name, short_id, gstin, status, type, domain, verified, enabled, location_id, description, mobile_number, mobile_country_code, from_time, to_time, api_key, callback_url, head_count, created_at, updated_at, callback_api_key, info) VALUES
    ...
    ('mobility-app-parking                ', 'Mobility app', 'JUSPAY.MOBILITY.APP.UAT.3', NULL, 'APPROVED', 'APP', 'PARKING', true, true, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'http://localhost:8022/beckn', NULL, now(), now(), NULL, NULL),
    ('mock-public-transport-bpp', 'Public transport BPP mock', 'JUSPAY.MOBILITY.PROVIDER.MOCK.1', NULL, 'APPROVED', 'PROVIDER', 'MOBILITY', true, true, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'http://localhost:8091', NULL, now(), now(), NULL, NULL);
