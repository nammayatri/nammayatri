              ...
              Just $
                FulfillmentDetails
                  { location =
                    ...
                    contact = Contact Nothing Nothing Nothing,
...
runInit :: ClientEnv -> Text -> API.BecknReq InitAPI.InitOrder -> IO (Either ClientError AckResponse)
