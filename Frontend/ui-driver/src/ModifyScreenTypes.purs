...
modifyScreenState st =
  case st of
    ...
    OnboardingFaqsScreenStateType a -> modifyState (\(GlobalState state) -> GlobalState $ state {onboardingFaqsScreen = a state.onboardingFaqsScreen})
    OperationHubScreenStateType a -> modifyState (\(GlobalState state) -> GlobalState $ state {operationHubScreen = a state.operationHubScreen})
