...
driverRegistrationStatus queryParam queryParam2 = (getBaseUrl "") <> "/driver/register/status?makeSelfieAadhaarPanMandatory=" <> show queryParam <> "&useHVSdkForDL=" <> show queryParam2
