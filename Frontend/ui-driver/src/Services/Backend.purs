...
getBusRideHistory :: String -> String -> BusTripStatus -> Flow GlobalState (Either ErrorResponse BusRideHistoryResp)
...
getBusRideHistoryBT :: String -> String -> BusTripStatus -> FlowBT String BusRideHistoryResp
