...
makePANCardReq :: Boolean -> String -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> String -> ValidationStatus -> PanCardReq
makePANCardReq consent consentTimestamp dateOfBirth nameOnCard imageId1 imageId2 panNumber validationStatus = PanCardReq
    {
       "consent" : consent,
