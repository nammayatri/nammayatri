...
newtype SubscriptionServiceResp = SubscriptionServiceResp {
  services :: Array ServicesSubscription
}

newtype ServicesSubscription = ServicesSubscription {tag :: String}
...
derive instance genericServicesSubscription :: Generic ServicesSubscription _
derive instance newtypeServicesSubscription :: Newtype ServicesSubscription _
instance standardEncodeServicesSubscription :: StandardEncode ServicesSubscription where standardEncode (ServicesSubscription res) = standardEncode res
instance showServicesSubscription :: Show ServicesSubscription where show = genericShow
instance decodeServicesSubscription :: Decode ServicesSubscription where decode = defaultDecode
instance encodeServicesSubscription :: Encode ServicesSubscription where encode = defaultEncode
-------------------------------------------------- SubscribePlan ------------------------------
