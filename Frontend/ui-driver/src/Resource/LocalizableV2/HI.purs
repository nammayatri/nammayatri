...
getHi =
  Keymap
    ...
    , term_1b: (\time -> "1. निर्धारित सवारी शुरू होने से " <> time <> " घंटे पहले रद्द करने पर प्लेटफॉर्म पर जुर्माना लगाया जाएगा।")
    , term_2b: (\time -> "2. निर्धारित सवारी प्रारंभ होने से " <> time <> " मिनट पहले ऑनलाइन रहें।")
    , term_3b: (\time -> "3. निर्धारित सवारी प्रारंभ समय से " <> time <> " मिनट पहले ग्राहक पिकअप स्थान पर पहुंचें।")
