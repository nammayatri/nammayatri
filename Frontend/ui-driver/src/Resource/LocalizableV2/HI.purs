...
getHi =
  Keymap
    ...
    , earn_upto_per_day: "प्रतिदिन R${} तक कमाएं!"
    , how_this_works: "यह कैसे काम करता है"
    , sign_up_for_autopay_by_paying_just: "केवल R$1 का भुगतान करके ऑटोपे के लिए साइन अप करें"
    ...
    , switch_and_save_desc: "आपने आज 7 से अधिक यात्राएं पूरी की हैं। डेली अनलिमिटेड योजना पर स्विच करके R$10 तक बचाएं"
    ...
    , daily_per_ride_plan_desc: (\price -> "प्रति दिन अधिकतम R$" <> price <> " तक")
    , autopay_cancelled: "ऑटोपे भुगतान रद्द"
    , no: "नहीं"
    , yes_cancel: "हां, रद्द करें"
    , pay_to_join_this_plan: "योजना से जुड़ने के लिए R$1 का भुगतान करें"
    ...
    , offer_card_banner_title: (\_ date price -> "ऑटोपे सेटअप करें और " <> date <> " तक केवल R$" <> price <> "/दिन पे करें")
    , offer_card_banner_desc: "1 नवंबर तक केवल R$15/दिन पे करें|"
    ...
    , pay_now: "भुगतान करें"
    , clear_dues_banner_title: "नॉन-स्टॉप सवारी का आनंद लेने के लिए शेष राशि(R${}) चुकाएँ"
    ...
    , due_limit_warning_banner_title: "आपकी R${} की देय सीमा जल्द ही पूरी हो जाएगी"
    ...
    , booth_charges_included: "बूथ शुल्क शामिल: R${}"
    ...
    , tip_can_be_added: (\maxTip -> "किराए में R$" <> maxTip <> " तक की टिप जोड़ी जा सकती है।")
