...
getBn =
  Keymap
    ...
    , earn_upto_per_day: "প্রতিদিন R${} পর্যন্ত উপার্জন করুন!"
    , how_this_works: "কিভাবে এই কাজ করে"
    , sign_up_for_autopay_by_paying_just: "মাত্র R$1 দিয়ে অটোপে-এর জন্য সাইন আপ করুন"
    ...
    , switch_and_save_desc: "আপনি আজ 7টির বেশি রাইড সম্পূর্ণ করেছেন। দৈনিক আনলিমিটেড প্ল্যানে স্যুইচ করে R$10 পর্যন্ত সঞ্চয় করুন"
    ...
    , daily_per_ride_plan_desc: (\price -> "প্রতিদিন সর্বোচ্চ R$" <> price <> " পর্যন্ত")
    , pay_to_join_this_plan: "প্ল্যানে যোগ দিতে R$1 পে করুন"
    ...
    , offer_card_banner_title: (\_ date price -> "অটোপে সেটআপ করুন এবং " <> date <> " পর্যন্ত শুধুমাত্র R$" <> price <> "/দিন পে করুন")
    , offer_card_banner_desc: "1 নভেম্বর পর্যন্ত শুধুমাত্র R$15/দিন পে করুন"
    ...
    , due_limit_warning_banner_title: "আপনার যথাসময়ে R${} ডলার সীমা শীঘ্রই পৌঁছে যাবে"
    ...
    , booth_charges_included: "বুথ চার্জ অন্তর্ভুক্ত: R${}"
    ...
    , tip_can_be_added: (\maxTip -> "টিপ হিসাবে সর্বোচ্চ R$" <> maxTip <> " রাইড ভাড়ায় যোগ করা যেতে পারে।")
