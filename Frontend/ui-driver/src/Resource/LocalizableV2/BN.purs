...
getBn =
  Keymap
    ...
    , join_a_plan_to_continue_taking_rides: "রাইডগুলি চালিয়ে যেতে বেছে নিন"
    ...
    , route_number : "রুট নম্বর"
    , select_route_number : "রুট নম্বর নির্বাচন করুন"
    , scan_bus_qr : "বাসের QR স্ক্যান করুন"
    , bus_no : "বাস নং"
    , route_no : "রুট নং"
    , bus_type_ : "বাসের ধরণ"
    , recent_ride : "সাম্প্রতিক যাত্রা"
    , assigned_rides : "নির্ধারিত যাত্রা"
    , on_duty : "ডিউটিতে"
    , end_duty : "ডিউটি শেষ করুন"
    , send_request : "অনুরোধ পাঠান"
    , send_end_ride_request_to_your_depot : "আপনার ডিপো ম্যানেজারের কাছে রাইড শেষ করার অনুমতির জন্য অনুরোধ পাঠান"
    , waiting_for_depot_response : "ডিপোর প্রতিক্রিয়ার জন্য অপেক্ষা করুন!"
    , waiting_for_depot_manager_response : "আপনার রাইড শেষ করার জন্য ডিপো ম্যানেজারের প্রতিক্রিয়ার জন্য অপেক্ষা করুন"
    ...
    , poor : "খারাপ"
    , bus_driver: "বাস চালক"
    , bus_conductor: "বাস কন্ডাক্টর"
    , select_bus_driver: "বাস ড্রাইভার নির্বাচন করুন"
    , select_bus_conductor: "বাস কন্ডাক্টর নির্বাচন করুন"
