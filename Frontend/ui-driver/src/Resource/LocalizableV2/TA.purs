...
getTa =
  Keymap
    ...
    , search : "தேடுக"
    , warning : "எச்சரிக்கை!"
    , you_have_been_blocked_for_n_days: "கூடுதல் கட்டணத்திற்காக பல வாடிக்கையாளர் புகார்கள் வந்ததால் உங்களை நாட்களுக்கு தடை செய்யப்பட்டுள்ளது."
    , do_not_ask_customers_for_extra_payment: "வாடிக்கையாளர்களிடம் கூடுதல் பணம் கேட்க வேண்டாம். தொடர்ந்து செய்யும் பட்சத்தில் தடை செய்யப்பட வாய்ப்பு உள்ளது."
    , blocked_for_variant_rides_till : (\a b c -> a <> " ప్రయాణాలకు " <> b <> "," <> c <> " వరకు నిలిపివేయబడింది")
    , blocked_for_variant_rides_reason : (\a -> "అదనపు చార్జీల గురించి అనేక వినియోగదారుల ఫిర్యాదుల కారణంగా మీరు " <> a <> " ప్రయాణాలకు నిలిపివేయబడ్డారు")
    }