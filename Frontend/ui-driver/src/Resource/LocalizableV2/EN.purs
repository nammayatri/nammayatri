...
getEn =
  Keymap
    ...
    , eligibility_criteria_for_rc: "Eligibility criteria for RC"
    , car_must_be_less_than_3_years_old: "Your car must be less than 3 years old"
    , car_must_be_sedan_or_suv: "Your car must be a Sedan or SUV"
    ...
    , verified_linked_with_name: (\name -> "Verified. Linked with " <> name)
    , visit_your_nearest_hub_to_complete_a_short_vehicle_inspection_to_start_earning_with_us: "Visit your nearest hub to complete a short vehicle inspection to start earning with us"
    , you_will_be_contacted_by_your_selected_hub_within_24_hours: "You will be contacted by your selected hub within 24 hours"
    , operator_referral_code_applied: "Operator referral code applied"
    , got_an_operator_referral_code: "Got an Operations Partner code?"
    , locate_on_map: "Locate on Map"
    , contact_number: "Contact No"
    , address: "Address"
    , vehicle_photos : "Vehicle Photos"
    , operation_hub : "Operation Hub"
    , take_a_clear_picture_of_the_vehicle_from_the_suggested_angles : "Take a clear picture of the vehicle from the suggested angles"
    , take_a_clear_selfie_with_your_face_inside_the_marked_area : "Take a clear selfie with your face inside the marked area"
    , ensure_only_your_vehicle_is_in_the_frame_when_uploading : "Ensure only your vehicle is in the frame when uploading"
    , only_your_face_should_be_in_the_frame_when_uploading_the_image : "Only your face should be in the frame when uploading the image"
    , full_view : "Full View"
    , avoid_people : "Avoid People"
    , cropped_area : "Cropped area"
    , inside_marked_area : "Inside Marked Area"
    ...
    , enter_the_code_shared_with_you_by_the_operations_agent_during_onboarding : "Enter the code shared with you by the Operations agent during onboarding"
    ...
    , vehicle_registeraton_certificate: "Registration Certificate (RC)"
    ...
    , take_slash_upload_photo: "Take/Upload Photo"
    ...
    , driving_license_details: "Driving License Details"
    ...
    , you_will_lose_a_chance_to_earn: (\coins -> "You will lose a chance to earn " <> coins <> " points")
    ...
    , noida: "Noida"
    , bangalore: "Bangalore"
    , car_must_be_maruti_suzuki_vehicle: "Your car must be a Maruti Suzuki vehicle"
    , car_must_be_commercial_vehicle: "Your car must be a commercial vehicle"
    , pan_aadhaar_dl_same_person: "The PAN, Aadhaar, and Driving License (DL) should belong to the same person"
    , hotspots: "Hotspots"
    , very_high: "Very High"
    , high: "High"
    ...
    , ride_ensured_at_no_extra_cost: "Your ride is now insured at no extra cost"
    , policy_number: "Policy Number"
    , sum_insured: "Sum Insured"
    , generating_your_policy: "Generating your policy"
    ...
    , onboarding_faq_setting_up_account : "Setting up my account"
    , onboarding_faq_managing_account : "Managing my account"
    , onboarding_faq_adding_managing_drivers : "Adding and managing drivers"
    , onboarding_faq_adding_managing_vehicles : "Adding and managing vehicles"
    , onboarding_faq_mapping_drivers_vehicles : "Mapping drivers and vehicles"
    , onboarding_faq_register_fleet_operator_q : "How do I become a register as a Fleet operator on MSIL FleetX?"
    , onboarding_faq_register_fleet_operator_a : "To register as a Fleet Operator, visit the <span style='color:#2194FF'>msilfleetx.com</span> and follow the on-screen instructions to complete the sign-up process."
    , onboarding_faq_choose_language_q : "How do I choose my preferred language?"
    , onboarding_faq_choose_language_a : "Navigate to the top right corner of the Welcome page, and select your desired language from the list."
    , onboarding_faq_signup_email_q : "Can I Sign-Up with my Email?"
    , onboarding_faq_signup_email_a : "For registering onto MSIL FleetX, you need a valid mobile no. <br><br>Additionally you can enter your email ID in the \"Get Started\" section after registration to receive timely updates on mail."
    , onboarding_faq_otp_issue_q : "I am not able to receive OTP for login"
    , onboarding_faq_otp_issue_a : "If you're having trouble receiving an OTP: <br>1. Click \"Resend OTP\" <br>2.If the issue continues, you can contact us at you can call us +91xxxxxxxxx or reach out to us as <span style='color:#2194FF'>msilfleetx@maruti.co.in</span>"
    , onboarding_faq_individual_business_fleet_q : "What is the difference between Individual Fleet and Business Fleet?"
    , onboarding_faq_individual_business_fleet_a : "You can register as a Business Fleet only if your fleet is a registered fleet business and you hold the necessary documents (Business License, GST Number, Business PAN). <br><br>If not, you can register as an Individual Fleet Operator."
    , onboarding_faq_registration_details_q : "What details do I need to provide to complete my registration?"
    , onboarding_faq_registration_details_a : "As a business fleet operator you need to enter/upload the following: <br>1. Fleet Name <br>2. Registered Mobile Number <br>3. City of Operations <br>4. Email ID <br>5. Operator Code (Optional) <br>6. Business PAN number and document <br>7. GST number and document <br>8. Business License number and document  <br><br>For an Individual Fleet Operator you need to enter/upload the following: <br>1. Fleet Owner Name <br>2. Registered Mobile Number <br>3. City of Operations <br>4. Email ID <br>5. Operator Code (Optional) <br>6. Aadhaar Card number and document <br>7. Personal PAN number and document"
    , onboarding_faq_operating_cities_q : "What cities can I operate in?"
    , onboarding_faq_operating_cities_a : "As of now, you can operate within the Delhi-NCR region."
    , onboarding_faq_operator_referral_code_q : "What is the operator referral code?"
    , onboarding_faq_operator_referral_code_a : "The Operator Referral Code is a unique 4-digit code given to you by your onboarding partner. <br><br>To ensure you're correctly tagged to your onboarding partner, enter the code in the 'Operator code' field during the onboarding process."
    , onboarding_faq_required_documents_q : "What documents am I required to upload?"
    , onboarding_faq_required_documents_a : "In case of a Business Fleet operator: <br>1. Business PAN Card <br>2. GST Certificate <br>3. Business License <br><br>In case of an Individual Fleet Operator:  <br>1. Aadhaar Card <br>2. Personal PAN card"
    , onboarding_faq_registration_assistance_q : "What do I do if I need assistance during the registration process? "
    , onboarding_faq_registration_assistance_a : "Click the Help option in the top right corner of the screen to access a dropdown menu with: <br><br>1. Contact MSIL Support <br>2. Change Language <br>3. Logout Option <br><br>Click on contact MSIL support or reach out to us as <span style='color:#2194FF'msilfleetx@maruti.co.in</span>"
    , onboarding_faq_update_documents_q : "How to update my documents?"
    , onboarding_faq_update_documents_a : "Go to Profile > Profile Details and click on Edit button. Upload the documents that need update and click Save."
    , onboarding_faq_view_profile_q : "Where can I view my profile details?"
    , onboarding_faq_view_profile_a : "Navigate to the bottom of you screen, and click on the profile photo icon to view your profile details."
    , onboarding_faq_logout_q : "How can I logout of my fleet account?"
    , onboarding_faq_logout_a : "Navigate to the bottom of you screen, and click on the profile photo icon to find the log-out option."
    , onboarding_faq_profile_picture_q : "How do I add or remove a profile picture?"
    , onboarding_faq_profile_picture_a : "Go to the \"Profile\" tab from the navigation bar. Tap on the photo icon and click the edit photo icon, upload photo and click Save"
    , onboarding_faq_msil_provide_drivers_q : "Will MSIL provide me with drivers for my fleet?"
    , onboarding_faq_msil_provide_drivers_a : "No, MSIL does not provide drivers for your fleet."
    , onboarding_faq_add_multiple_drivers_q : "Can I add muliple drivers to my fleet?"
    , onboarding_faq_add_multiple_drivers_a : "Yes, you can onboard as many drivers as you like, provided they have valid documentation."
    , onboarding_faq_onboard_driver_q : "How do I onboard a driver on my fleet?"
    , onboarding_faq_onboard_driver_a : "Once you have completed the sign up process, you will be directed to your Fleet Dashboard. <br><br>Click on 'Drivers' on the left-side panel. Click on \"Add driver\" on the top right corner of the screen and follow the on screen instructions to add drivers to your fleet."
    , onboarding_faq_add_driver_manually_q : "How do I add a driver manually?"
    , onboarding_faq_add_driver_manually_a : "To add drivers manually: <br><br>1. Go to your Driver Dashboard <br>2. Click on \"Add Driver\" at the top right corner <br>3. Select \"Single Driver\" <br>4. Enter the driver's contact number and click on \"Send OTP\" <br>5.Once the OTP is received and entered, a driver profile will be created and automatically linked to your fleet <br><br>Note: Driver documents must be uploaded manually after the driver's name appears under your fleet. You can search for the driver using his/her DL no. or mobile no. to start adding documents for your driver."
    , onboarding_faq_driver_bulk_upload_q : "How does driver bulk upload help?"
    , onboarding_faq_driver_bulk_upload_a : "To onboard multiple drivers at once:<br><br> 1. Go to your Driver Dashboard <br>2. Click on \"Add Driver\" at the top right corner <br>3. Select \"Bulk Upload\" <br>4. Upload a CSV file containing driver names and contact numbers <br>5. Upon verification, each driver will receive a joining link. This link redirects them to the Play Store to download the MSIL Fleetx app making onboarding a one-time and seamless process <br>6. Drivers will be automatically linked to your fleet <br><br>Note: Driver documents will still need to be uploaded separately for each driver, either by the drivver or by you. You can search for the driver using his/her DL no. or mobile no. to start adding documents for your driver."
    , onboarding_faq_driver_documents_q : "What documents do I need to onboard a driver?"
    , onboarding_faq_driver_documents_a : "To onboard a driver, you will need the following documents:<br><br>1. Driving License <br>2. Aadhaar Card <br>3. PAN Card"
    , onboarding_faq_driver_tab_q : "What is the Driver tab?"
    , onboarding_faq_driver_tab_a : "The Driver tab provides you with a list of drivers under operating under your fleet. The page also includes driver status, driver contact, active vehicle, and document verification status. The Driver dashboard also allows you to change and filter your driver view as per your needs."
    , onboarding_faq_track_driver_docs_q : "Can I track my driver's documentation and onboarding verification on my dashboard?"
    , onboarding_faq_track_driver_docs_a : "Yes, on the driver dashboard, view the column \"Driver Docs\". Under the column, along side each driver, you can track their document verification and onboarding status. "
    , onboarding_faq_add_remove_drivers_q : "Can I add or remove drivers from my fleet profile?"
    , onboarding_faq_add_remove_drivers_a : "Yes, go to \"Drivers\" tab <br><br>To add a driver, click on \"Add New Driver\", upload the required documents and link them to a vehicle. <br><br>To remove a driver, select the driver from the list, click \"Remove\", and confirm the action. "
    , onboarding_faq_manage_driver_docs_q : "How do I manage driver documents?"
    , onboarding_faq_manage_driver_docs_a : "Navigate to \"Drivers\" tab and view the coloumn of Vehicle Docs. Click to view driver documents and status."
    , onboarding_faq_onboard_vehicle_q : "How do I onboard a vehicle to my fleet?"
    , onboarding_faq_onboard_vehicle_a : "Once you have completed the sign up process, you will be directed to your Fleet Dashboard. <br>1. Click on \"Vehicles\" in the left-side panel <br>2. Then click on \"Add Vehicle\" at the top right corner <br>3. Follow the on-screen instructions to complete the vehicle addition process"
    , onboarding_faq_add_multiple_vehicles_q : "Can I add multiple vehicles to my fleet at once?"
    , onboarding_faq_add_multiple_vehicles_a : "Yes, you can add multipe vehicles to your fleet by clicking on Bulk upload.You can refer the bulk upload template (.csv) file and add the vehicles to be onboarded in the same csv format"
    , onboarding_faq_vehicle_documents_q : "What documents do I need to Onboard a vehicle?"
    , onboarding_faq_vehicle_documents_a : "Vehicle Documents required for onboaring vehicle: <br><br>1. Registration Certificate <br>2. Vehicle Permit <br>3. Vehicle PUC Certificate <br>4. Vehicle Fitness Certificate <br>5. Vehicle Insurance <br>6. Vehicle Photos"
    , onboarding_faq_readd_vehicle_q : "Can I re-add a vehicle that I had previously deleted?"
    , onboarding_faq_readd_vehicle_a : "Yes, you can add the vehicle which was previously deleted but you have to re-upload the vehicle documents for verification and vehicle will be active only post successful verification"
    , onboarding_faq_vehicle_inspection_q : "What is vehicle inspection and why is it required?"
    , onboarding_faq_vehicle_inspection_a : "In order to complete vehicle onboarding, you need to visit a MSIL Vehicle inspection hub in order to complete a short and simple vehicle quality check. <br><br>You will be guided by a designated MSIL Onboarding partner throughout the process to ensure a seamless onboarding experience. <br><br>In order to schedule a vehicle inspection, select a MSIL vehicle inspection hub from the drop down list and select continue. You will be a contacted by a MSIL onboarding partner within 24 hours to complete your vehicle inspection"
    , onboarding_faq_inspection_cost_q : "Is there a cost for vehicle inspection?"
    , onboarding_faq_inspection_cost_a : "No, vehicle inspection is completely free of cost. <br><br>MSIL will arrange for vehicle inspection as part of the onboarding, and you will not be charged for it."
    , onboarding_faq_manage_vehicle_docs_q : "How do I manage vehicle documents?"
    , onboarding_faq_manage_vehicle_docs_a : "Navigate to \"Vehicles\" tab from the left side panel. You can track, view and update vehicle documents under the Vehicle Docs column along side each vehicle."
    , onboarding_faq_track_vehicle_docs_q : "How can I track pending vehicle document uploads across my fleet?"
    , onboarding_faq_track_vehicle_docs_a : "Navigate to \"Vehicles\" tab from the left side panel. You can track, view and update vehicle documents under the Vehicle Docs column along side each vehicle."
    , onboarding_faq_assign_driver_vehicle_q : "Can I assign a specific driver to a specific vehicle?"
    , onboarding_faq_assign_driver_vehicle_a : "Yes, you can assign any driver to any vehicle. You can even assign multiple drivers to the same vehicle. However, please note that 2 drivers cannot be active on the same vehicle at the same time"
    , onboarding_faq_remove_vehicle_q : "How can I remove or delete a vehicle from my fleet?"
    , onboarding_faq_remove_vehicle_a : "To remove a vehicle: <br>1. Go to the Vehicle Dashboard <br>2. Click on the 3 dots next to the vehicle <br>3. Select \"Delete\" from the drop down"
    , onboarding_faq_edit_vehicle_q : "How do I edit details of an existing vehicle?"
    ...
    , nominate_your_representative : "Nominate your representative"
    , your_namma_kutumba_membership_has_been_revoked : "Your Namma Kutumba membership has been revoked"
    , high_cancellation_rate_take_more_rides : "High cancellation rate. Take more rides to continue being a part of Namma Kutumba"
    , accidental_medical_support : "Accidental Medical Support"
    , accidental_medical_support_description : "Receive coverage of up to ₹20,000 per incident, claimable once every year."
    , accidental_death_support : "Accidental Death Support"
    , accidental_death_support_description : "If an accidental death occurs, your family is eligible to claim ₹50,000 as compensation."
    , medical_health_insurance : "Medical Health Insurance"
    , medical_health_insurance_description : "Opt in to a low-cost medical insurance plan designed for drivers like you. Affordable, optional, and easy to enroll."
    , personal_loans : "Personal Loans"
    , personal_loans_description : "Avail personal loans through our lending partners at preferential interest rates, subject to terms and eligibility."
    , namma_support : "Namma Support"
    , namma_support_description : "Receive professional assistance for challenges related to RTO procedures, legal issues, and other administrative matters."
    , eligibility_criteria : "Eligibility Criteria"
    , completed_50_rides_in_the_last_3_months : "Completed 50+ rides in the last 3 months"
    , safety_score_of_80_or_above : "Safety score of 80 or above"
    , rating_of_4_6_or_above : "Rating of 4.6 or above"
    , cancellation_rate_below_30 : "Cancellation rate below 30"
    , claim_via : "Claim via"
    , what_is_kutumba : "What is Kutumba?"
    , how_can_i_be_eligible : "How can I be eligible?"
    , can_i_refer_a_friend_to_kutumba_once_i_am_eligible : "Can I refer a friend to Kutumba once I am eligible?"
    , how_do_i_claim_a_benefit : "How do I claim a benefit?"
    , are_there_limits_on_claims_per_month : "Are there limits on claims per month?"
    , what_is_kutumba_answer : "Kutumba (Namma Driver Welfare Trust) is an initiative / program by Namma Yatri to promote the welfare of drivers associated with Namma Yatri, including financial support, health benefits, rewards, and recognition programs."
    , how_can_i_be_eligible_answer : "The eligibility to the Kutumba can be obtained by following 3 simple steps; Ride More, Cancel Less and Ensure Good Customer Service."
    , can_i_refer_a_friend_to_kutumba_once_i_am_eligible_answer : "No. One cannot refer to the Kutumba. The eligibility can be earned by following what is explained above."
    , how_do_i_claim_a_benefit_answer : "At the time of claiming a benefit, you need to be a part of the Kutumba. You can claim a benefit from the Kutumba Section (a sub-section in the Benefits section) of the Namma Yatri Partner App."
    , are_there_limits_on_claims_per_month_answer : "The disbursal of the amount against the claims made is decided by the working committee as per the budget allocated in the particular month. The unutilised budget will be carried over to the subsequent month."
    , view_less : "View Less"
