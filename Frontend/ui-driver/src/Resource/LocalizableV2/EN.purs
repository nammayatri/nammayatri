...
getEn =
  Keymap
    ...
    , route_no : "Route No"
    , bus_type_ : "Bus Type"
    , recent_ride : "Recent Ride"
    , assigned_rides : "Assigned Rides"
    , on_duty : "On Duty"
    , end_duty : "End Duty"
    , send_request : "Send Request"
    , send_end_ride_request_to_your_depot : "Send end ride request to your depot\nmanager to be approved"
    , waiting_for_depot_response : "Waiting for depot response!"
    , waiting_for_depot_manager_response : "Waiting for the depot manager's response to end your ride"
    ...
    , you_can_cancel_the_ride_without_affecting_your_rating: "You can cancel the ride without affecting your rating"
    , customer_not_picking_up_the_call: "Customer not picking up the call?"
    , your_rating_wont_be_affected: "(Your rating won't be affected)"
    }
