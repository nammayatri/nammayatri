...
getMl =
  Keymap
    ...
    , you_have_been_blocked_for_n_days: "കൂടുതൽ നിരക്കിനെക്കുറിച്ച് പല ഉപഭോക്താക്കളും പരാതിപ്പെട്ടതിനാൽ നിങ്ങളെ ദിവസങ്ങൾക്ക് ബ്ലോക്ക് ചെയ്തിരിക്കുന്നു."
    , do_not_ask_customers_for_extra_payment: "ഉപഭോക്താക്കളോട് അധിക പണം ആവശ്യപ്പെടരുത്. ഇത് തുടർന്നാൽ നിങ്ങൾ ബ്ലോക്ക് ചെയ്യപ്പെടാം."
    , blocked_for_variant_rides_till : (\a b c -> a <> " യാത്രകൾ " <> b <> "," <> c <> " വരെ തടഞ്ഞിരിക്കുന്നു")
    , blocked_for_variant_rides_reason : (\a -> "അധികകൂലി സംബന്ധിച്ച നിരവധി ഉപഭോക്തൃ പരാതികൾ മൂലം നിങ്ങൾ " <> a <> " യാത്രകൾക്കായി തടയപ്പെട്ടിരിക്കുന്നു")
    }