...
getMl =
  Keymap
    ...
    , route_number : "റൂട്ട് നമ്പർ"
    , select_route_number : "റൂട്ട് നമ്പർ തിരഞ്ഞെടുക്കുക"
    , scan_bus_qr : "ബസിന്റെ QR സ്കാൻ ചെയ്യുക"
    , bus_no : "ബസ് നമ്പർ"
    , route_no : "റൂട്ട് നമ്പർ"
    , bus_type_ : "ബസിന്റെ തരം"
    , recent_ride : "അടുത്തിടെ നടത്തിയ യാത്ര"
    , assigned_rides : "ചുമതലപ്പെടുത്തിയ യാത്രകൾ"
    , on_duty : "ഡ്യൂട്ടിയിൽ"
    , end_duty : "ഡ്യൂട്ടി അവസാനിപ്പിക്കുക"
    , send_request : "അഭ്യർത്ഥന അയയ്ക്കുക"
    , send_end_ride_request_to_your_depot : "നിങ്ങളുടെ ഡിപ്പോ മാനേജറിന് യാത്ര അവസാനിപ്പിക്കാൻ അഭ്യർത്ഥന അയയ്ക്കുക"
    , waiting_for_depot_response : "ഡിപ്പോയുടെ പ്രതികരണത്തിനായി കാത്തിരിക്കുന്നു!"
    , waiting_for_depot_manager_response : "നിങ്ങളുടെ യാത്ര അവസാനിപ്പിക്കാൻ ഡിപ്പോ മാനേജറുടെ പ്രതികരണത്തിനായി കാത്തിരിക്കുന്നു"
    , cancel_request : "അഭ്യർത്ഥന റദ്ദാക്കുക"
    , scan_the_qr_to_start_new_ride : "പുതിയ യാത്ര തുടങ്ങാൻ ബസിൽ ഒട്ടിച്ച QR സ്കാൻ ചെയ്യുക"
