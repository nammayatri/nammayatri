...
getMl =
  Keymap
    ...
    , term_1b: (\time -> "1. ഷെഡ്യൂൾ ചെയ്‌ത റൈഡ് ആരംഭിക്കുന്നതിന് " <> time <> " മണിക്കൂറിന് മുമ്പ് റദ്ദാക്കുന്നത് പ്ലാറ്റ്‌ഫോമിൽ പിഴ ഈടാക്കും.")
    , term_2b: (\time -> "2. ഷെഡ്യൂൾ ചെയ്‌ത റൈഡ് ആരംഭിക്കുന്നതിന് " <> time <> " മിനിറ്റ് മുമ്പ് ഓൺലൈനാകുക.")
    , term_3b: (\time -> "3. ഷെഡ്യൂൾ ചെയ്ത റൈഡ് ആരംഭിക്കുന്ന സമയം മുതൽ " <> time <> " മിനിറ്റ് മുമ്പ് കസ്റ്റമർ പിക്കപ്പ് ലൊക്കേഷനിൽ എത്തിച്ചേരുക.")
    , excluded_charges: "ഒഴിവാക്കപ്പെട്ട നിരക്കുകൾ"
    , tolls: "ടോളുകൾ"
    , state_permit: "സംസ്ഥാന അനുമതികൾ"
    , excluded_footer: "ഈ നിരക്ക് ഘടകങ്ങൾ നിരക്കിൽ ഉൾപ്പെടുത്തിയിട്ടില്ല, അവ ഉപഭോക്താവുമായി പ്രത്യേകം തീർപ്പാക്കേണ്ടതാണ്"
