...
getMl =
  Keymap
    ...
    , cancelling_this_ride_will_block_you: "ഈ റൈഡ് റദ്ദാക്കുന്നത് നിങ്ങളെ ബ്ലോക്ക് ചെയ്യും."
    , your_cancellation_rate_is_high: "നിങ്ങളുടെ റദ്ദാക്കൽ നിരക്ക് ഉയർന്നതാണ്"
    , cancelling_this_ride_will_lower_your_score_and_may_lead_to_blocking: "ഈ റൈഡ് റദ്ദാക്കുന്നത് നിങ്ങളുടെ സ്കോർ കുറയ്ക്കും<br/>ബ്ലോക്കിംഗിന് കാരണമാകാം"
    , your_daily_cancellation_rate_will_increase_to_x_percent_and_will_block_you_for_x_hours: "നിങ്ങളുടെ ദൈനംദിന റദ്ദാക്കൽ നിരക്ക് <b>%s%%</b> വരെ വർദ്ധിപ്പിക്കും, നിങ്ങളെ <b>%s മണിക്കൂർ</b> ബ്ലോക്ക് ചെയ്യും"
    , your_weekly_cancellation_rate_will_increase_to_x_percent_and_will_block_you_for_x_hours: "നിങ്ങളുടെ ആഴ്ചതോറും റദ്ദാക്കൽ നിരക്ക് <b>%s%%</b> വരെ വർദ്ധിപ്പിക്കും, നിങ്ങളെ <b>%s മണിക്കൂർ</b> ബ്ലോക്ക് ചെയ്യും"
    , continue: "തുടരുക"
