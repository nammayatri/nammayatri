...
getMl =
  Keymap
    ...
    , earn_upto_per_day: "ഒരു ദിവസം R${} വരെ സമ്പാദിക്കുക!"
    , how_this_works: "ഇത് എങ്ങനെ പ്രവർത്തിക്കുന്നു"
    , sign_up_for_autopay_by_paying_just: "വെറും R$1 നൽകി സ്വയമേവ പണമടയ്ക്കാൻ സൈൻ അപ്പ് ചെയ്യുക"
    ...
    , switch_and_save_desc: "നിങ്ങൾ ഇന്ന് 7-ലധികം റൈഡുകൾ പൂർത്തിയാക്കി. ഡെയ്‌ലി അൺലിമിറ്റഡ് പ്ലാനിലേക്ക് മാറുന്നതിലൂടെ R$10 വരെ ലാഭിക്കൂ"
    ...
    , daily_per_ride_plan_desc: (\price -> "പ്രതിദിനം പരമാവധി R$" <> price <> " വരെ")
    , pay_to_join_this_plan: "പ്ലാനിൽ ചേരാൻ R$1 അടയ്ക്കുക"
    ...
    , offer_card_banner_title: (\_ date price -> "ഓട്ടോപേ സജ്ജീകരിച്ച് " <> date <> " വരെ പ്രതിദിനം R$" <> price <> " മാത്രം നൽകുക")
    , offer_card_banner_desc: "നവംബർ 1 വരെ പ്രതിദിനം R$15 മാത്രം നൽകുക"
    ...
    , booth_charges_included: "ബൂത്ത് ചാർജുകൾ ഉൾപ്പെടുന്നു: R${}"
    ...
    , tip_can_be_added: (\maxTip -> "യാത്ര നിരക്കിൽ R$" <> maxTip <> " വരെ ടിപ്പ് ചേർക്കാം.")
