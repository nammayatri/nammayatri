...
getMl =
  Keymap
    ...
    , eligibility_criteria_for_rc: "ആർസി ഗാഗിയ് അര്ഹതೆയ മാനദംഡഗളും"
    , car_must_be_less_than_3_years_old: "നിങ്ങളുടെ കാര് 3 വര്ഷഗളില്ലാത്തപ്പോൾ ഹള്ക്കും"
    , car_must_be_sedan_or_suv: "നിങ്ങളുടെ കാര് സെഡാന് അല്ലെങ്കില് എസ്യുവി ആയിരിക്കണം"
    ...
    , trip: "യാത്ര"
    , optional_str: "ഓപ്ഷണൽ"
    , my_vehicle: "എന്റെ വാഹനം"
    , app_permissions: "അപ്ലിക്കേഷൻ അനുമോദനം"
    , trainings: "പ്രാസ്തുലർച്ചയും"
    , verify: "പരിശോധന നടത്തുക"
    , invalid_code_please_re_enter: "അസാധുവായ കോഡ്! ദയവാൾ മീണ്ടും ഉള്ളിടുക"
    , verified_linked_with_name: (\name -> "പരിശോധന നടത്തുക. " <> name <> " എന്ന് ബന്ധപ്പെട്ടു")
    , visit_your_nearest_hub_to_complete_a_short_vehicle_inspection_to_start_earning_with_us: "നിങ്ങളുടെ കനീസ ഹബ് കി ജാവിസ്റ്റ് മുകളിൽ നിങ്ങളുടെ വാഹനം പ്രാരംഭിക്കുക ഞങ്ങളുടെ സാഥ് കമാനുഗെ ശുരുവായി"
    , you_will_be_contacted_by_your_selected_hub_within_24_hours: "നിങ്ങളുടെ എംച്ച് ക്രിയായിരുന്ന ഹബ് 24 മണിക്കൂറുകൾക്ക് നിങ്ങളുടെ സഹിതം കലിക്കും"
    , operator_referral_code_applied: "അപ്രധാനമായ രേഖപ്പെടുത്തുക പ്രയത്നം നടത്തുക"
    , got_an_operator_referral_code: "ഓപ്പറേഷൻസ് പാർട്ട്നർ കോഡ് ലഭിച്ചിട്ടുണ്ടോ?"
    , locate_on_map: "മ്യാപ്പിൽ സ്ഥാനാന്നിരിക്കുക"
    , contact_number: "സംപ്രദായ നമ്പർ"
    , address: "വിളാസ്"
    , vehicle_photos : "വാഹന ഫോട്ടോകൾ"
    , operation_hub : "ഓപ്പറേഷൻ ഹബ്"
    , take_a_clear_picture_of_the_vehicle_from_the_suggested_angles : "നിർദ്ദേശിക്കപ്പെട്ട കോണുകളിൽ നിന്ന് വാഹനത്തിന്റെ വ്യക്തമായ ചിത്രം എടുക്കുക."
    , take_a_clear_selfie_with_your_face_inside_the_marked_area : "അടയാളപ്പെടുത്തിയിരിക്കുന്ന സ്ഥലത്ത് നിങ്ങളുടെ മുഖം വ്യക്തമായി കാണുന്ന ഒരു സെൽഫി എടുക്കുക."
    , ensure_only_your_vehicle_is_in_the_frame_when_uploading : "അപ്‌ലോഡ് ചെയ്യുമ്പോൾ ഫ്രെയിമിൽ നിങ്ങളുടെ വാഹനം മാത്രമേ ഉള്ളൂ എന്ന് ഉറപ്പാക്കുക."
    , only_your_face_should_be_in_the_frame_when_uploading_the_image : "ചിത്രം അപ്‌ലോഡ് ചെയ്യുമ്പോൾ ഫ്രെയിമിൽ നിങ്ങളുടെ മുഖം മാത്രമേ ഉണ്ടാകാവൂ."
    , full_view : "പൂർണ്ണ കാഴ്ച"
    , avoid_people : "ആളുകളെ ഒഴിവാക്കുക"
    , cropped_area : "ചിത്രം ക്രോപ്പ് ചെയ്ത ഏരിയ"
    , inside_marked_area : "അടയാളപ്പെടുത്തിയ പ്രദേശത്തിനുള്ളിൽ"
    ...
    , enter_the_code_shared_with_you_by_the_operations_agent_during_onboarding : "ഓൺബോർഡിംഗ് സമയത്ത് ഓൺബോർഡിംഗ് ഏജന്റ് നിങ്ങളുമായി പങ്കിട്ട 6 അക്ക കോഡ് നൽകുക."
    ...
    , whatsapp_chat: "വാട്സ്ആപ്പ് ചാറ്റ്"
    , mail_us: "ഞങ്ങൾക്ക് മെയിൽ ചെയ്യുക"
    , call_us: "ഞങ്ങളെ വിളിക്കുക"
    , operations_hub: "ഓപ്പറേഷൻസ് ഹബ്"
    ...
    , take_slash_upload_photo: "ഫോട്ടോ എടുക്കുക/അപ്ലോഡ് ചെയ്യുക"
    ...
    , faqs_str: "പതിവ് ചോദ്യങ്ങൾ"
    , delhi: "ഡൽഹി"
    , gurugram: "ഗുരുഗ്രാം"
    , noida: "നോയിഡ"
    , bangalore: "ബെംഗളൂരു"
    , car_must_be_maruti_suzuki_vehicle: "നിങ്ങളുടെ കാർ മാരുതി സുജുകി വാഹനമായിരിക്കണം"
    , car_must_be_commercial_vehicle: "നിങ്ങളുടെ കാർ വാണിജ്യ വാഹനമായിരിക്കണം"
    , pan_aadhaar_dl_same_person: "PAN, ആധാർ, ഡ്രൈവിംഗ് ലൈസൻസ് (DL) ഒരേ വ്യക്തിക്ക് ഉള്ളതായിരിക്കണം"
    ...
    , ride_ensured_at_no_extra_cost: "നിങ്ങളുടെ യാത്ര ഇനി അധിക ചെലവില്ലാതെ ഇൻഷുറൻസ് ഉൾപ്പെടുന്നു."
    , policy_number: "പോളിസി നമ്പർ"
    , sum_insured: "ഇൻഷുറൻസ് തുക"
    , generating_your_policy: "നിങ്ങളുടെ പോളിസി സൃഷ്ടിച്ചു കൊണ്ടിരിക്കുകയാണ്"
    ...
    , collect_from_the_customer_via_upi_qr_or_cash: "UPI QR അല്ലെങ്കിൽ പണം വഴി ഉപഭോക്താവിൽ നിന്ന് ശേഖരിക്കുക"
    ...
    , thanks_for_accepting_pet_ride : "വളർത്തുമൃഗങ്ങളുമായുള്ള യാത്ര സ്വീകരിച്ചതിന് നന്ദി!"
    , clean_the_vehicle_after_ride_if_needed : "ആവശ്യമെങ്കിൽ യാത്രയ്ക്ക് ശേഷം വാഹനം വൃത്തിയാക്കുക।"
    , the_customer_is_responsible_for_pet : "ഉപഭോക്താവ് തങ്ങളുടെ വളർത്തുമൃഗത്തിനും യാത്രയ്ക്കിടെ സംഭവിക്കുന്ന ഏതെങ്കിലും പ്രശ്നങ്ങൾക്കും ഉത്തരവാദിയാണ്।"
    ...
    , i_have_read_and_accept_the : "ഞാൻ ഇത് വായിച്ചു മേല്മഡി ചെയ്തു"
    , nominate_your_representative : "നിങ്ങളുടെ പര്യാപ്തതാ സ്കോർ ഉണ്ട്\nപര്യാപ്തതാ സ്കോർ ഉണ്ട്"
    , your_namma_kutumba_membership_has_been_revoked : "നിങ്ങളുടെ നമ്മ കുതുമാ സദസ്യത್തെ രദ്ദു ചെയ്തിരിക്കുന്നു"
    , high_cancellation_rate_take_more_rides : "ഉച്ച റദ്ദു ദര. നമ്മ കുതുമാ ഭാഗവാഗിരിക്കാന്‍ ഹെച്ചിന്‍ അധികം റൈഡ്സ് തെറ്റുക"
    , accidental_medical_support : "അനാപത്തിക ചികിത്സാ സമര്ഥനെ"
    , accidental_medical_support_description : "പ്രതി ഘടന കെ അധികത്തിക 20,000 രൂപായുത്തിരുവുള്ളുദര്‍, പ്രതി വര്‍ഷദല്‍ലി ഒംദു ബാര് ദലില്‍ മാഡബഹുദു"
    , accidental_death_support : "അനാപത്തിക മരണ സമര്ഥനെ"
    , accidental_death_support_description : "യദി അനാപത്തിക മരണ ഘടിസിദരുവുള്ളുദര്‍, നിമ്മ കുടുംബ 50,000 രൂപായുത്തിരുവുള്ളുദര്‍, ദലില്‍ മാഡബഹുദു"
    , medical_health_insurance : "ചികിത്സാ സമര്ഥനെ"
    , medical_health_insurance_description : "നിമ്മ ജന്‍യ ഡ്രൈവര്‍ഗളിഗാഗിരിക്കാന്‍ വിന്‍യാസ മാഡിദ ഒംദു കമ ഖര്‍ച്ചെയ ചികിത്സാ സമര്ഥനെ അനുമത"
    , personal_loans : "വ്യക്തിഗത ഋണഗള്‍"
    , personal_loans_description : "നമ്മ ഋണ പാര്‍ട്നര്‍ഗള്‍ മൂലക ക്ക് വ്യക്തിഗത ഋണഗള്‍ അനുമതിസി, ശര്ത്തുകൾ മത്തും അനുമതികൾ അംതര്‍ഗത"
    , namma_support : "നമ്മ സമര്ഥനെ"
    , namma_support_description : "RTO പ്രക്രിയകള്‍, കാനൂനിക് സമസ്യകള്‍ മത്തും ഇതരെ പ്രശാസനിക് സമസ്യകള്‍ സംബംധിസിദ്ദ ചാന്‍സ്ഗള്‍ ഗളിഗാഗിരിക്കാന്‍ പേശീകര സഹായ പ്രാപ്തിസി"
    , eligibility_criteria : "യോഗ്യതാ മാനദംഡ്"
    , completed_50_rides_in_the_last_3_months : "അംതിമ 3 മഹിളകളില്‍ 50+ റൈഡ്സ് പൂര്‍ണ്ണിക്കുക"
    , safety_score_of_80_or_above : "80 അഥവാ അദക്കിംത ഹെച്ചിന്‍ അധികം സുരക്ഷതാ സ്കോർ"
    , rating_of_4_6_or_above : "4.6 അഥവാ അദക്കിംത ഹെച്ചിന്‍ അധികം രേടിംഗ്"
    , cancellation_rate_below_30 : "30 ക്കിംത കഡിമെ റദ്ദു ദര"
    , claim_via : "ദലില്‍ മാഡബഹുദു"
    , what_is_kutumba : "കുതുമാ എന്ത്?"
    , how_can_i_be_eligible : "നിങ്ങളുടെ യോഗ്യതാ മാനദംഡ് എന്ത്?"
    , can_i_refer_a_friend_to_kutumba_once_i_am_eligible : "നിങ്ങളുടെ യോഗ്യതാ മാനദംഡ് എന്ത്?"
    , how_do_i_claim_a_benefit : "നിങ്ങളുടെ യോഗ്യതാ മാനദംഡ് എന്ത്?"
    , are_there_limits_on_claims_per_month : "നിങ്ങളുടെ യോഗ്യതാ മാനദംഡ് എന്ത്?"
    , what_is_kutumba_answer : "നിങ്ങളുടെ യോഗ്യതാ മാനദംഡ് എന്ത്?"
    , how_can_i_be_eligible_answer : "നിങ്ങളുടെ യോഗ്യതാ മാനദംഡ് എന്ത്?"
    , can_i_refer_a_friend_to_kutumba_once_i_am_eligible_answer : "നിങ്ങളുടെ യോഗ്യതാ മാനദംഡ് എന്ത്?"
    , how_do_i_claim_a_benefit_answer : "നിങ്ങളുടെ യോഗ്യതാ മാനദംഡ് എന്ത്?"
    , are_there_limits_on_claims_per_month_answer : "നിങ്ങളുടെ യോഗ്യതാ മാനദംഡ് എന്ത്?"
    ...
    , metro : "മെട്രോ"
    -- Onboarding FAQ Translations
    , onboarding_faq_setting_up_account : "എന്റെ അക്കൗണ്ട് സജ്ജമാക്കൽ"
    , onboarding_faq_managing_account : "എന്റെ അക്കൗണ്ട് നിയന്ത്രിക്കൽ"
    , onboarding_faq_adding_managing_drivers : "ഡ്രൈവർമാരെ ചേർക്കുകയും നിയന്ത്രിക്കുകയും ചെയ്യൽ"
    , onboarding_faq_adding_managing_vehicles : "വാഹനങ്ങൾ ചേർക്കുകയും നിയന്ത്രിക്കുകയും ചെയ്യൽ"
    , onboarding_faq_mapping_drivers_vehicles : "ഡ്രൈവർമാരെയും വാഹനങ്ങളെയും മാപ്പിംഗ് ചെയ്യൽ"
    , onboarding_faq_register_fleet_operator_q : "MSIL FleetX-ൽ ഫ്ലീറ്റ് ഓപ്പറേറ്റർ ആയി എങ്ങനെ രജിസ്റ്റർ ചെയ്യാം?"
    , onboarding_faq_register_fleet_operator_a : "ഫ്ലീറ്റ് ഓപ്പറേറ്റർ ആയി രജിസ്റ്റർ ചെയ്യാൻ <span style='color:#2194FF'>msilfleetx.com</span> സന്ദർശിച്ച് സ്ക്രീനിലെ നിർദ്ദേശങ്ങൾ പിന്തുടർന്ന് സൈൻ-അപ്പ് പ്രക്രിയ പൂർത്തിയാക്കുക."
    , onboarding_faq_choose_language_q : "എന്റെ പ്രിയപ്പെട്ട ഭാഷ എങ്ങനെ തിരഞ്ഞെടുക്കാം?"
    , onboarding_faq_choose_language_a : "സ്വാഗത പേജിന്റെ മുകളിൽ വലത് മൂലയിലേക്ക് പോയി പട്ടികയിൽ നിന്ന് നിങ്ങൾക്ക് ആഗ്രഹിക്കുന്ന ഭാഷ തിരഞ്ഞെടുക്കുക."
    , onboarding_faq_signup_email_q : "എന്റെ ഇമെയിലിൽ സൈൻ-അപ്പ് ചെയ്യാമോ?"
    , onboarding_faq_signup_email_a : "MSIL FleetX-ൽ രജിസ്റ്റർ ചെയ്യാൻ നിങ്ങൾക്ക് സാധുതയുള്ള മൊബൈൽ നമ്പർ ആവശ്യമാണ്. <br><br>കൂടാതെ രജിസ്ട്രേഷന് ശേഷം \"ആരംഭിക്കുക\" വിഭാഗത്തിൽ നിങ്ങളുടെ ഇമെയിൽ ഐഡി നൽകാം."
    , onboarding_faq_otp_issue_q : "ലോഗിൻ ചെയ്യാൻ OTP ലഭിക്കുന്നില്ല"
    , onboarding_faq_otp_issue_a : "OTP ലഭിക്കുന്നതിൽ പ്രശ്നം ഉണ്ടെങ്കിൽ: <br>1. \"OTP വീണ്ടും അയയ്ക്കുക\" ക്ലിക്ക് ചെയ്യുക <br>2. പ്രശ്നം തുടരുകയാണെങ്കിൽ +91xxxxxxxxx-ൽ ഞങ്ങളെ വിളിക്കാം അല്ലെങ്കിൽ <span style='color:#2194FF'>msilfleetx@maruti.co.in</span>-ലേക്ക് ബന്ധപ്പെടാം"
    , onboarding_faq_individual_business_fleet_q : "വ്യക്തിഗത ഫ്ലീറ്റും ബിസിനസ് ഫ്ലീറ്റും തമ്മിലുള്ള വ്യത്യാസം എന്താണ്?"
    , onboarding_faq_individual_business_fleet_a : "നിങ്ങളുടെ ഫ്ലീറ്റ് രജിസ്റ്റർ ചെയ്ത ഫ്ലീറ്റ് ബിസിനസ് ആണെങ്കിൽ മാത്രമേ ബിസിനസ് ഫ്ലീറ്റ് ആയി രജിസ്റ്റർ ചെയ്യാൻ കഴിയൂ (ബിസിനസ് ലൈസൻസ്, GST നമ്പർ, ബിസിനസ് PAN). <br><br>അല്ലെങ്കിൽ വ്യക്തിഗത ഫ്ലീറ്റ് ഓപ്പറേറ്റർ ആയി രജിസ്റ്റർ ചെയ്യാം."
    , onboarding_faq_registration_details_q : "എന്റെ രജിസ്ട്രേഷൻ പൂർത്തിയാക്കാൻ എന്ത് വിവരങ്ങൾ നൽകണം?"
    , onboarding_faq_registration_details_a : "ബിസിനസ് ഫ്ലീറ്റ് ഓപ്പറേറ്റർ ആയി നിങ്ങൾ ഇനിപ്പറയുന്നവ നൽകണം/അപ്‌ലോഡ് ചെയ്യണം: <br>1. ഫ്ലീറ്റ് പേര് <br>2. രജിസ്റ്റർ ചെയ്ത മൊബൈൽ നമ്പർ <br>3. പ്രവർത്തന നഗരം <br>4. ഇമെയിൽ ഐഡി <br>5. ഓപ്പറേറ്റർ കോഡ് (ഓപ്ഷണൽ) <br>6. ബിസിനസ് PAN നമ്പറും ഡോക്യുമെന്റും <br>7. GST നമ്പറും ഡോക്യുമെന്റും <br>8. ബിസിനസ് ലൈസൻസ് നമ്പറും ഡോക്യുമെന്റും <br><br>വ്യക്തിഗത ഫ്ലീറ്റ് ഓപ്പറേറ്റർ ആയി നിങ്ങൾ ഇനിപ്പറയുന്നവ നൽകണം: <br>1. ഫ്ലീറ്റ് ഉടമയുടെ പേര് <br>2. രജിസ്റ്റർ ചെയ്ത മൊബൈൽ നമ്പർ <br>3. പ്രവർത്തന നഗരം <br>4. ഇമെയിൽ ഐഡി <br>5. ഓപ്പറേറ്റർ കോഡ് (ഓപ്ഷണൽ) <br>6. ആധാർ കാർഡ് നമ്പറും ഡോക്യുമെന്റും <br>7. വ്യക്തിഗത PAN നമ്പറും ഡോക്യുമെന്റും"
    , onboarding_faq_operating_cities_q : "ഏത് നഗരങ്ങളിൽ പ്രവർത്തിക്കാം?"
    , onboarding_faq_operating_cities_a : "നിലവിൽ ഡൽഹി-NCR മേഖലയിൽ മാത്രമേ പ്രവർത്തിക്കാൻ കഴിയൂ."
    , onboarding_faq_operator_referral_code_q : "ഓപ്പറേറ്റർ റഫറൽ കോഡ് എന്താണ്?"
    , onboarding_faq_operator_referral_code_a : "ഓപ്പറേറ്റർ റഫറൽ കോഡ് നിങ്ങളുടെ ഓൺബോർഡിംഗ് പങ്കാളിയാൽ നൽകപ്പെട്ട അദ്വിതീയ 4-അക്ക കോഡാണ്. <br><br>നിങ്ങൾ ശരിയായി ടാഗ് ചെയ്യപ്പെട്ടിരിക്കുന്നുവെന്ന് ഉറപ്പാക്കാൻ ഓൺബോർഡിംഗ് പ്രക്രിയയിൽ 'ഓപ്പറേറ്റർ കോഡ്' ഫീൽഡിൽ കോഡ് നൽകുക."
    , onboarding_faq_required_documents_q : "എന്ത് ഡോക്യുമെന്റുകൾ അപ്‌ലോഡ് ചെയ്യണം?"
    , onboarding_faq_required_documents_a : "ബിസിനസ് ഫ്ലീറ്റ് ഓപ്പറേറ്റർ ആയി: <br>1. ബിസിനസ് PAN കാർഡ് <br>2. GST സർട്ടിഫിക്കറ്റ് <br>3. ബിസിനസ് ലൈസൻസ് <br><br>വ്യക്തിഗത ഫ്ലീറ്റ് ഓപ്പറേറ്റർ ആയി: <br>1. ആധാർ കാർഡ് <br>2. വ്യക്തിഗത PAN കാർഡ്"
    , onboarding_faq_registration_assistance_q : "രജിസ്ട്രേഷൻ പ്രക്രിയയിൽ സഹായം ആവശ്യമുണ്ടെങ്കിൽ എന്ത് ചെയ്യണം?"
    , onboarding_faq_registration_assistance_a : "സ്ക്രീനിന്റെ മുകളിൽ വലത് മൂലയിൽ സഹായം ഓപ്ഷൻ ക്ലിക്ക് ചെയ്ത് ഡ്രോപ്ഡൗൺ മെനു ആക്സസ് ചെയ്യുക: <br><br>1. MSIL സപ്പോർട്ടുമായി ബന്ധപ്പെടുക <br>2. ഭാഷ മാറ്റുക <br>3. ലോഗൗട്ട് ഓപ്ഷൻ <br><br>MSIL സപ്പോർട്ടുമായി ബന്ധപ്പെടുക അല്ലെങ്കിൽ <span style='color:#2194FF'>msilfleetx@maruti.co.in</span>-ലേക്ക് ബന്ധപ്പെടാം"
    , onboarding_faq_update_documents_q : "എന്റെ ഡോക്യുമെന്റുകൾ എങ്ങനെ അപ്ഡേറ്റ് ചെയ്യാം?"
    , onboarding_faq_update_documents_a : "പ്രൊഫൈൽ > പ്രൊഫൈൽ വിവരങ്ങൾ എന്നതിലേക്ക് പോയി എഡിറ്റ് ബട്ടൺ ക്ലിക്ക് ചെയ്യുക. അപ്ഡേറ്റ് ആവശ്യമുള്ള ഡോക്യുമെന്റുകൾ അപ്‌ലോഡ് ചെയ്ത് സേവ് ക്ലിക്ക് ചെയ്യുക."
    , onboarding_faq_view_profile_q : "എന്റെ പ്രൊഫൈൽ വിവരങ്ങൾ എവിടെ കാണാം?"
    , onboarding_faq_view_profile_a : "നിങ്ങളുടെ സ്ക്രീനിന്റെ താഴെയുള്ള ഭാഗത്തേക്ക് പോയി പ്രൊഫൈൽ ഫോട്ടോ ഐക്കൺ ക്ലിക്ക് ചെയ്ത് നിങ്ങളുടെ പ്രൊഫൈൽ വിവരങ്ങൾ കാണുക."
    , onboarding_faq_logout_q : "എന്റെ ഫ്ലീറ്റ് അക്കൗണ്ടിൽ നിന്ന് എങ്ങനെ ലോഗൗട്ട് ചെയ്യാം?"
    , onboarding_faq_logout_a : "നിങ്ങളുടെ സ്ക്രീനിന്റെ താഴെയുള്ള ഭാഗത്തേക്ക് പോയി പ്രൊഫൈൽ ഫോട്ടോ ഐക്കൺ ക്ലിക്ക് ചെയ്ത് ലോഗൗട്ട് ഓപ്ഷൻ കണ്ടെത്തുക."
    , onboarding_faq_profile_picture_q : "പ്രൊഫൈൽ ചിത്രം എങ്ങനെ ചേർക്കാം അല്ലെങ്കിൽ നീക്കം ചെയ്യാം?"
    , onboarding_faq_profile_picture_a : "നാവിഗേഷൻ ബാറിൽ നിന്ന് \"പ്രൊഫൈൽ\" ടാബിലേക്ക് പോയി ഫോട്ടോ ഐക്കൺ ടാപ്പ് ചെയ്ത് എഡിറ്റ് ഫോട്ടോ ഐക്കൺ ക്ലിക്ക് ചെയ്യുക, ഫോട്ടോ അപ്‌ലോഡ് ചെയ്ത് സേവ് ക്ലിക്ക് ചെയ്യുക"
    , onboarding_faq_msil_provide_drivers_q : "MSIL എന്റെ ഫ്ലീറ്റിന് ഡ്രൈവർമാരെ നൽകുമോ?"
    , onboarding_faq_msil_provide_drivers_a : "ഇല്ല, MSIL നിങ്ങളുടെ ഫ്ലീറ്റിന് ഡ്രൈവർമാരെ നൽകുന്നില്ല."
    , onboarding_faq_add_multiple_drivers_q : "എന്റെ ഫ്ലീറ്റിലേക്ക് ഒന്നിലധികം ഡ്രൈവർമാരെ ചേർക്കാമോ?"
    , onboarding_faq_add_multiple_drivers_a : "അതെ, സാധുതയുള്ള ഡോക്യുമെന്റേഷൻ ഉള്ളവരെ എത്രയും ഡ്രൈവർമാരെ ഓൺബോർഡ് ചെയ്യാം."
    , onboarding_faq_onboard_driver_q : "എന്റെ ഫ്ലീറ്റിലേക്ക് ഡ്രൈവർ എങ്ങനെ ഓൺബോർഡ് ചെയ്യാം?"
    , onboarding_faq_onboard_driver_a : "സൈൻ അപ്പ് പ്രക്രിയ പൂർത്തിയാക്കിയ ശേഷം നിങ്ങളുടെ ഫ്ലീറ്റ് ഡാഷ്ബോർഡിലേക്ക് നയിക്കപ്പെടും. <br><br>ഇടത് വശത്തെ പാനലിൽ 'ഡ്രൈവർമാർ' ക്ലിക്ക് ചെയ്യുക. സ്ക്രീനിന്റെ മുകളിൽ വലത് മൂലയിൽ \"ഡ്രൈവർ ചേർക്കുക\" ക്ലിക്ക് ചെയ്ത് ഫ്ലീറ്റിലേക്ക് ഡ്രൈവർമാരെ ചേർക്കാൻ സ്ക്രീനിലെ നിർദ്ദേശങ്ങൾ പിന്തുടരുക."
    , onboarding_faq_add_driver_manually_q : "ഡ്രൈവർ എങ്ങനെ കൈകൊണ്ട് ചേർക്കാം?"
    , onboarding_faq_add_driver_manually_a : "ഡ്രൈവർമാരെ കൈകൊണ്ട് ചേർക്കാൻ: <br><br>1. നിങ്ങളുടെ ഡ്രൈവർ ഡാഷ്ബോർഡിലേക്ക് പോകുക <br>2. മുകളിൽ വലത് മൂലയിൽ \"ഡ്രൈവർ ചേർക്കുക\" ക്ലിക്ക് ചെയ്യുക <br>3. \"ഒറ്റ ഡ്രൈവർ\" തിരഞ്ഞെടുക്കുക <br>4. ഡ്രൈവറിന്റെ കോൺടാക്റ്റ് നമ്പർ നൽകി \"OTP അയയ്ക്കുക\" ക്ലിക്ക് ചെയ്യുക <br>5. OTP ലഭിച്ച് നൽകിയ ശേഷം ഡ്രൈവർ പ്രൊഫൈൽ സൃഷ്ടിക്കപ്പെടും <br><br>ശ്രദ്ധ: ഡ്രൈവറിന്റെ പേര് നിങ്ങളുടെ ഫ്ലീറ്റിന് കീഴിൽ പ്രത്യക്ഷപ്പെട്ട ശേഷം ഡ്രൈവർ ഡോക്യുമെന്റുകൾ കൈകൊണ്ട് അപ്‌ലോഡ് ചെയ്യണം."
    , onboarding_faq_driver_bulk_upload_q : "ഡ്രൈവർ ബൾക്ക് അപ്‌ലോഡ് എങ്ങനെ സഹായിക്കുന്നു?"
    , onboarding_faq_driver_bulk_upload_a : "ഒരേ സമയം ഒന്നിലധികം ഡ്രൈവർമാരെ ഓൺബോർഡ് ചെയ്യാൻ:<br><br> 1. നിങ്ങളുടെ ഡ്രൈവർ ഡാഷ്ബോർഡിലേക്ക് പോകുക <br>2. മുകളിൽ വലത് മൂലയിൽ \"ഡ്രൈവർ ചേർക്കുക\" ക്ലിക്ക് ചെയ്യുക <br>3. \"ബൾക്ക് അപ്‌ലോഡ്\" തിരഞ്ഞെടുക്കുക <br>4. ഡ്രൈവർ പേരുകളും കോൺടാക്റ്റ് നമ്പറുകളും അടങ്ങിയ CSV ഫയൽ അപ്‌ലോഡ് ചെയ്യുക <br>5. പരിശോധനയ്ക്ക് ശേഷം ഓരോ ഡ്രൈവർക്കും ജോയിൻ ലിങ്ക് ലഭിക്കും <br>6. ഡ്രൈവർമാർ നിങ്ങളുടെ ഫ്ലീറ്റുമായി യാന്ത്രികമായി ലിങ്ക് ചെയ്യപ്പെടും <br><br>ശ്രദ്ധ: ഡ്രൈവർ ഡോക്യുമെന്റുകൾ ഇപ്പോഴും വെറെ അപ്‌ലോഡ് ചെയ്യണം."
    , onboarding_faq_driver_documents_q : "ഡ്രൈവർ ഓൺബോർഡ് ചെയ്യാൻ എന്ത് ഡോക്യുമെന്റുകൾ ആവശ്യമാണ്?"
    , onboarding_faq_driver_documents_a : "ഡ്രൈവർ ഓൺബോർഡ് ചെയ്യാൻ ഇനിപ്പറയുന്ന ഡോക്യുമെന്റുകൾ ആവശ്യമാണ്:<br><br>1. ഡ്രൈവിംഗ് ലൈസൻസ് <br>2. ആധാർ കാർഡ് <br>3. PAN കാർഡ്"
    , onboarding_faq_driver_tab_q : "ഡ്രൈവർ ടാബ് എന്താണ്?"
    , onboarding_faq_driver_tab_a : "ഡ്രൈവർ ടാബ് നിങ്ങളുടെ ഫ്ലീറ്റിന് കീഴിൽ പ്രവർത്തിക്കുന്ന ഡ്രൈവർമാരുടെ പട്ടിക നൽകുന്നു. പേജിൽ ഡ്രൈവർ സ്റ്റാറ്റസ്, ഡ്രൈവർ കോൺടാക്റ്റ്, സജീവ വാഹനം, ഡോക്യുമെന്റ് വെരിഫിക്കേഷൻ സ്റ്റാറ്റസ് എന്നിവയും ഉൾപ്പെടുന്നു."
    , onboarding_faq_track_driver_docs_q : "എന്റെ ഡാഷ്ബോർഡിൽ ഡ്രൈവറിന്റെ ഡോക്യുമെന്റേഷനും ഓൺബോർഡിംഗ് വെരിഫിക്കേഷനും ട്രാക്ക് ചെയ്യാമോ?"
    , onboarding_faq_track_driver_docs_a : "അതെ, ഡ്രൈവർ ഡാഷ്ബോർഡിൽ \"ഡ്രൈവർ ഡോക്സ്\" കോളം കാണുക. കോളത്തിന് കീഴിൽ, ഓരോ ഡ്രൈവറിനോടൊപ്പം അവരുടെ ഡോക്യുമെന്റ് വെരിഫിക്കേഷനും ഓൺബോർഡിംഗ് സ്റ്റാറ്റസും ട്രാക്ക് ചെയ്യാം."
    , onboarding_faq_add_remove_drivers_q : "എന്റെ ഫ്ലീറ്റ് പ്രൊഫൈലിൽ നിന്ന് ഡ്രൈവർമാരെ ചേർക്കാമോ അല്ലെങ്കിൽ നീക്കം ചെയ്യാമോ?"
    , onboarding_faq_add_remove_drivers_a : "അതെ, \"ഡ്രൈവർമാർ\" ടാബിലേക്ക് പോകുക <br><br>ഡ്രൈവർ ചേർക്കാൻ \"പുതിയ ഡ്രൈവർ ചേർക്കുക\" ക്ലിക്ക് ചെയ്യുക, ആവശ്യമായ ഡോക്യുമെന്റുകൾ അപ്‌ലോഡ് ചെയ്ത് വാഹനവുമായി ലിങ്ക് ചെയ്യുക. <br><br>ഡ്രൈവർ നീക്കം ചെയ്യാൻ പട്ടികയിൽ നിന്ന് ഡ്രൈവർ തിരഞ്ഞെടുത്ത് \"നീക്കം ചെയ്യുക\" ക്ലിക്ക് ചെയ്യുക."
    , onboarding_faq_manage_driver_docs_q : "ഡ്രൈവർ ഡോക്യുമെന്റുകൾ എങ്ങനെ നിയന്ത്രിക്കാം?"
    , onboarding_faq_manage_driver_docs_a : "\"ഡ്രൈവർമാർ\" ടാബിലേക്ക് പോയി വാഹന ഡോക്സ് കോളം കാണുക. ഡ്രൈവർ ഡോക്യുമെന്റുകളും സ്റ്റാറ്റസും കാണാൻ ക്ലിക്ക് ചെയ്യുക."
    , onboarding_faq_onboard_vehicle_q : "എന്റെ ഫ്ലീറ്റിലേക്ക് വാഹനം എങ്ങനെ ഓൺബോർഡ് ചെയ്യാം?"
    , onboarding_faq_onboard_vehicle_a : "സൈൻ അപ്പ് പ്രക്രിയ പൂർത്തിയാക്കിയ ശേഷം നിങ്ങളുടെ ഫ്ലീറ്റ് ഡാഷ്ബോർഡിലേക്ക് നയിക്കപ്പെടും. <br>1. ഇടത് വശത്തെ പാനലിൽ \"വാഹനങ്ങൾ\" ക്ലിക്ക് ചെയ്യുക <br>2. തുടർന്ന് മുകളിൽ വലത് മൂലയിൽ \"വാഹനം ചേർക്കുക\" ക്ലിക്ക് ചെയ്യുക <br>3. വാഹനം ചേർക്കൽ പ്രക്രിയ പൂർത്തിയാക്കാൻ സ്ക്രീനിലെ നിർദ്ദേശങ്ങൾ പിന്തുടരുക"
    , onboarding_faq_add_multiple_vehicles_q : "എന്റെ ഫ്ലീറ്റിലേക്ക് ഒരേ സമയം ഒന്നിലധികം വാഹനങ്ങൾ ചേർക്കാമോ?"
    , onboarding_faq_add_multiple_vehicles_a : "അതെ, ബൾക്ക് അപ്‌ലോഡിൽ ക്ലിക്ക് ചെയ്ത് ഒന്നിലധികം വാഹനങ്ങൾ ചേർക്കാം. ബൾക്ക് അപ്‌ലോഡ് ടെംപ്ലേറ്റ് (.csv) ഫയൽ റഫർ ചെയ്ത് ഓൺബോർഡ് ചെയ്യേണ്ട വാഹനങ്ങൾ ചേർക്കാം."
    , onboarding_faq_vehicle_documents_q : "വാഹനം ഓൺബോർഡ് ചെയ്യാൻ എന്ത് ഡോക്യുമെന്റുകൾ ആവശ്യമാണ്?"
    , onboarding_faq_vehicle_documents_a : "വാഹനം ഓൺബോർഡ് ചെയ്യാൻ ആവശ്യമായ വാഹന ഡോക്യുമെന്റുകൾ: <br><br>1. രജിസ്ട്രേഷൻ സർട്ടിഫിക്കറ്റ് <br>2. വാഹന പെർമിറ്റ് <br>3. വാഹന PUC സർട്ടിഫിക്കറ്റ് <br>4. വാഹന ഫിറ്റ്നസ് സർട്ടിഫിക്കറ്റ് <br>5. വാഹന ഇൻഷുറൻസ് <br>6. വാഹന ഫോട്ടോകൾ"
    , onboarding_faq_readd_vehicle_q : "ഞാൻ മുമ്പ് ഇല്ലാതാക്കിയ വാഹനം വീണ്ടും ചേർക്കാമോ?"
    , onboarding_faq_readd_vehicle_a : "അതെ, മുമ്പ് ഇല്ലാതാക്കിയ വാഹനം ചേർക്കാം, പക്ഷേ വെരിഫിക്കേഷനായി വാഹന ഡോക്യുമെന്റുകൾ വീണ്ടും അപ്‌ലോഡ് ചെയ്യണം."
    , onboarding_faq_vehicle_inspection_q : "വാഹന പരിശോധന എന്താണ്, എന്തുകൊണ്ട് ഇത് ആവശ്യമാണ്?"
    , onboarding_faq_vehicle_inspection_a : "വാഹന ഓൺബോർഡിംഗ് പൂർത്തിയാക്കാൻ MSIL വാഹന പരിശോധന ഹബ് സന്ദർശിക്കണം. <br><br>പ്രക്രിയയിൽ MSIL ഓൺബോർഡിംഗ് പങ്കാളിയാൽ നയിക്കപ്പെടും."
    , onboarding_faq_inspection_cost_q : "വാഹന പരിശോധനയ്ക്ക് ചിലവ് ഉണ്ടോ?"
    , onboarding_faq_inspection_cost_a : "ഇല്ല, വാഹന പരിശോധന പൂർണ്ണമായും സൗജന്യമാണ്. <br><br>MSIL ഓൺബോർഡിംഗിന്റെ ഭാഗമായി വാഹന പരിശോധന ക്രമീകരിക്കും."
    , onboarding_faq_manage_vehicle_docs_q : "വാഹന ഡോക്യുമെന്റുകൾ എങ്ങനെ നിയന്ത്രിക്കാം?"
    , onboarding_faq_manage_vehicle_docs_a : "ഇടത് വശത്തെ പാനലിൽ നിന്ന് \"വാഹനങ്ങൾ\" ടാബിലേക്ക് പോകുക. ഓരോ വാഹനത്തിനോടൊപ്പം വാഹന ഡോക്സ് കോളത്തിന് കീഴിൽ വാഹന ഡോക്യുമെന്റുകൾ ട്രാക്ക്, കാണ, അപ്ഡേറ്റ് ചെയ്യാം."
    , onboarding_faq_track_vehicle_docs_q : "എന്റെ ഫ്ലീറ്റിലുടനീളം പെൻഡിംഗ് വാഹന ഡോക്യുമെന്റ് അപ്‌ലോഡുകൾ എങ്ങനെ ട്രാക്ക് ചെയ്യാം?"
    , onboarding_faq_track_vehicle_docs_a : "ഇടത് വശത്തെ പാനലിൽ നിന്ന് \"വാഹനങ്ങൾ\" ടാബിലേക്ക് പോകുക. ഓരോ വാഹനത്തിനോടൊപ്പം വാഹന ഡോക്സ് കോളത്തിന് കീഴിൽ വാഹന ഡോക്യുമെന്റുകൾ ട്രാക്ക്, കാണ, അപ്ഡേറ്റ് ചെയ്യാം."
    , onboarding_faq_assign_driver_vehicle_q : "ഒരു പ്രത്യേക ഡ്രൈവറിനെ ഒരു പ്രത്യേക വാഹനത്തിലേക്ക് നിയോഗിക്കാമോ?"
    , onboarding_faq_assign_driver_vehicle_a : "അതെ, ഏത് ഡ്രൈവറിനെയും ഏത് വാഹനത്തിലേക്കും നിയോഗിക്കാം. ഒരേ വാഹനത്തിലേക്ക് ഒന്നിലധികം ഡ്രൈവർമാരെയും നിയോഗിക്കാം."
    , onboarding_faq_remove_vehicle_q : "എന്റെ ഫ്ലീറ്റിൽ നിന്ന് വാഹനം എങ്ങനെ നീക്കം ചെയ്യാം അല്ലെങ്കിൽ ഇല്ലാതാക്കാം?"
    , onboarding_faq_remove_vehicle_a : "വാഹനം നീക്കം ചെയ്യാൻ: <br>1. വാഹന ഡാഷ്ബോർഡിലേക്ക് പോകുക <br>2. വാഹനത്തിന് അടുത്തുള്ള 3 ഡോട്ടുകൾ ക്ലിക്ക് ചെയ്യുക <br>3. ഡ്രോപ് ഡൗണിൽ നിന്ന് \"ഇല്ലാതാക്കുക\" തിരഞ്ഞെടുക്കുക"
    , onboarding_faq_edit_vehicle_q : "നിലവിലുള്ള വാഹനത്തിന്റെ വിവരങ്ങൾ എങ്ങനെ എഡിറ്റ് ചെയ്യാം?"
    , onboarding_faq_edit_vehicle_a : "ഏത് വാഹന വിവരങ്ങളും എഡിറ്റ് ചെയ്യാൻ: <br>1. നിങ്ങളുടെ ഡാഷ്ബോർഡിൽ വാഹനത്തിന് അടുത്തുള്ള 3 ഡോട്ടുകൾ ക്ലിക്ക് ചെയ്യുക <br>2. പോപ്-അപ്പ് മെനുവിൽ നിന്ന് \"എഡിറ്റ്\" തിരഞ്ഞെടുക്കുക <br>3. ആവശ്യമുള്ള വാഹന വിവരങ്ങൾ അപ്ഡേറ്റ് ചെയ്യാം."
    , onboarding_faq_update_driver_status_q : "ഒരു നിശ്ചിത ഡ്രൈവറിന്റെ സ്റ്റാറ്റസ് സജീവ/നിഷ്ക്രിയ ആയി എങ്ങനെ അപ്ഡേറ്റ് ചെയ്യാം?"
    , onboarding_faq_update_driver_status_a : "ഡ്രൈവറിന്റെ സ്റ്റാറ്റസ് അപ്ഡേറ്റ് ചെയ്യാൻ: <br>1. ഡ്രൈവർ ഡാഷ്ബോർഡിലേക്ക് പോകുക <br>2. മാറ്റേണ്ട ഡ്രൈവർ സ്റ്റാറ്റസിന് അടുത്തുള്ള 3 ഡോട്ടുകൾ ക്ലിക്ക് ചെയ്ത് \"എഡിറ്റ്\" തിരഞ്ഞെടുക്കുക <br>3. ഡ്രോപ്ഡൗൺ വഴി സ്റ്റാറ്റസും വാഹന നിയോഗവും അപ്ഡേറ്റ് ചെയ്യുക."
    , contact_hub : "ഹബ് സംയോഗം"
    }
