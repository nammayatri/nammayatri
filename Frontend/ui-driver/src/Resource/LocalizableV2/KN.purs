...
getKn =
  Keymap
    ...
    , blocked_for_variant_rides_till: (\a b c -> a <> " ರೈಡ್‌ಗಳಿಗೆ " <> b <> "," <> c <> "ರವರೆಗೆ ತಡೆಗಟ್ಟಲಾಗಿದೆ")
    , blocked_for_variant_rides_reason: (\a -> "ಹೆಚ್ಚುವರಿ ಭಾಡಿಗೆ ಕುರಿತಾಗಿ ಹಲವಾರು ಗ್ರಾಹಕರ ದೂರುಗಳಿಂದಾಗಿ ನೀವು " <> a <> " ರೈಡ್‌ಗಳಿಗೆ ತಡೆಗಟ್ಟಲ್ಪಟ್ಟಿದ್ದೀರಿ")
    }