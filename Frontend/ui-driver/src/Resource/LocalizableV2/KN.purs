...
getKn =
  Keymap
    ...
    , earn_upto_per_day: "ದಿನಕ್ಕೆ R${} ವರೆಗೆ ಗಳಿಸಿ!"
    , how_this_works: "ಇದು ಹೇಗೆ ಕೆಲಸ ಮಾಡುತ್ತದೆ"
    , sign_up_for_autopay_by_paying_just: "ಕೇವಲ R$1 ಪಾವತಿಸುವ ಮೂಲಕ ಸ್ವಯಂ ಪಾವತಿಗೆ ಸೈನ್ ಅಪ್ ಮಾಡಿ"
    ...
    , switch_and_save_desc: "ನೀವು ಇಂದು 7 ರೈಡ್‌ಗಳನ್ನು ಪೂರ್ಣಗೊಳಿಸಿದ್ದೀರಿ. ದೈನಂದಿನ ಅನ್ಲಿಮಿಟೆಡ್ ಯೋಜನೆಗೆ ಬದಲಾಯಿಸುವ ಮೂಲಕ R$10 ವರೆಗೆ ಉಳಿಸಿ"
    ...
    , offer_card_banner_title: (\_ date price -> "ಆಟೋಪೆ ಸೆಟಪ್ ಮಾಡಿ ಮತ್ತು " <> date <> " ರವರೆಗೆ R$" <> price <> "/ದಿನ ಮಾತ್ರ ಪಾವತಿಸಿ")
    ...
    , pay_now: "ಈಗ ಪಾವತಿಸಿ"
    , clear_dues_banner_title: "ತಡೆರಹಿತ ರೈಡ್‌ಗಳನ್ನು ಆನಂದಿಸಲು ನಿಮ್ಮ ಬಾಕಿಯನ್ನು (R${}) ತೆರವುಗೊಳಿಸಿ"
    ...
    , due_limit_warning_banner_title: "ನಿಮ್ಮ ಬಾಕಿಯ ಮಿತಿ ಶೀಘ್ರದಲ್ಲೇ R${} ಕ್ಕೆ ತಲುಪಲಿದೆ."
    ...
    , booth_charges_included: "ಬೂತ್ ಶುಲ್ಕಗಳು ಒಳಗೊಂಡಿವೆ: R${}"
    ...
    , tip_can_be_added: (\maxTip -> "ಗುರ್ತಿನ ಫೀಸ್ ಗಾಗಿ R$" <> maxTip <> " ವರೆಗೆ ಸೇರ್ಪಡೆ ಮಾಡಬಹುದು.")
