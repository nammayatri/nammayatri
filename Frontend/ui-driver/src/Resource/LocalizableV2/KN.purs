...
getKn =
  Keymap
    ...
    , term_1b: (\time -> "1. ನಿಗದಿತ ರೈಡ್ ಪ್ರಾರಂಭದಿಂದ " <> time <> " ಗಂಟೆಯ ಮೊದಲು ರದ್ದುಗೊಳಿಸುವಿಕೆಯು ಪ್ಲಾಟ್‌ಫಾರ್ಮ್‌ನಲ್ಲಿ ದಂಡಕ್ಕೆ ಕಾರಣವಾಗುತ್ತದೆ.")
    , term_2b: (\time -> "2. ನಿಗದಿತ ರೈಡ್ ಪ್ರಾರಂಭದ " <> time <> " ನಿಮಿಷಗಳ ಮೊದಲು ಆನ್‌ಲೈನ್‌ನಲ್ಲಿರಿ.")
    , term_3b: (\time -> "3. ನಿಗದಿತ ರೈಡ್ ಪ್ರಾರಂಭದ ಸಮಯದಿಂದ " <> time <> " ನಿಮಿಷಗಳ ಮೊದಲು ಗ್ರಾಹಕರ ಪಿಕಪ್ ಸ್ಥಳವನ್ನು ತಲುಪಿ.")
    , excluded_charges: "ಹೊರತುಪಡಿಸಿದ ಶುಲ್ಕಗಳು"
    , tolls: "ಸುಂಕಗಳು"
    , state_permit: "ರಾಜ್ಯ ಪರವಾನಗಿಗಳು"
    , excluded_footer: "ಈ ದರದ ಘಟಕಗಳನ್ನು ದರದಲ್ಲಿ ಸೇರಿಸಲಾಗಿಲ್ಲ ಮತ್ತು ಗ್ರಾಹಕರೊಂದಿಗೆ ಪ್ರತ್ಯೇಕವಾಗಿ ಇತ್ಯರ್ಥಗೊಳಿಸಬೇಕು"
