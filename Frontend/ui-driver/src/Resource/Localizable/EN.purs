...
getEN stringKey =
    case stringKey of
        ...
        FACE_DETECTION_FAILED -> "Face detection failed, Please try again"
        NEED_PERMISSION_TO_ACCESS_CAMERA -> "Need Permission To Access The Camera"
        FACE_NOT_CLEAR -> "Face is not clear"
