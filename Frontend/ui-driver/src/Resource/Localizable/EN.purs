...
getEN stringKey =
    case stringKey of
        ...
        YATRI_POINTS_FAQS_QUES1 _ -> "What are Yatri Points?"
        ...
        YATRI_POINTS_FAQS_QUES3_ANS1 _ -> "Points are earned through day-to-day activities on the app like taking rides, referring customers. You don’t need to do anything different."
        YATRI_POINTS_FAQS_QUES3_ANS2 _ -> "You can earn more points by exhibiting good behavior like low cancellations, getting good ratings from customers, etc."
        ...
        YATRI_POINTS_FAQS_QUES6_ANS1 _ -> "Points are gained or lost for various actions based on the following table:"
