...
getEN stringKey =
    case stringKey of
        ...
        YATRI_COINS_FAQS_QUES1_ANS2 -> "The earned coins can be used to avail benefits like purchasing subscription plans with coins only."
        YATRI_COINS_FAQS_QUES1_ANS3 -> "New benefits will be added in the future."
        ...
        YATRI_COINS_FAQS_QUES5 -> "Is setting up Autopay mandatory for using Yatri Coins?"
        YATRI_COINS_FAQS_QUES5_ANS1 -> "Yes. Setting up Autopay is mandatory for using Yatri Coins."
        YATRI_COINS_FAQS_QUES5_ANS2 -> "However, you can keep earning them even without setting up Autopay"
        YATRI_COINS_FAQS_QUES5_ANS3 -> "The Autopay setup is mandatory only for using the coins."
        YATRI_COINS_FAQS_QUES6 -> "What is the eligibility to earn and use Yatri Coins?"
        YATRI_COINS_FAQS_QUES6_ANS1 -> "You must complete your first ride with Namma Yatri to start earning Yatri Coins."
        YATRI_COINS_FAQS_QUES6_ANS2 -> "The Yatri Coins section will be disabled until you complete your first ride."
        YATRI_COINS_FAQS_QUES7 -> "Some Yatri Coins were deducted from my account without using them. Why?"
        YATRI_COINS_FAQS_QUES7_ANS1 -> "Coins may be deducted when there is undesirable behavior. Examples of undesirable behavior can be bad ratings from the customer, booking cancellation."
