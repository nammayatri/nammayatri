...
getEN stringKey =
    case stringKey of
        ...
        NEED_IT_TO_ENABLE_LOCATION (stringForConfig) -> "Namma Yatri Partner collect location data to enable share your location to monitor driver current location, even when the app is closed or not in use."
        ...
        PAYMENT_PENDING_ALERT_DESC (stringForConfig) -> "To continue taking rides on Namma Yatri, clear your payment dues"
        ...
        HOW_IT_WORKS (stringForConfig) -> "How it works?"
        ...
        VIEW_FAQs -> "View FAQs"
        FIND_HELP_CENTRE (stringForConfig) -> "Find Help Centre"
        CONTACT -> "Contact"
        ...
        SUBSCRIPTION_PLAN_STR (stringForConfig) -> "Subscription Plan"
