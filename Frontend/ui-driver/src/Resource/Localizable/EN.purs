...
getEN stringKey =
    case stringKey of
        ...
        SEVEN_DAY_FREE_TRIAL_ACTIVATED -> "{}-Day FREE TRIAL Activated!"
        TAKE_UNLIMITED_RIDES_FOR_THE_NEXT_SEVEN_DAYS -> "Take unlimited rides for the first {} days"
        ...
        FREE_TRIAL_REMINDER -> "Day {}: FREE TRIAL reminder"
        PLAN_STARTS -> "Day {}: Plan Starts"
