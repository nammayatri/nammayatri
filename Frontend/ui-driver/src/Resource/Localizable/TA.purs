...
getTA stringKey =
    case stringKey of
        ...
        CAPTURE_DOC_DESC_1 -> "உங்கள் வாகனத்தின் {} ஒரு தட்டையான மேற்பரப்பில் தெளிவான படத்தை எடுக்கவும்."
        ...
        CAPTURE_DOC_DESC_3 -> "கீழே காட்டப்பட்டுள்ளபடி, குறிக்கப்பட்ட பகுதியில் வாகனத்தை {} சரியாகப் பொருத்தவும்"
        UPLOAD_DOC -> "பதிவேற்ற {}"
