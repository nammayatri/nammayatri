...
getTA stringKey =
    case stringKey of
        ...
        FACE_DETECTION_FAILED -> "முகம் கண்டறிதல் தோல்வியடைந்தது, மீண்டும் முயற்சிக்கவும்"
        NEED_PERMISSION_TO_ACCESS_CAMERA -> "கேமராவை அணுக அனுமதி தேவை"
        FACE_NOT_CLEAR -> "முகம் தெளிவாக இல்லை"
        MULTIPLE_FACES -> "பல முகங்கள் கண்டறியப்பட்டன"