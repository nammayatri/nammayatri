...
getTA stringKey =
    case stringKey of
        ...
        RIDE_COMPLETE -> "சவாரி முடிந்தது"
        HOW_WAS_YOUR_RIDE_WITH_NAME name -> name <> " உடன் உங்கள் பயணம் எப்படி இருந்தது"
        HAS_PAID_YOU name -> name <> " உங்களுக்கு பணம் கொடுத்துள்ளார்"
