...
, ["TERM_1B", (time) => "1. निर्धारित सवारी शुरू होने से " + time +" घंटे पहले रद्द करने पर प्लेटफॉर्म पर जुर्माना लगाया जाएगा।"]
, ["TERM_2B", (time) => "2. निर्धारित सवारी प्रारंभ होने से " + time +" मिनट पहले ऑनलाइन रहें।"]
, ["TERM_3B", (time) => "3. निर्धारित सवारी प्रारंभ समय से " + time +" मिनट पहले ग्राहक पिकअप स्थान पर पहुंचें।"]
, ["EXCLUDED_CHARGES", "अपवर्जित शुल्क"]
, ["TOLLS", "टोल"]
, ["STATE_PERMIT", "राज्य परमिट"]
, ["EXCLUDED_FOOTER", "ये किराया घटक किराए में शामिल नहीं हैं और इन्हें ग्राहक के साथ अलग से तय किया जाना चाहिए"]
...
, ["CONTINUE_WITH", (text) => text + " के साथ जारी रखें"]
...
, ["PLEASE_BE_ONLINE", (time) => "कृपया"+time+"मिनट के लिए ऑनलाइन रहे"]
...
export const getHiFromJS = (key) => {
  const splitedArr = key.trim().split(',');
  const pattern =  hiMap.get(splitedArr[0].trim());
