...
getBN stringKey =
    case stringKey of
        ...
        REFER -> "উল্লেখ করুন "
        EARN_CASH -> "নগদ টাকা উপার্জন"
        SHARE -> "শেয়ার করুন"
        REFERRED_CUSTOMERS_INFO -> "আপনার দ্বারা রেফার করা গ্রাহকরা যারা সফলভাবে তাদের প্রথম রাইড সম্পূর্ণ করেছেন"
        REFERRED_DRIVERS_INFO -> "আপনার রেফারেল কোড সহ যে সমস্ত ড্রাইভার নম্মা যাত্রীতে উঠেছেন"
        GOT_IT_TEXT -> "বুঝেছি"
        CUSTOMER_TEXT -> "ক্রেতা"
        DRIVER_TEXT -> "ড্রাইভার"
