...
getBN stringKey =
    case stringKey of
        ...
        FACE_DETECTION_FAILED -> "মুখ সনাক্তকরণ ব্যর্থ হয়েছে, অনুগ্রহ করে আবার চেষ্টা করুন"
        NEED_PERMISSION_TO_ACCESS_CAMERA -> "ক্যামেরা অ্যাক্সেস করার জন্য অনুমতি প্রয়োজন"
        FACE_NOT_CLEAR -> "মুখ পরিষ্কার নয়"
        MULTIPLE_FACES -> "একাধিক মুখ সনাক্ত করা হয়েছে"