...
getBN stringKey =
    case stringKey of
        ...
        DESTINATION -> "গন্তব্য"
        YOU_DID_NOT_TAKE_ANY_RIDES_ON_THE_SELECTED_DATE -> "আপনি নির্বাচিত তারিখে কোনো রাইড নেননি"
        CONVERT -> "রূপান্তর"
        ...
        YATRI_COINS_FAQS_QUES1_ANS1 -> "ইয়াত্রী কয়েন হলো সারাদিনের কার্যক্রমে আপনি নাম্মা ইয়াত্রী তে রাইড, রেফারেন্স, ভাল রেটিং ইত্যাদি প্রতি দিন আয় করেন।"
        YATRI_COINS_FAQS_QUES1_ANS2 -> "অর্জিত কয়েন গুলি দিয়ে আপনি সদস্যপণ্য পরিকল্পনার মধ্যে কয়েন দিয়ে উপকার নিতে পারবেন।"
        YATRI_COINS_FAQS_QUES1_ANS3 -> "ভবিষ্যতে নতুন উপকার যোগ হবে।"
        YATRI_COINS_FAQS_QUES2 -> "ইয়াত্রী কয়েনের মেয়াদ কত?"
        YATRI_COINS_FAQS_QUES2_ANS1 -> "ইয়াত্রী কয়েন প্রাপ্তির দিন থেকে 90 দিনের জন্য বৈধ। এই সময়কালে, আপনি কয়েন বৈধতা অবধি উপকার নেতে পারবেন।"
        YATRI_COINS_FAQS_QUES3 -> "আমি কিভাবে ইয়াত্রী কয়েন উপার্জন করতে পারি?"
        YATRI_COINS_FAQS_QUES3_ANS1 -> "রাইড, গ্রাহকের উপার্জনের মধ্যে পাঠানোর মতো আপনি এপ্লিকেশনে সারাদিনের কার্যক্রমের মাধ্যমে কয়েন উপার্জন করতে পারেন। আপনাকে কিছু আলাদা করতে হবে না।"
        YATRI_COINS_FAQS_QUES3_ANS2 -> "আপনি আরও কয়েন আয় করতে পারেন যদি আপনি লো ক্যানসেলেশন, গ্রাহকদের কাছে ভাল রেটিং ইত্যাদি এমন ভাল আচরণ দেখাতে পারেন।"
        YATRI_COINS_FAQS_QUES4 -> "আমি কিভাবে আমার ইয়াত্রী কয়েন ব্যবহার করতে পারি?"
        YATRI_COINS_FAQS_QUES4_ANS1 -> "আপনি আপনার অর্জিত কয়েন বৈধতা অবধি মুফতে সদস্যপণ্য পরিকল্পনা কেনার জন্য ব্যবহার করতে পারেন।"
        YATRI_COINS_FAQS_QUES4_ANS2 -> "ভবিষ্যতে, ইয়াত্রী কয়েন ব্যবহারের জন্য আরও বিকল্প যোগ হবে।"
        YATRI_COINS_FAQS_QUES5 -> "ইয়াত্রী কয়েন ব্যবহার করতে আপোনা অটোপে সেটআপ করা কি অপরিহার্য?"
        YATRI_COINS_FAQS_QUES5_ANS1 -> "হ্যাঁ, ইয়াত্রী কয়েন ব্যবহার করতে অটোপে সেটআপ করা অপরিহার্য।"
        YATRI_COINS_FAQS_QUES5_ANS2 -> "তবে, অটোপে সেটআপ না করেও আপনি তাদের কাছে আর্জিত করতে থাকতে পারেন।"
        YATRI_COINS_FAQS_QUES5_ANS3 -> "সিক্কোগুলি ব্যবহার করার জন্য অটোপে সেটআপ অপরিহার্য মাত্র।"
        YATRI_COINS_FAQS_QUES6 -> "ইয়াত্রী কয়েন উপার্জন এবং ব্যবহার করার জন্য অযোগ্যতা কি?"
        YATRI_COINS_FAQS_QUES6_ANS1 -> "আপনার প্রথম Namma Yatri রাইড সম্পন্ন করতে হবে ইয়াত্রী কয়েন উপার্জন করতে।"
        YATRI_COINS_FAQS_QUES6_ANS2 -> "আপনি যদি আপনার প্রথম রাইড সম্পন্ন না করেন, তবে Yatri Coins বিভাগটি নিষ্ক্রিয় থাকবে যা প্রথম রাইড সম্পন্ন হওয়া পর্যন্ত বন্ধ থাকবে।"
        YATRI_COINS_FAQS_QUES7 -> "কিছু Yatri Coins আমার অ্যাকাউন্ট থেকে ব্যবহার না করে কাটানো হয়েছে। এটির কারণ কি?"
        YATRI_COINS_FAQS_QUES7_ANS1 -> "সিক্কো কাটা হতে পারে যখন অবাঞ্ছনীয় আচরণ থাকে। অবাঞ্ছনীয় আচরণের উদাহরণ"