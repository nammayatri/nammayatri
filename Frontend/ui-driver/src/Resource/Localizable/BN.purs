...
getBN stringKey =
    case stringKey of
        ...
        CAPTURE_DOC_DESC_1 -> "একটি সমতল পৃষ্ঠে আপনার যানবাহনের {} একটি পরিষ্কার ছবি তুলুন।"
        CAPTURE_DOC_DESC_2 -> "নিশ্চিত করুন যে আলো পর্যাপ্ত এবং সমস্ত বিবরণ স্পষ্টভাবে দৃশ্যমান"
        CAPTURE_DOC_DESC_3 -> "নিচে দেখানো হিসাবে সঠিকভাবে চিহ্নিত জায়গায় {} যানবাহন ফিট করুন"
        UPLOAD_DOC -> "আপলোড {}"
