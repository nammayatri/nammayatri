...
getBN stringKey =
    case stringKey of
        ...
        YATRI_COINS_STR -> "ইয়াত্রি কয়েন"
        INTRODUCING_YATRI_COINS -> "ইয়াত্রি কয়েন পরিচয় করানো হচ্ছে"
        NOW_EARN_COINS_FOR_EVERY_RIDE_AND_REFERRAL_AND_USE_THEM_TO_GET_REWARDS _ -> "এখন প্রতিটি রাইড এবং রেফারেলের জন্য কয়েন উপার্জন করুন এবং তাদের ব্যবহার করুন পুরস্কার পেতে"
        PAID_BY_YATRI_COINS -> "ইয়াত্রি কয়েন দ্বারা পরিশোধিত"
        YATRI_COINS_USAGE_POPUP _ -> "ইয়াত্রি কয়েনগুলি আপনার সাবস্ক্রিপশন পরিকল্পনার বিরুদ্ধে আপনি উপভোগ করতে পারেন ছাড়।"
        USE_COINS_NOW -> "এখন কয়েন ব্যবহার করুন"
        BUY_NOW -> "এখন কিনুন"
        SELECT_DATE -> "তারিখ নির্বাচন করুন"
        WHAT_WILL_MY_COINS_BE_CONVERTED_TO -> "আমার কয়েন কীভাবে রূপান্তরিত হবে?"
        COINS_EXPIRING_IN_THE_NEXT -> "পরবর্তী"
        DAYS_USE_THEM_BEFORE_THEY_EXPIRE -> "দিনের মধ্যে কয়েন ব্যবহার করুন"
        COINS_EXPIRING -> "কয়েন মেয়াদ শেষ হচ্ছে"
        NO_COINS_AVAILABLE -> "কোন কয়েন উপলব্ধ নেই"
        FAILED_TO_USE_COINS_PLEASE_TRY_AGAIN_LATER -> "কয়েন ব্যবহার করতে ব্যর্থ হয়েছে, পরে আবার চেষ্টা করুন"
        ...
        VIEW_MORE -> "আরও দেখুন"
        MINIMUM -> "ন্যূনতম"
        COINS_IS_REQUIRED_FOR_CONVERSION -> "কয়েন রূপান্তরের জন্য প্রয়োজন"
        DISCOUNT -> "ছাড়"
        CHECK_NOW -> "এখনই চেক করুন"
        COIN_BALANCE -> "কয়েন অবশিষ্ট"
        COINS_BALANCE -> "কয়েন অবশিষ্ট"
        TOTAL_EARNED -> "মোট অর্জিত"
        RIDE_HISTORY -> "যাত্রার ইতিহাস"
        TRANSACTION_HISTORY -> "আপনি কি আমার সাথে কি করতে চান"
        COINS_EARNED -> "অর্জিত মুদ্রা"
        NO_RIDES -> "ব্যবহৃত মুদ্রা"
        COINS_USED -> "ব্যবহৃত মুদ্রা"
        USE_COINS -> "কয়েন ব্যবহার করুন"
        INSIGHTS -> "অন্তর্দৃষ্টি"
        USAGE_HISTORY -> "ব্যবহারের ইতিহাস"
        NO_COINS_EARNED -> "কোন কয়েন অর্জিত"
        NO_COINS_USED -> "কোন কয়েন ব্যবহার করা হয় না"
        EARN_COINS_BY_TAKING_RIDES_AND_REFERRING_THE_APP_TO_OTHERS _ -> "রাইড নিয়ে এবং অন্যদের কাছে অ্যাপটি উল্লেখ করে কয়েন উপার্জন করুন"
        ...
        COMPLETE_FIRST_RIDE_TO_UNLOCK_COINS -> "কয়েন আনলক করতে প্রথম রাইড সম্পূর্ণ করুন"
        DESTINATION -> "গন্তব্য"
        YOU_DID_NOT_TAKE_ANY_RIDES_ON_PREFIX -> "আপনি"
        YOU_DID_NOT_TAKE_ANY_RIDES_ON_SUFFIX -> "-এ কোনো রাইড নেননি"
        CONVERT -> "রূপান্তর"
        CONVERT_COINS -> "কয়েন রূপান্তর"
        ...
        USING_COINS_REQUIRES_AN_ACTIVE_PLAN -> "কয়েন ব্যবহার করার জন্য একটি সক্রিয় পরিকল্পনা প্রয়োজন।"
        TO_GET_STARTED -> "শুরু করতে"
        CONVERTED_FROM_COINS -> "মুদ্রা থেকে রূপান্তরিত"
        YATRI_COINS_FAQS  -> "ইয়াত্রি কয়েন সাধারণ প্রশ্ন"
        LEARN_ABOUT_YATRI_COINS  -> "ইয়াত্রি কয়েন সম্পর্কে জানুন"
        YATRI_COINS_FAQS_QUES1 _ -> "ইয়াত্রী কয়েন কি?"
        YATRI_COINS_FAQS_QUES1_ANS1 _ -> "Yatri Coins হল সেই পুরস্কার যা আপনি নম্মা যাত্রীতে প্রতিদিনের কার্যকলাপ যেমন রাইড, রেফারেল, ভাল রেটিং ইত্যাদিতে উপার্জন করেন।"
        YATRI_COINS_FAQS_QUES1_ANS2 _ -> "অর্জিত কয়েন ডিসকাউন্ট পেতে ব্যবহার করা যেতে পারে (উদাহরণ: কয়েন ব্যবহার করে সাবস্ক্রিপশন প্ল্যান কেনার ক্ষেত্রে ডিসকাউন্ট)"
        YATRI_COINS_FAQS_QUES1_ANS3 _ -> "প্রতিটি যাত্রী কয়েনকে রূপান্তরিত করা যাবে টাকা ছাড়ে। 0.10 এবং সাবস্ক্রিপশন প্ল্যানে ডিসকাউন্ট পাওয়ার জন্য ব্যবহার করা যেতে পারে। ডিসকাউন্ট পাওয়ার আরও সুযোগ ভবিষ্যতে যোগ করা হবে"
        YATRI_COINS_FAQS_QUES2 _ -> "ইয়াত্রি কয়েনের বৈধতা কী?"
        YATRI_COINS_FAQS_QUES2_ANS1 days -> "যাত্রী কয়েন যেদিন থেকে উপার্জন করা হয় সেই দিন থেকে "<> days <>" দিনের জন্য বৈধ। এই সময়ের মধ্যে, আপনি সুবিধা পাওয়ার জন্য কয়েন ব্যবহার করতে পারেন।"
        YATRI_COINS_FAQS_QUES2_ANS2 days -> "যাত্রী কয়েন "<> days <>" দিনের মধ্যে খালাস না হলে বাজেয়াপ্ত করা হয়"
        YATRI_COINS_FAQS_QUES3 _ -> "আমি কিভাবে ইয়াত্রী কয়েন উপার্জন করতে পারি?"
        YATRI_COINS_FAQS_QUES3_ANS1 _ -> "অ্যাপে প্রতিদিনের ক্রিয়াকলাপের মাধ্যমে কয়েনগুলি উপার্জন করা হয় যেমন রাইড করা, গ্রাহকদের উল্লেখ করা। আপনার আলাদা কিছু করার দরকার নেই।"
        YATRI_COINS_FAQS_QUES3_ANS2 _ -> "কম বাতিলকরণ, গ্রাহকদের কাছ থেকে ভাল রেটিং পাওয়া ইত্যাদির মতো ভাল আচরণ প্রদর্শন করে আপনি আরও কয়েন উপার্জন করতে পারেন।"
        YATRI_COINS_FAQS_QUES4 _ -> "আমি যে ইয়াট্রি কয়েন অর্জন করেছি তা আমি কীভাবে ব্যবহার করতে পারি?"
        YATRI_COINS_FAQS_QUES4_ANS1 _ -> "আপনি বৈধতার মেয়াদের মধ্যে বিনামূল্যের সাবস্ক্রিপশন প্ল্যান ক্রয় করতে অর্জিত কয়েন ব্যবহার করতে পারেন।"
        YATRI_COINS_FAQS_QUES4_ANS2 _ -> "ভবিষ্যতে, ইয়াট্রি কয়েন ব্যবহারের জন্য আরও বিকল্প যোগ করা হবে।"
        YATRI_COINS_FAQS_QUES4_ANS3 _ -> "যাত্রী কয়েন ডিসকাউন্ট পাওয়া ছাড়া অন্য কোনো উদ্দেশ্যে ব্যবহার করা যাবে না"
        YATRI_COINS_FAQS_QUES5 _ -> "ইয়াট্রি কয়েন উপার্জন এবং ব্যবহার করার যোগ্যতা কি?"
        YATRI_COINS_FAQS_QUES5_ANS1 _ -> "যাত্রী কয়েন উপার্জন শুরু করতে আপনাকে অবশ্যই নম্মা যাত্রীর সাথে আপনার প্রথম যাত্রা সম্পূর্ণ করতে হবে।"
        YATRI_COINS_FAQS_QUES5_ANS2 _ -> "আপনি আপনার প্রথম রাইড সম্পূর্ণ না করা পর্যন্ত Yatri Coins বিভাগটি নিষ্ক্রিয় থাকবে।"
        YATRI_COINS_FAQS_QUES6 _ -> "আমি বিভিন্ন কর্মের জন্য কত মুদ্রা লাভ বা হারাতে পারি?"
        YATRI_COINS_FAQS_QUES6_ANS1 _ -> "নিম্নলিখিত টেবিলের উপর ভিত্তি করে বিভিন্ন ক্রিয়াকলাপের জন্য কয়েনগুলি অর্জিত বা হারিয়ে যায়:"
        ...
        KNOW_ABOUT_COINS -> "কয়েন সম্পর্কে জানুন"
        NOT_ENOUGH_COINS_DESCRIPTION -> "আপনার পর্যাপ্ত কয়েন ব্যালেন্স নেই। অনুগ্রহ করে রূপান্তর করার কম মান নির্বাচন করুন"
        SHARE -> "শেয়ার"
        ...
        RIDE_TOLL_FARE_INCLUDES -> "টোল চার্জ অন্তর্ভুক্ত"
        ...
        RIDE_MORE_AND_EARN_COINS -> "আরও রাইড করুন এবং কয়েন আর্ন করুন"
        RIDE_MORE_EARN_MORE -> "আরও বেশি চড়ুন, আরও বেশি উপার্জন করুন!"
        TAKE_MORE_RIDES_TO_EARN_MORE_COINS_AND_CONVERT_IT_TO_SUBSCRIPTION_DISCOUNTS -> "সাবস্ক্রিপশন ফি ছাড়ের জন্য কয়েন ব্যবহার করা যেতে পারে।"
        CHECK_YATRI_COINS -> "যাত্রী কয়েন চেক করুন"
        TWO_MORE_RIDES_TO_GO -> "দুটি আরও রাইড বাকি আছে"
        TAKE_TWO_MORE_RIDES_TO_EARN_COINS coinValue -> "আরও দুটি রাইড নিন এবং " <> coinValue <> " কয়েন আর্ন করুন"
        ONE_MORE_RIDE_TO_GO -> "একটি আরও রাইড বাকি আছে"
        TAKE_ONE_MORE_RIDE_TO_EARN_COINS coinValue -> "একটি আরও রাইড নিন এবং " <> coinValue <> " কয়েন আর্ন করুন"
        CONGRATULATIONS -> "অভিনন্দন"
        YOU_HAVE_EARNED_COINS_FOR_COMPLETING_EIGHT_RIDES coinValue -> "আপনি আটটি রাইড সম্পন্ন করার জন্য " <> coinValue <> " কয়েন আর্ন করেছেন"
        REFER_NAMMA_YATRI_APP_TO_CUSTOMERS_AND_EARN_COINS _ -> "গ্রাহকদের নাম্মা ইয়াত্রী অ্যাপ উল্লেখ করুন এবং কয়েন আর্ন করুন"
