...
import Prelude 
import Language.Types2 (getJSKey)

foreign import getBnFromJS :: String -> String

getBN :: STR -> String
getBN stringKey = getBnFromJS $ getJSKey stringKey
    -- case stringKey of
    ...
    --     TERM_1B time-> "1. নির্ধারিত রাইড শুরুর " <> time <>" ঘন্টা আগে বাতিল করলে প্ল্যাটফর্মে জরিমানা করা হবে।"
    --     TERM_2B time-> "2. নির্ধারিত রাইড শুরুর " <> time <>" মিনিট আগে অনলাইনে থাকুন।"
    --     TERM_3B time-> "3. নির্ধারিত রাইড শুরুর সময় থেকে " <> time <>" মিনিটের আগে গ্রাহক পিকআপ অবস্থানে পৌঁছান।"        
    ...
    --     PLEASE_BE_ONLINE time  -> "অনুগ্রহ করে"<>time<>"মিনিট অনলাইনে থাকুন"
