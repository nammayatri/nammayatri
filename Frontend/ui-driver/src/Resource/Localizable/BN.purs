...
getBN stringKey =
    case stringKey of
        ...
        FREE_TRIAL_ENDING_IN_N_DAYS days -> "বিনামূল্যে ট্রায়াল "<> days <>" দিনের মধ্যে শেষ!"
        ...
        N_FREE_RIDES_COMPLETED n -> n <> " ফ্রি রাইড সম্পন্ন হয়েছে"
        N_MORE_FREE_RIDES n -> n <> " আরও ফ্রি রাইড বাকি!"
