...
getBN stringKey =
    case stringKey of
        ...
        VEHICLE_REGISTRATION_NUMBER _-> "যানবাহন রেজিস্ট্রেশন সার্টিফিকেট নম্বর"
        RE_ENTER_VEHICLE_REGISTRATION_NUMBER _ -> "যানবাহন রেজিস্ট্রেশন সার্টিফিকেট নম্বর পুনরায় লিখুন"
        ...
        AND -> " এবং "
        DIRECT_PAYMENT_NO_COMMISSIONS _-> "সরাসরি অর্থপ্রদান।\nকোন কমিশন নেই"
        CUSTOMER_PAYS_DIRECTLY _-> "গ্রাহক আপনাকে সরাসরি \nনগদ বা UPI এর মাধ্যমে অর্থ প্রদান করে"
        HUNDRED_PERCENT_FARE_GOES_TO_YOU _-> "ভাড়ার 100%\nআপনার কাছে যাবে!"
        FARE_SHOWN_IS_FARE_YOU_GET _ -> "দেখানো ভাড়া হল আপনি যে ভাড়া পাবেন।\nকোন লুকানো চার্জ নেই।"
        BE_A_PART_OF_OPEN_MOBILITY_REVOLUTION _ -> "ওপেন মোবিলিটি রেভোলিউশনের অংশ হোন\n!"
        OUR_DATA_AND_PRODUCT_ARE_TRANSPARENT _ -> "আমাদের ডেটা এবং পণ্যের রোডম্যাপ\nসকলের জন্য স্বচ্ছ৷"
        ...
        ONLY_5_MORE_RIDES_FOR_100_POINTS -> "শুধুমাত্র 5 টি আরও রাইড নিন এবং 100 পয়েন্ট পান"
        ONLY_3_MORE_RIDES_FOR_50_POINTS -> "শুধুমাত্র ৩ টি আরও রাইড নিন এবং 40 পয়েন্ট পান"
        ...
        LIMITED_TIME_OFFER_UNTIL_JUNE_30 -> "জুন ৩০ পর্যন্ত সীমিত সময়ের অফার"
        ...
        YOU_ARE_ON_A_INTERCITY_RIDE -> "আপনি ইন্টারসিটি রাইডে আছেন |"
        YOU_CAN_DESCRIBE_THE_ISSUE_YOU_FACED_HERE -> "আপনি এখানে যে সমস্যার সম্মুখীন হয়েছেন তা বর্ণনা করতে পারেন"
        PLEASE_ENTER_A_VALID_EMAIL -> "আপনার ইমেল আইডি"
        SUBMIT_REQUEST -> "অনুরোধ জমা দিন"
        DEL_ACCOUNT -> "অ্যাকাউন্ট মুছুন"
