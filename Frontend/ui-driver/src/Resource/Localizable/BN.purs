...
getBN stringKey =
    case stringKey of
        ...
        REGISTERED_ADDRESS_DESCRIPTION _ ->  "স্ট্যালিয়ন বিজনেস সেন্টার, নং 444, 3য় এবং 4র্থ তলা, 18 তম প্রধান, 6 তম ব্লক, কোরামঙ্গলা, বেঙ্গালুরু, কর্ণাটক- 560095, ভারত"
        ...
        NOW_EARN_COINS_FOR_EVERY_RIDE_AND_REFERRAL_AND_USE_THEM_TO_GET_REWARDS -> "এখন প্রতিটি রাইড এবং রেফারেলের জন্য কয়েন উপার্জন করুন এবং তাদের ব্যবহার করুন পুরস্কার পেতে"
        PAID_BY_YATRI_COINS -> "ইয়াত্রি কয়েন দ্বারা পরিশোধিত"
        YATRI_COINS_USAGE_POPUP -> "ইয়াত্রি কয়েনগুলি আপনার সাবস্ক্রিপশন পরিকল্পনার বিরুদ্ধে আপনি উপভোগ করতে পারেন ছাড়।"
        ...
        EARN_COINS_BY_TAKING_RIDES_AND_REFERRING_THE_APP_TO_OTHERS -> "রাইড নিয়ে এবং অন্যদের কাছে অ্যাপটি উল্লেখ করে কয়েন উপার্জন করুন"
        ...
        CHOOSE_A_PLAN_TO_GET_STARTED -> "শুরু করার জন্য একটি পরিকল্পনা চয়ন করুন!"
        ...
        YATRI_COINS_FAQS_QUES1 -> "ইয়াত্রী কয়েন কি?"
        YATRI_COINS_FAQS_QUES1_ANS1 -> "Yatri Coins হল সেই পুরস্কার যা আপনি নম্মা যাত্রীতে প্রতিদিনের কার্যকলাপ যেমন রাইড, রেফারেল, ভাল রেটিং ইত্যাদিতে উপার্জন করেন।"
        YATRI_COINS_FAQS_QUES1_ANS2 -> "অর্জিত কয়েন ডিসকাউন্ট পেতে ব্যবহার করা যেতে পারে (উদাহরণ: কয়েন ব্যবহার করে সাবস্ক্রিপশন প্ল্যান কেনার ক্ষেত্রে ডিসকাউন্ট)"
        ...
        YATRI_COINS_FAQS_QUES2 -> "ইয়াত্রি কয়েনের বৈধতা কী?"
        YATRI_COINS_FAQS_QUES2_ANS1 -> "যাত্রী কয়েন যেদিন থেকে উপার্জন করা হয় সেই দিন থেকে 90 দিনের জন্য বৈধ। এই সময়ের মধ্যে, আপনি সুবিধা পাওয়ার জন্য কয়েন ব্যবহার করতে পারেন।"
        YATRI_COINS_FAQS_QUES2_ANS2 -> "যাত্রী কয়েন 90 দিনের মধ্যে খালাস না হলে বাজেয়াপ্ত করা হয়"
        YATRI_COINS_FAQS_QUES3 -> "আমি কিভাবে ইয়াত্রী কয়েন উপার্জন করতে পারি?"
        YATRI_COINS_FAQS_QUES3_ANS1 -> "অ্যাপে প্রতিদিনের ক্রিয়াকলাপের মাধ্যমে কয়েনগুলি উপার্জন করা হয় যেমন রাইড করা, গ্রাহকদের উল্লেখ করা। আপনার আলাদা কিছু করার দরকার নেই।"
        YATRI_COINS_FAQS_QUES3_ANS2 -> "কম বাতিলকরণ, গ্রাহকদের কাছ থেকে ভাল রেটিং পাওয়া ইত্যাদির মতো ভাল আচরণ প্রদর্শন করে আপনি আরও কয়েন উপার্জন করতে পারেন।"
        YATRI_COINS_FAQS_QUES4 -> "আমি যে ইয়াট্রি কয়েন অর্জন করেছি তা আমি কীভাবে ব্যবহার করতে পারি?"
        YATRI_COINS_FAQS_QUES4_ANS1 -> "আপনি বৈধতার মেয়াদের মধ্যে বিনামূল্যের সাবস্ক্রিপশন প্ল্যান ক্রয় করতে অর্জিত কয়েন ব্যবহার করতে পারেন।"
        YATRI_COINS_FAQS_QUES4_ANS2 -> "ভবিষ্যতে, ইয়াট্রি কয়েন ব্যবহারের জন্য আরও বিকল্প যোগ করা হবে।"
        YATRI_COINS_FAQS_QUES4_ANS3 -> "যাত্রী কয়েন ডিসকাউন্ট পাওয়া ছাড়া অন্য কোনো উদ্দেশ্যে ব্যবহার করা যাবে না"
        YATRI_COINS_FAQS_QUES5 -> "ইয়াট্রি কয়েন উপার্জন এবং ব্যবহার করার যোগ্যতা কি?"
        YATRI_COINS_FAQS_QUES5_ANS1 -> "যাত্রী কয়েন উপার্জন শুরু করতে আপনাকে অবশ্যই নম্মা যাত্রীর সাথে আপনার প্রথম যাত্রা সম্পূর্ণ করতে হবে।"
        YATRI_COINS_FAQS_QUES5_ANS2 -> "আপনি আপনার প্রথম রাইড সম্পূর্ণ না করা পর্যন্ত Yatri Coins বিভাগটি নিষ্ক্রিয় থাকবে।"
        YATRI_COINS_FAQS_QUES6 -> "আমি বিভিন্ন কর্মের জন্য কত মুদ্রা লাভ বা হারাতে পারি?"
        YATRI_COINS_FAQS_QUES6_ANS1 -> "নিম্নলিখিত টেবিলের উপর ভিত্তি করে বিভিন্ন ক্রিয়াকলাপের জন্য কয়েনগুলি অর্জিত বা হারিয়ে যায়:"
