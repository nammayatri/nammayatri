...
getBN stringKey =
    case stringKey of
        ...
        NEED_IT_TO_ENABLE_LOCATION (stringForConfig) -> "জাটি সাথি ড্রাইভার ড্রাইভারের বর্তমান অবস্থান নিরীক্ষণের জন্য আপনার অবস্থানটি ভাগ করে নিতে সক্ষম করতে অবস্থানের ডেটা সংগ্রহ করে, এমনকি অ্যাপটি বন্ধ থাকলেও বা ব্যবহার না করা হয়।"
        ...
        PAYMENT_PENDING_ALERT_DESC (stringForConfig) -> "নম্মা যাত্রীতে রাইড চালিয়ে যেতে, আপনার পেমেন্ট বকেয়া পরিশোধ করুন"
        ...
        HOW_IT_WORKS (stringForConfig) -> "কিভাবে এটা কাজ করে"
        ...
        GET_SPECIAL_OFFERS (stringForConfig) -> "বিশেষ অফার পান"
        ...
        FIND_HELP_CENTRE (stringForConfig) -> "সহায়তা কেন্দ্র খুঁজুন"
        CONTACT -> "যোগাযোগ"
        ...
        SUBSCRIPTION_PLAN_STR (stringForConfig) -> "সাবস্ক্রিপশন প্ল্যান"
