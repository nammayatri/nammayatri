...
getStringFromEnum key = case key of
    ...
    CLICK_TO_ADD_PROFILE_PICTURE -> "CLICK_TO_ADD_PROFILE_PICTURE"
    ADD_PROFILE_PHOTO -> "ADD_PROFILE_PHOTO"
    TAKE_PHOTO -> "TAKE_PHOTO"
    TAKE_SELFIE -> "TAKE_SELFIE"
    YOUR_PHOTO_WILL_HELP_US_TO_VERIFY_IDENTITY -> "YOUR_PHOTO_WILL_HELP_US_TO_VERIFY_IDENTITY"
    CONFIRM_SELFIE -> "CONFIRM_SELFIE"
    RETAKE_SELFIE -> "RETAKE_SELFIE"
    CONFIRM_AND_UPLOAD -> "CONFIRM_AND_UPLOAD"
    SELFIE_VERIFIED -> "SELFIE_VERIFIED"
    PLEASE_RETAKE_SELFIE -> "PLEASE_RETAKE_SELFIE"
    PROFILE_PICTURE_ADDED_SUCCESSFULLY -> "PROFILE_PICTURE_ADDED_SUCCESSFULLY"
    PROFILE_PICTURE_UPDATED_SUCCESSFULLY -> "PROFILE_PICTURE_UPDATED_SUCCESSFULLY"
