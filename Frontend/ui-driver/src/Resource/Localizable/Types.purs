...
data STR = LETS_GET_STARTED
        ...
        | EARN_ADDITIONAL_MONEY_WITH_PET_AUTOS
        | GET_RIDES_FROM_USERS_TRAVELLING_WITH_PETS
        | OPT_OUT
        | ARE_YOU_SURE_YOU_WANT_TO_OPT_OUT
        | YOU_CAN_ALWAYS_GO_BACK_AND_CHANGE_THIS_FROM_RIDE_PREFERENCES
