...
data STR = LETS_GET_STARTED
        ...
        | RIDE_ENSURED_AT_NO_EXTRA_COST
        | POLICY_NUMBER     
        | SUM_INSURED      
        | GENERATING_YOUR_POLICY      
        | PLEASE_TRY_AGAIN_IN_SOME_TIME      
        | POLICY_GENERATE_ONCE_RIDE_START      
        | THIS_RIDE_IS_ENSURED_FOR_FREE      
        | THIS_RIDE_COME_WITH_COMPLIMENTARY_INSURANCE      
        ...
        | PET_RIDES
        | THANKS_FOR_ACCEPTING_PET_RIDE
        | CLEAN_THE_VEHICLE_AFTER_RIDE_IF_NEEDED
        | THE_CUSTOMER_IS_RESPONSIBLE_FOR_PET
        | YOU_MAY_LOSE_SOME_COINS_IF_YOU_CANCEL_THIS_RIDE
        | CANCELLATION_COMPENSATION
        | CANCELLATION_PENALISATON
        | YOU_ARE_IN_PROBATION_PERIOD_TILL String
        | METRO
