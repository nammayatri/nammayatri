...
data STR = LETS_GET_STARTED
        ...
        | REFER_CUSTOMERS_TO_ENTER_RANKINGS
        | ACTIVE_STRING
        | VIEW_ALL_RANKINGS
        | LEARN_MORE
        | NOT_AVAILABLE_YET
        ...
        | JOIN_THE_REFERRAL_PROGRAM
        | START_TAKING_RIDES_AND_REFER_CUSTOMERS_TO_JOIN_NAMMA_YATRI
        | APP_QR_CODE
...
getStringFromEnum key = case key of
    ...
    REFER_CUSTOMERS_TO_ENTER_RANKINGS -> "REFER_CUSTOMERS_TO_ENTER_RANKINGS"
    ACTIVE_STRING -> "ACTIVE"
    VIEW_ALL_RANKINGS -> "VIEW_ALL_RANKINGS"
    LEARN_MORE -> "LEARN_MORE"
    NOT_AVAILABLE_YET -> "NOT_AVAILABLE_YET"
    YOUR_RANK -> "YOUR_RANK"
    GET_MY_REFERRAL_CODE -> "GET_MY_REFERRAL_CODE"
    RIDE_LEADERBOARD -> "RIDE_LEADERBOARD"
    REFERRAL_LEADERBOARD -> "REFERRAL_LEADERBOARD"
    JOIN_THE_REFERRAL_PROGRAM -> "JOIN_THE_REFERRAL_PROGRAM"
    START_TAKING_RIDES_AND_REFER_CUSTOMERS_TO_JOIN_NAMMA_YATRI -> "START_TAKING_RIDES_AND_REFER_CUSTOMERS_TO_JOIN_NAMMA_YATRI"
    APP_QR_CODE -> "APP_QR_CODE"
    DOWNLOAD_NAMMA_YATRI -> "DOWNLOAD_NAMMA_YATRI"
