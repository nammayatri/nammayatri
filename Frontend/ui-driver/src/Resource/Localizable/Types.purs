...
data STR = LETS_GET_STARTED
        ...
        | VERIFIED_LINKED_WITH_NAME String
        | VISIT_YOUR_NEAREST_HUB_TO_COMPLETE_A_SHORT_VEHICLE_INSPECTION_TO_START_EARNING_WITH_US
        | YOU_WILL_BE_CONTACTED_BY_YOUR_SELECTED_HUB_WITHIN_24_HOURS
        | OPERATOR_REFERRAL_CODE_APPLIED
        | GOT_AN_OPERATOR_REFERRAL_CODE
        | LOCATE_ON_MAP_STR
        | CONTACT_NUMBER
        | ADDRESS
        | VEHICLE_PHOTOS_STR
        | OPERATION_HUB_STR
        | TAKE_A_CLEAR_PICTURE_OF_THE_VEHICLE_FROM_THE_SUGGESTED_ANGLES
        | TAKE_A_CLEAR_SELFIE_WITH_YOUR_FACE_INSIDE_THE_MARKED_AREA
        | ENSURE_ONLY_YOUR_VEHICLE_IS_IN_THE_FRAME_WHEN_UPLOADING
        | ONLY_YOUR_FACE_SHOULD_BE_IN_THE_FRAME_WHEN_UPLOADING_THE_IMAGE
        | FULL_VIEW
        | AVOID_PEOPLE
        | CROPPED_AREA
        | INSIDE_MARKED_AREA
        ...
        | FRONT_INTERIOR
        | REAR_INTERIOR
        | ENTER_THE_CODE_SHARED_WITH_YOU_BY_THE_OPERATIONS_AGENT_DURING_ONBOARDING
        | REGISTER_YOUR_PROFILE
        | REGISTRATION_COMPLETED
        | WE_WILL_NOFITY_YOU_WHEN_WE_GO_LIVE
        | UPLOAD_AGAIN
        | SELECT_OPERATION_HUB
        | HELP_CENTRE
        | ALL_TIME
        | SUBSCRIPTION_AMOUNT_SPENT
        | RIDE_BOOST_RECEIVED
        | CANCELLATION_CHARGES_RECEIVED
        | TODAYS
        ...
        | ELIGIBILITY_CRITERIA_FOR_RC
        | CAR_MUST_BE_LESS_THAN_3_YEARS_OLD
        | CAR_MUST_BE_SEDAN_VEHICLE
        | UPDATED_AT
        | TRIP_COUNT
        | TODAYS_EARNINGS
        | TODAYS_EARNINGS_STR
        ...
        | BY_CLICKING_THIS_YOU_WILL_BE_AGREEING_TO_OUR
        ...
        | COMPLETE_THE_STEPS_TO_START_EARNING
        | COMPLETE
        | HOW_TO_UPLOAD
        ...
        | BUS__
        | DRIVER_UNSUBSCRIBED
        | ONBOARDING_FAQ_SETTING_UP_ACCOUNT
        | ONBOARDING_FAQ_MANAGING_ACCOUNT
        | ONBOARDING_FAQ_ADDING_MANAGING_DRIVERS
        | ONBOARDING_FAQ_ADDING_MANAGING_VEHICLES
        | ONBOARDING_FAQ_MAPPING_DRIVERS_VEHICLES
        | ONBOARDING_FAQ_REGISTER_FLEET_OPERATOR_Q
        | ONBOARDING_FAQ_REGISTER_FLEET_OPERATOR_A
        | ONBOARDING_FAQ_CHOOSE_LANGUAGE_Q
        | ONBOARDING_FAQ_CHOOSE_LANGUAGE_A
        | ONBOARDING_FAQ_SIGNUP_EMAIL_Q
        | ONBOARDING_FAQ_SIGNUP_EMAIL_A
        | ONBOARDING_FAQ_OTP_ISSUE_Q
        | ONBOARDING_FAQ_OTP_ISSUE_A
        | ONBOARDING_FAQ_INDIVIDUAL_BUSINESS_FLEET_Q
        | ONBOARDING_FAQ_INDIVIDUAL_BUSINESS_FLEET_A
        | ONBOARDING_FAQ_REGISTRATION_DETAILS_Q
        | ONBOARDING_FAQ_REGISTRATION_DETAILS_A
        | ONBOARDING_FAQ_OPERATING_CITIES_Q
        | ONBOARDING_FAQ_OPERATING_CITIES_A
        | ONBOARDING_FAQ_OPERATOR_REFERRAL_CODE_Q
        | ONBOARDING_FAQ_OPERATOR_REFERRAL_CODE_A
        | ONBOARDING_FAQ_REQUIRED_DOCUMENTS_Q
        | ONBOARDING_FAQ_REQUIRED_DOCUMENTS_A
        | ONBOARDING_FAQ_REGISTRATION_ASSISTANCE_Q
        | ONBOARDING_FAQ_REGISTRATION_ASSISTANCE_A
        | ONBOARDING_FAQ_UPDATE_DOCUMENTS_Q
        | ONBOARDING_FAQ_UPDATE_DOCUMENTS_A
        | ONBOARDING_FAQ_VIEW_PROFILE_Q
        | ONBOARDING_FAQ_VIEW_PROFILE_A
        | ONBOARDING_FAQ_LOGOUT_Q
        | ONBOARDING_FAQ_LOGOUT_A
        | ONBOARDING_FAQ_PROFILE_PICTURE_Q
        | ONBOARDING_FAQ_PROFILE_PICTURE_A
        | ONBOARDING_FAQ_MSIL_PROVIDE_DRIVERS_Q
        | ONBOARDING_FAQ_MSIL_PROVIDE_DRIVERS_A
        | ONBOARDING_FAQ_ADD_MULTIPLE_DRIVERS_Q
        | ONBOARDING_FAQ_ADD_MULTIPLE_DRIVERS_A
        | ONBOARDING_FAQ_ONBOARD_DRIVER_Q
        | ONBOARDING_FAQ_ONBOARD_DRIVER_A
        | ONBOARDING_FAQ_ADD_DRIVER_MANUALLY_Q
        | ONBOARDING_FAQ_ADD_DRIVER_MANUALLY_A
        | ONBOARDING_FAQ_DRIVER_BULK_UPLOAD_Q
        | ONBOARDING_FAQ_DRIVER_BULK_UPLOAD_A
        | ONBOARDING_FAQ_DRIVER_DOCUMENTS_Q
        | ONBOARDING_FAQ_DRIVER_DOCUMENTS_A
        | ONBOARDING_FAQ_DRIVER_TAB_Q
        | ONBOARDING_FAQ_DRIVER_TAB_A
        | ONBOARDING_FAQ_TRACK_DRIVER_DOCS_Q
        | ONBOARDING_FAQ_TRACK_DRIVER_DOCS_A
        | ONBOARDING_FAQ_ADD_REMOVE_DRIVERS_Q
        | ONBOARDING_FAQ_ADD_REMOVE_DRIVERS_A
        | ONBOARDING_FAQ_MANAGE_DRIVER_DOCS_Q
        | ONBOARDING_FAQ_MANAGE_DRIVER_DOCS_A
        | ONBOARDING_FAQ_ONBOARD_VEHICLE_Q
        | ONBOARDING_FAQ_ONBOARD_VEHICLE_A
        | ONBOARDING_FAQ_ADD_MULTIPLE_VEHICLES_Q
        | ONBOARDING_FAQ_ADD_MULTIPLE_VEHICLES_A
        | ONBOARDING_FAQ_VEHICLE_DOCUMENTS_Q
        | ONBOARDING_FAQ_VEHICLE_DOCUMENTS_A
        | ONBOARDING_FAQ_READD_VEHICLE_Q
        | ONBOARDING_FAQ_READD_VEHICLE_A
        | ONBOARDING_FAQ_VEHICLE_INSPECTION_Q
        | ONBOARDING_FAQ_VEHICLE_INSPECTION_A
        | ONBOARDING_FAQ_INSPECTION_COST_Q
        | ONBOARDING_FAQ_INSPECTION_COST_A
        | ONBOARDING_FAQ_MANAGE_VEHICLE_DOCS_Q
        | ONBOARDING_FAQ_MANAGE_VEHICLE_DOCS_A
        | ONBOARDING_FAQ_TRACK_VEHICLE_DOCS_Q
        | ONBOARDING_FAQ_TRACK_VEHICLE_DOCS_A
        | ONBOARDING_FAQ_ASSIGN_DRIVER_VEHICLE_Q
        | ONBOARDING_FAQ_ASSIGN_DRIVER_VEHICLE_A
        | ONBOARDING_FAQ_REMOVE_VEHICLE_Q
        | ONBOARDING_FAQ_REMOVE_VEHICLE_A
        | ONBOARDING_FAQ_EDIT_VEHICLE_Q
        | ONBOARDING_FAQ_EDIT_VEHICLE_A
        | ONBOARDING_FAQ_UPDATE_DRIVER_STATUS_Q
        | ONBOARDING_FAQ_UPDATE_DRIVER_STATUS_A
