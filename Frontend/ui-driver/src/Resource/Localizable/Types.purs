...
type PLEASE_ASK_THE_CUSTOMER_FOR_THE_OTP = String
...
type ADD_ALTERNATE_NUMBER = String
type ENTER_ALTERNATE_MOBILE_NUMBER = String
type PLEASE_ENTER_A_VALID_10_DIGIT_NUMBER = String
type VERIFICATION_IS_TAKING_A_BIT_LONGER  = String
type COMPLETE_ONBOARDING = String
type PERSON_WITH_THIS_NUMBER_ALREADY_EXISTS =String
type ADD_ALTERNATE_NUMBER_IN_MEANTIME = String
