...
data STR = LETS_GET_STARTED
        ...
        | METRO_WARRIORS
        | SEARCH
        | INTERCITY_ROUND_TRIP_RIDE_ACCEPTED
        | YOU_ARE_ON_INTERCITY_ROUND_TRIP_RIDE
        | PLEASE_ENSURE_THAT_YOUR_VEHICLE_IS_READY_FOR_INTERCITY_ROUND_TRIP String
        | YOUR_INTERCITY_ROUND_TRIP_RIDE_STARTS_IN
