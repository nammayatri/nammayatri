...
getHI stringKey =
    case stringKey of
        ...
        RUSH_HOURS_DESC charges -> "*भीड़ के घंटों के दौरान, उच्च यातायात के लिए चालक के समय की भरपाई के लिए " <> charges <> "% अतिरिक्त किराया लागू होता है।"
        TOLL_OR_PARKING_CHARGES -> "^टोल/पार्किंग शुल्क"
        TOLL_CHARGES_ESTIMATED -> "टोल शुल्क (अनुमानित)^"
        RUSH_HOUR_CHARGES -> "भीड़ के घंटे के शुल्क*"
