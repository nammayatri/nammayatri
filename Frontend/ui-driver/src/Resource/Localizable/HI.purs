...
getHI stringKey =
    case stringKey of
        ...
        REFER_AND_EARN -> "रेफर और कमाएँ"
        REFER -> "रेफर "
        EARN_CASH -> "पैसे कमाएं"
        SHARE -> "शेयर"
        REFERRED_CUSTOMERS_INFO -> "आपके द्वारा संदर्भित ग्राहक जिन्होंने अपनी पहली सवारी सफलतापूर्वक पूरी कर ली है"
        REFERRED_DRIVERS_INFO -> "वे ड्राइवर जो आपके रेफ़रल कोड के साथ नम्मा यात्री पर शामिल हुए हैं"
        GOT_IT_TEXT -> "समझ गया"
        CUSTOMER_TEXT -> "ग्राहक"
        DRIVER_TEXT -> "चालक"
