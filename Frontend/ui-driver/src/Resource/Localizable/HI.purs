...
getHI stringKey =
    case stringKey of
        ...
        FACE_DETECTION_FAILED -> "चेहरे का पता लगाना विफल, कृपया पुनः प्रयास करें"
        NEED_PERMISSION_TO_ACCESS_CAMERA -> "कैमरे तक पहुंचने के लिए अनुमति की आवश्यकता है"
        FACE_NOT_CLEAR -> "चेहरा स्पष्ट नहीं है"
        MULTIPLE_FACES -> "एकाधिक चेहरों का पता चला"