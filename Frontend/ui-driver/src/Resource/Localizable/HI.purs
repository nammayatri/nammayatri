...
getHI stringKey =
    case stringKey of
        ...
        NEED_IT_TO_ENABLE_LOCATION (stringForConfig) -> "नम्मा यात्री पार्टनर ड्राइवर के लोकेशन की निगरानी के लिए अपना स्थान साझा करने के लिए लोकेशन डेटा एकत्र करता है, तब भी जब ऐप बंद हो या उपयोग में न हो।"
        ...
        PAYMENT_PENDING_ALERT_DESC (stringForConfig) -> "नम्मा यात्री पर यात्रा जारी रखने के लिए, अपनी शेष राशि चुकाएं"
        ...
        HOW_IT_WORKS (stringForConfig) -> "जानिए यह कैसे काम करता है"
        ...
        GET_SPECIAL_OFFERS (stringForConfig) -> "विशेष ऑफ़र प्राप्त करें"
        VALID_ONLY_IF_PAYMENT -> "भुगतान पूरा होने पर ही मान्य"
        HELP_STR -> "सहायता"
        REFRESH_STRING -> "पुनः लोड करें"
        CHAT_FOR_HELP -> "चैट करें"
        VIEW_FAQs -> "प्रश्न?"
        FIND_HELP_CENTRE (stringForConfig) -> "सहायता केंद्र ढूंढें"
        CONTACT -> "संपर्क करें"
        ...
        SUBSCRIPTION_PLAN_STR (stringForConfig) -> "सदस्यता योजना"
