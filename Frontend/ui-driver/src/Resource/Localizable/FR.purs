...
getFR stringKey =
    case stringKey of
        ...
        NEED_IT_TO_ENABLE_LOCATION (stringForConfig) -> "Namma Yatri Partner recueille des données de localisation afin de partager votre position pour suivre la position du conducteur en direct, même lorsque l'application est fermée ou n'est pas utilisée"
        ...
        PAYMENT_PENDING_ALERT_DESC (stringForConfig) -> "Pour continuer à faire des trajets sur Namma Yatri, effacez vos frais de paiement"
        ...
        HOW_IT_WORKS (stringForConfig) -> "Comment ça marche"
        ...
        GET_SPECIAL_OFFERS (stringForConfig) -> "Get Special Offers"
        VALID_ONLY_IF_PAYMENT -> "valid only if payment is completed"
        HELP_STR -> "HELP"
        REFRESH_STRING -> "Refresh"
        CHAT_FOR_HELP -> "Chat for Help"
        VIEW_FAQs -> "View FAQs"
        FIND_HELP_CENTRE (stringForConfig) -> "Trouver le centre d'aide"
        CONTACT -> "Contact"
        ...
        SUBSCRIPTION_PLAN_STR (stringForConfig) -> "Plan d'abonnement"
        ...
        START_TAKING_RIDES_AND_REFER -> "Commencez à faire des courses et à recommander des chauffeurs pour vous inscrire sur l'application Namma Yatri Driver"
        ...
        EARN_UPTO_PER_DAY -> "Gagnez jusqu'à ₹{} par jour!"
