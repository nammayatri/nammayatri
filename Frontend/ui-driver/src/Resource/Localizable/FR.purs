...
getFR stringKey =
    case stringKey of
        ...
        YATRI_COINS_FAQS_QUES1_ANS1 -> "Les Yatri Coins sont les récompenses que vous gagnez lors d'activités quotidiennes sur Namma Yatri comme des manèges, des références, de bonnes notes, etc."
        YATRI_COINS_FAQS_QUES1_ANS2 -> "Les pièces gagnées peuvent être utilisées pour bénéficier de réductions (Exemple : remises sur l'achat de plans d'abonnement à l'aide de pièces)"
        YATRI_COINS_FAQS_QUES1_ANS3 -> "Chaque pièce Yatri peut être convertie en une réduction de Rs. 9,999. 0,10 et peut être utilisé pour bénéficier de réductions sur les plans d’abonnement. D'autres possibilités de bénéficier de réductions seront ajoutées à l'avenir."
        YATRI_COINS_FAQS_QUES2 -> "Quelle est la validité des Yatri Coins?"
        YATRI_COINS_FAQS_QUES2_ANS1 -> "Les Yatri Coins sont valables pour une période de 90 jours à compter du jour où elles sont gagnées. Pendant cette période, vous pouvez utiliser les pièces pour bénéficier d’avantages."
        YATRI_COINS_FAQS_QUES2_ANS2 -> "Les Yatri Coins non échangés dans les 90 jours seront perdus"
        YATRI_COINS_FAQS_QUES3 -> "Comment puis-je gagner des pièces Yatri ?"
        ...
        YATRI_COINS_FAQS_QUES4_ANS3 -> "Les Yatri Coins ne peuvent pas être utilisées à d'autres fins que celles de bénéficier de réductions."
        YATRI_COINS_FAQS_QUES5 -> "Quelle est l’éligibilité pour gagner et utiliser des Yatri Coins ?"
        YATRI_COINS_FAQS_QUES5_ANS1 -> "Vous devez effectuer votre premier trajet avec Namma Yatri pour commencer à gagner des Yatri Coins."
        YATRI_COINS_FAQS_QUES5_ANS2 -> "La section des Yatri Coins sera désactivée jusqu'à ce que vous ayez effectué votre premier trajet."
        YATRI_COINS_FAQS_QUES6 -> "Combien de pièces puis-je gagner ou perdre pour diverses actions ?"
        YATRI_COINS_FAQS_QUES6_ANS1 -> "Les pièces sont gagnées ou perdues pour diverses actions selon le tableau suivant :"
        ...
        PAID_BY -> "Payé par"
        TEN_DIGIT_MOBILE_NUMBER -> "Numéro de portable à 10 chiffres"
        DRIVER_REFERRAL_CODE -> "Code de référence du conducteur"
