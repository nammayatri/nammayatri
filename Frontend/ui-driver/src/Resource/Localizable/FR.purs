...
getFR stringKey =
    case stringKey of
        ...
        YATRI_COINS_FAQS_QUES2_ANS1 _ -> "Les Yatri Coins sont valables pour une période de 90 jours à compter du jour où elles sont gagnées. Pendant cette période, vous pouvez utiliser les pièces pour bénéficier d’avantages."
        YATRI_COINS_FAQS_QUES2_ANS2 _ -> "Les Yatri Coins non échangés dans les 90 jours seront perdus"
