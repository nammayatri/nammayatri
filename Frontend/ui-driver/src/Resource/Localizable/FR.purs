...
getFR stringKey =
    case stringKey of
        ...
        DISMISS -> "Rejeter"
        EARNINGS -> "Gains"
        YATRI_COINS -> "Pièces Yatri"
        YATRI_COINS_STR -> "Pièces Yatri"
        INTRODUCING_YATRI_COINS -> "Présentation des pièces Yatri"
        NOW_EARN_COINS_FOR_EVERY_RIDE_AND_REFERRAL_AND_USE_THEM_TO_GET_REWARDS _ -> "Gagnez maintenant des pièces pour chaque trajet et référence, et utilisez-les pour obtenir des récompenses"
        PAID_BY_YATRI_COINS -> "Payé par des pièces Yatri"
        YATRI_COINS_USAGE_POPUP _ -> "Les pièces Yatri seront converties en réductions que vous pouvez utiliser contre votre plan d'abonnement"
        USE_COINS_NOW -> "Utiliser des pièces maintenant"
        BUY_NOW -> "Acheter maintenant"
        SELECT_DATE -> "Sélectionner une date"
        WHAT_WILL_MY_COINS_BE_CONVERTED_TO -> "À quoi mes pièces seront-elles converties ?"
        COINS_EXPIRING_IN_THE_NEXT -> "{} pièces expirant dans les {} prochains jours. Utilisez-les avant leur expiration."
        DAYS_USE_THEM_BEFORE_THEY_EXPIRE -> "jours. Utilisez-les avant qu'ils n'expirent"
        COINS_EXPIRING -> "Pièces expirant"
        NO_COINS_AVAILABLE -> "Aucune pièce disponible"
        FAILED_TO_USE_COINS_PLEASE_TRY_AGAIN_LATER -> "Échec de l'utilisation des pièces. Veuillez réessayer plus tard"
        ...
        VIEW_MORE -> "Voir plus"
        MINIMUM -> "Minimum"
        COINS_IS_REQUIRED_FOR_CONVERSION -> "Les pièces sont nécessaires pour la conversion"
        DISCOUNT -> "Remise"
        CHECK_NOW -> "Vérifier maintenant"
        COIN_BALANCE -> "pièces restantes"
        COINS_BALANCE -> "Solde des pièces"
        TOTAL_EARNED -> "Total Gagné"
        RIDE_HISTORY -> "histoire de balade"
        TRANSACTION_HISTORY -> "Historique des transactions"
        COINS_EARNED -> "pièces gagnées"
        NO_RIDES -> "Pas de manèges"
        COINS_USED -> "pièces utilisées"
        USE_COINS -> "utiliser des pièces"
        INSIGHTS -> "connaissances"
        USAGE_HISTORY -> "historique d'utilisation"
        NO_COINS_EARNED -> "aucune pièce gagnée"
        NO_COINS_USED -> "aucune pièce utilisée"
        EARN_COINS_BY_TAKING_RIDES_AND_REFERRING_THE_APP_TO_OTHERS _ -> "Gagnez des pièces en faisant des courses et en référant l'application à d'autres"
        ...
        COMPLETE_FIRST_RIDE_TO_UNLOCK_COINS -> "Terminez le premier tour pour débloquer des pièces"
        DESTINATION -> "Destination"
        YOU_DID_NOT_TAKE_ANY_RIDES_ON_PREFIX -> "Vous n'avez effectué aucun trajet le"
        YOU_DID_NOT_TAKE_ANY_RIDES_ON_SUFFIX -> ""
        CONVERT -> "Convertir"
        CONVERT_COINS -> "Convertir des pièces"
        ...
        USING_COINS_REQUIRES_AN_ACTIVE_PLAN -> "L’utilisation de Coins nécessite un plan actif."
        TO_GET_STARTED -> "pour commencer"
        CONVERTED_FROM_COINS -> "converti à partir de pièces de monnaie"
        YATRI_COINS_FAQS  -> "Pièces Yatri Questions Générales"
        LEARN_ABOUT_YATRI_COINS  -> "En savoir plus sur les pièces Yatri"
        YATRI_COINS_FAQS_QUES1 _ -> "Qu'est-ce que Yatri Coins?"
        YATRI_COINS_FAQS_QUES1_ANS1 _ -> "Les Yatri Coins sont les récompenses que vous gagnez lors d'activités quotidiennes sur Namma Yatri comme des manèges, des références, de bonnes notes, etc."
        YATRI_COINS_FAQS_QUES1_ANS2 _ -> "Les pièces gagnées peuvent être utilisées pour bénéficier de réductions (Exemple : remises sur l'achat de plans d'abonnement à l'aide de pièces)"
        YATRI_COINS_FAQS_QUES1_ANS3 _ -> "Chaque pièce Yatri peut être convertie en une réduction de Rs. 9,999. 0,10 et peut être utilisé pour bénéficier de réductions sur les plans d’abonnement. D'autres possibilités de bénéficier de réductions seront ajoutées à l'avenir."
        YATRI_COINS_FAQS_QUES2 _ -> "Quelle est la validité des Yatri Coins?"
        YATRI_COINS_FAQS_QUES2_ANS1 days -> "Les Yatri Coins sont valables pour une période de "<> days <>" jours à compter du jour où elles sont gagnées. Pendant cette période, vous pouvez utiliser les pièces pour bénéficier d’avantages."
        YATRI_COINS_FAQS_QUES2_ANS2 days -> "Les Yatri Coins non échangés dans les "<> days <>" jours seront perdus"
        YATRI_COINS_FAQS_QUES3 _ -> "Comment puis-je gagner des pièces Yatri ?"
        YATRI_COINS_FAQS_QUES3_ANS1 _ -> "Les pièces sont gagnées grâce aux activités quotidiennes sur l'application telles que les trajets, les recommandations de clients. Vous n'avez rien de différent à faire."
        YATRI_COINS_FAQS_QUES3_ANS2 _ -> "Vous pouvez gagner plus de pièces en adoptant un bon comportement, comme peu d'annulations, en obtenant de bonnes évaluations de la part des clients, etc."
        YATRI_COINS_FAQS_QUES4 _ -> "Comment puis-je utiliser les Yatri Coins que j'ai gagnées?"
        YATRI_COINS_FAQS_QUES4_ANS1 _ -> "Vous pouvez utiliser les pièces gagnées pour acheter des plans d'abonnement gratuitement pendant la période de validité."
        YATRI_COINS_FAQS_QUES4_ANS2 _ -> "À l'avenir, d'autres options seront ajoutées pour utiliser les Yatri Coins."
        YATRI_COINS_FAQS_QUES4_ANS3 _ -> "Les Yatri Coins ne peuvent pas être utilisées à d'autres fins que celles de bénéficier de réductions."
        YATRI_COINS_FAQS_QUES5 _ -> "Quelle est l’éligibilité pour gagner et utiliser des Yatri Coins ?"
        YATRI_COINS_FAQS_QUES5_ANS1 _ -> "Vous devez effectuer votre premier trajet avec Namma Yatri pour commencer à gagner des Yatri Coins."
        YATRI_COINS_FAQS_QUES5_ANS2 _ -> "La section des Yatri Coins sera désactivée jusqu'à ce que vous ayez effectué votre premier trajet."
        YATRI_COINS_FAQS_QUES6 _ -> "Combien de pièces puis-je gagner ou perdre pour diverses actions ?"
        YATRI_COINS_FAQS_QUES6_ANS1 _ -> "Les pièces sont gagnées ou perdues pour diverses actions selon le tableau suivant :"
        ...
        KNOW_ABOUT_COINS -> "En savoir plus sur les pièces"
        ...
        TAKE_TWO_MORE_RIDES_TO_EARN_COINS coinValue -> "Faites deux trajets de plus et gagnez " <> coinValue <> " pièces"
        ONE_MORE_RIDE_TO_GO -> "Un trajet de plus à faire"
        TAKE_ONE_MORE_RIDE_TO_EARN_COINS coinValue -> "Faites un trajet de plus et gagnez " <> coinValue <> " pièces"
        CONGRATULATIONS -> "Félicitations"
        YOU_HAVE_EARNED_COINS_FOR_COMPLETING_EIGHT_RIDES coinValue -> "Vous avez gagné " <> coinValue <> " pièces pour avoir terminé huit trajets"
        REFER_NAMMA_YATRI_APP_TO_CUSTOMERS_AND_EARN_COINS _ -> "Référez l'application Namma Yatri à des clients et gagnez des pièces"
        ...
        MERCHANT_COINS merchant -> "Pièces de monnaie " <> merchant
        ...
        ACCEPT -> "Accepter"
        PASS -> "Passer"
        TERM_1A -> "1. Le tarif total sera calculé en fonction de la distance finale réelle du trajet."
        TERM_2A -> "2. Le péage ne sera applicable que si une route à péage est empruntée."
        TERM_3A -> "3. Les éventuels frais de stationnement devront être réglés séparément avec le chauffeur."
        TERM_1B -> "1. L'annulation avant 1 heure du début prévu du trajet entraînera des pénalités sur la plateforme."
        TERM_2B -> "2. Soyez en ligne avant 45 minutes avant le début prévu du trajet."
        TERM_3B -> "3. Atteignez le lieu de prise en charge du client avant 15 minutes après l'heure de début prévue du trajet."        
        EXCLUDED_CHARGES -> "Frais exclus"
        TOLLS -> "Péages"
        STATE_PERMIT -> "Permis d'État"
        EXCLUDED_FOOTER -> "Ces éléments tarifaires ne sont PAS inclus dans le tarif et doivent être réglés séparément avec le client."
        INCLUDED_CHARGES -> "Charges incluses"
        INC_1 -> "*Les frais supplémentaires ne sont applicables que si vous dépassez la distance/temps inclus."
        INC_2A -> "Frais de nuit : conduire entre 22h00 et 5h00 aura un multiplicateur de 1,1x sur le tarif final."
        INC_2B -> "Frais de nuit : Pour conduire entre 22h00 et 5h00 du matin, des frais de nuit forfaitaires seront ajoutés au tarif."
        PICKUP_DROP -> "Ramassage et dépôt"
        MORE_RIDES -> "Plus de manèges"
        SORT_BY -> "Trier par"
        CURRENTLY_THERE_ARE_NO_RIDES_AVAILABLE -> "Actuellement, aucun trajet n'est disponible."
        RIDE_REQUESTS -> "Demandes de courses"
        SCHEDULED_RIDE_ACCEPTED -> "Trajet programmé accepté"
        YOU_CAN_ACCESS_SCHEDULED_RIDES -> "vous pouvez accéder aux trajets programmés"
        FROM_YOUR_HOMESCREEN -> "Depuis votre écran d'accueil"
        _ -> ""
