...
getFR stringKey =
    case stringKey of
        ...
        NOW_EARN_COINS_FOR_EVERY_RIDE_AND_REFERRAL_AND_USE_THEM_TO_GET_REWARDS -> "Gagnez maintenant des pièces pour chaque trajet et référence, et utilisez-les pour obtenir des récompenses"
        PAID_BY_YATRI_COINS -> "Payé par des pièces Yatri"
        YATRI_COINS_USAGE_POPUP -> "Les pièces Yatri seront converties en réductions que vous pouvez utiliser contre votre plan d'abonnement"
        ...
        EARN_COINS_BY_TAKING_RIDES_AND_REFERRING_THE_APP_TO_OTHERS -> "Gagnez des pièces en faisant des courses et en référant l'application à d'autres"
        ...
        YOU_DID_NOT_TAKE_ANY_RIDES_ON_THE_SELECTED_DATE -> "Vous n'avez effectué aucun trajet à la date sélectionnée"
        CONVERT -> "Convertir"
        ...
        CHOOSE_A_PLAN_TO_GET_STARTED -> "Choisissez un forfait pour commencer !"
        ...
        YATRI_COINS_FAQS_QUES1 -> "Qu'est-ce que Yatri Coins?"
        YATRI_COINS_FAQS_QUES1_ANS1 -> "Les Yatri Coins sont les récompenses que vous gagnez dans vos activités quotidiennes sur Namma Yatri, telles que les trajets, les recommandations, les bonnes évaluations, etc."
        YATRI_COINS_FAQS_QUES1_ANS2 -> "Les pièces gagnées peuvent être utilisées pour bénéficier d'avantages tels que l'achat de plans d'abonnement uniquement avec des pièces."
        YATRI_COINS_FAQS_QUES1_ANS3 -> "De nouveaux avantages seront ajoutés à l'avenir."
        YATRI_COINS_FAQS_QUES2 -> "Quelle est la validité des Yatri Coins?"
        YATRI_COINS_FAQS_QUES2_ANS1 -> "Les Yatri Coins sont valides pendant une période de 90 jours à partir du jour où ils sont gagnés. Pendant cette période, vous pouvez utiliser les pièces pour bénéficier d'avantages."
        YATRI_COINS_FAQS_QUES3 -> "Comment puis-je gagner des Yatri Coins?"
        YATRI_COINS_FAQS_QUES3_ANS1 -> "Les pièces sont gagnées grâce aux activités quotidiennes sur l'application telles que les trajets, les recommandations de clients. Vous n'avez rien de différent à faire."
        YATRI_COINS_FAQS_QUES3_ANS2 -> "Vous pouvez gagner plus de pièces en adoptant un bon comportement, comme peu d'annulations, en obtenant de bonnes évaluations de la part des clients, etc."
        YATRI_COINS_FAQS_QUES4 -> "Comment puis-je utiliser les Yatri Coins que j'ai gagnées?"
        YATRI_COINS_FAQS_QUES4_ANS1 -> "Vous pouvez utiliser les pièces gagnées pour acheter des plans d'abonnement gratuitement pendant la période de validité."
        YATRI_COINS_FAQS_QUES4_ANS2 -> "À l'avenir, d'autres options seront ajoutées pour utiliser les Yatri Coins."
        YATRI_COINS_FAQS_QUES5 -> "La configuration d'Autopay est-elle obligatoire pour utiliser les Yatri Coins?"
        YATRI_COINS_FAQS_QUES5_ANS1 -> "Oui. La configuration d'Autopay est obligatoire pour utiliser les Yatri Coins."
        YATRI_COINS_FAQS_QUES5_ANS2 -> "Cependant, vous pouvez continuer à les gagner même sans configurer Autopay."
        YATRI_COINS_FAQS_QUES5_ANS3 -> "La configuration d'Autopay est obligatoire uniquement pour utiliser les pièces."
        YATRI_COINS_FAQS_QUES6 -> "Quelles sont les conditions d'éligibilité pour gagner et utiliser les Yatri Coins?"
        YATRI_COINS_FAQS_QUES6_ANS1 -> "Vous devez effectuer votre premier trajet avec Namma Yatri pour commencer à gagner des Yatri Coins."
        YATRI_COINS_FAQS_QUES6_ANS2 -> "La section des Yatri Coins sera désactivée jusqu'à ce que vous ayez effectué votre premier trajet."
        YATRI_COINS_FAQS_QUES7 -> "Certains Yatri Coins ont été déduits de mon compte sans les utiliser. Pourquoi?"
        YATRI_COINS_FAQS_QUES7_ANS1 -> "Les pièces peuvent être déduites en cas de comportement indésirable. Des exemples de comportement indésirable peuvent être de mauvaises évaluations de la part du client, une annulation de réservation."
        _ -> ""
