...
getFR stringKey =
    case stringKey of
        ...
        REFER -> "Référer "
        EARN_CASH -> "Gagner de l'argent"
        SHARE -> "Partager"
        REFERRED_CUSTOMERS_INFO -> "Clients ayant réalisé avec succès leur premier trajet, référés par vous"
        REFERRED_DRIVERS_INFO -> "Chauffeurs qui se sont inscrits sur Namma yatri avec votre code de parrainage"
        GOT_IT_TEXT -> "J'ai compris"
        CUSTOMER_TEXT -> "Client"
        DRIVER_TEXT -> "Conducteur"
        _ -> ""
