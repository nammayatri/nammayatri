...
getFR stringKey =
    case stringKey of
        ...
        VEHICLE_REGISTRATION_NUMBER _ -> "Numéro de certificat d'immatriculation du véhicule"
        RE_ENTER_VEHICLE_REGISTRATION_NUMBER _ -> "Entrez à nouveau le numéro du certificat d'immatriculation du véhicule"
        ...
        PICK_UP -> "Ramasser"
        YOU_CAN_DESCRIBE_THE_ISSUE_YOU_FACED_HERE -> "Vous pouvez décrire le problème que vous avez rencontré ici"
        PLEASE_ENTER_A_VALID_EMAIL -> "Votre identifiant de messagerie"
        SUBMIT_REQUEST -> "Soumettre la demande"
        DEL_ACCOUNT -> "Supprimer le compte"
        WE_WOULD_APPRECIATE_YOUR_REASONING -> "Nous apprécierions vos commentaires sur votre raisonnement derrière la suppression du compte"
        REASON_FOR_DELETING_ACCOUNT -> "Raison de la suppression du compte"
