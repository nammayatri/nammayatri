...
getKN stringKey =
    case stringKey of
        ...
        FACE_DETECTION_FAILED -> "ಮುಖ ಪತ್ತೆ ವಿಫಲವಾಗಿದೆ, ದಯವಿಟ್ಟು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ"
        NEED_PERMISSION_TO_ACCESS_CAMERA -> "ಕ್ಯಾಮೆರಾವನ್ನು ಪ್ರವೇಶಿಸಲು ಅನುಮತಿ ಅಗತ್ಯವಿದೆ"
        FACE_NOT_CLEAR -> "ಮುಖ ಸ್ಪಷ್ಟವಾಗಿಲ್ಲ"
        MULTIPLE_FACES -> "ಬಹು ಮುಖಗಳನ್ನು ಪತ್ತೆಹಚ್ಚಲಾಗಿದೆ"