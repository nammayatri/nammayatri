...
getKN stringKey =
    case stringKey of
        ...
        FREE_TRIAL_ENDING_IN_N_DAYS days -> "ಫ್ರೀ ಅವಧಿಯು "<> days <>" ದಿನಗಳಲ್ಲಿ ಕೊನೆಗೊಳ್ಳುತ್ತದೆ!"
        ...
        N_FREE_RIDES_COMPLETED n -> n <> " ಉಚಿತ ಸವಾರಿ ಮುಗಿದಿದೆ"
        N_MORE_FREE_RIDES n -> n <> " ಇನ್ನೂ ಉಚಿತ ಸವಾರಿ ಬಾಕಿ ಇದೆ!"
