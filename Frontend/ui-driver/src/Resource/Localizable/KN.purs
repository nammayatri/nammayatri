...
getKN stringKey =
    case stringKey of
        ...
        RESEND_OTP -> "<a href=\"\">OTP ಅನ್ನು ಮರುಕಳುಹಿಸಿ</a>"
        ...
        NEED_IT_TO_ENABLE_LOCATION (stringForConfig) -> "ಅಪ್ಲಿಕೇಶನ್ ಮುಚ್ಚಿದಾಗ ಅಥವಾ ಬಳಕೆಯಲ್ಲಿಲ್ಲದಿದ್ದರೂ ಸಹ ಚಾಲಕ ಪ್ರಸ್ತುತ ಸ್ಥಳವನ್ನು ಮೇಲ್ವಿಚಾರಣೆ ಮಾಡಲು ನಿಮ್ಮ ಸ್ಥಳವನ್ನು ಹಂಚಿಕೊಳ್ಳಲು ಸಕ್ರಿಯಗೊಳಿಸಲು ನಮ್ಮ ಯಾತ್ರಿ ಪಾಲುದಾರರು ಸ್ಥಳ ಡೇಟಾವನ್ನು ಸಂಗ್ರಹಿಸುತ್ತಾರೆ."
        ...
        PAYMENT_PENDING_ALERT_DESC (stringForConfig) -> "ನಮ್ಮ ಯಾತ್ರಿಯಲ್ಲಿ ಸವಾರಿ ಮಾಡುವುದನ್ನು ಮುಂದುವರಿಸಲು, ನಿಮ್ಮ ಪಾವತಿ ಬಾಕಿಗಳನ್ನು ತೆರವುಗೊಳಿಸಿ"
        ...
        HOW_IT_WORKS (stringForConfig) -> "ಇದು ಹೇಗೆ ಕೆಲಸ ಮಾಡುತ್ತದೆ"
        ...
        GET_SPECIAL_OFFERS (stringForConfig) -> "ಸ್ಪೆಷಲ್ ಆಫರ್ಗಳು ಪಡೆಯಿರಿ"
        VALID_ONLY_IF_PAYMENT -> "ಪಾವತಿ ಪೂರ್ಣಗೊಂಡರೆ ಮಾತ್ರ ಮಾನ್ಯವಾಗಿರುತ್ತದೆ"
        HELP_STR -> "ಸಹಾಯ"
        REFRESH_STRING -> "ರಿಫ್ರೆಶ್"
        CHAT_FOR_HELP -> "ಚಾಟ್?"
        VIEW_FAQs -> "ಎಫ್.ಎ.ಕ್ಯೂ ವೀಕ್ಷಿಸಿ"
        FIND_HELP_CENTRE (stringForConfig) -> "ಸಹಾಯ ಕೇಂದ್ರವನ್ನು ಹುಡುಕಿ"
        CONTACT -> "ಸಂಪರ್ಕಿಸಿ"
        ...
        SUBSCRIPTION_PLAN_STR (stringForConfig) -> "ಚಂಚಲೀಕರಣ ಯೋಜನೆ"
