...
getKN stringKey =
    case stringKey of
        ...
        RUSH_HOURS_DESC charges -> "*ರಶ್ ಅವರ್ಸ್ ಸಮಯದಲ್ಲಿ, ಹೆಚ್ಚಿನ ಸಂಚಾರ ಸಮಯಕ್ಕಾಗಿ ಚಾಲಕರ ಸಮಯವನ್ನು ಪೂರೈಸಲು " <> charges <> "% ಹೆಚ್ಚುವರಿ ಭಾಡೆ ಅನ್ವಯಿಸುತ್ತದೆ."
        TOLL_OR_PARKING_CHARGES -> "^ಟೋಲ್/ ಪಾರ್ಕಿಂಗ್ ಶುಲ್ಕಗಳು"
        TOLL_CHARGES_ESTIMATED -> "ಟೋಲ್ ಶುಲ್ಕ (ಅಂದಾಜು)^"
        RUSH_HOUR_CHARGES -> "ರಶ್ ಅವರ್ಸ್ ಶುಲ್ಕ*"
