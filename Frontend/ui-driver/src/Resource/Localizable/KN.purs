...
getKN stringKey =
    case stringKey of
        ...
        BENGALI -> "বাংলা"
        ENGLISH -> "ಇಂಗ್ಲಿಷ್"
        YOU_HAVE_SUCCESSFULLY_COMPLETED -> "ನೀವು ಯಶಸ್ವಿಯಾಗಿ ಪೂರೈಸಿದ್ದೀರಿ"
        ALL_ANSWERS_SHOULD_BE_CORRECT_TO_COMPLETE -> "ಪೂರೈಸಲು ಎಲ್ಲಾ ಉತ್ತರಗಳೂ ಸರಾಗವಾಗಿರಬೇಕು"
        QUESTIONS_SHOULD_BE_CORRECT_TO_COMPLETE -> "ಪೂರೈಸಲು ಪ್ರಶ್ನೆಗಳು ಸರಿಯಾಗಿರಬೇಕು"
        CORRECT -> "ಸರಿ"
        RETAKE_QUIZ -> "ಕುಯಿಜ್ ಮತ್ತೊಮ್ಮೆ ಪಡೆಯಿರಿ"
        TAKE_A_QUIZ -> "ಕುಯಿಜ್ ಪಡೆಯಿರಿ"
        PLAY_AGAIN -> "ಮತ್ತೆ ಆಡಿ"
        PLAY_NOW -> "ಈಗ ಆಡಿ"
        WATCH_ALL_VIDEOS_TO_LEARN -> "ಎಲ್ಲಾ ವೀಡಿಯೊಗಳನ್ನು ನೋಡಿ ಕಲಿಯಿರಿ"
        PLAY_QUIZ_TO_COMPLETE_YOUR_TRAINING -> "ನಿಮ್ಮ ತರಬೇತಿಯನ್ನು ಪೂರೈಸಲು ಕುಯಿಜ್ ಆಡಿ"
        TRAINING_COMPLETED -> "ತರಬೇತಿ ಪೂರೈಸಲು ಸಿಗಿತು"
        WATCHED -> "ನೋಡಿದ್ದೇನೆ"
        UH_OH_SOMETHING_WENT_WRONG -> "ಉಹ್ ಓ! ಏನೋ ತಪ್ಪಾಗಿದೆ"
        WATCH_ALL_VIDEOS_TO_UNLOCK_QUIZ -> "ಕುಯಿಜ್ ಅನಲಾಕ್ ಮಾಡಲು ಎಲ್ಲಾ ವೀಡಿಯೊಗಳನ್ನು ನೋಡಿ"
        INCOMPLETE -> "ಅಷ್ಟೇಕೆ"
        NEW_C -> "ಹೊಸ"
        PENDING_STR_C -> "ಬಾಕಿ"
        ...
        UNABLE_TO_LOAD_QUIZ_PLEASE_TRY_AGAIN -> "ರಸಪ್ರಶ್ನೆಯನ್ನು ಲೋಡ್ ಮಾಡಲು ಸಾಧ್ಯವಾಗುತ್ತಿಲ್ಲ. ದಯವಿಟ್ಟು ಪುನಃ ಪ್ರಯತ್ನಿಸಿ"
