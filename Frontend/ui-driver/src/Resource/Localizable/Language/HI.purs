...
getHI script = case script of
  ...
  ENTER_MOBILE_NUMBER -> "मोबाइल नंबर एंटर करें"
  ...
  MAX_IMAGES -> "आप केवल 3 चित्र जोड़ सकते हैं"
  ...
  OTP_LIMIT_EXCEED -> "OTP सीमा पार हो गई है, राइड कैंसिल करें और फिर से कोशिश करें"
  ...
  RESOLVED_ISSUE -> "हल किए गए मुद्दे"
  ...
  ISSUE_NUMBER -> "अंक संख्या   "
  REMOVE_ISSUE -> "समस्या दूर करें"
  ...
  MIN_AGO -> "मिनट पहले"
  SEC_AGO -> "सेकंड पहले"
  ISSUE_REMOVED -> "मुद्दा निकाला गया"
  DEMO -> "DEMO"
