...
getHI script = case script of
  ...
  MESSAGE -> "संदेश"
  FARE_UPDATED -> "किराया अपडेट किया"
  I_WILL_BE_THERE_IN_2_MINS -> "मैं 2 मिनट में वहाँ पहुँच जाऊँगा|"
  I_AM_AT_THE_PICKUP_LOCATION -> "मैं पिकअप पर हूँ|"
  ARE_YOU_COMING -> "क्या आप आ रहे हो?"
  I_HAVE_ARRIVED -> "मैं पहूंच गया हूं|"
  I_AM_STUCK_IN_TRAFFIC -> "मैं ट्रैफिक में फंस गया हूं|"
  I_AM_ON_THE_WAY -> "मैं रास्ते में हूं|"
  YES_I_AM_ALMOST_THERE -> "हाँ, मैं लगभग बस पोहच ही गया|"
  DELAYED_A_BIT_REACHING_IN_SOME_TIME -> "हाँ, कुछ देर में पिकअप पर पहुंच जाऊंगा|"
  OKAY -> "ठीक है|"
  PLEASE_BE_QUICK_I_AM_WAITING -> "ठीक है, आप जल्दी आजाओ, मैं रुका हूं|"
