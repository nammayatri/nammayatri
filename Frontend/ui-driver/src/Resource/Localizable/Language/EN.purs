...
getEN script = case script of
  ...
  MESSAGE -> "Message"
  FARE_UPDATED -> "Fare updated"
  I_WILL_BE_THERE_IN_2_MINS -> "I'll be there in 2 min"
  I_AM_AT_THE_PICKUP_LOCATION -> "I'm at the pickup location"
  ARE_YOU_COMING -> "Are you coming?"
  I_HAVE_ARRIVED -> "I've Arrived"
  I_AM_STUCK_IN_TRAFFIC -> "I'm stuck in traffic"
  I_AM_ON_THE_WAY -> "I'm on the way"
  YES_I_AM_ALMOST_THERE -> "Yes, I am almost there"
  DELAYED_A_BIT_REACHING_IN_SOME_TIME -> "Delayed a bit; reaching in some time"
  OKAY -> "Okay"
  PLEASE_BE_QUICK_I_AM_WAITING -> "Please be quick, I am waiting"
