...
getML stringKey =
    case stringKey of
        ...
        FACE_DETECTION_FAILED -> "മുഖം കണ്ടെത്തൽ പരാജയപ്പെട്ടു, ദയവായി വീണ്ടും ശ്രമിക്കുക"
        NEED_PERMISSION_TO_ACCESS_CAMERA -> "ക്യാമറ ആക്‌സസ് ചെയ്യാൻ അനുമതി വേണം"
        FACE_NOT_CLEAR -> "മുഖം വ്യക്തമല്ല"
        MULTIPLE_FACES -> "ഒന്നിലധികം മുഖങ്ങൾ കണ്ടെത്തി"