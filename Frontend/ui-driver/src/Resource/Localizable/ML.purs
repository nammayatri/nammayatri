...
getML stringKey =
    case stringKey of
        ...
        CAPTURE_DOC_DESC_1 -> "പരന്ന പ്രതലത്തിൽ നിങ്ങളുടെ വാഹനത്തിൻ്റെ {} വ്യക്തമായ ചിത്രം എടുക്കുക."
        CAPTURE_DOC_DESC_2 -> "ലൈറ്റിംഗ് മതിയായതാണെന്നും എല്ലാ വിശദാംശങ്ങളും വ്യക്തമായി ദൃശ്യമാണെന്നും ഉറപ്പാക്കുക"
        CAPTURE_DOC_DESC_3 -> "ചുവടെ കാണിച്ചിരിക്കുന്നതുപോലെ അടയാളപ്പെടുത്തിയ സ്ഥലത്ത് വാഹനം {} ശരിയായി ഘടിപ്പിക്കുക"
        UPLOAD_DOC -> "അപ്‌ലോഡ് {}"
