...
getML stringKey =
    case stringKey of
        ...
        YATRI_POINTS_USAGE_SECONDARY points discountPoints -> "ഓരോ "<> points <>" യാത്ര പോയിന്റുകൾ "<> discountPoints <>" ഡിസ്കൗണ്ട് പോയിന്റായി പരിവർത്തനം ചെയ്യാൻ കഴിയും"
        ...
        ONLY_5_MORE_RIDES_FOR_100_POINTS -> "కేవలం 5 రైడ్‌లను కలిగి ఉంటే 100 കോയിനുകൾ"
        ONLY_3_MORE_RIDES_FOR_50_POINTS -> "മാത്രം മൂന്ന് റൈഡുകൾ ഉള്ളതിനാൽ 40 കോയിനുകൾ"
        YOU_GOT_N_POINTS points -> "നിങ്ങൾ " <> points <>" കോയിനുകൾ ലഭിച്ചു"
        ...
        ADD_NOW  -> "ആഡ് ചെയ്യുക"
        ONLY_3_MORE_RIDES_FOR_100_POINTS -> "മാത്രം മൂന്ന് റൈഡുകൾ ഉള്ളതിനാൽ 100 പോയിൻ്റുകൾ"
        DISCOUNTED -> "കഴിഞ്ഞു"
