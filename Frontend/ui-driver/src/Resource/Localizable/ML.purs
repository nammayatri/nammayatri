...
getML stringKey =
    case stringKey of
        ...
        VEHICLE_REGISTRATION_NUMBER _ -> "വാഹന രജിസ്ട്രേഷൻ നമ്പർ"
        RE_ENTER_VEHICLE_REGISTRATION_NUMBER _ -> "വാഹന രജിസ്ട്രേഷൻ  നമ്പർ വീണ്ടും നൽകുക"
        ...
        AND -> " ഒപ്പം "
        DIRECT_PAYMENT_NO_COMMISSIONS _-> "നേരിട്ടുള്ള പേയ്‌മെന്റ്.\nകമ്മീഷനുകളൊന്നുമില്ല"
        CUSTOMER_PAYS_DIRECTLY _-> "ഉപഭോക്താവ് നിങ്ങൾക്ക് നേരിട്ട് \nപണം അല്ലെങ്കിൽ UPI വഴി പണം നൽകുന്നു"
        HUNDRED_PERCENT_FARE_GOES_TO_YOU _-> "നിരക്കിന്റെ 100%\nനിങ്ങൾക്കായി!"
        FARE_SHOWN_IS_FARE_YOU_GET _ -> "കാണിച്ചിരിക്കുന്ന നിരക്ക് നിങ്ങൾക്ക് ലഭിക്കുന്ന നിരക്കാണ്.\nമറഞ്ഞിരിക്കുന്ന നിരക്കുകളൊന്നുമില്ല."
        BE_A_PART_OF_OPEN_MOBILITY_REVOLUTION _ -> "ഓപ്പൺ\nമൊബിലിറ്റി വിപ്ലവത്തിന്റെ ഭാഗമാകൂ!"
        OUR_DATA_AND_PRODUCT_ARE_TRANSPARENT _ -> "ഞങ്ങളുടെ ഡാറ്റയും ഉൽപ്പന്ന റോഡ്‌മാപ്പും\nഎല്ലാവർക്കും സുതാര്യമാണ്."
        ...
        EARNINGS -> "വരുമാനം"
        YATRI_POINTS -> "യാത്രി പോയിൻ്റുകൾ"
        DISCOUNT_POINTS -> "ഡിസ്കൗണ്ട് പോയിൻറുകൾ"
        YATRI_POINTS_STR -> "യാത്രി \nപോയിൻ്റുകൾ"
        INTRODUCING_YATRI_POINTS -> "യാത്രി പോയിൻ്റുകൾ പരിചയപ്പെടുത്തുന്നു"
        NOW_EARN_POINTS_FOR_EVERY_RIDE_AND_REFERRAL_AND_USE_THEM_TO_GET_REWARDS _ -> "ഇപ്പോൾ എല്ലാ റൈഡുകളും റഫറൽസുകളും നടത്തി നിങ്ങൾക്ക് പോയിൻ്റുകൾ സമ്പാദിക്കാം. അവയെ പ്രതിഫലങ്ങളുടെ വിനിമയത്തിന് ഉപയോഗിക്കാം"
        ...
        WHAT_WILL_MY_POINTS_BE_CONVERTED_TO -> "എന്താകും എന്ന് എന്റെ പോയിൻ്റുകൾ മാറുകയാണോ?"
        POINTS_EXPIRING_IN_THE_NEXT -> "{} ദിവസങ്ങളിൽ കാലാന്തരിച്ചുവരുന്ന {} പോയിൻ്റുകൾ. അവയ്ക്ക് കാലാന്തരിച്ചതുമായി അവയെ ഉപയോഗിക്കുക."
        DAYS_USE_THEM_BEFORE_THEY_EXPIRE -> "ദിവസങ്ങൾ. അവ കാലഹരണപ്പെടുന്നതിന് മുൻപ് അവയെ ഉപയോഗിക്കുക"
        POINTS_EXPIRING -> "കാലഹരണപ്പെടുന്ന പോയിൻ്റുകൾ"
        NO_POINTS_AVAILABLE -> "പോയിൻ്റുകൾ ലഭ്യമല്ല"
        FAILED_TO_USE_POINTS_PLEASE_TRY_AGAIN_LATER -> "പോയിൻ്റുകൾ ഉപയോഗിക്കാൻ പരാജയപ്പെട്ടു. പിന്നീട് ശ്രമിക്കുക"
        ...
        MINIMUM -> "കുറഞ്ഞ"
        POINTS_IS_REQUIRED_FOR_CONVERSION -> "പോയിൻ്റുകൾ മാറ്റാൻ ആവശ്യമായി"
        DISCOUNT -> "ഡിസ്കൗണ്ട്"
        CHECK_NOW -> "ഇപ്പോൾ പരിശോധിക്കുക"
        COIN_BALANCE -> "പോയിൻ്റുകൾ അവശേഷിക്കുന്നു"
        POINTS_BALANCE -> "പോയിൻ്റുകൾ അവശേഷിക്കുന്നു"
        TOTAL_EARNED -> "ആകെ സമ്പാദിച്ചത്"
        RIDE_HISTORY -> "റൈഡ് ചരിത്രം"
        TRANSACTION_HISTORY -> "ഇടപാട് ചരിത്രം"
        POINTS_EARNED -> "സമ്പാദിച്ച പോയിൻ്റുകൾ"
        NO_RIDES -> "റൈഡുകൾ ഇല്ല"
        POINTS_USED -> "ഉപയോഗിച്ച പോയിൻ്റുകൾ"
        USE_POINTS -> "പോയിൻ്റുകൾ ഉപയോഗിക്കുക"
        INSIGHTS -> "ഉൾക്കാഴ്ചകൾ"
        USAGE_HISTORY -> "ഉപയോഗ ചരിത്രം"
        NO_POINTS_EARNED -> "പോയിൻ്റുകളൊന്നുമില്ല നേടിയില്ല"
        NO_POINTS_USED -> "പോയിൻ്റുകൾ ഉപയോഗിച്ചിട്ടില്ല"
        EARN_POINTS_BY_TAKING_RIDES_AND_REFERRING_THE_APP_TO_OTHERS _ -> "സവാരി നടത്തി ആപ്പ് മറ്റുള്ളവർക്ക് റഫർ ചെയ്തുകൊണ്ട് പോയിൻ്റുകൾ സമ്പാദിക്കുക"
        ...
        CONVERT_POINTS -> "പോയിൻ്റുകൾ മാറ്റുക"
        ...
        USING_POINTS_REQUIRES_AN_ACTIVE_PLAN -> "പോയിൻ്റുകൾ ഉപയോഗിക്കുന്നതിന് ഒരു സജീവ പ്ലാൻ ആവശ്യമാണ്."
        TO_GET_STARTED -> "ആരംഭിക്കാന് ഒരു പ്ലാൻ തിരഞ്ഞെടുക്കുക"
        CONVERTED_FROM_POINTS -> "നാണയങ്ങളിൽ നിന്ന് പരിവർത്തനം ചെയ്തു"
        YATRI_POINTS_FAQS -> "യാത്രി പോയിൻ്റുകൾ പൊതുവായ ചോദ്യം"
        LEARN_ABOUT_YATRI_POINTS -> "യാത്രി പോയിൻ്റുകൾ കുറിച്ച് അറിയുക"
        YATRI_POINTS_FAQS_QUES1 _ -> "യാത്രി പോയിൻ്റുകൾ എന്താണ്?"
        YATRI_POINTS_FAQS_QUES1_ANS1 _ -> "റൈഡുകൾ, റഫറലുകൾ, നല്ല റേറ്റിംഗുകൾ മുതലായവ പോലുള്ള നമ്മ യാത്രയിലെ ദൈനംദിന പ്രവർത്തനങ്ങളിൽ നിന്ന് നിങ്ങൾ നേടുന്ന റിവാർഡുകളാണ് യാത്രി പോയിൻ്റുകൾ."
        YATRI_POINTS_FAQS_QUES1_ANS2 _ -> "നേടിയ യാത്രി പോയിൻ്റുകൾ, പ്ലാറ്റ്‌ഫോമിൽ ഉപയോഗിക്കാവുന്ന ഡിസ്‌കൗണ്ട് പോയിൻ്റുകൾക്ക് നിങ്ങളെ യോഗ്യരാക്കുന്നു."
        YATRI_POINTS_FAQS_QUES1_ANS3 _ -> "ഓരോ യാത്രി പോയിൻ്റും 0.1 കിഴിവ് പോയിൻ്റായി പരിവർത്തനം ചെയ്യാൻ കഴിയും, അത് പ്ലാൻ അനുസരിച്ച് സബ്‌സ്‌ക്രിപ്‌ഷൻ ഫീയ്‌ക്കെതിരെ ക്രമീകരിക്കും."
        YATRI_POINTS_FAQS_QUES2 _ -> "യാത്രി പോയിൻ്റുകളുടെ സാധുത എന്താണ്?"
        YATRI_POINTS_FAQS_QUES2_ANS1 days -> "യാത്രി പോയിൻ്റുകൾ സമ്പാദിച്ച ദിവസം മുതൽ " <> days <> " ദിവസത്തേക്ക് സാധുതയുള്ളതാണ്. ഈ കാലയളവിൽ, ആനുകൂല്യങ്ങൾ ലഭിക്കുന്നതിന് നിങ്ങൾക്ക് പോയിൻ്റുകൾ ഉപയോഗിക്കാം."
        YATRI_POINTS_FAQS_QUES2_ANS2 _ -> "ഡിസ്കൗണ്ട് പോയിൻ്റുകൾ അതേ കാലയളവിനുള്ളിൽ ഉപയോഗിക്കേണ്ടതാണ്."
        YATRI_POINTS_FAQS_QUES2_ANS3 -> "ഈ സമയപരിധിക്കുള്ളിൽ പരിവർത്തനമോ വിനിയോഗമോ നടന്നില്ലെങ്കിൽ, പോയിൻ്റുകൾ നഷ്‌ടപ്പെടും."
        YATRI_POINTS_FAQS_QUES3 _ -> "എനിക്ക് എങ്ങനെ യാത്രി പോയിൻ്റുകൾ സമ്പാദിക്കാം?"
        YATRI_POINTS_FAQS_QUES3_ANS1 _ -> "റൈഡുകൾ, ഉപഭോക്താക്കളെ റഫർ ചെയ്യൽ തുടങ്ങിയ ആപ്പിലെ ദൈനംദിന പ്രവർത്തനങ്ങളിലൂടെയാണ് പോയിൻ്റുകൾ സമ്പാദിക്കുന്നത്. നിങ്ങൾ വ്യത്യസ്തമായി ഒന്നും ചെയ്യേണ്ടതില്ല."
        YATRI_POINTS_FAQS_QUES3_ANS2 _ -> "കുറഞ്ഞ റദ്ദാക്കലുകൾ, ഉപഭോക്താക്കളിൽ നിന്ന് നല്ല റേറ്റിംഗ് നേടൽ തുടങ്ങിയ നല്ല പെരുമാറ്റം പ്രകടിപ്പിക്കുന്നതിലൂടെ നിങ്ങൾക്ക് കൂടുതൽ പോയിൻ്റുകൾ നേടാനാകും."
        YATRI_POINTS_FAQS_QUES4 _ -> "ഞാൻ സമ്പാദിച്ച യാത്രി പോയിൻ്റുകൾ എങ്ങനെ ഉപയോഗിക്കാം?"
        ...
        YATRI_POINTS_FAQS_QUES4_ANS2 _ -> "ഭാവിയിൽ, യാത്രി പോയിൻ്റുകൾ ഉപയോഗിക്കുന്നതിന് കൂടുതൽ ഓപ്ഷനുകൾ ചേർക്കും.."
        ...
        YATRI_POINTS_FAQS_QUES6 _ -> "വിവിധ പ്രവർത്തനങ്ങൾക്കായി എനിക്ക് എത്ര പോയിൻ്റുകൾ നേടാം അല്ലെങ്കിൽ നഷ്ടപ്പെടും?"
        YATRI_POINTS_FAQS_QUES6_ANS1 _ -> "ഇനിപ്പറയുന്ന പട്ടികയെ അടിസ്ഥാനമാക്കി വിവിധ പ്രവർത്തനങ്ങൾക്കായി പോയിൻ്റുകൾ നേടുകയോ നഷ്ടപ്പെടുകയോ ചെയ്യുന്നു:"
        ...
        KNOW_ABOUT_POINTS -> "പോയിൻ്റുകൾ കുറിച്ച് അറിയുക"
        NOT_ENOUGH_POINTS_DESCRIPTION -> "നിങ്ങളുടെ നികുതി പോയിൻ്റുകൾ ബാലൻസ് പോലെ കുറഞ്ഞതാണ്. കൂടുതൽ മൂല്യം മാറ്റാൻ ദയവായി കുറഞ്ഞ മൌല്യം തെരഞ്ഞെടുക്കുക"
        SHARE -> "പങ്കിടുക"
        SHARE_NAMMA_YATRI _ -> "നമ്മുടെ യാത്രക്കാരൻ പങ്കിടുക"
        SHARE_NAMMA_YATRI_MESSAGE _ -> "ഹലോ! \n\nഇന്ത്യയിലെ ആദ്യ സീറ്റ് കമ്മിഷൻ റൈഡ് ഹെയിലിങ് ആപ്പ് പരിശോധിക്കുക. \n100% ഓപ്പൺ സോഴ്സ് | 100% ഓപ്പൺ ഡാറ്റ \n\n"
        ...
        RIDE_MORE_AND_EARN_POINTS -> "കൂടുതൽ റൈഡുകൾ ചെയ്യുക പോയിൻ്റുകൾ സമ്പാദിക്കുക"
        RIDE_MORE_EARN_MORE -> "കൂടുതൽ സവാരി ചെയ്യുക, കൂടുതൽ സമ്പാദിക്കുക!"
        TAKE_MORE_RIDES_TO_EARN_MORE_POINTS_AND_CONVERT_IT_TO_SUBSCRIPTION_DISCOUNTS -> "സബ്‌സ്ക്രിപ്ഷന്‍ ഫീ കുറഞ്ഞുപോകുന്നതിന് നാണക്കുകള്‍ ഉപയോഗിക്കാന്‍ കഴിയും."
        CHECK_YATRI_POINTS -> "യാത്രി പോയിൻ്റുകൾ പരിശോധിക്കുക"
        TWO_MORE_RIDES_TO_GO -> "ഇനി രണ്ട് റൈഡുകൾ ബാക്കി ഉണ്ട്"
        TAKE_TWO_MORE_RIDES_TO_EARN_POINTS coinValue -> "കൂടുതൽ രണ്ട് റൈഡുകൾ ചെയ്യുക പോയിൻ്റുകൾ സമ്പാദിക്കുക " <> coinValue
        ONE_MORE_RIDE_TO_GO -> "ഇനി ഒരു റൈഡ് ബാക്കി ഉണ്ട്"
        TAKE_ONE_MORE_RIDE_TO_EARN_POINTS coinValue -> "ഒരു റൈഡ് കൂടുതൽ ചെയ്യുക പോയിൻ്റുകൾ സമ്പാദിക്കുക " <> coinValue
        CONGRATULATIONS -> "അഭിനന്ദനങ്ങൾ"
        YOU_HAVE_EARNED_POINTS_FOR_COMPLETING_EIGHT_RIDES coinValue -> "നിങ്ങൾ എട്ട് റൈഡുകൾ പൂർത്തിയാക്കിയിരിക്കുന്നതിനായി " <> coinValue <> " പോയിൻ്റുകൾ സമ്പാദിച്ചിരിക്കുന്നു"
        REFER_NAMMA_YATRI_APP_TO_CUSTOMERS_AND_EARN_POINTS _ -> "ക്രിയാത്മകമായി നമ്മുടെ ആപ്പ് ഗ്രാഹകരോടുകൂടി പങ്കിടുകയും പോയിൻ്റുകൾ സമ്പാദിക്കുക"
        REFER_NOW -> "ഇപ്പോൾ പങ്കിടുക"
        CONVERT_YOUR_POINTS_TO_DISCOUNT -> "പോയിൻ്റുകൾ രൂപാന്തരിപ്പിക്കുക"
        CONVERT_YOUR_POINTS_TO_GET_DISCOUNT_ON_YOUR_SUBSCRIPTION -> "നിങ്ങളുടെ സബ്സ്ക്രിപ്ഷൻ ഡിസ്കൗണ്ട് ലഭിക്കാൻ പോയിൻ്റുകൾ രൂപാന്തരിപ്പിക്കുക"
        ...
        MERCHANT_POINTS merchant -> merchant <> " പോയിൻ്റുകൾ"
        ...
        ONLY_5_MORE_RIDES_FOR_100_POINTS -> "కేవలం 5 రైడ్‌లను కలిగి ఉంటే 100 పాయింట్లు"
        ONLY_3_MORE_RIDES_FOR_50_POINTS -> "മാത്രം മൂന്ന് റൈഡുകൾ ഉള്ളതിനാൽ 40 പോയിൻ്റുകൾ"
        YOU_GOT_N_POINTS points -> "നിങ്ങൾ " <> points <>" പോയിൻ്റുകൾ ലഭിച്ചു"
        DISCOUNTED -> "കഴിഞ്ഞു"
        YATRI_POINTS_FAQS_QUES1_ANS4 _ -> "കൂടുതൽ വിവരങ്ങൾക്ക് നിബന്ധനകളിലും വ്യവസ്ഥകളിലും ഉപയോഗ വിഭാഗം കാണുക -"
        ...
        YOU_CAN_DESCRIBE_THE_ISSUE_YOU_FACED_HERE -> "നിങ്ങൾ നേരിട്ട പ്രശ്നം ഇവിടെ വിവരിക്കാം"
        PLEASE_ENTER_A_VALID_EMAIL -> "നിങ്ങളുടെ ഇമെയിൽ ഐഡി"
        SUBMIT_REQUEST -> "അഭ്യർത്ഥന സമർപ്പിക്കുക"
        DEL_ACCOUNT -> "അക്കൗണ്ട് ഇല്ലാതാക്കുക"
        ...
        RIDE_COMPLETE -> "റൈഡ് പൂർത്തിയായി"
        HOW_WAS_YOUR_RIDE_WITH_NAME name -> name <> " ഉപയോഗിച്ചുള്ള നിങ്ങളുടെ യാത്ര എങ്ങനെയായിരുന്നു"
        HAS_PAID_YOU name -> name <> " നിങ്ങൾക്ക് പണം നൽകി"
