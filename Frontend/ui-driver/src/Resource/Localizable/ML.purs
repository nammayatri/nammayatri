...
getML stringKey =
    case stringKey of
        ...
        REFER -> "റഫർ ചെയ്യുക "
        EARN_CASH -> "പണം സമ്പാദിക്കുക"
        SHARE -> "പങ്കിടുക"
        REFERRED_CUSTOMERS_INFO -> "നിങ്ങൾ റഫർ ചെയ്ത ആദ്യ റൈഡ് വിജയകരമായി പൂർത്തിയാക്കിയ ഉപഭോക്താക്കൾ"
        REFERRED_DRIVERS_INFO -> "നിങ്ങളുടെ റഫറൽ കോഡ് സഹിതം നമ്മ യാത്രയിൽ കയറിയ ഡ്രൈവർമാർ"
        GOT_IT_TEXT -> "മനസ്സിലായി"
        CUSTOMER_TEXT -> "ഉപഭോക്താവ്"
        DRIVER_TEXT -> "ഡ്രൈവർ"
