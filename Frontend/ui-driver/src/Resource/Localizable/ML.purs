...
getML stringKey =
    case stringKey of
        ...
        RUSH_HOURS_DESC charges -> "*റഷ് ആഴറ്സിൽ, ഉയർന്ന ഗതാഗതത്തിനുള്ള ഡ്രൈവറുടെ സമയത്തിന്റെ പൂർണ്ണതയ്ക്ക് " <> charges <> "% അധിക നിരക്ക് ബാധകമാണ്."
        TOLL_OR_PARKING_CHARGES -> "^ടോൾ/ പാർക്കിംഗ് ചാർജുകൾ"
        TOLL_CHARGES_ESTIMATED -> "ടോൾ ചാർജുകൾ (അനുമാനം)^"
        RUSH_HOUR_CHARGES -> "റഷ് ആഴർ ചാർജുകൾ*"
