...
getML stringKey =
    case stringKey of
        ...
        SEVEN_DAY_FREE_TRIAL_ACTIVATED ->  "{} ദിവസത്തെ സൗജന്യ ട്രയൽ സജീവമാക്കി!"
        TAKE_UNLIMITED_RIDES_FOR_THE_NEXT_SEVEN_DAYS ->  "ആദ്യത്തെ {} ദിവസത്തേക്ക് പരിധിയില്ലാത്ത റൈഡുകൾ എടുക്കുക"
        ...
        FREE_TRIAL_REMINDER ->  "ദിവസം {}: സൗജന്യ ട്രയൽ റിമൈൻഡർ"
        PLAN_STARTS ->  "ദിവസം {}: പ്ലാൻ ആരംഭിക്കുന്നു"
