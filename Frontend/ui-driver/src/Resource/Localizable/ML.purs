...
getML stringKey =
    case stringKey of
        ...
        NEED_IT_TO_ENABLE_LOCATION (stringForConfig) -> "അപ്ലിക്കേഷൻ ഉപയോഗത്തിൽ ഇല്ലാത്തപ്പോൾ പോലും , നിങ്ങളുടെ നിലവിലെ സ്ഥാനം നിർണ്ണയിക്കാൻ നമ്മ യാത്രി പാർട്ട്നർ ആപ്പ് ലൊക്കേഷൻ ഡാറ്റ ശേഖരിക്കുന്നതായിരിക്കും."
        ...
        PAYMENT_PENDING_ALERT_DESC (stringForConfig) -> "നമ്മ യാത്രിയിൽ യാത്ര തുടരാൻ, നിങ്ങളുടെ പേയ്‌മെന്റ് കുടിശ്ശിക തീർക്കുക"
        ...
        HOW_IT_WORKS (stringForConfig) -> "ഇത് എങ്ങനെ പ്രവർത്തിക്കുന്നു"
        ...
        FIND_HELP_CENTRE (stringForConfig) -> "സഹായ കേന്ദ്രം കണ്ടെത്തുക"
        CONTACT -> "ബന്ധപ്പെടുക"
        ...
        SUBSCRIPTION_PLAN_STR (stringForConfig) -> "സബ്സ്ക്രിപ്ഷൻ പ്ലാൻ"
