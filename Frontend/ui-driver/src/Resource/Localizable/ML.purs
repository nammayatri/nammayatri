...
getML stringKey =
    case stringKey of
        ...
        ONLY_3_MORE_RIDES_FOR_50_POINTS -> "മാത്രം മൂന്ന് റൈഡുകൾ ഉള്ളതിനാൽ 50 പോയിൻ്റുകൾ"
        YOU_GOT_50_POINTS -> "നിങ്ങൾ 50 പോയിൻ്റുകൾ ലഭിച്ചു"
        YOU_GOT_10_POINTS -> "നിങ്ങൾ 10 പോയിൻ്റുകൾ ലഭിച്ചു"
        DISCOUNTED -> "കഴിഞ്ഞു"
