...
getML stringKey =
    case stringKey of
        ...
        YATRI_COINS_FAQS_QUES1_ANS1 -> "യാത്രി കോയിനുകൾ നമ്മ യാത്രിയിൽ ദിനംദിനം നടത്തുന്ന കാര്യങ്ങളിൽ നിന്നും ലഭിക്കുന്ന പ്രതിഫലങ്ങൾ ആണ്."
        YATRI_COINS_FAQS_QUES1_ANS2 -> "നേടിയ കോയിനുകൾ കൊണ്ട് നിക്ഷേപങ്ങൾ വാങ്ങുന്നതിന് മാത്രമാക്കാം."
        YATRI_COINS_FAQS_QUES1_ANS3 -> "ഭവിഷ്യത്തിൽ പൂർത്തിയാക്കാൻ പുതിയ പ്രയോജനങ്ങൾ ചേർക്കുന്നതാണ്."
        YATRI_COINS_FAQS_QUES2 -> "യാത്രി കോയിനുകൾക്ക് എത്ര കാലാവധി?"
        YATRI_COINS_FAQS_QUES2_ANS1 -> "യാത്രി കോയിനുകൾ അർജ്ജിച്ച ദിവസത്തിനുശേഷം 90 ദിവസങ്ങൾക്ക് പുറപ്പെടുന്നതാണ്. ഇനിയും, ഈ കാലാവധിയിലേക്ക് നിങ്ങൾ കോയിനുകൾ ഉപയോഗിക്കാനുള്ള അവധിയാണ്."
        YATRI_COINS_FAQS_QUES3 -> "എങ്ങനെ ഞാൻ യാത്രി കോയിനുകൾ അർജ്ജിക്കാം?"
        YATRI_COINS_FAQS_QUES3_ANS1 -> "കാര്യങ്ങൾ വഹനങ്ങളെക്കുറിച്ച്, ക്ലൈന്റുകളെ പരിചയപ്പെടുത്താൻ, നല്ല അകമ്പനികൾ പ്രാപിക്കാൻ പോകുക എന്നിവയാണ് ആപ്ലിക്കേഷനിൽ ദിനംദിനം നടത്തുന്ന പ്രവർത്തനങ്ങൾ മൂലമെന്ന് കോയിനുകൾ നേടുന്നത്."
        YATRI_COINS_FAQS_QUES3_ANS2 -> "നല്ല നടത്തം, കുറഞ്ഞ റിട്ടൺ വിവാദപ്പെടാൻ, ക്ലൈന്റുകളോട് നല്ല റേറ്റിങ്ങുകൾ കണക്കാക്കാനോ നിലവിലുള്ള അകമ്പനികളെ പ്രാപിക്കാനോ നിങ്ങൾ കോയിനുകൾ കൂടെ അധികം നേടാം."
        YATRI_COINS_FAQS_QUES4 -> "ഞാൻ അർജ്ജിച്ച യാത്രി കോയിനുകൾ എങ്ങനെ ഉപയോഗിക്കാം?"
        YATRI_COINS_FAQS_QUES4_ANS1 -> "നിക്ഷേപങ്ങൾ കാലാവധിയുള്ളിൽ കോസ്റ്റ് കിട്ടാതെ സബ്സ്ക്രിപ്ഷൻ പ്ലാനുകൾ വാങ്ങാൻ നിങ്ങൾ അർജ്ജിച്ച കോയിനുകൾ ഉപയോഗിക്കാം."
        YATRI_COINS_FAQS_QUES4_ANS2 -> "ഭവിഷ്യത്തിൽ, യാത്രി കോയിനുകൾ ഉപയോഗിക്കാൻ കൂടുതൽ ഐക്യങ്ങൾ ചേർക്കപ്പെടും."
        YATRI_COINS_FAQS_QUES5 -> "യാത്രി കോയിനുകൾ ഉപയോഗിക്കാൻ ആവശ്യമാണോ ആട്ടോപേ സ്ഥാപിക്കേണ്ടത്?"
        YATRI_COINS_FAQS_QUES5_ANS1 -> "അതെ. യാത്രി കോയിനുകൾ ഉപയോഗിക്കാൻ ആവശ്യമായത് ആട്ടോപേ സ്ഥാപിക്കേണ്ടതാണ്."
        YATRI_COINS_FAQS_QUES5_ANS2 -> "എന്നാൽ, ആട്ടോപേ സജ്ജമാക്കാതെയും നിങ്ങൾ അവയുകൊണ്ട് അധികം അർജ്ജിച്ചു നേടാം"
        YATRI_COINS_FAQS_QUES5_ANS3 -> "കോയിനുകൾ ഉപയോഗിക്കാൻ ആവശ്യമായത് മാത്രമാണ് ആട്ടോപേ സ്ഥാപിക്കേണ്ടത്."
        YATRI_COINS_FAQS_QUES6 -> "യാത്രി കോയിനുകൾ അർജ്ജിക്കാൻ എന്താണ് അർഹത?"
        YATRI_COINS_FAQS_QUES6_ANS1 -> "യാത്രി കോയിനുകൾ അർജ്ജിക്കാൻ നിങ്ങൾക്ക് നമ്മ യാത്രിയൊട്ടാകെ നിങ്ങളുടെ ആദ്യ യാത്ര പൂർത്തിയാക്കാനും വേണം."
        YATRI_COINS_FAQS_QUES6_ANS2 -> "യാത്രി കോയിനുകൾ പരിഭാഷയിൽ ചേർന്നതും നിങ്ങളുടെ ആദ്യ യാത്ര പൂർത്തിയാക്കുവാൻ വേണ്ടി അനപ്പോഴും അക്ഷമമാക്കപ്പെടുന്നതുമാണ്."
        YATRI_COINS_FAQS_QUES7 -> "എനക്ക് യാത്രി കോയിനുകൾ ഉപയോഗിക്കാതെ കഴിഞ്ഞു. ഏതെങ്കിലും കാരണം എനിക്കാണോ?"
        YATRI_COINS_FAQS_QUES7_ANS1 -> "അഭികാമ്യമല്ലാത്ത പെരുമാറ്റം ഉണ്ടാകുമ്പോൾ നാണയങ്ങൾ കുറയ്ക്കാം. ഉപഭോക്താവിൽ നിന്നുള്ള മോശം റേറ്റിംഗുകൾ, ബുക്കിംഗ് റദ്ദാക്കൽ എന്നിവ അഭികാമ്യമല്ലാത്ത പെരുമാറ്റത്തിന്റെ ഉദാഹരണങ്ങളാണ്"
