...
const tamilStrings = {
  ...
  MONTHS : "மாதங்கள்",
  PLACE_CALL_REQUEST : "இடம் அழைப்பு கோரிக்கை",
  ...
  YOUR_DUES_DESCRIPTION : "உங்கள் நிலுவைத் தொகையைச் செலுத்த, தானாகப் பணம் செலுத்தும் முறையை அமைத்துள்ளீர்கள். உங்கள் நிலுவைத் தொகை எப்போதும் சரியான நேரத்தில் செலுத்தப்படுவதை உறுதிசெய்ய நாங்கள் தானாகவே முயற்சிப்போம்.",
  CURRENT_DUES : "தற்போதைய நிலுவைத் தொகை",
  YOUR_LIMIT : "உங்கள் வரம்பு",
  DUE_DETAILS : "உரிய விவரங்கள்",
  TRIP_DATE : "பயண தேதி",
  AMOUNT : "தொகை",
  VIEW_DUE_DETAILS : "கட்டண விவரங்களைக் காண்க",
  SETUP_AUTOPAY : "தானாக செலுத்துதலை அமைக்கவும்",
  CURRENT_PLAN : "தற்போதைய திட்டம்",
  ALTERNATE_PLAN : "மாற்றுத் திட்டம்",
  AUTOPAY_DETAILS : "தானாகச் செலுத்தும் விவரங்கள்",
  CANCEL_AUTOPAY_STR : "தானாகச் செலுத்துவதை ரத்துசெய்",
  WE_MIGHT_BE_LOST : "ஓ! நாம் தொலைந்து போகலாம்",
  EXEPERIENCING_ERROR : "பிழையை அனுபவிக்கிறது",
  ENJOY_THESE_BENEFITS : "இந்த நன்மைகளை அனுபவிக்கவும்",
  CHOOSE_YOUR_PLAN : "இப்போது ஒரு திட்டத்தைத் தேர்ந்தெடுங்கள்!",
  GET_FREE_TRAIL_UNTIL : "வரை இலவச சோதனையைப் பெறுங்கள்",
  CLEAR_DUES : "தெளிவான நிலுவைத் தொகைகள்",
  PAYMENT_PENDING_ALERT : "⚠️ கட்டணம் நிலுவையில் உள்ளது! ⚠️",
  PAYMENT_PENDING_ALERT_DESC : "நம்ம யாத்ரியில் தொடர்ந்து சவாரி செய்ய, உங்கள் கட்டண நிலுவைத் தொகையைச் செலுத்துங்கள்",
  LOW_ACCOUNT_BALANCE : "குறைந்த கணக்கு இருப்பு",
  LOW_ACCOUNT_BALANCE_DESC : "உங்கள் பேங்க் அக்கவுண்ட் பேலன்ஸ் குறைவாக உள்ளது. தடையின்றி சவாரி செய்து மகிழ பணத்தைச் சேர்க்கவும்.",
  OKAY_GOT_IT : "சரி, புரிந்தது",
  LIMITED_TIME_OFFER : "உங்களுக்கு வரையறுக்கப்பட்ட நேரச் சலுகை!",
  JOIN_NOW : "இப்போது சேரவும்",
  AUTOMATIC_PAYMENTS_WILL_APPEAR_HERE : "தானியங்கு பணம் இங்கே தோன்றும்",
  MANUAL_PAYMENTS : "கைமுறையாக பணம் செலுத்துதல்",
  MANUAL_PAYMENTS_WILL_APPEAR_HERE : "கைமுறையாக பணம் செலுத்துவது இங்கே தோன்றும்",
  NO_AUTOMATIC_PAYMENTS_DESC : "உங்களிடம் கட்டணம் வசூலிக்கப்பட்டவுடன் உங்கள் தானாகச் செலுத்தும் வரலாறு இங்கே தோன்றும்",
  NO_MANUAL_PAYMENTS_DESC : "ஏதேனும் இருந்தால், நிலுவைத் தொகையைச் செலுத்துவதற்கான உங்கள் கட்டண வரலாறு இங்கே தோன்றும்.",
  PAYMENT_HISTORY : "கட்டண வரலாறு",
  DO_A_ONE_TIME_SETTLEMENT : "ஒருமுறை தீர்வு செய்யுங்கள்",
  TAP_A_PLAN_TO_VIEW_DETAILS : "விவரங்களைப் பார்க்க ஒரு திட்டத்தைத் தட்டவும்",
  ...
  VIEW_AUTOPAY_DETAILS : "தானாகச் செலுத்தும் விவரங்களைக் காண்க",
  SWITCH_AND_SAVE : "மாறி சேமி",
  SWITCH_AND_SAVE_DESC : "இன்று 7 ரைடுகளுக்கு மேல் முடித்துவிட்டீர்கள். தினசரி வரம்பற்ற திட்டத்திற்கு மாறுவதன் மூலம் ₹10 வரை சேமிக்கவும்",
  SWITCH_NOW : "இப்போது மாறு",
  PAYMENT_MODE_CHANGED_TO_MANUAL : "கட்டண முறை கைமுறையாக மாற்றப்பட்டது",
  PAYMENT_MODE_CHANGED_TO_MANUAL_DESC : "உங்கள் UPI தானியங்குப்பணத்தை இடைநிறுத்திவிட்டீர்கள். உங்கள் நிலுவைத் தொகையை கைமுறையாகச் செலுத்தலாம்.",
  AUTOPAY_PAYMENTS : "தானாக பணம் செலுத்துதல்",
  TRANSACTION_ON : "பரிவர்த்தனை ஆன்",
  SUCCESS : "வெற்றி",
  PAID_ON : "பணம் செலுத்தப்பட்டது",
  RIDES_TAKEN_ON : "ரைட்ஸ் எடுக்கப்பட்டது",
  JOIN_PLAN : "திட்டத்தில் சேரவும்",
  JOIN_NAMMAA_YATRI : "நம்ம யாத்ரியில் சேரவும்",
  CANCEL_AUTOPAY_AND_PAY_MANUALLY : "தானாகச் செலுத்துவதை ரத்துசெய்து கைமுறையாகச் செலுத்து",
  PLAN_ACTIVATED_SUCCESSFULLY : "திட்டம் வெற்றிகரமாக செயல்படுத்தப்பட்டது",
  DUES_CLEARED_SUCCESSFULLY : "பாக்கிகள் வெற்றிகரமாக அழிக்கப்பட்டன",
  ...
  ENABLE_AUTOPAY_DESC : "தொந்தரவு இல்லாத கட்டணங்களைத் தொடங்க, தானாகப் பணம் செலுத்துவதை இப்போது இயக்கு!",
  ENABLE_AUTOPAY_NOW : "இப்போது தானாகச் செலுத்துவதை இயக்கு",
  PAYMENT_PENDING_STR : "கட்டணம் நிலுவையில் உள்ளது!",
  PAYMENT_PENDING_DESC_STR : "உங்கள் கட்டணம் செயல்படுத்தப்படுகிறது.\nபுதுப்பிப்பு வரும்போது நாங்கள் உங்களுக்குத் தெரிவிப்போம்.",
  REFRESH_STR : "புதுப்பித்தல்",
  TRANSACTION_DETAILS : "பரிவர்த்தனை விவரங்கள்",
  RIDE_DETAILS : "சவாரி விவரங்கள்",
  NAMMA_YATRI_PLANS : "எங்கள் யாத்ரி திட்டங்கள்",
  SWITCH_TO : "இதற்கு மாறு",
  PLEASE_TRY_AGAIN : "தயவு செய்து மீண்டும் முயற்சிக்கவும்",
  ...
  FIRST_FREE_RIDE : "முதல் இலவச சவாரி",
  JOIN_THE_UNLIMITED_PLAN : "ஒரு நாளைக்கு ₹1 கட்டணத்தில் UNLIMITED திட்டத்தில் சேர்ந்து 96% சேமிக்கவும்!!",
