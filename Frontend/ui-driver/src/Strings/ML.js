...
const mlStrings = {
  INACCURATE_DATE_AND_TIME: "غلط تاریخ اور وقت!",
  ADJUST_YOUR_DEVICE_DATE_AND_TIME_AND_TRY_AGAIN: "براہ کرم اپنے آلہ کی تاریخ اور وقت کو درست کریں اور دوبارہ کوشش کریں",
  THE_CURRENT_DATE_AND_TIME_IS: "موجودہ تاریخ اور وقت ہے",
  GO_TO_SETTING: "ترتیبات میں جائیں",
  LETS_GET_STARTED: "آئیے شروع کرتے ہیں",
  YOUR_APPLICATION_HAS_BEEN_SUBMITTED_SUCCESSFULLY_AND_IS_UNDER_VERIFICATION: "آپ کی درخواست کامیابی سے جمع ہوگئی ہے اور تصدیق کے زیر ہے",
  VIEW_STATUS: "حالت دیکھیں",
  GO_HOME: "ہوم پر جائیں",
  SELECT_LANGUAGE: "زبان منتخب کریں",
  WHICH_LANGUAGE_DO_YOU_PREFER: "آپ کو کون سی زبان پسند ہے؟",
  NEXT: "اگلے",
  T_C: "شرائط و ضوابط",
  ENTER_MOBILE_NUMBER: "موبائل نمبر درج کریں",
  BY_CLICKING_CONTINUE_YOU_WILL_BE_AGREEING_TO_OUR: "جاری رکھنے پر کلک کرکے آپ ہمارے متفق ہوں گے",
  ENTER_OTP: "OTP درج کریں",
  DIDNT_RECIEVE_OTP: "OTP موصول نہ ہوا؟",
  RESEND_OTP: "OTP دوبارہ بھیجیں",
  PLEASE_ENTER_VALID_OTP: "براہ کرم صحیح OTP درج کریں",
  INVALID_MOBILE_NUMBER: "غلط موبائل نمبر",
  REGISTER: "رجسٹر کریں",
  MOBILE_NUMBER: "موبائل نمبر",
  AUTO_READING_OTP: "OTP خود کر رہا ہے...",
  UPLOAD_DRIVING_LICENSE: "ڈرائیونگ لائسنس اپلوڈ کریں",
  UPLOAD_BACK_SIDE: "ڈی ال کی پچھلا حصہ اپلوڈ کریں",
  UPLOAD_FRONT_SIDE: "ڈی ال کا سامنا حصہ اپلوڈ کریں",
  BACK_SIDE: "پچھلا حصہ",
  FRONT_SIDE: "سامنا حصہ",
  LICENSE_INSTRUCTION_PICTURE: "براہ کرم لائسنس کی دونوں طرفوں کی تصاویر اپلوڈ کریں",
  LICENSE_INSTRUCTION_CLARITY: "فوٹو اور تمام تفصیلات واضح ہونی چاہئے",
  REGISTRATION_STEPS: "رجسٹریشن مراحل",
  PROGRESS_SAVED: "آپ کی پیش رفت محفوظ ہوگئی ہے، آپ کسی بھی معلومات میں تبدیلی کرنے کے لئے پچھلے مراحل پر واپس جا سکتے ہیں",
  DRIVING_LICENSE: "ڈرائیونگ لائسنس",
  AADHAR_CARD: "آدھار کارڈ",
  BANK_DETAILS: "بینک کی تفصیلات",
  VEHICLE_DETAILS: "گاڑی کی تفصیلات",
  UPLOAD_FRONT_BACK: "دونوں طرفوں کی تصویر اپ لوڈ کریں",
  EARNINGS_WILL_BE_CREDITED: "آپ کی کمائی یہاں منتقل ہوگی",
  FILL_VEHICLE_DETAILS: "گاڑی کی تفصیلات درج کریں",
  FOLLOW_STEPS: "رجسٹریشن کے لیے مندرجہ ذیل اقدامات پر عمل کریں",
  REGISTRATION: "رجسٹریشن",
  UPLOAD_ADHAAR_CARD: "آڈھار کارڈ اپ لوڈ کریں",
  ADHAAR_INTRUCTION_PICTURE: "آڈھار کارڈ کی دونوں طرفوں کی تصویر اپ لوڈ کریں",
  ADD_VEHICLE_DETAILS: "گاڑی کی تفصیلات شامل کریں",
  VEHICLE_REGISTRATION_NUMBER: "گاڑی کا رجسٹریشن نمبر",
  RE_ENTER_VEHICLE_REGISTRATION_NUMBER: "گاڑی کا رجسٹریشن نمبر دوبارہ درج کریں",
  ENTER_VEHICLE_NO: "گاڑی کا نمبر درج کریں",
  VEHICLE_TYPE: "گاڑی کی قسم",
  VEHICLE_MODEL_NAME: "گاڑی کے ماڈل کا نام",
  ENTER_MODEL_NAME: "ماڈل کا نام درج کریں",
  VEHICLE_COLOUR: "گاڑی کا رنگ",
  ENTER_VEHICLE_COLOUR: "گاڑی کے رنگ کو درج کریں",
  UPLOAD_REGISTRATION_CERTIFICATE: "رجسٹریشن سرٹیفیکیٹ اپ لوڈ کریں",
  UPLOAD_RC: "RC اپ لوڈ کریں",
  PREVIEW: "پریویو",
  CHOOSE_VEHICLE_TYPE: "گاڑی کی قسم منتخب کریں",
  BENIFICIARY_NUMBER: "فائدہ اٹھانے والے کا اکاؤنٹ نمبر",
  RE_ENTER_BENIFICIARY_NUMBER: "فائدہ اٹھانے والے کا اکاؤنٹ نمبر دوبارہ درج کریں",
  IFSC_CODE: "IFSC کوڈ",
  SENDING_OTP: "OTP بھیج رہا ہے",
  PLEASE_WAIT_WHILE_IN_PROGRESS: "براہ کرم انتظار کریں جب تک عمل میں ہو",
  YOUR_REQUEST_HAS_TIMEOUT_TRY_AGAIN: "آپ کی درخواست کا وقت ختم ہوگیا، براہ کرم دوبارہ کوشش کریں",
  ERROR_OCCURED_PLEASE_TRY_AGAIN_LATER: "خرابی واقع ہوئی، براہ کرم بعد میں دوبارہ کوشش کریں",
  ENTER_OTP_SENT_TO: "درج کریں OTP جو بھیجا گیا",
  OTP_SENT_TO: "OTP بھیج دیا گیا",
  COUNTRY_CODE_INDIA: "91",
  ENTER_ACCOUNT_NUMBER: "اکاؤنٹ نمبر درج کریں",
  ADD_BANK_DETAILS: "بینک کی تفصیلات شامل کریں",
  ENTER_IFSC_CODE: "IFSC کوڈ درج کریں",
  SUBMIT: "جمع کرائیں",
  PERSONAL_DETAILS: "ذاتی تفصیلات",
  LANGUAGES: "زبانیں",
  HELP_AND_FAQ: "مدد اور عمومی سوالات",
  ...
  LOGO: "لوگو",
  ABOUT_APP_DESCRIPTION: "ہمارا سفر کا شریک ایک کھلا پلیٹ فارم ہے جو مسافرین کو ڈرائیورز سے جوڑتا ہے۔ اس ایپلیکیشن کی مدد سے ڈرائیورز مخصوص شرح پر سواروں کو تلاش کر سکتے ہیں۔ سواروں پر کوئی کمیشن نہیں ہے، صرف مہینے کی چھوٹی سی رقم کی اشتراک کی ضرورت ہے",
  TERMS_AND_CONDITIONS: "شرائط و ضوابط",
  UPDATE_VEHICLE_DETAILS: "گاڑی کی تفصیلات اپ ڈیٹ کریں",
  Help_AND_SUPPORT: "مدد اور حمایت",
  NOTE: "نوٹ",
  VISIT_MY_RIDES_SCREEN_FOR_SPECIFIC_COMPLAINTS: "مخصوص شکایات کے لئے 'میری سواریوں' کے حصے کو دیکھیں",
