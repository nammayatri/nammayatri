...
fetchAndUpdateLocationUpdateServiceVars stage frequentLocationUpdates tripType = do
  ...
  void $ pure $ Storage.setValueToLocalStore LOCATION_FRESHNESS_THRESHOLD_KEY locationUpdateServiceConfig.freshnessThreshold
  void $ pure $ Storage.setValueToLocalStore LOCATION_UPDATE_INTERVAL_KEY locationUpdateServiceConfig.updateInterval
  void $ pure $ Storage.setValueToLocalStore LOCATION_BATCH_INTERVAL_KEY locationUpdateServiceConfig.batchInterval
