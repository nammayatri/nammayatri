...
import Prelude
import ReactComponents.Calendar.Controller (ComponentOutput(..), Action(..), Config, dummyDateItem)
...
import React.Basic.Hooks (JSX, Component, component)
...
app push = do
  component "calendar" \initialState -> React.do
    pure $ view push initialState

view :: (ComponentOutput -> Effect Unit) -> Config -> JSX
view push state =
  linearLayout
  { width: "match_parent"
  , height: "match_parent"
...
-- calendarView :: (Action -> Effect Unit) -> Config -> JSX
-- calendarView = do
--   linearLayout
--     { width: "wrap_content"
--     , height: "wrap_content"
...
-- app :: (Action -> Effect Unit) -> Component Config
-- view push = do
--   component "calendar" \initialState -> React.do
--     pure $ view push initialState

-- view :: (Action -> Effect Unit) -> Config -> JSX
-- view =
--   linearLayout
--   [ width: "match_p"
--   ]
