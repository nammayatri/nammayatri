                        ...
                        [ if (key == "back" || key == "done") then
                            linearLayout
                              ...
                              , clickable
                                  if key == "back" then
                                    true
                                  else if ((length state.inputTextConfig.text == 4 && state.modalType == KeyboardModalType.OTP && not state.otpIncorrect) || (length state.inputTextConfig.text == 10 && state.modalType == KeyboardModalType.MOBILE__NUMBER && state.isValidAlternateNumber)) then true else false
                              ]
                              [ if key == "back" then
                                  imageView
                                    [ width $ V 24
