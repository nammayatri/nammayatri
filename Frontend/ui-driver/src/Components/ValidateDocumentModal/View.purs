...
view push state =
  ...
  mkVerificationText status = case status of
  ...
  inProgressText verificationType =
    getString
      if verificationType == "DL" then
        DL_UPLOADING
      else
        RC_UPLOADING

  successText :: String -> String
  successText verificationType =
    ( getString
        if verificationType == "DL" then
          DL_UPLOADED
        else
