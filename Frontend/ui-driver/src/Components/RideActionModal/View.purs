...
rideActionView layoutMargin push config =
  ...
  , stroke $ "1," <> Color.grey800
    ...
    , bottomPlatformInfoBar INVISIBLE
  ]
...
bottomPlatformInfoBar :: forall w. Visibility -> PrestoDOM (Effect Unit) w
bottomPlatformInfoBar visible =
  linearLayout
  [ height $ V 45
  , width MATCH_PARENT
  , background Color.black900
  , alignParentBottom "true,-1"
  , id $ getNewIDWithTag "bottomPlatformInfoBar"
  , clickable true
  , orientation VERTICAL
  , visibility visible
  ][ linearLayout
