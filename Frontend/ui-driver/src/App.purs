...
newtype GlobalState = GlobalState {
  ...
  , customerReferralTrackerScreen :: CustomerReferralTrackerScreenData.CustomerReferralTrackerScreenState
  }
...
data ScreenType =
  ...
  | CustomerReferralTrackerScreenStateType (CustomerReferralTrackerScreenData.CustomerReferralTrackerScreenState -> CustomerReferralTrackerScreenData.CustomerReferralTrackerScreenState)
...
data CUSTOMER_REFERRAL_TRACKER_SCREEN_OUTPUT = REFRESH_TRACKING_SCREEN CustomerReferralTrackerScreenData.CustomerReferralTrackerScreenState
                                               | ADD_UPI_FLOW CustomerReferralTrackerScreenData.CustomerReferralTrackerScreenState