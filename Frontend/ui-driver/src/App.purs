...
data PERMISSIONS_SCREEN_OUTPUT = DRIVER_HOME_SCREEN | LOGOUT_FROM_PERMISSIONS_SCREEN | FCM_NOTIFICATION_PERMISSION String NotificationBody | GO_TO_REGISTERATION_SCREEN PermissionsScreenState | GO_TO_FAQS_SCREEN_FROM_PERMISSIONS PermissionsScreenState | SELECT_LANG_SCREEN PermissionsScreenState
