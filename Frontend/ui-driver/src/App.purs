...
data METER_RIDE_SCREEN_OUTPUT = ENTER_DESTINATION MeterRideScreenState | GO_TO_DRIVER_PROFILE MeterRideScreenState | START_METER_RIDE MeterRideScreenState | END_METER_RIDE MeterRideScreenState | UPDATE_RATE_CARD_API MeterRideScreenState Int