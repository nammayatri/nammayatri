...
data BOOKING_OPTIONS_SCREEN_OUTPUT = SELECT_CAB BookingOptionsScreenState Boolean | ENABLE_RENTAL_RIDE BookingOptionsScreenState Boolean | GO_TO_PROFILE | CHANGE_RIDE_PREFERENCE BookingOptionsScreenState RidePreference | UPDATE_AC_AVAILABILITY BookingOptionsScreenState Boolean | HOME_SCREEN_FROM_BOOKING_PREFS
...
data RIDE_SUMMARY_SCREEN_OUTPUT = GO_TO_HOME_FROM_RIDE_SUMMARY
