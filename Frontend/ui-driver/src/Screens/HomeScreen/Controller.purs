...
import Components.FavouritePopUp.Controller(Action(..)) as FavouritePopUp
...
data ScreenOutput =   Refresh ST.HomeScreenState
                    ...
                    | FcmNotification String (Maybe ST.NotificationBody) ST.HomeScreenState
...
data Action = NoAction
            ...
            | ScreenClick
            | BookingOptions
            | Notification String (Maybe ST.NotificationBody)
            ...
            | GetRideCount Int
            | FavouritePopUpAction FavouritePopUp.Action
...
eval (FavouritePopUpAction (FavouritePopUp.OnClickDone PrimaryButtonController.OnClick)) state = continue state{data{favPopUp{visibility = false}}}
