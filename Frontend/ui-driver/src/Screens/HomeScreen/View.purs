        ...
        , padding $ Padding 16 10 10 10
         ...
         , linearLayout
           ...
           , onClick push $ const $ if cityConfig.showEarningSection then ToggleStatsModel else NoAction
              ...
              [ width WRAP_CONTENT
              , height WRAP_CONTENT
              , text $ "R$" <> formatCurrencyWithCommas (show state.data.totalEarningsOfDay)
              , color Color.black800
...
expandedStatsModel push state =
  ...
  , clickable true
      ...
      , commonTV push ("R$" <> formatCurrencyWithCommas (show state.data.totalEarningsOfDay)) Color.black800 FontStyle.h2 RIGHT 0 ToggleStatsModel false state.data.driverStats
      , imageView 
        [ width $ V 12
        , height $ V 12
        , margin $ MarginLeft 5
    ...
    , linearLayout
      ...
      , visibility $ boolToVisibility $ isJust state.data.earningPerKm
        ...
        , commonTV push ("R$" <> earningPerKm <> "/km") Color.black800 FontStyle.subHeading1 RIGHT 0 NoAction true state.data.driverStats
      ]
    , separatorView 10
    , textView $
      [ width MATCH_PARENT
