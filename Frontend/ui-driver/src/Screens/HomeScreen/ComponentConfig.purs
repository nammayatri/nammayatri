...
vehicleNotSupportedPopup state = 
  let cityConfig = state.data.cityConfig
      vehicle = state.data.vehicleType
      vehicleIs = case vehicle of
        _ | elem vehicle ["AMBULANCE_TAXI", "AMBULANCE_TAXI_OXY", "AMBULANCE_AC", "AMBULANCE_AC_OXY", "AMBULANCE_VENTILATOR"] -> getString AMBULANCE
        _ -> HU.getVehicleType vehicle
  in PopUpModal.config {
      ...
      margin = MarginHorizontal 25 25, 
      primaryText {
        text = vehicleIs <> getString IS_NOT_SUPPORTED_YET
      , textStyle = Heading2
      , margin = Margin 16 0 16 10},
      secondaryText{
        text = getString $ WE_WILL_NOFITY_YOU_WHEN_IT_IS_AVAILABLE vehicleIs
      , textStyle = Body5
      , margin = Margin 16 0 16 15 },
      option1 {
        text = getString OKAY
      ...
      coverImageConfig {
        imageUrl = case state.data.linkedVehicleCategory of 
                   ...
                   _ -> spy "Image iss" $ fetchImage FF_ASSET cityConfig.vehicleNSImg
      , visibility = VISIBLE
      , margin = MarginHorizontal 16 16
      , width = V 300
      , height = V 315
...
getCoinEarnedPopupConfig state = case state.props.coinPopupType of
  ...
  ST.EIGHT_RIDE_COMPLETED -> createCoinPopupConfig (getString RIDE_MORE_EARN_MORE) (getString $ LIMITED_TIME_OFFER_UNTIL ((EHC.convertUTCtoISC (runFn2 EHC.getDateMinusNDays state.data.config.coinsConfig.monsoonOfferDate 1) "Do MMM"))) true (getString CHECK_YATRI_POINTS) (getString CHECK_YATRI_POINTS) false (HU.fetchImage HU.COMMON_ASSET "ny_ic_eight_rides_completed") "" (getString CONGRATULATIONS <> "🎉") "" true false
  ST.FIVE_RIDE_COMPLETED -> createCoinPopupConfig (getString ONLY_5_MORE_RIDES_FOR_100_POINTS) (getString $ LIMITED_TIME_OFFER_UNTIL ((EHC.convertUTCtoISC (runFn2 EHC.getDateMinusNDays state.data.config.coinsConfig.monsoonOfferDate 1) "Do MMM"))) true (getString CHECK_YATRI_POINTS) (getString CHECK_YATRI_POINTS) false (HU.fetchImage HU.COMMON_ASSET "ny_ic_five_rides_completed_v2") "" (getString CONGRATULATIONS <> "🎉") (getString $ YOU_GOT_N_POINTS "40") true true
  ST.TEN_RIDE_COMPLETED -> createCoinPopupConfig (getString RIDE_MORE_EARN_MORE) (getString $ LIMITED_TIME_OFFER_UNTIL ((EHC.convertUTCtoISC (runFn2 EHC.getDateMinusNDays state.data.config.coinsConfig.monsoonOfferDate 1) "Do MMM"))) true (getString CHECK_YATRI_POINTS) (getString CHECK_YATRI_POINTS) false (HU.fetchImage HU.COMMON_ASSET "ny_ic_ten_rides_completed") "" (getString CONGRATULATIONS <> "🎉") "" true false
  ST.TWO_RIDE_COMPLETED -> createCoinPopupConfig (getString ONLY_3_MORE_RIDES_FOR_50_POINTS) (getString $ LIMITED_TIME_OFFER_UNTIL ((EHC.convertUTCtoISC (runFn2 EHC.getDateMinusNDays state.data.config.coinsConfig.monsoonOfferDate 1) "Do MMM"))) true (getString CHECK_YATRI_POINTS) (getString CHECK_YATRI_POINTS) false (HU.fetchImage HU.COMMON_ASSET "ny_ic_two_rides_completed_v2") "" (getString CONGRATULATIONS <> "🎉") (getString $ YOU_GOT_N_POINTS "10") true true
