...
import Screens.HomeScreen.ScreenData (dummyAvailableRoutes, dummyBusVehicleDetails)
import Data.Lens ((^.))
...
linkTripModalPopup state = 
  let 
    (availableRoutesList) = fromMaybe [] state.data.whereIsMyBusData.availableRoutes
    ...
    , option1 {
      ...
      , strokeColor = Color.black900
      , color = Color.yellow900
      , text = StringsV2.getStringV2 LT2.link_trip
...
selectBusRoutePopupConfig state = 
  ...
  PopUpModal.config {
    ...
    searchableListConfig {
      title = StringsV2.getStringV2 LT2.route_bus_number,
      visibility = VISIBLE,
      isSearchable = false,
      ...
      selectedValue = state.props.whereIsMyBusConfig.selectedRoutes,
...
selectBusDriverPopupConfig state =
  ...
  PopUpModal.config {
    ...
    searchableListConfig {
      ...
      mainContainerMargin = Margin 0 0 0 0,
      mainContainerPadding = Padding 0 0 0 0,
      selectedValue = state.props.whereIsMyBusConfig.selectedFleetDriverBadge,
      optionConfig {
        margin = Margin 0 16 0 8,
        padding = Padding 20 16 20 16,
        background = Color.white900,
      ...
      hasMoreOptions = state.props.whereIsMyBusConfig.showLoadMoreForDrivers
    }
  }
...
selectBusConductorPopupConfig state =
  ...
  PopUpModal.config {
    ...
    searchableListConfig {
      ...
      mainContainerMargin = Margin 0 0 0 0,
      mainContainerPadding = Padding 0 0 0 0,
      selectedValue = state.props.whereIsMyBusConfig.selectedFleetConductor,
      optionConfig {
        margin = Margin 0 16 0 8,
        padding = Padding 20 16 20 16,
        background = Color.white900,
      ...
      hasMoreOptions = state.props.whereIsMyBusConfig.showLoadMoreForConductors
    }
  }
    ...
    mkConfig (API.TripTransactionDetails tripDetails) =
        ...
        in
          config {
            ...
            driverBadgeName = fromMaybe "--" tripDetails.driverName
          }
