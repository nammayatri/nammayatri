...
convertCoinsView push state = 
  linearLayout
    ...
    , orientation VERTICAL
      ...
      , alertView push "ny_ic_warning_unfilled_red" "Minimum 250 coins is required for conversion" false Color.redOpacity16 8.0 (Margin 16 20 16 0)
...
coinsUsageAlertView push state = 
  ...
  --     , gravity CENTER
  --     ] [ imageView
  --         [ imageWithFallback $ "ny_ic_check_green,"
  --         , height $ V 14
  --         , width $ V 14
  --         , margin $ Margin 24 16 8 16
  --         ]  
  --       , textView $ [
  --           text "₹25 has been adjusted in your\nsubscription dues"
  --         , color Color.black700
  ...
  --     , gravity CENTER
  --     ] [ imageView
  --         [ imageWithFallback $ "ny_ic_info_yellow,"
  --         , height $ V 14
  --         , width $ V 14
  --         , margin $ Margin 24 16 8 16
  --         ]  
  --       , textView $ [
  --           text "₹50 will be adjusted in your future subscription dues"
  --         , color Color.black700
  -- , padding $ Padding 16 16 16 16
  --         , weight 1.0
  --         ] <> FontStyle.tags TypoGraphy
...
convertView push state = 
  ...
  , linearLayout
    ...
    , background Color.white900
    , stroke $ "1," <> Color.grey900
    , alpha if state.data.coinsToUse < 250 then 0.6 else 1.0
    , clickable $ state.data.coinsToUse >= 250
    , padding $ Padding 16 16 16 16
    ][  frameLayout
          [ height MATCH_PARENT
          , width MATCH_PARENT
              ...
              , gravity CENTER
                ...
                , Anim.screenAnimationFadeInOut $ linearLayout
                  ...
                  , onAnimationEnd (\action -> runEffectFn7 renderSlider (getNewIDWithTag "ConvertCoinsSliderView") push SliderCallback 10.0 250 2500 100
                      )(const AfterRender)
                  ][]
                , textView $ [
                    text "2500"
            ...
            , linearLayout
              [ height MATCH_PARENT
              , width MATCH_PARENT
              , visibility if state.data.coinsToUse < 250 then VISIBLE else GONE
              , clickable true
              ][]
          ]
        , PrimaryButton.view (push <<< PrimaryButtonActionController) (primaryButtonConfig (state.data.coinsToUse >= 250))
      ]
  ]
