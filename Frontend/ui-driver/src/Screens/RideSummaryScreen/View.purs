...
includedChargesBox state push =  
    let 
      (BookingAPIEntity entity) = state.data.rideDetails
      dummyFare = RateCardItem{ price : 23, priceWithCurrency : {amount:43.0, currency:"INR"}, title : UNPLANNED_PER_KM_CHARGE }
      ...
      linearLayout
        ...
        , linearLayout
            ...
            [ (case tripCategory.tag of 
                ...
                _ -> chargesTile "Pickup Charges" ("₹"<>(show fare.price)) true state push)
            , linearLayout 
                [ width WRAP_CONTENT
                , height $ V 24
                , weight 1.0
            ...
            -- , chargesTile "Extra Distance Charges*" "Rs50/hr" (tripCategory.tag /= CTA.InterCity)  state push 
