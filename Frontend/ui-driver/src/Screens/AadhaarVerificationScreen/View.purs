  ...
  , linearLayout
    ...
    , clickable state.props.isDateClickable
      ...
      [ width MATCH_PARENT
        ...
        ([ text if isEmpty state.data.driverDob then (getString SELECT_DATE_OF_BIRTH) else state.data.driverDob
        , color if isEmpty state.data.driverDob then Color.darkGrey else Color.greyTextColor
        , weight 1.0
