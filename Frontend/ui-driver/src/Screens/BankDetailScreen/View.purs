...
screen :: ST.BankDetailScreenState -> LoggableScreen Action ST.BankDetailScreenState ScreenOutput
screen initialState =
  { initialState
  , view
  ...
  , eval
  , parent : Nothing
  , logWhitelist : initialState.data.config.logWhitelistConfig.bankDetailScreenLogWhitelist
  }
