...
frontUploadSection state push =
  ...
  , linearLayout
    ...
    , if (state.data.imageFront /= "") then previewIcon state push "front" else
      ...
      [ width ( V 20 )
      , height ( V 20 )
      , imageWithFallback $ "ny_ic_upload," <> (getCommonAssetStoreLink FunctionCall) <> "/driver/images/ny_ic_upload.png"
      ]
    ]
  ]
...
instructionSectionView state = 
  linearLayout
    ...
    , margin (MarginBottom 10)
      ...
      [ width ( V 100 )
      , height ( V 100 ) 
      , imageWithFallback $ "ny_ic_aadhaar," <> (getCommonAssetStoreLink FunctionCall) <> "/driver/images/ny_ic_aadhaar.png"
      ]
    , textView
      ([ width WRAP_CONTENT
    ...
    , linearLayout
      ...
      , margin (Margin 0 11 0 11)
        ...
        , imageWithFallback $ "ny_ic_text_pointer_right," <> (getCommonAssetStoreLink FunctionCall) <> "/driver/images/ny_ic_text_pointer_right.png"
        ]
      , textView
  ...
  linearLayout
    ...
    , gravity CENTER
      ...
      , imageView
          ...
          , imageWithFallback $ "ny_ic_cancel," <> (getCommonAssetStoreLink FunctionCall) <> "/driver/images/ny_ic_cancel.png"
