...
instance loggableAction :: Loggable Action where
  performLog action appId = case action of
    ...
    BackPressed flag -> do
      ...
      if flag then
        trackAppScreenEvent appId (getScreen ABOUT_US_SCREEN) "in_screen" "backpress_in_demo_mode_popup"
      else
...
data Action
  ...
  | AfterRender
  | ShowDemoPopUp
  | PopUpModalDemoModeAction PopUpModal.Action
