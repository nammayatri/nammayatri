...
data StageStatus = COMPLETED | IN_PROGRESS | NOT_STARTED | FAILED | MANUAL_VERIFICATION_REQUIRED | UNAUTHORIZED | PENDING_REVIEW
...
type DriverProfileScreenData = {
  ...
  cachedVehicleCategory :: Common.VehicleCategory
}
