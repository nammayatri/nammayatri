...
type MeterMapScreenState = {
  data :: MeterMapScreenData,
  props :: MeterMapScreenProps
}
...
type MeterMapScreenProps = {
  ...
  searchLocationModelProps :: SearchLocationModelProps,
  isSearchLocation :: SearchLocationModelType,
  rideSearchProps ::  RideSearchPropsMap
}
...
type RideSearchProps = {
  sourceSelectType :: CustomerLocationSelectType,
  sourceManuallyMoved :: Boolean,
  destManuallyMoved :: Boolean 
}

type RideSearchPropsMap = {
  sourceSelectType :: CustomerLocationSelectType
}
