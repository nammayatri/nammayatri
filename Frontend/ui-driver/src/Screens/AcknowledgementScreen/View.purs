...
screen :: ST.AcknowledgementScreenState -> LoggableScreen Action ST.AcknowledgementScreenState ScreenOutput
screen initialState =
  { initialState
  , view
  ...
  , parent : Nothing
  , logWhitelist: initialState.data.config.logWhitelistConfig.acknowledgementScreenLogWhitelist
  }
