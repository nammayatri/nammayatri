...
import Screens.Types(VehicleDetailsScreenState, VehicalTypes(..) , AmbulanceVariant(..))
...
initData = {
  data:  {
    ...
    vehicleTypes : [Sedan, Hatchback, SUV, Auto, Bike, Ambulance Taxi, Ambulance AC, Ambulance AC_Oxy, Ambulance Taxi_Oxy, Ambulance Ventilator],
    vehicleRegNumber : "",
    vehicleType : "",
    vehicleModel : "",
    vehicleColor : ""
