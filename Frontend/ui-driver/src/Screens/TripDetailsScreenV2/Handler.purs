...
module Screens.TripDetailsScreenV2.Handler where

import Prelude ( bind , ($), pure, (<$>))
import Engineering.Helpers.BackTrack (getState)
import Screens.TripDetailsScreenV2.Controller (ScreenOutput(..))
import Control.Monad.Except.Trans (lift)
import Control.Transformers.Back.Trans as App
import PrestoDOM.Core.Types.Language.Flow (runScreen)
import Screens.TripDetailsScreenV2.View as TripDetailsScreen
import Types.App (FlowBT, GlobalState(..), TRIP_DETAILS_SCREEN_OUTPUT(..))

tripDetailsScreenV2 :: FlowBT String TRIP_DETAILS_SCREEN_OUTPUT
tripDetailsScreenV2 = do
