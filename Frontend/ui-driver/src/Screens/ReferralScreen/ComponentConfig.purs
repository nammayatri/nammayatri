...
genericHeaderConfig state = let
  ...
  genericHeaderConfig' = config
    ...
    , textConfig {
        text = if state.props.stage == ST.LeaderBoard then (getStringEnToHi CONTEST) else if state.props.stage == ST.ReferralFlow then (getStringEnToHi REFERRAL_ENROLMENT) else (getStringEnToHi REFERRALS)
