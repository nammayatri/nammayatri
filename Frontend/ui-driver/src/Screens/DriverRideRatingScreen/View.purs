...
screen :: ST.DriverRideRatingScreenState -> LoggableScreen Action ST.DriverRideRatingScreenState ScreenOutput
screen initialState =
  { initialState
  , view
  ...
  , eval
  , parent : Nothing
  , logWhitelist: initialState.data.config.logWhitelistConfig.driverRideRatingScreenLogWhitelist
  }
