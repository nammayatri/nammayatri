          ...
          case (length filteredDriverFees == 1) of
              true -> [
                  ...
                  },
                  {
                    ...
                    val : case driverFee'.specialZoneRideCount, driverFee'.totalBoothRideCharges of
                            Just 0, Just 0.0 -> ""
                    ...
                    case (length filteredDriverFees /= 1) of
                        true -> mapWithIndex (\ ind (API.DriverFeeInfoEntity driverFee) ->  do
                                ...
                                autoPayStageData = getAutoPayStageData driverFee.autoPayStage
                            {
                                ...
                                boothCharges : case driverFee.specialZoneRideCount, driverFee.totalBoothRideCharges of
