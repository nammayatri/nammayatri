...
-}
module Screens.PaymentHistoryScreen.ComponentConfig where
...
getTransactionConfig transactionInfo = do
  let
    status = transactionInfo.paymentStatus
    ...
    title' =
      getString case status, feeType, isRegisteredWithDuesClear of
