...
import PrestoDOM.Core.Types.Language.Flow (initUIWithScreen, initUIWithNameSpace, runScreenWithNameSpace)
...
splashScreen = do
  ...
  void $ EHB.liftFlowBT $ initUIWithNameSpace "SplashScreen" Nothing
  void $ lift $ lift $ do 
    void $ runScreenWithNameSpace $ SplashScreen.screen globalState.splashScreen
    liftFlow HU.hideSplash
