...
driverGenericHeaderConfig state =
  let
    config = GenericHeader.config
...
alternatePrimaryEditTextConfig state =
  let
    config = PrimaryEditText.config
