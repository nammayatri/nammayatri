  ...
  case action of
    ...
    UPDATE_ROUTE state -> do
      ...
      if state.props.showDottedRoute then do
        ...
        void $ pure $ removeAllPolylines ""
        liftFlowBT $ drawRoute coors 0 {points : []} "DOT" "#323643" false "ny_ic_src_marker" "ny_ic_dest_marker" 9 "NORMAL" source destination (mapRouteConfig "" "" false getPolylineAnimationConfig) (getNewIDWithTag "DriverTrackingHomeScreenMap")
        homeScreenFlow
          ...
          case shortRoute of
            Just (Route route) -> do
              ...
              void $ pure $ removeAllPolylines ""
              liftFlowBT $ drawRoute coor 0 {points : []} "LineString" "#323643" true "ny_ic_src_marker" "ny_ic_dest_marker" 9 "NORMAL" source destination (mapRouteConfig "" "" false getPolylineAnimationConfig) (getNewIDWithTag "DriverTrackingHomeScreenMap")
              pure unit
            Nothing -> pure unit
          homeScreenFlow
          else do
            ...
            case shortRoute of
              Just (Route route) -> do
                ...
                void $ pure $ removeAllPolylines ""
                liftFlowBT $ drawRoute coor 0 {points : []} "ic_vehicle_side" "#323643" true "ny_ic_src_marker" "ny_ic_dest_marker" 9 "NORMAL" source destination (mapRouteConfig "" "" false getPolylineAnimationConfig) (getNewIDWithTag "DriverTrackingHomeScreenMap")
                pure unit
              Nothing -> pure unit
            homeScreenFlow
