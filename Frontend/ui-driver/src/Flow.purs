...
setUPIPaymentStatus status = do
  ...
  case status of
    ...
    CRST.PENDING -> modifyScreenState $ CustomerReferralTrackerScreenStateType (\customerReferralTracker -> customerReferralTracker{data{orderStatus = Just status}, props{showInfoPopUp = true}})
    _ -> pure unit
