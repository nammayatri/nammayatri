...
driverReferralScreenFlow = do
  ...
  let referralCode = getValueToLocalStore REFERRAL_CODE
      ...
      referralItem = if cityConfig.referralConfig.showCustomerReferral then CUSTOMER_REFERRAL else DRIVER_REFERRAL
  modifyScreenState $ DriverReferralScreenStateType (\driverReferralScreen -> driverReferralScreen { data {referralCode = referralCode, cityConfig = cityConfig}, props{currentReferralItem = Just referralItem}})
...
referralFlow = do
  ...
  if cityConfig.referralConfig.showDriverReferral || appConfig.enableDriverReferral || cityConfig.referralConfig.showCustomerReferral then driverReferralScreenFlow
