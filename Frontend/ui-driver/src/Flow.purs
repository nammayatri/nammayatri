...
homeScreenFlow = do
  ...
  case action of             
    ...
    GO_TO_METER_RIDE_SCREEN -> meterFareScreenFlow
  homeScreenFlow
...
meterFareScreenFlow :: FlowBT String Unit
meterFareScreenFlow = do
  action <- UI.meterFareScreen
  case action of
    GO_TO_HOME_SCREEN_FROM_METER_FARE state -> homeScreenFlow
