...
loginFlow = do
  ...
  config <- getAppConfigFlowBT Constants.appConfig
  void $ pure $ setCleverTapUserProp [{key : "Preferred Language", value : unsafeToForeign $ config.defaultLanguage}]
  setValueToLocalStore LANGUAGE_KEY $ config.defaultLanguage
  _ <- UI.chooseLanguage
