...
chooseLanguageFlow mbEvent = do
  ...
  case action of
    TA.LOGIN_FLOW -> loginFlow mbEvent mbEvent
...
homeScreenFlow = do
  ...
  Events.measureDurationFlowBT "Flow.homeScreenFlow" $ do    
    ...
    checkDriverBlockingStatus getDriverInfoResp globalHomeScreenState.data.config.subscriptionConfig.enableBlocking
