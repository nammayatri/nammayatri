...
const malayalamStrings = {
  ...
  "YOUR_FEEDBACK_HELPS_US" : "നമ്മ യാത്രി അനുഭവം മെച്ചപ്പെടുത്താൻ നിങ്ങളുടെ ഫീഡ്‌ബാക്ക് ഞങ്ങളെ സഹായിക്കുന്നു",
  ...
  "UNPROFESSIONAL_DRIVER": "അവിജ്ഞാനം പരിഷ്കർത്താവ്",
  "RASH_DRIVING": "മുറിക്കിടക്കൽ വാഹനം",
  "DRIVER_CHARGED_MORE": "ഡ്രൈവർ കൂടുതൽ ചാർജുകൾ ചെയ്തു",
  "UNCOMFORTABLE_AUTO": "അസുഖകരമായ ഓട്ടോ",
  "TRIP_GOT_DELAYED": "യാത്ര താൽപ്പര്യം ചെയ്തു",
  "FELT_UNSAFE": "അപരിമിതമായ ആത്മാവിലേക്ക്",
  "POLITE_DRIVER": "വിനയപൂർവ്വം ഉപയോക്താവ്",
  "EXPERT_DRIVING": "വിപണിയായി വാഹനം",
  "SAFE_RIDE": "സുരക്ഷിത സവാരി",
  "CLEAN_AUTO": "വിട്ട് അടിച്ചേരൽ",
  "ON_TIME": "സമയത്ത്",
  "SKILLED_NAVIGATOR": "കൌശലമുള്ള നാവിഗേറ്റർ",
  "RUDE_DRIVER": "അസഭ്യ ഡ്രൈവർ",
  "TOO_MANY_CALLS": "പല കോളുകൾ",
  "RECKLESS_DRIVING": "അപായകാരി വാഹനചാലനം",
  "LATE_DROP_OFF": "വിലമ്പിച്ച ഡ്രോപ്പ് ഓഫ്", 
  "LATE_PICK_UP": "വിലമ്പിച്ച പിക്കപ്പ്",
