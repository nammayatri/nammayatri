...
const bengaliStrings = {
  ...
  "LOOKS_OFFLINE": "মনে হচ্ছে আপনি অফলাইনে আছেন!",
  "OFFLINE_DRIVER_ON_WAY": "আপনার ড্রাইভার রাইডটি বাতিল করতে নেটওয়ার্কের সাথে পুনরায় সংযোগ করার পথে থাকতে পারে৷",
  "BACK_TO_RIDE_DETAILS": "রাইডের বিবরণে ফিরে যান",
  "RECONNECT_TO_UPDATE": "লাইভ আপডেট দেখতে নেটওয়ার্কে পুনরায় সংযোগ করুন৷",
  "DRIVER_ON_WAY": "চিন্তা করবেন না! আপনার ড্রাইভার এখনও তার পথে থাকতে পারে।",
  "RECONNECT_TO_UPDATE_2": "লাইভ বিবরণ দেখতে পুনরায় সংযোগ করুন.", 
  "RIDE_ACTIVE": "চিন্তা করবেন না! আপনার রাইড এখনও সক্রিয়"
}
