...
-- eval (StartNammaSafetyOnboarding PrimaryButtonController.OnClick) state = continue state { props { currentStage = NammaSafetyDashboard } }--SetDefaultEmergencyContacts } }
