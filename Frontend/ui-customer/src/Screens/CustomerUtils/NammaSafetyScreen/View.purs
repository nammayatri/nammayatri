    ...
    [ linearLayout
        ...
        , linearLayout
            ...
            , linearLayout
                ...
                , width MATCH_PARENT
                , orientation VERTICAL
                , visibility $ boolToVisibility $ state.props.currentStage == SetPersonalSafetySettings && isSafetyPlus state
                ]
                [ textView
                    $ [ text $ getString if state.props.enableLocalPoliceSupport then PERSONAL_SAFETY_SETTINGS_ACTIONS_PLUS else PERSONAL_SAFETY_SETTINGS_ACTIONS "PERSONAL_SAFETY_SETTINGS_ACTIONS"
                      , color Color.black800
                      ]
                    <> FontStyle.body5 TypoGraphy
                , textView
...
nammaSafetyMeasuresView state visibility' =
  linearLayout
    ...
    , linearLayout
        ...
        ( map
            ( \item ->
                measureView (getStringBasedOnMode item $ isSafetyPlus state) false true Color.black800 16
            )
            safetyMeasuresData
        )
    ]
...
aboutSOSView state visibility' =
  linearLayout
    ...
    , linearLayout
        ...
        ( map
            ( \item ->
                measureView (getStringBasedOnMode item $ isSafetyPlus state) true true Color.black800 16
            )
            aboutSoSData
        )
    ]
