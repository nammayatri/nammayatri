...
screen initialState =
  ...
  , globalEvents:
      [ ( \push -> do
            if initialState.props.timerId == "" then pure unit else pure $ EHC.clearCountDownTimer initialState.props.timerId "RecordingTimer"
            if initialState.props.shareTimerId == "" then pure unit else pure $ EHC.clearCountDownTimer initialState.props.shareTimerId "ShareTimer"
            pure $ pure unit
        )
      ]
  , eval:
          ...
          [ linearLayout
              ...
              , linearLayout
                  ...
                  [ frameLayout
                      ...
                      , linearLayout
                          [ height $ V 4
                          , width $ V ((getRecordViewWidth "" / 15) * (15 - state.props.timerValue))
