...
deleteGenericHeaderConfig state =
  let
...
primaryButtonConfigSubmitRequest state =
  let
  ...
  let
    ...
    popUpConfig' =
      config
        ...
        , secondaryText
          { text = getString ACCOUNT_DELETION_CONFIRMATION
  ...
  let
    ...
    popUpConfig' =
      config
        ...
        , secondaryText
          { text = getString WE_WILL_DELETE_YOUR_ACCOUNT
