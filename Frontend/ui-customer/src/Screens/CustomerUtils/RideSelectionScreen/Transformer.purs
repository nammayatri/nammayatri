...
myRideListTransformer isSrcServiceable listRes config mbSelectedCategory = mapMaybe transformRide listRes
  ...
  , isAirConditioned : ride.isAirConditioned
              ...
              , vehicleModel : if (rideDetails.vehicleModel `DA.elem` ["", "Unkown", "Unknown"]) then fromMaybe (HU.getVariantRideType rideDetails.vehicleVariant) ride.serviceTierName else rideDetails.vehicleModel
