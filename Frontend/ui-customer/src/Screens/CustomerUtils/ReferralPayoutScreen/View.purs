    ...
    $ linearLayout
        ...
        [ linearLayout
            ...
            [ linearLayout
                ...
                , textView
                    $ [ text "Your earnings will be credited to this account"
                      , color Colors.black900
                      ]
                      ...
                      linearLayout
                        ...
                        $ [ linearLayout
                              ...
                              [ linearLayout
                                  ...
                                  [ textView
                                      $ [ text "Took cab ride using referral code"
                                        , color Colors.black900
                                        ]
                                      <> FontStyle.body1 TypoGraphy
                                  , textView
                                      $ [ text "31 Aug 2022 • 31 Aug 2022"
...
coverView push state =
  linearLayout
    ...
    , textView
        ...
        <> FontStyle.title2Italic TypoGraphy
    -- , textView
    --     $ [ text "& enjoy Extra Kekkadha Rides!"
    --       , color Colors.black900
    --       ]
  ...
  map
    ( \item ->
        linearLayout
          ...
          [ textView
              $ [ text item.title -- "You Get"
                , color Colors.black900
                ]
              <> FontStyle.body8 TypoGraphy
          , textView
              $ [ text item.desc -- "₹50 credited to your UPI ID when your friend uses your referral code for their first Namma Yatri ride in Chennai"
                , color Colors.black900
                ]
              <> FontStyle.body1 TypoGraphy
          ]
    ...
    ( [ { title: "You Get"
        , desc: "₹50 credited to your UPI ID when your friend uses your referral code for their first Namma Yatri ride in Chennai"
        }
      , { title: "They Get"
        , desc: "₹50 credited to their UPI ID when they use your referral code for their first Namma Yatri ride in Chennai"
        }
      ]
    )
                    ...
                    [ linearLayout
                        ...
                        , linearLayout
                            ...
                            ( DA.mapWithIndex
                                ...
                                ( [ "To get the referral reward, new user should install the app and enter the referral code before taking their first ride."
                                  , "The referral reward will be given only for the first ride post checking the ride validity."
                                  , "The referral reward program is a time bound program and can be stopped at any time without prior intimation."
                                  , "Namma Yatri reserves the right to determine the eligibility of a customer to be valid for referral reward or not."
                                  ]
                                )
                            )
                        , linearLayout
  ...
  linearLayout
    ...
    [ scrollView
        ...
        [ linearLayout
            ...
            , textView
                $ [ text "Collect Referral Earnings"
                  , color Colors.black800
                  ]
                <> FontStyle.h2 TypoGraphy
            , textView
                $ [ text "Verify your UPI ID to receive your referral earnings"
                  , margin $ MarginTop 8
                  , color Colors.black700
                  ]
                <> FontStyle.body1 TypoGraphy
          ...
          [ linearLayout
              ...
              [ textView
                  $ [ height WRAP_CONTENT
                    ...
                    , text case state.data.verificationStatus of
                        ST.UpiVerified -> "UPI ID Verified!"
                        ST.UpiNotVerified -> "Enter UPI ID in the format “number@bankname”"
                        ST.UpiFailed -> "UPI ID is invalid. Please check and re-enter"
                        ST.UpiVerifying -> "Enter UPI ID in the format “number@bankname”"
        ...
        [ PrestoAnim.animationSet
            ...
            $ linearLayout
                ...
                [ linearLayout
                    ...
                    [ textView
                        $ [ text "Download Namma Yatri"
                          , color Colors.black900
                          ]
                        <> FontStyle.h1 TypoGraphy
                    , textView
                        $ [ text $ "Scan QR code to download the app and apply your invite code automatically"
                          , color Colors.black800
                          , gravity CENTER
...
collectEarningView push state =
  ...
  in
    linearLayout
      ...
      [ textView
          $ [ text if isPayoutPending then "Yay! You have referral earnings" else "Your Earnings \n ₹" <> show totalEarning
  ...
  in
    linearLayout
      ...
      [ linearLayout
          ...
          , textView
              $ [ text $ "UPI ID " <> if state.props.isUpiUpdated then "Submitted" else "Updated" <> "!"
                , color Colors.black800
                ]
              <> FontStyle.h2 TypoGraphy
          , textView
