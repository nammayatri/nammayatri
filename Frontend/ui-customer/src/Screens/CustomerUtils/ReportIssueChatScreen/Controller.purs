...
import JBridge (addMediaFile, clearFocus, clearWaitingTimer, generatePDF, hideKeyboardOnNavigation, lottieAnimationConfig, removeMediaPlayer, renderBase64ImageFile, saveAudioFile, scrollToEnd, startAudioRecording, startLottieProcess, stopAudioRecording, toast, uploadFile, uploadMultiPartData, waitingCountdownTimer, openUrlInApp)
...
eval BackPressed state =
  continueWithCmd state [do
    ...
    pure $ Exit $ (case state.data.entryPoint of 
                    ...
                    RideSelectionScreenEntry -> GoToRideSelectionScreen) state {props {showSubmitComp = false}}
  ]
