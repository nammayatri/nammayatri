...
screen initialState =
  ...
  , globalEvents : [ (\push -> do
                      -- Dummy for now will be used later on
...
enterAadhaarDetailsView push state =
  ...
  , padding (Padding 16 16 16 16)
        ...
        , textView $
          [ height WRAP_CONTENT
          , width WRAP_CONTENT
          , text "Please reach out to your nearest booth to get your Aadhaar verified"
  ...
  , linearLayout
    ...
    , clickable state.props.isDateClickable
      ...
      [ width MATCH_PARENT
        ...
        ([ text if state.data.driverDob == "" then "Select date of birth" else state.data.driverDob
...
termsAndConditionsView _ =
  ...
  , margin $ MarginTop 10
      ...
      , orientation HORIZONTAL
        ...
        [ width WRAP_CONTENT
        , height WRAP_CONTENT
        , textFromHtml "By clicking Continue, you agree to our "
        , color Color.greyTextColor
        , alpha 0.5
        ] <> FontStyle.body3 TypoGraphy
      , textView $
...
resendOTPView push state =
  ...
  , orientation VERTICAL
      ...
      [ height WRAP_CONTENT
      , width WRAP_CONTENT
      , textFromHtml "<a href=\"\"> Resend OTP</a>"
    ...
    , textView $
      [ height WRAP_CONTENT
      , width WRAP_CONTENT
      , textFromHtml $ "<u>Resend OTP in </u>" <> "  " <> state.data.timer
