...
-- TODO : reduce the backward compatibility here i dont need to use the RateCardThing anymore might need to rewrite the whole function again but 
-- this is made for rentals as well so it might break in future :P
