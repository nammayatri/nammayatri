...
rideSummaryCardConfig (BookingAPIEntity entity) = 
  let 
    ...
    isVehicleAirConditioned = any (_ == vehicleServiceTier)["COMFY","ECO","SUV","HATCHBACK_TIER","TAXI_PLUS"]
    isVehicleNonAirConditioned = any (_ == vehicleServiceTier)["AUTO_RICKSHAW","SEDAN_TIER","PREMIUM","TAXI"]
  ...
  in 
      ...
      , vehicleInfo :
        { airConditioned : vehicleServiceTierAirConditioned
        , seatingCapacity : vehicleServiceTierSeatingCapacity
        , name : vehicleServiceTierName
