    ...
    Anim.screenAnimation $ 
      ...
      , background Color.white900
        ...
        linearLayout
            ...
            , padding (PaddingBottom (if EHC.safeMarginBottom == 0 then 24 else EHC.safeMarginBottom))
        ...
        , linearLayout
            ...
            , margin $ MarginBottom if EHC.os == "IOS" then 85 else 75
            , background Color.white900
...
personalDetails state push =
  ...
  , width MATCH_PARENT
  , padding $ PaddingBottom if EHC.os == "IOS" then 60 else 15
  , background Color.white900
  , orientation VERTICAL
  ...
  linearLayout 
    ...
    , linearLayout
        ...
        [ textView
          ...
          , textSize FontSize.a_16
          , fontStyle $ if state.data.editedGender /= Nothing then FontStyle.bold LanguageStyle else FontStyle.semiBold LanguageStyle
          , height WRAP_CONTENT
          , width WRAP_CONTENT
          , color if state.data.editedGender == Nothing then Color.black500 else Color.black800
          ]
        , linearLayout
            [ height WRAP_CONTENT
            , width MATCH_PARENT
