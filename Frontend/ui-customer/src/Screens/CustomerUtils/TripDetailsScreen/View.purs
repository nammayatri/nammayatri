...
tripDetailsView state =
  ...
  , gravity CENTER_VERTICAL
          ...
          , orientation HORIZONTAL
            ...
            , imageView
              [ imageWithFallback $ if state.data.selectedItem.vehicleVariant == "AUTO_RICKSHAW" then "ic_driver_auto,https://assets.juspay.in/nammayatri/images/user/ny_ic_driver_auto.png"
