...
-}
module Screens.MultiModalFlow.JourneyTrackingScreen.ScreenData where
...
initData :: ST.JourneyTrackingScreenState
initData =
  let
...
mockDriverInfo =
  ...
  , driversPreviousRideDropLocLat : Mb.Nothing
  , driversPreviousRideDropLocLon : Mb.Nothing
  , spLocationName : Mb.Nothing
  , addressWard : Mb.Nothing
  , currentChatRecipient : dummyChatRecipient
  , hasToll : false
  , isAlreadyFav : false
  , favCount : 0
  , rideDuration : Mb.Nothing
  , rideScheduledAtUTC : Mb.Nothing
  }
