...
instance eqGender :: Eq Gender where
  eq = genericEq
...
data ActiveFieldAccountSetup
  = DropDown
  | NameSection

derive instance genericActiveFieldAccountSetup :: Generic ActiveFieldAccountSetup _

instance eqActiveFieldAccountSetup :: Eq ActiveFieldAccountSetup where
  eq = genericEq
...
instance showTripDetailsGoBackType :: Show TripDetailsGoBackType where
  show = genericShow

instance eqTripDetailsGoBackType :: Eq TripDetailsGoBackType where
  eq = genericEq
...
type IndividualRideCardState
  = { date :: String
    ...
    , -- Added only For Backward Compatibility faresList :: Array FareComponent
...
instance eqVehicleVariant :: Eq VehicleVariant where
  eq = genericEq
...
instance eqPermissionScreenStage :: Eq PermissionScreenStage where
  eq = genericEq

instance showPermissionScreenStage :: Show PermissionScreenStage where
  show = genericShow
...
instance showBottomNavBarIcon :: Show BottomNavBarIcon where
  show = genericShow

instance eqBottomNavBarIcon :: Eq BottomNavBarIcon where
  eq = genericEq

data SafetyAlertType
  = DEVIATION
  | STATIONARY_VEHICLE

derive instance genericSafetyAlertType :: Generic SafetyAlertType _

instance showSafetyAlertType :: Show SafetyAlertType where
  show = genericShow

instance eqSafetyAlertType :: Eq SafetyAlertType where
  eq = genericEq
...
instance showSheetState :: Show SheetState where
  show = genericShow

instance eqSheetState :: Eq SheetState where
  eq = genericEq

instance encodeSheetState :: Encode SheetState where
  encode = defaultEnumEncode

instance decodeSheetState :: Decode SheetState where
  decode = defaultEnumDecode
...
data TipViewStage
  ...
  | TIP_AMOUNT_SELECTED
  | TIP_ADDED_TO_SEARCH
  | RETRY_SEARCH_WITH_TIP

derive instance genericTipViewStage :: Generic TipViewStage _

instance showTipViewStage :: Show TipViewStage where
  show = genericShow

instance eqTipViewStage :: Eq TipViewStage where
  eq = genericEq

instance encodeTipViewStage :: Encode TipViewStage where
  encode = defaultEncode

instance decodeTipViewStage :: Decode TipViewStage where
...
instance showSosBannerType :: Show SosBannerType where
  show = genericShow

instance eqSosBannerType :: Eq SosBannerType where
  eq = genericEq
...
instance showDeleteStatus :: Show DeleteStatus where
  show = genericShow

instance eqDeleteStatus :: Eq DeleteStatus where
  eq = genericEq

instance encodeDeleteStatus :: Encode DeleteStatus where
  encode = defaultEnumEncode

instance decodeDeleteStatus :: Decode DeleteStatus where
  decode = defaultEnumDecode
...
instance eqErrorType :: Eq ErrorType where
  eq = genericEq
...
instance eqCallType :: Eq CallType where
  eq = genericEq

instance showCallType :: Show CallType where
  show = genericShow

instance encodeCallType :: Encode CallType where
  encode = defaultEnumEncode

instance decodeCallType :: Decode CallType where
  decode = defaultEnumDecode
...
instance encodeCardType :: Encode CardType where
  encode = defaultEnumEncode

instance decodeCardType :: Decode CardType where
  decode = defaultEnumDecode
...
data NotifyFlowEventType
  = RATE_DRIVER_SKIPPED
  | SEARCH_CANCELLED

derive instance genericNotifyFlowEventType :: Generic NotifyFlowEventType _

instance showNotifyFlowEventType :: Show NotifyFlowEventType where
  show = genericShow
...
instance eqLocItemType :: Eq LocItemType where
  eq = genericEq

instance showLocItemType :: Show LocItemType where
  show = genericShow

instance encodeLocItemType :: Encode LocItemType where
  encode = defaultEnumEncode

instance decodeLocItemType :: Decode LocItemType where
  decode = defaultEnumDecode
...
instance eqSearchResultType :: Eq SearchResultType where
  eq = genericEq

instance showSearchResultType :: Show SearchResultType where
  show = genericShow
...
type SuggestionsMap
  = Map SourceGeoHash Suggestions

type SourceGeoHash
  = String

type DestinationGeoHash
  = String
...
instance eqLocationItemType :: Eq LocationItemType where
  eq = genericEq

instance showLocationItemType :: Show LocationItemType where
  show = genericShow

instance encodeLocationItemType :: Encode LocationItemType where
  encode = defaultEnumEncode

instance decodeLocationItemType :: Decode LocationItemType where
  decode = defaultEnumDecode
...
instance showFlowStatusData :: Show FlowStatusData where
  show = genericShow

instance encodeFlowStatusData :: Encode FlowStatusData where
  encode = defaultEncode

instance decodeFlowStatusData :: Decode FlowStatusData where
  decode = defaultDecode
...
instance showZoneType :: Show ZoneType where
  show = genericShow

instance eqZoneType :: Eq ZoneType where
  eq = genericEq

instance encodeZoneType :: Encode ZoneType where
  encode = defaultEncode

instance decodeZoneType :: Decode ZoneType where
  decode = defaultDecode
...
instance showTipViewData :: Show TipViewData where
  show = genericShow

instance encodeTipViewData :: Encode TipViewData where
  encode = defaultEncode

instance decodeTipViewData :: Decode TipViewData where
  decode = defaultDecode
...
type FlattenedBusinessHourData
  = { id :: String
    , slot :: Maybe String
    , -- array of slots startTime :: Maybe String
...
type TicketBookingScreenData
  = { servicesAvailing :: Array TicketServiceI
    , -- TODO:: Use this for generic handling dateOfVisit :: String
...
instance showTicketBookingScreenStage :: Show TicketBookingScreenStage where
  show = genericShow

instance eqTicketBookingScreenStage :: Eq TicketBookingScreenStage where
  eq = genericEq
...
instance showMetroLine :: Show MetroLine where
  show = genericShow

instance eqMetroLine :: Eq MetroLine where
  eq = genericEq
...
data PreviousMetroTicketDetailsStage
  = MetroMyTicketsStage
...
instance showPreviousMetroTicketDetailsStage :: Show PreviousMetroTicketDetailsStage where
  show = genericShow

instance eqPreviousMetroTicketDetailsStage :: Eq PreviousMetroTicketDetailsStage where
  eq = genericEq

data MetroTicketDetailsScreenStage
  = MetroTicketDetailsStage
  | MetroMapStage
...
instance showMetroTicketDetailsScreenStage :: Show MetroTicketDetailsScreenStage where
  show = genericShow

instance eqMetroTicketDetailsScreenStage :: Eq MetroTicketDetailsScreenStage where
  eq = genericEq
...
data MetroMyTicketsEntry
  = HomeScreenToMetroMyTickets
...
data TicketStatusEntry
  = MetroTicketToPaymentStatusEntry
  | ZooTicketToPaymentStatusEntry

derive instance genericTicketStatusEntry :: Generic TicketStatusEntry _

instance showTicketStatusEntry :: Show TicketStatusEntry where
  show = genericShow

instance eqTicketStatusEntry :: Eq TicketStatusEntry where
  eq = genericEq
...
instance eqSearchLocationActionType :: Eq SearchLocationActionType where
  eq = genericEq

data SearchLocationTextField
  = SearchLocPickup
  | SearchLocDrop

derive instance genericSearchLocationTextField :: Generic SearchLocationTextField _

instance showSearchLocationTextField :: Show SearchLocationTextField where
  show = genericShow

instance eqSearchLocationTextField :: Eq SearchLocationTextField where
  eq = genericEq

data SearchLocationStage
...
instance eqSearchLocationStage :: Eq SearchLocationStage where
  eq = genericEq
...
instance eqSafetySetupStage :: Eq SafetySetupStage where
  eq = genericEq

instance showSafetySetupStage :: Show SafetySetupStage where
  show = genericShow
...
instance eqRecordingState :: Eq RecordingState where
  eq = genericEq

instance showRecordingState :: Show RecordingState where
  show = genericShow

data FollowRideScreenStage
  = PersonList
  | FollowingRide
  | ChatWithEM
  | MockFollowRide
...
instance showFollowRideScreenStage :: Show FollowRideScreenStage where
  show = genericShow

instance eqFollowRideScreenStage :: Eq FollowRideScreenStage where
  eq = genericEq
...
instance eqEmAudioPlayStatus :: Eq EmAudioPlayStatus where
  eq = genericEq
...
instance eqReferralStatus :: Eq ReferralStatus where
  eq = genericEq
...
data MetroTicketBookingStage
  = MetroTicketSelection
  | GetMetroQuote
  | ConfirmMetroQuote
  | PaymentSDKPooling
...
instance eqMetroTicketBookingStage :: Eq MetroTicketBookingStage where
  eq = genericEq

instance showMetroTicketBookingStage :: Show MetroTicketBookingStage where
  show = genericShow
...
instance eqTicketType :: Eq TicketType where
  eq = genericEq

data LocationActionId
  = Src
  | Dest

derive instance genericLocationActionId :: Generic LocationActionId _

instance eqLocationActionId :: Eq LocationActionId where
  eq = genericEq

instance showLocationActionId :: Show LocationActionId where
  show = genericShow
...
data MetroTicketStatusScreenEntry
  = HomescreenToMetroTicketStatus
  | MyMetroTicketsToMetroTicketStatus
...
data AutoCompleteReqType
  = PICKUP
  | DROP

derive instance genericAutoCompleteReqType :: Generic AutoCompleteReqType _

instance showAutoCompleteReqType :: Show AutoCompleteReqType where
  show = genericShow
...
instance eqLocationSelectType :: Eq LocationSelectType where
  eq = genericEq
...
instance eqReferralStage :: Eq ReferralStage where
  eq = genericEq

type SpecialLocationMap
  = DM.Map String SpecialLocationList
...
data RentalScreenStage
  = RENTAL_SELECT_PACKAGE
  | RENTAL_SELECT_VARIANT
  | RENTAL_CONFIRMATION

derive instance genericRentalScreenStage :: Generic RentalScreenStage _

instance showRentalScreenStage :: Show RentalScreenStage where
  show = genericShow

instance eqRentalScreenStage :: Eq RentalScreenStage where
  eq = genericEq
...
instance showFareProductType :: Show FareProductType where
  show = genericShow

instance eqFareProductType :: Eq FareProductType where
  eq = genericEq

data CancelSearchType
  = NORMAL_RIDE_CANCEL
  | RENTAL_SEARCH_CANCEL

derive instance genericCancelSearchType :: Generic CancelSearchType _

instance showCancelSearchType :: Show CancelSearchType where
  show = genericShow

instance eqCancelSearchType :: Eq CancelSearchType where
  eq = genericEq

data VehicleViewType
  = LEFT_VIEW
  | RIGHT_VIEW

derive instance genericVehicleViewType :: Generic VehicleViewType _

instance showVehicleViewType :: Show VehicleViewType where
  show = genericShow

instance eqVehicleViewType :: Eq VehicleViewType where
  eq = genericEq
