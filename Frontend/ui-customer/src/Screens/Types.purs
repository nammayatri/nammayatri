...
type QuotesList = {
  ...
  -- intercityFareDetails :: IntercityFareDetails
}
...
newtype BookingAPIEntity = BookingAPIEntity {
  ...
  vehicleServiceTierSeatingCapacity ::  Maybe String
}
