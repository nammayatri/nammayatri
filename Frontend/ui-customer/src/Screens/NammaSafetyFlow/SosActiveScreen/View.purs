...
view push state =
  ...
  headerConfig = Header.config { useLightColor = true, title = getString EMERGENCY_SOS, learnMoreTitle = getString LEARN_ABOUT_NAMMA_SAFETY }
