...
-}
module Screens.NammaSafetyFlow.ValidateMpinScreen.Controller where
...
data Action
  ...
  | DisableShimmer
  | ContinueBtn PrimaryButtonController.Action
  | CallContact Int
  | CallPolice
  | ShowPoliceView
  | LearnMoreClicked
...
eval (ContinueBtn PrimaryButtonController.OnClick) state = exit $ UpdateAsSafe state
