      ...
      let Tuple newRoute points = 
            case state.data.route of 
              ...
              Nothing -> 
                ...
                in Tuple newRoute newPts
          routeConfig = JB.mkRouteConfig points srcMarkerConfig destMarkerConfig Nothing "NORMAL" "LineString" true JB.DEFAULT $ HU.mkMapRouteConfig "" "" false getPolylineAnimationConfig
