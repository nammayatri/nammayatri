...
var dHomeScreen = function dHomeScreen(func) {
  return function (onError, onSuccess) {
    ...
    newScript.onload = function () {
      ...
      Promise.resolve().then(function () {
        return _interopRequireWildcard(require("./../../output/Screens.RideBookingFlow.Flow"));
      }).then(function (module) {
        console.log("onSuccess import dHomeScreen");
...
exports.dHomeScreen = dHomeScreen;