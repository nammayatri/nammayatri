module Screens.RideBookingFlow.MeterSelectDestinationScreen.Transformer where
...
import Data.Lens ((^.))
import Accessor (_description, _place_id, _types, _distance)
import Data.String (Pattern(..), split, drop, indexOf)
import Screens.RideBookingFlow.MeterSelectDestinationScreen.ScreenData (dummyAddress)
