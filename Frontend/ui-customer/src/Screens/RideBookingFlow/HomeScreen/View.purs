  ...
  frameLayout
    ...
    [  linearLayout
       ...
       [ relativeLayout
            ...
            , if state.props.showSafetyPlusInfoPopup then safetyPlusInfoPopup push state else emptyTextView state
            , if state.props.showSafetyPlusInfoIntoPopup then showSafetyPlusInfoPopupIntro push state else emptyTextView state
