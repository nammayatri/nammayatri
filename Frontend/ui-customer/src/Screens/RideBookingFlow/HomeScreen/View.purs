  ...
  , globalEvents:
      [ ( \push -> do
            ...
            if (not initialState.props.callbackInitiated) then do
              ...
              _ <- runEffectFn3 storeCallBackInternetAction push InternetCallBackCustomer "HomeScreen"
              _ <- runEffectFn2 storeNoInternetAction push UpdateNoInternet
