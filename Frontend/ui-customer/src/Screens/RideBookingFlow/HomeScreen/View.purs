  ...
  frameLayout
    ...
    [ linearLayout
        ...
        [ relativeLayout
            ...
            , if ((state.props.showlocUnserviceablePopUp || (state.props.isMockLocation && (getMerchant FunctionCall == NAMMAYATRI))) && state.props.currentStage == HomeScreen) then (sourceUnserviceableView push state) else emptyTextView state
...
completedRideDetails state push = 
  ...
  , gradient $ Linear (if os == "IOS" then 90.0 else 0.0) [Color.black900, Color.black900, "#29334A", Color.black900]
  , gravity CENTER
  ][  linearLayout
      [ width MATCH_PARENT
      , height WRAP_CONTENT
...
commonTextView :: forall w. HomeScreenState 
                            -> (Action -> Effect Unit) 
                            -> String 
                            -> String 
                            ->(forall properties. (Array (Prop properties))) 
                            -> Int 
