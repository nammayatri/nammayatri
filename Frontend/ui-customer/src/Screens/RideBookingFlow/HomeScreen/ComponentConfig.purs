  ...
  let
    ...
    rateCardConfig' =
      config'
        ...
        , buttonText = if state.data.rateCard.currentRateCardType == DefaultRateCard then (getString GOT_IT) else (getString GO_BACK_)
        ...
        , fareList = ([
          ...
          ]) <> (if (HU.getMerchant FunctionCall) == HU.NAMMAYATRI && (state.data.rateCard.additionalFare > 0) then 
