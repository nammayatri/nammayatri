    ...
    messagingViewConfig' =
      config
        ...
        , feature
          ...
          , enableSuggestions = if state.props.stageBeforeChatScreen == RideStarted && state.data.fareProductType == FPT.RENTAL then false else state.data.config.feature.enableSuggestions
          }
