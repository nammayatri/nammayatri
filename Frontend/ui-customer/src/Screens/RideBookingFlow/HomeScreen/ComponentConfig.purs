...
rideCompletedCardConfig state = 
  ...
  where
    ...
    additionalCharges = 
      ...
      [
        {
          text :  getString if state.data.toll.confidence == (Just Unsure) then  TOLL_CHARGES_MAYBE_APPLICABLE else if finalFareHasToll then  TOLL_CHARGES_INCLUDED else TOLL_ROAD_CHANGED 
