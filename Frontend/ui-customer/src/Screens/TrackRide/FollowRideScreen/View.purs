...
getMessageNotificationViewConfig state =
  ...
  , removeNotification : if state.props.isRideStarted && not state.props.currentUserOnRide && currentFollower.priority == 0 then state.props.removeNotification else true
