  ...
  where
    ...
    getInputViewConfigBasedOnActionType actionType =
      case actionType of 
            ...
            ST.BusRouteSelectionAction -> { srcPrefixImageName :"", destPrefixImageName : "", srcPlaceHolder : "Route/Bus No" , destPlaceHolder : "", inputViewMargin : MarginTop 8, headerVisibility : false, imageLayoutMargin : MarginLeft 0 }
