  ...
  linearLayout
    ...
    , onAnimationEnd push $ const ListExpandAinmationEnd
        ...
        , orientation VERTICAL
          ...
          ]) state.data.routeSearchedList) -- Ensure this is of type Array GetBusRouteResp
                      ...
                      [ 
                        ...
                        , linearLayout
                              ...
                              -- , onClick push $ const $ SelectRouteslistView
                                  ...
                                  , color Color.greyTextColor
                                  , textFromHtml $ state.props.isEmptyRoute --if state.props.isEmptyRoute == "" then "Select Route Number" else  state.props.isEmptyRoute                                            
                                  , weight 4.0
                                  , cornerRadius 6.0
