...
, here_is_a_surprise_upgrade : "ಅಚ್ಚರಿಯ ಅಪ್‌ಗ್ರೇಡ್ ಇಲ್ಲಿದೆ! 🎉"
, new_fare : "ಹೊಸ ದರ: "
, confirming_ride_in : (\time -> "ಸವಾರಿ ಖಚಿತಪಡಿಸಲಾಗುತ್ತಿದೆ " <> time <> "ಸೆ ಗಳಲ್ಲಿ")
, no_continue_search_for : (\serviceTierName -> "ಇಲ್ಲ, " <> serviceTierName <> " ಗಾಗಿ ಶೋಧನೆ ಮುಂದುವರಿಸು.")
}