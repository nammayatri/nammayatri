...
, referral_code_failed : "Referral Code Invalid! Please check and try again"
    , enter_6_digit_referral_code : "Enter referral code"
...
, search_again_with_a_tip: "Search again with voluntary addition?"
, try_again_with_a_tip: "Try again with voluntary addition?"
, boost_your_ride_chances_and_help_drivers_with_tips: "It seems to be a very busy day. You may try adding more to increase chances of getting a ride."
, try_again_without_tip: "Try Again"
, search_again_without_a_tip: "Search Again"
, try_again_with: "Try Again With"
, search_again_with: "Search Again With"
, tip: "Addition"
, customer_selected_fare: "Customer Addition^"
...
, tip_selected: "Addition Selected"
, add_a_tip_to_find_a_ride_quicker: "Add more (voluntary) to find a ride!"
...
, educational_pop_up_slide_2_subtitle: "• Drivers will be prompted to call instead <br>   of texting. <br> • Drivers will be prompted to sound horn <br>    once at the pickup. <br> • Drivers will be sensitised to help them with <br>    their needs and requests."
, educational_pop_up_slide_3_subtitle: "• Drivers will be prompted to text instead <br>    of calling. <br> • Drivers will be prompted to message them <br>    once at the pickup. <br> • Drivers will be sensitised to help them with <br>   their needs and requests."
, educational_pop_up_slide_4_subtitle: "• Drivers will be prompted to come to their <br>    exact location for pickup. <br> • Drivers will be prompted to help them <br>    with their mobility aid. <br>• Drivers will be sensitised to help them with <br>   their needs and requests."
, educational_pop_up_slide_5_subtitle: "• We will be collecting other types of <br>   disabilities and shall be incorporating them <br>   among the list of disabilities available <br>   as needed."
...
, view_more: "View More"
, view_less: "View Less"
, have_a_refferal: "Got a referral Code?"
...
, a_tip_helps_find_a_ride_quicker: "Voluntary addition helps find a ride!"
, tip_added: "amount added!"
, continue_search_with_no_tip: "Continue Search"
, searching_with_no_tip: "Searching without Addition"
...
, try_adding_tip_or_change_ride_type: "Try adding more or changing your ride type"
, applicable_toll_charges: "Toll Charges are included in your fare"
, update_tip_str: "Update Addition"
, book: (\name -> "Book " <> name)
, book_for_: (\name -> "Book for " <> name)
...
, live_chat: "Live Chat"
, driver_tip_addition: "Driver Addition"
...
, tip_can_be_added: (\maxTip -> "Upto ₹" <> maxTip <> " can be added to the ride fare.")
...
, no_remaining_tickets : "No remaining tickets"
    ...
    , to_get_the_referral_reward_new_user_should_install_the_app_and_enter_the_referral_code_before_taking_their_first_ride: "To get the referral reward, new user should install the app and enter the referral code before taking their first ride."
    , the_referral_reward_will_be_given_only_for_the_first_ride_post_checking_the_ride_validity: "The referral reward will be given only for the first ride post checking the ride validity."
    , the_referral_reward_program_is_a_time_bound_program_and_can_be_stopped_at_any_time_without_prior_intimation: "The referral reward program is a time bound program and can be stopped at any time without prior intimation."
    , namma_yatri_reserves_the_right_to_determine_the_eligibility_of_a_customer_to_be_valid_for_referral_reward_or_not: "Namma Yatri reserves the right to determine the eligibility of a customer to be valid for referral reward or not."
    , collect_referral_earnings: "Collect Referral Earnings"
    , verify_your_upi_id_to_receive_your_referral_earnings: "Verify your UPI ID to receive your referral earnings"
    , upi_id_verified: "UPI ID Verified!"
    , enter_upi_id_in_the_format_numberbankname: "Enter UPI ID in the format “number@bankname”"
