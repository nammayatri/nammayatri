...
, here_is_a_surprise_upgrade : "यहाँ एक आश्चर्यजनक उन्नयन है! 🎉"
, new_fare : "नया किराया: "
, confirming_ride_in : (\time -> time <> "s में सवारी की पुष्टि")
, no_continue_search_for : (\serviceTierName -> "नहीं, " <> serviceTierName <> " की खोज जारी रखें")
}