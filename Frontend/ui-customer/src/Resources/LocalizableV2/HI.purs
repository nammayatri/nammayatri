...
, referral_code_failed: "रेफरल कोड विफल हुआ! कृपया जांच करें और फिर से प्रयास करें।"
    , enter_6_digit_referral_code : "अपना रेफरल कोड दर्ज करें"
...
, no_remaining_tickets : "कोई शेष टिकट नहीं"
    ...
    , success: "सफलता"
    , invite_and_earn_: \ a ->"आमंत्रित करें और कमाएं!"
    ...
    , credited_to_the_referees_account_when_the_referee__use_your_referral_code_for_app_installation_and_then_takes_a_valid_ride : \a -> "रेफ़री के खाते में जमा किया जाएगा, जब वह आपके रेफ़रल कोड का उपयोग करके ऐप इंस्टॉल करता है और एक वैध सवारी लेता है।"
    , credited_to_your_account_when_your_referee_uses_your_referral_code_for_app_installation_and_uses_the_app_for_taking_a_valid_ride: \a -> "आपके खाते में जमा किया जाएगा, जब आपका रेफ़री आपके रेफ़रल कोड का उपयोग करके ऐप इंस्टॉल करता है और एक वैध सवारी लेता है।"
