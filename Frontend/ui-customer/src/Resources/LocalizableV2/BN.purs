...
, here_is_a_surprise_upgrade : "এখানে একটি আশ্চর্যজনক আপগ্রেড! 🎉"
, new_fare : "নতুন ভাড়া: "
, confirming_ride_in : (\time -> time <> "s মধ্যে রাইড নিশ্চিত করা")  
, no_continue_search_for : (\serviceTierName -> "না, " <> serviceTierName <> " এর জন্য অনুসন্ধান চালিয়ে যান।")
}