...
, no_remaining_tickets : "কোনো অবশিষ্ট টিকিট নেই" 
    ...
    , you_get: "আপনি পাবেন"
    , they_get: "তারা পাবে"
    , credited_to_the_referees_account_when_the_referee__use_your_referral_code_for_app_installation_and_then_takes_a_valid_ride: "রেফারির অ্যাকাউন্টে যোগ হবে, যদি সে আপনার রেফারেল কোড ব্যবহার করে অ্যাপ ইনস্টল করে এবং একটি বৈধ রাইড নেয়।"
    , credited_to_your_account_when_your_referee_uses_your_referral_code_for_app_installation_and_uses_the_app_for_taking_a_valid_ride: "আপনার অ্যাকাউন্টে যোগ হবে, যদি আপনার রেফারেল কোড ব্যবহার করে রেফারি অ্যাপ ইনস্টল করে এবং একটি বৈধ রাইড নেয়।"
