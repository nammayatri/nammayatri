...
, referral_code_failed:"রেফারেল কোড ব্যর্থ হয়েছে! অনুগ্রহ করে যাচাই করুন এবং আবার চেষ্টা করুন।"
    , enter_6_digit_referral_code: "আপনার রেফারেল কোড প্রবেশ করুন"
...
, no_remaining_tickets : "কোনো অবশিষ্ট টিকিট নেই" 
    ...
    , took_cab_ride_using_referral_code: "রেফারেল কোড ব্যবহার করে ক্যাব রাইড নিয়েছেন"
    , success: "সফলতা"
    , invite_and_earn_: \ a ->"আমন্ত্রণ করুন এবং উপার্জন করুন!"
    , enjoy_extra_kekkadha_rides: "& অতিরিক্ত কেক্কাদা রাইডস উপভোগ করুন!"
    , your_invite_code: "আপনার আমন্ত্রণ কোড"
    , share: "শেয়ার করুন"
    , you_get: "আপনি পাবেন"
    , they_get: "তারা পাবে"
    , credited_to_the_referees_account_when_the_referee__use_your_referral_code_for_app_installation_and_then_takes_a_valid_ride : \a -> "রেফারির অ্যাকাউন্টে যোগ হবে, যদি সে আপনার রেফারেল কোড ব্যবহার করে অ্যাপ ইনস্টল করে এবং একটি বৈধ রাইড নেয়।"
    , credited_to_your_account_when_your_referee_uses_your_referral_code_for_app_installation_and_uses_the_app_for_taking_a_valid_ride: \a -> "আপনার অ্যাকাউন্টে যোগ হবে, যদি আপনার রেফারেল কোড ব্যবহার করে রেফারি অ্যাপ ইনস্টল করে এবং একটি বৈধ রাইড নেয়।"
    , have_questions: "প্রশ্ন আছে?"
    , _view_the_faqs: "প্রায়শই জিজ্ঞাসিত প্রশ্নাবলী দেখুন"
    , referral_faqs: "রেফারেল প্রশ্নাবলী"
    , to_get_the_referral_reward_new_user_should_install_the_app_and_enter_the_referral_code_before_taking_their_first_ride: "রেফারেল পুরস্কার পেতে, নতুন ব্যবহারকারীকে অ্যাপটি ইনস্টল করতে হবে এবং তাদের প্রথম যাত্রার আগে রেফারেল কোড প্রবেশ করাতে হবে।"
    , the_referral_reward_will_be_given_only_for_the_first_ride_post_checking_the_ride_validity: "যাত্রার বৈধতা পরীক্ষা করার পরে শুধুমাত্র প্রথম যাত্রার জন্য রেফারেল পুরস্কার দেওয়া হবে।"
    , the_referral_reward_program_is_a_time_bound_program_and_can_be_stopped_at_any_time_without_prior_intimation: "রেফারেল পুরস্কার প্রোগ্রাম একটি সময়-সীমাবদ্ধ প্রোগ্রাম এবং এটি পূর্ব বিজ্ঞপ্তি ছাড়াই যে কোনও সময় বন্ধ করা যেতে পারে।"
    , namma_yatri_reserves_the_right_to_determine_the_eligibility_of_a_customer_to_be_valid_for_referral_reward_or_not: "কোনও গ্রাহক রেফারেল পুরস্কারের জন্য যোগ্য কিনা তা নির্ধারণ করার অধিকার নাম্মা যাত্রীর রয়েছে।"
    , collect_referral_earnings: "রেফারেল উপার্জন সংগ্রহ করুন"
    , verify_your_upi_id_to_receive_your_referral_earnings: "আপনার রেফারেল উপার্জন পেতে আপনার UPI ID যাচাই করুন"
    , upi_id_verified: "UPI ID যাচাই করা হয়েছে!"
    , enter_upi_id_in_the_format_numberbankname: "“সংখ্যা@ব্যাংকের নাম” ফরম্যাটে UPI আইডি প্রবেশ করুন"
    ...
    , pendingamount_will_be_credited_soon_to_n_statedatavpa: \ a b -> a <> " শীঘ্রই " <> b <> "তে জমা হবে"
    , amount: "পরিমাণ"
