...
newtype Keymap = Keymap {
    ...
    success  :: String ,
    invite_and_earn_  :: String ,
    enjoy_extra_kekkadha_rides  :: String ,
    your_invite_code  :: String ,
    share  :: String ,
    you_get  :: String ,
    they_get  :: String ,
    credited_to_the_referees_account_when_the_referee__use_your_referral_code_for_app_installation_and_then_takes_a_valid_ride  :: String ,
    credited_to_your_account_when_your_referee_uses_your_referral_code_for_app_installation_and_uses_the_app_for_taking_a_valid_ride  :: String ,
...
downlaod_app :: Proxy "downlaod_app"
downlaod_app = a
