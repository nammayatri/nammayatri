...
getHI script = case script of
  ...
  SELECT_A_RIDE -> "कोई राइड चुनें"
  SELECT_A_RIDE_FOR_MORE_DETAILS -> "ज़्यादा जानकारी के लिए कोई राइड चुनें"
  CONFIRMING_SELECTED_RIDE_IN -> "में चुने गए राइड इन की पुष्टि की जा रही है"
