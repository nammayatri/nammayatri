...
getHI script = case script of
  ...
  EARLY_RIDE_END_TEXT1 -> "आपकी राइड जल्दी खत्म हो गई! आपके ड्राइवर पार्टनर को उचित मुआवजा देने के लिए, ₹"
  EARLY_RIDE_END_TEXT2 -> " का शुल्क जोड़ दिया गया है।"
