...
getHI script = case script of
  ...
  NOMINAL_FARE -> "चालक परिवर्धन*"
  DRIVERS_CAN_CHARGE_AN_ADDITIONAL_FARE_UPTO -> "*चालक यातायात, वापसी यात्रा के अवसर आदि को कवर करने के लिए अतिरिक्त बोली लगा सकता है। चालक की अतिरिक्त सीमा की गणना आधार किराए के 10% पर निकटतम ₹10 तक की जाती है।"
