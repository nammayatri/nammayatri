...
getKN script = case script of
  ...
  MESSAGE -> "ಸಂದೇಶ"
  I_WILL_BE_THERE_IN_2_MINS -> "2 ನಿಮಿಷಗಳಲ್ಲಿ ಪಿಕಪ್‌ಗೆ ಬರಲಿದೆ"
  I_AM_AT_THE_PICKUP_LOCATION -> "ನಾನು ಪಿಕಪ್ ಸ್ಥಳದಲ್ಲಿದ್ದೇನೆ"
  ARE_YOU_COMING -> "ನೀವು ಬರುವಿರಾ?"
  I_HAVE_ARRIVED -> "ನಾನು ಆಗಮಿಸಿದ್ದೇನೆ"
  I_AM_STUCK_IN_TRAFFIC -> "ನಾನು ಟ್ರಾಫಿಕ್‌ನಲ್ಲಿ ಸಿಲುಕಿಕೊಂಡಿದ್ದೇನೆ"
  I_AM_ON_THE_WAY -> "ನಾನು ಪಿಕಪ್‌ಗೆ ಬರುತ್ತಿದ್ದೇನೆ"
  START_YOUR_CHAT_WITH_THE_DRIVER -> "ಚಾಲಕನೊಂದಿಗೆ ನಿಮ್ಮ ಚಾಟ್ ಅನ್ನು ಪ್ರಾರಂಭಿಸಿ"
  YES_I_AM_ALMOST_THERE -> "ತಲುಪುತ್ತೇನೆ"
  DELAYED_A_BIT_REACHING_IN_SOME_TIME -> "ಸ್ವಲ್ಪ ತಡವಾಯಿತು; ಕೆಲವೇ ಸಮಯದಲ್ಲಿ ತಲುಪುತ್ತೇನೆ"
  OKAY -> "ಓಕೆ"
  PLEASE_BE_QUICK_I_AM_WAITING -> "ಓಕೆ, ಸ್ವಲ್ಪ ತಡವಾಯಿತು; ಕೆಲವೇ ಸಮಯದಲ್ಲಿ ತಲುಪುತ್ತದೆ"
