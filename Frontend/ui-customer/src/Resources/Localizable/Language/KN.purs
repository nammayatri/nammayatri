...
getKN script = case script of
  ...
  CALL_DRIVER_USING -> "ಇದನ್ನು ಬಳಸಿಕೊಂಡು ಚಾಲಕನಿಗೆ ಕರೆ ಮಾಡಿ:"
  ...
  THANK_YOUR_DRIVER -> "ನಿಮ್ಮ ಚಾಲಕನಿಗೆ ಧನ್ಯವಾದಗಳು!"
  ...
  SKIP -> "ಬಿಟ್ಟುಬಿಡಿ"
  ERROR_404 -> "ದೋಷ 404"
  PROBLEM_AT_OUR_END -> "ನಮ್ಮ ಕಡೆಯಿಂದ ಸಮಸ್ಯೆ ಇದೆ ಎಂದು ತೋರುತ್ತದೆ. ನಾವು ಮತ್ತೆ ಲಭ್ಯವಾದಾಗ ಸೂಚನೆ ಪಡೆಯಿರಿ"
  ...
  TRY_CONNECTING_WITH_THE_DRIVER -> "ಚಾಲಕನೊಂದಿಗೆ ನೇರವಾಗಿ ಸಂಪರ್ಕಿಸಲು ನೀವು ಕಾಲ್‌ಬ್ಯಾಕ್ ಅನ್ನು ವಿನಂತಿಸಬಹುದು"
  ...
  RATE_YOUR_DRIVER -> "ನಿಮ್ಮ ಚಾಲಕನನ್ನು ರೇಟ್ ಮಾಡಿ"
  ...
  AUTO_ASSIGN_DRIVER -> "ಚಾಲಕನನ್ನು ಸ್ವಯಂ ನಿಯೋಜಿಸಿ"
