...
getKN script = case script of
  ...
  SELECT_A_RIDE -> "ಸವಾರಿಯನ್ನು ಆಯ್ಕೆಮಾಡಿ"
  SELECT_A_RIDE_FOR_MORE_DETAILS -> "ಹೆಚ್ಚಿನ ವಿವರಗಳಿಗಾಗಿ ಸವಾರಿಯನ್ನು ಆಯ್ಕೆಮಾಡಿ"
  CONFIRMING_SELECTED_RIDE_IN -> "ಆಯ್ಕೆಮಾಡಿದ ಸವಾರಿಯನ್ನು ದೃಢೀಕರಿಸಲಾಗುತ್ತಿದೆ"
