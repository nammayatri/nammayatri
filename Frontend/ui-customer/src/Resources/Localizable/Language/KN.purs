...
getKN script = case script of
  ...
  DRIVERS_CAN_CHARGE_AN_ADDITIONAL_FARE_UPTO -> "*ಚಾಲಕರು ಟ್ರಾಫಿಕ್, ರಿಟರ್ನ್ ಟ್ರಿಪ್‌ನ ಅವಕಾಶ ಇತ್ಯಾದಿಗಳನ್ನು ಸರಿದೂಗಿಸಲು ಹೆಚ್ಚುವರಿಯನ್ನು ಉಲ್ಲೇಖಿಸಬಹುದು. ಚಾಲಕ ಸೇರ್ಪಡೆ ಮಿತಿಗಳನ್ನು ಮೂಲ ದರದ 10% ರಷ್ಟು ಹತ್ತಿರದ ₹10 ಕ್ಕೆ ಪೂರ್ಣಗೊಳಿಸಲಾಗುತ್ತದೆ."
