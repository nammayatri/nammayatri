...
getML stringKey =
    case stringKey of
        ...
        LOCATION_PERMISSION_SUBTITLE_NEW_USER -> "നമ്മ യാത്രി എന്നാൽ സ്വാഗതമാണ്! \nറൈഡുകൾ ബുക്ക് ചെയ്വാൻ, ഞങ്ങളുടെ നിങ്ങളുടെ ഡിവൈസ് സ്ഥാനം ആവശ്യമാണ്."
        YOUR_FEEDBACK_HELPS_US -> "നിനക്ക് എങ്ങനെ നിങ്ങളുടെ യാത്ര സാഥി അനുഭവം സുധാരിക്കാനായി നിനക്ക് സഹായിക്കുന്നു"
