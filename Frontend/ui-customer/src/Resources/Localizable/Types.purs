...
data STR
  = ABOUT
 | CONFIRM
 | CHOOSE_MODE_OF_PAYMENT 
 | PAY_ONLINE_ONCE_RIDE_HAS_ENDED 
 | PAY_THE_DRIVER_DIRECTLY_USING_CASH 
...
getKeyString key = case key of
  ...
  REPLY -> "REPLY"
  CHOOSE_MODE_OF_PAYMENT -> "CHOOSE_MODE_OF_PAYMENT"
  PAY_ONLINE_ONCE_RIDE_HAS_ENDED -> "PAY_ONLINE_ONCE_RIDE_HAS_ENDED"
  PAY_THE_DRIVER_DIRECTLY_USING_CASH -> "PAY_THE_DRIVER_DIRECTLY_USING_CASH"
