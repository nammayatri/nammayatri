...
getKeyString key = case key of
  ...
  IS_WAITING_AT_PICKUP -> "IS_WAITING_AT_PICKUP"
  ...
  YOU_SEEM_TO_BE_FAR_FROM_PICK_UP -> "YOU_SEEM_TO_BE_FAR_FROM_PICK_UP"
  ARE_YOU_SURE_YOU_WANT_TO_PROCEED_WITH_THE_BOOKING -> "ARE_YOU_SURE_YOU_WANT_TO_PROCEED_WITH_THE_BOOKING"
  MY_TICKETS -> "MY_TICKETS"
  SOMETHING_WENT_WRONG_TRY_AGAIN_LATER -> "SOMETHING_WENT_WRONG_TRY_AGAIN_LATER"
  YOU_CAN_BOOK_TICKETS_TO_THE_ZOO_BY_CLICKING_THE_BUTTON -> "YOU_CAN_BOOK_TICKETS_TO_THE_ZOO_BY_CLICKING_THE_BUTTON"
  CHARGES_APPLICABLE_AFTER_3_MINS -> "CHARGES_APPLICABLE_AFTER_3_MINS"
  REACHING_YOUR_DESTINATION_IN_ -> "REACHING_YOUR_DESTINATION_IN_"
  WAITING_AT_PICKUP -> "WAITING_AT_PICKUP"
  LEARN_MORE -> "LEARN_MORE"
  PICKUP -> "PICKUP"
  PAY_BY_CASH_OR_UPI -> "PAY_BY_CASH_OR_UPI"
  WAIT_TIMER -> "WAIT_TIMER"
  HOW_LONG_DRIVER_WAITED_FOR_PICKUP -> "HOW_LONG_DRIVER_WAITED_FOR_PICKUP"
  YOU_WILL_PAY_FOR_EVERY_MINUTE -> "YOU_WILL_PAY_FOR_EVERY_MINUTE"
  CHAT_WITH -> "CHAT_WITH"
  QUICK -> "QUICK"
  CHATS -> "CHATS"
  REPLIES -> "REPLIES"
  ...
  YOU_SENT -> "YOU_SENT"
  MESSAGE_YOUR_DRIVER -> "MESSAGE_YOUR_DRIVER"
  CHECK_IN_WITH_YOUR_DRIVER -> "CHECK_IN_WITH_YOUR_DRIVER"
  TRACK_ON_GOOGLE_MAPS -> "TRACK_ON_GOOGLE_MAPS"
  OTP_EXPIRE_TIMER -> "OTP_EXPIRE_TIMER"
  SHOWS_FOR_HOW_LONG_YOUR_OTP_ -> "SHOWS_FOR_HOW_LONG_YOUR_OTP_"
  IF_YOUR_OTP_EXPIRES_ -> "IF_YOUR_OTP_EXPIRES_"
  YOU_HAVE_REACHED_DESTINATION -> "YOU_HAVE_REACHED_DESTINATION"