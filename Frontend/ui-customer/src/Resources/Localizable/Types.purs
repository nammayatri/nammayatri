...
data STR
 ...
 | INVALID_REFERRAL_CODE
  ...
  | HERE_IS_BUS_TICKET
  | DASHCAM_LEARN_MORE_POP_UP
  | DASHCAM_LEARN_MORE_BULLET_1
  | DASHCAM_LEARN_MORE_BULLET_2
  | DASHCAM_INTRO_POP_UP_TITLE
  | DASHCAM_INTRO_POP_UP_BULLET_1
  | DASHCAM_INTRO_POP_UP_BULLET_2
  | HELP_AND_SUPPORT_SAFETY_PLUS
  | CALL_CAUTIO_SUPPORT
  | REACH_OUT_TO_CAUTIO
  | ENABLE_CAUTIO
  | SECURED_WITH_SAFETY_PLUS
  | PREFER_SAFTEY_PLUS_CAUTIO
  | SAFETY_PLUS_BY