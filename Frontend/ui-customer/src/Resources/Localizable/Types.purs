...
data STR
 ...
 | IF_YOU_FEEL_THIS_IS_WRONGLY_CHARGED
 | CANCELLATION_FEE_WILL_BE_APPLIED
 | DRIVER_IS_ALREADY_ON_THE_WAY
 | YOUR_DRIVER_IS_DISTANCE_AWAY Int
 | YOU_HAVE_DUE_AGAINST_PREVIOUS_CANCELLATIONS Int
 | THIS_WILL_BE_ADDED_TO_YOUR_NEXT_RIDE
 | CHARGE_DUE_AGAINST_PREVIOUS_CANCELLATION_WILL_BE_ADDED_TO_THIS_RIDE Int
 | RUPEES_PAYABLE Int 
 | CLEAR_DUES
 | INCLUDES_PREVIOUS_CANCELLATION_FEE Int
 | RIDE_CANCELLATION_DUE
 | WHICH_IS_ADDED_TO_THIS_RIDE
 | CLEAR_YOUR_DUES_TO_CONTINUE_TAKING_RIDES
