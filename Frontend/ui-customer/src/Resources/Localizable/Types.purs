...
data STR =  DOWNLOAD_INVOICE
        ...
        | REASON_EARLY_RIDE_END_CHARGES_A
        | REASON_EARLY_RIDE_END_CHARGES_B


type CALL_DRIVER_USING = String
type DIRECT_CALL = String
type ANONYMOUS_CALL = String
type YOUR_NUMBER_WILL_NOT_BE_SHOWN_TO_THE_DRIVER = String
type YOUR_NUMBER_WILL_BE_VISIBLE_TO_THE_DRIVER_USE_IF_NOT_CALLING_FROM_REGISTERED_NUMBER = String
type CUSTOMER_TIP_DESCRIPTION = String
type NO_TIP = String
type CUSTOMER_SELECTED_FARE = String
type PLEASE_TELL_US_WHY_YOU_WANT_TO_CANCEL = String
type NO_DONT = String
type YES_CANCEL_SEARCH = String
type YES_TRY_AGAIN = String
...
type TRY_LOOKING_FOR_RIDES_AGAIN = String

type CANCEL_ONGOING_SEARCH = String

type GO_BACK_ = String

type SEARCH_AGAIN_WITH_A_TIP = String

type TRY_AGAIN_WITH_A_TIP = String

type BOOST_YOUR_RIDE_CHANCES_AND_HELP_DRIVERS_WITH_TIPS = String

type TRY_AGAIN_WITHOUT_TIP = String
type SEARCH_AGAIN_WITHOUT_A_TIP = String

type TRY_AGAIN_WITH = String
type SEARCH_AGAIN_WITH = String
...
type ADD_ANOTHER_CONTACT = String
...
type FARE_UPDATE_POLICY = String
type DRIVER_ADDITIONS_OPTIONAL = String
type THE_DRIVER_MAY_QUOTE_EXTRA_TO_COVER_FOR_TRAFFIC = String
type DRIVER_ADDITIONS_ARE_CALCULATED_AT_RATE = String
type DRIVER_MAY_NOT_CHARGE_THIS_ADDITIONAL_FARE = String
type YOU_MAY_SEE_AN_UPDATED_FINAL_FARE_DUE_TO_ANY_OF_THE_BELOW_REASONS = String
type REASON_CHANGE_IN_ROUTE_A = String
type REASON_CHANGE_IN_ROUTE_B = String
type REASON_EARLY_RIDE_END_CHARGES_A = String
type REASON_EARLY_RIDE_END_CHARGES_B = String
