...
data STR
 ...
 | INVALID_REFERRAL_CODE
  ...
  | TRICHY
  | REQUEST_POLICE_HELP
  | OPTION_TO_SEEK_IMMEDIATE_POLICE_HELP
  | LAYERED_SAFETY_CHECKS_IN_CASE_OF_DEVIATIONS_IN_RIDES_AT_NIGHT
  | SEEK_POLICE_HELP
  | SEEK_POLICE_HELP_SUBTEXT_ONE
  | SEEK_POLICE_HELP_SUBTEXT_TWO
  | INCIDENT_REPORTED_SUCCESSFULLY
