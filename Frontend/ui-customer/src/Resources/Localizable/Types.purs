...
data STR
 ...
 | INVALID_REFERRAL_CODE
  ...
  | HERE_IS_BUS_TICKET
    | YOUR_EARNINGS_WILL_BE_CREDITED_TO_THIS_ACCOUNT
    | TRANSACTION_HISTORY
    | TOTAL_EARNED
    | TOOK_CAB_RIDE_USING_REFERRAL_CODE
    | SUCCESS
    | INVITE_AND_EARN_ String
    | ENJOY_EXTRA_KEKKADHA_RIDES
    | YOUR_INVITE_CODE
    | SHARE
    | YOU_GET
    | THEY_GET
    ...
    | VIEW_THE_FAQS
    | REFERRAL_FAQS
    | TO_GET_THE_REFERRAL_REWARD_NEW_USER_SHOULD_INSTALL_THE_APP_AND_ENTER_THE_REFERRAL_CODE_BEFORE_TAKING_THEIR_FIRST_RIDE
    | THE_REFERRAL_REWARD_WILL_BE_GIVEN_ONLY_FOR_THE_FIRST_RIDE_POST_CHECKING_THE_RIDE_VALIDITY
    | THE_REFERRAL_REWARD_PROGRAM_IS_A_TIME_BOUND_PROGRAM_AND_CAN_BE_STOPPED_AT_ANY_TIME_WITHOUT_PRIOR_INTIMATION
    | NAMMA_YATRI_RESERVES_THE_RIGHT_TO_DETERMINE_THE_ELIGIBILITY_OF_A_CUSTOMER_TO_BE_VALID_FOR_REFERRAL_REWARD_OR_NOT
    | COLLECT_REFERRAL_EARNINGS
    | VERIFY_YOUR_UPI_ID_TO_RECEIVE_YOUR_REFERRAL_EARNINGS
    | UPI_ID_VERIFIED
    | ENTER_UPI_ID_IN_THE_FORMAT_NUMBERBANKNAME
    | UPI_ID_IS_INVALID_PLEASE_CHECK_AND_REENTER
    | GO_BACK
    | YAY_YOU_HAVE_REFERRAL_EARNINGS
    | YOUR_EARNINGS_N_
    | COLLECT_NOW
    | SUBMITTED
    | UPDATED
    | PENDINGAMOUNT_WILL_BE_CREDITED_SOON_TO_N_STATEDATAVPA String String
    | AMOUNT
    | DOWNLOAD_APP
    | SCAN_QR_CODE_TO_DOWNLOAD_THE_APP_AND_APPLY_YOUR_INVITE_CODE_AUTOMATICALLY
    | EARN_ String
    | COLLECT_ String
    | ADD_UPI_ID
    | EARNINGS
    | ENTER_UPI_ID
    | YOU_GET_50__THEY_GET_50 String String
    | WHEN_YOUR_FRIEND_USES_YOUR_REFERRAL_CODE_N_AND_TAKES_THEIR_FIRST_RIDE
    | READ_TERMS_AND_CONDITIONS
    | RIDE_IS_CONSIDERED_VALID_BASED_ON_CERTAIN_RIDE_DISTANCE_RIDE_TIME_AND_FRAUD_CHECKS_MAINTAINED_INTERNALLY
    | COLLECT_EARNINGS_NOW
    | UPDATE_UPI_ID
    | YOUVE_EARNED_50_FOR_TAKING_YOUR_FIRST_RIDE String
    | GET_50_REFERRAL_BENEFIT_FOR_YOUR_FIRST_RIDE String
    | TAKE_A_RIDE_NOW
    | TAKE_A_RIDE__CLAIM_50 String
    | SELECT_ROUTE
  | AC_BUS
  | EARLY_DEPARTURE
  | TICKET_PRICE
