...
getKeyString key = case key of
  ...
  WE_NOTICED_YOUR_RIDE_HASNT_MOVED -> "WE_NOTICED_YOUR_RIDE_HASNT_MOVED"
  WE_NOTICED_YOUR_RIDE_IS_ON_DIFFERENT_ROUTE -> "WE_NOTICED_YOUR_RIDE_IS_ON_DIFFERENT_ROUTE"
  WE_ARE_HERE_FOR_YOU -> "WE_ARE_HERE_FOR_YOU"
  I_NEED_HELP -> "I_NEED_HELP"
  I_FEEL_SAFE -> "I_FEEL_SAFE"
  EVERYTHING_OKAY_Q -> "EVERYTHING_OKAY_Q"
  PLEASE_REMAIN_CALM_YOU_CAN_REQUEST_AN_IMMEDIATE_CALL -> "PLEASE_REMAIN_CALM_YOU_CAN_REQUEST_AN_IMMEDIATE_CALL"
  RECEIVE_CALL_FROM_SUPPORT -> "RECEIVE_CALL_FROM_SUPPORT"
  DISMISS -> "DISMISS"
