...
getKN stringKey =
    case stringKey of
        ...
        KOZHIKODE -> "ಕೋಝಿಕೋಡ್"
        THRISSUR -> "ತೃಶೂರ್"
        TRIVANDRUM -> "ತಿರುವನಂತಪುರಂ"        METRO_FREE_TICKET_EVENT freeTicketInterval -> "ಪ್ರತಿ " <> freeTicketInterval <> " ಟಿಕೆಟ್ ಉಚಿತವಾಗಿದೆ!"
        METRO_FREE_TICKET_EVENT_DESC freeTicketInterval maxFreeTicketCashback -> "ಪ್ರತಿ " <> freeTicketInterval <> " ಟಿಕೆಟ್ ಉಚಿತವಾಗಿದೆ (ಅತ್ಯಧಿಕ ₹" <> maxFreeTicketCashback <> ")"
