...
getKN stringKey =
    case stringKey of
        ...
        SALEM -> "ಸೇಲಂ"
        TRICHY -> "ತ್ರಿಚಿ"
        REQUEST_POLICE_HELP -> "ಪೋಲೀಸ್ ಸಹಾಯವನ್ನು ವಿನಂತಿಸಿ"
        OPTION_TO_SEEK_IMMEDIATE_POLICE_HELP -> "ತಕ್ಷಣ ಪೊಲೀಸ್ ಸಹಾಯವನ್ನು ಪಡೆಯುವ ಆಯ್ಕೆ"
        LAYERED_SAFETY_CHECKS_IN_CASE_OF_DEVIATIONS_IN_RIDES_AT_NIGHT -> "ರಾತ್ರಿ ವಿಚಲನಗಳ ಸಂದರ್ಭದಲ್ಲಿ ಲೇಯರ್ಡ್ ಸುರಕ್ಷತಾ ತಪಾಸಣೆ"
        SEEK_POLICE_HELP -> "ಪೊಲೀಸ್ ಸಹಾಯವನ್ನು ಪಡೆಯಿರಿ"
        SEEK_POLICE_HELP_SUBTEXT_ONE -> "ಎಲ್ಲಾ ಮಾರ್ಗ ಬಿಂದುಗಳನ್ನು ಒಳಗೊಂಡಂತೆ ನಿಮ್ಮ ಸವಾರಿ ಮತ್ತು ಸ್ಥಳದ ವಿವರಗಳನ್ನು ಪೊಲೀಸರೊಂದಿಗೆ ಹಂಚಿಕೊಳ್ಳಲಾಗುತ್ತದೆ"
        SEEK_POLICE_HELP_SUBTEXT_TWO -> "ಪೊಲೀಸ್ ಕ್ಯೂಆರ್‌ಟಿಯು ನೋಂದಾಯಿತ ಮೊಬೈಲ್ ಸಂಖ್ಯೆಗೆ ಕರೆ ಮಾಡುವ ಮೂಲಕ ನಿಮ್ಮನ್ನು ತಲುಪುತ್ತದೆ, ವಿಫಲವಾದರೆ ನಿಮಗೆ ಸಹಾಯ ಮಾಡಲು ಕ್ಯೂಆರ್‌ಟಿಯನ್ನು ಸಜ್ಜುಗೊಳಿಸಲಾಗುತ್ತದೆ."
        INCIDENT_REPORTED_SUCCESSFULLY -> "ಘಟನೆಯನ್ನು ಯಶಸ್ವಿಯಾಗಿ ವರದಿ ಮಾಡಲಾಗಿದೆ"
