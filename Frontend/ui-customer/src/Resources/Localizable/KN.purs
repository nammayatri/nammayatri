...
getKN stringKey =
    case stringKey of
        ...
        SHARE_INFO_WITH_EMERGENCY_CONTACTS_DESC -> "ನಿಮ್ಮ ಸೈಕಿಳ್‌ನಿಂದ ಪ್ರತಿಸಾಧಿಕೊಳ್ಳಲು, ಸ್ಥಳೀಯ ರಕ್ಷಕ ಅಥವಾ ನಗರ ಸ್ನೇಹಿತನನ್ನು ಹೀರಿ."
        ...
        RIDE_SHARE_AFTER_SIX_PM -> "9 PM ರಿಂದ 6 AM ವರೆ ನಿಮ್ಮ ಯಾತಾಯಾತ ಅಱಿಯಲು ಅಪಾತಕಾಲದ ಸಂಪರ್ಕಗಳಿಗೆ ಸೂಚನೆಗಳನ್ನು ಕಳುಹಿಸಲಾಗುತ್ತದೆ."
        WHO_CAN_TRACK_YOUR_RIDE _ -> "ನಮ್ಮ ಯಾತ್ರಾ ಆಪ್‌ನಲ್ಲಿ ನಿಮ್ಮ ಯಾತ್ರೆಯನ್ನು ಅನುಸರಿಸಬಹುದು ಯಾರು"
        ...
        RECOMMEND_EMERGENCY_CONTACTS_TO_INSTALL -> "ನಾವು ಆಪಾತ್ಕಾಲಿಕ ಸಂಪರ್ಕಗಳಿಗೆ ನಮ್ಮಯಾತ್ರಿ ಅನುಸ್ಥಾಪಿಸಲು ಸೂಚಿಸುತ್ತಾರೆ ಹೆಚ್ಚಿನ ಟ್ರ್ಯಾಕಿಂಗ್ ಅನುಭವಕ್ಕಾಗಿ"
        ...
        SAFETY_TEAM_WILL_BE_ALERTED -> "ಆಪತ್ಕಾಲದಲ್ಲಿ, ನಮ್ಮ ಯಾತ್ರಿ ಸುರಕ್ಷಾ ತಂಡಕ್ಕೆ ಅವಗಾಹನವಾಗುತ್ತದೆ"
        ...
        PLEASE_STAY_CALM_TEAM_ALERTED -> "ದಯವಿಟ್ಟು ಶಾಂತವಾಗಿರಿ, ನಮ್ಮ ಯಾತ್ರಾ ಸುರಕ್ಷಾ ತಂಡಕ್ಕೆ ಅಲರ್ಟ್ ಹೊಂದಿದೆ!"
        ...
        INDICATION_TO_EMERGENCY_CONTACTS -> "ನಿಮ್ಮ ಆಪಾತ ಸಂಪರ್ಕಗಳಿಗೆ ಇದು ಪರೀಕ್ಷಣ ಎಂದು ಸೂಚಿಸುತ್ತದೆ, ದುಃಖರಹಿತ ಅನುಭವವನ್ನು ಖಚಿತಪಡಿಸುತ್ತದೆ."
        ARE_YOU_READY_TO_START_DRILL -> "ನೀವು ಪರೀಕ್ಷೆ ಡ್ರಿಲ್ ಪ್ರಾರಂಭಿಸಲು ಸಿದ್ಧರಾಗಿದ್ದೀರಾ?"
        TEST_DRILL_DESC -> "ನಿಮ್ಮ ಆಪತ್ಕಾಲ ಸಂಪರ್ಕಗಳಿಗೆ ನಿಮ್ಮ ಪ್ರಯಾಣವನ್ನು ಹಂಚಿಕೊಳ್ಳಲು ನಿಮ್ಮ ಸುರಕ್ಷಾ ಡ್ರಿಲ್ ಪರೀಕ್ಷಿಸಿ"
