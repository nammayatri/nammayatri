...
getEN stringKey =
    case stringKey of
        ...
        EMERGENCY_CONTACTS_SCREEN_DESCRIPTION -> "Choose responsive contacts for your ride, like a local guardian or a city friend."
        COPIED -> "Copied"
        TRIP_ID -> "Trip Id"
        ...
        GET_OPTIONS_TO_DIRECTLY_CALL_POLICE -> "Option to directly call Police Helpline"
        ...
        RIDE_SHARE_AFTER_SIX_PM -> "Auto share my trip with emergency contacts after 6pm"
        WHO_CAN_TRACK_YOUR_RIDE -> "Who can track your ride after 6pm"
        ...
        EMERGENCY_CONTACTS_CAN_FOLLOW -> "Emergency contacts can follow and take emergency response actions"
        ALERT_SAFETY_TEAM -> "Alert Namma Yatri Safety Team"
        OPTION_TO_REPORT_A_SAFETY_ISSUE -> "Option to Report a Safety Issue"
        RECOMMEND_EMERGENCY_CONTACTS_TO_INSTALL -> "We recommend emergency contacts to install NammaYatri for an enhanced tracking experience"
        TEST_SAFETY_DRILL -> "Test Safety Drill"
        START_TEST_DRILL -> "Start Test Drill"
        REPORT_SAFETY_ISSUE -> "Report Safety Issue"
        SAFETY_TEAM_WILL_BE_ALERTED -> "Upon SOS  Namma Yatri safety team will be notified"
        ...
        SHARE_RIDE_DESCRIPTION -> "On choosing this NY will send app push notification to the emergency contacts"
        SHARE_RIDE_WITH_CONTACT -> "Share with {} contact"
        SHARE_LINK -> "Share Link"
        GLAD_TO_KNOW_YOU_ARE_SAFE -> "Glad to know that you are safe!"
        PLEASE_STAY_CALM_TEAM_ALERTED -> "Please stay calm, Namma Yatri safety team is alerted!"
        ...
        INDICATION_TO_EMERGENCY_CONTACTS -> "NammaYatri will indicate to your emergency contacts that this is a test drill, ensuring a stress-free experience."
