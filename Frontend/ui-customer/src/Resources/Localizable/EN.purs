...
getEN stringKey =
    case stringKey of
        ...
        YOU_WILL_PAY_FOR_EVERY_MINUTE -> "Waiting Charge is zero for the first {} minutes. Waiting Charge of ₹{} per minute will be applicable thereafter."
        ...
        EXCESS_DISTANCE_CHARGE_DESCRIPTION -> "Any distance covered in excess of the included kms will be charged extra"
        ...
        RENTAL_INFO_POLICY_DESC -> "<b>·</b> Each hour of rental booking gets you a base of 10 kilometers.<br><br><b>·</b> You can choose to add more kilometers at a lower price for the same selected rental duration by increasing the distance."