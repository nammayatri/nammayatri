...
getEN stringKey =
    case stringKey of
        ...
        APP_TOLL_CHARGES -> "Applicable Toll charges are included in the fares"
        APP_PARKING_CHARGES -> "Applicable Parking charges are included in the fares"
        APP_TOLL_PARKING_CHARGES -> "Applicable Toll & Parking charges are included in the fares"
