...
getEN stringKey =
    case stringKey of
        ...
        SALEM -> "Salem"
        TRICHY -> "Trichy"
        REQUEST_POLICE_HELP -> "Request Police Help"
        OPTION_TO_SEEK_IMMEDIATE_POLICE_HELP -> "Option to seek immediate police help"
        LAYERED_SAFETY_CHECKS_IN_CASE_OF_DEVIATIONS_IN_RIDES_AT_NIGHT -> "Layered safety checks in case of deviations in rides at night"
        SEEK_POLICE_HELP -> "Seek Police Help"
        SEEK_POLICE_HELP_SUBTEXT_ONE -> "Your ride and location details including all waypoints will be shared with the police"
        SEEK_POLICE_HELP_SUBTEXT_TWO -> "The police QRT will reach out to you via call to the registered mobile number, failing which the QRT will be mobilised to help you."
        INCIDENT_REPORTED_SUCCESSFULLY -> "Incident reported successfully"
