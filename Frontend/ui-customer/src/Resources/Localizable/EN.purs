...
getEN stringKey =
    case stringKey of
        ...
        LATE_DROP_OFF -> "Late Drop/Pickup"
        ...
        RENTAL_INFO_POLICY_DESC inclusiveKms -> "&#8226;" <> inclusiveKms <> " kms for each hour of rental booking is included in your package.<br><br>&#8226; If the base distance is not sufficient, You can choose to add additional kilometers and save on extra costs."
        RENTAL_SCREEN_EXPLAINER -> "Customize the distance included in your package based on your requirement."
        INSTANT -> "Instant"
