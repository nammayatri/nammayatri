...
getEN stringKey =
    case stringKey of
        ...
        COMPLETE_YOUR_NAMMA_SAFETY_SETUP_FOR_SAFE_RIDE_EXPERIENCE -> "Complete your Safety setup for safe ride experience"
        SETUP_NOW -> "Setup Now"
        NAMMA_SAFETY -> "Safety Mode"
        ...
        TO_ENSURE_SAFETY_USERS_SHOULD -> "To ensure safety, users should:"
        ...
        EMERGENCY_INFO_SHARED_ACTION -> "Your emergency contacts and our support team has your location and video.\nUpon critical situations the police will be intimated and appropriate action will be taken."
        ...
        SHARE_LOCATION_AND_RIDE_DETAILS_WITH_NAMMA_YATRI_SUPPORT_TEAM -> "Share location and ride details with Namma Yatri Support Team"
        ACTIVATE_LIVE_VIDEO_RECORDING_FEATURES -> "Activate live video recording features"
        ...
        TRIGGER_ALERT_TO_NAMMA_YATRI_SUPPORT -> "Trigger alert to NammaYatri support"
        ...
        SAFETY_MEASURE_5 -> "Safety Training and Certification for all Namma Yatri Drivers"
        ...
        ABOUT_SOS_3 -> "Other male passengers asked to join ride without your consent"
        ...
        ABOUT_SOS_11 -> "Inform your family & friends/ Namma Yatri support by emergency sharing."
        ...
        THE_VIDEO_WILL_BE_RECORDED -> "The video will be recorded for 15 sec only and will be shared as per your settings"
        ...
        GET_OPTIONS_TO_DIRECTLY_CALL_POLICE -> "Get options to directly call Police"
        SHARE_SOS_SILENTLY_WITH_POLICE -> "Share SOS silently with Police"
        ...
        ABOUT_SOS_12_PLUS -> "You can choose to Call the Police Helpline (112) or send a silent SOS to the same"
        SAFETY_MEASURE_5_PLUS -> "Safety Training and Certification for all Yatri Sathi Drivers"
        SHARE_LOCATION_AND_RIDE_DETAILS_WITH_NAMMA_YATRI_SUPPORT_TEAM_PLUS -> "Share location and ride details with Yatri Sathi Support Team"
        ...
        CALL_SUPPORT_FOR_SAFETY -> "Call Our\nSupport"
        SAFETY_MEASURE_6 -> "Safety Training and Certification for all Namma Yatri Drivers"
