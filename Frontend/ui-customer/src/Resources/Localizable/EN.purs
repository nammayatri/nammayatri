...
getEN stringKey =
    case stringKey of
        ...
        ENABLE_NIGHT_TIME_SAFETY_ALERTS_DESC -> "To ensure your safety, from <b><span style='color:#454545'>9 PM-6AM</span></b>, we would send safety check alerts basis anomaly detection of driver’s route. In cases of route-deviation or when vehicle is not moving."
