...
getEN stringKey =
    case stringKey of
        ...
        KOZHIKODE -> "Kozhikode"
        THRISSUR -> "Thrissur"
        TRIVANDRUM -> "Trivandrum"        METRO_FREE_TICKET_EVENT freeTicketInterval -> "Every " <> freeTicketInterval <> " ticket is FREE!"
        METRO_FREE_TICKET_EVENT_DESC freeTicketInterval maxFreeTicketCashback -> "Get a FREE ticket (up to ₹" <> maxFreeTicketCashback <> ") on every " <> freeTicketInterval <> " ticket"
        ...
        METRO_OFFER_DETAILS freeTicketInterval -> "Every "<> freeTicketInterval <>" one FREE"