...
getFR stringKey =
    case stringKey of
        ...
        KOZHIKODE -> "Kozhikode"
        THRISSUR -> "Thrissur"
        TRIVANDRUM -> "Trivandrum"        METRO_FREE_TICKET_EVENT freeTicketInterval -> "Réservez un billet de métro gratuit toutes les " <> freeTicketInterval <> " minutes"
        METRO_FREE_TICKET_EVENT_DESC freeTicketInterval maxFreeTicketCashback -> "Obtenez un billet GRATUIT (jusqu'à ₹" <> maxFreeTicketCashback <> ") sur chaque billet toutes les " <> freeTicketInterval <> " minutes"
