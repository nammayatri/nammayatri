...
getFR stringKey =
    case stringKey of
        ...
        SALEM -> "Salem"
        TRICHY -> "Trichy"
        REQUEST_POLICE_HELP -> "Demander de l'aide à la police"
        OPTION_TO_SEEK_IMMEDIATE_POLICE_HELP -> "Option pour demander de l'aide à la police immédiatement"
        LAYERED_SAFETY_CHECKS_IN_CASE_OF_DEVIATIONS_IN_RIDES_AT_NIGHT -> "Vérifications de sécurité en couches en cas de déviations dans les trajets de nuit"
        SEEK_POLICE_HELP -> "Demander de l'aide à la police"
        SEEK_POLICE_HELP_SUBTEXT_ONE -> "Votre trajet et vos détails de localisation, y compris tous les points de passage, seront partagés avec la police"
        SEEK_POLICE_HELP_SUBTEXT_TWO -> "La QRT de la police vous contactera par appel au numéro de mobile enregistré, en cas d'échec, la QRT sera mobilisée pour vous aider."
        INCIDENT_REPORTED_SUCCESSFULLY -> "Incident signalé avec succès"
