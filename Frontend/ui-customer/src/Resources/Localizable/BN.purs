...
getBN stringKey =
    case stringKey of
        ...
        DELIVERY_STR -> "ডেলিভারি"
        CONFIRM_PICKUP_AND_DROP_LOCATION -> "কনফার্ম পিকআপ অ্যান্ড ড্রপ"
        ...
        SENDER_NAME -> "সেন্ডারের নাম*"
        SENDER_PHONE -> "সেন্ডারের ফোন*"
        SENDERS_BUILDING_FLAT -> "সেন্ডারের বিল্ডিং/ফ্ল্যাট নং*"
        PICKUP_INSTRUCTIONS -> "পিকআপ নির্দেশাবলী (ঐচ্ছিক)"
        RECEIVER_NAME -> "রিসিভারের নাম*"
        RECEIVER_PHONE -> "রিসিভারের ফোন*"
        RECEIVERS_BUILDING_FLAT -> "রিসিভারের বিল্ডিং/ফ্ল্যাট নং*"
        ...
        PLEASE_REFRESH_ONCE_DRIVER_TAKES_PHOTO -> "দয়া করে রিফ্রেশ করুন যখন ড্রাইভার প্যাকেজের ছবি তুলবে।"
