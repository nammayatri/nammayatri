...
getBN stringKey =
    case stringKey of
        ...
        YOU_HAVE_AN_ACTIVE_RIDE bookingTime -> "আপনার একটি সক্রিয় রাইড " <> bookingTime <> " পর্যন্ত আছে। একটি নতুন বুকিং তৈরি করতে, বিদ্যমান বুকিংটি বাতিল করুন অথবা এটি সম্পন্ন"
