...
getBN stringKey =
    case stringKey of
        ...
        SHARE_LOCATION_AND_RIDE_DETAILS_WITH_NAMMA_YATRI_SUPPORT_TEAM _ -> "নম্মা যাত্রী সাপোর্ট টিমের সাথে অবস্থান এবং রাইডের বিবরণ শেয়ার করুন"
        ...
        WHEN_YOU_START_EMERGENCY_SOS_PLUS -> "যখন আপনি সেফটি+ সক্রিয় করবেন, তখন আপনার অ্যাপ্লিকেশানটি নিচের কাজগুলি সম্পাদন করবে"
        ...
        ABOUT_SOS_12_PLUS _ -> "আপনি পুলিশ হেল্পলাইনে কল করতে পারেন (112) অথবা একই সাথে একটি নীরব এসওএস পাঠাতে পারেন"
        ...
        COMPLETE_YOUR_NAMMA_SAFETY_SETUP_FOR_SAFE_RIDE_EXPERIENCE_PLUS -> "নিরাপত্তা+ সেটআপ সম্পন্ন করুন\nনিরাপত্তা মোড সক্রিয় করতে"
        ...
        NIGHT_SAFETY_DESC -> "এটি ঘটবে সেফটি সক্রিয় করা হোক না কেন"
        NIGHT_SAFETY_DESC_PLUS -> "এটি ঘটবে সেফটি+ সক্রিয় করা হোক না কেন"
        ACTIVATE_NAMMA_SAFETY_WILL_ENABLE_ACCESS -> "নিরাপত্তা মোড সক্রিয় করলে নিম্নলিখিত বৈশিষ্ট্যগুলি অ্যাক্সেস সক্ষম করবে!"
        ACTIVATE_NAMMA_SAFETY_WILL_ENABLE_ACCESS_PLUS -> "নিরাপত্তা+ মোড সক্রিয় করলে নিম্নলিখিত বৈশিষ্ট্যগুলি অ্যাক্সেস সক্ষম করবে!"