...
getBN stringKey =
    case stringKey of
        ...
        NIGHT_TIME_FEE_DESCRIPTION nightChages start end -> "যদি আপনার যাত্রা যেকোনো সময় " <> start <> " থেকে " <> end <> " এর মধ্যে শুরু/শেষ হয়, তবে " <> nightChages <> " টাকা রাত্রিকালীন ফি চার্জ করা হবে"
