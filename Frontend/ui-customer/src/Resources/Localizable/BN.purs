...
getBN stringKey =
    case stringKey of
        ...
        KOZHIKODE -> "কোজিকোড"
        THRISSUR -> "ত্রিশূর"
        TRIVANDRUM -> "তিরুবনন্তপুরম"        METRO_FREE_TICKET_EVENT freeTicketInterval -> "প্রতিটি " <> freeTicketInterval <> " টিকেট বিনামূল্যে!"
        METRO_FREE_TICKET_EVENT_DESC freeTicketInterval maxFreeTicketCashback -> "প্রতিটি " <> freeTicketInterval <> " টিকেটে একটি বিনামূল্যে টিকেট পান (সর্বোচ্চ ₹" <> maxFreeTicketCashback <> ")"
