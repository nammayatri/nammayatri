...
getBN stringKey =
    case stringKey of
        ...
        SALEM -> "সেলেম"
        TRICHY -> "ত্রিচি"
        REQUEST_POLICE_HELP -> "পুলিশ সাহায্য অনুরোধ করুন"
        OPTION_TO_SEEK_IMMEDIATE_POLICE_HELP -> "তাৎক্ষণিক পুলিশ সাহায্য অনুরোধের বিকল্প"
        LAYERED_SAFETY_CHECKS_IN_CASE_OF_DEVIATIONS_IN_RIDES_AT_NIGHT -> "রাতের সময় রাইডে প্রতিস্থাপন হলে স্তরবদ্ধ নিরাপত্তা পরীক্ষা"
        SEEK_POLICE_HELP -> "পুলিশ সাহায্য অনুরোধ করুন"
        SEEK_POLICE_HELP_SUBTEXT_ONE -> "আপনার রাইড এবং স্থানের বিবরণ, সমস্ত উইপয়েন্ট সহ পুলিশ সাথে ভাগ করা হবে"
        SEEK_POLICE_HELP_SUBTEXT_TWO -> "পুলিশ QRT আপনার নিবন্ধিত মোবাইল নম্বরে কলের মাধ্যমে আপনার সাথে যোগাযোগ করবে, যদি তা ব্যর্থ হয় তবে QRT আপনাকে সাহায্য করতে মোবাইলাইজ করা হবে।"
        INCIDENT_REPORTED_SUCCESSFULLY -> "ঘটনা সফলভাবে প্রতিবেদন করা হয়েছে"
