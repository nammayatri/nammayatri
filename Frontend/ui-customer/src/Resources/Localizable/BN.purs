...
getBN stringKey =
    case stringKey of
        ...
        TICKETS_FOR_DELHI_METRO -> "দিল্লি মেট্রোর টিকিট"
        ...
        CONFIRM_PICKUP_AND_DROP_LOCATION -> "কনফার্ম পিকআপ অ্যান্ড ড্রপ লোকেশন"
        CONFIRM_YOUR_DELIVERY -> "কনফার্ম ইউর ডেলিভারি"
        PAYMENT_AT_RECEIVING_END -> "রিসিভারের প্রান্তে পেমেন্ট"
        ...
        OPTIONAL_INSTRUCTION -> "নির্দেশাবলী (ঐচ্ছিক)"
        HELP_US_PROVIDE_SMOOTH_PICKUP -> "আমাদের একটি মসৃণ পিকআপ প্রদান করতে সহায়তা করে"
        HELP_US_PROVIDE_SMOOTH_DROP -> "আমাদের একটি মসৃণ ড্রপ প্রদান করতে সহায়তা করে"
        I_AM_THE_SENDER -> "আমি সেন্ডার"
        I_AM_THE_RECEIVER -> "আমি রিসিভার"
        RECKLESS_HANDLING -> "অবহেলা করে হ্যান্ডলিং"
        DELIVERY_DELAYED -> "ডেলিভারি দেরিতে হয়েছে"
        ITEMS_MISSING -> "আইটেম অনুপস্থিত"
        POLITE_ATTITUDE -> "ভদ্র মনোভাব"
        SMOOTH_EXPERIENCE -> "মসৃণ অভিজ্ঞতা"
        ...
        ENTER_6_DIGIT_REFERRAL_CODE -> "রেফারেল কোড লিখুন"
        ...
        VIEW_THE_FAQS ->"প্রায়শই জিজ্ঞাসিত প্রশ্নাবলী দেখুন"
