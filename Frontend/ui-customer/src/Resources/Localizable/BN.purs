...
getBN stringKey =
    case stringKey of
        ...
        WAITING_CHARGE_DESCRIPTION -> "°প্রথম 3 মিনিটের জন্য ওয়েটিং চার্জ শূন্য। এর পরে অপেক্ষার সময় প্রতি মিনিটে আপনাকে ₹2 চার্জ করা হবে।"
        WAITING_CHARGE_RATECARD_DESCRIPTION -> "1. প্রথম 3 মিনিটের জন্য ওয়েটিং চার্জ শূন্য। \n 2. এর পরে প্রতি মিনিটে ₹2 এর ওয়েটিং চার্জ প্রযোজ্য হবে।"
        FARE_POLICY_WAITING_CHARGES -> "প্রযোজ্য @ ₹2 প্রতি মিনিটে প্রথম 3 মিনিট অপেক্ষা করার পরে"
