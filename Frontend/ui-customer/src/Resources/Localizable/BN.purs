...
getBN stringKey =
    case stringKey of
        ...
        CONFIRM_JOURNEY -> "যাত্রা নিশ্চিত করুন"
        ...
        START_TYPING_TO_SEARCH_PLACES_OR_ADD_STOPS -> "স্থানগুলি অনুসন্ধান করতে একটি পাঠ্য ক্ষেত্রে আলতো চাপুন বা আরও স্টপ যোগ করতে '+' আলতো চাপুন৷"
