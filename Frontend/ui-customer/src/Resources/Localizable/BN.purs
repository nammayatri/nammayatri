...
getBN stringKey =
    case stringKey of
        ...
        RIDE_SHARE_AFTER_SIX_PM -> "6 টার পরে আমার আপাতকালীন যোগাযোগের সাথে আমার ভ্রমণগুলি অটোমেটিকভাবে ভাগ করুন।"
        WHO_CAN_TRACK_YOUR_RIDE -> "6 টার পরে আপনার যাত্রা কে ট্র্যাক করতে পারে"
        ...
        EMERGENCY_CONTACTS_CAN_FOLLOW -> "আপনার জরুরি পরিচিতিদের আপনার রাইড ট্র্যাক করতে পারে"
        ALERT_SAFETY_TEAM -> "নম্মা যাত্রী সেফটি টীমকে চেতাবনি করুন"
        ...
        SHARE_RIDE_DESCRIPTION -> "এটি চয়ন করলে এনওয়ায় অ্যাপ পুশ বিজ্ঞপ্তি অ্যাপাট এমারজেন্সি কন্ট্যাক্টসকে প্রেরণ করবে।"
        SHARE_RIDE_WITH_CONTACT -> "{} সংপর্ক সাথে ভাগাভাগি করুন"
