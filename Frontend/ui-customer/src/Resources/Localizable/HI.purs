...
getHI stringKey =
    case stringKey of
        ...
        SALEM -> "सलेम"
        TRICHY -> "त्रिची"
        REQUEST_POLICE_HELP -> "पुलिस सहायता का अनुरोध करें"
        OPTION_TO_SEEK_IMMEDIATE_POLICE_HELP -> "तत्काल पुलिस सहायता पाने का विकल्प"
        LAYERED_SAFETY_CHECKS_IN_CASE_OF_DEVIATIONS_IN_RIDES_AT_NIGHT -> "रात की यात्राओं में विचलन के मामले में सुरक्षा जांचें"
        SEEK_POLICE_HELP -> "पुलिस सहायता प्राप्त करें"
        SEEK_POLICE_HELP_SUBTEXT_ONE -> "आपके सवारी और स्थान विवरण सहित सभी वेपॉइंट्स पुलिस के साथ साझा किए जाएंगे"
        SEEK_POLICE_HELP_SUBTEXT_TWO -> "यदि आपसे संपर्क नहीं हो पाता है, तो पुलिस की क्विक रिस्पांस टीम आपकी सहायता के लिए मौके पर पहुंचेगी"
        INCIDENT_REPORTED_SUCCESSFULLY -> "घटना सफलतापूर्वक दर्ज की गई"
