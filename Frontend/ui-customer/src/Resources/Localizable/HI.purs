...
getHI stringKey =
    case stringKey of
        ...
        KOZHIKODE -> "कोझिकोड"
        THRISSUR -> "त्रिशूर"
        TRIVANDRUM -> "तिरुवनंतपुरम"        METRO_FREE_TICKET_EVENT freeTicketInterval -> "हर " <> freeTicketInterval <> " टिकट मुफ्त है!"
        METRO_FREE_TICKET_EVENT_DESC freeTicketInterval maxFreeTicketCashback -> "हर " <> freeTicketInterval <> " टिकट पर मुफ्त टिकट प्राप्त करें (अधिकतम ₹" <> maxFreeTicketCashback <> ")"
