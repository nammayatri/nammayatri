...
getHI stringKey =
    case stringKey of
        ...
        YOU_HAVE_AN_ACTIVE_RIDE bookingTime -> "आपका एक चालू सवारी " <> bookingTime <> " तक है। एक नई बुकिंग बनाने के लिए, मौजूदा बुकिंग को रद्द करें या इसे पूरा होने तक इंतजार करें।"
