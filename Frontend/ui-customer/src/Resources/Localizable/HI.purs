...
getHI stringKey =
    case stringKey of
        ...
        PERSONAL_SAFETY_SETTINGS_ACTIONS _ -> " •  112 को कॉल करें\n •  NammaYatri समर्थन को कॉल करें\n •  वीडियो रिकॉर्ड करें"
        ...
        ABOUT_SOS_12_PLUS _ -> "आप पुलिस हेल्पलाइन (112) पर कॉल करना चुन सकते हैं या उस पर एक साइलेंट SOS भेज सकते हैं"
