...
getHI stringKey =
    case stringKey of
        ...
        CONFIRM_JOURNEY -> "यात्रा की पुष्टि करें"
        ...
        START_TYPING_TO_SEARCH_PLACES_OR_ADD_STOPS -> "स्थानों को खोजने के लिए टेक्स्ट फ़ील्ड पर टैप करें या अधिक स्टॉप जोड़ने के लिए '+' पर टैप करें"
