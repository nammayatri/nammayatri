...
const hindiStrings = {
    "WELCOME_TEXT" : "Welcome to the  Namma Yatri",
...
const englishStrings = {
    "WELCOME_TEXT" : "Welcome to the Namma Yatri",
    "ABOUT_TEXT" : "Namma Yatri is an open platform to connect riders with drivers. The app makes it convenient for riders to book a ride with meter rate hence minimal fare."
}