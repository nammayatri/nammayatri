...
config =
  ...
  , estimateAndQuoteConfig : 
      { variantTypes : [ ["SUV"], ["HATCHBACK", "TAXI_PLUS", "SEDAN"], ["TAXI"], ["AUTO_RICKSHAW"], ["TAXI"], ["AMBULANCE_VENTILATOR"],["AMBULANCE_AC_OXY"], ["AMBULANCE_AC"],["AMBULANCE_TAXI_OXY"] ,["AMBULANCE_TAXI"]]
      , variantOrder : ["BIKE", "HATCHBACK", "TAXI_PLUS", "SEDAN", "TAXI", "SUV", "AUTO_RICKSHAW","AMBULANCE_VENTILATOR","AMBULANCE_AC_OXY", "AMBULANCE_AC","AMBULANCE_TAXI_OXY" ,"AMBULANCE_TAXI"]
      , variantInfo : {
        hatchback : {
          name : "Hatchback",
        ...
        ambulanceTaxi : {
          name : "Ambulance Taxi",
          image : "ny_ic_ambulance_noac_nooxy,https://assets.moving.tech/beckn/nammayatri/user/images/ny_ic_ambulance_noac_nooxy.png",
          leftViewImage : "ny_ic_ambulance_noac_nooxy,"
        },
        ambulanceTaxiOxy : {
          name : "Ambulance Taxi with Oxygen",
          image : "ny_ic_ambulance_noac_oxy,https://assets.moving.tech/beckn/nammayatri/user/images/ny_ic_ambulance_noac_oxy.png",
          leftViewImage : "ny_ic_ambulance_noac_oxy,"
        },
        ambulanceAc : {
          name : "Ambulance AC",
          image : "ny_ic_ambulance_ac_nooxy,https://assets.moving.tech/beckn/nammayatri/user/images/ny_ic_ambulance_ac_nooxy.png",
          leftViewImage : "ny_ic_ambulance_ac_nooxy,"
        },
        ambulanceAcOxy : {
          name : "Ambulance AC with Oxygen",
          image : "ny_ic_ambulance_ac_oxy,https://assets.moving.tech/beckn/nammayatri/user/images/ny_ic_ambulance_ac_oxy.png",
          leftViewImage : "ny_ic_ambulance_ac_oxy,"
        },
        ambulanceVentilator : {
          name : "Ambulance with Ventilator",
          image : "ny_ic_ambulance_ventilator,https://assets.moving.tech/beckn/nammayatri/user/images/ny_ic_ambulance_ventilator.png",
