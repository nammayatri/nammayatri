  ...
  in
    if (bookingStatus == "FAILED") then
      ...
      if ticketStatus == Just "ACTIVE" then
        TicketStatus { status : FRFS_PENDING, statusColor : Color.green900, statusIcon : fetchImage FF_COMMON_ASSET "ny_ic_green_tick", textColor: Color.white900}
        ...
        TicketStatus { status : FRFS_EXPIRED, statusColor : Color.grey900, statusIcon : fetchImage FF_ASSET "ny_ic_info", textColor: Color.black700}
    else
      TicketStatus { status : FRFS_PENDING, statusColor : Color.yellow900, statusIcon : fetchImage FF_COMMON_ASSET "ny_ic_yellow_clock", textColor: Color.white900}
