...
getVariantRideType variant =
  case getMerchant FunctionCall of
    YATRISATHI -> case variant of
                    ...
                    "SEDAN" -> "Sedan"
                    "HATCHBACK" -> "AC Mini"
                    "AMBULANCE_TAXI" -> "Ambulance"
                    "AMBULANCE_TAXI_OXY" -> "Ambulance"
                    "AMBULANCE_AC" -> "Ambulance"
                    "AMBULANCE_AC_OXY" -> "Ambulance"
                    "AMBULANCE_VENTILATOR" -> "Ambulance"
                    _      -> "AC Cab"
    _          -> getString AC_CAB
...
quoteModalVariantImage variant = 
  ...
  in 
    if variant == "AUTO_RICKSHAW"
      ...
      else if variant `elem` ["AMBULANCE_TAXI", "AMBULANCE_TAXI_OXY", "AMBULANCE_AC", "AMBULANCE_AC_OXY", "AMBULANCE_VENTILATOR"]
...
getCitySpecificMarker city variant currentStage =
    case variant of
              ...
              "AMBULANCE_TAXI" -> "ny_ic_ambulance_nav_on_map"
              "AMBULANCE_TAXI_OXY" -> "ny_ic_ambulance_nav_on_map"
              "AMBULANCE_AC" -> "ny_ic_ambulance_nav_on_map"
              "AMBULANCE_AC_OXY" -> "ny_ic_ambulance_nav_on_map"
              "AMBULANCE_VENTILATOR" -> "ny_ic_ambulance_nav_on_map"
