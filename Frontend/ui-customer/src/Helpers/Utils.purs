...
getMetroConfigFromCity city =
  case city of
    Kochi -> mkCityBasedConfig "ny_ic_kochi_metro" (getString TICKETS_FOR_KOCHI_METRO) "ny_ic_kochi_metro_map" "ny_ic_kochi_metro_banner" "#F5FFFF" "#02B0AF" "https://metro-terms.triffy.in/kochi/index.html" [getString KOCHI_METRO_TERM_1 ,getString KOCHI_METRO_TERM_2] (getString KOCHI_METRO_TIME) {startTime : "05:00:00", endTime : "18:45:00"}
    Chennai -> mkCityBasedConfig "ny_ic_chennai_metro" (getString TICKETS_FOR_CHENNAI_METRO) "ny_ic_chennai_metro_map" "ny_ic_chennai_metro_banner" "#D8E2FF" "#2250BF" "https://metro-terms.triffy.in/chennai/index.html" [getString CHENNAI_METRO_TERM_1 ,getString CHENNAI_METRO_TERM_1] (getString CHENNAI_METRO_TIME) {startTime : "04:30:00", endTime: "22:30:00"}
    _ -> mkCityBasedConfig "" "" "" "" "" "" "" [] "" {startTime : "00:00:00", endTime : "00:00:00"}
  where
    mkCityBasedConfig logoImage title mapImage bannerImage bannerBackgroundColor bannerTextColor termsAndConditionsUrl termsAndConditions errorPopupTitle operationalHours = 
      CityMetroConfig
        { logoImage
        , title
        , mapImage
