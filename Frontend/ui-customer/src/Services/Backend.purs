            ...
            case route of
                Just (Route routes) ->
                    if (routes.distance <= 50000) then do
                      ...
                      lift $ lift $ liftFlow $ drawRoute [ (walkCoordinate srcLat srcLng destLat destLng)] "DOT" false sourceMarkerConfig destMarkerConfig 8 routeType specialLocation (getNewIDWithTag "CustomerHomeScreen") -- check this
                      pure route 
                Nothing -> pure route
