...
------- busTicket/{ticketId} -- JAYPAL, confirm endpoint once
data BusTicketReq = BusTicketReq String

-- JAYPAL, check if marked with IRTS marked fields, PS: Also assumed same ticket for multiple peoples.
newtype BusTicketRes = BusTicketRes {
  id :: String,
  -- bppTicketId :: Maybe String, IRTS
  status :: String,
  quoteId :: Maybe String,
  -- providerId :: String, IRTS
  -- providerUrl :: String, IRTS
  -- itemId :: String, IRTS
  paymentUrl :: Maybe String,
  -- fulfillmentId :: Maybe String, IRTS
  -- searchRequestId :: String, IRTS
  -- bppOrderId :: Maybe String, IRTS
  quantity :: Int,
  pricePerAdult :: Number,
  totalPrice :: Number,
  -- merchantId :: String, IRTS
  qrData :: String
}
