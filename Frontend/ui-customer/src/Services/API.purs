...
instance decodeQuoteAPIContents :: Decode QuoteAPIContents where
  decode body =
    case (runExcept $ (readProp "fareProductType" (spy "body QuoteAPIContents" body)) >>= decode) of
    ...
    -- (ONE_WAY <$> decode body) <|>
    -- (DRIVER_OFFER <$> decode body) <|>
    -- (SPECIAL_ZONE <$> decode body) <|>
    -- (RENTAL <$> decode body) <|>
    -- (INTER_CITY <$> decode body) <|>
    -- (fail $ ForeignError "Unknown response")
...
instance decodeQuoteAPIDetails :: Decode QuoteAPIDetails where
      decode body = case (runExcept $ (readProp "fareProductType" (spy "body QuoteAPIDetails" body))) of
                      Right fareProductType -> 
                        case (runExcept $ (readProp "contents" (spy "body contents" body))) of
                          Right contents ->
