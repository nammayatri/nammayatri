...
data ACCOUNT_SET_UP_SCREEN_OUTPUT
  = GO_HOME AccountSetUpScreenState
  | GO_BACK

data TRIP_DETAILS_SCREEN_OUTPUT
  = ON_SUBMIT TripDetailsScreenState
  | GO_TO_INVOICE TripDetailsScreenState
  | GO_TO_HOME TripDetailsScreenState
  | GO_TO_RIDES
  | GO_TO_HELPSCREEN
  | CONNECT_WITH_DRIVER TripDetailsScreenState
  | GET_CATEGORIES_LIST TripDetailsScreenState
  | GO_TO_ISSUE_CHAT_SCREEN TripDetailsScreenState CategoryListType

data CONTACT_US_SCREEN_OUTPUT
  = GO_TO_HOME_FROM_CONTACT ContactUsScreenState

data MY_RIDES_SCREEN_OUTPUT
  = REFRESH MyRidesScreenState
  | TRIP_DETAILS MyRidesScreenState
  | LOADER_OUTPUT MyRidesScreenState
  | BOOK_RIDE
  | GO_TO_HELP_SCREEN
  | GO_TO_NAV_BAR
  | REPEAT_RIDE_FLOW MyRidesScreenState
  | GO_TO_RIDE_SCHEDULED_SCREEN MyRidesScreenState
  | MY_RIDES_GO_TO_HOME_SCREEN MyRidesScreenState

data ABOUT_US_SCREEN_OUTPUT
  = GO_TO_HOME_FROM_ABOUT

data EMERGECY_CONTACTS_SCREEN_OUTPUT
...
data TICKET_INFO_SCREEN_OUTPUT
  = GO_TO_HOME_SCREEN_FROM_TICKET_INFO

data HOME_SCREEN_OUTPUT
  = LOGOUT
  | RELOAD Boolean
  | REFRESH_HOME_SCREEN
  | RETRY
...
data SELECT_LANGUAGE_SCREEN_OUTPUT
  = GO_TO_HOME_SCREEN
  | UPDATE_LANGUAGE SelectLanguageScreenState

data PERMISSION_SCREEN_OUTPUT
  = REFRESH_INTERNET
  | TURN_ON_GPS
  | TURN_ON_INTERNET

data SAVED_LOCATION_SCREEN_OUTPUT
  = ADD_NEW_LOCATION SavedLocationScreenState
  | DELETE_LOCATION String
  | EDIT_LOCATION LocationListItemState
  | GO_BACK_FROM_SAVED_LOCATION

data ADD_NEW_ADDRESS_SCREEN_OUTPUT
  = SEARCH_ADDRESS String AddNewAddressScreenState
...
data MY_PROFILE_SCREEN_OUTPUT
  = UPDATE_USER_PROFILE MyProfileScreenState
  | GO_TO_HOME_

data REFERRAL_SCREEN_OUPUT
  = UPDATE_REFERRAL String
  | BACK_TO_HOME
...
data TICKET_BOOKING_SCREEN_OUTPUT
  = GET_BOOKING_INFO_SCREEN TicketBookingScreenState BookingStatus
...
data METRO_TICKET_STATUS_SCREEN_OUTPUT
...
data TICKETING_SCREEN_SCREEN_OUTPUT
  = EXIT_TO_HOME TicketingScreenState
...
data METRO_TICKET_DETAILS_SCREEN_OUTPUT
  = METRO_TICKET_DETAILS_SCREEN_OUTPUT_NO_OUTPUT
...
data METRO_MY_TICKETS_SCREEN_OUTPUT
  = METRO_MY_TICKETS_SCREEN_OUTPUT_NO_OUTPUT
...
data METRO_TICKET_SCREEN_OUTPUT
  = GO_TO_HOME_SCREEN_FROM_METRO_TICKET MetroTicketBookingScreenState
