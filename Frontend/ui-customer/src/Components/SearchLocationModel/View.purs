...
selectSlabView push state =
  linearLayout [ 
      ...
      --       ]
      --   ]
      --   , slabIncreaseView push state
      -- ]

slabIncreaseView :: forall w. (Action -> Effect Unit) -> SearchLocationModelState -> PrestoDOM (Effect Unit) w
slabIncreaseView push state = 
  linearLayout
    [ width MATCH_PARENT
    , height WRAP_CONTENT
    ...
    , linearLayout [
      ...
      , weight 1.0
          ...
          $
            ...
            , singleLine true
            , accessibility DISABLE
            , accessibilityHint $ "Duration : " <> state.rentalData.baseDuration
            , color Color.black800
            , gravity CENTER_VERTICAL
            ]
          <> FontStyle.subHeading1 TypoGraphy
      ...
      , textView
          $
            ...
            , singleLine true
            , accessibility DISABLE
            , accessibilityHint $ "Distance : " <> state.rentalData.baseDuration
            , color Color.black600
            , gravity CENTER_VERTICAL
            ]
          <> FontStyle.subHeading1 TypoGraphy
