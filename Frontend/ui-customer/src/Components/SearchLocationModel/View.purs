  ...
  linearLayout
    ...
    , afterRender (\action -> do
      ...
      , orientation HORIZONTAL
            ...
            , onChange
                ...
                SourceChanged
            , Id.testId $ Id.TextField Id.source
        ...
        , linearLayout
            ...
            , Id.testId $ Id.Object (Id.source <> Id.underScore <> Id.clear)
    ...
    , linearLayout
        ...
        [ editText
            ( [ height $ V 45
              ...
              , onChange
                  ...
                  DestinationChanged
              , Id.testId $ Id.TextField Id.destination
              , inputTypeI if state.isSearchLocation == LocateOnMap then 0 else 1
        ...
        , linearLayout -- TO BE ADDED LATER FOR CLEARING TEXT
            ...
            , Id.testId $ Id.Object if state.destination /= "" then (Id.destination <> Id.underScore <> Id.clear) else Id.noAction 
            ]
            [ imageView
                [ height $ V 16
                , width $ V 16
