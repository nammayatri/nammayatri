...
import Screens.Types (SearchLocationModelType, LocationListItemState, LocItemType(..), SearchLocationEditTextFocusType(..))
...
data Action = GoBack
            ...
            | SetLocationOnMap
            | SetCurrentLocation
            | EditTextFocusChanged SearchLocationEditTextFocusType Boolean
