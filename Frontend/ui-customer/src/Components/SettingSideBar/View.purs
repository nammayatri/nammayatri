...
settingsView state push =
  ...
  , orientation VERTICAL
        ...
        "MetroTickets" -> if (DA.any (_ == city) [Kochi, Chennai]) then settingsMenuView {imageUrl : fetchImage FF_ASSET "ny_ic_ticket_grey_small", text : getString MY_TICKETS, accessibilityHint : "Tickets", tag : SETTINGS_MY_METRO_TICKETS, iconUrl : "", showNewTag: true} push else linearLayout[visibility GONE][]
        ...
        "HelpAndSupport" -> settingsMenuView {imageUrl : fetchImage FF_ASSET  "ny_ic_help", text :  if state.appConfig.enableHelpAndSupport then getString HELP_AND_SUPPORT else getString CONTACT_SUPPORT, accessibilityHint : "Help And Support", tag : SETTINGS_HELP, iconUrl : "", showNewTag : false} push
