...
settingsView state push =
  ...
  , orientation VERTICAL
        ...
        "HelpAndSupport" -> settingsMenuView {imageUrl : "ny_ic_help_menu," <> (getAssetStoreLink FunctionCall) <> "ny_ic_help_menu.png", text : (getString HELP_AND_SUPPORT), accessibilityHint : "Help And Support ", tag : SETTINGS_HELP, iconUrl : ""} push -- TEMP : For removing contact support
