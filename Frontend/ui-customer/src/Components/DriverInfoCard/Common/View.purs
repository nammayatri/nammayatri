...
sourceDestinationView push config = 
  let isNotRentalRide = (config.fareProductType /= FPT.RENTAL)
      ...
      dropLocationTextWidth = if config.enableEditDestination && isNotRentalRide then locationTextWidthWhenFeatureEnabled else locationTextWidthWhenFeatureDisabled
