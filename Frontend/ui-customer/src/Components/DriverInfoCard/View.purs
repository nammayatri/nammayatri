...
driverInfoView push state =
  let tagConfig =  if true then safetyPlusTagConfig else specialZoneTagConfig state.props.zoneType.priorityTag
  ...
  , visibility $ boolToVisibility $ not $ isOtpRideFlow state 
      ...
      , scrollBarY false
         ...
         , stroke $ state.data.config.driverInfoConfig.cardStroke
              ...
              ][  if true then safetyPlusView tagConfig else specialZoneView tagConfig
              , linearLayout
                [ orientation VERTICAL
                , height WRAP_CONTENT
                , width MATCH_PARENT
  ...
  where
    ...
    safetyPlusView tagConfig = 
      linearLayout
        ...
        , orientation HORIZONTAL
        , padding (PaddingVertical 6 6)
        , visibility $ boolToVisibility $ true --state.data.isSafetyPlus
        , clickable $ isJust tagConfig.infoPopUpConfig
        ][ textView
          ([ width WRAP_CONTENT
          , height WRAP_CONTENT
