...
import Data.Array (filter, head, null, (!!), mapWithIndex, slice, length, cons, findIndex, elem, sortBy, foldl, sortWith, any)
      ...
      smartTipReason = case state.selectedEstimatesObject.smartTipReason of 
                        ...
                        Nothing -> do 
                                    ...
                                    case head reasons of 
                                      Just val -> val
                                      Nothing -> getString IT_SEEMS_TO_BE_TAKING_LONGER_THAN_USUAL
