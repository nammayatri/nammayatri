...
import Components.StepsHeaderModel.Controller (Action(..),Config)
  ...
  linearLayout
    ...
    , padding $ PaddingVertical 10 10
        ...
        , gravity CENTER_VERTICAL
            ...
            [ height $ V 25
            , width $ V 25
            , imageWithFallback "ic_chevron_left_white,https://assets.juspay.in/nammayatri/images/user/ny_ic_navigation.png"
