...
getChatConfig :: Config -> String -> Boolean -> Boolean -> Int -> {margin :: Margin, gravity :: Gravity, background :: String, cornerRadii :: Corners, textColor :: String, playAudioImage :: String}
