...
-}
module Components.LargeBannerCarousel.Controller where
...
data BannerSize
  = Small --TODO:: Move string to BannerSize for bannerSize param
  | Medium
  | Large
        ...
        let
          ...
          config'' =
            config'
              ...
              , bannerSize = spy "TempBannerSize" mbBannerSize
              }
        in
          config''
    )
