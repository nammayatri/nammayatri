...
view :: forall w. String -> String -> (Action -> Effect Unit) -> String -> String -> Length -> Boolean -> PrestoDOM (Effect Unit) w
view image title push backgroundColor strokeColor width' useMargin =
  linearLayout
    ([ height WRAP_CONTENT
    , width width'
