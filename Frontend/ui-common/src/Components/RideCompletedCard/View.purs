  ...
  , gravity CENTER
    ...
    , linearLayout
      ...
      , padding $ PaddingVertical 30 26
        ...
        -- , pillView config push -- Removed temporarily till endride screen redesigned
...
bottomCardView config push =
  ...
  , weight 1.0
    ...
    , if config.qrVisibility then driverUpiQrCodeView config push else noVpaView config push
...
noVpaView config push = 
   linearLayout 
    ...
    , margin $ MarginBottom 26
        ...
        , width $ V 24
        , margin $ MarginVertical 8 13
        , imageWithFallback "ny_ic_info_orange,https://assets.juspay.in/nammayatri/images/common/ny_ic_info_orange.png"
        ]
      , textView $
