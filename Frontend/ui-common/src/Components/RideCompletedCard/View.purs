...
import Components.RideCompletedCard.Controller (Config, Action(..), Theme(..), RideCompletedElements(..), InfoCardConfig(..), RentalRowView(..), RentalTextConfig(..))
...
import Prelude (Unit, bind, const, discard, not, pure, unit, void, ($), (&&), (*), (-), (/), (<), (<<<), (<>), (==), (>), (>=), (||), (<=), show, void, (/=), when, mod)
