...
vehicleInfo config push  = 
  linearLayout
    ...
    [ imageView
        [ height $ V 14
        , width $ V 14
        , imageWithFallback $ if config.vehicleInfo.vehicleServiceTierAirConditioned then fetchImage FF_COMMON_ASSET "ny_ic_ac_white" else fetchImage FF_COMMON_ASSET "ny_ic_non_ac_white"
    ...
    , textView $ 
        [ height WRAP_CONTENT
        , width WRAP_CONTENT
        , text if config.vehicleInfo.vehicleServiceTierAirConditioned then "AC" else "Non-AC"
        , color Color.white900
