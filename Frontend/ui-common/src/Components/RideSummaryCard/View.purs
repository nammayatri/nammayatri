...
vehicleInfo config push  = 
  linearLayout
    ...
    [ linearLayout 
        ...
        , orientation HORIZONTAL
        , cornerRadius 18.0
        , background if config.vehicleInfo.airConditioned then Color.blue800 else Color.black700
        ...
        [ imageView
            [ height $ V 14
            , width $ V 14
            , imageWithFallback $ fetchImage FF_COMMON_ASSET $ if config.vehicleInfo.airConditioned then "ny_ic_ac_white" else "ny_ic_non_ac_white"
        ...
        , textView $ 
            [ width WRAP_CONTENT
            , height WRAP_CONTENT
            , text (show config.vehicleInfo.seatingCapacity)
            , color Color.black700
            ] <> FontStyle.body1 TypoGraphy
        ]
    ]
  ...
  linearLayout
    ...
    , linearLayout
        ...
        [ textView $
            ...
            , accessibilityHint $ convertUTCtoISC dateAndTime "DD" <> convertUTCtoISC dateAndTime "/ MM" <> convertUTCtoISC dateAndTime " / YYYY"
            ] <> FontStyle.body1 TypoGraphy
        , imageView 
            [ width $ V 5
            , height $ V 5
