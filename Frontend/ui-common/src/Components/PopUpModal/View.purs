                ...
                [ linearLayout
                    ...
                    [   shimmerFrameLayout
                        ...
                        [ imageView [
                            ...
                            , height WRAP_CONTENT
                            , accessibility ENABLE
                            , text $ spy "priting timerValue -> " (if state.option1.enableTimer && state.option1.timerValue > 0 then (state.option1.text <> " (" <> (show state.option1.timerValue) <> ")") else state.option1.text)
