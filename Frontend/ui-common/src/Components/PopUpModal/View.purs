...
busInfo push state = 
    ...
    visibility $ boolToVisibility $ not state.whereIsMyBusConfig.selectRouteStage 
        ...
        linearLayout[][]
        -- ,
        -- selectBusDriverButton push state
    ]
...
-- selectRoute push state =
    ...
    --     SelectableItem.view 
    --       (\action -> push action)
    --       { primaryText: state.whereIsMyBusConfig.selectRouteButton.busRouteNumber
    --       , primaryTextColor: Colors.black900
    --       , secondaryText: Just state.whereIsMyBusConfig.selectRouteButton.sourceText
    --       , destinationText: Just state.whereIsMyBusConfig.selectRouteButton.destination
    --       , onClick: SelectableItem.Click
    --       , showChevron: true
    --       , isSelectable: true
    ...
    --       , fontSize: FontStyle.Body3
    --       , primaryFontSize: FontStyle.SubHeading1
    --       , leadingIcon: Nothing
    --       , trailingIcon: Nothing
    --       , backgroundColor: if isRouteSelected then Colors.blue600 else Colors.white900
    --       , selectedBackgroundColor: Colors.blue600
    --       , borderColor: if isRouteSelected then Colors.blue900 else Colors.grey800
...
searchableListView push state =
    ...
    [
        ...
        SearchableList.view (push <<< SearchableListAction) state.searchableListConfig 
    ]