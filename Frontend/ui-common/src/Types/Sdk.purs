...
instance decodeSDKResponse :: DecodeWithOptions (Maybe b) => Decode (SDKResponse b) where decode = defaultDecode
instance encodeSDKResponse :: EncodeWithOptions (Maybe b) => Encode (SDKResponse b) where encode = defaultEncode
...
instance decodeSDKRequest :: DecodeWithOptions a => Decode (SDKRequest a) where
    decode = defaultDecode
instance encodeSDKRequest :: EncodeWithOptions a => Encode (SDKRequest a) where
