...
getDriverProfile action push state = do
  ...
  (driversProfileResp) <- lift $ lift $ SB.getDriverProfile state.props.driverId
        ...
        ,   orientation VERTICAL
            ...
            ,   linearLayout
                ...
                ,   imageView [ 
                    width $ V 14
                    , height $ V 14
                    , imageWithFallback $ fetchImage FF_COMMON_ASSET "ny_ic_info_grey1"
...
driverInfoCard push state =
    ...
    ,   linearLayout[
        ...
        ,   visibility $ boolToVisibility $ not (state.data.drivingSince == Nothing)
            ...
            [ height WRAP_CONTENT
            , width WRAP_CONTENT
            , text $ "🗓️    " <> getString WITH_NAMMAYATRI_FOR <>" " <> show (fromMaybe 0 state.data.drivingSince) <>"+ " <> getString YEARS
            , color Color.black700
            ] <> FontStyle.body1 CT.TypoGraphy
        ]
    ,   linearLayout[
    ...
    ,   linearLayout[
        ...
        ,   linearLayout[
            ...
            ,   textView $
                [ height WRAP_CONTENT
                , width WRAP_CONTENT
                , text $ state.data.driverName <> getString CARD_TEXT
                , color Color.black800
                , gravity CENTER
