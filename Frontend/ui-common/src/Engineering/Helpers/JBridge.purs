...
foreign import voipDialer :: forall action. EffectFn6 String Boolean String Boolean (action -> Effect Unit) (String -> String -> Int -> Int -> String -> String -> String -> action) Unit
