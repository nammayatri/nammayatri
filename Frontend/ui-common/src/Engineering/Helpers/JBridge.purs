...
showDateTimePicker ∷ forall action. (action → Effect Unit) -> (String → Int → Int → Int → String → Int → Int → action) -> Maybe String -> Boolean -> Boolean -> Aff Unit
showDateTimePicker push action maybePrevDate openDatePicker openTimePicker = do
  let 
