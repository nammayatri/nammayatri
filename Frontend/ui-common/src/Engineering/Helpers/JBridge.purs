...
foreign import voipDialer :: forall action. String -> Boolean -> String -> Boolean -> (action -> Effect Unit) -> (String -> String -> Int -> Int -> String -> String -> String -> action) -> Effect Unit
