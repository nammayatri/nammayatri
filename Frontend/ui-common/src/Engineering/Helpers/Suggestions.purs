...
suggestionsDefinitions dummy = [
  ...
  {key : "cis2BP", value : {en_us : "Urgent, come soon", ta_in : "அவசரம், சீக்கிரம் வாருங்கள்", kn_in : "ದಯವಿಟ್ಟು ಬೇಗ ಬನ್ನಿ ", hi_in : "अर्जेंट है प्लीज जड़ली आइये", ml_in : "അത്യാവശ്യമാണ്, വേഗം വരൂ", bn_in : "জরুরী আছে, দয়া করে তাড়াতাড়ি আসুন" }},
