...
foreign import getUTCAfterNSecondsImpl :: EffectFn2 String Int String
...
getUTCAfterNSeconds :: String -> Int -> Effect String
getUTCAfterNSeconds = runEffectFn2 getUTCAfterNSecondsImpl
