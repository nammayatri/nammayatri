...
import static in.juspay.mobility.appcommon.R.integer.REQUEST_CODE_UPDATE_APP;
...
import in.juspay.mobility.appcommon.ConnectionStateMonitor;
//import in.juspay.mobility.utils.LocationUpdateService;
import in.juspay.mobility.appcommon.NetworkBroadcastReceiver;
...
//        DefaultMediaPlayerControl.mediaPlayer.reset();// COMMENTED CHECK
        super.onDestroy();
    }
