...
public class CheckPermissionAutoStart {
    ...
    public void getAutoStartPermission(Context context) {
        ...
        String build_info = Build.MANUFACTURER.toLowerCase();
        System.out.println("Inside CheckPermissionAutoStart getAutoStartPermission " + build_info + " Manufaturer " + (Build.MANUFACTURER));
        switch (build_info) {
            case BRAND_ASUS:
