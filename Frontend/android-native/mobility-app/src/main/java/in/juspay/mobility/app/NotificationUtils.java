        ...
        try {
            ...
            if (ALLOCATION_TYPE.equals(notificationType)) {
                ...
                try {
                    ...
                    sheetData.putInt("customerCancellationDues", entity_payload.has("customerCancellationDues") && !entity_payload.isNull("customerCancellationDues") ? entity_payload.getInt("customerCancellationDues") : 0 );
