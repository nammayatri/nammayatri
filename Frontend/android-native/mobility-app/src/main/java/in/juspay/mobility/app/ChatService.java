...
public class ChatService extends Service {
    ...
    MessageOverlay.SendMessageCallBack sendMessageCallBackOverlay;
    ...
    public void onCreate() {
        ...
        MessageOverlay.registerSendMessageCallBack(sendMessageCallBackOverlay);
    ...
    public void onDestroy() {
        ...
        MessageOverlay.deRegisterSendMessageCallBack(sendMessageCallBackOverlay);
        stopForeground(true);
