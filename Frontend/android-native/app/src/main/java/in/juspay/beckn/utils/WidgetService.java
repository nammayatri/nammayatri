...
public class WidgetService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (widgetMessage!=null){
            LinearLayout messageView =  widgetView.findViewById(R.id.message_view);
            messageView.setVisibility(View.VISIBLE);
            TextView messageTextView = widgetView.findViewById(R.id.messageTextView);
    ...
    public void onCreate() {
        ...
        try{
            imageClose.setImageResource(R.drawable.ic_close_transparent);
        }catch (Exception e){
                    ...
                    switch (motionEvent.getAction()){
                        ...
                        case MotionEvent.ACTION_MOVE:
                            ...
                            if (widgetLayoutParams.y > height*0.85 && widgetLayoutParams.x > width*0.30 && widgetLayoutParams.x < width*0.55){
                                imageClose.setImageResource(R.drawable.ic_close_filled_round);
