            ...
            public void onEvent(JSONObject jsonObject, JuspayResponseHandler juspayResponseHandler) {
                ...
                switch (event) {
                    ...
                    case "in_app_notification":
                        System.out.println("In app notification receivedzxc: "+ jsonObject.toString());
            ...
            handler.postDelayed(() -> {
                try {
                    if (inAppNotification != null){
                        System.out.println("In app notification generateNotification received: zxc "+ payload.toString());
