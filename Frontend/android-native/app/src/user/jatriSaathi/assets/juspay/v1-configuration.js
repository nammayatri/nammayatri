...
window.getMerchantConfig = function () {
  return JSON.stringify({
    ...
    "tipsEnabled" : true,
    "tipEnabledCities" : ["Kolkata", "Siliguri"],
    "customerTip" : {
      "auto" : false,
      "cabs" : true
    },
  ...
  , "notifyRideConfirmationConfig" : 
    ...
    , "estimateAndQuoteConfig" : 
      { "variantTypes" : [ ["SUV"], ["SEDAN", "HATCHBACK", "TAXI_PLUS"], ["TAXI"], ["BOOK_ANY"], ["BIKE"],["AMBULANCE_VENTILATOR"],["AMBULANCE_AC_OXY"], ["AMBULANCE_AC"],["AMBULANCE_TAXI_OXY"] ,["AMBULANCE_TAXI"]]
      , "variantOrder" : ["BIKE", "BOOK_ANY", "SEDAN", "HATCHBACK", "TAXI_PLUS", "TAXI", "SUV","AMBULANCE_VENTILATOR","AMBULANCE_AC_OXY", "AMBULANCE_AC","AMBULANCE_TAXI_OXY" ,"AMBULANCE_TAXI"]
